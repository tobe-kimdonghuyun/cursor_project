...
if (!nexacro.Combo)
{
            ...
            switch (type)
            {
                ...
                case "caseisearch":
                    ...
                    if (this._p_type == "caseisearch")
                    {
                        ...
                        index = ds.findRowExpr(col + ".match(/^" + parse_val + "/i)");
                    }
                    else
    ...
    _pCombo._getParseValue = function (edit_val)
    {
        var regExp;
        var parse_val = "";
    ...
    _pComboPopupControl._getPopupPosition = function ()
	{
        ...
        {
            if (rootframe._isShowTitleBar())
                titlebarHeight = rootframe._titlebarheight ? rootframe._titlebarheight : 0;
        }

        return { left: popup_left + xgap, top: popup_top + ygap - titlebarHeight, width: popup_width, height: popup_height };
	};
