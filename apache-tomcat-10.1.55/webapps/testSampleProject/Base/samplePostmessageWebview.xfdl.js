(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("0");
            obj.getSetter("onmessage").set("wbvSample_onmessage");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("samplePostmessageWebview.xfdl", function() {
        this.sPageUrl = "http://172.10.11.74:8080/pagepage/postMsgTobeTechSample.html";
        ...
        this.loadIncludeScript("samplePostmessageWebview.xfdl");
