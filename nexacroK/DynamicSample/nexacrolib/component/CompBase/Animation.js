...
if (!nexacro.Animation)
{
    ...
    }(pThis, function ()
    {
        ...
        var is = {
            ...
            col: function (a) { return (is.hex(a) || is.rgb(a) || is.hsl(a) || Object.prototype.hasOwnProperty.call(nexacro._xreNamedColorList, a)); } //nexacro._xreNamedColorList.hasOwnProperty(a)); }
        };
        ...
        var easings = function ()
        {
            ...
            {
                if (Object.prototype.hasOwnProperty.call(equations, type)) //if (equations.hasOwnProperty(type))
                {
        ...
        {
            return Object.prototype.hasOwnProperty.call(nexacro._xreNamedColorList, val);//nexacro._xreNamedColorList.hasOwnProperty(val);
        }
        ...
        function getUnit(val)
        {
            ...
            var split = /([+-]?[0-9#.]+)(%|px|pt|em|rem|in|cm|mm|ex|pc|vw|vh|deg|rad|turn)?/.exec(val); ///([\+\-]?[0-9#\.]+)(%|px|pt|em|rem|in|cm|mm|ex|pc|vw|vh|deg|rad|turn)?/.exec(val);
        ...
        function anime(params)
        {
            ...
            function setAnimationsProgress(insTime)
            {
                ...
                while (i < animationsLength)
                {
                    ...
                    if(animatable.target && animatable.target._is_alive === false)
                    {
                        i++;
                        continue;
                    }
                ...
                else
                {
                    ...
                    {
                        if(Object.prototype.hasOwnProperty.call(transforms, prop)) //if (transforms.hasOwnProperty(prop))
                        {
                            transformsLength++;
                        }
                    }
            ...
            instance.equalInstance = function (instanceProp, pParams)
            {
                var temp_instance = createNewInstance(pParams);
    ...
    _pAnimation._makeParamsObject = function (isReset, offset)
    {
        ...
        for (var i = 0, n = items.length; i < n; i++)
        {
            ...
            if (item)
            {
                ...
                prop_str = item.props;
                prop_obj = nexacro._parseJsonLiteral('{' + prop_str + '}');
