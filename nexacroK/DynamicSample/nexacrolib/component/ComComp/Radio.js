...
if (!nexacro.Radio)
{
    ...
    _pRadio.on_attach_contents_handle = function (win, enablea11y)
    {
        var text_elem = this._text_elem;
        if (text_elem)
        {
    ...
    _pRadio._getDlgCode = function (keycode, altKey, ctrlKey, shiftKey)
    {
        ...
        if (keycode == nexacro.Event.KEY_DOWN || keycode == nexacro.Event.KEY_UP)
        {
            ...
            if (env?._p_enableaccessibility && (!this._isItemAccessibilityEnable() || env?._p_accessibilitycontentsearchkey))
            {
                _want_arrows = false;
            }
            else
        ...
        if (control_elem)
        {
            ...
            if (icon)
            {
                ...
                else
                {
                    ...
                    icon_size = nexacro._getImageSize_extended(iconurl, this._on_icon_onload, this) || { width: this._icon_width, height: this._icon_height };
                }
