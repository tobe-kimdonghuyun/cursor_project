 ...
 */
    ...
    */
    ...
    _pPluginElement.callMethod = function ()
    {
       ...
       if (this.handle && this._object_node)
        {
            const target = this._embed_node || this._object_node;
            const args = Array.prototype.slice.call(arguments);
            const fn_name = args.shift();
            const fn = target[fn_name];
    ...
    __pPluginObject.callMethod = function ()
    {
        ...
        //HTMLAllCollection 은 The ToBoolean abstract operation in JavaScript returns false  
        if (this.handle || this.handle !== undefined)  
        {
            ...
            {
                const pobject = new nexacro.PluginObject();
...
//	        if (this.left || this.top)
    ...
    */
    ...
    {
        if (arguments.length < 1 || !this._window)
        {
            return undefined;
        }
