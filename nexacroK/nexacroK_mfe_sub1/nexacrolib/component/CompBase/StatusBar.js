...
if (!nexacro.StatusBarControl)
{
    ...
    _pStatusBarControl._p_progressbardirection = "forward";
    _pStatusBarControl._p_progressbargap = undefined;
    _pStatusBarControl._p_progressbarsize = undefined;
    _pStatusBarControl._p_progressbarsmooth = false;
    /* internal variable */
    ...
    {
        if (this._p_progressbarsize != val)
        {
            this._p_progressbarsize = val;
    ...
    {
        if (this._p_progressbargap != val)
        {
            this._p_progressbargap = val;
    ...
    {
        if (this._p_progressbardirection != val)
        {
            this._p_progressbardirection = val;
    ...
    {
        if (this._p_progressbarsmooth != val)
        {
            this._p_progressbarsmooth = val;
    ...
    _pStatusBarControl.set_resizable = function (val)
    {
        ...
        if (this._p_resizable != val)
        {
            this._p_resizable = val;
    ...
    _pStatusBarControl._recalcLayout = function (width, height)
    {
        ...
        if (resizegrip)
        {
            ...
            if (this.resizable)
            {
                ...
                if (icon)
                {
                    var iconurl = nexacro._getURIValue(icon.value);
                    iconurl = this._getEnvironment()?._getImageLocation(iconurl, this._getRefFormBaseUrl());
                    var iconsize = nexacro._getImageSize_extended(iconurl, this._on_load_resizegripicon, this);
                    if (iconsize)
                    {
    ...
    {
        var ownerframe = this._p_parent.getOwnerFrame();
    ...
    _pStatusBarControl._properties = [{ name: "progressbardirection" }, { name: "progressbargap" }, { name: "progressbarsize" },
    { name: "progressbarsmooth" }
    ];
    nexacro._defineProperties(_pStatusBarControl, _pStatusBarControl._properties);
    _pStatusBarControl = null;
