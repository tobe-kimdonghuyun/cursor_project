...
if (!nexacro.PopupDateRangePicker)
{
    ...
    _pPopupDateRangePicker.on_attach_contents_handle = function (win, enablea11y)
    {
        // 기본작업
    ...
    {
        return nexacro.DateRangePicker.prototype.on_apply_prop_stringresource.call(this);            
    };
