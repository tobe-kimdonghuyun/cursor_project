...
if (!nexacro.TimePickerControl)
{
    ...
    _pTimePickerControl.on_attach_contents_handle = function (win, enablea11y)
    {
        if (this._ampm_control && this._is_ampm_front)
            this._ampm_control.attachHandle(win, enablea11y);
        if (this._hour_control)
            this._hour_control.attachHandle(win, enablea11y);
        if (this._delimiter1)
            this._delimiter1.attachHandle(win, enablea11y);
        if (this._min_control)
            this._min_control.attachHandle(win, enablea11y);
        if (this._delimiter2)
            this._delimiter2.attachHandle(win, enablea11y);
        if (this._sec_control)
            this._sec_control.attachHandle(win, enablea11y);
        if (this._ampm_control && !this._is_ampm_front)
            this._ampm_control.attachHandle(win, enablea11y);
    };
    ...
    _pTimePickerControl._setType = function (){};
