				...
				"class" : [
				{
					"btn_top" : 
					{
						"self" : 
						{
							...
							"focused" : 
							{
								"border" : BorderObject("2px solid lightsteelblue")
							},
							"enabled" : 
							{
								"border" : BorderObject("2px solid red")
							},
							"selected" : 
							{
								"border" : BorderObject("2px solid indigo")
							}
						}
					}
				},
				{
					"btn_left" : 
					{
						"self" : 
						{
							"mouseover" : 
							{
								"border" : BorderObject("2px solid pink")
							},
							"focused" : 
							{
								"border" : BorderObject("2px solid green")
							},
							"enabled" : 
							{
								"border" : BorderObject("2px solid black")
							},
							"selected" : 
							{
								"border" : BorderObject("2px solid gold")
							}
						}
					}
				},
				{
					"btn_work" : 
					{
						"self" : 
						{
							"mouseover" : 
							{
								"border" : BorderObject("2px solid navy")
							},
							"focused" : 
							{
								"border" : BorderObject("2px solid greenyellow")
							},
							"enabled" : 
							{
								"border" : BorderObject("2px solid blue")
							},
							"selected" : 
							{
								"border" : BorderObject("2px solid darkcyan")
							}
						}
					}
				}
