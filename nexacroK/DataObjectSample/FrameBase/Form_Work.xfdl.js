(function()
{
    const fn = function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.DataObject("dobj_post", this);
            this.addChild(obj.name, obj);


            obj = new nexacro.Dataset("ds_post", this);
            obj._setContents({"ColumnInfo" : {}});
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new nexacro.Static("stc_title","30","20","900","30",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("DataObject 오브젝트 REST API 연동 샘플 (GET https://jsonplaceholder.typicode.com/posts)");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("btn_search","30","60","140","40",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("게시글 조회");
            this.addChild(obj.name, obj);

            obj = new nexacro.Static("stc_status","190","60","700","40",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new nexacro.Grid("grd_post","30","120","1220","560",null,null,null,null,null,null,this);
