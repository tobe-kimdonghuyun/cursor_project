(function()
{
    const fn = function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.TextArea("TextArea00","791","12","308","74",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            this.addChild(obj.name, obj);
        ...
        this.btn_showmodal_onclick = function(obj,e)
        {
        	...
        	.then((result1) => {
        	  ...
        	  this.TextArea00.insertText("showmodal :" +result1.arg);
        		...
        		this.TextArea00.insertText("Failed to open popup promise_open_test1 : " + err.message + " return = " + ret1);
        	});
        };
