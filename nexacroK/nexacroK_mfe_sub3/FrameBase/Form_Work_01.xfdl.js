(function()
{
    const fn = function(nexacro, system, trace, environment, application)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Button("Button00","212","346","369","70",null,null,null,null,null,null,this);
            obj.set_taborder("12");
        ...
        // User Script
        this.registerScript("Form_Work_01.xfdl", function(nexacro, system, trace, environment, application) {
        ...
        this.loadIncludeScript("Form_Work_01.xfdl");
...
//# sourceMappingURL=Form_Work_01.xfdl.js.map
