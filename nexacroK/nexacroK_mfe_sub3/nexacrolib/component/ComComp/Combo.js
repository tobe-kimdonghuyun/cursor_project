...
if (!nexacro.Combo)
{
    ...
    _pCombo.on_attach_contents_handle = function (win, enablea11y)
    {
        if (this._p_comboedit)
        {
            this._p_comboedit.attachHandle(win, enablea11y);
    ...
    _pCombo._getDlgCode = function (keycode, altKey, ctrlKey, shiftKey)
    {
        ...
        if ((keycode == nexacro.Event.KEY_UP || keycode == nexacro.Event.KEY_DOWN))
        {
            ...
            else
            {
                ...
                if (env) 
                    _want_arrows = !env._p_enableaccessibility || !env._p_accessibilitycontentsearchkey;
                _want_arrows = _want_arrows || ctrlKey;
            }
        }
            ...
            switch (type)
            {
                ...
                case "caseisearch":
                    ...
                    if (this._p_type == "caseisearch")
                    {
                        ...
                        parse_val = nexacro._escapeWhitespace(parse_val);
