(function()
{
    const fn = function(nexacro, system, trace, environment, application)  
	{
        ...
        this.on_initApplication = function()
        {
            ...
            mainframe.set_hotkey("ALT+SHIFT+P");
        ...
        this.on_initEvent = function()
        {
            ...
            this.mainframe?.addEventHandler("ondeactivate",this.mainframe_ondeactivate,this);
        };
        
        // script Compiler
        this.registerScript("Application_Desktop.xadl", function(nexacro, system, trace, environment, application) {

        this.mainframe_ondeactivate = function(obj,e)
        {
        	trace("nexacroK_mfe_sub3 mainframe_ondeactivate");
        };

        this.mainframe_onactivate = function(obj,e)
        {
        	trace("nexacroK_mfe_sub3 mainframe_onactivate");
        };
...
//# sourceMappingURL=Application_Desktop.xadl.js.map
