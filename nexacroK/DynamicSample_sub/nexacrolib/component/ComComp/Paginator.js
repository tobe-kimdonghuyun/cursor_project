...
if (!nexacro.Paginator)
{
    ...
    _pPaginator._navibuttongap = undefined;
    _pPaginator._pagebuttongap = undefined;
    _pPaginator._outsidegap = undefined;
    ...
    _pPaginator.on_attach_contents_handle = function (win, enablea11y)
    {
        if (this._prevButton)
            this._prevButton.on_created(win);
        if (this._firstButton)
        ...
        for (var i = 0; i < this._page_slots.length; i++)
        {
            this._page_slots[i].button.attachHandle(win, enablea11y);
        }
    ...
    {
        if (!nexacro._isEmRemUnit(v) && (isNaN(v = +v) || v < 0))
        {
            return;
        }
    ...
    _pPaginator._getNavibuttongap = function () { return (this._navibuttongap !== undefined) ? this._navibuttongap : this._p_navibuttongap; };

    _pPaginator.on_apply_navibuttongap = function (/*v*/)
    {
        this._navibuttongap = nexacro._isEmRemUnit(this._p_navibuttongap) ? this._resolveEmPx(this._p_navibuttongap) : undefined;
        this._recalcLayout();
    };
    ...
    _pPaginator._getPagebuttongap = function () { return (this._pagebuttongap !== undefined) ? this._pagebuttongap : this._p_pagebuttongap; };

    _pPaginator.on_apply_pagebuttongap = function (/*v*/)
    {
        this._pagebuttongap = nexacro._isEmRemUnit(this._p_pagebuttongap) ? this._resolveEmPx(this._p_pagebuttongap) : undefined;
        this._recalcLayout();
    };
    ...
    _pPaginator._getOutsidegap = function () { return (this._outsidegap !== undefined) ? this._outsidegap : this._p_outsidegap; };

    _pPaginator.on_apply_outsidegap = function (/*v*/)
    {
        this._outsidegap = nexacro._isEmRemUnit(this._p_outsidegap) ? this._resolveEmPx(this._p_outsidegap) : undefined;
        this._recalcLayout();
    };

    _pPaginator.on_apply_font = function (font)
    {
        nexacro.Component.prototype.on_apply_font.call(this, font);
        this._reapplyRemValues();
    };

    _pPaginator._reapplyRemValues = function ()
    {
        if (!this._isEnableRedraw()) return;
        var v;
        v = this._p_navibuttongap;
        if (nexacro._isEmRemUnit(v))
            this.on_apply_navibuttongap();
        v = this._p_pagebuttongap;
        if (nexacro._isEmRemUnit(v))
            this.on_apply_pagebuttongap();
        v = this._p_outsidegap;
        if (nexacro._isEmRemUnit(v))
            this.on_apply_outsidegap();
    };
    ...
    _pPaginator._recalcLayout = function (moving_calc, resize_calc, recursive)
    {
        ...
        if (!moving_calc && !resize_calc)
        {
            for (var i = 0; i < this._page_slots.length; i++)
            {
                this._page_slots[i].spacing = this._getPagebuttongap();
        ...
        var left = this._getOutsidegap();
        var right = this._adjust_width - this._getOutsidegap();
        ...
        if (!moving_calc)
        {
            if (this._p_showfirstlastbutton)
            {
                ...
                left += (nw + this._getNavibuttongap());
