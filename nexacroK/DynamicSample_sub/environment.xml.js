...
{ 	
    if (nexacro.Environment)
    {
        ...
        {
            return [
            {"id":"Desktop_screen","type":"desktop","themeid":"theme::blue","initvaluefileid":"initvalue::test.xiv","xadl":"Application_Desktop.xadl.js"}
            ];
        };
        ...
        {
            this.set_appkey("DynamicSample_sub");
        ...
        env.loadTypeDefinition = function ()
        {
            ...
            this._addService("VisibleComp", "form", "./VisibleComp/", "session", null, "", "0", "0");
            this._addService("InvisibleComp", "form", "./InvisibleComp/", "session", null, "", "0", "0");
