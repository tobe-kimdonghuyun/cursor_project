...
if (!nexacro.FileUpTransfer)
{
	...
	_pFileUpTransfer.upload = function (strUrl, strReturnType)
	{
		...
		if (env)
		{
			...
			//if (!strUrl)
			//	return;
			httpvariables = env._getHttpVariableAll();
		}
		this._response_headers = undefined;
		var isPromise = (strReturnType === "promise") ? true : false;
		return nexacro._uploadTransfer(this._p_filelist, this._p_postdatalist, httpvariables, strUrl, -1, this, isPromise);
	};
