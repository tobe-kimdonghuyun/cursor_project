...
if (!nexacro.ScrollBarControl)
{
    ...
    _pScrollBar.on_create_contents = function ()
    {
        ...
        if (control_elem)
        {
            ...
            if (!this._isAllowDefaultPinchZoom())
    ...
    _pScrollBar.on_attach_contents_handle = function (win, enablea11y)
    {
        if (this._p_decbutton)
        {
            this._p_decbutton.attachHandle(win, enablea11y);
        }
        if (this._p_trackbar)
        {
            this._p_trackbar.attachHandle(win, enablea11y);
        }
        if (this._p_incbutton)
        {
            this._p_incbutton.attachHandle(win, enablea11y);
        }
    };
...
if (!nexacro.ScrollIndicatorControl)
{
    ...
    _pScrollIndicatorControl.on_attach_contents_handle = function (win, enablea11y)
    {
        if (this._p_trackbar)
        {
            this._p_trackbar.attachHandle(win, enablea11y);
...
if (!nexacro.SpinBarControl)
{
    ...
    _pSpinBarControl.on_attach_contents_handle = function (win, enablea11y)
    {
        if (this._p_decbutton)
        {
            this._p_decbutton.attachHandle(win, enablea11y);
