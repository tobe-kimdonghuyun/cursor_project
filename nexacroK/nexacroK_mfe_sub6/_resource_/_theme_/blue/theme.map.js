				...
				"class" : [
				{
					"chb_top" : 
					{
						"self" : 
						{
							"mouseover" : 
							{
								"border" : BorderObject("2px solid #ffd700")
							},
							"focused" : 
							{
								"border" : BorderObject("2px solid #ff4500")
							},
							"enabled" : 
							{
								"border" : BorderObject("2px solid #ff8c00")
							}
						}
					}
				},
				{
					"chb_left" : 
					{
						"self" : 
						{
							"mouseover" : 
							{
								"border" : BorderObject("2px solid #da70d6")
							},
							"focused" : 
							{
								"border" : BorderObject("2px solid #9400d3")
							},
							"enabled" : 
							{
								"border" : BorderObject("2px solid #8b008b")
							}
						}
					}
				},
				{
					"chb_work" : 
					{
						"self" : 
						{
							"mouseover" : 
							{
								"border" : BorderObject("2px solid #00fa9a")
							},
							"focused" : 
							{
								"border" : BorderObject("2px solid #32cd32")
							},
							"enabled" : 
							{
								"border" : BorderObject("2px solid #228b22")
							}
						}
					}
				}
