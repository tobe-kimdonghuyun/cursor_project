(function()
{
    const fn = function(nexacro, system, trace, environment, application)
    {
        ...
        // User Script
        this.registerScript("hotkey_sub6.xfdl", function(nexacro, system, trace, environment, application) {
        ...
        this.loadIncludeScript("hotkey_sub6.xfdl");
...
//# sourceMappingURL=hotkey_sub6.xfdl.js.map
