...
if (!nexacro.DesignForm)
{
  ...
  //  	trace("DesignForm.showPreviewContents:" + compid);
    ...
    _pDesignForm._restoreSubLayoutPosition = function (obj)
    {
        ...
        // [RP: 105114] 2026/05/21 오상민(smoh) : 변경한 Div의 Width, Height 값이 이전 값으로 되돌아 가는 현상
        var width = (obj._b_width != null) ? obj._p_width : obj._b_width;
        var height = (obj._b_height != null) ? obj._p_height : obj._b_height;
        obj.move(obj._b_left, obj._b_top, width, height, obj._b_right, obj._b_bottom);
