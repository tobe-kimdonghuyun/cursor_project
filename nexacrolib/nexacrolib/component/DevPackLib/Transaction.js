		...
		switch(errorCode)
		{
			...
			case -999999999 :
				if (objSvcID.silent != "Y")
				{
					...
					// TODO 로그인세션 만료시 기존 링크 페이지로 되돌리기 구현 필요
...
pForm.gfnGetCommonCode = function()
{
	this.gfnTransaction(
		'searchCommonCode_'+Date.now(),
		'strSvcUrl',
		'inData',
		'outData',
		'arguments',
		'gfnCommonCodeCallback'
	)
}

pForm.gfnCommonCodeCallback = function()
{

}

pForm.gfnSessionCheck = function()
{
	var strSvcUrl   = "cmns/login/loginChk.do";
	var inData      = "gdsUserInfo=gdsUserInfo";
	var outData     = "gdsUserInfo=gdsUserInfo gdsCount=gdsCount";
