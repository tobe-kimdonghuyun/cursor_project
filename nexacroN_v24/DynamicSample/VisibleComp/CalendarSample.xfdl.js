(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_normal","10","74","160","32",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("일반(팝업) Calendar");
            this.addChild(obj.name, obj);

            obj = new Button("btn_spin","180","74","130","32",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("스핀 Calendar");
            this.addChild(obj.name, obj);

            obj = new Button("btn_clear","320","74","90","32",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("전체 삭제");
            this.addChild(obj.name, obj);

            obj = new Static("stc_count","424","80","120","22",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("생성 수: 0");
            obj.getSetter("forecolor").set("#1a56db");
            this.addChild(obj.name, obj);
        ...
        {
            this.addEventHandler("onload",this.CalendarSample_onload,this);
