(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_create","10","74","100","32",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Tab 생성");
            this.addChild(obj.name, obj);

            obj = new Button("btn_addPage","120","74","120","32",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("탭 페이지 추가");
            this.addChild(obj.name, obj);

            obj = new Button("btn_delPage","250","74","120","32",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("탭 페이지 삭제");
            this.addChild(obj.name, obj);

            obj = new Button("btn_clear","380","74","90","32",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("Tab 삭제");
            this.addChild(obj.name, obj);

            obj = new Static("stc_result","484","80","760","22",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("");
            obj.getSetter("forecolor").set("#cc0000");
            this.addChild(obj.name, obj);

            obj = new Div("div_area","10","116","1250","534",null,null,null,null,null,null,this);
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("TabSample.xfdl", function() {
        ...
        {
            this.addEventHandler("onload",this.TabSample_onload,this);
