(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_create","10","74","150","32",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Grid+Dataset 생성");
            this.addChild(obj.name, obj);

            obj = new Button("btn_addRow","170","74","90","32",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("행 추가");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("GridSample.xfdl", function() {
        ...
        {
            this.addEventHandler("onload",this.GridSample_onload,this);
