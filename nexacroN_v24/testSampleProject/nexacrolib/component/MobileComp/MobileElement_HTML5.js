...
if (nexacro._Browser != "Runtime" && !nexacro.FlexibleControlElement)
{
    ...
    _pSimpleInputElement.createCommand = function ()
    {
        ...
        if (owner_elem && !this._created)
        {
            ...
            {
                if (nexacro._enableaccessibility != true || nexacro._accessibilitytype != 5 || (this.owner_elem.linkedcontrol && !(this.owner_elem.linkedcontrol instanceof nexacro.MaskEdit)))
    ...
    */
    _pSimpleInputElement.attachHandle = function (win)
    {
        if (this.name && !this.handle)
        {
            ...
            if (this._use_accessibility_label && nexacro._enableaccessibility)
    ...
    */
    ...
    _pSimpleTextAreaElement._createElementHandle = function (owner_elem, _doc)
    {
...
{
    delete _process;
    delete _pMobileElement;
    delete _pFlexibleControlElement;
    delete _pSimpleInputElement;
    delete _pSimpleTextAreaElement;
}
