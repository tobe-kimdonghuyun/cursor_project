...
if (!nexacro.DateRangePicker)
{
    ...
    delete _pRangeDateChangedEventInfo;
...
//                else
    ...
    _pDatePickerGroup._animateScroll = function (kind, chk_alldate, no_ani, is_popup_act)
    {
        ...
        {
            var aniframe = new nexacro.AnimationFrame(this, animate);
            aniframe.start();
    ...
    _pDatePickerGroup._updateRangeDate = function ()
    {
        ...
        for (var i = 0; i < list.length; i++)
        {
            ...
            if (!pos)
                continue;// nexacro._traceV8CallStack(true);
...
//      var enableaccessibility = nexacro._enableaccessibility;
    ...
    _pDatePickerControlEx.set_overlaybackground = function ()
    {
    ...
    delete _pDateRangePickerDayClickEventInfo;
    delete _pDateRangePicker;
    delete _pPickerHeadLineControl;
    delete _pTimePickerGroup;
    delete _pDatePickerGroup;
    delete _pPickerGroup;
    delete _pDatePickerControlEx;
    delete _pDatePickerSplitLine;
    delete _pRangeSelectionControl;
};