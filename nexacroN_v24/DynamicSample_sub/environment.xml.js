if (nexacro.Environment)
{
    ...
    env.on_init = function ()
    {
        ...
        this.getSetter("appkey").set("DynamicSample_sub");
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("VisibleComp", "form", "./VisibleComp/", "session", null, "", "0", "0");
        nexacro._addService("InvisibleComp", "form", "./InvisibleComp/", "session", null, "", "0", "0");
