(function()
{
    return function()
    {
        ...
        {
            this.set_name("TextAreaSample_sub");
            ...
            obj = new Button("btn_create","10","74","120","32",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("TextArea 생성");
            this.addChild(obj.name, obj);

            obj = new Button("btn_getValue","140","74","90","32",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("값 읽기");
            this.addChild(obj.name, obj);

            obj = new Button("btn_clear","240","74","90","32",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("전체 삭제");
            this.addChild(obj.name, obj);

            obj = new Static("stc_count","344","80","120","22",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("생성 수: 0");
            obj.set_color("#1a56db");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("TextAreaSample.xfdl", function() {

        // this.nTxaCount (Form 속성) 으로 관리 — var 클로저 변수 사용 금지

        this.TextAreaSample_sub_onload = function(obj, e)
        {
            this.nTxaCount = 0;
        };
        ...
        {
            this.addEventHandler("onload",this.TextAreaSample_sub_onload,this);
