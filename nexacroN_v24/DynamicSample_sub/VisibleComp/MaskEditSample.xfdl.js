(function()
{
    return function()
    {
        ...
        {
            this.set_name("MaskEditSample_sub");
            ...
            obj = new Button("btn_getValue","170","74","90","32",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("값 읽기");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stc_result","374","80","880","22",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("");
        ...
        // User Script
        this.registerScript("MaskEditSample.xfdl", function() {
        ...
        {
            this.addEventHandler("onload",this.MaskEditSample_sub_onload,this);
