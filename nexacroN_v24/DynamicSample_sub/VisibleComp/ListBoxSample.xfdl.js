(function()
{
    return function()
    {
        ...
        {
            this.set_name("ListBoxSample_sub");
            ...
            obj = new Button("btn_getValue","140","74","110","32",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("선택값 확인");
            this.addChild(obj.name, obj);

            obj = new Button("btn_clear","260","74","90","32",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("전체 삭제");
            this.addChild(obj.name, obj);

            obj = new Static("stc_count","364","80","120","22",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("생성 수: 0");
            obj.set_color("#1a56db");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("ListBoxSample.xfdl", function() {
        ...
        this.ListBoxSample_sub_onload = function(obj, e)
        {
            this.nLstCount = 0;
        };
        ...
        {
            this.addEventHandler("onload",this.ListBoxSample_sub_onload,this);
