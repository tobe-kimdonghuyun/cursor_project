(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_search","180","96","130","32",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("조회 (await)");
            this.addChild(obj.name, obj);

            obj = new Button("btn_clear","320","96","80","32",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("초기화");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("TransactionSample02.xfdl", function() {
