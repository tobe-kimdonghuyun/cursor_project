(function()
{
    return function()
    {
        ...
        {
            this.set_name("CheckBoxSample_sub");
            ...
            obj = new Button("btn_create","10","74","130","32",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("CheckBox 생성");
            this.addChild(obj.name, obj);

            obj = new Button("btn_getValue","150","74","110","32",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("선택값 확인");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("CheckBoxSample.xfdl", function() {
        ...
        this.CheckBoxSample_sub_onload = function(obj, e)
        {
            this.nChkCount = 0;
        };
        ...
        {
            this.addEventHandler("onload",this.CheckBoxSample_sub_onload,this);
