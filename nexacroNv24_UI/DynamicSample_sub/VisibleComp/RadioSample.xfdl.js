(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_create_h","10","74","160","32",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("가로배치 Radio 생성");
            this.addChild(obj.name, obj);

            obj = new Button("btn_create_v","180","74","160","32",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("세로배치 Radio 생성");
            this.addChild(obj.name, obj);

            obj = new Button("btn_getValue","350","74","110","32",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("선택값 확인");
            this.addChild(obj.name, obj);

            obj = new Button("btn_clear","470","74","90","32",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("전체 삭제");
            this.addChild(obj.name, obj);

            obj = new Static("stc_count","574","80","120","22",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("생성 수: 0");
            obj.set_color("#1a56db");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("Button00","633","190","120","50",null,null,null,null,null,null,this.div_area.form);
            obj.set_taborder("0");
            obj.set_text("Button00");
            this.div_area.addChild(obj.name, obj);

            obj = new Radio("Radio00","717","149","280","50",null,null,null,null,null,null,this);
            obj.set_taborder("10");
        ...
        // User Script
        this.registerScript("RadioSample.xfdl", function() {

        // this.nRadCount (Form 속성) 으로 관리 — var 클로저 변수 사용 금지

        this.RadioSample_sub_onload = function(obj, e)
        {
            this.nRadCount = 0;
        };
        ...
        {
            this.addEventHandler("onload",this.RadioSample_sub_onload,this);
