...
if (!nexacro.GridFormat)
{
    ...
    nexacro.GridCellInfo = function (id, band, grid, type, idx)
    {
        ...
        // accessibility prop
        this._p_accessibilityrole = (band && band._type == "head") ? "columnheader" : "gridcell"; // for table acc
    };
    ...
    _pGridCellInfo._query_status_background_of_subcell = function (rowidx, userstatus, parent_cellinfo, bExport)
    {
        return this._grid._getCellStyleInfo(this._cellidx, "background", rowidx, userstatus == "selected", parent_cellinfo, null, bExport);
    };
    ...
    {
        return this._getAttrValue(this._p_suppress, rowidx);
    };
