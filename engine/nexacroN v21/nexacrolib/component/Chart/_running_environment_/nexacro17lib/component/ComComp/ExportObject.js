...
if (!nexacro.ExcelExportObject)
{
    ...
    _pExcelExport.addExportItem = function (type, item/*, range*/)
    {
        ...
        var orgvalue_cells = [];
        var orgvalue_param_idx = arguments.length - 1; // function 마지막 param 추가시 조절필요
            ...
            for (k = 0; k < partRowCount; k++)
            {
                ...
                for (j = 0; j < bodycntcell; j++)
                {
                    ...
                    */
                    ...
                    /* style name & value seperate using chrcode */
                    var delimiter;
                    if (exportObj._commdataformat == 3)
                    {
                        // csv 구문자를 회피하기 위한 합의된 문자열
