...
if (!nexacro.TextArea)
{
    ...
    _pTextArea._onRecalcScrollSize = function ()
    {
        ...
        if (control_elem && input_elem)
        {
            ...
            var size = input_elem.getElementContentSize();
    ...
    {
        var want_arrow = true;
        var is_readonly = this.readonly;
        var is_enable = this.enable;
        ...
        if (keycode >= nexacro.Event.KEY_LEFT && keycode <= nexacro.Event.KEY_DOWN)
        {
            if (!this._onlydisplay)
			{
				...
				else 
                {
					...
					var accessibility_legacykey = nexacro._enableaccessibility && nexacro._accessibilitycontentsearchkey;

					var vscrollbar = (this.scrolltype != "none" && this.scrolltype != "horizontal") ? this.vscrollbar : null;
					var hscrollbar = (this.scrolltype != "none" && this.scrolltype != "vertical") ? this.hscrollbar : null;
