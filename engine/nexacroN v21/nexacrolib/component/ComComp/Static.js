    ...
    _pIconText._on_getFitSize = function ()
    {
        ...
        if (control_elem)
        {
            ...
            if (text)
            {
                ...
                {
                    // multiline 아닌경우, wordwrap 적용하여 반영
                    if (!multiline)
                    {
...
if (!nexacro.Static)
{
    ...
    _pStatic._apply_setTagfocus = function ()
    {
        if (this._linkCount < 1)
            return;
        var cell_elem = this._cell_elem;
    ...
    _pStatic.on_apply_text = function (text)
    {
        ...
        if (cell_elem && this.fittocontents != "none")
        {
            this._update_position();
        }
    };
