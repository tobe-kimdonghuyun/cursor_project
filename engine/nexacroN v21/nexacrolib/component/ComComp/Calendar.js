...
if (!nexacro.Calendar)
{
	...
	_pCalendar.on_created_contents = function (win)
	{
		...
		{
			this.calendaredit.on_apply_usesoftkeyboard();
		}
	...
	_pCalendar.set_restoreonblur = function(v)
	{
		...
		if(this._real_restoreonblur != v || this.restoreonblur != v)
		{
			this.restoreonblur = v;
	...
	_pCalendar.on_apply_usesoftkeyboard = function ()
	{
		if (this.calendaredit)
		{
			this.calendaredit.set_usesoftkeyboard(this._getUseSoftKeyboardValue(this._initsoftkeyboard));
		}
	};
	...
	_pCalendar._setFocusToNextComponent = function ()
	{
		...
		{
			next_comp.setFocus();
			if (!next_comp.autoselect && next_comp._isEditableComponent())
