...
if (!nexacro.Spin)
{
    ...
    _pSpin.on_created_contents = function ()
    {
        ...
        if (this.spinedit)
        {
            this.spinedit.on_apply_usesoftkeyboard();
        }
    ...
    _pSpin.on_apply_usesoftkeyboard = function ()
    {
        if (this.spinedit)
        {
            this.spinedit.set_usesoftkeyboard(this._getUseSoftKeyboardValue(this._initsoftkeyboard));
        }
    };
	...
	_pSpinEditControl._apply_setfocus = function (evt_name)
	{
	    ...
	    if (input_elem)
	    {
	        ...
	        if (!this._onlydisplay)
            {
                //��ũ������(Sense Reader, NVDA, JAWS)�� ���������� ����Ű �̵��� ���� aria-label�� ������� �ʾ� aria-live�� ���� ����� �����ϵ��� ����
