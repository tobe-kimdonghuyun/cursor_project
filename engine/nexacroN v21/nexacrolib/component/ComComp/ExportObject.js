...
if (!nexacro.ExcelExportObject)
{
    ...
    _pExcelExport.commdataformat = "SSV";
    ...
    _pExcelExport.commandversion = "1.0";
  ...
  //      }
    ...
    _pExcelExport.exportData = function (argsParam, argsDsParam, nOrgValueType, bFileDownload)
    {
        ...
        if (this._commdataformat == 0 || (this.commandversion != "1.0" && this._commdataformat == 3)) //xml or json(commandversion 1.0)
        {
	...
	{
		if (cellindex != this.valuetypecellindex)
		{
			this.valuetypecellindex = cellindex;
	...
	{
		if (bandid != this.valuetypebandid)
		{
			this.valuetypebandid = bandid;
    ...
    _pExportItem._makeforDsStyle = function (ds_style, align, background, color, font, line, cell_type, row_merge, col_merge)
    {
        ...
        var delimiter = this.parent ? this.parent._commdatadelimiter : String.fromCharCode(29);
    ...
    _pExportItem._modifyFormat = function (cell, style1, style2, rowidx, mainCell, virtual_merge_value)
    {
        ...
        if (rowidx < 0)
        {
            ...
            {
                var maskeditpostfixtext = cell._getAttrValue(cell.maskeditpostfixtext, rowidx);
    ...
    _pExportItem._gridExportContinue = function (exportObj)
    {
        ...
        ds_command.setColumn(0, "commandversion", exportObj.commandversion);
                    ...
                    */
                    ...
                    if (cell._subcells.length)
                    {
                        ...
                        for (var i = 0; i < subL; i++)
                        {
                            ...
                            if (exportObj.commandversion == "1.0")
                                ds.setColumn(idx, "Column" + (j + subcnt), val + delimiter + style_name);
                            else if (exportObj.commandversion == "2.0")
