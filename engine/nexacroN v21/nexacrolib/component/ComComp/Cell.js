...
if (!nexacro._CellControl)
{
    ...
    _pCellEdit.accessibilityrole = "gridcell";
    ...
    _pCellEdit._setProperty = function (onlycontrolprop)
    {
        ...
        if (this._view)
        {
             var usesoftkeyboard = this._view._initsoftkeyboard;
             this.set_usesoftkeyboard(this._view._getUseSoftKeyboardValue(usesoftkeyboard));
        }
    ...
    _pCellCalendar._setProperty = function (onlycontrolprop)
    {
        ...
        if (view)
        {
             var usesoftkeyboard = view._initsoftkeyboard;
             this.set_usesoftkeyboard(view._getUseSoftKeyboardValue(usesoftkeyboard));
        }
