...
if (!nexacro.InputEventInfo)
{
    ...
    nexacro._EditInputType.MAP = {
        ...
        , ambiguous: "\\u00a1" + //INVERTED EXCLAMATION MARK
            ...
            "\\u00bc-\\u00be" + // VULGAR FRACTION ONE QUARTER..VULGAR
            "\\u00c6" + // LATIN CAPITAL LETTER AE
            "\\u00d0" + // LATIN CAPITAL LETTER ETH
            "\\u00d7-\\u00d8" + // MULTIPLICATION SIGN
            "\\u00de-\\u00e1" + // LATIN CAPITAL LETTER THORN..LATIN 
            "\\u00e6" + // LATIN CAPITAL LETTER THORN..LATIN 
            "\\u00e8-\\u00ea" + // LATIN CAPITAL LETTER THORN..LATIN 
            "\\u00ec-\\u00ed" + // LATIN SMALL LETTER I WITH 
            "\\u00ec-\\u00ed" + // LATIN SMALL LETTER I WITH 
            "\\u00f0" + // LATIN CAPITAL LETTER THORN..LATIN 
            "\\u00f2-\\u00f3" + // LATIN SMALL LETTER I WITH 
            "\\u00f7" + // LATIN CAPITAL LETTER THORN..LATIN 
            "\\u00f8-\\u00fa" + // LATIN SMALL LETTER O WITH STROKE..LATIN SMALL LETTER U WITH ACUTE
            "\\u00fc" + // LATIN CAPITAL LETTER THORN..LATIN 
            "\\u00fe" + // LATIN CAPITAL LETTER THORN..LATIN 
            "\\u0101" + // LATIN CAPITAL LETTER THORN..LATIN 
            "\\u0111" + // LATIN CAPITAL LETTER THORN..LATIN 
            "\\u0113" + // LATIN CAPITAL LETTER THORN..LATIN 
            "\\u011b" + // LATIN CAPITAL LETTER THORN..LATIN 
            "\\u0126-\\u0127" + // LATIN SMALL LETTER O WITH STROKE..LATIN SMALL LETTER U WITH ACUTE
            "\\u012b" + // LATIN CAPITAL LETTER THORN..LATIN 
            "\\u0131-\\u0133" + // [3] LATIN SMALL LETTER DOTLESS I..LATIN 
            "\\u0138" + // [3] LATIN SMALL LETTER DOTLESS I..LATIN 
            "\\u013f-\\u0142" + // [3] LATIN SMALL LETTER DOTLESS I..LATIN 
            "\\u0144" + // [3] LATIN SMALL LETTER DOTLESS I..LATIN 
            "\\u0148-\\u014b" + // [3] LATIN SMALL LETTER DOTLESS I..LATIN 
            "\\u014d" + // [3] LATIN SMALL LETTER DOTLESS I..LATIN 
            "\\u0152-\\u0153" + // [3] LATIN SMALL LETTER DOTLESS I..LATIN 
            "\\u0166-\\u0167" + // [3] LATIN SMALL LETTER DOTLESS I..LATIN 
            "\\u016b" + // [3] LATIN SMALL LETTER DOTLESS I..LATIN 
            "\\u01CE" + // LATIN SMALL LETTER A WITH CARON
            "\\u01d0" + // LATIN SMALL LETTER A WITH CARON
            "\\u01d2" + // LATIN SMALL LETTER A WITH CARON
            "\\u01d4" + // LATIN SMALL LETTER A WITH CARON
            "\\u01d6" + // LATIN SMALL LETTER A WITH CARON
            "\\u01d8" + // LATIN SMALL LETTER A WITH CARON
            "\\u01da" + // LATIN SMALL LETTER A WITH CARON
            "\\u01dc" + // LATIN SMALL LETTER A WITH CARON
            "\\u0251" + // LATIN SMALL LETTER A WITH CARON
            "\\u0261" + // LATIN SMALL LETTER A WITH CARON
            "\\u02c4" + // MODIFIER LETTER UP ARROWHEAD
            "\\u02c7" + // CARON
            "\\u02C9-\\u02CB" + //[17] GREEK CAPITAL LETTER ALPHA..GREEK 
            "\\u02cd" + // CARON
            "\\u02d0" + // CARON
            "\\u02d8-\\u02db" + //[4] BREVE..OGONEK
            "\\u02dd" + // DOUBLE ACUTE ACCENT
            ...
            "\\u0300-\\u036f" + //[4] BREVE..OGONEK                       
            //...
            "\\u0391-\\u03a1" + //[17] GREEK CAPITAL LETTER ALPHA..GREEK 
            "\\u03a3-\\u03a9" + //[7] GREEK CAPITAL LETTER SIGMA..GREEK 
            "\\u03b1-\\u03c1" + //[7] GREEK CAPITAL LETTER SIGMA..GREEK 
            "\\u03c3-\\u03c9" + //[7] GREEK CAPITAL LETTER SIGMA..GREEK 
            "\\u0401" + // CYRILLIC CAPITAL LETTER IO
            "\\u0410-\\u044f" + //[7] GREEK CAPITAL LETTER SIGMA..GREEK 
            "\\u0451" + // CYRILLIC CAPITAL LETTER IO
            "\\u2010" + // HYPHEN
            "\\u2013-\\u2015" + //[7] GREEK CAPITAL LETTER SIGMA..GREEK 
            "\\u2016" + // DOUBLE VERTICAL LINE
            "\\u2018-\\u2019" + // RIGHT SINGLE QUOTATION MARK
            "\\u201c" + // LEFT DOUBLE QUOTATION MARK
            "\\u201d" + // RIGHT DOUBLE QUOTATION MARK
            "\\u2020-\\u2022" + // RIGHT DOUBLE QUOTATION MARK
            "\\u2024-\\u2027" + // [4] ONE DOT LEADER..HYPHENATION POINT
            "\\u2030" + // RIGHT DOUBLE QUOTATION MARK
            "\\u2032-\\u2033" + // [4] ONE DOT LEADER..HYPHENATION POINT
            "\\u2035" + // RIGHT DOUBLE QUOTATION MARK
            "\\u203b" + // RIGHT DOUBLE QUOTATION MARK
            "\\u203e" + // RIGHT DOUBLE QUOTATION MARK
            "\\u2074" + // RIGHT DOUBLE QUOTATION MARK
            "\\u207f" + // RIGHT DOUBLE QUOTATION MARK
            "\\u2081-\\u2084" + // [4] ONE DOT LEADER..HYPHENATION POINT
            "\\u20ac" + // RIGHT DOUBLE QUOTATION MARK
            "\\u2103" + // RIGHT DOUBLE QUOTATION MARK
            "\\u2105" + // RIGHT DOUBLE QUOTATION MARK
            "\\u2109" + // RIGHT DOUBLE QUOTATION MARK
            "\\u2113" + // RIGHT DOUBLE QUOTATION MARK
            "\\u2116" + // RIGHT DOUBLE QUOTATION MARK
            "\\u2121-\\u2122" + //[21] NEGATIVE CIRCLED NUMBER ELEVEN..NEGATIVE CIRCLED DIGIT ZERO
            "\\u2126" + // RIGHT DOUBLE QUOTATION MARK
            "\\u212b" + // RIGHT DOUBLE QUOTATION MARK
            "\\u2153-\\u2154" + //[21] NEGATIVE CIRCLED NUMBER ELEVEN..NEGATIVE CIRCLED DIGIT ZERO
            "\\u215b-\\u215e" + //[4] VULGAR FRACTION ONE EIGHTH..VULGAR FRACTION SEVEN EIGHTHS
            "\\u2160-\\u216b" + //[12] ROMAN NUMERAL ONE..ROMAN NUMERAL TWELVE
            "\\u2170-\\u2179" + //[10] SMALL ROMAN NUMERAL ONE..SMALL ROMAN NUMERAL TEN
            "\\u2189" + //VULGAR FRACTION ZERO THIRDS
            "\\u2190-\\u2199" + //[5] LEFTWARDS ARROW..LEFT RIGHT ARROW
            "\\u21b8-\\u21b9" + //[5] LEFTWARDS ARROW..LEFT RIGHT ARROW
            ...
            "\\u2215" + //DIVISION SLASH    
            "\\u221a" + //SQUARE ROOT
            "\\u221d-\\u2220" + //[4] PROPORTIONAL TO..ANGLE
            "\\u2223" + //DIVIDES
            "\\u2225" + //PARALLEL TO
            "\\u2227-\\u222C" + //[6] LOGICAL AND..DOUBLE INTEGRAL
            "\\u222E" + //CONTOUR INTEGRAL
            "\\u2234-\\u2237" + //[6] LOGICAL AND..DOUBLE INTEGRAL
            "\\u223C-\\u223D" + //[6] LOGICAL AND..DOUBLE INTEGRAL
            "\\u2248" + //CONTOUR INTEGRAL
            ...
            "\\u22bf" + //RIGHT TRIANGLE
            "\\u2312" + //ARC
            "\\u2460-\\u24e9" + //CIRCLED DIGIT ONE..NUMBER TWENTY FULL STOP
            "\\u24eb-\\u254b" + //[21] NEGATIVE CIRCLED NUMBER ELEVEN..NEGATIVE CIRCLED DIGIT ZERO
            "\\u2550-\\u2573" + //[36] BOX DRAWINGS DOUBLE HORIZONTAL..BOX DRAWINGS LIGHT DIAGONAL CROSS

            "\\u2580-\\u258f" + //16] UPPER HALF BLOCK..LEFT ONE EIGHTH BLOCK
            "\\u2592-\\u2595" + //[4] MEDIUM SHADE..RIGHT ONE EIGHTH BLOCK
            "\\u25a0-\\u25a1" + //[2] BLACK SQUARE..WHITE SQUARE
            "\\u25a3-\\u25a9" + //[7] WHITE SQUARE CONTAINING BLACK SMALL 
            "\\u25b2-\\u25b3" + //[2] BLACK UP-POINTING TRIANGLE..WHITE UP-POINTING TRIANGLE
            "\\u25b6-\\u25b7" + //16] BLACK RIGHT-POINTING TRIANGLE
            "\\u25bc-\\u25bd" + //16] BLACK RIGHT-POINTING TRIANGLE
            "\\u25c0-\\u25c1" + //BLACK LEFT-POINTING TRIANGLE
            "\\u25c6-\\u25c8" + //[3] BLACK DIAMOND..WHITE DIAMOND CONTAINING BLACK SMALL DIAMOND

            "\\u25cb" + //WHITE CIRCLE
            "\\u25ce-\\u25d1" + //[4] BULLSEYE..CIRCLE WITH RIGHT HALF BLACK
            "\\u25e2-\\u25e5" + //[4] BULLSEYE..CIRCLE WITH RIGHT HALF BLACK
            "\\u25ef" + // LARGE CIRCLE
            "\\u2605-\\u2606" + //[2] BLACK STAR..WHITE STAR
            "\\u2609" + // LARGE CIRCLE
            "\\u260e-\\u260f" + //[2] BLACK STAR..WHITE STAR
            "\\u261c" + // LARGE CIRCLE
            "\\u261e" + // LARGE CIRCLE
            ...
            "\\u26fe-\\u26ff" + //[2] BLACK STAR..WHITE STAR
            "\\u273d" + //[2] BLACK STAR..WHITE STAR
            "\\u2776-\\u277f" + //[10] DINGBAT NEGATIVE CIRCLED DIGIT ONE..DINGBAT NEGATIVE CIRCLED NUMBER TEN
            "\\u2b56-\\u2b59" + //[4] HEAVY OVAL WITH OVAL INSIDE..HEAVY CIRCLED SALTIRE
            "\\u3248-\\u324f" + //8] CIRCLED NUMBER TEN ON BLACK SQUARE..CIRCLED NUMBER EIGHTY ON BLACK 
            "\\ue000-\\uf8ff" + //[10] DINGBAT NEGATIVE CIRCLED DIGIT ONE..DINGBAT NEGATIVE CIRCLED NUMBER TEN
            "\\ufe00-\\ufe0f" //[16] VARIATION SELECTOR-1..VARIATION SELECTOR-16
        // BMP 밖 wide 범위 추가
        , wide_supplementary: "\\u{16FE0}-\\u{16FE4}" +
            "\\u{16FF0}-\\u{16FF6}" +
            "\\u{17000}-\\u{18CD5}" +
            "\\u{18CFF}-\\u{18D1E}" +
            "\\u{18D80}-\\u{18DF2}" +
        ...
        // BMP 밖 ambiguous 범위 추가
        , ambiguous_supplementary: "\\u{1F100}-\\u{1F10A}" +
            "\\u{1F110}-\\u{1F12D}" +
            "\\u{1F130}-\\u{1F169}" +
            "\\u{1F170}-\\u{1F18D}" +
            "\\u{1F18F}-\\u{1F190}" +
    ...
    _pEditInputType._parse = function (type)
    {
        if (type)
        {
            ...
            var bufferType = "";
            var bufferTypeSupplementary = "";
            var bufferTypeFilter = "";
            var bufferFilterSupplementary = "";
            var i, regex;
            ...
            for (i = 0; i < lenType; i++)
            {
                ...
                if (regex) bufferType += regex;

                regex = nexacro._EditInputType.MAP[arrType[i] + "_supplementary"];
                if (regex) bufferTypeSupplementary += regex;
            }
            ...
            for (i = 0; i < lenFilter; i++)
            {
                ...
                if (regex) bufferTypeFilter += regex;

                regex = nexacro._EditInputType.MAP[arrTypeFilter[i] + "_supplementary"];
                if (regex) bufferFilterSupplementary += regex;
            }
            ...
            // supplementary 패턴: 서로게이트 페어를 직접 매칭
            this.typepattern_supplementary = (bufferTypeSupplementary.length
                ? this._buildSurrogatePairRegex(bufferTypeSupplementary) : null);
            this.filterpattern_supplementary = (bufferFilterSupplementary.length
                ? this._buildSurrogatePairRegex(bufferFilterSupplementary) : null);
        }
    };

    // supplementary 코드포인트 문자열을 서로게이트 페어 정규식으로 변환
    _pEditInputType._buildSurrogatePairRegex = function (supplementaryStr)
    {
        // supplementary 문자들을 2글자(서로게이트 페어) 단위로 분리하여
        // (high1low1|high2low2|...) 형태의 alternation 정규식 생성
        var pairs = [];
        var i = 0;
        var len = supplementaryStr.length;
        while (i < len)
        {
            var code = supplementaryStr.charCodeAt(i);
            if (code >= 0xD800 && code <= 0xDBFF && (i + 1) < len)
            {
                var low = supplementaryStr.charCodeAt(i + 1);
                if (low >= 0xDC00 && low <= 0xDFFF)
                {
                    pairs.push(supplementaryStr.charAt(i) + supplementaryStr.charAt(i + 1));
                    i += 2;
                    continue;
                }
            }
            // BMP 문자가 섞여 있으면 그냥 개별 추가
            pairs.push(supplementaryStr.charAt(i));
            i++;
        }

        if (pairs.length === 0) return null;

        // 각 페어를 이스케이프하여 alternation으로 연결
        var escaped = [];
        for (var j = 0; j < pairs.length; j++)
        {
            var hi = "\\u" + ("0000" + pairs[j].charCodeAt(0).toString(16)).slice(-4);
            if (pairs[j].length === 2)
            {
                var lo = "\\u" + ("0000" + pairs[j].charCodeAt(1).toString(16)).slice(-4);
                escaped.push(hi + lo);
            }
            else
            {
    ...
    {
        if (!value) value = "";
        if (value && (this.typepattern || this.typepattern_supplementary || this.filterpattern || this.filterpattern_supplementary))
        {
            value = value.replace(/\r\n/g, "\n");
            var text = [];
            var i = 0;
            ...
            while (i < len)
            {
                ...
                if (code >= 0xD800 && code <= 0xDBFF && (i + 1) < len)
                {
                    ...
                    if (low >= 0xDC00 && low <= 0xDFFF)
                    {
                        ch = value.charAt(i) + value.charAt(i + 1);
                        i += 2;
                ...
                if (isSurrogatePair)
                {
                    if (this.filterpattern_supplementary && this.filterpattern_supplementary.test(ch))
                        continue;
                }
                else
                {
                ...
                if (ch != "\n")
                {
                    if (isSurrogatePair)
                    {
                        if (this.typepattern_supplementary)
                        {
                            if (!this.typepattern_supplementary.test(ch))
                                continue;
                        }
                        else if (this.typepattern)
                        {
                            // supplementary 패턴 없으면 BMP만 허용 → 서로게이트 페어 차단
                            continue;
                        }
                    }
                    else
