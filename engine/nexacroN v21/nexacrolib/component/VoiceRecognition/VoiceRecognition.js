...
if (!nexacro.VoiceRecognition)
{
    ...
    _pVoiceRecognition.intentanalyzersvcurl = undefined;
    _pVoiceRecognition.entityanalyzersvcurl = undefined;
    _pVoiceRecognition.subscriptionkey = undefined;
    _pVoiceRecognition.serviceregion = undefined;
    _pVoiceRecognition.servicelanguage = undefined;
    //en-US - (English)
    //ko-KR - (Korean)
    //ja    - (Japanese)
    ...
    _pVoiceRecognition.init = function (configs) 	
    {
        ...
        switch (_os)
        {
            case "Windows":
                ...
                break;
            case "Android":
                handle = nexacro._loadExtensionLibrary("com.tobesoft.voicerecognition.VoiceRecognition");
                break;
            case "iOS":
    ...
    {
        if (this._intentanalyzersvcurl != v)
        {
            this._intentanalyzersvcurl = v;
    ...
    {
        return this._intentanalyzersvcurl;
    };
    ...
    _pVoiceRecognition.on_apply_intentanalyzersvcurl = function (v)
    {
        ...
        if (intentanalyzer)
            intentanalyzer.set_url(this._intentanalyzersvcurl);
    };

    _pVoiceRecognition.set_entityanalyzersvcurl = function (v)
    {
        if (this._entityanalyzersvcurl != v)
        {
            this._entityanalyzersvcurl = v;
    ...
    {
        return this._entityanalyzersvcurl;
    };
    ...
    _pVoiceRecognition.on_apply_entityanalyzersvcurl = function (v)
    {
        ...
        if (entityanalyzer)
            entityanalyzer.set_url(this._entityanalyzersvcurl);
    };

    _pVoiceRecognition.set_subscriptionkey = function (v)
    {
        if (this.subscriptionkey != v)
        {
            this.subscriptionkey = v;
        }
    };

    _pVoiceRecognition.set_serviceregion = function (v)
    {
        if (this.serviceregion != v)
        {
            this.serviceregion = v;
        }
    };

    _pVoiceRecognition.set_servicelanguage = function (v)
    {
        if (this.servicelanguage != v)
        {
            this.servicelanguage = v;
        }
    };
