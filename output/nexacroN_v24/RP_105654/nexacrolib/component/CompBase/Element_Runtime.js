...
if (nexacro._Browser == "Runtime")
{
    ...
    if (!nexacro.Element)
    {
        ...
        _pElement._getLinkTagElements = nexacro._emptyFn;        

        _pElement._getIndexByLinkTagElement = function()
        {
            return -1;
        };
        // coordinate info
        ...
        */
        ...
        _pInputElement.setElementBlur = function ()
        {
            ...
            if (handle)
            {
                ...
                if (this._is_focused)
                {
                    ...
                    // lastselection을 유지 하는 것으로 변경, WRE와 NRE 동일하게 동작확인
                    // lastselection 말고 component의 caret_pos 내부 변수를 활용하는 방법으로 변경이 필요함
                    //this._setElementLastSelectionRange();
        ...
        _pTextAreaElement._setElementScrollSize = nexacro._emptyFn;
        ...
        _pControlElement.setElementZoom = function (zoomfactor, options)
        {
            var handle = this.handle;
            if (handle)
            {
                ...
                if (nexacro.__setElementHandleScaleOpts)
                {
                    nexacro.__setElementHandleScaleOpts(handle, zoomfactor, options);
                }
                else
                {
        ...
        _pControlElement.beginTransitionEffect = function (effectObj, callback)
        {
            ...
            {
                if (nexacro.__beginTransitionEffectWithCallback)
                {
                    nexacro.__beginTransitionEffectWithCallback(this.handle, effectObj, callback);
                }
                else
                {
                    nexacro.__beginTransitionEffect(this.handle, effectObj);
                    if (callback) callback();
                }
            }
        };
        _pControlElement.applyTransitionEffect = function (effectObj)
        {
            if (this.handle)
            {
        ...
        _pControlElement.cancelTransitionEffect = function (effectObj)
        {
            if (this.handle)
            {
        ...
        */
        ...
        _pScrollableControlElement.initElementInfo = function ()
        {
            ...
            if (control._is_scrollable)
            {
                ...
                // init status
                this._use_translate_scroll = control._use_translate_scroll; // 전역(nexacro) 제거하고 Component로 이동
        ...
        _pScrollableControlElement.setElementZoom = function (zoomfactor, options)
        {
            var handle = this.handle;
            if (handle)
            {
                ...
                if (nexacro.__setElementHandleScaleOpts)
                {
                    nexacro.__setElementHandleScaleOpts(client.handle, this.zoom, options);
                }
                else
                {
        ...
        __pContainerElement.setElementZoom = function (zoomfactor, options)
        {
            if (this.handle)
            {
                this.zoom = zoomfactor;
                if (nexacro.__setElementHandleScaleOpts)
                {
                    nexacro.__setElementHandleScaleOpts(this.handle, zoomfactor, options);
                }
                else
                {
        ...
        __pWebViewPluginElement._closeDefaultDownloadDialog = function ()
        {
            this._plugin_object.callMethod("CloseDefaultDownloadDialog");
        };
        ...
        __pWebViewPluginElement.postMessage = function (message, targetOrigin)
        {
            if (!this._plugin_object)
                return false;
            ...
            {
                msg = JSON.stringify(String(message));
            }

            var origin = (targetOrigin === undefined || targetOrigin === null) ? "*" : String(targetOrigin);
            var script = "postMessage(" + msg + "," + JSON.stringify(origin) + ")";
