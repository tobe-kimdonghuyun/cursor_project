...
if (nexacro._Browser !== "Runtime" && !nexacro._ViewTransitionEffect)
{
    ...
    //   ��, ::view-transition-old, ::view-transition-new pseudoElement�� ����ϱ� ������
    //   Javascript�� ����Ͽ� ���� ��Ÿ�� ������ �Ұ��ϱ� ������, CSS Variable�� ����Ͽ� ó��. 
    ////////////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    (function (map)
    {
        ...
        const flip3DEffect = (function ()
        {
            function calculateQuad(dRotate, direction, nWidth, nHeight)
            {
                ...
                switch (direction) 
                {
                    case 'toleft':
                        ...
                        // start�� 90���� ��, width���� Ȧ���̸� 1 pixel ���̴� ���� ó��.
                        // ��, safari���� start�� 90���� ��, quad[0]�� quad[2]�� ������ ������
                        // ������ effect�� ǥ�� �ȵǴ� ���� ����.
                        if (dRotate === 90)
                        {
                            quad[2] = quad[0] + 0.1;
                    ...
                    case 'tobottom':
                        ...
                        // start�� 90���� ��, height���� Ȧ���̸� 1 pixel ���̴� ���� ó��.
                        // ��, safari���� start�� 90���� ��, quad[1]�� quad[5]�� ������ ������
                        // ������ effect�� ǥ�� �ȵǴ� ���� ����.
                        if (dRotate === 90)
                        {
                            quad[5] = quad[1] + 0.1;
            ...
            // safari���� delay ���� 180���� ������ after�̹����� ����� ǥ�õ��� �ʾƼ� delayó����.
            return {
                viewTransitionName: "nexa-effect-axis-root",
                all: [
                    {
