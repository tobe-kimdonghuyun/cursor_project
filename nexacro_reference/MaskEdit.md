...
| Name | Description |
| --- | --- |
| accessibilityaction | MaskEdit에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다. |
| accessibilitydesclevel | MaskEdit 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| accessibilitydescription | MaskEdit에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다. |
| accessibilityenable | MaskEdit 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| accessibilitylabel | MaskEdit에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다. |
| accessibilityrole | MaskEdit에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다. |
| autoselect | MaskEdit 의 편집영역이 활성화 될 때 텍스트를 전체선택 할지 설정하는 속성입니다. |
| autoskip | MaskEdit 에 입력중인 문자열이 format 속성값에 만족했을 때 포커스를 자동으로 이동시킬지 설정하는 속성입니다. |
| background | MaskEdit 의 배경 영역을 설정하는 속성입니다. |
| border-radius | MaskEdit 의 모서리 모양을 설정하는 속성입니다. |
| bottom | MaskEdit 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다. |
| box-shadow | MaskEdit 에 그림자 효과를 설정하는 속성입니다. |
| clipmode | format 속성에 설정된 형식 중 입력하지 않은 마스크에 대한 처리 방법을 결정하는 속성입니다. |
| color | MaskEdit 에 표시되는 텍스트의 색상을 설정하는 속성입니다. |
| cssclass | MaskEdit 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다. |
| cursor | MaskEdit 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다. |
| displayinvalidtext | MaskEdit 의 value 속성값이 유효하지 않은 값일 때 표시될 대체 문자열을 설정하는 속성입니다. |
| displaynulltext | MaskEdit 의 value 속성값이 null 또는 undefined 일 때 MaskEdit 에 표시될 대체 문자열을 설정하는 속성입니다. |
| enable | MaskEdit 의 사용가능 여부를 설정하는 속성입니다. |
| enableevent | MaskEdit 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다. |
...
| font | MaskEdit 에서 사용하는 폰트를 설정하는 속성입니다. |
| format | MaskEdit 에서 입력 받을 문자의 형식을 마스크로 지정하는 속성입니다. |
| height | MaskEdit 을(를) 표시하기 위한 높이를 설정하는 속성입니다. |
| hotkey | MaskEdit 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다. |
| id | MaskEdit의 고유 식별자를 설정하는 속성입니다. |
| imeaction | 키보드에 하단 모서리에 표시되는 사용자 작업 버튼 UI와 동작을 설정하는 속성입니다. |
| initvalueid | MaskEdit 에 적용될 InitValue 의 ID 를 설정하는 속성입니다. |
| layoutorder | Layout 컨테이너 내 Main Axis(type 속성값이 "horizontal"이면 수평축, type 속성값이 "vertical"이면 수직축)에 컴포넌트가 배치되는 순서를 설정합니다. |
| left | MaskEdit 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다. |
| letter-spacing | MaskEdit 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다. |
| limitbymask | MaskEdit 에 숫자값 입력 시 format 속성값이 적용되는 부분을 설정하는 속성입니다. |
| locale | MaskEdit 에 적용될 국가 및 언어(locale)를 설정하는 속성입니다. |
| maskchar | format 속성에 정의된 마스크에 대응하는 문자를 지정하는 속성입니다. |
| maxheight | MaskEdit 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다. |
| maxwidth | MaskEdit 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다. |
| minheight | MaskEdit 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다. |
| minwidth | MaskEdit 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다. |
| name | MaskEdit 의 이름을 설정하는 속성입니다. |
| -nexa-border | MaskEdit 의 테두리를 설정하는 속성입니다. |
| -nexa-edge | MaskEdit 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-padding | MaskEdit 영역의 안쪽 여백을 설정하는 속성입니다. |
| -nexa-rtl-background-image | MaskEdit 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다. |
| -nexa-rtl-edge-image | MaskEdit 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-text-align | MaskEdit 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다. |
| -nexa-text-decoration | MaskEdit 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다. |
| opacity | MaskEdit 영역의 투명도를 설정하는 속성입니다. |
| parent | MaskEdit 의 부모 오브젝트를 갖는 읽기전용 속성입니다. |
| positionstep | 부모 오브젝트가 화면분할기능을 사용할 때 MaskEdit 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다. |
| postfixtext | 표시되는 텍스트 뒤에 붙여서 표시할 문자열을 지정하는 속성입니다. |
| readonly | MaskEdit 에서 편집을 허용할 지 설정하는 속성입니다. |
| right | MaskEdit 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다. |
| rtl | MaskEdit 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다. |
| tablecellarea | Layout 컨테이너 내 가상의 Table Cell 영역 내에서 컴포넌트가 배치되는 영역을 설정합니다. |
| taborder | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 MaskEdit 의 순서를 설정하는 속성입니다. |
| tabstop | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 MaskEdit 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다. |
| text | format 속성에 정의된 형식에 맞게 value 값을 변환하여 갖는 읽기전용 속성입니다. |
| tooltiptext | MaskEdit 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다. |
| tooltiptype | MaskEdit 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다. |
| top | MaskEdit 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다. |
| trimtype | format 속성에 설정된 형식 중 좌우 공백에 대한 처리 방법을 결정하는 속성입니다. |
| type | MaskEdit 에 입력되는 형식을 설정하는 속성입니다. |
| usecontextmenu | MaskEdit 의 편집영역에서 오른쪽 마우스 클릭 시 기본팝업메뉴의 표시 여부를 설정하는 속성입니다. |
| usesoftkeyboard | MaskEdit 가 포커스를 가질 때 키패드의 표시 여부를 설정하는 속성입니다. |
| value | MaskEdit 에 표시되는 문자열의 원본값을 갖는 속성입니다. |
| visible | MaskEdit 이(가) 화면에 표시될지 여부를 설정하는 속성입니다. |
| width | MaskEdit 을(를) 표시하기 위한 너비를 설정하는 속성입니다. |
| word-spacing | MaskEdit 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다. |

**Method**

| Name | Description |
| --- | --- |
| addEvent | MaskEdit 에 특정 이벤트를 선언하여 추가하는 메소드입니다. |
| addEventHandler | MaskEdit 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다. |
| addEventHandlerLookup | 함수를 검색하여 MaskEdit 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다. |
| bringToFront | 부모가 동일한 컴포넌트 중 MaskEdit 이(가) 화면의 제일 앞에 표시되게 합니다. |
| bringToPrev | 부모가 동일한 컴포넌트 중 MaskEdit 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| clearEventHandler | 특정 이벤트에 등록된 핸들러 함수를 모두 제거하는 메소드입니다. |
| destroy | 스크립트에서 동적으로 생성한 MaskEdit 을(를) 삭제하는 메소드입니다. |
| findEventHandler | MaskEdit 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다. |
| getCaretPos | MaskEdit 에서 캐럿이 위치한 인덱스를 반환하는 메소드입니다. |
| getDisplayText | MaskEdit 에 표시된 텍스트값을 반환하는 메소드입니다. |
| getEventHandler | MaskEdit 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다. |
| getLength | MaskEdit 의 value 속성에 설정된 문자열의 길이를 반환하는 메소드입니다. |
| getOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 MaskEdit 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetHeight | MaskEdit 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 MaskEdit 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 MaskEdit 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 MaskEdit 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetWidth | MaskEdit 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getPixelBottom | MaskEdit 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelHeight | MaskEdit 의 height 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelLeft | MaskEdit 의 left 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelRight | MaskEdit 의 right 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelTop | MaskEdit 의 top 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelWidth | MaskEdit 의 width 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getSelect | MaskEdit 컴포넌트의 텍스트 편집 영역에서 선택한 텍스트의 시작 인덱스와 끝 인덱스를 배열 형태로 반환하는 메서드입니다. |
| getSelectedText | MaskEdit 컴포넌트의 텍스트 편집 영역에서 선택한 텍스트를 반환하는 메서드입니다. |
| init | 스크립트로 MaskEdit 을(를) 동적 생성한 후에 초기화하는 메소드입니다. |
| insertEventHandler | MaskEdit 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다. |
| move | MaskEdit 의 위치와 크기를 변경하는 메소드입니다. |
| moveToNext | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 MaskEdit 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| moveToPrev | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 MaskEdit 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| removeEvent | MaskEdit 에 선언된 특정 이벤트를 삭제하는 메소드입니다. |
| removeEventHandler | MaskEdit 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다. |
| removeEventHandlerLookup | MaskEdit 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다. |
| resize | MaskEdit 의 크기를 변경하는 메소드입니다. |
| sendToBack | 부모가 동일한 컴포넌트 중 MaskEdit 이(가) 화면의 제일 뒤에 표시되게 합니다. |
| sendToNext | 부모가 동일한 컴포넌트 중 MaskEdit 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| setCaretPos | MaskEdit 에서 캐럿의 위치를 인덱스로 설정하는 메소드입니다. |
| setEventHandler | MaskEdit 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다. |
| setEventHandlerLookup | MaskEdit 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다. |
| setFocus | MaskEdit 에 포커스를 설정하는 메서드입니다. |
| setOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 MaskEdit 의 bottom 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetHeight | MaskEdit 의 높이를 픽셀단위로 설정하는 메소드입니다. |
| setOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 MaskEdit 의 left 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 MaskEdit 의 right 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 MaskEdit 의 top 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetWidth | MaskEdit 의 너비를 픽셀단위로 설정하는 메소드입니다. |
| setSelect | MaskEdit 에 포커스가 있을 때 인수로 지정된 영역을 선택하는 메소드입니다. |
| show | 스크립트로 동적 생성한 MaskEdit 을(를) 화면에 표시하는 메소드입니다. |
| updateToDataset | MaskEdit 의 value 속성값을 바인딩 되어 있는 DataSet 에 즉시 반영시키는 메소드입니다. |

**Event**

| Name | Description |
| --- | --- |
| canchange | MaskEdit 에서 value 속성값이 변경될 때 발생하는 이벤트입니다. |
| onchanged | MaskEdit 에서 value 속성값이 변경된 후 발생하는 이벤트입니다. |
| oncontextmenu | MaskEdit 영역에서 오른쪽 마우스 버튼을 클릭하거나 터치를 일정시간 유지할 때 발생하는 이벤트입니다. |
| ondevicebuttonup | 모바일 에서 디바이스 버튼을 눌렀을 때 발생하는 이벤트입니다. |
| ondrag | MaskEdit 영역 내에서 마우스 왼쪽버튼으로 드래그를 수행했을 때 발생하는 이벤트입니다. |
| ondragenter | MaskEdit 영역 내로 드래그 상태의 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다. |
| ondragleave | MaskEdit 영역 밖으로 드래그 상태의 마우스 포인터가 나갈 때 발생하는 이벤트입니다. |
| ondragmove | MaskEdit 영역 내에서 드래그 상태의 마우스 포인터가 움직일 때 발생하는 이벤트입니다. |
| ondrop | MaskEdit 영역 내에서 드래그 상태의 마우스 버튼을 떼었을 때 발생하는 이벤트입니다. |
| oneditclick | MaskEdit 컴포넌트의 텍스트 편집 영역에서 마우스 왼쪽 버튼을 클릭했을 때 발생하는 이벤트입니다. |
| onimeaction | 사용자 작업 버튼 또는 ENTER 키 입력 시 발생하는 이벤트입니다. |
| oninput | MaskEdit 에서 입력을 시도할 때 발생하는 이벤트 입니다. |
| onkeydown | MaskEdit 에 포커스가 있는 상태에서 키보드의 키가 눌렸을 때 발생하는 이벤트입니다. |
| onkeyup | MaskEdit 에 포커스가 있는 상태에서 눌렸던 키보드가 떼어질 때 발생하는 이벤트입니다. |
| onkillfocus | MaskEdit 에서 포커스가 나갈  때 발생하는 이벤트입니다. |
| onlbuttondown | MaskEdit 영역 내에서 마우스 왼쪽버튼을 눌렀을 때 발생하는 이벤트입니다. |
| onlbuttonup | MaskEdit 영역 내에서 눌렸던 마우스 왼쪽버튼을 떼었을 때 발생하는 이벤트입니다. |
| onmouseenter | MaskEdit 영역 내로 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다. |
| onmouseleave | MaskEdit 영역 밖으로 마우스 포인터가 나갈 때 발생하는 이벤트입니다. |
| onmousemove | MaskEdit 영역 내에서 마우스 포인터가 움직일 때 발생하는 이벤트입니다. |
| onmove | MaskEdit 의 위치가 이동했을 때 발생하는 이벤트입니다. |
| onrbuttondown | MaskEdit 영역 내에서 마우스 오른쪽버튼을 눌렀을 때 발생하는 이벤트입니다. |
| onrbuttonup | MaskEdit 영역 내에서 마우스 오른쪽버튼을 떼었을 때 발생하는 이벤트입니다. |
| onsetfocus | MaskEdit 에 포커스가 들어올 때 발생하는 이벤트입니다. |
| onsize | MaskEdit 의 크기가 변경됐을 때 발생하는 이벤트입니다. |
| ontouchend | MaskEdit 영역 내에서 터치를 떼었을 때 발생하는 이벤트입니다. |
| ontouchmove | MaskEdit 영역 내에서 터치 상태를 유지하며 움직일 때 발생하는 이벤트입니다. |
| ontouchstart | MaskEdit 영역 내에서 터치가 시작될 때 발생하는 이벤트입니다. |
...
> Components > Component > MaskEdit > Property > -nexa-border

**Description**

MaskEdit 의 테두리를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.border[= strborder]
```
...
this.MaskEdit00.border = "1px solid #999999";
this.MaskEdit00.border = "1px solid #999999, 1px solid #999999, 1px solid #999999, 1px solid #999999";
```
...
> Components > Component > MaskEdit > Property > -nexa-edge

**Description**

MaskEdit 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.edge[= stredge]
```
...
* Script ( normal property )
this.MaskEdit00.edge = "URL('./images/border.png')" 5px 5px;
```
...
- MaskEdit 내부에 테두리 형태로 이미지를 표시하고자 할 때 사용하는 속성입니다.
...
> Components > Component > MaskEdit > Property > -nexa-padding

**Description**

MaskEdit 영역의 안쪽 여백을 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.padding[= strpadding]
```
...
* Script ( normal property )
this.MaskEdit00.padding = "5px 5px 5px 5px";
```
- **`<npadding>`** — MaskEdit 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
- -nexa-padding 속성은 내부 컨텐츠영역과 MaskEdit 사이의 여백으로 적용됩니다.
...
> Components > Component > MaskEdit > Property > -nexa-rtl-background-image

**Description**

MaskEdit 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.-nexa-rtl-background-image
```
...
> Components > Component > MaskEdit > Property > -nexa-rtl-edge-image

**Description**

MaskEdit 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.-nexa-rtl-edge-image
```
...
> Components > Component > MaskEdit > Property > -nexa-text-align

**Description**

MaskEdit 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.textAlign[= strtextalign]
```
...
* Script ( normal property )
this.MaskEdit00.textAlign = "center";
```
...
- MaskEdit 의 너비보다 표시되는 텍스트의 길이가 크면 "right" 를 설정해도 "left" 로 동작됩니다.
...
> Components > Component > MaskEdit > Property > -nexa-text-decoration

**Description**

MaskEdit 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.textDecoration[= strTxtDeco]
```
...
* Script ( normal property )
this.MaskEdit00.textDecoration = "underline overline";
```
...
> Components > Component > MaskEdit > Property > accessibilityaction

**Description**

MaskEdit에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.accessibilityaction[= strAction]
```

**Setting Syntax**

```javascript
this.MaskEdit00.accessibilityaction = "Accessibility Action Message"; 
this.MaskEdit00.accessibilityaction = "Select by direction key";
```
...
> Components > Component > MaskEdit > Property > accessibilitydesclevel

**Description**

MaskEdit 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.accessibilitydesclevel[= enumLevel]
```
...
```
```javascript
this.MaskEdit00.accessibilitydesclevel = "all";
```
- **`"all"`** — MaskEdit 와 자식 컴포넌트에 대한 접근성을 모두 출력합니다.
- **`"self"`** — MaskEdit 의 접근성만 출력하고 자식 컴포넌트의 접근성은 출력하지 않습니다.
- **`"child"`** — MaskEdit 의 접근성은 출력하지 않고, 자식 컴포넌트의 접근성은 출력합니다.
- **`"none"`** — MaskEdit 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
...
- accessibilitydesclevel 속성은 선택상자의 이동에 영향을 주지 않으므로 방향키로 선택상자가 MaskEdit 에 이동되게 하지 않으려면 accessibilityenable 속성을 설정하여야 합니다.
...
> Components > Component > MaskEdit > Property > accessibilitydescription

**Description**

MaskEdit에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.accessibilitydescription[= strDescription]
```

**Setting Syntax**

```javascript
this.MaskEdit00.accessibilitydescription = "Option";
```
...
> Components > Component > MaskEdit > Property > accessibilityenable

**Description**

MaskEdit 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.accessibilityenable[= bEnable]
```
...
```
```javascript
this.MaskEdit00.accessibilityenable = false;
```
- **`true`** — MaskEdit 에 선택상자가 이동되면 접근성 관련 속성값을 출력합니다.

방향키 또는 제스처로 선택상자 이동 시 Static 과 같이 포커스를 갖지 않는 컴포넌트에도 선택상자가 이동됩니다.
- **`false`** — MaskEdit 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.

데스크탑 환경에서 방향키로 선택상자가 MaskEdit 에 이동되지 않습니다.
모바일 환경에서 제스처로 선택상자가 MaskEdit 에 이동되지 않습니다.
...
- 선택상자 이동 시 컴포넌트의 ARIA-LABEL + Value + Status + Role 순서로 정보가 조합되어 접근성으로 출력됩니다.
   ...
   > Value : MaskEdit 의 text 속성값이 반영됩니다. text 속성값이 없을 경우 "빈줄"로 반영됩니다.
   > Status : MaskEdit 가 편집가능상태인지 여부가 반영됩니다.
   > Role : accessibilityrole 속성값이 반영됩니다. accessibilityrole 속성값을 설정하지 않으면 MaskEdit 의 고유 Role 이 반영됩니다.
               센스리더는 MaskEdit 의 고유 Role 로 "편집창"을 출력합니다.

- MaskEdit 가 편집상태일 때 캐럿이동 또는 텍스트선택/삭제 시 캐럿위치의 텍스트를 접근성으로 출력합니다.
   캐럿 이동 및 텍스트 선택은 접근성과 무관하게 키액션으로 동작됩니다.

- MaskEdit 에 입력된 텍스트가 없을 경우 접근성으로 "빈줄" 이라고 출력합니다.

- accessibilityenable 속성값이 false 일 때 데스크탑 환경에서 방향키 외의 방법으로 선택상자를 MaskEdit 로 이동시키면 스크린 리딩 프로그램에서 임의의 값을 출력할 수 있습니다.
...
> Components > Component > MaskEdit > Property > accessibilitylabel

**Description**

MaskEdit에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.accessibilitylabel[= strLabel]
```

**Setting Syntax**

```javascript
this.MaskEdit00.accessibilitylabel = "OK Button"; 
this.MaskEdit00.accessibilitylabel = "[@static00]"; 
this.MaskEdit00.accessibilitylabel = "[@static00][@static01]"; 
this.MaskEdit00.accessibilitylabel = "[@static00][@static01] OK Button";
```
...
> Components > Component > MaskEdit > Property > accessibilityrole

**Description**

MaskEdit에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.accessibilityrole[= enumRole]
```
...
```
```javascript
this.MaskEdit00.accessibilityrole = "none"; 
this.MaskEdit00.accessibilityrole = "button";
```
...
- accessibilityenable 속성값을 설정하지 않으면 MaskEdit의 기본 Role 로 적용됩니다.

- 추가적인 속성값이 필요한 Role 설정 시 MaskEdit에 해당 속성이 없으면 스크린 리더에 따라 정상적으로 정보를 읽지 못할 수 있습니다.
...
> Components > Component > MaskEdit > Property > autoselect

**Description**

MaskEdit 의 편집영역이 활성화 될 때 텍스트를 전체선택 할지 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.autoselect[= bAutoSelect]
```
...
```
```javascript
this.MaskEdit00.autoselect=true;
```
...
> Components > Component > MaskEdit > Property > autoskip

**Description**

MaskEdit 에 입력중인 문자열이 format 속성값에 만족했을 때 포커스를 자동으로 이동시킬지 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.autoskip[= bAutoskip]
```
...
```
```javascript
this.MaskEdit00.autoskip = true;
```
- **`true`** — 문자열이 format 속성값에 만족하면 포커스를 다음 컴포넌트로 이동시킵니다.

마지막 문자가 입력 된 후 포커스가 이동됩니다.
- **`false`** — 문자열이 format 속성값을 만족해도 포커스를 다음 컴포넌트로 이동시키지 않습니다.

**Remark**

- autoskip 속성값을 설정하지 않으면 false 로 적용됩니다.

- 한글과 같은 멀티바이트 문자는 지원하지 않습니다.
...
> Components > Component > MaskEdit > Property > background

**Description**

MaskEdit 의 배경 영역을 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.background[= strbackground]
```
...
* Script ( normal property )
this.MaskEdit00.background = "#ffffaa";
this.MaskEdit00.background = ""URL('./images/smiley.gif')" no-repeat center center #ffffaa";
this.MaskEdit00.background = ""URL('./images/smiley.gif')" no-repeat center center /auto #ffffaa";
this.MaskEdit00.background = ""URL('./images/smiley.gif')" no-repeat center center /15px 15% #ffffaa";
this.MaskEdit00.background = "linear-gradient( red , blue , yellow )";
this.MaskEdit00.background = "linear-gradient( #FF0000 , rgb(0,0,255) , rgb(255,255,0))";
this.MaskEdit00.background = ""URL('./images/smiley.gif')" border-box border-box #ffffaa";
```
...
"left" 설정 시 MaskEdit 의 왼쪽면과 이미지의 왼쪽면이 정렬되어 표시됩니다.
"center" 설정 시 MaskEdit 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"right" 설정 시 MaskEdit 의 오른쪽면과 이미지의 오른쪽면이 정렬되어 표시됩니다.
...
"top" 설정 시 MaskEdit 의 윗쪽면과 이미지의 윗쪽면이 정렬되어 표시됩니다.
"center" 설정 시 MaskEdit 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"bottom" 설정 시 MaskEdit 의 아랫쪽면과 이미지의 아랫쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
0 보다 작거나 100 보다 큰 값을 설정 시 MaskEdit 의 영역을 벗어난 가상의 위치로 적용됩니다.
...
예를 들어 <angle> 값이 "to left" 이면 MaskEdit 의 right 위치가 시작점이 되고, left 위치가 끝점이 됩니다.
              <angle> 값이 "to right" 이면 MaskEdit 의 left 위치가 시작점이 되고, right 위치가 끝점이 됩니다.
...
<bg-image> 에 적용된 이미지에 투명으로 적용된 부분이 있거나 이미지가 MaskEdit 영역보다 작다면 해당 영역에 배경색이 표시됩니다.
...
> Components > Component > MaskEdit > Property > border-radius

**Description**

MaskEdit 의 모서리 모양을 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.borderRadius[= strborderradius]
```
...
* Script ( normal property )
this.MaskEdit00.borderRadius = "10px";
this.MaskEdit00.borderRadius = "5px 6px 10px / 5px 10px";
```
...
> Components > Component > MaskEdit > Property > bottom

**Description**

MaskEdit 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.bottom[= nBottom]
```
...
```
```javascript
this.MaskEdit00.bottom = 10; 
this.MaskEdit00.bottom = "10px"; 
this.MaskEdit00.bottom = "10%"; 
this.MaskEdit00.bottom = "Button00:10px"; 
this.MaskEdit00.bottom = "Button00:10%";
```
- **`<strCompID>`** — MaskEdit 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 MaskEdit 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 MaskEdit 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — MaskEdit 의 하단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 bottom 속성값을 기준으로 MaskEdit의 하단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 MaskEdit의 하단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 MaskEdit의 하단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 MaskEdit의 하단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 top 속성값을 기준으로 MaskEdit의 하단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 MaskEdit의 하단 위치 결정
...
> Components > Component > MaskEdit > Property > box-shadow

**Description**

MaskEdit 에 그림자 효과를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.boxShadow[= strbshadow]
```
...
* Script ( normal property )
this.MaskEdit00.boxShadow  = "10px 10px 10px #888888";
this.MaskEdit00.boxShadow  = "inset 10px 10px 10px 5px #888888";
```
...
MaskEdit 의 좌상단 위치를 기준으로 그림자 효과가 표시될 위치를 가로/세로 픽셀값으로 설정합니다.
...
> Components > Component > MaskEdit > Property > clipmode

**Description**

format 속성에 설정된 형식 중 입력하지 않은 마스크에 대한 처리 방법을 결정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.clipmode[= enumClipmode]
```
...
```
```javascript
this.MaskEdit00.clipmode = "excludespace";
```
- **`"includespace"`** — 입력하지 않은 마스크와 입력한 스페이스 문자를 모두 공백으로 처리하여 value 속성에 저장합니다.

trimtype 속성에서 좌우공백에 대한 처리를 추가적으로 설정할 수 있습니다.
- **`"excludespace"`** — 입력하지 않은 마스크는 잘라내고 스페이스를 포함하여 입력된 문자를 왼쪽으로 모아서 value 속성에 저장합니다.

trimtype 속성값이 무시되어 좌우공백을 추가적으로 처리할 수 없습니다.

**Remark**

- clipmode 속성값을 설정하지 않으면 "includespace" 로 적용됩니다.

- type 속성값이 "string" 인 경우에만 적용되는 속성입니다.

- clipmode 속성은 사용자가 직접 입력할 때만 적용됩니다.
  스크립트로 value 속성값을 설정할 때는 적용되지 않습니다.

- clipmode 속성값을 스크립트로 변경해도 value 값이 변경되지 않습니다.
...
> Components > Component > MaskEdit > Property > color

**Description**

MaskEdit 에 표시되는 텍스트의 색상을 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.color[= strcolor]
```
...
* Script ( normal property )
this.MaskEdit00.color = "#999999";
this.MaskEdit00.color = "rgb(255,0,0)";
this.MaskEdit00.color = "red";
```
- **`<NamedColor>`** — "red","blue" 와 같이 미리 정의된 색상이름을 문자열로 설정합니다.
- **`<NumericColor>`** — 표시할 색의 색상코드입니다.
...
> Components > Component > MaskEdit > Property > cssclass

**Description**

MaskEdit 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.cssclass[= strcssclass]
```
...
```
```javascript
this.MaskEdit00.cssclass = "TestClass"; 
this.MaskEdit00.cssclass = "TestClass,TestClass2";
```
...
> Components > Component > MaskEdit > Property > cursor

**Description**

MaskEdit 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.cursor[= strCursor]
```
...
* Script ( normal property )
this.MaskEdit00.cursor = "default";
```
...
MaskEdit 의 value 속성값이 유효하지 않은 값일 때 표시될 대체 문자열을 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.displayinvalidtext[= strFillstyle]
```

**Setting Syntax**

```javascript
this.MaskEdit00.displayinvalidtext = "Data Error";
```
- **`strText`** — value 속성값이 NaN, ±Infinity, 유효하지 않은 값 일 때 MaskEdit 에 표시될 대체 문자열을 설정합니다.
...
> Components > Component > MaskEdit > Property > displaynulltext

**Description**

MaskEdit 의 value 속성값이 null 또는 undefined 일 때 MaskEdit 에 표시될 대체 문자열을 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.displaynulltext[= strText]
```

**Setting Syntax**

```javascript
this.MaskEdit00.displaynulltext = "no value";
```
- **`strText`** — value 속성값이 null 일 때 MaskEdit 에 표시될 대체 문자열을 설정합니다.

**Remark**

- value 속성값이 null 또는 undefined 이고, MaskEdit 에 포커스가 없을 때 대체 문자열이 표시됩니다.
...
> Components > Component > MaskEdit > Property > enable

**Description**

MaskEdit 의 사용가능 여부를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.enable[= benable]
```
...
```
```javascript
this.MaskEdit00.enable = true; 
this.MaskEdit00.enable = false;
```
- **`true`** — MaskEdit 을(를) 사용할 수 있게 설정합니다.
- **`false`** — MaskEdit 을(를) 사용할 수 없게 설정합니다.
...
> Components > Component > MaskEdit > Property > enableevent

**Description**

MaskEdit 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.enableevent[= bEvent]
```
...
> Components > Component > MaskEdit > Property > flexgrow
...
> Components > Component > MaskEdit > Property > flexshrink
...
> Components > Component > MaskEdit > Property > font

**Description**

MaskEdit 에서 사용하는 폰트를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.font[= strfont]
```
...
* Script ( normal property )
this.MaskEdit00.font = "bold 12pt/30px arial, sans-serif";
```
...
> Components > Component > MaskEdit > Property > format

**Description**

MaskEdit 에서 입력 받을 문자의 형식을 마스크로 지정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.format [=strFormat]
```
...
- 윈도우의 키보드 에서는 통화표시기호("\")와 백슬래시("＼")를 구분할수 없지만, 모바일 키패드에서는 두 문자를 구분하고 있습니다.
   따라서 format 에 "\"를 표현하려면 "＼\"를 사용하는게 올바른 문법입니다.

- type 속성값에 따라 텍스트 편집 시 표시되는 키패드가 달라집니다.
  type 속성값이 "number"인 경우 number 타입의 키패드
  type 속성값이 "string"인 경우 format 속성값에 설정한 마스크 문자열에 따라 해당하는 타입의 키패드
...
> Components > Component > MaskEdit > Property > height

**Description**

MaskEdit 을(를) 표시하기 위한 높이를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.height[= nHeight]
```
...
```
```javascript
this.MaskEdit00.height = 10; 
this.MaskEdit00.height = "10px"; 
this.MaskEdit00.height = 10%"; 
this.MaskEdit00.height = Button00:10%";
```
- **`<strCompID>`** — MaskEdit 의 높이를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 MaskEdit 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 MaskEdit 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 높이가 적용됩니다.
- **`<nVal>`** — MaskEdit 의 높이를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.


* <strCompID> 값을 생략했을 때 :
- "px": MaskEdit의 높이 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 MaskEdit의 높이 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 MaskEdit의 높이 결정
- "rem": MainFrame font-size 속성값을 기준으로 MaskEdit의 높이 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 MaskEdit의 높이 결정
- "%": <strCompID>의 height 속성값을 기준으로 MaskEdit의 높이 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > MaskEdit > Property > hotkey

**Description**

MaskEdit 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.hotkey[= strHotkey]
```

**Setting Syntax**

```javascript
this.MaskEdit00.hotkey = "G"; 
this.MaskEdit00.hotkey = "CTRL+A"; 
this.MaskEdit00.hotkey = "CTRL+ALT+X";
```
...
> Components > Component > MaskEdit > Property > id

**Description**

MaskEdit의 고유 식별자를 설정하는 속성입니다.
...
- **`id`** — MaskEdit를 구별할 수 있는 유일값을 갖습니다.
...
> Components > Component > MaskEdit > Property > imeaction
...
```javascript
MaskEdit.imeaction[= enumImeaction]
```
...
```
```javascript
this.MaskEdit00.imeaction = "none";
```
...
> Components > Component > MaskEdit > Property > initvalueid

**Description**

MaskEdit 에 적용될 InitValue 의 ID 를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.initvalueid[= strValueID]
```

**Setting Syntax**

- **`strValueID`** — InitValueDefinition 영역에 정의된 InitValue 파일에서 MaskEdit 에 적용할 항목의 ID 를 문자열로 설정합니다.

**Remark**

- MaskEdit 가 화면에 표시된 후에는 속성값을 설정하거나 변경 할 수 없습니다.
   MaskEdit 를 동적으로 생성 시 show() 메소드 실행 전에 속성값을 설정하여야 합니다.
...
> Components > Component > MaskEdit > Property > layoutorder
...
> Components > Component > MaskEdit > Property > left

**Description**

MaskEdit 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.MaskEdit00.left = 10; 
this.MaskEdit00.left = "10px"; 
this.MaskEdit00.left = "10%"; 
this.MaskEdit00.left = "Button00:10px"; 
this.MaskEdit00.left = "Button00:10%";
```
- **`<strCompID>`** — MaskEdit 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — MaskEdit 의 좌측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 left 속성값을 기준으로 MaskEdit의 좌측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 MaskEdit의 좌측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 MaskEdit의 좌측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 MaskEdit의 좌측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 right 속성값을 기준으로 MaskEdit의 좌측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 MaskEdit의 좌측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > MaskEdit > Property > letter-spacing

**Description**

MaskEdit 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.letterSpacing[= strspace]
```
...
* Script ( normal property )
this.MaskEdit00.letterSpacing = "2px";
```
...
> Components > Component > MaskEdit > Property > limitbymask

**Description**

MaskEdit 에 숫자값 입력 시 format 속성값이 적용되는 부분을 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.limitbymask[= enumLimitmask]
```
...
```
```javascript
this.MaskEdit00.limitbymask = "decimal";
```
- **`"none"`** — format 속성값과 관계없이 숫자값 입력에 제한을 두지 않습니다.
- **`"integer"`** — 정수부분만 format 속성값에 따라 입력을 제한합니다.
소수부분은 format 속성값이 정의되어 있어도 제한없이 입력이 가능합니다.
- **`"decimal"`** — 정수부분은 format 속성값이 정의되어 있어도 제한없이 입력이 가능합니다.
소수부분만 format 속성값에 따라 입력을 제한합니다.
- **`"both"`** — 정수부분과 소수부분 모두 format 속성값에 따라 입력을 제한합니다.

**Remark**

- limitbymask 속성값을 설정하지 않으면 "decimal"로 적용됩니다.

- type 속성값이 "number" 인 경우에만 적용되는 속성입니다.

- 부호(Sign)는 limitbymask 속성값에 관계없이 입력할 수 있습니다.

- 예를 들어 format 속성값이 "###.##"이고, limitbymask 속성값이 "decimal" 이면 소수부 입력 시 두자리 숫자까지만 입력됩니다.
...
> Components > Component > MaskEdit > Property > locale

**Description**

MaskEdit 에 적용될 국가 및 언어(locale)를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.locale[= strlocale]
```

**Setting Syntax**

```javascript
this.MaskEdit00.locale = "ko_KR";
```
...
> Components > Component > MaskEdit > Property > maskchar
...
```javascript
MaskEdit.maskchar[= strMaskchar]
```

**Setting Syntax**

```javascript
this.MaskEdit00.maskchar = "?";
```
- **`strMaskchar`** — format 속성에 정의된 마스크("#","@" 등) 위치에 표시될 문자를 설정합니다.

**Remark**

- maskchar 속성값을 설정하지 않으면 언더바("_")로 적용됩니다.
...
> Components > Component > MaskEdit > Property > maxheight

**Description**

MaskEdit 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.maxheight[= nMaxHeight]
```
...
```
```javascript
this.MaskEdit00.maxheight = 20; 
this.MaskEdit00.maxheight = "20px";
```
- **`<nVal>`** — MaskEdit 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 maxheight 보다 크면 화면에 표시되는 MaskEdit 의 높이는 maxheight 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 MaskEdit 의 높이가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > MaskEdit > Property > maxwidth

**Description**

MaskEdit 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.maxwidth[= nMaxWidth]
```
...
```
```javascript
this.MaskEdit00.maxwidth = 20; 
this.MaskEdit00.maxwidth = "20px";
```
- **`<nVal>`** — MaskEdit 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 maxwidth 보다 크면 화면에 표시되는 MaskEdit 의 너비는 maxwidth 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 MaskEdit 의 너비가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > MaskEdit > Property > minheight

**Description**

MaskEdit 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.minheight[= nMinHeight]
```
...
```
```javascript
this.MaskEdit00.minheight = 20; 
this.MaskEdit00.minheight = "20px";
```
- **`<nVal>`** — MaskEdit 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 minheight 보다 작다면 화면에 표시되는 MaskEdit 의 높이는 minheight 속성값으로 적용됩니다.
  표시되는 높이만 적용되고 height 속성값은 변경되지 않습니다.
...
> Components > Component > MaskEdit > Property > minwidth

**Description**

MaskEdit 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.minwidth[= nMinWidth]
```
...
```
```javascript
this.MaskEdit00.minwidth = 20; 
this.MaskEdit00.minwidth = "20px";
```
- **`<nVal>`** — MaskEdit 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 minwidth 보다 작으면 화면에 표시되는 MaskEdit 의 너비는 minwidth 속성값으로 적용됩니다.
  표시되는 너비만 적용되고 width 속성값은 변경되지 않습니다.
...
> Components > Component > MaskEdit > Property > name

**Description**

MaskEdit 의 이름을 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.name[= strName]
```
...
> Components > Component > MaskEdit > Property > opacity

**Description**

MaskEdit 영역의 투명도를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.opacity[= stropacity]
```
...
* Script ( normal property )
this.MaskEdit00.opacity = "0.8";
this.MaskEdit00.opacity = 0.8;
this.MaskEdit00.opacity = "80%";
```
...
> Components > Component > MaskEdit > Property > parent

**Description**

MaskEdit 의 부모 오브젝트를 갖는 읽기전용 속성입니다.
...
```javascript
var objParent = this.MaskEdit00.parent;
```
...
- MaskEdit 이(가) Div 와 같은 컨테이너 컴포넌트에 자식으로 존재한다면 parent 속성은 해당 컨테이너 컴포넌트를 갖습니다.
...
> Components > Component > MaskEdit > Property > positionstep

**Description**

부모 오브젝트가 화면분할기능을 사용할 때 MaskEdit 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.positionstep[= nStep]
```

**Setting Syntax**

```javascript
this.MaskEdit00.positionstep = 0; 
this.MaskEdit00.positionstep = -1;
```
- **`nStep`** — MaskEdit 이(가) 표시될 분할화면의 인덱스를 설정합니다.
"-1" 로 설정하면 모든 분할화면에 MaskEdit 이(가) 표시됩니다.
...
> Components > Component > MaskEdit > Property > postfixtext
...
```javascript
MaskEdit.postfixtext[= strPostFixText]
```

**Setting Syntax**

```javascript
this.MaskEdit00.postfixtext = "%";
```
...
- type 속성값이 "number"인 경우에는 format 속성값 설정 시 숫자를 표기하기 위한 마스크 문자 외에 다른 문자를 설정할 수 없습니다. 때문에 "20%"와 같은 텍스트를 표시할 수 없습니다. postfixtext 속성값을 "%"로 지정하면 숫자 뒤에 원하는 문자열을 설정해서 표시할 수 있습니다.
...
> Components > Component > MaskEdit > Property > readonly

**Description**

MaskEdit 에서 편집을 허용할 지 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.readonly[= bReadOnly]
```
...
```
- **`true`** — MaskEdit 의 편집을 불가능하게 설정합니다.
...
- **`false`** — MaskEdit 의 편집을 가능하게 설정합니다.
...
> Components > Component > MaskEdit > Property > right

**Description**

MaskEdit 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.right[= nRight]
```
...
```
```javascript
this.MaskEdit00.right = 10; 
this.MaskEdit00.right = "10px"; 
this.MaskEdit00.right = "10%"; 
this.MaskEdit00.right = "Button00:10px"; 
this.MaskEdit00.right = "Button00:10%";
```
- **`<strCompID>`** — MaskEdit 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — MaskEdit 의 우측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 right 속성값을 기준으로 MaskEdit의 우측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 MaskEdit의 우측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 MaskEdit의 우측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 MaskEdit의 우측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 left 속성값을 기준으로 MaskEdit의 우측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 MaskEdit의 우측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > MaskEdit > Property > rtl

**Description**

MaskEdit 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다.
...
```
```javascript
var vRtl = this.MaskEdit00.rtl;
```
- **`undefined`** — undefined 설정 시 상위 컴포넌트의 rtl 속성값이 적용됩니다.

사용자가 rtl 속성값을 설정하지 않거나 삭제했을 경우 undefined 가 설정됩니다.
- **`true`** — MaskEdit 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 오른쪽으로 설정합니다.
MaskEdit 의 내부 좌표계의 기준을 오른쪽으로 설정합니다.
MaskEdit 의 텍스트 표시 기준을 오른쪽으로 설정합니다.
수직스크롤바가 있을 경우 왼쪽에 표시됩니다.
- **`false`** — MaskEdit 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
MaskEdit 의 내부 좌표계의 기준을 왼쪽으로 설정합니다.
MaskEdit 의 텍스트 표시 기준을 왼쪽으로 설정합니다.
...
- MaskEdit 부터 Environment 까지 상위의 모든 rtl 속성값이 undefined 이면
...
> Components > Component > MaskEdit > Property > tablecellarea
...
```javascript
MaskEdit.tablecellarea[= strArea]
```
...
> Components > Component > MaskEdit > Property > taborder

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 MaskEdit 의 순서를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.taborder[= nTabOrder]
```
...
> Components > Component > MaskEdit > Property > tabstop

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 MaskEdit 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.tabstop[= bTabStop]
```
...
bTabStop ::= 'true' | 'false'
```
- **`"true"`** — MaskEdit 이(가) 탭키 입력에 의한 포커스를 받습니다.
- **`"false"`** — MaskEdit 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
...
> Components > Component > MaskEdit > Property > text

**Description**

format 속성에 정의된 형식에 맞게 value 값을 변환하여 갖는 읽기전용 속성입니다.
...
```javascript
var strTxt = this.MaskEdit00.text;
```

**Remark**

- value 속성이나 format 속성이 변경되면 자동으로 text 속성에 적용됩니다.
...
> Components > Component > MaskEdit > Property > tooltiptext

**Description**

MaskEdit 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.tooltiptext[= strToolTipText]
```
...
- 마우스 포인터가 MaskEdit 영역 위에서 일정시간 움직이지 않으면 풍선도움말이 표시됩니다.
...
> Components > Component > MaskEdit > Property > tooltiptype

**Description**

MaskEdit 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.tooltiptype[= enumTooltipType]
```
...
```
```javascript
this.MaskEdit00.tooltiptype = "hover";
```
- **`"default"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 MaskEdit 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"hover"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 MaskEdit 영역내에 멈춰서 일정시간이 경과하면 풍선도움말이 사라집니다.
MaskEdit 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경되거나 사라진 풍선도움말이 다시 표시됩니다.
- **`"inplace"`** — MaskEdit 의 좌측상단 안쪽에 풍선도움말을 표시합니다.

마우스 포인터가 MaskEdit 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"default,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 MaskEdit 영역에 있으면 풍선도움말이 사라지지 않습니다.
- **`"hover,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 MaskEdit 영역에 있으면 풍선도움말이 사라지지 않습니다.
MaskEdit 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경됩니다.
- **`"inplace,mouseleave"`** — MaskEdit 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
- 표시되었다가 사라진 풍선도움말은 마우스 포인터가 MaskEdit 영역을 나갔다가 들어오면 다시 표시됩니다.

- 마우스 포인터가 MaskEdit 영역에서 벗어나면 풍선도움말이 사라집니다.
...
> Components > Component > MaskEdit > Property > top

**Description**

MaskEdit 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.MaskEdit00.top = 10; 
this.MaskEdit00.top = "10px"; 
this.MaskEdit00.top = "10%"; 
this.MaskEdit00.top = "Button00:10px"; 
this.MaskEdit00.top = "Button00:10%";
```
- **`<strCompID>`** — MaskEdit 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — MaskEdit의 상단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 top 속성값을 기준으로 MaskEdit의 상단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 MaskEdit의 상단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 MaskEdit의 상단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 MaskEdit의 상단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 bottom 속성값을 기준으로 MaskEdit의 상단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 MaskEdit의 상단 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > MaskEdit > Property > trimtype

**Description**

format 속성에 설정된 형식 중 좌우 공백에 대한 처리 방법을 결정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.trimtype[= enumTrimtype]
```
...
```
```javascript
this.MaskEdit00.trimtype = "both";
```
- **`"none"`** — 입력하지 않은 마스크와 입력한 스페이스 문자를 모두 공백으로 처리하여 value 속성에 저장합니다.
- **`"left"`** — 왼쪽에 입력하지 않은 마스크와 입력한 스페이스 문자는 잘라내고 입력된 문자를 왼쪽으로 모아서 value 속성에 저장합니다.

오른쪽에 입력하지 않은 마스크와 입력한 스페이스 문자를 모두 공백으로 처리하여 value 속성에 저장합니다.
- **`"right"`** — 왼쪽에 입력하지 않은 마스크와 입력한 스페이스 문자를 모두 공백으로 처리하여 value 속성에 저장합니다.

오른쪽에 입력하지 않은 마스크와 입력한 스페이스 문자는 잘라내고 value 속성에 저장합니다.
- **`"both"`** — 왼쪽과 오른쪽에 입력하지 않은 마스크와 입력한 스페이스 문자는 모두 잘라내고 입력된 문자를 왼쪽으로 모아서 value 속성에 저장합니다.

**Remark**

- trimtype 속성값을 설정하지 않으면 "none"으로 적용됩니다.

- type 속성값이 "string" 이고 clipmode 속성값이 "includespace" 인 경우에만 적용되는 속성입니다.

- type 속성값이 "number" 인 경우에는 모든 공백을 자동으로 잘라냅니다.

- maskedittrimtype 속성은 사용자가 직접 입력할 때만 적용됩니다.
  스크립트로 value 속성값을 설정하거나 바인딩 된 DataSet 의 값을 표시할 때는 적용되지 않습니다.
...
> Components > Component > MaskEdit > Property > type

**Description**

MaskEdit 에 입력되는 형식을 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.type[= enumType]
```
...
format, displaycomma, limitbymask 속성값이 입력방식에 영향을 줍니다.
- **`"string"`** — MaskEdit 에서 문자 형식으로 입력을 받습니다.

format, maskchar, clipmode, trimtype 속성값이 입력방식에 영향을 줍니다.

**Remark**

- type 속성값을 설정하지 않으면 "number"로 적용됩니다.
...
> Components > Component > MaskEdit > Property > usecontextmenu

**Description**

MaskEdit 의 편집영역에서 오른쪽 마우스 클릭 시 기본팝업메뉴의 표시 여부를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.usecontextmenu[= bUseContextMenu]
```
...
```
```javascript
this.MaskEdit00.usecontextmenu = true;
```
...
- Environment 의 usecontextmenu 속성값이 "none" 또는 "form" 인 경우 MaskEdit 의 usecontextmenu 속성은 false 로 동작합니다.
...
> Components > Component > MaskEdit > Property > usesoftkeyboard

**Description**

MaskEdit 가 포커스를 가질 때 키패드의 표시 여부를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.usesoftkeyboard[= bUseKeyboard]
```
...
```
```javascript
this.MaskEdit00.usesoftkeyboard = false;
```
- **`true`** — MaskEdit 가 포커스를 가질 때 키패드가 자동으로 표시됩니다.
- **`false`** — MaskEdit 가 포커스를 가질 때 키패드가 표시되지 않습니다.
...
> Components > Component > MaskEdit > Property > value

**Description**

MaskEdit 에 표시되는 문자열의 원본값을 갖는 속성입니다.

**Syntax**

```javascript
MaskEdit.value[= strValue]
```

**Setting Syntax**

```javascript
this.MaskEdit00.value = "Hello";
```
- **`strValue`** — MaskEdit 에 표시될 문자열을 설정합니다.

**Remark**

- value 속성값을 설정하지 않으면 undefined 로 적용됩니다.

- format 속성값에 따라서 value 속성이 가질 수 있는 값이 제한됩니다.

- MaskEdit 에 Dataset을 바인딩 하면 기본적으로 연동되는 속성입니다.

- type 속성값이 "string" 일 경우 마스크("#","@" 등)에 해당하는 문자만 저장됩니다.
   type 속성값이 "number" 일 경우 콤마(",")를 제외한 숫자, 소수점, 사인(Sign)값만 저장됩니다.
...
> Components > Component > MaskEdit > Property > visible

**Description**

MaskEdit 이(가) 화면에 표시될지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.visible[= bVisible]
```
...
```
```javascript
this.MaskEdit00.visible = true; 
this.MaskEdit00.visible = false;
```
- **`"true"`** — MaskEdit 을(를) 화면에 표시합니다.
- **`"false"`** — MaskEdit 을(를) 화면에 표시하지 않습니다.
...
> Components > Component > MaskEdit > Property > width

**Description**

MaskEdit 을(를) 표시하기 위한 너비를 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.width[= nWidth]
```
...
```
```javascript
this.MaskEdit00.width = 10; this.MaskEdit00.width = "10px"; 
this.MaskEdit00.width = "10%"; 
this.MaskEdit00.width = "Button00:10%";
```
- **`<strCompID>`** — MaskEdit 의 너비를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 MaskEdit 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 MaskEdit 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 너비가 적용됩니다.
- **`<nVal>`** — MaskEdit 의 너비를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": MaskEdit의 너비 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 MaskEdit의 너비 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 MaskEdit의 너비 결정
- "rem": MainFrame font-size 속성값을 기준으로 MaskEdit의 너비 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 MaskEdit의 너비 결정
- "%": <strCompID>의 width 속성값을 기준으로 MaskEdit의 너비 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > MaskEdit > Property > word-spacing

**Description**

MaskEdit 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다.

**Syntax**

```javascript
MaskEdit.wordSpacing[= strwordspacing]
```
...
* Script ( normal property )
this.MaskEdit00.wordSpacing = "30px";
```
...
> Components > Component > MaskEdit > Method > addEvent

**Description**

MaskEdit 에 특정 이벤트를 선언하여 추가하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.addEvent( strEventID )
```
...
- MaskEdit 에서 특정 이벤트를 제거하려면 removeEvent() 메소드를 사용하여야 합니다.
...
> Components > Component > MaskEdit > Method > addEventHandler

**Description**

MaskEdit 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.addEventHandler( strEventID, objFunc, objTarget )
```
...
> Components > Component > MaskEdit > Method > addEventHandlerLookup

**Description**

함수를 검색하여 MaskEdit 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.addEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
> Components > Component > MaskEdit > Method > bringToFront

**Description**

부모가 동일한 컴포넌트 중 MaskEdit 이(가) 화면의 제일 앞에 표시되게 합니다.

**Syntax**

```javascript
MaskEdit.bringToFront()
```

**Parameters**

this.MaskEdit.bringToFront();
...
- bringToFront() 메소드는 MaskEdit 을(를) 가장 나중에 표시되게 순서를 바꿉니다.
...
> Components > Component > MaskEdit > Method > bringToPrev

**Description**

부모가 동일한 컴포넌트 중 MaskEdit 이(가) 화면에 한단계 앞에 표시되게 합니다.

**Syntax**

```javascript
MaskEdit.bringToPrev()
```

**Parameters**

this.MaskEdit.bringToPrev();
...
- bringToPrev() 메소드는 MaskEdit 을(를) 한단계 나중에 표시되는 컴포넌트와 순서를 바꿉니다.
...
> Components > Component > MaskEdit > Method > clearEventHandler
...
```javascript
MaskEdit.clearEventHandler( strEventID )
```
...
> Components > Component > MaskEdit > Method > destroy

**Description**

스크립트에서 동적으로 생성한 MaskEdit 을(를) 삭제하는 메소드입니다.
...
var bSucc = this.MaskEdit00.destroy();
...
- 동적으로 생성한 MaskEdit 을(를) 완전히 삭제하기 위해서는 destroy() 메소드를 호출해야 합니다.

**See Also**

Form.addChildForm.insertChildForm.removeChildMaskEdit.initMaskEdit.show
...
> Components > Component > MaskEdit > Method > findEventHandler

**Description**

MaskEdit 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.findEventHandler( strEventID, objFunc, objTarget )
```
...
> Components > Component > MaskEdit > Method > getCaretPos

**Description**

MaskEdit 에서 캐럿이 위치한 인덱스를 반환하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.getCaretPos()
```

**Parameters**

var nPos = this.MaskEdit00.getCaretPos();
...
- MaskEdit 에 포커스가 있고 캐럿이 표시되고 있어야 합니다.

- value 속성값이 아닌 화면에 표시되는 text 속성값을 기준으로 인덱스를 계산합니다.
  즉, 화면에 표시되는 마스크 이외의 문자도 인덱스 계산에 포함합니다.
...
> Components > Component > MaskEdit > Method > getDisplayText

**Description**

MaskEdit 에 표시된 텍스트값을 반환하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.getDisplayText()
```

**Parameters**

var strTxt = this.MaskEdit00.getDisplayText() ;
...
> Components > Component > MaskEdit > Method > getEventHandler

**Description**

MaskEdit 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.getEventHandler( strEventID, nIdx )
```
...
> Components > Component > MaskEdit > Method > getLength

**Description**

MaskEdit 의 value 속성에 설정된 문자열의 길이를 반환하는 메소드입니다.
...
var nLength = this.MaskEdit00.getLength();
...
> Components > Component > MaskEdit > Method > getOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 MaskEdit 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.getOffsetBottom();
```

**Parameters**

var nBottom = this.MaskEdit.getOffsetBottom();
...
- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 MaskEdit 의 bottom 값을 동적으로 계산합니다.
...
> Components > Component > MaskEdit > Method > getOffsetHeight

**Description**

MaskEdit 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.getOffsetHeight();
```

**Parameters**

var nHeight = this.MaskEdit.getOffsetHeight();
...
- 화면에 표시된 MaskEdit 의 높이를 동적으로 계산합니다.
...
> Components > Component > MaskEdit > Method > getOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 MaskEdit 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.getOffsetLeft();
```

**Parameters**

var nleft = this.MaskEdit.getOffsetLeft();
...
- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 MaskEdit 의 left 값을 동적으로 계산합니다.
...
> Components > Component > MaskEdit > Method > getOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 MaskEdit 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.getOffsetRight();
```

**Parameters**

var nRight = this.MaskEdit.getOffsetRight();
...
- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 MaskEdit 의 right 값을 동적으로 계산합니다.
...
> Components > Component > MaskEdit > Method > getOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 MaskEdit 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.getOffsetTop();
```

**Parameters**

var nTop = this.MaskEdit.getOffsetTop();
...
- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 MaskEdit 의 top 값을 동적으로 계산합니다.
...
> Components > Component > MaskEdit > Method > getOffsetWidth

**Description**

MaskEdit 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.getOffsetWidth();
```

**Parameters**

var nWidth = this.MaskEdit.getOffsetWidth();
...
- 화면에 표시된 MaskEdit 의 너비를 동적으로 계산합니다.
...
> Components > Component > MaskEdit > Method > getPixelBottom

**Description**

MaskEdit 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.getPixelBottom();
```

**Parameters**

var nbottom = this.MaskEdit.getPixelBottom();
...
> Components > Component > MaskEdit > Method > getPixelHeight

**Description**

MaskEdit 의 height 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.getPixelHeight();
```

**Parameters**

var nheight = this.MaskEdit.getPixelHeight();
...
> Components > Component > MaskEdit > Method > getPixelLeft

**Description**

MaskEdit 의 left 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.getPixelLeft();
```

**Parameters**

var nleft = this.MaskEdit.getPixelLeft();
...
> Components > Component > MaskEdit > Method > getPixelRight

**Description**

MaskEdit 의 right 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.getPixelRight();
```

**Parameters**

var nright = this.MaskEdit.getPixelRight();
...
> Components > Component > MaskEdit > Method > getPixelTop

**Description**

MaskEdit 의 top 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.getPixelTop();
```

**Parameters**

var ntop = this.MaskEdit.getPixelTop();
...
> Components > Component > MaskEdit > Method > getPixelWidth

**Description**

MaskEdit 의 width 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.getPixelWidth();
```

**Parameters**

var nwidth = this.MaskEdit.getPixelWidth();
...
> Components > Component > MaskEdit > Method > getSelect

**Description**

MaskEdit 컴포넌트의 텍스트 편집 영역에서 선택한 텍스트의 시작 인덱스와 끝 인덱스를 배열 형태로 반환하는 메서드입니다.
...
var vArrSelect = this.MaskEdit00.getSelect();
...
- MaskEdit 컴포넌트의 텍스트 편집 영역에 포커스가 있고 캐럿이 표시된 상태에서만 정상적으로 값을 반환합니다.
...
> Components > Component > MaskEdit > Method > getSelectedText

**Description**

MaskEdit 컴포넌트의 텍스트 편집 영역에서 선택한 텍스트를 반환하는 메서드입니다.

**Syntax**

```javascript
MaskEdit.getSelectedText()
```

**Parameters**

var strText = this.MaskEdit00.getSelectedText();
...
> Components > Component > MaskEdit > Method > init

**Description**

스크립트로 MaskEdit 을(를) 동적 생성한 후에 초기화하는 메소드입니다.
...
- 인수값에 기준 컴포넌트를 포함하면 MaskEdit 의 위치는 기준 컴포넌트를 기준으로 상대적으로 결정됩니다.
  vLeft, vTop, vWidth, vHeight, vRight, vBottom 값에 기준 컴포넌트를 포함할 때는 "ID:Value" 형태로 설정하여야 합니다.

- 기준 컴포넌트는 MaskEdit 와(과) 부모(Parent)가 동일하여야 하며, Form 로딩 시 MaskEdit 보다 먼저 생성되어야 합니다.
...
Form.addChildForm.insertChildForm.removeChildMaskEdit.destroyMaskEdit.show
...
> Components > Component > MaskEdit > Method > insertEventHandler

**Description**

MaskEdit 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.insertEventHandler( strEventID, nIndex, objFunc, objTarget )
```
...
> Components > Component > MaskEdit > Method > move

**Description**

MaskEdit 의 위치와 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.move( vLeft, vTop [, vWidth, vHeight [, vRight, vBottom]] )
```
...
> Components > Component > MaskEdit > Method > moveToNext

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 MaskEdit 이(가) 화면에 한단계 뒤에 표시되게 합니다.

**Syntax**

```javascript
MaskEdit.moveToNext( objComp )
MaskEdit.moveToNext( strComp )
```
...
- 인수로 전달되는 기준 컴포넌트와 MaskEdit 은(는) 부모가 동일하여야 합니다.

- 디자인 시 소스에 컴포넌트가 선언된 순서대로 화면에 표시됩니다.
  소스에서 위에 선언된 컴포넌트가 먼저 표시되고, 아래에 선언된 컴포넌트가 나중에 표시되게 됩니다.
  컴포넌트가 겹쳐져 있을 경우 화면에 표시되는 순서에 따라 먼저 표시된 컴포넌트가 나중에 표시되는 컴포넌트에 가려지게 됩니다.

- moveToNext() 메소드는 기준 컴포넌트보다 MaskEdit 이(가) 한단계 먼저 표시되게 순서를 바꿉니다.
...
> Components > Component > MaskEdit > Method > moveToPrev

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 MaskEdit 이(가) 화면에 한단계 앞에 표시되게 합니다.

**Syntax**

```javascript
MaskEdit.moveToPrev( objComp )
MaskEdit.moveToPrev( strComp )
```
...
- moveToPrev() 메소드는 기준 컴포넌트보다 MaskEdit 이(가) 한단계 나중에 표시되게 순서를 바꿉니다.
...
> Components > Component > MaskEdit > Method > removeEvent

**Description**

MaskEdit 에 선언된 특정 이벤트를 삭제하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.removeEvent( strEventID )
```
...
- MaskEdit 에 특정 이벤트를 추가하려면 addEvent() 메소드를 사용하여야 합니다.

- MaskEdit 에 기본으로 선언되어 있는 이벤트 삭제 시 오동작 할 수 있으므로 주의하여야 합니다.
...
> Components > Component > MaskEdit > Method > removeEventHandler

**Description**

MaskEdit 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.removeEventHandler( strEventID, objFunc, objTarget )
```
...
> Components > Component > MaskEdit > Method > removeEventHandlerLookup

**Description**

MaskEdit 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.removeEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
> Components > Component > MaskEdit > Method > resize

**Description**

MaskEdit 의 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.resize( vWidth, vHeight )
```
...
- MaskEdit 의 left 속성값이 null 이 아니면 resize() 메소드 실행 후 MaskEdit 의 우측 위치가 변경됩니다.
  또한, 메소드 실행 후 right 속성값은 null 이 됩니다.

- MaskEdit 의 left 속성값이 null 이면 resize() 메소드 실행 후 MaskEdit 의 좌측 위치가 변경됩니다.
  또한, 메소드 실행 후 left 속성값은 null 로 유지됩니다.

- MaskEdit 의 top 속성값이 null 이 아니면 resize() 메소드 실행 후 MaskEdit 의 하단 위치가 변경됩니다.
  또한, 메소드 실행 후 bottom 속성값은 null 이 됩니다.

- MaskEdit 의 top 속성값이 null 이면 resize() 메소드 실행 후 MaskEdit 의 상단 위치가 변경됩니다.
...
> Components > Component > MaskEdit > Method > sendToBack

**Description**

부모가 동일한 컴포넌트 중 MaskEdit 이(가) 화면의 제일 뒤에 표시되게 합니다.
...
- sendToBack() 메소드는 MaskEdit 을(를) 가장 먼저 표시되게 순서를 바꿉니다.
...
> Components > Component > MaskEdit > Method > sendToNext

**Description**

부모가 동일한 컴포넌트 중 MaskEdit 이(가) 화면에 한단계 뒤에 표시되게 합니다.
...
- sendToNext() 메소드는 MaskEdit 을(를) 한단계 먼저 표시되는 컴포넌트와 순서를 바꿉니다.
...
MaskEdit 에서 캐럿의 위치를 인덱스로 설정하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.setCaretPos( [nIndex] )
```
...
> Components > Component > MaskEdit > Method > setEventHandler

**Description**

MaskEdit 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.setEventHandler( strEventID, objFunc, objTarget )
```
...
> Components > Component > MaskEdit > Method > setEventHandlerLookup

**Description**

MaskEdit 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.setEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
> Components > Component > MaskEdit > Method > setFocus

**Description**

MaskEdit 에 포커스를 설정하는 메서드입니다.

**Syntax**

```javascript
MaskEdit.setFocus( [bMoveScroll] )
```
...
> Components > Component > MaskEdit > Method > setOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 MaskEdit 의 bottom 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.setOffsetBottom( nBottom );
```
...
- 메소드 실행 전 MaskEdit 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > MaskEdit 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > MaskEdit 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > MaskEdit 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 height, bottom 속성이 설정됩니다.
...
> Components > Component > MaskEdit > Method > setOffsetHeight

**Description**

MaskEdit 의 높이를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.setOffsetHeight( nHeight );
```
...
> Components > Component > MaskEdit > Method > setOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 MaskEdit 의 left 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.setOffsetLeft( nLeft );
```
...
- 메소드 실행 전 MaskEdit 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > MaskEdit 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > MaskEdit 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, right 속성이 설정됩니다.
   > MaskEdit 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
...
> Components > Component > MaskEdit > Method > setOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 MaskEdit 의 right 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.setOffsetRight( nRight );
```
...
- 메소드 실행 전 MaskEdit 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > MaskEdit 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > MaskEdit 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > MaskEdit 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 width, right 속성이 설정됩니다.
...
> Components > Component > MaskEdit > Method > setOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 MaskEdit 의 top 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.setOffsetTop( nTop );
```
...
- 메소드 실행 전 MaskEdit 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > MaskEdit 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > MaskEdit 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, bottom 속성이 설정됩니다.
   > MaskEdit 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
...
> Components > Component > MaskEdit > Method > setOffsetWidth

**Description**

MaskEdit 의 너비를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.setOffsetWidth( nWidth );
```
...
> Components > Component > MaskEdit > Method > setSelect

**Description**

MaskEdit 에 포커스가 있을 때 인수로 지정된 영역을 선택하는 메소드입니다.

**Syntax**

```javascript
MaskEdit.setSelect( [nBegin [,nEnd]] )
```
...
> Components > Component > MaskEdit > Method > show

**Description**

스크립트로 동적 생성한 MaskEdit 을(를) 화면에 표시하는 메소드입니다.
...
Form.addChildForm.insertChildForm.removeChildMaskEdit.destroyMaskEdit.init
...
> Components > Component > MaskEdit > Method > updateToDataset

**Description**

MaskEdit 의 value 속성값을 바인딩 되어 있는 DataSet 에 즉시 반영시키는 메소드입니다.

**Syntax**

```javascript
MaskEdit.updateToDataset()
```

**Parameters**

var bSucc = this.MaskEdit00.updateToDataset();
...
- MaskEdit 의 value 속성이 DataSet 에 바인딩 되어 있어야 합니다.

- MaskEdit 의 value 속성값이 바인딩 되어있는 Dataset 의 값과 같으면 Dataset 에 값이 반영되지 않고 "false"를 반환합니다.
...
> Components > Component > MaskEdit > Event > canchange

**Description**

MaskEdit 에서 value 속성값이 변경될 때 발생하는 이벤트입니다.

**Syntax**

```javascript
canchange(obj:nexacro.MaskEdit,e:nexacro.ChangeEventInfo);
```
...
- MaskEdit 에서 문자를 입력/삭제 후 엔터키를 입력하거나 포커스를 이동하면 value 속성값이 변경됩니다.
...
> Components > Component > MaskEdit > Event > onchanged

**Description**

MaskEdit 에서 value 속성값이 변경된 후 발생하는 이벤트입니다.

**Syntax**

```javascript
onchanged(obj:nexacro.MaskEdit,e:nexacro.ChangeEventInfo);
```
...
> Components > Component > MaskEdit > Event > oncontextmenu

**Description**

MaskEdit 영역에서 오른쪽 마우스 버튼을 클릭하거나 터치를 일정시간 유지할 때 발생하는 이벤트입니다.

**Syntax**

```javascript
oncontextmenu(obj:nexacro.MaskEdit,e:nexacro.ContextMenuEventInfo);
```
...
> Components > Component > MaskEdit > Event > ondevicebuttonup
...
```javascript
ondevicebuttonup(obj:nexacro.MaskEdit,e:nexacro.DeviceButtonEventInfo);
```
...
> Components > Component > MaskEdit > Event > ondrag

**Description**

MaskEdit 영역 내에서 마우스 왼쪽버튼으로 드래그를 수행했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondrag(obj:nexacro.MaskEdit,e:nexacro.DragEventInfo);
```
...
- MaskEdit 영역 내에서 마우스의 LButtonDown 후 LButtonUp 액션 없이 마우스 이동 시 ondrag 이벤트가 발생합니다.
...
> Components > Component > MaskEdit > Event > ondragenter

**Description**

MaskEdit 영역 내로 드래그 상태의 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragenter(obj:nexacro.MaskEdit,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 MaskEdit 영역으로 마우스 포인터가 들어올 때마다 이벤트가 발생합니다.
...
> Components > Component > MaskEdit > Event > ondragleave

**Description**

MaskEdit 영역 밖으로 드래그 상태의 마우스 포인터가 나갈 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragleave(obj:nexacro.MaskEdit,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 MaskEdit 영역에서 마우스 포인터가 나갈 때마다 이벤트가 발생합니다.
...
> Components > Component > MaskEdit > Event > ondragmove

**Description**

MaskEdit 영역 내에서 드래그 상태의 마우스 포인터가 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragmove(obj:nexacro.MaskEdit,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 MaskEdit 영역 내에서 마우스 포인터가 움직일 때마다 이벤트가 발생합니다.
...
> Components > Component > MaskEdit > Event > ondrop

**Description**

MaskEdit 영역 내에서 드래그 상태의 마우스 버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondrop(obj:nexacro.MaskEdit,e:nexacro.DragEventInfo);
```
...
- MaskEdit 영역 내에서 드래그 상태인 마우스의 LButtonUp 액션 발생 시 ondrop 이벤트가 발생합니다.
...
> Components > Component > MaskEdit > Event > oneditclick

**Description**

MaskEdit 컴포넌트의 텍스트 편집 영역에서 마우스 왼쪽 버튼을 클릭했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
oneditclick(obj:nexacro.MaskEdit,e:nexacro.EditClickEventInfo);
```
...
> Components > Component > MaskEdit > Event > onimeaction
...
```javascript
onimeaction(obj:nexacro.MaskEdit,e:nexacro.KeyEventInfo);
```
...
> Components > Component > MaskEdit > Event > oninput

**Description**

MaskEdit 에서 입력을 시도할 때 발생하는 이벤트 입니다.

**Syntax**

```javascript
oninput(obj:nexacro.MaskEdit,e:nexacro.InputEventInfo);
```
...
> Components > Component > MaskEdit > Event > onkeydown

**Description**

MaskEdit 에 포커스가 있는 상태에서 키보드의 키가 눌렸을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkeydown(obj:nexacro.MaskEdit,e:nexacro.KeyEventInfo);
```
...
> Components > Component > MaskEdit > Event > onkeyup

**Description**

MaskEdit 에 포커스가 있는 상태에서 눌렸던 키보드가 떼어질 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkeyup(obj:nexacro.MaskEdit,e:nexacro.KeyEventInfo);
```
...
> Components > Component > MaskEdit > Event > onkillfocus

**Description**

MaskEdit 에서 포커스가 나갈  때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkillfocus(obj:nexacro.MaskEdit,e:nexacro.KillFocusEventInfo);
```
...
- showModal(), open() 등의 메소드로 팝업된 Frame 으로 포커스가 이동하는 경우 MaskEdit 에서 포커스 관련 이벤트가 발생하지 않습니다.
   또한, alert(), confirm() 메소드로 표시된 팝업으로 포커스가 이동하는 경우도 MaskEdit 에서 포커스 관련 이벤트가 발생하지 않습니다.
...
> Components > Component > MaskEdit > Event > onlbuttondown

**Description**

MaskEdit 영역 내에서 마우스 왼쪽버튼을 눌렀을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onlbuttondown(obj:nexacro.MaskEdit,e:nexacro.MouseEventInfo);
```
...
- MaskEdit 영역 내에서 마우스의 LButtonDown 액션이 발생하면 이벤트가 발생합니다.
...
> Components > Component > MaskEdit > Event > onlbuttonup

**Description**

MaskEdit 영역 내에서 눌렸던 마우스 왼쪽버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onlbuttonup(obj:nexacro.MaskEdit,e:nexacro.MouseEventInfo);
```
...
> Components > Component > MaskEdit > Event > onmouseenter

**Description**

MaskEdit 영역 내로 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmouseenter(obj:nexacro.MaskEdit,e:nexacro.MouseEventInfo);
```
...
> Components > Component > MaskEdit > Event > onmouseleave

**Description**

MaskEdit 영역 밖으로 마우스 포인터가 나갈 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmouseleave(obj:nexacro.MaskEdit,e:nexacro.MouseEventInfo);
```
...
> Components > Component > MaskEdit > Event > onmousemove

**Description**

MaskEdit 영역 내에서 마우스 포인터가 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmousemove(obj:nexacro.MaskEdit,e:nexacro.MouseEventInfo);
```
...
> Components > Component > MaskEdit > Event > onmove

**Description**

MaskEdit 의 위치가 이동했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmove(obj:nexacro.MaskEdit,e:nexacro.MoveEventInfo);
```
...
> Components > Component > MaskEdit > Event > onrbuttondown

**Description**

MaskEdit 영역 내에서 마우스 오른쪽버튼을 눌렀을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onrbuttondown(obj:nexacro.MaskEdit,e:nexacro.MouseEventInfo);
```
...
> Components > Component > MaskEdit > Event > onrbuttonup

**Description**

MaskEdit 영역 내에서 마우스 오른쪽버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onrbuttonup(obj:nexacro.MaskEdit,e:nexacro.MouseEventInfo);
```
...
> Components > Component > MaskEdit > Event > onsetfocus

**Description**

MaskEdit 에 포커스가 들어올 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onsetfocus(obj:nexacro.MaskEdit,e:nexacro.SetFocusEventInfo);
```
...
- open() 메소드로 오픈된 Modeless 창에서 부모창의 MaskEdit 에 setFocus() 메소드 실행 시 환경에 따라 동작에 차이가 있으므로 주의하여야 합니다.
...
> Components > Component > MaskEdit > Event > onsize

**Description**

MaskEdit 의 크기가 변경됐을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onsize(obj:nexacro.MaskEdit,e:nexacro.SizeEventInfo);
```
...
> Components > Component > MaskEdit > Event > ontouchend

**Description**

MaskEdit 영역 내에서 터치를 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchend(obj:nexacro.MaskEdit,e:nexacro.TouchEventInfo);
```
...
> Components > Component > MaskEdit > Event > ontouchmove

**Description**

MaskEdit 영역 내에서 터치 상태를 유지하며 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchmove(obj:nexacro.MaskEdit,e:nexacro.TouchEventInfo);
```
...
> Components > Component > MaskEdit > Event > ontouchstart

**Description**

MaskEdit 영역 내에서 터치가 시작될 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchstart(obj:nexacro.MaskEdit,e:nexacro.TouchEventInfo);
```
