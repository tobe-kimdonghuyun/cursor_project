...
| 메뉴 이동 | 상하방향키 | 메뉴 또는 서브메뉴 항목을 이동합니다.
...
| Name | Description |
| --- | --- |
| accessibilityaction | Menu에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다. |
| accessibilitydesclevel | Menu 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| accessibilitydescription | Menu에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다. |
| accessibilityenable | Menu 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| accessibilitylabel | Menu에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다. |
| accessibilityrole | Menu에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다. |
| autohotkey | Menu 의 hotkeycolumn 속성에 설정된 키를 단축키(HotKey) 로 적용할지 설정하는 속성입니다. |
| background | Menu 의 배경 영역을 설정하는 속성입니다. |
| border-radius | Menu 의 모서리 모양을 설정하는 속성입니다. |
| bottom | Menu 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다. |
| box-shadow | Menu 에 그림자 효과를 설정하는 속성입니다. |
...
| color | Menu 에 표시되는 텍스트의 색상을 설정하는 속성입니다. |
| cssclass | Menu 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다. |
| cursor | Menu 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다. |
| enable | Menu 의 사용가능 여부를 설정하는 속성입니다. |
| enablecolumn | innerdataset 속성에 설정된 DataSet 의 Column 중 메뉴 아이템의 활성화 여부가 정의된 Column을 설정하는 속성입니다. |
| enableevent | Menu 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다. |
| fittocontents | Menu 의 내부 컨텐츠영역이 컨텐츠 내용에 맞게 자동조정되는 영역을 설정하는 속성입니다. |
...
| font | Menu 에서 사용하는 폰트를 설정하는 속성입니다. |
| height | Menu 을(를) 표시하기 위한 높이를 설정하는 속성입니다. |
| hotkey | Menu 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다. |
...
| id | Menu의 고유 식별자를 설정하는 속성입니다. |
| idcolumn | innerdataset 속성에 설정된 DataSet 의 Column 중 메뉴 아이템의 ID가 정의된 Column을 설정하는 속성입니다. |
| initvalueid | Menu 에 적용될 InitValue 의 ID 를 설정하는 속성입니다. |
| innerdataset | Menu 의 메뉴 아이템이 정의된 DataSet 의 ID를 설정하는 속성입니다. |
| layoutorder | Layout 컨테이너 내 Main Axis(type 속성값이 "horizontal"이면 수평축, type 속성값이 "vertical"이면 수직축)에 컴포넌트가 배치되는 순서를 설정합니다. |
| left | Menu 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다. |
| letter-spacing | Menu 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다. |
| levelcolumn | innerdataset 속성에 설정된 DataSet 의 Column 중 메뉴 아이템의 상/하위 관계가 정의된 Column을 설정하는 속성입니다. |
| maxheight | Menu 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다. |
| maxwidth | Menu 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다. |
| minheight | Menu 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다. |
| minwidth | Menu 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다. |
| name | Menu 의 이름을 설정하는 속성입니다. |
| navigationbuttonsize | 표시해야 할 메뉴아이템의 너비가 Menu 의 너비보다 클 때 표시되는 스크롤 버튼의 너비를 설정하는 속성입니다. |
| -nexa-border | Menu 의 테두리를 설정하는 속성입니다. |
| -nexa-edge | Menu 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-padding | Menu 영역의 안쪽 여백을 설정하는 속성입니다. |
| -nexa-rtl-background-image | Menu 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다. |
| -nexa-rtl-edge-image | Menu 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| opacity | Menu 영역의 투명도를 설정하는 속성입니다. |
| parent | Menu 의 부모 오브젝트를 갖는 읽기전용 속성입니다. |
| popupitemheight | Menu 에서 하위 메뉴가 표시될 때 각 메뉴항목의 높이를 설정하는 속성입니다. |
| popupnavigationbuttonsize | 표시해야 할 서브메뉴아이템의 높이가 SubMenu 의 높이보다 클 때 표시되는 스크롤 버튼의 높이를 설정하는 속성입니다. |
| popuptype | Menu 에서 하위 메뉴가 표시되는 방식을 설정하는 속성입니다. |
| positionstep | 부모 오브젝트가 화면분할기능을 사용할 때 Menu 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다. |
| right | Menu 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다. |
| rtl | Menu 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다. |
| tablecellarea | Layout 컨테이너 내 가상의 Table Cell 영역 내에서 컴포넌트가 배치되는 영역을 설정합니다. |
| taborder | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 Menu 의 순서를 설정하는 속성입니다. |
| tabstop | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 Menu 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다. |
| tooltiptext | Menu 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다. |
| tooltiptype | Menu 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다. |
| top | Menu 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다. |
| userdatacolumn | innerdataset 속성에 설정된 DataSet의 Column 중 사용자 데이터를 처리하기 위한 Column을 설정하는 속성입니다. |
| visible | Menu 이(가) 화면에 표시될지 여부를 설정하는 속성입니다. |
| width | Menu 을(를) 표시하기 위한 너비를 설정하는 속성입니다. |
| word-spacing | Menu 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다. |

**Method**

| Name | Description |
| --- | --- |
| addEvent | Menu 에 특정 이벤트를 선언하여 추가하는 메소드입니다. |
| addEventHandler | Menu 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다. |
| addEventHandlerLookup | 함수를 검색하여 Menu 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다. |
| bringToFront | 부모가 동일한 컴포넌트 중 Menu 이(가) 화면의 제일 앞에 표시되게 합니다. |
| bringToPrev | 부모가 동일한 컴포넌트 중 Menu 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| cancelPopup | Menu 에 표시된 하위메뉴를 닫는 메소드입니다. |
| clearEventHandler | 특정 이벤트에 등록된 핸들러 함수를 모두 제거하는 메소드입니다. |
| destroy | 스크립트에서 동적으로 생성한 Menu 을(를) 삭제하는 메소드입니다. |
| findEventHandler | Menu 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다. |
| getEventHandler | Menu 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다. |
| getInnerDataset | Menu 의 innerdataset 속성에 설정되어 있는 DataSet 오브젝트를 반환하는 메소드입니다. |
| getOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 Menu 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetHeight | Menu 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 Menu 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 Menu 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 Menu 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetWidth | Menu 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getPixelBottom | Menu 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelHeight | Menu 의 height 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelLeft | Menu 의 left 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelRight | Menu 의 right 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelTop | Menu 의 top 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelWidth | Menu 의 width 속성값을 픽셀단위로 반환하는 메소드입니다. |
| init | 스크립트로 Menu 을(를) 동적 생성한 후에 초기화하는 메소드입니다. |
| insertEventHandler | Menu 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다. |
| isPopup | Menu 에 하위메뉴가 표시되어 있는지 여부를 반환하는 메소드입니다. |
| move | Menu 의 위치와 크기를 변경하는 메소드입니다. |
| moveToNext | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Menu 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| moveToPrev | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Menu 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| removeEvent | Menu 에 선언된 특정 이벤트를 삭제하는 메소드입니다. |
| removeEventHandler | Menu 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다. |
| removeEventHandlerLookup | Menu 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다. |
| resize | Menu 의 크기를 변경하는 메소드입니다. |
| sendToBack | 부모가 동일한 컴포넌트 중 Menu 이(가) 화면의 제일 뒤에 표시되게 합니다. |
| sendToNext | 부모가 동일한 컴포넌트 중 Menu 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| setEventHandler | Menu 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다. |
| setEventHandlerLookup | Menu 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다. |
| setFocus | Menu 에 포커스를 설정하는 메서드입니다. |
| setInnerDataset | Menu 의 innerdataset 속성에 인수로 전달된 DataSet 오브젝트를 설정하는 메소드입니다. |
| setOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 Menu 의 bottom 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetHeight | Menu 의 높이를 픽셀단위로 설정하는 메소드입니다. |
| setOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 Menu 의 left 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 Menu 의 right 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 Menu 의 top 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetWidth | Menu 의 너비를 픽셀단위로 설정하는 메소드입니다. |
| show | 스크립트로 동적 생성한 Menu 을(를) 화면에 표시하는 메소드입니다. |
| trackPopup | 최상위 메뉴 아이템의 하위메뉴를 특정 위치에 팝업으로 표시하는 메소드입니다. |
...
> Components > Component > Menu > Property > -nexa-border

**Description**

Menu 의 테두리를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.border[= strborder]
```
...
this.Menu00.border = "1px solid #999999";
this.Menu00.border = "1px solid #999999, 1px solid #999999, 1px solid #999999, 1px solid #999999";
```
...
> Components > Component > Menu > Property > -nexa-edge

**Description**

Menu 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.
...
* Script ( normal property )
this.Menu00.edge = "URL('./images/border.png')" 5px 5px;
```
...
- Menu 내부에 테두리 형태로 이미지를 표시하고자 할 때 사용하는 속성입니다.
...
> Components > Component > Menu > Property > -nexa-padding

**Description**

Menu 영역의 안쪽 여백을 설정하는 속성입니다.

**Syntax**

```javascript
Menu.padding[= strpadding]
```
...
* Script ( normal property )
this.Menu00.padding = "5px 5px 5px 5px";
```
- **`<npadding>`** — Menu 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
- -nexa-padding 속성은 내부 컨텐츠영역과 Menu 사이의 여백으로 적용됩니다.
...
> Components > Component > Menu > Property > -nexa-rtl-background-image

**Description**

Menu 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.-nexa-rtl-background-image
```
...
> Components > Component > Menu > Property > -nexa-rtl-edge-image

**Description**

Menu 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.-nexa-rtl-edge-image
```
...
> Components > Component > Menu > Property > accessibilityaction

**Description**

Menu에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.accessibilityaction[= strAction]
```

**Setting Syntax**

```javascript
this.Menu00.accessibilityaction = "Accessibility Action Message"; 
this.Menu00.accessibilityaction = "Select by direction key";
```
...
> Components > Component > Menu > Property > accessibilitydesclevel

**Description**

Menu 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.accessibilitydesclevel[= enumLevel]
```
...
```
```javascript
this.Menu00.accessibilitydesclevel = "all";
```
- **`"all"`** — Menu 와 자식 컴포넌트에 대한 접근성을 모두 출력합니다.
- **`"self"`** — Menu 의 접근성만 출력하고 자식 컴포넌트의 접근성은 출력하지 않습니다.
- **`"child"`** — Menu 의 접근성은 출력하지 않고, 자식 컴포넌트의 접근성은 출력합니다.
- **`"none"`** — Menu 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
...
- accessibilitydesclevel 속성은 선택상자의 이동에 영향을 주지 않으므로 방향키로 선택상자가 Menu 에 이동되게 하지 않으려면 accessibilityenable 속성을 설정하여야 합니다.
...
> Components > Component > Menu > Property > accessibilitydescription

**Description**

Menu에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.accessibilitydescription[= strDescription]
```

**Setting Syntax**

```javascript
this.Menu00.accessibilitydescription = "Option";
```
...
> Components > Component > Menu > Property > accessibilityenable

**Description**

Menu 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.accessibilityenable[= bEnable]
```
...
```
```javascript
this.Menu00.accessibilityenable = false;
```
- **`true`** — Menu 에 선택상자가 이동되면 접근성 관련 속성값을 출력합니다.

방향키 또는 제스처로 선택상자 이동 시 Static 과 같이 포커스를 갖지 않는 컴포넌트에도 선택상자가 이동됩니다.
- **`false`** — Menu 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.

데스크탑 환경에서 방향키로 선택상자가 Menu 에 이동되지 않습니다.
모바일 환경에서 제스처로 선택상자가 Menu 에 이동되지 않습니다.
...
- 선택상자 이동 시 컴포넌트의 ARIA-LABEL + Status + HasPopup + Role 순서로 정보가 조합되어 접근성으로 출력됩니다.
   각 정보의 조합순서는 스크린 리더의 종류에 따라 달라질 수 있습니다.
   > ARIA-LABEL : Environment 의 accessbilitydescreadtype 속성에 설정된 속성값이 반영됩니다.
   > Status : Menu 가 편집가능상태인지 여부가 반영됩니다.
   > HasPopup : Menu 가 팝업이 가능한지 여부가 반영됩니다.
   > Role : accessibilityrole 속성값이 반영됩니다. accessibilityrole 속성값을 설정하지 않으면 Menu 의 고유 Role 이 반영됩니다.

- accessibilityenable 속성값이 false 일 때 데스크탑 환경에서 방향키 외의 방법으로 선택상자를 Menu 로 이동시키면 스크린 리딩 프로그램에서 임의의 값을 출력할 수 있습니다.
...
> Components > Component > Menu > Property > accessibilitylabel

**Description**

Menu에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.accessibilitylabel[= strLabel]
```

**Setting Syntax**

```javascript
this.Menu00.accessibilitylabel = "OK Button"; 
this.Menu00.accessibilitylabel = "[@static00]"; 
this.Menu00.accessibilitylabel = "[@static00][@static01]"; 
this.Menu00.accessibilitylabel = "[@static00][@static01] OK Button";
```
...
> Components > Component > Menu > Property > accessibilityrole

**Description**

Menu에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.accessibilityrole[= enumRole]
```
...
```
```javascript
this.Menu00.accessibilityrole = "none"; 
this.Menu00.accessibilityrole = "button";
```
...
- accessibilityenable 속성값을 설정하지 않으면 Menu의 기본 Role 로 적용됩니다.

- 추가적인 속성값이 필요한 Role 설정 시 Menu에 해당 속성이 없으면 스크린 리더에 따라 정상적으로 정보를 읽지 못할 수 있습니다.
...
> Components > Component > Menu > Property > autohotkey

**Description**

Menu 의 hotkeycolumn 속성에 설정된 키를 단축키(HotKey) 로 적용할지 설정하는 속성입니다.

**Syntax**

```javascript
Menu.autohotkey[= bAutohotkey]
```
...
> Components > Component > Menu > Property > background

**Description**

Menu 의 배경 영역을 설정하는 속성입니다.

**Syntax**

```javascript
Menu.background[= strbackground]
```
...
* Script ( normal property )
this.Menu00.background = "#ffffaa";
this.Menu00.background = ""URL('./images/smiley.gif')" no-repeat center center #ffffaa";
this.Menu00.background = ""URL('./images/smiley.gif')" no-repeat center center /auto #ffffaa";
this.Menu00.background = ""URL('./images/smiley.gif')" no-repeat center center /15px 15% #ffffaa";
this.Menu00.background = "linear-gradient( red , blue , yellow )";
this.Menu00.background = "linear-gradient( #FF0000 , rgb(0,0,255) , rgb(255,255,0))";
this.Menu00.background = ""URL('./images/smiley.gif')" border-box border-box #ffffaa";
```
...
"left" 설정 시 Menu 의 왼쪽면과 이미지의 왼쪽면이 정렬되어 표시됩니다.
"center" 설정 시 Menu 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"right" 설정 시 Menu 의 오른쪽면과 이미지의 오른쪽면이 정렬되어 표시됩니다.
...
"top" 설정 시 Menu 의 윗쪽면과 이미지의 윗쪽면이 정렬되어 표시됩니다.
"center" 설정 시 Menu 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"bottom" 설정 시 Menu 의 아랫쪽면과 이미지의 아랫쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
0 보다 작거나 100 보다 큰 값을 설정 시 Menu 의 영역을 벗어난 가상의 위치로 적용됩니다.
...
예를 들어 <angle> 값이 "to left" 이면 Menu 의 right 위치가 시작점이 되고, left 위치가 끝점이 됩니다.
              <angle> 값이 "to right" 이면 Menu 의 left 위치가 시작점이 되고, right 위치가 끝점이 됩니다.
...
<bg-image> 에 적용된 이미지에 투명으로 적용된 부분이 있거나 이미지가 Menu 영역보다 작다면 해당 영역에 배경색이 표시됩니다.
...
> Components > Component > Menu > Property > border-radius

**Description**

Menu 의 모서리 모양을 설정하는 속성입니다.

**Syntax**

```javascript
Menu.borderRadius[= strborderradius]
```
...
* Script ( normal property )
this.Menu00.borderRadius = "10px";
this.Menu00.borderRadius = "5px 6px 10px / 5px 10px";
```
...
> Components > Component > Menu > Property > bottom

**Description**

Menu 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.Menu00.bottom = 10; 
this.Menu00.bottom = "10px"; 
this.Menu00.bottom = "10%"; 
this.Menu00.bottom = "Button00:10px"; 
this.Menu00.bottom = "Button00:10%";
```
- **`<strCompID>`** — Menu 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 Menu 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 Menu 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Menu 의 하단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 bottom 속성값을 기준으로 Menu의 하단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 Menu의 하단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Menu의 하단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Menu의 하단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 top 속성값을 기준으로 Menu의 하단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 Menu의 하단 위치 결정
...
> Components > Component > Menu > Property > box-shadow

**Description**

Menu 에 그림자 효과를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.boxShadow[= strbshadow]
```
...
* Script ( normal property )
this.Menu00.boxShadow  = "10px 10px 10px #888888";
this.Menu00.boxShadow  = "inset 10px 10px 10px 5px #888888";
```
...
Menu 의 좌상단 위치를 기준으로 그림자 효과가 표시될 위치를 가로/세로 픽셀값으로 설정합니다.
...
> Components > Component > Menu > Property > captioncolumn
...
```javascript
Menu.captioncolumn[= strColumnID]
```

**Setting Syntax**

```javascript
this.Menu00.captioncolumn = "captioncolumn";
```
- **`strColumnID`** — Menu 컴포넌트에 아이템으로 표시될 텍스트가 정의된 Column 의 ID 를 문자열로 설정합니다.
...
> Components > Component > Menu > Property > checkboxcolumn
...
```javascript
Menu.checkboxcolumn[= strColumnID]
```

**Setting Syntax**

```javascript
this.Menu00.checkboxcolumn = "col_checkbox";
```
...
- 화면에 항상 표시되는 메인메뉴 아이템에는 체크이미지가 표시되지 않습니다.
   메인메뉴 클릭 시 팝업되는 서브메뉴 아이템부터 체크이미지가 텍스트 왼쪽에 표시됩니다.
...
> Components > Component > Menu > Property > color

**Description**

Menu 에 표시되는 텍스트의 색상을 설정하는 속성입니다.
...
* Script ( normal property )
this.Menu00.color = "#999999";
this.Menu00.color = "rgb(255,0,0)";
this.Menu00.color = "red";
```
- **`<NamedColor>`** — "red","blue" 와 같이 미리 정의된 색상이름을 문자열로 설정합니다.
- **`<NumericColor>`** — 표시할 색의 색상코드입니다.
...
> Components > Component > Menu > Property > cssclass

**Description**

Menu 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다.

**Syntax**

```javascript
Menu.cssclass[= strcssclass]
```
...
```
```javascript
this.Menu00.cssclass = "TestClass"; 
this.Menu00.cssclass = "TestClass,TestClass2";
```
...
> Components > Component > Menu > Property > cursor

**Description**

Menu 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.cursor[= strCursor]
```
...
> Components > Component > Menu > Property > enable

**Description**

Menu 의 사용가능 여부를 설정하는 속성입니다.
...
```
```javascript
this.Menu00.enable = true; 
this.Menu00.enable = false;
```
- **`true`** — Menu 을(를) 사용할 수 있게 설정합니다.
- **`false`** — Menu 을(를) 사용할 수 없게 설정합니다.
...
> Components > Component > Menu > Property > enablecolumn
...
```javascript
Menu.enablecolumn[= strColumnID]
```

**Setting Syntax**

```javascript
this.Menu00.enablecolumn = "enablecolumn";
```
...
> Components > Component > Menu > Property > enableevent

**Description**

Menu 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.enableevent[= bEvent]
```
...
```
```javascript
this.Menu00.enableevent = true;  
this.Menu00.enableevent = false;
```
- **`true`** — Menu 에서 이벤트가 발생하도록 설정합니다.
- **`false`** — Menu 에서 이벤트가 발생하지 않도록 설정합니다.
...
> Components > Component > Menu > Property > fittocontents

**Description**

Menu 의 내부 컨텐츠영역이 컨텐츠 내용에 맞게 자동조정되는 영역을 설정하는 속성입니다.

**Syntax**

```javascript
Menu.fittocontents[= enumFitTo]
```
...
```
```javascript
this.Menu00.fittocontents = "width";
```
- **`"none"`** — 컨텐츠 내용과 관계없이 디자인 시 설정한 Menu 의 너비와 높이를 유지합니다.
- **`"width"`** — 컨텐츠 내용에 맞게 Menu 의 내부 컨텐츠영역 너비를 자동 조정합니다.
- **`"height"`** — 컨텐츠 내용에 맞게 Menu 의 내부 컨텐츠영역 높이를 자동 조정합니다.
- **`"both"`** — 컨텐츠 내용에 맞게 Menu 의 내부 컨텐츠영역 너비와 높이를 자동 조정합니다.

**Remark**

- fittocontents 속성값을 설정하지 않으면 "none" 으로 적용됩니다.

- Menu 의 전체 크기는 내부 컨텐츠영역 크기에 -nexa-border, -nexa-padding 영역을 더해서 결정됩니다.

- Form 이 로딩될 때와 fittocontents 속성값이 변경되었을 때만 내부 컨텐츠영역의 크기가 자동 조정됩니다.
   Bind 된 속성이나 스크립트에 의해 Menu 의 컨텐츠가 변경된 경우는 내부 컨텐츠영역의 크기가 자동 조정되지 않습니다.

- Bind 된 속성에 의해 Menu 의 컨텐츠가 변경되어 내부 컨텐츠영역의 크기가 다시 조정되어야 할 때는
   Form 의 onbindingvaluechanged 이벤트에서 resetScroll() 메소드를 실행하여 크기를 재조정 하여야 합니다.

- 스크립트에 의해 Menu 의 컨텐츠가 변경되어 내부 컨텐츠영역의 크기가 다시 조정되어야 할 때는
...
> Components > Component > Menu > Property > flexgrow
...
> Components > Component > Menu > Property > flexshrink
...
> Components > Component > Menu > Property > font

**Description**

Menu 에서 사용하는 폰트를 설정하는 속성입니다.
...
* Script ( normal property )
this.Menu00.font = "bold 12pt/30px arial, sans-serif";
```
...
> Components > Component > Menu > Property > height

**Description**

Menu 을(를) 표시하기 위한 높이를 설정하는 속성입니다.
...
```
```javascript
this.Menu00.height = 10; 
this.Menu00.height = "10px"; 
this.Menu00.height = 10%"; 
this.Menu00.height = Button00:10%";
```
- **`<strCompID>`** — Menu 의 높이를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 Menu 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 Menu 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 높이가 적용됩니다.
- **`<nVal>`** — Menu 의 높이를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.


* <strCompID> 값을 생략했을 때 :
- "px": Menu의 높이 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 Menu의 높이 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Menu의 높이 결정
- "rem": MainFrame font-size 속성값을 기준으로 Menu의 높이 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 Menu의 높이 결정
- "%": <strCompID>의 height 속성값을 기준으로 Menu의 높이 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Menu > Property > hotkey

**Description**

Menu 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.hotkey[= strHotkey]
```

**Setting Syntax**

```javascript
this.Menu00.hotkey = "G"; 
this.Menu00.hotkey = "CTRL+A"; 
this.Menu00.hotkey = "CTRL+ALT+X";
```
...
> Components > Component > Menu > Property > hotkeycolumn
...
```javascript
Menu.hotkeycolumn[= strColumnID]
```

**Setting Syntax**

```javascript
this.Menu00.hotkeycolumn = "hotkeycolumn";
```
...
> Components > Component > Menu > Property > iconcolumn
...
```javascript
Menu.iconcolumn[= strColumnID]
```

**Setting Syntax**

```javascript
this.Menu00.iconcolumn = "col_icon";
```
...
- 화면에 항상 표시되는 메인메뉴 아이템에는 아이콘이 표시되지 않습니다.
   메인메뉴 클릭 시 팝업되는 서브메뉴 아이템부터 아이콘이 텍스트 왼쪽에 표시됩니다.
...
> Components > Component > Menu > Property > id

**Description**

Menu의 고유 식별자를 설정하는 속성입니다.
...
> Components > Component > Menu > Property > idcolumn
...
```javascript
Menu.idcolumn[= strColumnID]
```

**Setting Syntax**

```javascript
this.Menu00.idcolumn = "idcolumn";
```
...
> Components > Component > Menu > Property > initvalueid

**Description**

Menu 에 적용될 InitValue 의 ID 를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.initvalueid[= strValueID]
```

**Setting Syntax**

- **`strValueID`** — InitValueDefinition 영역에 정의된 InitValue 파일에서 Menu 에 적용할 항목의 ID 를 문자열로 설정합니다.

**Remark**

- Menu 가 화면에 표시된 후에는 속성값을 설정하거나 변경 할 수 없습니다.
   Menu 를 동적으로 생성 시 show() 메소드 실행 전에 속성값을 설정하여야 합니다.
...
> Components > Component > Menu > Property > innerdataset

**Description**

Menu 의 메뉴 아이템이 정의된 DataSet 의 ID를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.innerdataset[= strDatasetID]
```

**Setting Syntax**

```javascript
this.Menu00.innerdataset = "DataSet00";
```
- **`strDatasetID`** — 메뉴 아이템이 정의된 DataSet의 ID를 문자열로 설정합니다.
...
> Components > Component > Menu > Property > layoutorder
...
> Components > Component > Menu > Property > left

**Description**

Menu 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다.
...
```javascript
this.Menu00.left = 10; 
this.Menu00.left = "10px"; 
this.Menu00.left = "10%"; 
this.Menu00.left = "Button00:10px"; 
this.Menu00.left = "Button00:10%";
```
- **`<strCompID>`** — Menu 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Menu 의 좌측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 left 속성값을 기준으로 Menu의 좌측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Menu의 좌측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Menu의 좌측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Menu의 좌측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 right 속성값을 기준으로 Menu의 좌측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 Menu의 좌측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Menu > Property > letter-spacing

**Description**

Menu 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다.

**Syntax**

```javascript
Menu.letterSpacing[= strspace]
```
...
> Components > Component > Menu > Property > levelcolumn
...
```javascript
Menu.levelcolumn[= strColumnID]
```

**Setting Syntax**

```javascript
this.Menu00.levelcolumn = "levelcolumn";
```
- **`strColumnID`** — 각 메뉴 아이템의 상/하위 관계가 정의된 Column의 ID를 문자열로 설정합니다.

**Remark**

- "0" 레벨인 메뉴 아이템은 Menu 컴포넌트에 항상 표시됩니다.
...
> Components > Component > Menu > Property > maxheight

**Description**

Menu 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.maxheight[= nMaxHeight]
```
...
```
```javascript
this.Menu00.maxheight = 20; 
this.Menu00.maxheight = "20px";
```
- **`<nVal>`** — Menu 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 maxheight 보다 크면 화면에 표시되는 Menu 의 높이는 maxheight 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 Menu 의 높이가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > Menu > Property > maxwidth

**Description**

Menu 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.maxwidth[= nMaxWidth]
```
...
```
```javascript
this.Menu00.maxwidth = 20; 
this.Menu00.maxwidth = "20px";
```
- **`<nVal>`** — Menu 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 maxwidth 보다 크면 화면에 표시되는 Menu 의 너비는 maxwidth 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 Menu 의 너비가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > Menu > Property > minheight

**Description**

Menu 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.minheight[= nMinHeight]
```
...
```
```javascript
this.Menu00.minheight = 20; 
this.Menu00.minheight = "20px";
```
- **`<nVal>`** — Menu 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 minheight 보다 작다면 화면에 표시되는 Menu 의 높이는 minheight 속성값으로 적용됩니다.
  표시되는 높이만 적용되고 height 속성값은 변경되지 않습니다.
...
> Components > Component > Menu > Property > minwidth

**Description**

Menu 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.minwidth[= nMinWidth]
```
...
```
```javascript
this.Menu00.minwidth = 20; 
this.Menu00.minwidth = "20px";
```
- **`<nVal>`** — Menu 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 minwidth 보다 작으면 화면에 표시되는 Menu 의 너비는 minwidth 속성값으로 적용됩니다.
  표시되는 너비만 적용되고 width 속성값은 변경되지 않습니다.
...
> Components > Component > Menu > Property > name

**Description**

Menu 의 이름을 설정하는 속성입니다.
...
> Components > Component > Menu > Property > navigationbuttonsize

**Description**

표시해야 할 메뉴아이템의 너비가 Menu 의 너비보다 클 때 표시되는 스크롤 버튼의 너비를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.navigationbuttonsize[= nSize]
```

**Setting Syntax**

```javascript
this.Menu00.navigationbuttonsize = 30;
```
- **`nSize`** — 메뉴 리스트의 좌/우에 표시되는 스크롤버튼(prevbutton/nextbutton)의 너비를 pixel 단위의 숫자로 설정합니다.

설정값은 각 버튼에 동일하게 적용됩니다.

**Remark**

- navigationbuttonsize 속성값을 설정하지 않으면 "아이콘너비 + 좌/우padding값" 으로 자동 적용됩니다.

- 스크롤버튼(prevbutton/nextbutton)은 표시해야 할 메뉴아이템의 너비가 Menu 의 너비보다 클 때
  메뉴리스트의 좌/우에 자동으로 표시됩니다.

- prevbutton 클릭 시 메뉴리스트가 왼쪽으로 스크롤 되고, nextbutton 클릭 시 오른쪽으로 스크롤 됩니다.

- 서브메뉴에 표시되는 스크롤버튼(prevbutton/nextbutton)의 높이는 popupnavigationbuttonsize 속성에 설정합니다.

**See Also**

Menu.popupnavigationbuttonsize
...
> Components > Component > Menu > Property > opacity

**Description**

Menu 영역의 투명도를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.opacity[= stropacity]
```
...
* Script ( normal property )
this.Menu00.opacity = "0.8";
this.Menu00.opacity = 0.8;
this.Menu00.opacity = "80%";
```
...
> Components > Component > Menu > Property > parent

**Description**

Menu 의 부모 오브젝트를 갖는 읽기전용 속성입니다.
...
```javascript
var objParent = this.Menu00.parent;
```
...
- Menu 이(가) Div 와 같은 컨테이너 컴포넌트에 자식으로 존재한다면 parent 속성은 해당 컨테이너 컴포넌트를 갖습니다.
...
> Components > Component > Menu > Property > popupitemheight

**Description**

Menu 에서 하위 메뉴가 표시될 때 각 메뉴항목의 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.popupitemheight[= nHeight]
```

**Setting Syntax**

```javascript
this.Menu00.popupitemheight = 20;
```
...
### popupnavigationbuttonsize

> Components > Component > Menu > Property > popupnavigationbuttonsize

**Description**

표시해야 할 서브메뉴아이템의 높이가 SubMenu 의 높이보다 클 때 표시되는 스크롤 버튼의 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.popupnavigationbuttonsize[= nSize]
```

**Setting Syntax**

```javascript
this.Menu00.popupnavigationbuttonsize = 30;
```
- **`nSize`** — 서브메뉴 리스트의 상/하에 표시되는 스크롤버튼(prevbutton/nextbutton)의 높이를 pixel 단위의 숫자로 설정합니다.

설정값은 각 버튼에 동일하게 적용됩니다.

**Remark**

- popupnavigationbuttonsize 속성값을 설정하지 않으면 "아이콘높이 + 상/하padding값" 으로 자동 적용됩니다.

- 스크롤버튼(prevbutton/nextbutton)은 표시해야 할 서브메뉴아이템의 높이가 SubMenu 의 높이보다 클 때
  서브메뉴리스트의 상/하에 자동으로 표시됩니다.

- prevbutton 클릭 시 서브메뉴리스트가 윗쪽으로 스크롤 되고, nextbutton 클릭 시 아랫쪽으로 스크롤 됩니다.

- 메인메뉴에 표시되는 스크롤버튼(prevbutton/nextbutton)의 너비는 navigationbuttonsize 속성에 설정합니다.

**See Also**

Menu.navigationbuttonsize
...
> Components > Component > Menu > Property > popuptype

**Description**

Menu 에서 하위 메뉴가 표시되는 방식을 설정하는 속성입니다.

**Syntax**

```javascript
Menu.popuptype[= enumType]
```
...
```
```javascript
this.Menu00.popuptype  = "normal";
```
- **`"none"`** — 하위 메뉴를 화면에 표시하지 않습니다.
- **`"normal"`** — 하위 메뉴가 표시되는 일반적인 규칙을 따릅니다.
- **`"center"`** — Application이 실행중인 화면의 중앙에 하위 메뉴가 표시됩니다
...
- 다중 모니터의 경우 Menu 가 표시되고 있는 모니터를 기준으로 하위 메뉴가 표시됩니다.
...
> Components > Component > Menu > Property > positionstep

**Description**

부모 오브젝트가 화면분할기능을 사용할 때 Menu 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.positionstep[= nStep]
```

**Setting Syntax**

```javascript
this.Menu00.positionstep = 0; 
this.Menu00.positionstep = -1;
```
- **`nStep`** — Menu 이(가) 표시될 분할화면의 인덱스를 설정합니다.
"-1" 로 설정하면 모든 분할화면에 Menu 이(가) 표시됩니다.
...
> Components > Component > Menu > Property > right

**Description**

Menu 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.Menu00.right = 10; 
this.Menu00.right = "10px"; 
this.Menu00.right = "10%"; 
this.Menu00.right = "Button00:10px"; 
this.Menu00.right = "Button00:10%";
```
- **`<strCompID>`** — Menu 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Menu 의 우측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 right 속성값을 기준으로 Menu의 우측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Menu의 우측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Menu의 우측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Menu의 우측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 left 속성값을 기준으로 Menu의 우측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 Menu의 우측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Menu > Property > rtl

**Description**

Menu 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다.
...
```
```javascript
var vRtl = this.Menu00.rtl;
```
- **`undefined`** — undefined 설정 시 상위 컴포넌트의 rtl 속성값이 적용됩니다.

사용자가 rtl 속성값을 설정하지 않거나 삭제했을 경우 undefined 가 설정됩니다.
- **`true`** — Menu 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 오른쪽으로 설정합니다.
Menu 의 내부 좌표계의 기준을 오른쪽으로 설정합니다.
Menu 의 텍스트 표시 기준을 오른쪽으로 설정합니다.
수직스크롤바가 있을 경우 왼쪽에 표시됩니다.
- **`false`** — Menu 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
Menu 의 내부 좌표계의 기준을 왼쪽으로 설정합니다.
Menu 의 텍스트 표시 기준을 왼쪽으로 설정합니다.
...
- Menu 부터 Environment 까지 상위의 모든 rtl 속성값이 undefined 이면
...
> Components > Component > Menu > Property > tablecellarea
...
> Components > Component > Menu > Property > taborder

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 Menu 의 순서를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.taborder[= nTabOrder]
```
...
> Components > Component > Menu > Property > tabstop

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 Menu 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Menu.tabstop[= bTabStop]
```
...
bTabStop ::= 'true' | 'false'
```
- **`"true"`** — Menu 이(가) 탭키 입력에 의한 포커스를 받습니다.
- **`"false"`** — Menu 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
...
> Components > Component > Menu > Property > tooltiptext

**Description**

Menu 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다.

**Syntax**

```javascript
Menu.tooltiptext[= strToolTipText]
```

**Setting Syntax**

```javascript
this.Menu00.tooltiptext = "This is ToolTip Text"; this.Menu00.tooltiptext = "";          // 풍선 도움말이 표시되지 않습니다. 
this.Menu00.tooltiptext = null;        // 상위 컴포넌트의 풍선 도움말이 표시됩니다.
```
...
- 마우스 포인터가 Menu 영역 위에서 일정시간 움직이지 않으면 풍선도움말이 표시됩니다.
...
> Components > Component > Menu > Property > tooltiptype

**Description**

Menu 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다.

**Syntax**

```javascript
Menu.tooltiptype[= enumTooltipType]
```
...
```
```javascript
this.Menu00.tooltiptype = "hover";
```
- **`"default"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Menu 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"hover"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Menu 영역내에 멈춰서 일정시간이 경과하면 풍선도움말이 사라집니다.
Menu 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경되거나 사라진 풍선도움말이 다시 표시됩니다.
- **`"inplace"`** — Menu 의 좌측상단 안쪽에 풍선도움말을 표시합니다.

마우스 포인터가 Menu 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"default,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Menu 영역에 있으면 풍선도움말이 사라지지 않습니다.
- **`"hover,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Menu 영역에 있으면 풍선도움말이 사라지지 않습니다.
Menu 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경됩니다.
- **`"inplace,mouseleave"`** — Menu 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
- 표시되었다가 사라진 풍선도움말은 마우스 포인터가 Menu 영역을 나갔다가 들어오면 다시 표시됩니다.

- 마우스 포인터가 Menu 영역에서 벗어나면 풍선도움말이 사라집니다.
...
> Components > Component > Menu > Property > top

**Description**

Menu 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다.
...
```javascript
this.Menu00.top = 10; 
this.Menu00.top = "10px"; 
this.Menu00.top = "10%"; 
this.Menu00.top = "Button00:10px"; 
this.Menu00.top = "Button00:10%";
```
- **`<strCompID>`** — Menu 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Menu의 상단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 top 속성값을 기준으로 Menu의 상단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 Menu의 상단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Menu의 상단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Menu의 상단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 bottom 속성값을 기준으로 Menu의 상단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 Menu의 상단 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Menu > Property > userdatacolumn
...
```javascript
Menu.userdatacolumn[= strColumnID]
```

**Setting Syntax**

```javascript
this.Menu00.userdatacolumn = "userdatacolumn";
```
...
> Components > Component > Menu > Property > visible

**Description**

Menu 이(가) 화면에 표시될지 여부를 설정하는 속성입니다.
...
```
```javascript
this.Menu00.visible = true; 
this.Menu00.visible = false;
```
- **`"true"`** — Menu 을(를) 화면에 표시합니다.
- **`"false"`** — Menu 을(를) 화면에 표시하지 않습니다.
...
> Components > Component > Menu > Property > width

**Description**

Menu 을(를) 표시하기 위한 너비를 설정하는 속성입니다.
...
```
```javascript
this.Menu00.width = 10; this.Menu00.width = "10px"; 
this.Menu00.width = "10%"; 
this.Menu00.width = "Button00:10%";
```
- **`<strCompID>`** — Menu 의 너비를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 Menu 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 Menu 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 너비가 적용됩니다.
- **`<nVal>`** — Menu 의 너비를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": Menu의 너비 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Menu의 너비 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Menu의 너비 결정
- "rem": MainFrame font-size 속성값을 기준으로 Menu의 너비 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 Menu의 너비 결정
- "%": <strCompID>의 width 속성값을 기준으로 Menu의 너비 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Menu > Property > word-spacing

**Description**

Menu 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다.

**Syntax**

```javascript
Menu.wordSpacing[= strwordspacing]
```
...
> Components > Component > Menu > Method > addEvent

**Description**

Menu 에 특정 이벤트를 선언하여 추가하는 메소드입니다.

**Syntax**

```javascript
Menu.addEvent( strEventID )
```
...
| --- | --- | --- |
| strEventID | String | Menu 에 추가할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.Menu00.addEvent( "onmove" );
```
...
- Menu 에서 특정 이벤트를 제거하려면 removeEvent() 메소드를 사용하여야 합니다.
...
> Components > Component > Menu > Method > addEventHandler

**Description**

Menu 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다.

**Syntax**

```javascript
Menu.addEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.Menu00_onmove = function( obj:nexacro.Menu,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Menu00.addEventHandler( "onmove", this.Menu00_onmove, this);
```
...
> Components > Component > Menu > Method > addEventHandlerLookup

**Description**

함수를 검색하여 Menu 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다.

**Syntax**

```javascript
Menu.addEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.Menu00_onmove = function( obj:nexacro.Menu,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Menu00.addEventHandlerLookup( "onmove", "Menu00_onmove", this);
```
...
> Components > Component > Menu > Method > bringToFront

**Description**

부모가 동일한 컴포넌트 중 Menu 이(가) 화면의 제일 앞에 표시되게 합니다.
...
- bringToFront() 메소드는 Menu 을(를) 가장 나중에 표시되게 순서를 바꿉니다.
...
> Components > Component > Menu > Method > bringToPrev

**Description**

부모가 동일한 컴포넌트 중 Menu 이(가) 화면에 한단계 앞에 표시되게 합니다.
...
- bringToPrev() 메소드는 Menu 을(를) 한단계 나중에 표시되는 컴포넌트와 순서를 바꿉니다.
...
> Components > Component > Menu > Method > cancelPopup

**Description**

Menu 에 표시된 하위메뉴를 닫는 메소드입니다.
...
var bSucc = this.Menu00.cancelPopup();

**Return**

| Type | Description |
| --- | --- |
| Boolean | 하위메뉴 닫기에 성공하면 "true"를 반환합니다.
하위메뉴 닫기에 실패하면 "false"를 반환합니다. |
...
> Components > Component > Menu > Method > clearEventHandler
...
```javascript
Menu.clearEventHandler( strEventID )
```
...
```javascript
var nCnt = this.Menu00.clearEventHandler( "onmove" );
```
...
> Components > Component > Menu > Method > destroy

**Description**

스크립트에서 동적으로 생성한 Menu 을(를) 삭제하는 메소드입니다.
...
var bSucc = this.Menu00.destroy();

**Return**

| Type | Description |
| --- | --- |
| Boolean | Menu 이(가) 정상적으로 삭제되면 true 를 반환합니다.

Menu 이(가) 정상적으로 삭제되지 않으면 false 를 반환합니다. |

**Remark**

- 동적으로 생성한 Menu 을(를) 완전히 삭제하기 위해서는 destroy() 메소드를 호출해야 합니다.

**See Also**

Form.addChildForm.insertChildForm.removeChildMenu.initMenu.show
...
> Components > Component > Menu > Method > findEventHandler

**Description**

Menu 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다.

**Syntax**

```javascript
Menu.findEventHandler( strEventID, objFunc, objTarget )
```
...
var nIndex = this.Menu00.findEventHandler( "onmove", this.Menu00_onmove, this );
```
...
> Components > Component > Menu > Method > getEventHandler

**Description**

Menu 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다.

**Syntax**

```javascript
Menu.getEventHandler( strEventID, nIdx )
```
...
```javascript
var objFunc = Menu00.getEventHandler( "onmove", 0 );
```
...
> Components > Component > Menu > Method > getInnerDataset

**Description**

Menu 의 innerdataset 속성에 설정되어 있는 DataSet 오브젝트를 반환하는 메소드입니다.

**Syntax**

```javascript
Menu.getInnerDataset()
```

**Parameters**

var objDS = this.Menu00.getInnerDataset();
...
> Components > Component > Menu > Method > getOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Menu 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
Menu.getOffsetBottom();
```

**Parameters**

var nBottom = this.Menu.getOffsetBottom();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 Menu 의 bottom 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 Menu 의 bottom 값을 동적으로 계산합니다.
...
> Components > Component > Menu > Method > getOffsetHeight

**Description**

Menu 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nHeight = this.Menu.getOffsetHeight();

**Return**

| Type | Description |
| --- | --- |
| Number | Menu 의 높이를 픽셀단위의 숫자로 변환하여 반환합니다. |

**Remark**

- 화면에 표시된 Menu 의 높이를 동적으로 계산합니다.
...
> Components > Component > Menu > Method > getOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Menu 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nleft = this.Menu.getOffsetLeft();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 Menu 의 left 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 Menu 의 left 값을 동적으로 계산합니다.
...
> Components > Component > Menu > Method > getOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Menu 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nRight = this.Menu.getOffsetRight();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 Menu 의 right 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 Menu 의 right 값을 동적으로 계산합니다.
...
> Components > Component > Menu > Method > getOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Menu 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nTop = this.Menu.getOffsetTop();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 Menu 의 top 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 Menu 의 top 값을 동적으로 계산합니다.
...
> Components > Component > Menu > Method > getOffsetWidth

**Description**

Menu 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nWidth = this.Menu.getOffsetWidth();

**Return**

| Type | Description |
| --- | --- |
| Number | Menu 의 너비를 픽셀단위의 숫자로 변환하여 반환합니다. |

**Remark**

- 화면에 표시된 Menu 의 너비를 동적으로 계산합니다.
...
> Components > Component > Menu > Method > getPixelBottom

**Description**

Menu 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nbottom = this.Menu.getPixelBottom();

**Return**

| Type | Description |
| --- | --- |
| Number | Menu 의 bottom 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Menu > Method > getPixelHeight

**Description**

Menu 의 height 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nheight = this.Menu.getPixelHeight();

**Return**

| Type | Description |
| --- | --- |
| Number | Menu 의 height 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Menu > Method > getPixelLeft

**Description**

Menu 의 left 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nleft = this.Menu.getPixelLeft();

**Return**

| Type | Description |
| --- | --- |
| Number | Menu 의 left 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Menu > Method > getPixelRight

**Description**

Menu 의 right 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nright = this.Menu.getPixelRight();

**Return**

| Type | Description |
| --- | --- |
| Number | Menu 의 right 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Menu > Method > getPixelTop

**Description**

Menu 의 top 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var ntop = this.Menu.getPixelTop();

**Return**

| Type | Description |
| --- | --- |
| Number | Menu 의 top 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Menu > Method > getPixelWidth

**Description**

Menu 의 width 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nwidth = this.Menu.getPixelWidth();

**Return**

| Type | Description |
| --- | --- |
| Number | Menu 의 width 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Menu > Method > init

**Description**

스크립트로 Menu 을(를) 동적 생성한 후에 초기화하는 메소드입니다.
...
| vLeft | String, Number | Menu 의 left 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 right 속성값을 기준으로 Menu 의 left 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 Menu 의 left 가 결정됩니다. |
| vTop | String, Number | Menu 의 top 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 bottom 속성값을 기준으로 Menu 의 top 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Menu 의 top 이 결정됩니다. |
| vWidth | String, Number | Menu 의 width 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 Menu 의 width 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 Menu 의 width 가 결정됩니다. |
| vHeight | String, Number | Menu 의 height 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 Menu 의 height 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Menu 의 height 가 결정됩니다. |
| vRight | String, Number | Menu 의 right 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vLeft, vWidth 값을 모두 설정했을 경우 vRight 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 left 속성값을 기준으로 Menu 의 right 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 Menu 의 right 가 결정됩니다. |
| vBottom | String, Number | Menu 의 bottom 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vTop, vHeight 값을 모두 설정했을 경우 vBottom 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 top 속성값을 기준으로 Menu 의 bottom 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Menu 의 bottom 이 결정됩니다. |
| vMinWidth | String, Number | Menu 이(가) 화면에 표시되는 최소 너비값을 pixel 단위의 숫자로 설정합니다. |
| vMaxWidth | String, Number | Menu 이(가) 화면에 표시되는 최대 너비값을 pixel 단위의 숫자로 설정합니다.

vMinWidth 보다 작은 값을 설정하면 vMinWidth 값으로 설정됩니다. |
| vMinHeight | String, Number | Menu 이(가) 화면에 표시되는 최소 높이값을 pixel 단위의 숫자로 설정합니다. |
| vMaxHeight | String, Number | Menu 이(가) 화면에 표시되는 최대 높이값을 pixel 단위의 숫자로 설정합니다.
...
```javascript
var objComp = new Menu();

objComp.init( "Menu00", 30, 120, 196, 46 );
objComp.init( "Menu00", 30, 120, 196, 46, null, null );
objComp.init( "Menu00", null, null, 300, "400px", "80%", 300 );
objComp.init( "Menu00", 0, 0, 200, 100, null, null, 300, 500, 200, 500 );
objComp.init( "Menu00", "Menu22:10", 300, null, null, "Menu33:10", "20%", 300, 500, 200, 500 );
```
...
- 인수값에 기준 컴포넌트를 포함하면 Menu 의 위치는 기준 컴포넌트를 기준으로 상대적으로 결정됩니다.
  vLeft, vTop, vWidth, vHeight, vRight, vBottom 값에 기준 컴포넌트를 포함할 때는 "ID:Value" 형태로 설정하여야 합니다.

- 기준 컴포넌트는 Menu 와(과) 부모(Parent)가 동일하여야 하며, Form 로딩 시 Menu 보다 먼저 생성되어야 합니다.
...
Form.addChildForm.insertChildForm.removeChildMenu.destroyMenu.show
...
> Components > Component > Menu > Method > insertEventHandler

**Description**

Menu 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다.

**Syntax**

```javascript
Menu.insertEventHandler( strEventID, nIndex, objFunc, objTarget )
```
...
var nIndex = this.Menu00.insertEventHandler( "onmove", 0, this.Menu00_onmove, this);
```
...
> Components > Component > Menu > Method > isPopup

**Description**

Menu 에 하위메뉴가 표시되어 있는지 여부를 반환하는 메소드입니다.
...
var bStates = this.Menu00.isPopup();

**Return**

| Type | Description |
| --- | --- |
| Boolean | Menu에 하위메뉴가 표시되어 있으면 "true"를 반환합니다.
Menu에 하위메뉴가 표시되어 있지 않으면 "false"를 반환합니다. |
...
> Components > Component > Menu > Method > move

**Description**

Menu 의 위치와 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
Menu.move( vLeft, vTop [, vWidth, vHeight [, vRight, vBottom]] )
```
...
```javascript
this.Menu00.move(10,10);
this.Menu00.move(10,10,100,100);
this.Menu00.move(null, null, 300, "400px", "80%", 300 );
```
...
> Components > Component > Menu > Method > moveToNext

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Menu 이(가) 화면에 한단계 뒤에 표시되게 합니다.

**Syntax**

```javascript
Menu.moveToNext( objComp )
Menu.moveToNext( strComp )
```
...
```javascript
this.Menu.moveToNext( this.Button00 );
this.Menu.moveToNext( "Button00" );
```
...
- 인수로 전달되는 기준 컴포넌트와 Menu 은(는) 부모가 동일하여야 합니다.

- 디자인 시 소스에 컴포넌트가 선언된 순서대로 화면에 표시됩니다.
  소스에서 위에 선언된 컴포넌트가 먼저 표시되고, 아래에 선언된 컴포넌트가 나중에 표시되게 됩니다.
  컴포넌트가 겹쳐져 있을 경우 화면에 표시되는 순서에 따라 먼저 표시된 컴포넌트가 나중에 표시되는 컴포넌트에 가려지게 됩니다.

- moveToNext() 메소드는 기준 컴포넌트보다 Menu 이(가) 한단계 먼저 표시되게 순서를 바꿉니다.
...
> Components > Component > Menu > Method > moveToPrev

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Menu 이(가) 화면에 한단계 앞에 표시되게 합니다.

**Syntax**

```javascript
Menu.moveToPrev( objComp )
Menu.moveToPrev( strComp )
```
...
```javascript
this.Menu.moveToPrev( this.Button00 );
this.Menu.moveToPrev( "Button00" );
```
...
- moveToPrev() 메소드는 기준 컴포넌트보다 Menu 이(가) 한단계 나중에 표시되게 순서를 바꿉니다.
...
> Components > Component > Menu > Method > removeEvent

**Description**

Menu 에 선언된 특정 이벤트를 삭제하는 메소드입니다.

**Syntax**

```javascript
Menu.removeEvent( strEventID )
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| strEventID | String | Menu 에서 삭제할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.Menu00.removeEvent( "onmove" );
```
...
- Menu 에 특정 이벤트를 추가하려면 addEvent() 메소드를 사용하여야 합니다.

- Menu 에 기본으로 선언되어 있는 이벤트 삭제 시 오동작 할 수 있으므로 주의하여야 합니다.
...
> Components > Component > Menu > Method > removeEventHandler

**Description**

Menu 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
Menu.removeEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.Menu00_onmove = function( obj:nexacro.Menu,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Menu00.removeEventHandler( "onmove", this.Menu00_onmove, this);
```
...
> Components > Component > Menu > Method > removeEventHandlerLookup

**Description**

Menu 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
Menu.removeEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.Menu00_onmove = function( obj:nexacro.Menu,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Menu00.removeEventHandlerLookup( "onmove", "Menu00_onmove", this);
```
...
> Components > Component > Menu > Method > resize

**Description**

Menu 의 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
Menu.resize( vWidth, vHeight )
```
...
- Menu 의 left 속성값이 null 이 아니면 resize() 메소드 실행 후 Menu 의 우측 위치가 변경됩니다.
  또한, 메소드 실행 후 right 속성값은 null 이 됩니다.

- Menu 의 left 속성값이 null 이면 resize() 메소드 실행 후 Menu 의 좌측 위치가 변경됩니다.
  또한, 메소드 실행 후 left 속성값은 null 로 유지됩니다.

- Menu 의 top 속성값이 null 이 아니면 resize() 메소드 실행 후 Menu 의 하단 위치가 변경됩니다.
  또한, 메소드 실행 후 bottom 속성값은 null 이 됩니다.

- Menu 의 top 속성값이 null 이면 resize() 메소드 실행 후 Menu 의 상단 위치가 변경됩니다.
...
> Components > Component > Menu > Method > sendToBack

**Description**

부모가 동일한 컴포넌트 중 Menu 이(가) 화면의 제일 뒤에 표시되게 합니다.
...
- sendToBack() 메소드는 Menu 을(를) 가장 먼저 표시되게 순서를 바꿉니다.
...
> Components > Component > Menu > Method > sendToNext

**Description**

부모가 동일한 컴포넌트 중 Menu 이(가) 화면에 한단계 뒤에 표시되게 합니다.
...
- sendToNext() 메소드는 Menu 을(를) 한단계 먼저 표시되는 컴포넌트와 순서를 바꿉니다.
...
> Components > Component > Menu > Method > setEventHandler

**Description**

Menu 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다.

**Syntax**

```javascript
Menu.setEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.Menu00_onmove = function( obj:nexacro.Menu,  e:nexacro.MoveEventInfo ) { //수행할 스크립트 };
var nIndex = this.Menu00.setEventHandler( "onmove", this.Menu00_onmove, this );
```
...
> Components > Component > Menu > Method > setEventHandlerLookup

**Description**

Menu 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다.

**Syntax**

```javascript
Menu.setEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.Menu00_onmove = function( obj:nexacro.Menu,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Menu00.setEventHandlerLookup( "onmove", "Menu00_onmove", this);
```
...
> Components > Component > Menu > Method > setFocus

**Description**

Menu 에 포커스를 설정하는 메서드입니다.

**Syntax**

```javascript
Menu.setFocus( [bMoveScroll] )
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| bMoveScroll | Boolean | 부모 컴포넌트에 스크롤이 있을 경우, Menu 기준으로 스크롤을 이동할지 여부를 설정합니다.

true: Menu 이(가) 화면에 표시되도록 스크롤을 이동합니다.
false: Menu 위치와 관계없이 스크롤을 이동하지 않습니다.
...
```javascript
var objBefComp = this.Menu00.setFocus();
var objBefComp = this.Menu00.setFocus( false );
```
...
| Type | Description |
| --- | --- |
| Object | Menu 이(가) 포커스를 얻기 전에 포커스를 가지고 있던 컴포넌트를 반환합니다.
...
> Components > Component > Menu > Method > setInnerDataset

**Description**

Menu 의 innerdataset 속성에 인수로 전달된 DataSet 오브젝트를 설정하는 메소드입니다.

**Syntax**

```javascript
Menu.setInnerDataset( objDataset )
```
...
```javascript
this.Menu00.setInnerDataset( this.DataSet00 );
```
...
> Components > Component > Menu > Method > setOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Menu 의 bottom 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Menu.setOffsetBottom( nBottom );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nBottom | Number | 부모 컴포넌트의 Top 위치를 기준으로 Menu 의 bottom 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Menu.setOffsetBottom( 10 );
```
...
- 메소드 실행 전 Menu 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Menu 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > Menu 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > Menu 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 height, bottom 속성이 설정됩니다.
...
> Components > Component > Menu > Method > setOffsetHeight

**Description**

Menu 의 높이를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Menu.setOffsetHeight( nHeight );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nHeight | Number | Menu 의 높이를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Menu.setOffsetHeight( 10 );
```
...
> Components > Component > Menu > Method > setOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Menu 의 left 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Menu.setOffsetLeft( nLeft );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nLeft | Number | 부모 컴포넌트의 Left 위치를 기준으로 Menu 의 left 값을 픽셀단위의 숫자로 설정합니다 |

**Sample Call**

```javascript
this.Menu.setOffsetLeft( 10 );
```
...
- 메소드 실행 전 Menu 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Menu 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > Menu 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, right 속성이 설정됩니다.
   > Menu 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
...
> Components > Component > Menu > Method > setOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Menu 의 right 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Menu.setOffsetRight( nRight );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nRight | Number | 부모 컴포넌트의 Left 위치를 기준으로 Menu 의 right 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Menu.setOffsetRight( 600 );
```
...
- 메소드 실행 전 Menu 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Menu 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > Menu 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > Menu 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 width, right 속성이 설정됩니다.
...
> Components > Component > Menu > Method > setOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Menu 의 top 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Menu.setOffsetTop( nTop );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nTop | Number | 부모 컴포넌트의 Top 위치를 기준으로 Menu 의 top 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Menu.setOffsetTop( 10 );
```
...
- 메소드 실행 전 Menu 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Menu 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > Menu 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, bottom 속성이 설정됩니다.
   > Menu 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
...
> Components > Component > Menu > Method > setOffsetWidth

**Description**

Menu 의 너비를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Menu.setOffsetWidth( nWidth );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nWidth | Number | Menu 의 너비를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Menu.setOffsetWidth( 10 );
```
...
> Components > Component > Menu > Method > show

**Description**

스크립트로 동적 생성한 Menu 을(를) 화면에 표시하는 메소드입니다.
...
Form.addChildForm.insertChildForm.removeChildMenu.destroyMenu.init
...
> Components > Component > Menu > Method > trackPopup

**Description**

최상위 메뉴 아이템의 하위메뉴를 특정 위치에 팝업으로 표시하는 메소드입니다.

**Syntax**

```javascript
Menu.trackPopup( nIndex, nXpos, nYpos [,bCapture])
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nIndex | Number | levelColumn 속성값이 0인 menuitem의 순번을 숫자로 설정합니다.
첫 번째 menuitem의 nIndex 값은 0이고 두 번째 menuitem의 nIndex 값은 1이 됩니다. |
| nXpos | Number | Menu 컴포넌트 왼쪽 경계선 위치(getOffsetLeft)를 기준값(0)으로 설정하고 팝업 메뉴를 표시할 x 좌표 위치를 숫자로 설정합니다. |
| nYpos | Number | Menu 컴포넌트 아래쪽 경계선 위치(getOffsetBottom)를 기준값(0)으로 설정하고 팝업 메뉴를 표시할 y 좌표 위치를 숫자로 설정합니다. |
| bCapture | Boolean | 팝업되는 하위메뉴에 Capture 특성을 부여할 지 설정합니다.

"true" 설정 시 Capture 특성을 갖고 하위메뉴가 표시됩니다.
"false" 설정 시 Capture 특성 없이 하위메뉴가 표시됩니다.
...
```javascript
var bSuccess = this.Menu00.trackPopup(0, 10, 10);
var bSuccess = this.Menu00.trackPopup(0, 10, 10, false);
```
...
| Type | Description |
| --- | --- |
| Boolean | 메뉴 팝업에 성공하면 true를 반환합니다.
메뉴 팝업에 실패하면 false를 반환합니다. |

**Remark**

- 마우스를 클릭한 위치에 팝업 메뉴를 표시하고자 한다면 아래와 같은 코드를 사용할 수 있습니다.
  예)
  this.Form1_onrbuttondown = function(obj:nexacro.Form,e:nexacro.MouseEventInfo)
  {
    if (this.Menu00.isPopup() == false)
    {
      var zero_x = this.Menu00.getOffsetLeft();
      var zero_y = this.Menu00.getOffsetBottom();
      this.Menu00.trackPopup(1, e.clientx-zero_x, e.clienty-zero_y);
    }
  };

- 하위메뉴에 Capture 특성이 없다면 다른 컴포넌트 선택 시 하위메뉴가 사라지면서 포커스가 다른 컴포넌트로 바로 이동합니다.
  하위메뉴에 Capture 특성이 있다면 다른 컴포넌트 선택 시 첫번째 선택으로 하위메뉴가 사라지고, 두번째 선택으로 포커스가 이동합니다.

◆ Mobile 제약
- iOS/iPadOS 운영체제에서 Safari 브라우저 실행 시에 화면에 표시되지 않는 menuitem을 nIndex 파라미터 값으로 설정했을 때 nXpos, nYpos 파라미터 값으로 지정한 위치에 팝업이 표시되는 것을 보장할 수 없습니다.
  Safari 브라우저에서는 화면에 표시되지 않은 대상의 정확한 좌표 정보를 제공하지 않으며 이로 인해 정확한 좌표 값을 처리할 수 없습니다.
...
> Components > Component > Menu > Event > oncontextmenu
...
> Components > Component > Menu > Event > ondevicebuttonup
...
> Components > Component > Menu > Event > ondrag
...
> Components > Component > Menu > Event > ondragenter
...
> Components > Component > Menu > Event > ondragleave
...
> Components > Component > Menu > Event > ondragmove
...
> Components > Component > Menu > Event > ondrop
...
> Components > Component > Menu > Event > oninnerdatachanged
...
> Components > Component > Menu > Event > onkeydown
...
> Components > Component > Menu > Event > onkeyup
...
> Components > Component > Menu > Event > onkillfocus
...
> Components > Component > Menu > Event > onlbuttondown
...
- 메뉴 컴포넌트에 포커스가 없었다면 이벤트 발생 후 포커스를 받고 onsetfocus 이벤트가 발생합니다.
...
> Components > Component > Menu > Event > onlbuttonup
...
> Components > Component > Menu > Event > onmenuclick
...
> Components > Component > Menu > Event > onmousedown
...
> Components > Component > Menu > Event > onmouseenter
...
> Components > Component > Menu > Event > onmouseleave
...
> Components > Component > Menu > Event > onmousemove
...
> Components > Component > Menu > Event > onmouseup
...
> Components > Component > Menu > Event > onmove
...
> Components > Component > Menu > Event > onrbuttondown
...
> Components > Component > Menu > Event > onrbuttonup
...
> Components > Component > Menu > Event > onsetfocus
...
> Components > Component > Menu > Event > onsize
...
> Components > Component > Menu > Event > ontouchend
...
> Components > Component > Menu > Event > ontouchmove
...
> Components > Component > Menu > Event > ontouchstart
...
## Components > Component > Menu > Objects
...
Menu 컴포넌트를 구성하는 하위 오브젝트입니다.


---

## Components > Component > Menu > MenuItemControl

### MenuItemControl

> Components > Component > Menu > Objects > MenuItemControl

**Description**

Menu 컴포넌트를 구성하는 MenuItemControl 오브젝트입니다.

**Remark**

- Menu 컴포넌트에 Item 으로 한개 이상 추가되는 Control 오브젝트입니다.

**Property**

| Name | Description |
| --- | --- |
| background | MenuItemControl 의 배경 영역을 설정하는 속성입니다. |
| border-radius | MenuItemControl 의 모서리 모양을 설정하는 속성입니다. |
| color | MenuItemControl 에 표시되는 텍스트의 색상을 설정하는 속성입니다. |
| cursor | MenuItemControl 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다. |
| font | MenuItemControl 에서 사용하는 폰트를 설정하는 속성입니다. |
| letter-spacing | MenuItemControl 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다. |
| -nexa-border | MenuItemControl 의 테두리를 설정하는 속성입니다. |
| -nexa-edge | MenuItemControl 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-padding | MenuItemControl 에서 텍스트와 테두리 사이의 여백을 설정하는 속성입니다. |
| -nexa-rtl-background-image | MenuItemControl 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다. |
| -nexa-rtl-edge-image | MenuItemControl 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-text-align | MenuItemControl 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다. |
| -nexa-text-decoration | MenuItemControl 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다. |
| -nexa-vertical-align | MenuItemControl 에 표시되는 텍스트 또는 컨텐츠의 세로 정렬 방식을 설정하는 속성입니다. |
| opacity | MenuItemControl 영역의 투명도를 설정하는 속성입니다. |
| word-spacing | MenuItemControl 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다. |
...
> Components > Component > Menu > Objects > MenuItemControl > Property > -nexa-border

**Description**

MenuItemControl 의 테두리를 설정하는 속성입니다.

**Syntax**

```javascript
MenuItemControl.-nexa-border
```
...
- -nexa-border 속성값에 의해 테두리가 설정되면 fittocontents 속성값을 기준으로 크기가 변경되는 영역이 달라집니다.
   > fittocontents 속성값에 의해 크기가 고정되는 방향은 텍스트 영역의 크기가 확대/축소 됩니다.
   > fittocontents 속성값에 의해 크기가 자동설정 되는 방향은 MenuItemControl 의 크기가 확대/축소 됩니다.
      예를 들어 fittocontents 속성값이 "width" 인 경우 너비는 MenuItemControl 이 변경되고, 높이는 텍스트 영역이 변경됩니다.
   > fittocontents 속성은 메인메뉴에만 적용되고, 팝업되는 서브메뉴에는 적용되지 않습니다.
...
> Components > Component > Menu > Objects > MenuItemControl > Property > -nexa-edge

**Description**

MenuItemControl 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
MenuItemControl.-nexa-edge
```
...
- MenuItemControl 내부에 테두리 형태로 이미지를 표시하고자 할 때 사용하는 속성입니다.
...
> Components > Component > Menu > Objects > MenuItemControl > Property > -nexa-padding

**Description**

MenuItemControl 에서 텍스트와 테두리 사이의 여백을 설정하는 속성입니다.

**Syntax**

```javascript
MenuItemControl.-nexa-padding
```
...
-nexa-padding : 5px 5px 5px 5px;
```
- **`<npadding>`** — MenuItemControl 에서 텍스트와 테두리 사이의 여백을 pixel 단위로 설정합니다.
...
- -nexa-padding 속성은 Menu 아이템에 표시되는 텍스트의 바깥영역에 적용됩니다.

- -nexa-padding 속성값에 의해 여백이 설정되면 fittocontents 속성값을 기준으로 크기가 변경되는 영역이 달라집니다.
   fittocontents 속성값에 의해 크기가 고정되는 방향은 텍스트 영역의 크기가 확대/축소 됩니다.
   fittocontents 속성값에 의해 크기가 자동설정 되는 방향은 MenuItemControl 의 크기가 확대/축소 됩니다.
   예를 들어 fittocontents 속성값이 "width" 인 경우 너비는 MenuItemControl 이 변경되고, 높이는 텍스트 영역이 변경됩니다.
...
> Components > Component > Menu > Objects > MenuItemControl > Property > -nexa-rtl-background-image

**Description**

MenuItemControl 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
MenuItemControl.-nexa-rtl-background-image
```
...
> Components > Component > Menu > Objects > MenuItemControl > Property > -nexa-rtl-edge-image

**Description**

MenuItemControl 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
MenuItemControl.-nexa-rtl-edge-image
```
...
> Components > Component > Menu > Objects > MenuItemControl > Property > -nexa-text-align

**Description**

MenuItemControl 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
MenuItemControl.-nexa-text-align
```
...
- MenuItemControl 의 너비보다 표시되는 텍스트의 길이가 크면 "right" 를 설정해도 "left" 로 동작됩니다.
...
> Components > Component > Menu > Objects > MenuItemControl > Property > -nexa-text-decoration

**Description**

MenuItemControl 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다.

**Syntax**

```javascript
MenuItemControl.-nexa-text-decoration
```
...
> Components > Component > Menu > Objects > MenuItemControl > Property > -nexa-vertical-align

**Description**

MenuItemControl 에 표시되는 텍스트 또는 컨텐츠의 세로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
MenuItemControl.-nexa-vertical-align
```
...
> Components > Component > Menu > Objects > MenuItemControl > Property > background

**Description**

MenuItemControl 의 배경 영역을 설정하는 속성입니다.

**Syntax**

```javascript
MenuItemControl.background
```
...
"left" 설정 시 MenuItemControl 의 왼쪽면과 이미지의 왼쪽면이 정렬되어 표시됩니다.
"center" 설정 시 MenuItemControl 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"right" 설정 시 MenuItemControl 의 오른쪽면과 이미지의 오른쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
"top" 설정 시 MenuItemControl 의 윗쪽면과 이미지의 윗쪽면이 정렬되어 표시됩니다.
"center" 설정 시 MenuItemControl 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"bottom" 설정 시 MenuItemControl 의 아랫쪽면과 이미지의 아랫쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
0 보다 작거나 100 보다 큰 값을 설정 시 MenuItemControl 의 영역을 벗어난 가상의 위치로 적용됩니다.
...
<angle> 값에 설정된 방향에 따라 시작점과 끝점의 위치가 결정됩니다.
예를 들어 <angle> 값이 "to left" 이면 MenuItemControl 의 right 위치가 시작점이 되고, left 위치가 끝점이 됩니다.
              <angle> 값이 "to right" 이면 MenuItemControl 의 left 위치가 시작점이 되고, right 위치가 끝점이 됩니다.
...
<bg-image> 또는 <linear-gradient> 값이 설정되어 있다면 배경색은 배경이미지 또는 그라데이션 아래에 표시됩니다.
<bg-image> 에 적용된 이미지에 투명으로 적용된 부분이 있거나 이미지가 MenuItemControl 영역보다 작다면 해당 영역에 배경색이 표시됩니다.
...
> Components > Component > Menu > Objects > MenuItemControl > Property > border-radius

**Description**

MenuItemControl 의 모서리 모양을 설정하는 속성입니다.

**Syntax**

```javascript
MenuItemControl.border-radius
```
...
> Components > Component > Menu > Objects > MenuItemControl > Property > color

**Description**

MenuItemControl 에 표시되는 텍스트의 색상을 설정하는 속성입니다.

**Syntax**

```javascript
MenuItemControl.color
```
...
> Components > Component > Menu > Objects > MenuItemControl > Property > cursor

**Description**

MenuItemControl 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
MenuItemControl.cursor
```
...
> Components > Component > Menu > Objects > MenuItemControl > Property > font

**Description**

MenuItemControl 에서 사용하는 폰트를 설정하는 속성입니다.

**Syntax**

```javascript
MenuItemControl.font
```
...
> Components > Component > Menu > Objects > MenuItemControl > Property > letter-spacing

**Description**

MenuItemControl 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다.

**Syntax**

```javascript
MenuItemControl.letter-spacing
```
...
> Components > Component > Menu > Objects > MenuItemControl > Property > opacity

**Description**

MenuItemControl 영역의 투명도를 설정하는 속성입니다.

**Syntax**

```javascript
MenuItemControl.opacity
```
...
> Components > Component > Menu > Objects > MenuItemControl > Property > word-spacing

**Description**

MenuItemControl 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다.

**Syntax**

```javascript
MenuItemControl.word-spacing
```
