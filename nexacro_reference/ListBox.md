...
첫번째 또는 마지막 아이템에서 위/아래 방향키 입력 시 마지막 또는 첫번째 아이템으로 이동합니다. |
...
이동된 위치의 아이템이 자동으로 선택됩니다. |
| 다중아이템 결정 | Shift+상하방향키 | multiselect 속성값이 true 일 때 다중아이템을 선택합니다.
Shift+상하방향키가 시작된 아이템을 기준으로 위 또는 아래 아이템이 연속적으로 선택됩니다. |
...
| Name | Description |
| --- | --- |
| acceptvaluetype | ListBox 에서 InnerDataset 에 없는 코드값을 스크립트로 value 속성에 설정할 때 처리방식을 결정하는 속성입니다. |
| accessibilityaction | ListBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다. |
| accessibilitydesclevel | ListBox 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| accessibilitydescription | ListBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다. |
| accessibilityenable | ListBox 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| accessibilitylabel | ListBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다. |
| accessibilityrole | ListBox에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다. |
| background | ListBox 의 배경 영역을 설정하는 속성입니다. |
| border-radius | ListBox 의 모서리 모양을 설정하는 속성입니다. |
| bottom | ListBox 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다. |
| box-shadow | ListBox 에 그림자 효과를 설정하는 속성입니다. |
| codecolumn | ListBox 의 아이템 리스트에서 코드값으로 사용될 Column을 설정하는 속성입니다. |
| color | ListBox 에 표시되는 텍스트의 색상을 설정하는 속성입니다. |
| cssclass | ListBox 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다. |
| cursor | ListBox 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다. |
| datacolumn | ListBox 의 아이템 리스트에서 데이터값으로 사용될 Column을 설정하는 속성입니다. |
| dragscrolltype | ListBox에서 터치 후 드래그로 스크롤이 발생할 경우, 스크롤 방향을 설정하는 속성입니다. |
| enable | ListBox 의 사용가능 여부를 설정하는 속성입니다. |
| enableevent | ListBox 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다. |
...
| font | ListBox 에서 사용하는 폰트를 설정하는 속성입니다. |
| height | ListBox 을(를) 표시하기 위한 높이를 설정하는 속성입니다. |
| hotkey | ListBox 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다. |
| hscrollbar | ListBox 의 서브컨트롤인 수평 스크롤바의 오브젝트를 갖는 읽기전용 속성입니다. |
| id | ListBox의 고유 식별자를 설정하는 속성입니다. |
| index | ListBox 의 아이템 중 선택된 아이템의 인덱스를 갖는 속성입니다. |
| initvalueid | ListBox 에 적용될 InitValue 의 ID 를 설정하는 속성입니다. |
| innerdataset | ListBox 의 아이템 리스트를 구성할 DataSet 의 ID를 설정하는 속성입니다. |
| itemheight | ListBox 의 아이템 리스트에서 각 행의 높이를 설정하는 속성입니다. |
| layoutorder | Layout 컨테이너 내 Main Axis(type 속성값이 "horizontal"이면 수평축, type 속성값이 "vertical"이면 수직축)에 컴포넌트가 배치되는 순서를 설정합니다. |
| left | ListBox 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다. |
| letter-spacing | ListBox 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다. |
| maxheight | ListBox 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다. |
| maxwidth | ListBox 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다. |
| minheight | ListBox 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다. |
| minwidth | ListBox 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다. |
| multiselect | ListBox 에서 여러 개의 아이템을 선택할 수 있게 설정하는 속성입니다. |
| name | ListBox 의 이름을 설정하는 속성입니다. |
| -nexa-border | ListBox 의 테두리를 설정하는 속성입니다. |
| -nexa-edge | ListBox 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-padding | ListBox 영역의 안쪽 여백을 설정하는 속성입니다. |
| -nexa-rtl-background-image | ListBox 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다. |
| -nexa-rtl-edge-image | ListBox 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| opacity | ListBox 영역의 투명도를 설정하는 속성입니다. |
| parent | ListBox 의 부모 오브젝트를 갖는 읽기전용 속성입니다. |
| positionstep | 부모 오브젝트가 화면분할기능을 사용할 때 ListBox 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다. |
| readonly | ListBox 에서 아이템 변경을 허용할 지 설정하는 속성입니다. |
| right | ListBox 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다. |
| rtl | ListBox 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다. |
| scrollbarbarminsize | ListBox 에 표시되는 스크롤바의 트랙바(TrackBar) 최소크기를 설정하는 속성입니다. |
| scrollbarbaroutsize | ListBox 의 스크롤바에서 트랙바(TrackBar)가 사라지는 기준 크기를 설정하는 속성입니다. |
| scrollbardecbuttonsize | ListBox 에 표시되는 스크롤바의 감소 버튼(DecButton) 크기를 설정하는 속성입니다. |
| scrollbarincbuttonsize | ListBox 에 표시되는 스크롤바의 증가 버튼(IncButton) 크기를 설정하는 속성입니다. |
| scrollbarsize | ListBox 에 표시되는 스크롤바의 크기를 설정하는 속성입니다. |
| scrollbartrackbarsize | ListBox 에 표시되는 스크롤바의 트랙바(TrackBar) 크기를 설정하는 속성입니다. |
| scrollbartype | ListBox 에 스크롤바가 표시되는 형식을 설정하는 속성입니다. |
| scrollindicatorsize | ListBox 에 표시되는 스크롤 인디케이터바의 크기를 설정하는 속성입니다. |
| scrolltype | ListBox 에서 사용되는 스크롤의 종류를 설정하는 속성입니다. |
| selectscrollmode | ListBox 영역 내에서 드래그 액션을 했을 때 수행되는 동작을 설정하는 속성입니다. |
| tablecellarea | Layout 컨테이너 내 가상의 Table Cell 영역 내에서 컴포넌트가 배치되는 영역을 설정합니다. |
| taborder | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 ListBox 의 순서를 설정하는 속성입니다. |
| tabstop | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 ListBox 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다. |
| text | ListBox 에서 선택된 아이템의 데이터값을 갖는 읽기전용 속성입니다. |
| tooltiptext | ListBox 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다. |
| tooltiptype | ListBox 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다. |
| top | ListBox 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다. |
| value | ListBox 에서 선택된 아이템의 코드값을 갖는 속성입니다. |
| visible | ListBox 이(가) 화면에 표시될지 여부를 설정하는 속성입니다. |
| vscrollbar | ListBox 의 서브컨트롤인 수직 스크롤바의 오브젝트를 갖는 읽기전용 속성입니다. |
| width | ListBox 을(를) 표시하기 위한 너비를 설정하는 속성입니다. |
| word-spacing | ListBox 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다. |
...
| setFocus | ListBox 에 포커스를 설정하는 메서드입니다. |
...
| Name | Description |
| --- | --- |
| canitemchange | ListBox 에서 아이템을 변경할 때 발생하는 이벤트입니다. |
| oncontextmenu | ListBox 영역에서 오른쪽 마우스 버튼을 클릭하거나 터치를 일정시간 유지할 때 발생하는 이벤트입니다. |
| ondevicebuttonup | 모바일 에서 디바이스 버튼을 눌렀을 때 발생하는 이벤트입니다. |
| ondrag | ListBox 영역 내에서 마우스 왼쪽버튼으로 드래그를 수행했을 때 발생하는 이벤트입니다. |
| ondragenter | ListBox 영역 내로 드래그 상태의 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다. |
| ondragleave | ListBox 영역 밖으로 드래그 상태의 마우스 포인터가 나갈 때 발생하는 이벤트입니다. |
| ondragmove | ListBox 영역 내에서 드래그 상태의 마우스 포인터가 움직일 때 발생하는 이벤트입니다. |
| ondrop | ListBox 영역 내에서 드래그 상태의 마우스 버튼을 떼었을 때 발생하는 이벤트입니다. |
| onhscroll | ListBox 의 수평 스크롤바를 스크롤 했을 때 발생하는 이벤트입니다. |
| oninnerdatachanged | ListBox 의 innerdataset 속성에 바인딩된 DataSet 에서 데이터 변경이 된 후 발생하는 이벤트입니다. |
| onitemchanged | ListBox 에서 아이템 선택이 변경된 후 발생하는 이벤트입니다. |
| onitemclick | 아이템 리스트에서 아이템을 클릭했을 때 발생하는 이벤트입니다. |
| onitemdblclick | 아이템 리스트에서 아이템을 더블 클릭했을 때 발생하는 이벤트입니다. |
| onkeydown | ListBox 에 포커스가 있는 상태에서 키보드의 키가 눌렸을 때 발생하는 이벤트입니다. |
| onkeyup | ListBox 에 포커스가 있는 상태에서 눌렸던 키보드가 떼어질 때 발생하는 이벤트입니다. |
| onkillfocus | ListBox 에서 포커스가 나갈  때 발생하는 이벤트입니다. |
| onlbuttondown | ListBox 영역 내에서 마우스 왼쪽버튼을 눌렀을 때 발생하는 이벤트입니다. |
| onlbuttonup | ListBox 영역 내에서 눌렸던 마우스 왼쪽버튼을 떼었을 때 발생하는 이벤트입니다. |
| onmouseenter | ListBox 영역 내로 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다. |
| onmouseleave | ListBox 영역 밖으로 마우스 포인터가 나갈 때 발생하는 이벤트입니다. |
| onmousemove | ListBox 영역 내에서 마우스 포인터가 움직일 때 발생하는 이벤트입니다. |
| onmousewheel | ListBox 영역 내에서 마우스의 휠버튼을 회전했을 때 발생하는 이벤트입니다. |
| onmove | ListBox 의 위치가 이동했을 때 발생하는 이벤트입니다. |
| onrbuttondown | ListBox 영역 내에서 마우스 오른쪽버튼을 눌렀을 때 발생하는 이벤트입니다. |
| onrbuttonup | ListBox 영역 내에서 마우스 오른쪽버튼을 떼었을 때 발생하는 이벤트입니다. |
| onsetfocus | ListBox 에 포커스가 들어올 때 발생하는 이벤트입니다. |
| onsize | ListBox 의 크기가 변경됐을 때 발생하는 이벤트입니다. |
| ontouchend | ListBox 영역 내에서 터치를 떼었을 때 발생하는 이벤트입니다. |
| ontouchmove | ListBox 영역 내에서 터치 상태를 유지하며 움직일 때 발생하는 이벤트입니다. |
| ontouchstart | ListBox 영역 내에서 터치가 시작될 때 발생하는 이벤트입니다. |
| onvscroll | ListBox 의 수직 스크롤바를 스크롤 했을 때 발생하는 이벤트입니다. |
...
> Components > Component > ListBox > Property > -nexa-border

**Description**

ListBox 의 테두리를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.border[= strborder]
```
...
this.ListBox00.border = "1px solid #999999";
this.ListBox00.border = "1px solid #999999, 1px solid #999999, 1px solid #999999, 1px solid #999999";
```
...
> Components > Component > ListBox > Property > -nexa-edge

**Description**

ListBox 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.edge[= stredge]
```
...
* Script ( normal property )
this.ListBox00.edge = "URL('./images/border.png')" 5px 5px;
```
...
- ListBox 내부에 테두리 형태로 이미지를 표시하고자 할 때 사용하는 속성입니다.
...
> Components > Component > ListBox > Property > -nexa-padding

**Description**

ListBox 영역의 안쪽 여백을 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.padding[= strpadding]
```
...
* Script ( normal property )
this.ListBox00.padding = "5px 5px 5px 5px";
```
- **`<npadding>`** — ListBox 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
- -nexa-padding 속성은 내부 컨텐츠영역과 ListBox 사이의 여백으로 적용됩니다.
...
> Components > Component > ListBox > Property > -nexa-rtl-background-image

**Description**

ListBox 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.-nexa-rtl-background-image
```
...
> Components > Component > ListBox > Property > -nexa-rtl-edge-image

**Description**

ListBox 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.-nexa-rtl-edge-image
```
...
> Components > Component > ListBox > Property > acceptvaluetype

**Description**

ListBox 에서 InnerDataset 에 없는 코드값을 스크립트로 value 속성에 설정할 때 처리방식을 결정하는 속성입니다.

**Syntax**

```javascript
ListBox.acceptvaluetype[= enumAccept]
```
...
```
```javascript
this.ListBox00.acceptvaluetype = "ignoreinvalid";
```
...
- ListBox 에 바인드 된 DataSet 의 데이터값이 value 속성에 설정되는 경우는 적용되지 않습니다.
...
> Components > Component > ListBox > Property > accessibilityaction

**Description**

ListBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.accessibilityaction[= strAction]
```

**Setting Syntax**

```javascript
this.ListBox00.accessibilityaction = "Accessibility Action Message"; 
this.ListBox00.accessibilityaction = "Select by direction key";
```
...
> Components > Component > ListBox > Property > accessibilitydesclevel

**Description**

ListBox 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.accessibilitydesclevel[= enumLevel]
```
...
```
```javascript
this.ListBox00.accessibilitydesclevel = "all";
```
- **`"all"`** — ListBox 와 자식 컴포넌트에 대한 접근성을 모두 출력합니다.
- **`"self"`** — ListBox 의 접근성만 출력하고 자식 컴포넌트의 접근성은 출력하지 않습니다.
- **`"child"`** — ListBox 의 접근성은 출력하지 않고, 자식 컴포넌트의 접근성은 출력합니다.
- **`"none"`** — ListBox 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
...
- accessibilitydesclevel 속성은 선택상자의 이동에 영향을 주지 않으므로 방향키로 선택상자가 ListBox 에 이동되게 하지 않으려면 accessibilityenable 속성을 설정하여야 합니다.
...
> Components > Component > ListBox > Property > accessibilitydescription

**Description**

ListBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.accessibilitydescription[= strDescription]
```

**Setting Syntax**

```javascript
this.ListBox00.accessibilitydescription = "Option";
```
...
> Components > Component > ListBox > Property > accessibilityenable

**Description**

ListBox 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.accessibilityenable[= bEnable]
```
...
```
```javascript
this.ListBox00.accessibilityenable = false;
```
- **`true`** — ListBox 에 선택상자가 이동되면 접근성 관련 속성값을 출력합니다.

방향키 또는 제스처로 선택상자 이동 시 Static 과 같이 포커스를 갖지 않는 컴포넌트에도 선택상자가 이동됩니다.
- **`false`** — ListBox 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.

데스크탑 환경에서 방향키로 선택상자가 ListBox 에 이동되지 않습니다.
모바일 환경에서 제스처로 선택상자가 ListBox 에 이동되지 않습니다.
...
- 선택상자 이동 시 컴포넌트의 ARIA-LABEL + Status + Role 순서로 정보가 조합되어 접근성으로 출력됩니다.
   ...
   > Status : ListBox 의 현재 상태가 반영됩니다.
   > Role : accessibilityrole 속성값이 반영됩니다. accessibilityrole 속성값을 설정하지 않으면 ListBox 의 고유 Role 이 반영됩니다.

- accessibilityenable 속성값이 false 일 때 데스크탑 환경에서 방향키 외의 방법으로 선택상자를 ListBox 로 이동시키면 스크린 리딩 프로그램에서 임의의 값을 출력할 수 있습니다.
...
> Components > Component > ListBox > Property > accessibilitylabel

**Description**

ListBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.accessibilitylabel[= strLabel]
```

**Setting Syntax**

```javascript
this.ListBox00.accessibilitylabel = "OK Button"; 
this.ListBox00.accessibilitylabel = "[@static00]"; 
this.ListBox00.accessibilitylabel = "[@static00][@static01]"; 
this.ListBox00.accessibilitylabel = "[@static00][@static01] OK Button";
```
...
> Components > Component > ListBox > Property > accessibilityrole

**Description**

ListBox에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.accessibilityrole[= enumRole]
```
...
```
```javascript
this.ListBox00.accessibilityrole = "none"; 
this.ListBox00.accessibilityrole = "button";
```
...
- accessibilityenable 속성값을 설정하지 않으면 ListBox의 기본 Role 로 적용됩니다.

- 추가적인 속성값이 필요한 Role 설정 시 ListBox에 해당 속성이 없으면 스크린 리더에 따라 정상적으로 정보를 읽지 못할 수 있습니다.
...
> Components > Component > ListBox > Property > background

**Description**

ListBox 의 배경 영역을 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.background[= strbackground]
```
...
* Script ( normal property )
this.ListBox00.background = "#ffffaa";
this.ListBox00.background = ""URL('./images/smiley.gif')" no-repeat center center #ffffaa";
this.ListBox00.background = ""URL('./images/smiley.gif')" no-repeat center center /auto #ffffaa";
this.ListBox00.background = ""URL('./images/smiley.gif')" no-repeat center center /15px 15% #ffffaa";
this.ListBox00.background = "linear-gradient( red , blue , yellow )";
this.ListBox00.background = "linear-gradient( #FF0000 , rgb(0,0,255) , rgb(255,255,0))";
this.ListBox00.background = ""URL('./images/smiley.gif')" border-box border-box #ffffaa";
```
...
"left" 설정 시 ListBox 의 왼쪽면과 이미지의 왼쪽면이 정렬되어 표시됩니다.
"center" 설정 시 ListBox 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"right" 설정 시 ListBox 의 오른쪽면과 이미지의 오른쪽면이 정렬되어 표시됩니다.
...
"top" 설정 시 ListBox 의 윗쪽면과 이미지의 윗쪽면이 정렬되어 표시됩니다.
"center" 설정 시 ListBox 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"bottom" 설정 시 ListBox 의 아랫쪽면과 이미지의 아랫쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
0 보다 작거나 100 보다 큰 값을 설정 시 ListBox 의 영역을 벗어난 가상의 위치로 적용됩니다.
...
예를 들어 <angle> 값이 "to left" 이면 ListBox 의 right 위치가 시작점이 되고, left 위치가 끝점이 됩니다.
              <angle> 값이 "to right" 이면 ListBox 의 left 위치가 시작점이 되고, right 위치가 끝점이 됩니다.
...
<bg-image> 에 적용된 이미지에 투명으로 적용된 부분이 있거나 이미지가 ListBox 영역보다 작다면 해당 영역에 배경색이 표시됩니다.
...
> Components > Component > ListBox > Property > border-radius

**Description**

ListBox 의 모서리 모양을 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.borderRadius[= strborderradius]
```
...
* Script ( normal property )
this.ListBox00.borderRadius = "10px";
this.ListBox00.borderRadius = "5px 6px 10px / 5px 10px";
```
...
> Components > Component > ListBox > Property > bottom

**Description**

ListBox 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.bottom[= nBottom]
```
...
```
```javascript
this.ListBox00.bottom = 10; 
this.ListBox00.bottom = "10px"; 
this.ListBox00.bottom = "10%"; 
this.ListBox00.bottom = "Button00:10px"; 
this.ListBox00.bottom = "Button00:10%";
```
- **`<strCompID>`** — ListBox 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 ListBox 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 ListBox 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — ListBox 의 하단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 bottom 속성값을 기준으로 ListBox의 하단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 ListBox의 하단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 ListBox의 하단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 ListBox의 하단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 top 속성값을 기준으로 ListBox의 하단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 ListBox의 하단 위치 결정
...
> Components > Component > ListBox > Property > box-shadow

**Description**

ListBox 에 그림자 효과를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.boxShadow[= strbshadow]
```
...
* Script ( normal property )
this.ListBox00.boxShadow  = "10px 10px 10px #888888";
this.ListBox00.boxShadow  = "inset 10px 10px 10px 5px #888888";
```
...
ListBox 의 좌상단 위치를 기준으로 그림자 효과가 표시될 위치를 가로/세로 픽셀값으로 설정합니다.
...
> Components > Component > ListBox > Property > codecolumn

**Description**

ListBox 의 아이템 리스트에서 코드값으로 사용될 Column을 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.codecolumn[= strColumnID]
```

**Setting Syntax**

```javascript
this.ListBox00.codecolumn = "codecolumn";
```
...
- ListBox 에서 선택된 아이템의 코드값은 value 속성에 설정됩니다.
...
> Components > Component > ListBox > Property > color

**Description**

ListBox 에 표시되는 텍스트의 색상을 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.color[= strcolor]
```
...
* Script ( normal property )
this.ListBox00.color = "#999999";
this.ListBox00.color = "rgb(255,0,0)";
this.ListBox00.color = "red";
```
- **`<NamedColor>`** — "red","blue" 와 같이 미리 정의된 색상이름을 문자열로 설정합니다.
- **`<NumericColor>`** — 표시할 색의 색상코드입니다.
...
> Components > Component > ListBox > Property > cssclass

**Description**

ListBox 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.cssclass[= strcssclass]
```
...
```
```javascript
this.ListBox00.cssclass = "TestClass"; 
this.ListBox00.cssclass = "TestClass,TestClass2";
```
...
> Components > Component > ListBox > Property > cursor

**Description**

ListBox 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.cursor[= strCursor]
```
...
> Components > Component > ListBox > Property > datacolumn

**Description**

ListBox 의 아이템 리스트에서 데이터값으로 사용될 Column을 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.datacolumn[= strColumnID]
```

**Setting Syntax**

```javascript
this.ListBox00.datacolumn = "datacolumn";
```
...
- ListBox 에서 선택된 아이템의 데이터값은 text 속성값에 설정됩니다.
...
> Components > Component > ListBox > Property > dragscrolltype

**Description**

ListBox에서 터치 후 드래그로 스크롤이 발생할 경우, 스크롤 방향을 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.dragscrolltype[= enumType]
```
...
> Components > Component > ListBox > Property > enable

**Description**

ListBox 의 사용가능 여부를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.enable[= benable]
```
...
```
```javascript
this.ListBox00.enable = true; 
this.ListBox00.enable = false;
```
- **`true`** — ListBox 을(를) 사용할 수 있게 설정합니다.
- **`false`** — ListBox 을(를) 사용할 수 없게 설정합니다.
...
> Components > Component > ListBox > Property > enableevent

**Description**

ListBox 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.enableevent[= bEvent]
```
...
```
```javascript
this.ListBox00.enableevent = true;  
this.ListBox00.enableevent = false;
```
- **`true`** — ListBox 에서 이벤트가 발생하도록 설정합니다.
- **`false`** — ListBox 에서 이벤트가 발생하지 않도록 설정합니다.
...
> Components > Component > ListBox > Property > flexgrow
...
> Components > Component > ListBox > Property > flexshrink
...
> Components > Component > ListBox > Property > font

**Description**

ListBox 에서 사용하는 폰트를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.font[= strfont]
```
...
* Script ( normal property )
this.ListBox00.font = "bold 12pt/30px arial, sans-serif";
```
...
> Components > Component > ListBox > Property > height

**Description**

ListBox 을(를) 표시하기 위한 높이를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.height[= nHeight]
```
...
```
```javascript
this.ListBox00.height = 10; 
this.ListBox00.height = "10px"; 
this.ListBox00.height = 10%"; 
this.ListBox00.height = Button00:10%";
```
- **`<strCompID>`** — ListBox 의 높이를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 ListBox 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 ListBox 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 높이가 적용됩니다.
- **`<nVal>`** — ListBox 의 높이를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.


* <strCompID> 값을 생략했을 때 :
- "px": ListBox의 높이 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 ListBox의 높이 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 ListBox의 높이 결정
- "rem": MainFrame font-size 속성값을 기준으로 ListBox의 높이 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 ListBox의 높이 결정
- "%": <strCompID>의 height 속성값을 기준으로 ListBox의 높이 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > ListBox > Property > hotkey

**Description**

ListBox 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.hotkey[= strHotkey]
```

**Setting Syntax**

```javascript
this.ListBox00.hotkey = "G"; 
this.ListBox00.hotkey = "CTRL+A"; 
this.ListBox00.hotkey = "CTRL+ALT+X";
```
...
> Components > Component > ListBox > Property > hscrollbar

**Description**

ListBox 의 서브컨트롤인 수평 스크롤바의 오브젝트를 갖는 읽기전용 속성입니다.
...
```javascript
this.ListBox00.hscrollbar.decbuttonsize = 30;
```
...
> Components > Component > ListBox > Property > id

**Description**

ListBox의 고유 식별자를 설정하는 속성입니다.
...
- **`id`** — ListBox를 구별할 수 있는 유일값을 갖습니다.
...
> Components > Component > ListBox > Property > index

**Description**

ListBox 의 아이템 중 선택된 아이템의 인덱스를 갖는 속성입니다.

**Syntax**

```javascript
ListBox.index[= nIndex]
```

**Setting Syntax**

```javascript
this.ListBox00.index = 5;
var nIdx = this.ListBox00.index;
```
...
- multiselect 속성값을 "true" 로 설정하여 여러개의 아이템을 선택하여도 index 속성에는 마지막에 선택한 아이템의 인덱스값이 설정됩니다.

- multiselect 속성값이 "true" 일때는 스크립트나 DataSet 바인딩에 의해 선택된 아이템이 변경되어도 화면에 반영되지 않습니다.
...
> Components > Component > ListBox > Property > initvalueid

**Description**

ListBox 에 적용될 InitValue 의 ID 를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.initvalueid[= strValueID]
```

**Setting Syntax**

- **`strValueID`** — InitValueDefinition 영역에 정의된 InitValue 파일에서 ListBox 에 적용할 항목의 ID 를 문자열로 설정합니다.

**Remark**

- ListBox 가 화면에 표시된 후에는 속성값을 설정하거나 변경 할 수 없습니다.
   ListBox 를 동적으로 생성 시 show() 메소드 실행 전에 속성값을 설정하여야 합니다.
...
> Components > Component > ListBox > Property > innerdataset

**Description**

ListBox 의 아이템 리스트를 구성할 DataSet 의 ID를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.innerdataset[= strDatasetID]
```

**Setting Syntax**

```javascript
this.ListBox00.innerdataset = "Dataset00";
```
...
> Components > Component > ListBox > Property > itemheight

**Description**

ListBox 의 아이템 리스트에서 각 행의 높이를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.itemheight[= nHeight]
```
...
> Components > Component > ListBox > Property > layoutorder
...
> Components > Component > ListBox > Property > left

**Description**

ListBox 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.ListBox00.left = 10; 
this.ListBox00.left = "10px"; 
this.ListBox00.left = "10%"; 
this.ListBox00.left = "Button00:10px"; 
this.ListBox00.left = "Button00:10%";
```
- **`<strCompID>`** — ListBox 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — ListBox 의 좌측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 left 속성값을 기준으로 ListBox의 좌측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 ListBox의 좌측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 ListBox의 좌측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 ListBox의 좌측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 right 속성값을 기준으로 ListBox의 좌측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 ListBox의 좌측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > ListBox > Property > letter-spacing

**Description**

ListBox 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.letterSpacing[= strspace]
```
...
* Script ( normal property )
this.ListBox00.letterSpacing = "2px";
```
...
> Components > Component > ListBox > Property > maxheight

**Description**

ListBox 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.maxheight[= nMaxHeight]
```
...
```
```javascript
this.ListBox00.maxheight = 20; 
this.ListBox00.maxheight = "20px";
```
- **`<nVal>`** — ListBox 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 maxheight 보다 크면 화면에 표시되는 ListBox 의 높이는 maxheight 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 ListBox 의 높이가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > ListBox > Property > maxwidth

**Description**

ListBox 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.maxwidth[= nMaxWidth]
```
...
```
```javascript
this.ListBox00.maxwidth = 20; 
this.ListBox00.maxwidth = "20px";
```
- **`<nVal>`** — ListBox 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 maxwidth 보다 크면 화면에 표시되는 ListBox 의 너비는 maxwidth 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 ListBox 의 너비가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > ListBox > Property > minheight

**Description**

ListBox 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.minheight[= nMinHeight]
```
...
```
```javascript
this.ListBox00.minheight = 20; 
this.ListBox00.minheight = "20px";
```
- **`<nVal>`** — ListBox 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 minheight 보다 작다면 화면에 표시되는 ListBox 의 높이는 minheight 속성값으로 적용됩니다.
  표시되는 높이만 적용되고 height 속성값은 변경되지 않습니다.
...
> Components > Component > ListBox > Property > minwidth

**Description**

ListBox 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.minwidth[= nMinWidth]
```
...
```
```javascript
this.ListBox00.minwidth = 20; 
this.ListBox00.minwidth = "20px";
```
- **`<nVal>`** — ListBox 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 minwidth 보다 작으면 화면에 표시되는 ListBox 의 너비는 minwidth 속성값으로 적용됩니다.
  표시되는 너비만 적용되고 width 속성값은 변경되지 않습니다.
...
> Components > Component > ListBox > Property > multiselect

**Description**

ListBox 에서 여러 개의 아이템을 선택할 수 있게 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.multiselect[= bMultiselect]
```
...
```
- **`true`** — 아이템 리스트에서 여러개의 아이템을 선택할 수 있습니다.

Ctrl, Shift 키를 사용해 여러개의 아이템을 선택할 수 있습니다.
여러 개의 아이템을 선택할 때 index, value 속성은 마지막에 선택된 아이템의 값을 갖습니다.
value 속성이 DataSet에 바인딩되어 있을 때 index, value 속성은 DataSet 에서 선택된 값을 갖습니다.
- **`false`** — 아이템 리스트에서 한개의 아이템만 선택할 수 있습니다.

index, value 속성은 현재 선택된 아이템의 값을 갖습니다.
value 속성이 DataSet에 바인딩되어 있을 때 index, value 속성은 ListBox 에서 선택된 아이템의 값을 갖습니다.
ListBox 에서 시작한 드래그는 컴포넌트 안에서만 사용할 수 있습니다.

**Remark**

- multiselect 속성값을 설정하지 않으면 false로 적용됩니다.
- multiselect 속성값이 true이면 스크립트나 DataSet 바인딩에 의해 선택된 아이템이 변경되어도 화면에 반영되지 않습니다.
  따라서 화면에 남아 있는 선택표시와 실제 index 속성값에 차이가 있을 수 있으니 주의하셔야 합니다.

◆ 사용 환경에 따른 제약

모바일과 같이 입력 장치가 터치인 환경에서는 multiselect 기능을 부분 지원합니다.
- 블루투스 키보드
  방향키와 Shift 키 조합으로 여러 개의 아이템을 선택할 수 있습니다.
- 마우스 + 블루투스 키보드
  Android 운영체제에서는 Ctrl, Shift 키를 누르고 마우스 클릭 동작으로 여러 개의 아이템을 선택할 수 있습니다(iOS 운영체제는 지원하지 않는 동작입니다).
- 스크립트
  multiselect 속성값이 true일 때 setSelect 메소드 실행으로 여러 개의 아이템을 선택할 수 있습니다.

아래의 경우는 여러 개의 아이템을 선택할 수 없습니다.
- 화면 터치
  여러 개의 아이템을 선택할 수 없습니다(터치 조작 특성상 제약).
- 마우스
  마우스 드래그 동작으로 여러 개의 아이템을 선택할 수 없습니다.
- 화면 터치 + 블루투스 키보드
  Ctrl, Shift 키를 누르고 터치 동작으로 아이템 선택 시에는 키 입력 상태를 확인할 수 없어 여러 개의 아이템을 선택할 수 없습니다.
...
> Components > Component > ListBox > Property > name

**Description**

ListBox 의 이름을 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.name[= strName]
```
...
> Components > Component > ListBox > Property > opacity

**Description**

ListBox 영역의 투명도를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.opacity[= stropacity]
```
...
* Script ( normal property )
this.ListBox00.opacity = "0.8";
this.ListBox00.opacity = 0.8;
this.ListBox00.opacity = "80%";
```
...
> Components > Component > ListBox > Property > parent

**Description**

ListBox 의 부모 오브젝트를 갖는 읽기전용 속성입니다.
...
```javascript
var objParent = this.ListBox00.parent;
```
...
- ListBox 이(가) Div 와 같은 컨테이너 컴포넌트에 자식으로 존재한다면 parent 속성은 해당 컨테이너 컴포넌트를 갖습니다.
...
> Components > Component > ListBox > Property > positionstep

**Description**

부모 오브젝트가 화면분할기능을 사용할 때 ListBox 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.positionstep[= nStep]
```

**Setting Syntax**

```javascript
this.ListBox00.positionstep = 0; 
this.ListBox00.positionstep = -1;
```
- **`nStep`** — ListBox 이(가) 표시될 분할화면의 인덱스를 설정합니다.
"-1" 로 설정하면 모든 분할화면에 ListBox 이(가) 표시됩니다.
...
> Components > Component > ListBox > Property > readonly

**Description**

ListBox 에서 아이템 변경을 허용할 지 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.readonly[= bReadOnly]
```
...
> Components > Component > ListBox > Property > right

**Description**

ListBox 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.right[= nRight]
```
...
```
```javascript
this.ListBox00.right = 10; 
this.ListBox00.right = "10px"; 
this.ListBox00.right = "10%"; 
this.ListBox00.right = "Button00:10px"; 
this.ListBox00.right = "Button00:10%";
```
- **`<strCompID>`** — ListBox 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — ListBox 의 우측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 right 속성값을 기준으로 ListBox의 우측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 ListBox의 우측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 ListBox의 우측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 ListBox의 우측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 left 속성값을 기준으로 ListBox의 우측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 ListBox의 우측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > ListBox > Property > rtl

**Description**

ListBox 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다.
...
```
```javascript
var vRtl = this.ListBox00.rtl;
```
- **`undefined`** — undefined 설정 시 상위 컴포넌트의 rtl 속성값이 적용됩니다.

사용자가 rtl 속성값을 설정하지 않거나 삭제했을 경우 undefined 가 설정됩니다.
- **`true`** — ListBox 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 오른쪽으로 설정합니다.
ListBox 의 내부 좌표계의 기준을 오른쪽으로 설정합니다.
ListBox 의 텍스트 표시 기준을 오른쪽으로 설정합니다.
수직스크롤바가 있을 경우 왼쪽에 표시됩니다.
- **`false`** — ListBox 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
ListBox 의 내부 좌표계의 기준을 왼쪽으로 설정합니다.
ListBox 의 텍스트 표시 기준을 왼쪽으로 설정합니다.
...
- ListBox 부터 Environment 까지 상위의 모든 rtl 속성값이 undefined 이면
...
> Components > Component > ListBox > Property > scrollbarbarminsize

**Description**

ListBox 에 표시되는 스크롤바의 트랙바(TrackBar) 최소크기를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.scrollbarbarminsize[= nSize]
```

**Setting Syntax**

```javascript
this.ListBox00.scrollbarbarminsize = 20;
```
...
- ListBox 의 크기 변경에 의해 트랙바의 크기가 자동변경될 때 scrollbarbarminsize 속성값 미만으로 작아지지 않습니다.
...
> Components > Component > ListBox > Property > scrollbarbaroutsize

**Description**

ListBox 의 스크롤바에서 트랙바(TrackBar)가 사라지는 기준 크기를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.scrollbarbaroutsize[= nSize]
```

**Setting Syntax**

```javascript
this.ListBox00.scrollbarbaroutsize( 50 );
```
...
- ListBox 의 크기가 변경되어 스크롤바가 줄어들 때 트랙바를 표시할 공간이 scrollbarbaroutsize 속성값보다 작아지면 트랙바를 표시하지 않습니다.
...
> Components > Component > ListBox > Property > scrollbardecbuttonsize

**Description**

ListBox 에 표시되는 스크롤바의 감소 버튼(DecButton) 크기를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.scrollbardecbuttonsize[= nSize]
```

**Setting Syntax**

```javascript
this.ListBox00.scrollbardecbuttonsize = 30;
```
- **`nSize`** — 스크롤바의 감소 버튼(DecButton) 크기를 pixel 단위의 숫자로 설정합니다.

음수값이나 ListBox 의 너비/높이보다 큰 값을 설정할 수 없습니다.
...
> Components > Component > ListBox > Property > scrollbarincbuttonsize

**Description**

ListBox 에 표시되는 스크롤바의 증가 버튼(IncButton) 크기를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.scrollbarincbuttonsize[= nSize]
```

**Setting Syntax**

```javascript
this.ListBox00.scrollbarincbuttonsize = 30;
```
...
> Components > Component > ListBox > Property > scrollbarsize

**Description**

ListBox 에 표시되는 스크롤바의 크기를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.scrollbarsize[= nSize]
```

**Setting Syntax**

```javascript
this.ListBox00.scrollbarsize = 30;
```
...
> Components > Component > ListBox > Property > scrollbartrackbarsize

**Description**

ListBox 에 표시되는 스크롤바의 트랙바(TrackBar) 크기를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.scrollbartrackbarsize[= nSize]
```

**Setting Syntax**

```javascript
this.ListBox00.scrollbartrackbarsize = 20;
```
- **`nSize`** — 스크롤바의 트랙바 크기를 pixel 단위의 숫자로 설정합니다.

-1 을 설정하면 ListBox 크기와 내부 컨텐츠에 따라 트랙바 크기가 자동으로 조절됩니다.
...
> Components > Component > ListBox > Property > scrollbartype

**Description**

ListBox 에 스크롤바가 표시되는 형식을 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.scrollbartype[= strBartype]
```
...
```
```javascript
this.ListBox00.scrollbartype = "none"; 
this.ListBox00.scrollbartype = "default autoindicator"; 
this.ListBox00.scrollbartype = "auto fixed"; 
this.ListBox00.scrollbartype = "indicator none";
```
...
- 데스크탑에 적용되는 값과 모바일에 적용되는 값을 함께 설정할 수 있지만 권장하지 않습니다.
   ex) this.ListBox00.scrollbartype = "fixed autoindicator";
...
> Components > Component > ListBox > Property > scrollindicatorsize

**Description**

ListBox 에 표시되는 스크롤 인디케이터바의 크기를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.scrollindicatorsize[= nSize]
```

**Setting Syntax**

```javascript
this.ListBox00.scrollindicatorsize = 30;
```
...
- ListBox 에 스크롤 인디케이터바가 아닌 스크롤바가 표시될 경우 scrollbarsize 속성으로 크기를 설정하여야 합니다.
...
> Components > Component > ListBox > Property > scrolltype

**Description**

ListBox 에서 사용되는 스크롤의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.scrolltype[= enumType]
```
...
```
- **`"none"`** — ListBox 에서 수평/수직 스크롤을 사용하지 않습니다.
- **`"both"`** — ListBox 에서 수평/수직 스크롤을 모두 사용합니다.
- **`"vertical"`** — ListBox 에서 수직 스크롤만 사용합니다.

수평 스크롤은 사용하지 않습니다.
- **`"horizontal"`** — ListBox 에서 수평 스크롤만 사용합니다.
...
- ListBox 에서 사용되는 스크롤에 대한 자세한 설정은 scrollbartype 속성을 사용하여야 합니다.

**See Also**

ListBox.scrollbartype
...
> Components > Component > ListBox > Property > selectscrollmode

**Description**

ListBox 영역 내에서 드래그 액션을 했을 때 수행되는 동작을 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.selectscrollmode[= enumMode]
```
...
```
```javascript
this.ListBox00.selectscrollmode = "scroll";
this.ListBox00.selectscrollmode = "select";
```
...
> Components > Component > ListBox > Property > tablecellarea
...
> Components > Component > ListBox > Property > taborder

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 ListBox 의 순서를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.taborder[= nTabOrder]
```
...
> Components > Component > ListBox > Property > tabstop

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 ListBox 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.tabstop[= bTabStop]
```
...
bTabStop ::= 'true' | 'false'
```
- **`"true"`** — ListBox 이(가) 탭키 입력에 의한 포커스를 받습니다.
- **`"false"`** — ListBox 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
...
> Components > Component > ListBox > Property > text

**Description**

ListBox 에서 선택된 아이템의 데이터값을 갖는 읽기전용 속성입니다.
...
> Components > Component > ListBox > Property > tooltiptext

**Description**

ListBox 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.tooltiptext[= strToolTipText]
```

**Setting Syntax**

```javascript
this.ListBox00.tooltiptext = "This is ToolTip Text"; this.ListBox00.tooltiptext = "";          // 풍선 도움말이 표시되지 않습니다. 
this.ListBox00.tooltiptext = null;        // 상위 컴포넌트의 풍선 도움말이 표시됩니다.
```
...
- 마우스 포인터가 ListBox 영역 위에서 일정시간 움직이지 않으면 풍선도움말이 표시됩니다.
...
> Components > Component > ListBox > Property > tooltiptype

**Description**

ListBox 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.tooltiptype[= enumTooltipType]
```
...
```
```javascript
this.ListBox00.tooltiptype = "hover";
```
- **`"default"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 ListBox 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"hover"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 ListBox 영역내에 멈춰서 일정시간이 경과하면 풍선도움말이 사라집니다.
ListBox 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경되거나 사라진 풍선도움말이 다시 표시됩니다.
- **`"inplace"`** — ListBox 의 좌측상단 안쪽에 풍선도움말을 표시합니다.

마우스 포인터가 ListBox 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"default,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 ListBox 영역에 있으면 풍선도움말이 사라지지 않습니다.
- **`"hover,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 ListBox 영역에 있으면 풍선도움말이 사라지지 않습니다.
ListBox 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경됩니다.
- **`"inplace,mouseleave"`** — ListBox 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
- 표시되었다가 사라진 풍선도움말은 마우스 포인터가 ListBox 영역을 나갔다가 들어오면 다시 표시됩니다.

- 마우스 포인터가 ListBox 영역에서 벗어나면 풍선도움말이 사라집니다.
...
> Components > Component > ListBox > Property > top

**Description**

ListBox 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.ListBox00.top = 10; 
this.ListBox00.top = "10px"; 
this.ListBox00.top = "10%"; 
this.ListBox00.top = "Button00:10px"; 
this.ListBox00.top = "Button00:10%";
```
- **`<strCompID>`** — ListBox 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — ListBox의 상단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 top 속성값을 기준으로 ListBox의 상단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 ListBox의 상단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 ListBox의 상단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 ListBox의 상단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 bottom 속성값을 기준으로 ListBox의 상단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 ListBox의 상단 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > ListBox > Property > value

**Description**

ListBox 에서 선택된 아이템의 코드값을 갖는 속성입니다.

**Syntax**

```javascript
ListBox.value[= strValue]
```

**Setting Syntax**

```javascript
this.ListBox00.value = "1";
```
- **`strValue`** — ListBox의 아이템 중에서 선택할 아이템의 코드값을 문자열로 설정합니다.

**Remark**

- value 속성값을 설정하지 않으면 undefined 로 적용됩니다.

- ListBox 에서 선택된 아이템의 코드값이 value 속성값으로 설정됩니다.

- value 속성값 변경에 의해 선택된 아이템이 변경될 경우 index 속성값도 해당 아이템에 맞게 변경됩니다.

- ListBox 에 Dataset 을 바인딩 하면 기본적으로 연동되는 속성입니다.
   DataSet 연동 시 codecolumn 속성에 설정된 Column 의 데이터가 value 속성에 설정됩니다.

- multiselect 속성을 true 로 설정하여 여러개의 아이템을 선택하여도 value 속성에는 마지막에 선택한 아이템의 코드값이 설정됩니다.

- multiselect 속성이 true 이면 스크립트나 Dataset 바인딩에 의해 선택된 아이템이 변경되어도 화면에 반영되지 않습니다.
   따라서 화면에 남아 있는 선택표시와 실제 index 속성값에 차이가 있을 수 있으니 주의하셔야 합니다.
...
> Components > Component > ListBox > Property > visible

**Description**

ListBox 이(가) 화면에 표시될지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.visible[= bVisible]
```
...
```
```javascript
this.ListBox00.visible = true; 
this.ListBox00.visible = false;
```
- **`"true"`** — ListBox 을(를) 화면에 표시합니다.
- **`"false"`** — ListBox 을(를) 화면에 표시하지 않습니다.
...
> Components > Component > ListBox > Property > vscrollbar

**Description**

ListBox 의 서브컨트롤인 수직 스크롤바의 오브젝트를 갖는 읽기전용 속성입니다.
...
```javascript
this.ListBox00.vscrollbar.decbuttonsize = 30;
```
...
> Components > Component > ListBox > Property > width

**Description**

ListBox 을(를) 표시하기 위한 너비를 설정하는 속성입니다.
...
```
```javascript
this.ListBox00.width = 10; this.ListBox00.width = "10px"; 
this.ListBox00.width = "10%"; 
this.ListBox00.width = "Button00:10%";
```
- **`<strCompID>`** — ListBox 의 너비를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 ListBox 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 ListBox 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 너비가 적용됩니다.
- **`<nVal>`** — ListBox 의 너비를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": ListBox의 너비 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 ListBox의 너비 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 ListBox의 너비 결정
- "rem": MainFrame font-size 속성값을 기준으로 ListBox의 너비 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 ListBox의 너비 결정
- "%": <strCompID>의 width 속성값을 기준으로 ListBox의 너비 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > ListBox > Property > word-spacing

**Description**

ListBox 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다.

**Syntax**

```javascript
ListBox.wordSpacing[= strwordspacing]
```
...
* Script ( normal property )
this.ListBox00.wordSpacing = "30px";
```
...
> Components > Component > ListBox > Method > addEvent
...
```javascript
var bResult = this.ListBox00.addEvent( "onmove" );
```
...
> Components > Component > ListBox > Method > addEventHandler
...
```javascript
this.ListBox00_onmove = function( obj:nexacro.ListBox,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.ListBox00.addEventHandler( "onmove", this.ListBox00_onmove, this);
```
...
> Components > Component > ListBox > Method > addEventHandlerLookup
...
```javascript
this.ListBox00_onmove = function( obj:nexacro.ListBox,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.ListBox00.addEventHandlerLookup( "onmove", "ListBox00_onmove", this);
```
...
> Components > Component > ListBox > Method > bringToFront
...
> Components > Component > ListBox > Method > bringToPrev
...
> Components > Component > ListBox > Method > clearEventHandler
...
```javascript
var nCnt = this.ListBox00.clearEventHandler( "onmove" );
```
...
> Components > Component > ListBox > Method > clearSelect
...
> Components > Component > ListBox > Method > destroy
...
| Type | Description |
| --- | --- |
| Boolean | ListBox 이(가) 정상적으로 삭제되면 true 를 반환합니다.

ListBox 이(가) 정상적으로 삭제되지 않으면 false 를 반환합니다. |
...
Form.addChildForm.insertChildForm.removeChildListBox.initListBox.show
...
> Components > Component > ListBox > Method > findEventHandler
...
var nIndex = this.ListBox00.findEventHandler( "onmove", this.ListBox00_onmove, this );
```
...
> Components > Component > ListBox > Method > getCount
...
| Type | Description |
| --- | --- |
| Number | ListBox에 표시되는 전체 아이템의 갯수를 반환합니다. |
...
> Components > Component > ListBox > Method > getEventHandler
...
```javascript
var objFunc = ListBox00.getEventHandler( "onmove", 0 );
```
...
> Components > Component > ListBox > Method > getHScrollPos
...
ListBox.getVScrollPosListBox.scrollbartype
...
> Components > Component > ListBox > Method > getInnerDataset
...
> Components > Component > ListBox > Method > getOffsetBottom
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 ListBox 의 bottom 값을 픽셀단위의 숫자로 반환합니다. |
...
> Components > Component > ListBox > Method > getOffsetHeight
...
| Type | Description |
| --- | --- |
| Number | ListBox 의 높이를 픽셀단위의 숫자로 변환하여 반환합니다. |
...
> Components > Component > ListBox > Method > getOffsetLeft
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 ListBox 의 left 값을 픽셀단위의 숫자로 반환합니다. |
...
> Components > Component > ListBox > Method > getOffsetRight
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 ListBox 의 right 값을 픽셀단위의 숫자로 반환합니다. |
...
> Components > Component > ListBox > Method > getOffsetTop
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 ListBox 의 top 값을 픽셀단위의 숫자로 반환합니다. |
...
> Components > Component > ListBox > Method > getOffsetWidth
...
| Type | Description |
| --- | --- |
| Number | ListBox 의 너비를 픽셀단위의 숫자로 변환하여 반환합니다. |
...
> Components > Component > ListBox > Method > getPixelBottom
...
| Type | Description |
| --- | --- |
| Number | ListBox 의 bottom 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > ListBox > Method > getPixelHeight
...
| Type | Description |
| --- | --- |
| Number | ListBox 의 height 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > ListBox > Method > getPixelLeft
...
| Type | Description |
| --- | --- |
| Number | ListBox 의 left 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > ListBox > Method > getPixelRight
...
| Type | Description |
| --- | --- |
| Number | ListBox 의 right 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > ListBox > Method > getPixelTop
...
| Type | Description |
| --- | --- |
| Number | ListBox 의 top 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > ListBox > Method > getPixelWidth
...
| Type | Description |
| --- | --- |
| Number | ListBox 의 width 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > ListBox > Method > getSelect
...
```javascript
var bSelect = this.ListBox00.getSelect( 0 );
```
...
| Type | Description |
| --- | --- |
| Boolean | nIndex 에 해당하는 아이템이 선택된 상태이면 true 를 반환합니다.
nIndex 에 해당하는 아이템이 선택된 상태가 아니면 false 를 반환합니다.

잘못된 nIndex 값을 설정하면 -1 을 반환합니다. |
...
> Components > Component > ListBox > Method > getSelectedCount
...
| Type | Description |
| --- | --- |
| Number | multiselect 속성값이 "false" 이면 "0" 또는 "1" 이 반환됩니다.
multiselect 속성값이 "true" 이면 선택상태인 아이템의 전체 갯수를 반환합니다. |
...
> Components > Component > ListBox > Method > getSelectedItems
...
> Components > Component > ListBox > Method > getVScrollPos
...
ListBox.getHScrollPosListBox.scrollbartype
...
> Components > Component > ListBox > Method > init
...
| vLeft | String, Number | ListBox 의 left 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 right 속성값을 기준으로 ListBox 의 left 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 ListBox 의 left 가 결정됩니다. |
| vTop | String, Number | ListBox 의 top 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 bottom 속성값을 기준으로 ListBox 의 top 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 ListBox 의 top 이 결정됩니다. |
| vWidth | String, Number | ListBox 의 width 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 ListBox 의 width 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 ListBox 의 width 가 결정됩니다. |
| vHeight | String, Number | ListBox 의 height 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 ListBox 의 height 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 ListBox 의 height 가 결정됩니다. |
| vRight | String, Number | ListBox 의 right 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vLeft, vWidth 값을 모두 설정했을 경우 vRight 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 left 속성값을 기준으로 ListBox 의 right 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 ListBox 의 right 가 결정됩니다. |
| vBottom | String, Number | ListBox 의 bottom 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vTop, vHeight 값을 모두 설정했을 경우 vBottom 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 top 속성값을 기준으로 ListBox 의 bottom 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 ListBox 의 bottom 이 결정됩니다. |
| vMinWidth | String, Number | ListBox 이(가) 화면에 표시되는 최소 너비값을 pixel 단위의 숫자로 설정합니다. |
| vMaxWidth | String, Number | ListBox 이(가) 화면에 표시되는 최대 너비값을 pixel 단위의 숫자로 설정합니다.

vMinWidth 보다 작은 값을 설정하면 vMinWidth 값으로 설정됩니다. |
| vMinHeight | String, Number | ListBox 이(가) 화면에 표시되는 최소 높이값을 pixel 단위의 숫자로 설정합니다. |
| vMaxHeight | String, Number | ListBox 이(가) 화면에 표시되는 최대 높이값을 pixel 단위의 숫자로 설정합니다.
...
```javascript
var objComp = new ListBox();

objComp.init( "ListBox00", 30, 120, 196, 46 );
objComp.init( "ListBox00", 30, 120, 196, 46, null, null );
objComp.init( "ListBox00", null, null, 300, "400px", "80%", 300 );
objComp.init( "ListBox00", 0, 0, 200, 100, null, null, 300, 500, 200, 500 );
objComp.init( "ListBox00", "ListBox22:10", 300, null, null, "ListBox33:10", "20%", 300, 500, 200, 500 );
```
...
Form.addChildForm.insertChildForm.removeChildListBox.destroyListBox.show
...
> Components > Component > ListBox > Method > insertEventHandler
...
var nIndex = this.ListBox00.insertEventHandler( "onmove", 0, this.ListBox00_onmove, this);
```
...
> Components > Component > ListBox > Method > move
...
```javascript
this.ListBox00.move(10,10);
this.ListBox00.move(10,10,100,100);
this.ListBox00.move(null, null, 300, "400px", "80%", 300 );
```
...
> Components > Component > ListBox > Method > moveToNext
...
```javascript
this.ListBox.moveToNext( this.Button00 );
this.ListBox.moveToNext( "Button00" );
```
...
> Components > Component > ListBox > Method > moveToPrev
...
```javascript
this.ListBox.moveToPrev( this.Button00 );
this.ListBox.moveToPrev( "Button00" );
```
...
> Components > Component > ListBox > Method > removeEvent
...
```javascript
var bResult = this.ListBox00.removeEvent( "onmove" );
```
...
> Components > Component > ListBox > Method > removeEventHandler
...
```javascript
this.ListBox00_onmove = function( obj:nexacro.ListBox,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.ListBox00.removeEventHandler( "onmove", this.ListBox00_onmove, this);
```
...
> Components > Component > ListBox > Method > removeEventHandlerLookup
...
```javascript
this.ListBox00_onmove = function( obj:nexacro.ListBox,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.ListBox00.removeEventHandlerLookup( "onmove", "ListBox00_onmove", this);
```
...
> Components > Component > ListBox > Method > resize
...
> Components > Component > ListBox > Method > scrollBy
...
> Components > Component > ListBox > Method > scrollTo
...
> Components > Component > ListBox > Method > sendToBack
...
> Components > Component > ListBox > Method > sendToNext
...
> Components > Component > ListBox > Method > setEventHandler
...
```javascript
this.ListBox00_onmove = function( obj:nexacro.ListBox,  e:nexacro.MoveEventInfo ) { //수행할 스크립트 };
var nIndex = this.ListBox00.setEventHandler( "onmove", this.ListBox00_onmove, this );
```
...
> Components > Component > ListBox > Method > setEventHandlerLookup
...
```javascript
this.ListBox00_onmove = function( obj:nexacro.ListBox,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.ListBox00.setEventHandlerLookup( "onmove", "ListBox00_onmove", this);
```
...
> Components > Component > ListBox > Method > setFocus

**Description**

ListBox 에 포커스를 설정하는 메서드입니다.

**Syntax**

```javascript
ListBox.setFocus( [bMoveScroll] )
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| bMoveScroll | Boolean | 부모 컴포넌트에 스크롤이 있을 경우, ListBox 기준으로 스크롤을 이동할지 여부를 설정합니다.

true: ListBox 이(가) 화면에 표시되도록 스크롤을 이동합니다.
false: ListBox 위치와 관계없이 스크롤을 이동하지 않습니다.
...
```javascript
var objBefComp = this.ListBox00.setFocus();
var objBefComp = this.ListBox00.setFocus( false );
```
...
| Type | Description |
| --- | --- |
| Object | ListBox 이(가) 포커스를 얻기 전에 포커스를 가지고 있던 컴포넌트를 반환합니다.
...
> Components > Component > ListBox > Method > setInnerDataset
...
```javascript
this.ListBox00.setInnerDataset( this.Dataset00 ) ;
```
...
> Components > Component > ListBox > Method > setOffsetBottom
...
```javascript
this.ListBox.setOffsetBottom( 10 );
```
...
> Components > Component > ListBox > Method > setOffsetHeight
...
```javascript
this.ListBox.setOffsetHeight( 10 );
```
...
> Components > Component > ListBox > Method > setOffsetLeft
...
> Components > Component > ListBox > Method > setOffsetRight
...
```javascript
this.ListBox.setOffsetRight( 600 );
```
...
> Components > Component > ListBox > Method > setOffsetTop
...
> Components > Component > ListBox > Method > setOffsetWidth
...
```javascript
this.ListBox.setOffsetWidth( 10 );
```
...
> Components > Component > ListBox > Method > setSelect
...
false 설정 시 아이템의 선택상태가 해제 됩니다. |

**Sample Call**

```javascript
this.ListBox00.setSelect( 0, false );
```
...
> Components > Component > ListBox > Method > show
...
Form.addChildForm.insertChildForm.removeChildListBox.destroyListBox.init
...
> Components > Component > ListBox > Method > updateToDataset
...
> Components > Component > ListBox > Event > canitemchange

**Description**

ListBox 에서 아이템을 변경할 때 발생하는 이벤트입니다.

**Syntax**

```javascript
canitemchange(obj:nexacro.ListBox,e:nexacro.ItemChangeEventInfo);
```
...
> Components > Component > ListBox > Event > oncontextmenu

**Description**

ListBox 영역에서 오른쪽 마우스 버튼을 클릭하거나 터치를 일정시간 유지할 때 발생하는 이벤트입니다.

**Syntax**

```javascript
oncontextmenu(obj:nexacro.ListBox,e:nexacro.ContextMenuEventInfo);
```
...
- ListBox 컴포넌트는 마우스 우클릭이나 터치에 의해 표시되는 기본팝업메뉴가 제공되지 않습니다.
...
> Components > Component > ListBox > Event > ondevicebuttonup
...
```javascript
ondevicebuttonup(obj:nexacro.ListBox,e:nexacro.DeviceButtonEventInfo);
```
...
> Components > Component > ListBox > Event > ondrag

**Description**

ListBox 영역 내에서 마우스 왼쪽버튼으로 드래그를 수행했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondrag(obj:nexacro.ListBox,e:nexacro.DragEventInfo);
```
...
- ListBox 영역 내에서 마우스의 LButtonDown 후 LButtonUp 액션 없이 마우스 이동 시 ondrag 이벤트가 발생합니다.
...
> Components > Component > ListBox > Event > ondragenter

**Description**

ListBox 영역 내로 드래그 상태의 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragenter(obj:nexacro.ListBox,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 ListBox 영역으로 마우스 포인터가 들어올 때마다 이벤트가 발생합니다.
...
> Components > Component > ListBox > Event > ondragleave

**Description**

ListBox 영역 밖으로 드래그 상태의 마우스 포인터가 나갈 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragleave(obj:nexacro.ListBox,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 ListBox 영역에서 마우스 포인터가 나갈 때마다 이벤트가 발생합니다.
...
> Components > Component > ListBox > Event > ondragmove

**Description**

ListBox 영역 내에서 드래그 상태의 마우스 포인터가 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragmove(obj:nexacro.ListBox,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 ListBox 영역 내에서 마우스 포인터가 움직일 때마다 이벤트가 발생합니다.
...
> Components > Component > ListBox > Event > ondrop

**Description**

ListBox 영역 내에서 드래그 상태의 마우스 버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondrop(obj:nexacro.ListBox,e:nexacro.DragEventInfo);
```
...
- ListBox 영역 내에서 드래그 상태인 마우스의 LButtonUp 액션 발생 시 ondrop 이벤트가 발생합니다.
...
> Components > Component > ListBox > Event > onhscroll

**Description**

ListBox 의 수평 스크롤바를 스크롤 했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onhscroll(obj:nexacro.ListBox,e:nexacro.ScrollEventInfo);
```
...
> Components > Component > ListBox > Event > oninnerdatachanged

**Description**

ListBox 의 innerdataset 속성에 바인딩된 DataSet 에서 데이터 변경이 된 후 발생하는 이벤트입니다.

**Syntax**

```javascript
oninnerdatachanged(obj:nexacro.ListBox,e:nexacro.InnerdataChangedEventInfo);
```
...
- innerdataset 속성에 바인딩된 DataSet 의 Data 가 변경되면 oninnerdatachanged 이벤트가 발생합니다.
  ...
  예를 들어 DataSet 의 Data 변경에 의해 ListBox 의 아이템 길이가 변경되면 이벤트가 발생합니다.
...
> Components > Component > ListBox > Event > onitemchanged

**Description**

ListBox 에서 아이템 선택이 변경된 후 발생하는 이벤트입니다.

**Syntax**

```javascript
onitemchanged(obj:nexacro.ListBox,e:nexacro.ItemChangeEventInfo);
```
...
- index 속성이 변경됐을 때만 onitemchanged 이벤트가 발생합니다.
  multiselect 속성값을 true로 설정하고 2개 이상의 아이템을 선택한 경우 현재 index 위치가 아닌 아이템을 선택 취소하면 index 속성은 그대로 유지되므로 onitemchanged 이벤트가 발생하지 않습니다. 하지만, 현재 index 위치의 아이템을 선택 취소하면 이전 index 속성값으로 변경되고 onitemchanged 이벤트가 발생합니다.
...
> Components > Component > ListBox > Event > onitemclick
...
```javascript
onitemclick(obj:nexacro.ListBox,e:nexacro.ItemClickEventInfo);
```
...
> Components > Component > ListBox > Event > onitemdblclick

**Description**

아이템 리스트에서 아이템을 더블 클릭했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onitemdblclick(obj:nexacro.ListBox,e:nexacro.ClickEventInfo);
```
...
- onitemdblclick 이벤트는 onitemclick -> onitemclick -> onitemdblclick 순서로 발생합니다.

- 마우스 선택으로 아이템이 변경되었다면 onitemclick -> canitemchange -> onitemdchanged -> onitemclick -> onitemdblclick 순서로 발생합니다.
...
> Components > Component > ListBox > Event > onkeydown

**Description**

ListBox 에 포커스가 있는 상태에서 키보드의 키가 눌렸을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkeydown(obj:nexacro.ListBox,e:nexacro.KeyEventInfo);
```
...
＊ multiselect="false" 인 경우      
- 상하방향키 다운 : 아이템 선택 변경      
- 조합키 [Ctrl+Down/Up] 다운 : 스크롤 다운/업 처리 

＊ multiselect="true" 인 경우      
- 상하방향키 다운 : 아이템 선택 변경      
- 조합키 [Ctrl+Down/Up] 다운 : 스크롤 다운/업 처리      
- 조합키 [Shift+Down/Up] 다운 : 아이템 멀티 선택      
- 조합키 [Ctrl+Space] 다운 : 아이템 선택 토글 처리
...
> Components > Component > ListBox > Event > onkeyup

**Description**

ListBox 에 포커스가 있는 상태에서 눌렸던 키보드가 떼어질 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkeyup(obj:nexacro.ListBox,e:nexacro.KeyEventInfo);
```
...
> Components > Component > ListBox > Event > onkillfocus

**Description**

ListBox 에서 포커스가 나갈  때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkillfocus(obj:nexacro.ListBox,e:nexacro.KillFocusEventInfo);
```
...
- showModal(), open() 등의 메소드로 팝업된 Frame 으로 포커스가 이동하는 경우 ListBox 에서 포커스 관련 이벤트가 발생하지 않습니다.
   또한, alert(), confirm() 메소드로 표시된 팝업으로 포커스가 이동하는 경우도 ListBox 에서 포커스 관련 이벤트가 발생하지 않습니다.
...
> Components > Component > ListBox > Event > onlbuttondown

**Description**

ListBox 영역 내에서 마우스 왼쪽버튼을 눌렀을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onlbuttondown(obj:nexacro.ListBox,e:nexacro.MouseEventInfo);
```
...
- ListBox 영역 내에서 마우스의 LButtonDown 액션이 발생하면 이벤트가 발생합니다.
...
> Components > Component > ListBox > Event > onlbuttonup

**Description**

ListBox 영역 내에서 눌렸던 마우스 왼쪽버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onlbuttonup(obj:nexacro.ListBox,e:nexacro.MouseEventInfo);
```
...
> Components > Component > ListBox > Event > onmouseenter

**Description**

ListBox 영역 내로 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmouseenter(obj:nexacro.ListBox,e:nexacro.MouseEventInfo);
```
...
> Components > Component > ListBox > Event > onmouseleave

**Description**

ListBox 영역 밖으로 마우스 포인터가 나갈 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmouseleave(obj:nexacro.ListBox,e:nexacro.MouseEventInfo);
```
...
> Components > Component > ListBox > Event > onmousemove

**Description**

ListBox 영역 내에서 마우스 포인터가 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmousemove(obj:nexacro.ListBox,e:nexacro.MouseEventInfo);
```
...
ListBox 영역 내에서 마우스의 휠버튼을 회전했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmousewheel(obj:nexacro.ListBox,e:nexacro.MouseWheelEventInfo);
```
...
- ListBox 에서 마우스의 휠버튼 회전값을 처리할 필요가 없을 때 상위 컴포넌트로 휠버튼 회전값과 이벤트가 전파됩니다.
   즉, ListBox 에서 스크롤이 이동될 때는 상위로 이벤트가 전파되지 않고, 스크롤이 처음이나 마지막 상태일 때 상위로 이벤트가 전파됩니다.
...
- Zoom 상태에서도 ListBox 에서 이벤트가 발생하고 리턴값에 따라 상위로 전파되므로 스크립트 작성 시 주의하여야 합니다.
   이 때, 스크롤은 처리되지 않으며 e.ctrlkey 속성값이 true 로 설정됩니다.

**Default Action**

- ListBox 컴포넌트에 스크롤바가 있다면 이벤트 발생 후 스크롤을 이동시킵니다.
...
> Components > Component > ListBox > Event > onmove

**Description**

ListBox 의 위치가 이동했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmove(obj:nexacro.ListBox,e:nexacro.MoveEventInfo);
```
...
> Components > Component > ListBox > Event > onrbuttondown

**Description**

ListBox 영역 내에서 마우스 오른쪽버튼을 눌렀을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onrbuttondown(obj:nexacro.ListBox,e:nexacro.MouseEventInfo);
```
...
> Components > Component > ListBox > Event > onrbuttonup

**Description**

ListBox 영역 내에서 마우스 오른쪽버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onrbuttonup(obj:nexacro.ListBox,e:nexacro.MouseEventInfo);
```
...
> Components > Component > ListBox > Event > onsetfocus

**Description**

ListBox 에 포커스가 들어올 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onsetfocus(obj:nexacro.ListBox,e:nexacro.SetFocusEventInfo);
```
...
- open() 메소드로 오픈된 Modeless 창에서 부모창의 ListBox 에 setFocus() 메소드 실행 시 환경에 따라 동작에 차이가 있으므로 주의하여야 합니다.
...
> Components > Component > ListBox > Event > onsize

**Description**

ListBox 의 크기가 변경됐을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onsize(obj:nexacro.ListBox,e:nexacro.SizeEventInfo);
```
...
> Components > Component > ListBox > Event > ontouchend

**Description**

ListBox 영역 내에서 터치를 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchend(obj:nexacro.ListBox,e:nexacro.TouchEventInfo);
```
...
> Components > Component > ListBox > Event > ontouchmove

**Description**

ListBox 영역 내에서 터치 상태를 유지하며 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchmove(obj:nexacro.ListBox,e:nexacro.TouchEventInfo);
```
...
> Components > Component > ListBox > Event > ontouchstart

**Description**

ListBox 영역 내에서 터치가 시작될 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchstart(obj:nexacro.ListBox,e:nexacro.TouchEventInfo);
```
...
- selectscrollmode="select" 이면 이벤트 발생 후 ListBox 컴포넌트가 포커스 되고, 터치된 아이템에 Status가 적용됩니다.
...
> Components > Component > ListBox > Event > onvscroll

**Description**

ListBox 의 수직 스크롤바를 스크롤 했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onvscroll(obj:nexacro.ListBox,e:nexacro.ScrollEventInfo);
```
...
## Components > Component > ListBox > Objects
...
ListBox 를 구성하는 하위 오브젝트입니다.


---

## Components > Component > ListBox > ListBoxItemControl

### ListBoxItemControl

> Components > Component > ListBox > Objects > ListBoxItemControl

**Description**

ListBox 컴포넌트를 구성하는 ListBoxItemControl 오브젝트입니다.

**Remark**

- ListBox 컴포넌트에 Item 으로 한개 이상 추가되는 Control 오브젝트입니다.

**Property**

| Name | Description |
| --- | --- |
| background | ListBoxItemControl 의 배경 영역을 설정하는 속성입니다. |
| border-radius | ListBoxItemControl 의 모서리 모양을 설정하는 속성입니다. |
| color | ListBoxItemControl 에 표시되는 텍스트의 색상을 설정하는 속성입니다. |
| cursor | ListBoxItemControl 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다. |
| font | ListBoxItemControl 에서 사용하는 폰트를 설정하는 속성입니다. |
| letter-spacing | ListBoxItemControl 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다. |
| -nexa-border | ListBoxItemControl 의 테두리를 설정하는 속성입니다. |
| -nexa-edge | ListBoxItemControl 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-padding | ListBoxItemControl 영역의 안쪽 여백을 설정하는 속성입니다. |
| -nexa-rtl-background-image | ListBoxItemControl 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다. |
| -nexa-rtl-edge-image | ListBoxItemControl 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-text-align | ListBoxItemControl 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다. |
| -nexa-text-decoration | ListBoxItemControl 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다. |
| -nexa-vertical-align | ListBoxItemControl 에 표시되는 텍스트 또는 컨텐츠의 세로 정렬 방식을 설정하는 속성입니다. |
| opacity | ListBoxItemControl 영역의 투명도를 설정하는 속성입니다. |
| word-spacing | ListBoxItemControl 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다. |
...
> Components > Component > ListBox > Objects > ListBoxItemControl > Property > -nexa-border

**Description**

ListBoxItemControl 의 테두리를 설정하는 속성입니다.

**Syntax**

```javascript
ListBoxItemControl.-nexa-border
```
...
> Components > Component > ListBox > Objects > ListBoxItemControl > Property > -nexa-edge

**Description**

ListBoxItemControl 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
ListBoxItemControl.-nexa-edge
```
...
- ListBoxItemControl 내부에 테두리 형태로 이미지를 표시하고자 할 때 사용하는 속성입니다.
...
> Components > Component > ListBox > Objects > ListBoxItemControl > Property > -nexa-padding

**Description**

ListBoxItemControl 영역의 안쪽 여백을 설정하는 속성입니다.

**Syntax**

```javascript
ListBoxItemControl.-nexa-padding
```
...
-nexa-padding : 5px 5px 5px 5px;
```
- **`<npadding>`** — ListBoxItemControl 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
- ListBoxItemControl 의 너비보다 표시되는 컨텐츠의 너비가 길면 "right" 방향의 padding 값이 무시됩니다.
...
> Components > Component > ListBox > Objects > ListBoxItemControl > Property > -nexa-rtl-background-image

**Description**

ListBoxItemControl 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
ListBoxItemControl.-nexa-rtl-background-image
```
...
> Components > Component > ListBox > Objects > ListBoxItemControl > Property > -nexa-rtl-edge-image

**Description**

ListBoxItemControl 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
ListBoxItemControl.-nexa-rtl-edge-image
```
...
> Components > Component > ListBox > Objects > ListBoxItemControl > Property > -nexa-text-align

**Description**

ListBoxItemControl 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
ListBoxItemControl.-nexa-text-align
```
...
- ListBoxItemControl 의 너비보다 표시되는 텍스트의 길이가 크면 "right" 를 설정해도 "left" 로 동작됩니다.
...
> Components > Component > ListBox > Objects > ListBoxItemControl > Property > -nexa-text-decoration

**Description**

ListBoxItemControl 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다.

**Syntax**

```javascript
ListBoxItemControl.-nexa-text-decoration
```
...
> Components > Component > ListBox > Objects > ListBoxItemControl > Property > -nexa-vertical-align

**Description**

ListBoxItemControl 에 표시되는 텍스트 또는 컨텐츠의 세로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
ListBoxItemControl.-nexa-vertical-align
```
...
> Components > Component > ListBox > Objects > ListBoxItemControl > Property > background

**Description**

ListBoxItemControl 의 배경 영역을 설정하는 속성입니다.

**Syntax**

```javascript
ListBoxItemControl.background
```
...
"left" 설정 시 ListBoxItemControl 의 왼쪽면과 이미지의 왼쪽면이 정렬되어 표시됩니다.
"center" 설정 시 ListBoxItemControl 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"right" 설정 시 ListBoxItemControl 의 오른쪽면과 이미지의 오른쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
"top" 설정 시 ListBoxItemControl 의 윗쪽면과 이미지의 윗쪽면이 정렬되어 표시됩니다.
"center" 설정 시 ListBoxItemControl 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"bottom" 설정 시 ListBoxItemControl 의 아랫쪽면과 이미지의 아랫쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
0 보다 작거나 100 보다 큰 값을 설정 시 ListBoxItemControl 의 영역을 벗어난 가상의 위치로 적용됩니다.
...
<angle> 값에 설정된 방향에 따라 시작점과 끝점의 위치가 결정됩니다.
예를 들어 <angle> 값이 "to left" 이면 ListBoxItemControl 의 right 위치가 시작점이 되고, left 위치가 끝점이 됩니다.
              <angle> 값이 "to right" 이면 ListBoxItemControl 의 left 위치가 시작점이 되고, right 위치가 끝점이 됩니다.
...
<bg-image> 또는 <linear-gradient> 값이 설정되어 있다면 배경색은 배경이미지 또는 그라데이션 아래에 표시됩니다.
<bg-image> 에 적용된 이미지에 투명으로 적용된 부분이 있거나 이미지가 ListBoxItemControl 영역보다 작다면 해당 영역에 배경색이 표시됩니다.
...
> Components > Component > ListBox > Objects > ListBoxItemControl > Property > border-radius

**Description**

ListBoxItemControl 의 모서리 모양을 설정하는 속성입니다.

**Syntax**

```javascript
ListBoxItemControl.border-radius
```
...
> Components > Component > ListBox > Objects > ListBoxItemControl > Property > color

**Description**

ListBoxItemControl 에 표시되는 텍스트의 색상을 설정하는 속성입니다.

**Syntax**

```javascript
ListBoxItemControl.color
```
...
> Components > Component > ListBox > Objects > ListBoxItemControl > Property > cursor

**Description**

ListBoxItemControl 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
ListBoxItemControl.cursor
```
...
> Components > Component > ListBox > Objects > ListBoxItemControl > Property > font

**Description**

ListBoxItemControl 에서 사용하는 폰트를 설정하는 속성입니다.

**Syntax**

```javascript
ListBoxItemControl.font
```
...
> Components > Component > ListBox > Objects > ListBoxItemControl > Property > letter-spacing

**Description**

ListBoxItemControl 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다.

**Syntax**

```javascript
ListBoxItemControl.letter-spacing
```
...
> Components > Component > ListBox > Objects > ListBoxItemControl > Property > opacity

**Description**

ListBoxItemControl 영역의 투명도를 설정하는 속성입니다.

**Syntax**

```javascript
ListBoxItemControl.opacity
```
...
> Components > Component > ListBox > Objects > ListBoxItemControl > Property > word-spacing

**Description**

ListBoxItemControl 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다.

**Syntax**

```javascript
ListBoxItemControl.word-spacing
```
