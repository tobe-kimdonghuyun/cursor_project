...
## Components > ContainerComponent > Div
...
| Name | Description |
| --- | --- |
| accessibilityaction | Div에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다. |
| accessibilitydesclevel | Div 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| accessibilitydescription | Div에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다. |
| accessibilityenable | Div 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| accessibilitylabel | Div에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다. |
| accessibilityrole | Div에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다. |
| async | Div 의 url 속성값을 동적으로 변경 시 연결된 Form 의 로딩방식을 설정하는 속성입니다. |
| background | Div 의 배경 영역을 설정하는 속성입니다. |
| border-radius | Div 의 모서리 모양을 설정하는 속성입니다. |
| bottom | Div 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다. |
| box-shadow | Div 에 그림자 효과를 설정하는 속성입니다. |
| color | Div 에 표시되는 텍스트의 색상을 설정하는 속성입니다. |
| cssclass | Div 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다. |
| cursor | Div 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다. |
| enable | Div 의 사용가능 여부를 설정하는 속성입니다. |
| enableevent | Div 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다. |
| fittocontents | Div 의 내부 컨텐츠영역이 컨텐츠 내용에 맞게 자동조정되는 영역을 설정하는 속성입니다. |
...
| font | Div 에서 사용하는 폰트를 설정하는 속성입니다. |
| form | Div 에서 모든 오브젝트가 등록된 Form 을 갖는 읽기전용 속성입니다. |
| formscrollbarbarminsize | Div 의 내부 Form 에 표시되는 스크롤바의 트랙바(TrackBar) 최소크기를 설정하는 속성입니다. |
| formscrollbarbaroutsize | Div 의 내부 Form 에 표시되는 스크롤바에서 트랙바(TrackBar)가 사라지는 기준 크기를 설정하는 속성입니다. |
| formscrollbardecbuttonsize | Div 에서 내부 Form 에 표시되는 스크롤바의 감소 버튼(DecButton) 크기를 설정하는 속성입니다. |
| formscrollbarincbuttonsize | Div 에서 내부 Form 에 표시되는 스크롤바의 증가 버튼(IncButton) 크기를 설정하는 속성입니다. |
| formscrollbarsize | Div 에서 내부 Form 에 표시되는 스크롤바의 크기를 설정하는 속성입니다. |
| formscrollbartrackbarsize | Div 의 내부 Form 에 표시되는 스크롤바의 트랙바(TrackBar) 크기를 설정하는 속성입니다. |
| formscrollbartype | Div 에서 내부 Form 에 스크롤바가 표시되는 형식을 설정하는 속성입니다. |
| formscrollindicatorsize | Div 에서 내부 Form 에 표시되는 스크롤 인디케이터바의 크기를 설정하는 속성입니다. |
| formscrolltype | Div 의 내부 Form 에서 사용되는 스크롤의 종류를 설정하는 속성입니다. |
| height | Div 을(를) 표시하기 위한 높이를 설정하는 속성입니다. |
| hotkey | Div 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다. |
| id | Div의 고유 식별자를 설정하는 속성입니다. |
| initvalueid | Div 에 적용될 InitValue 의 ID 를 설정하는 속성입니다. |
| layoutorder | Layout 컨테이너 내 Main Axis(type 속성값이 "horizontal"이면 수평축, type 속성값이 "vertical"이면 수직축)에 컴포넌트가 배치되는 순서를 설정합니다. |
| left | Div 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다. |
| letter-spacing | Div 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다. |
| maxheight | Div 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다. |
| maxwidth | Div 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다. |
| minheight | Div 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다. |
| minwidth | Div 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다. |
| name | Div 의 이름을 설정하는 속성입니다. |
| -nexa-border | Div 의 테두리를 설정하는 속성입니다. |
| -nexa-edge | Div 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-rtl-background-image | Div 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다. |
| -nexa-rtl-edge-image | Div 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| opacity | Div 영역의 투명도를 설정하는 속성입니다. |
| parent | Div 의 부모 오브젝트를 갖는 읽기전용 속성입니다. |
| positionstep | 부모 오브젝트가 화면분할기능을 사용할 때 Div 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다. |
| right | Div 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다. |
| rtl | Div 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다. |
...
| taborder | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 Div 의 순서를 설정하는 속성입니다. |
| tabstop | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 Div 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다. |
| text | Div 에 내부 컴포넌트가 없을 때 화면에 표시될 텍스트를 설정하는 속성입니다. |
| tooltiptext | Div 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다. |
| tooltiptype | Div 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다. |
| top | Div 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다. |
| url | Div 에 Form 을 연결하여 표시할 때 설정하는 속성입니다. |
| urlchangeeffect | Div 에서 스크립트로 url 속성값을 변경할 때 적용될 Animation 효과를 설정하는 속성입니다. |
| visible | Div 이(가) 화면에 표시될지 여부를 설정하는 속성입니다. |
| width | Div 을(를) 표시하기 위한 너비를 설정하는 속성입니다. |
| word-spacing | Div 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다. |

**Method**

| Name | Description |
| --- | --- |
| addChild | 스크립트에서 동적으로 생성한 컴포넌트를 Div 의 자식 컴포넌트로 추가하는 메소드입니다. |
| addEvent | Div 에 특정 이벤트를 선언하여 추가하는 메소드입니다. |
| addEventHandler | Div 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다. |
| addEventHandlerLookup | 함수를 검색하여 Div 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다. |
| bringToFront | 부모가 동일한 컴포넌트 중 Div 이(가) 화면의 제일 앞에 표시되게 합니다. |
| bringToPrev | 부모가 동일한 컴포넌트 중 Div 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| clearEventHandler | 특정 이벤트에 등록된 핸들러 함수를 모두 제거하는 메소드입니다. |
| destroy | 스크립트에서 동적으로 생성한 Div 을(를) 삭제하는 메소드입니다. |
| findEventHandler | Div 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다. |
| getEventHandler | Div 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다. |
| getOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 Div 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetHeight | Div 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 Div 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 Div 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 Div 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetWidth | Div 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getPixelBottom | Div 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelHeight | Div 의 height 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelLeft | Div 의 left 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelRight | Div 의 right 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelTop | Div 의 top 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelWidth | Div 의 width 속성값을 픽셀단위로 반환하는 메소드입니다. |
| init | 스크립트로 Div 을(를) 동적 생성한 후에 초기화하는 메소드입니다. |
| insertChild | 스크립트로 동적 생성한 컴포넌트를 Div 의 자식 컴포넌트로 특정 순서에 추가하는 메소드입니다. |
| insertEventHandler | Div 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다. |
| move | Div 의 위치와 크기를 변경하는 메소드입니다. |
| moveToNext | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Div 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| moveToPrev | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Div 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| reload | Div 에 url 속성으로 연결된 Form 을 다시 로딩하는 메서드입니다. |
| removeChild | Div 에 동적으로 추가된 컴포넌트를 제거하는 메소드입니다. |
| removeEvent | Div 에 선언된 특정 이벤트를 삭제하는 메소드입니다. |
| removeEventHandler | Div 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다. |
| removeEventHandlerLookup | Div 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다. |
| resize | Div 의 크기를 변경하는 메소드입니다. |
| sendToBack | 부모가 동일한 컴포넌트 중 Div 이(가) 화면의 제일 뒤에 표시되게 합니다. |
| sendToNext | 부모가 동일한 컴포넌트 중 Div 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| setContents | Div 의 내부 구성 컨텐츠를 동적으로 설정하는 메소드입니다. |
| setEventHandler | Div 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다. |
| setEventHandlerLookup | Div 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다. |
| setFocus | Div 컴포넌트(오브젝트)에 포커스를 설정하는 메서드입니다. |
| setOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 Div 의 bottom 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetHeight | Div 의 높이를 픽셀단위로 설정하는 메소드입니다. |
| setOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 Div 의 left 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 Div 의 right 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 Div 의 top 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetWidth | Div 의 너비를 픽셀단위로 설정하는 메소드입니다. |
| show | 스크립트로 동적 생성한 Div 을(를) 화면에 표시하는 메소드입니다. |

**Event**

| Name | Description |
| --- | --- |
| onclick | Div 영역 내에서 마우스 왼쪽버튼을 클릭했을 때 발생하는 이벤트입니다. |
| oncontextmenu | Div 영역에서 오른쪽 마우스 버튼을 클릭하거나 터치를 일정시간 유지할 때 발생하는 이벤트입니다. |
| ondevicebuttonup | 모바일 에서 디바이스 버튼을 눌렀을 때 발생하는 이벤트입니다. |
| ondrag | Div 영역 내에서 마우스 왼쪽버튼으로 드래그를 수행했을 때 발생하는 이벤트입니다. |
| ondragenter | Div 영역 내로 드래그 상태의 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다. |
| ondragleave | Div 영역 밖으로 드래그 상태의 마우스 포인터가 나갈 때 발생하는 이벤트입니다. |
| ondragmove | Div 영역 내에서 드래그 상태의 마우스 포인터가 움직일 때 발생하는 이벤트입니다. |
| ondrop | Div 영역 내에서 드래그 상태의 마우스 버튼을 떼었을 때 발생하는 이벤트입니다. |
| onhscroll | Div 의 수평 스크롤바를 스크롤 했을 때 발생하는 이벤트입니다. |
| onkeydown | Div 에 포커스가 있는 상태에서 키보드의 키가 눌렸을 때 발생하는 이벤트입니다. |
| onkeyup | Div 에 포커스가 있는 상태에서 눌렸던 키보드가 떼어질 때 발생하는 이벤트입니다. |
| onkillfocus | Div 에서 포커스가 나갈  때 발생하는 이벤트입니다. |
| onlbuttondown | Div 영역 내에서 마우스 왼쪽버튼을 눌렀을 때 발생하는 이벤트입니다. |
| onlbuttonup | Div 영역 내에서 눌렸던 마우스 왼쪽버튼을 떼었을 때 발생하는 이벤트입니다. |
| onmousedown | Div 영역 내에서 마우스의 왼쪽/오른쪽 버튼을 제외한 나머지 버튼이 눌렸을 때 발생하는 이벤트입니다. |
| onmouseenter | Div 영역 내로 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다. |
| onmouseleave | Div 영역 밖으로 마우스 포인터가 나갈 때 발생하는 이벤트입니다. |
| onmousemove | Div 영역 내에서 마우스 포인터가 움직일 때 발생하는 이벤트입니다. |
| onmouseup | 마우스의 왼쪽/오른쪽 버튼을 제외한 나머지 버튼이 떼어질 때 발생하는 이벤트입니다. |
| onmousewheel | Div 영역 내에서 마우스의 휠버튼을 회전했을 때 발생하는 이벤트입니다. |
| onmove | Div 의 위치가 이동했을 때 발생하는 이벤트입니다. |
| onrbuttondown | Div 영역 내에서 마우스 오른쪽버튼을 눌렀을 때 발생하는 이벤트입니다. |
| onrbuttonup | Div 영역 내에서 마우스 오른쪽버튼을 떼었을 때 발생하는 이벤트입니다. |
| onsetfocus | Div 에 포커스가 들어올 때 발생하는 이벤트입니다. |
| onsize | Div 의 크기가 변경됐을 때 발생하는 이벤트입니다. |
| ontouchend | Div 영역 내에서 터치를 떼었을 때 발생하는 이벤트입니다. |
| ontouchmove | Div 영역 내에서 터치 상태를 유지하며 움직일 때 발생하는 이벤트입니다. |
| ontouchstart | Div 영역 내에서 터치가 시작될 때 발생하는 이벤트입니다. |
| onvscroll | Div 의 수직 스크롤바를 스크롤 했을 때 발생하는 이벤트입니다. |
...
> Components > ContainerComponent > Div > Property > -nexa-border

**Description**

Div 의 테두리를 설정하는 속성입니다.

**Syntax**

```javascript
Div.border[= strborder]
```
...
this.Div00.border = "1px solid #999999";
this.Div00.border = "1px solid #999999, 1px solid #999999, 1px solid #999999, 1px solid #999999";
```
...
> Components > ContainerComponent > Div > Property > -nexa-edge

**Description**

Div 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.
...
* Script ( normal property )
this.Div00.edge = "URL('./images/border.png')" 5px 5px;
```
...
- Div 내부에 테두리 형태로 이미지를 표시하고자 할 때 사용하는 속성입니다.
...
> Components > ContainerComponent > Div > Property > -nexa-rtl-background-image

**Description**

Div 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
Div.-nexa-rtl-background-image
```
...
> Components > ContainerComponent > Div > Property > -nexa-rtl-edge-image

**Description**

Div 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
Div.-nexa-rtl-edge-image
```
...
> Components > ContainerComponent > Div > Property > accessibilityaction

**Description**

Div에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Div.accessibilityaction[= strAction]
```

**Setting Syntax**

```javascript
this.Div00.accessibilityaction = "Accessibility Action Message"; 
this.Div00.accessibilityaction = "Select by direction key";
```
...
> Components > ContainerComponent > Div > Property > accessibilitydesclevel

**Description**

Div 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
Div.accessibilitydesclevel[= enumLevel]
```
...
```
```javascript
this.Div00.accessibilitydesclevel = "all";
```
- **`"all"`** — Div 와 자식 컴포넌트에 대한 접근성을 모두 출력합니다.
- **`"self"`** — Div 의 접근성만 출력하고 자식 컴포넌트의 접근성은 출력하지 않습니다.
- **`"child"`** — Div 의 접근성은 출력하지 않고, 자식 컴포넌트의 접근성은 출력합니다.
- **`"none"`** — Div 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
...
- accessibilitydesclevel 속성은 선택상자의 이동에 영향을 주지 않으므로 방향키로 선택상자가 Div 에 이동되게 하지 않으려면 accessibilityenable 속성을 설정하여야 합니다.
...
> Components > ContainerComponent > Div > Property > accessibilitydescription

**Description**

Div에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Div.accessibilitydescription[= strDescription]
```

**Setting Syntax**

```javascript
this.Div00.accessibilitydescription = "Option";
```
...
> Components > ContainerComponent > Div > Property > accessibilityenable

**Description**

Div 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
Div.accessibilityenable[= bEnable]
```
...
```
```javascript
this.Div00.accessibilityenable = false;
```
- **`true`** — Div 에 선택상자가 이동되면 접근성 관련 속성값을 출력합니다.

데스크탑 환경에서 방향키로 Div 에 선택상자가 이동됩니다.
모바일 환경에서는 Div 에 선택상자가 이동되지 않습니다.
- **`false`** — Div 에 선택상자가 이동되지 않습니다.
...
- 선택상자 이동 시 컴포넌트의 ARIA-LABEL + Status + Role 순서로 정보가 조합되어 접근성으로 출력됩니다.
   ...
   > Role : accessibilityrole 속성값이 반영됩니다. accessibilityrole 속성값을 설정하지 않으면 Div 의 고유 Role 이 반영됩니다.

- accessibilityenable 속성값이 false 일 때 데스크탑 환경에서 방향키 외의 방법으로 선택상자를 Div 로 이동시키면 스크린 리딩 프로그램에서 임의의 값을 출력할 수 있습니다.
...
> Components > ContainerComponent > Div > Property > accessibilitylabel

**Description**

Div에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Div.accessibilitylabel[= strLabel]
```

**Setting Syntax**

```javascript
this.Div00.accessibilitylabel = "OK Button"; 
this.Div00.accessibilitylabel = "[@static00]"; 
this.Div00.accessibilitylabel = "[@static00][@static01]"; 
this.Div00.accessibilitylabel = "[@static00][@static01] OK Button";
```
...
> Components > ContainerComponent > Div > Property > accessibilityrole

**Description**

Div에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Div.accessibilityrole[= enumRole]
```
...
```
```javascript
this.Div00.accessibilityrole = "none"; 
this.Div00.accessibilityrole = "button";
```
...
- accessibilityenable 속성값을 설정하지 않으면 Div의 기본 Role 로 적용됩니다.

- 추가적인 속성값이 필요한 Role 설정 시 Div에 해당 속성이 없으면 스크린 리더에 따라 정상적으로 정보를 읽지 못할 수 있습니다.
...
> Components > ContainerComponent > Div > Property > async

**Description**

Div 의 url 속성값을 동적으로 변경 시 연결된 Form 의 로딩방식을 설정하는 속성입니다.
...
```
- **`true`** — Div 에 Form 을 비동기(ASync) 방식으로 로드합니다.

Div 에 로딩된 Form 에서 onload 이벤트가 발생한 후 Form 의 내부 컴포넌트에 접근 가능합니다.
onload 이벤트 발생 전 Div 에 로딩된 Form 의 내부 컴포넌트 접근 시 오류가 발생합니다.

url 속성값을 변경한 위치 이후 스크립트 수행 기준은 Remark 를 참조하시기 바랍니다.
- **`false`** — Div 에 Form 을 동기(Sync) 방식으로 로드합니다.
...
- Div 를 포함한 Form 이 최초 로딩될 때 Div 에 url 속성으로 연결된 Form 은 async 속성값에 관계없이 항상 동기(Sync)방식으로 로딩됩니다.

- Div 에 연결된 Form 내부에서 Div 의 url 속성을 변경 시 async 속성값이 false 일 경우 오동작 할 수 있습니다.
   async 속성값이 false 이면 Div 의 url 속성을 변경하는 즉시 새로운 Form 이 로드되고 기존 Form이 제거되므로
   스크립트가 끝나기 전에 해당 오브젝트가 제거되서 문제가 발생할 수 있습니다.

- async 속성값이 true 일 때 url 속성을 변경한 위치 이후의 스크립트 수행 기준은 Div 에 연결된 Form 의 캐시여부에 따라 달라집니다.
...
> Components > ContainerComponent > Div > Property > background

**Description**

Div 의 배경 영역을 설정하는 속성입니다.

**Syntax**

```javascript
Div.background[= strbackground]
```
...
* Script ( normal property )
this.Div00.background = "#ffffaa";
this.Div00.background = ""URL('./images/smiley.gif')" no-repeat center center #ffffaa";
this.Div00.background = ""URL('./images/smiley.gif')" no-repeat center center /auto #ffffaa";
this.Div00.background = ""URL('./images/smiley.gif')" no-repeat center center /15px 15% #ffffaa";
this.Div00.background = "linear-gradient( red , blue , yellow )";
this.Div00.background = "linear-gradient( #FF0000 , rgb(0,0,255) , rgb(255,255,0))";
this.Div00.background = ""URL('./images/smiley.gif')" border-box border-box #ffffaa";
```
...
"left" 설정 시 Div 의 왼쪽면과 이미지의 왼쪽면이 정렬되어 표시됩니다.
"center" 설정 시 Div 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"right" 설정 시 Div 의 오른쪽면과 이미지의 오른쪽면이 정렬되어 표시됩니다.
...
"top" 설정 시 Div 의 윗쪽면과 이미지의 윗쪽면이 정렬되어 표시됩니다.
"center" 설정 시 Div 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"bottom" 설정 시 Div 의 아랫쪽면과 이미지의 아랫쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
0 보다 작거나 100 보다 큰 값을 설정 시 Div 의 영역을 벗어난 가상의 위치로 적용됩니다.
...
예를 들어 <angle> 값이 "to left" 이면 Div 의 right 위치가 시작점이 되고, left 위치가 끝점이 됩니다.
              <angle> 값이 "to right" 이면 Div 의 left 위치가 시작점이 되고, right 위치가 끝점이 됩니다.
...
<bg-image> 에 적용된 이미지에 투명으로 적용된 부분이 있거나 이미지가 Div 영역보다 작다면 해당 영역에 배경색이 표시됩니다.
...
> Components > ContainerComponent > Div > Property > border-radius

**Description**

Div 의 모서리 모양을 설정하는 속성입니다.

**Syntax**

```javascript
Div.borderRadius[= strborderradius]
```
...
* Script ( normal property )
this.Div00.borderRadius = "10px";
this.Div00.borderRadius = "5px 6px 10px / 5px 10px";
```
...
> Components > ContainerComponent > Div > Property > bottom

**Description**

Div 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.Div00.bottom = 10; 
this.Div00.bottom = "10px"; 
this.Div00.bottom = "10%"; 
this.Div00.bottom = "Button00:10px"; 
this.Div00.bottom = "Button00:10%";
```
- **`<strCompID>`** — Div 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 Div 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 Div 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Div 의 하단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 bottom 속성값을 기준으로 Div의 하단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 Div의 하단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Div의 하단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Div의 하단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 top 속성값을 기준으로 Div의 하단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 Div의 하단 위치 결정
...
> Components > ContainerComponent > Div > Property > box-shadow

**Description**

Div 에 그림자 효과를 설정하는 속성입니다.

**Syntax**

```javascript
Div.boxShadow[= strbshadow]
```
...
* Script ( normal property )
this.Div00.boxShadow  = "10px 10px 10px #888888";
this.Div00.boxShadow  = "inset 10px 10px 10px 5px #888888";
```
...
Div 의 좌상단 위치를 기준으로 그림자 효과가 표시될 위치를 가로/세로 픽셀값으로 설정합니다.
...
> Components > ContainerComponent > Div > Property > color

**Description**

Div 에 표시되는 텍스트의 색상을 설정하는 속성입니다.
...
* Script ( normal property )
this.Div00.color = "#999999";
this.Div00.color = "rgb(255,0,0)";
this.Div00.color = "red";
```
- **`<NamedColor>`** — "red","blue" 와 같이 미리 정의된 색상이름을 문자열로 설정합니다.
- **`<NumericColor>`** — 표시할 색의 색상코드입니다.
...
> Components > ContainerComponent > Div > Property > cssclass

**Description**

Div 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다.

**Syntax**

```javascript
Div.cssclass[= strcssclass]
```
...
```
```javascript
this.Div00.cssclass = "TestClass"; 
this.Div00.cssclass = "TestClass,TestClass2";
```
...
> Components > ContainerComponent > Div > Property > cursor

**Description**

Div 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
Div.cursor[= strCursor]
```
...
> Components > ContainerComponent > Div > Property > enable

**Description**

Div 의 사용가능 여부를 설정하는 속성입니다.
...
```
```javascript
this.Div00.enable = true; 
this.Div00.enable = false;
```
- **`true`** — Div 을(를) 사용할 수 있게 설정합니다.
- **`false`** — Div 을(를) 사용할 수 없게 설정합니다.
...
> Components > ContainerComponent > Div > Property > enableevent

**Description**

Div 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Div.enableevent[= bEvent]
```
...
```
```javascript
this.Div00.enableevent = true;  
this.Div00.enableevent = false;
```
- **`true`** — Div 에서 이벤트가 발생하도록 설정합니다.
- **`false`** — Div 에서 이벤트가 발생하지 않도록 설정합니다.
...
> Components > ContainerComponent > Div > Property > fittocontents

**Description**

Div 의 내부 컨텐츠영역이 컨텐츠 내용에 맞게 자동조정되는 영역을 설정하는 속성입니다.

**Syntax**

```javascript
Div.fittocontents[= enumFitTo]
```
...
```
```javascript
this.Div00.fittocontents = "width";
```
- **`"none"`** — 컨텐츠 내용과 관계없이 디자인 시 설정한 Div 의 너비와 높이를 유지합니다.
- **`"width"`** — 컨텐츠 내용에 맞게 Div 의 내부 컨텐츠영역 너비를 자동 조정합니다.
- **`"height"`** — 컨텐츠 내용에 맞게 Div 의 내부 컨텐츠영역 높이를 자동 조정합니다.
- **`"both"`** — 컨텐츠 내용에 맞게 Div 의 내부 컨텐츠영역 너비와 높이를 자동 조정합니다.

**Remark**

- fittocontents 속성값을 설정하지 않으면 "none" 으로 적용됩니다.

- Div 컴포넌트의 전체 크기는 내부 콘텐츠 영역 크기에 -nexa-border 영역과 spacing, horizontalgap, verticalgap 속성값이 반영되어 결정됩니다.

- Form 이 로딩될 때와 fittocontents 속성값이 변경되었을 때만 내부 콘텐츠 영역의 크기가 자동 조정됩니다.


◆ 스크립트로 내부 콘텐츠 변경 시

- 스크립트에 의해 Div 컴포넌트의 콘텐츠가 변경된 경우는 내부 콘텐츠 영역의 크기가 자동 조정되지 않습니다.
스크립트에 의해 Div 컴포넌트의 콘텐츠가 변경되어 내부 콘텐츠 영역의 크기가 다시 조정되어야 할 때는 콘텐츠를 변경시킨 스크립트 이후에 resetScroll() 메서드를 실행하여 크기를 재조정해야 합니다.

- resetScroll() 메서드 실행 시 fittocontents 속성이 "none" 이외의 값이어야 내부 콘텐츠 영역의 크기가 재조정됩니다.


◆ type 속성값에 따라 동작하지 않는 속성

type, fittocontents 속성값 설정이 일부 속성값 설정보다 우선 적용됩니다. 
아래 Div 컴포넌트 또는 Div 컴포넌트에 배치된 컴포넌트 속성은 동작하지 않습니다.

- type = "horizontal", fittocontents = "width" 또는 "both"
  Div 컴포넌트: flexwrap, flexmainaxisalign
  배치된 컴포넌트: flexgrow, flexshrink

- type = "horizontal", fittocontents = "height" 또는 "both"
  Div 컴포넌트: flexcrossaxisalign

- type = "vertical", fittocontents = "height" 또는 "both"
  Div 컴포넌트: flexwrap, flexmainaxisalign
  배치된 컴포넌트: flexgrow, flexshrink

- type = "vertical", fittocontents = "width" 또는 "both"
  Div 컴포넌트: flexcrossaxisalign


◆ type 속성값이 "table"일 경우 동작

tabletemplate 속성값에 따라 동작이 달라집니다.

- px, % 단위로 설정한 경우: 셀의 크기가 tabletemplate 크기에 맞춰집니다. 
  셀 크기보다 배치된 컴포넌트 크기가 큰 경우 스크롤이 표시될 수 있습니다.

- * 단위로 설정한 경우: 셀의 크기가 배치된 컴포넌트 크기에 맞춰집니다. 
  tabletemplate 비율은 유지됩니다.


◆ type 속성값이 "default"일 경우 동작

- Div 컴포넌트 내부 콘텐츠 영역 내에서 배치된 컴포넌트의 right, bottom 경계가 Div 컴포넌트 내부 콘텐츠 영역의 right, bottom 경계에 가까운 컴포넌트를 기준으로 Div 컴포넌트의 내부 콘텐츠 영역이 자동조정됩니다.
  예를 들어 Div 컴포넌트의 width 속성값이 100이고 left 속성값 20, width 50인 Button 컴포넌트를 배치한 후 fittocontents 속성값을 "width"로 설정한 경우 Div 컴포넌트의 내부 콘텐츠 영역이 Button 컴포넌트의 right 경계에 맞추어 줄어들면서 Div 컴포넌트의 너비가 70으로 표시됩니다.
...
> Components > ContainerComponent > Div > Property > flexgrow
...
> Components > ContainerComponent > Div > Property > flexshrink
...
> Components > ContainerComponent > Div > Property > font

**Description**

Div 에서 사용하는 폰트를 설정하는 속성입니다.
...
* Script ( normal property )
this.Div00.font = "bold 12pt/30px arial, sans-serif";
```
...
> Components > ContainerComponent > Div > Property > form

**Description**

Div 에서 모든 오브젝트가 등록된 Form 을 갖는 읽기전용 속성입니다.
...
```javascript
this.Div00.form.Button00.click();
```

**Remark**

- Div 내부에 정의된 컴포넌트에 접근하기 위해서는 form 속성을 사용하여야 합니다.
...
> Components > ContainerComponent > Div > Property > formscrollbarbarminsize

**Description**

Div 의 내부 Form 에 표시되는 스크롤바의 트랙바(TrackBar) 최소크기를 설정하는 속성입니다.

**Syntax**

```javascript
Div.formscrollbarbarminsize[= nSize]
```

**Setting Syntax**

```javascript
this.Div00.formscrollbarbarminsize = 20;
```
...
> Components > ContainerComponent > Div > Property > formscrollbarbaroutsize

**Description**

Div 의 내부 Form 에 표시되는 스크롤바에서 트랙바(TrackBar)가 사라지는 기준 크기를 설정하는 속성입니다.

**Syntax**

```javascript
Div.formscrollbarbaroutsize[= nSize]
```

**Setting Syntax**

```javascript
this.Div00.formscrollbarbaroutsize = 50;
```
...
- Div 의 크기가 변경되어 스크롤바가 줄어들 때 트랙바를 표시할 공간이 formscrollbarbaroutsize 속성값보다 작아지면 트랙바를 표시하지 않습니다.
...
> Components > ContainerComponent > Div > Property > formscrollbardecbuttonsize

**Description**

Div 에서 내부 Form 에 표시되는 스크롤바의 감소 버튼(DecButton) 크기를 설정하는 속성입니다.

**Syntax**

```javascript
Div.formscrollbardecbuttonsize[= nSize]
```

**Setting Syntax**

```javascript
this.Div00.formscrollbardecbuttonsize = 30;
```
...
> Components > ContainerComponent > Div > Property > formscrollbarincbuttonsize

**Description**

Div 에서 내부 Form 에 표시되는 스크롤바의 증가 버튼(IncButton) 크기를 설정하는 속성입니다.

**Syntax**

```javascript
Div.formscrollbarincbuttonsize[= nSize]
```

**Setting Syntax**

```javascript
 this.Div00.formscrollbarincbuttonsize = 30;
```
...
> Components > ContainerComponent > Div > Property > formscrollbarsize

**Description**

Div 에서 내부 Form 에 표시되는 스크롤바의 크기를 설정하는 속성입니다.

**Syntax**

```javascript
Div.formscrollbarsize[= nSize]
```

**Setting Syntax**

```javascript
this.Div00.formscrollbarsize = 30;
```
...
> Components > ContainerComponent > Div > Property > formscrollbartrackbarsize

**Description**

Div 의 내부 Form 에 표시되는 스크롤바의 트랙바(TrackBar) 크기를 설정하는 속성입니다.

**Syntax**

```javascript
Div.formscrollbartrackbarsize[= nSize]
```

**Setting Syntax**

```javascript
this.Div00.formscrollbartrackbarsize = 20;
```
- **`nSize`** — 스크롤바의 트랙바 크기를 pixel 단위의 숫자로 설정합니다.

-1 을 설정하면 Div 의 크기와 내부에 표시되는 컴포넌트 위치에 따라 트랙바 크기가 자동으로 조절됩니다.
...
> Components > ContainerComponent > Div > Property > formscrollbartype

**Description**

Div 에서 내부 Form 에 스크롤바가 표시되는 형식을 설정하는 속성입니다.

**Syntax**

```javascript
Div.formscrollbartype[= strBartype]
```
...
```
```javascript
this.Div00.formscrollbartype = "none"; 
this.Div00.formscrollbartype = "default autoindicator"; 
this.Div00.formscrollbartype = "auto fixed"; 
this.Div00.formscrollbartype = "indicator none";
```
...
- 데스크탑에 적용되는 값과 모바일에 적용되는 값을 함께 설정할 수 있지만 권장하지 않습니다.
   ex) this.Div00.formscrollbartype = "fixed autoindicator";
...
> Components > ContainerComponent > Div > Property > formscrollindicatorsize

**Description**

Div 에서 내부 Form 에 표시되는 스크롤 인디케이터바의 크기를 설정하는 속성입니다.

**Syntax**

```javascript
Div.formscrollindicatorsize[= nSize]
```

**Setting Syntax**

```javascript
this.Div00.formscrollindicatorsize = 30;
```
...
- Div 에 스크롤 인디케이터바가 아닌 스크롤바가 표시될 경우 formscrollbarsize 속성으로 크기를 설정하여야 합니다.
...
> Components > ContainerComponent > Div > Property > formscrolltype

**Description**

Div 의 내부 Form 에서 사용되는 스크롤의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
Div.formscrolltype[= enumType]
```
...
```
```javascript
this.Div00.formscrolltype = "vertical";
```
- **`"none"`** — Div 의 내부 Form 에서 수평/수직 스크롤을 사용하지 않습니다.
- **`"both"`** — Div 의 내부 Form 에서 수평/수직 스크롤을 모두 사용합니다.
- **`"vertical"`** — Div 의 내부 Form 에서 수직 스크롤만 사용합니다.

수평 스크롤은 사용하지 않습니다.
- **`"horizontal"`** — Div 의 내부 Form 에서 수평 스크롤만 사용합니다.
...
- Div 의 내부 Form 에서 사용되는 스크롤에 대한 자세한 설정은 formscrollbartype 속성을 사용하여야 합니다.
...
> Components > ContainerComponent > Div > Property > height

**Description**

Div 을(를) 표시하기 위한 높이를 설정하는 속성입니다.
...
```
```javascript
this.Div00.height = 10; 
this.Div00.height = "10px"; 
this.Div00.height = 10%"; 
this.Div00.height = Button00:10%";
```
- **`<strCompID>`** — Div 의 높이를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 Div 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 Div 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 높이가 적용됩니다.
- **`<nVal>`** — Div 의 높이를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.


* <strCompID> 값을 생략했을 때 :
- "px": Div의 높이 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 Div의 높이 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Div의 높이 결정
- "rem": MainFrame font-size 속성값을 기준으로 Div의 높이 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 Div의 높이 결정
- "%": <strCompID>의 height 속성값을 기준으로 Div의 높이 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > ContainerComponent > Div > Property > hotkey

**Description**

Div 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다.

**Syntax**

```javascript
Div.hotkey[= strHotkey]
```
...
```javascript
this.Div00.hotkey = "G"; 
this.Div00.hotkey = "CTRL+A"; 
this.Div00.hotkey = "CTRL+ALT+X";
```
...
> Components > ContainerComponent > Div > Property > id

**Description**

Div의 고유 식별자를 설정하는 속성입니다.
...
> Components > ContainerComponent > Div > Property > initvalueid

**Description**

Div 에 적용될 InitValue 의 ID 를 설정하는 속성입니다.

**Syntax**

```javascript
Div.initvalueid[= strValueID]
```

**Setting Syntax**

- **`strValueID`** — InitValueDefinition 영역에 정의된 InitValue 파일에서 Div 에 적용할 항목의 ID 를 문자열로 설정합니다.

**Remark**

- Div 가 화면에 표시된 후에는 속성값을 설정하거나 변경 할 수 없습니다.
   Div 를 동적으로 생성 시 show() 메소드 실행 전에 속성값을 설정하여야 합니다.
...
> Components > ContainerComponent > Div > Property > layoutorder
...
> Components > ContainerComponent > Div > Property > left

**Description**

Div 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다.
...
```javascript
this.Div00.left = 10; 
this.Div00.left = "10px"; 
this.Div00.left = "10%"; 
this.Div00.left = "Button00:10px"; 
this.Div00.left = "Button00:10%";
```
- **`<strCompID>`** — Div 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Div 의 좌측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 left 속성값을 기준으로 Div의 좌측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Div의 좌측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Div의 좌측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Div의 좌측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 right 속성값을 기준으로 Div의 좌측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 Div의 좌측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > ContainerComponent > Div > Property > letter-spacing

**Description**

Div 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다.

**Syntax**

```javascript
Div.letterSpacing[= strspace]
```
...
> Components > ContainerComponent > Div > Property > maxheight

**Description**

Div 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Div.maxheight[= nMaxHeight]
```
...
```
```javascript
this.Div00.maxheight = 20; 
this.Div00.maxheight = "20px";
```
- **`<nVal>`** — Div 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 maxheight 보다 크면 화면에 표시되는 Div 의 높이는 maxheight 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 Div 의 높이가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > ContainerComponent > Div > Property > maxwidth

**Description**

Div 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다.

**Syntax**

```javascript
Div.maxwidth[= nMaxWidth]
```
...
```
```javascript
this.Div00.maxwidth = 20; 
this.Div00.maxwidth = "20px";
```
- **`<nVal>`** — Div 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 maxwidth 보다 크면 화면에 표시되는 Div 의 너비는 maxwidth 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 Div 의 너비가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > ContainerComponent > Div > Property > minheight

**Description**

Div 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Div.minheight[= nMinHeight]
```
...
```
```javascript
this.Div00.minheight = 20; 
this.Div00.minheight = "20px";
```
- **`<nVal>`** — Div 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 minheight 보다 작다면 화면에 표시되는 Div 의 높이는 minheight 속성값으로 적용됩니다.
  표시되는 높이만 적용되고 height 속성값은 변경되지 않습니다.
...
> Components > ContainerComponent > Div > Property > minwidth

**Description**

Div 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다.

**Syntax**

```javascript
Div.minwidth[= nMinWidth]
```
...
```
```javascript
this.Div00.minwidth = 20; 
this.Div00.minwidth = "20px";
```
- **`<nVal>`** — Div 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 minwidth 보다 작으면 화면에 표시되는 Div 의 너비는 minwidth 속성값으로 적용됩니다.
  표시되는 너비만 적용되고 width 속성값은 변경되지 않습니다.
...
> Components > ContainerComponent > Div > Property > name

**Description**

Div 의 이름을 설정하는 속성입니다.
...
> Components > ContainerComponent > Div > Property > opacity

**Description**

Div 영역의 투명도를 설정하는 속성입니다.

**Syntax**

```javascript
Div.opacity[= stropacity]
```
...
* Script ( normal property )
this.Div00.opacity = "0.8";
this.Div00.opacity = 0.8;
this.Div00.opacity = "80%";
```
...
> Components > ContainerComponent > Div > Property > parent

**Description**

Div 의 부모 오브젝트를 갖는 읽기전용 속성입니다.
...
```javascript
var objParent = this.Div00.parent;
```
...
- Div 이(가) Div 와 같은 컨테이너 컴포넌트에 자식으로 존재한다면 parent 속성은 해당 컨테이너 컴포넌트를 갖습니다.
...
> Components > ContainerComponent > Div > Property > positionstep

**Description**

부모 오브젝트가 화면분할기능을 사용할 때 Div 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다.

**Syntax**

```javascript
Div.positionstep[= nStep]
```

**Setting Syntax**

```javascript
this.Div00.positionstep = 0; 
this.Div00.positionstep = -1;
```
- **`nStep`** — Div 이(가) 표시될 분할화면의 인덱스를 설정합니다.
"-1" 로 설정하면 모든 분할화면에 Div 이(가) 표시됩니다.
...
> Components > ContainerComponent > Div > Property > right

**Description**

Div 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다.
...
```javascript
this.Div00.right = 10; 
this.Div00.right = "10px"; 
this.Div00.right = "10%"; 
this.Div00.right = "Button00:10px"; 
this.Div00.right = "Button00:10%";
```
- **`<strCompID>`** — Div 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Div 의 우측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 right 속성값을 기준으로 Div의 우측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Div의 우측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Div의 우측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Div의 우측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 left 속성값을 기준으로 Div의 우측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 Div의 우측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > ContainerComponent > Div > Property > rtl

**Description**

Div 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다.
...
```
```javascript
var vRtl = this.Div00.rtl;
```
- **`undefined`** — undefined 설정 시 상위 컴포넌트의 rtl 속성값이 적용됩니다.

사용자가 rtl 속성값을 설정하지 않거나 삭제했을 경우 undefined 가 설정됩니다.
- **`true`** — Div 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 오른쪽으로 설정합니다.
Div 의 내부 좌표계의 기준을 오른쪽으로 설정합니다.
Div 의 텍스트 표시 기준을 오른쪽으로 설정합니다.
수직스크롤바가 있을 경우 왼쪽에 표시됩니다.
- **`false`** — Div 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
Div 의 내부 좌표계의 기준을 왼쪽으로 설정합니다.
Div 의 텍스트 표시 기준을 왼쪽으로 설정합니다.
...
- Div 부터 Environment 까지 상위의 모든 rtl 속성값이 undefined 이면
...
> Components > ContainerComponent > Div > Property > tablecellarea
...
> Components > ContainerComponent > Div > Property > taborder

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 Div 의 순서를 설정하는 속성입니다.

**Syntax**

```javascript
Div.taborder[= nTabOrder]
```
...
> Components > ContainerComponent > Div > Property > tabstop

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 Div 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Div.tabstop[= bTabStop]
```
...
bTabStop ::= 'true' | 'false'
```
- **`"true"`** — Div 이(가) 탭키 입력에 의한 포커스를 받습니다.
- **`"false"`** — Div 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
...
> Components > ContainerComponent > Div > Property > text

**Description**

Div 에 내부 컴포넌트가 없을 때 화면에 표시될 텍스트를 설정하는 속성입니다.
...
```javascript
this.Div00.text = "Empty Form";
```
- **`strText`** — Div 에 연결된 Form이 없거나 내부 컴포넌트가 없을 때 화면에 표시될 텍스트를 설정합니다.
...
> Components > ContainerComponent > Div > Property > tooltiptext

**Description**

Div 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다.

**Syntax**

```javascript
Div.tooltiptext[= strToolTipText]
```

**Setting Syntax**

```javascript
this.Div00.tooltiptext = "This is ToolTip Text"; this.Div00.tooltiptext = "";          // 풍선 도움말이 표시되지 않습니다. 
this.Div00.tooltiptext = null;        // 상위 컴포넌트의 풍선 도움말이 표시됩니다.
```
...
- 마우스 포인터가 Div 영역 위에서 일정시간 움직이지 않으면 풍선도움말이 표시됩니다.
...
> Components > ContainerComponent > Div > Property > tooltiptype

**Description**

Div 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다.

**Syntax**

```javascript
Div.tooltiptype[= enumTooltipType]
```
...
```
```javascript
this.Div00.tooltiptype = "hover";
```
- **`"default"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Div 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"hover"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Div 영역내에 멈춰서 일정시간이 경과하면 풍선도움말이 사라집니다.
Div 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경되거나 사라진 풍선도움말이 다시 표시됩니다.
- **`"inplace"`** — Div 의 좌측상단 안쪽에 풍선도움말을 표시합니다.

마우스 포인터가 Div 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"default,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Div 영역에 있으면 풍선도움말이 사라지지 않습니다.
- **`"hover,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Div 영역에 있으면 풍선도움말이 사라지지 않습니다.
Div 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경됩니다.
- **`"inplace,mouseleave"`** — Div 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
- 표시되었다가 사라진 풍선도움말은 마우스 포인터가 Div 영역을 나갔다가 들어오면 다시 표시됩니다.

- 마우스 포인터가 Div 영역에서 벗어나면 풍선도움말이 사라집니다.
...
> Components > ContainerComponent > Div > Property > top

**Description**

Div 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다.
...
this.Div00.top = "10px"; 
this.Div00.top = "10%"; 
this.Div00.top = "Button00:10px"; 
this.Div00.top = "Button00:10%";
```
- **`<strCompID>`** — Div 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Div의 상단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 top 속성값을 기준으로 Div의 상단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 Div의 상단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Div의 상단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Div의 상단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 bottom 속성값을 기준으로 Div의 상단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 Div의 상단 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > ContainerComponent > Div > Property > url

**Description**

Div 에 Form 을 연결하여 표시할 때 설정하는 속성입니다.
...
```
```javascript
this.Div00.url = "http://localhost:8080/Prj/Base/temp00.xfdl.js";     // 절대경로
this.Div00.url = "../Base/temp00.xfdl";                                        // 상대경로this.Div00.url = "Base::temp00.xfdl";                                           // TypeDefinition의 Services 경로
```
...
- 기존에 작성된 Form 을 Div 에 연결할 때 사용하는 속성입니다.
...
- Div 가 속한 Form 과 상위 Form 들은 url 속성에 설정하여 연결 할 수 없습니다.
...
Div 에서 스크립트로 url 속성값을 변경할 때 적용될 Animation 효과를 설정하는 속성입니다.

**Syntax**

```javascript
Div.urlchangeeffect[= strEffect]
```

**Setting Syntax**

```javascript
strEffect ::= <enumType> <nDuration> <enumEasing> <enumDirection>

<enumType> ::= 'cubic' | 'fade' | 'flip' | 'slide' | 'wipe'
<enumEasing> ::= 'linear' 
...
<enumDirection> ::= 'toleft' | 'totop' | 'toright' | 'tobottom'
```
```javascript
this.Div00.urlchangeeffect = "slide 1000 linear tobottom";
```
- **`<enumType>`** — 적용될 Animation 효과의 종류를 설정합니다.

"cubic", "fade", "flip", "slide", "wipe" 중 하나를 설정합니다.
- **`<nDuration>`** — Animation 효과가 적용되는 시간을 밀리초(Millisecond) 단위로 설정합니다.
...
중 하나의 값을 설정합니다.
- **`<enumDirection>`** — Animation 효과가 적용되는 방향을 설정합니다.

"toleft", "totop", "toright", "tobottom" 중 하나를 설정합니다.

* <enumType> 값이 "fade" 인 경우는 적용되지 않습니다.

**Remark**

- Div 가 포함된 Form 이 최초 로드될 때는 적용되지 않습니다.
...
- WRE에서 실행 시 일정 버전 이상 브라우저에서만 동작하는 startViewTransition 메서드를 사용합니다.
   때문에, urlchangeeffect 속성을 적용할 수 있는 브라우저 최소 버전은 아래와 같습니다.
   Edge(111), Chrome(111), Safari(18), Opera(97)
    
   startViewTransition 메서드에 대한 정보는 아래 링크를 참고하세요.
...
> Components > ContainerComponent > Div > Property > visible

**Description**

Div 이(가) 화면에 표시될지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Div.visible[= bVisible]
```
...
```
- **`"true"`** — Div 을(를) 화면에 표시합니다.
- **`"false"`** — Div 을(를) 화면에 표시하지 않습니다.
...
> Components > ContainerComponent > Div > Property > width

**Description**

Div 을(를) 표시하기 위한 너비를 설정하는 속성입니다.
...
```
```javascript
this.Div00.width = 10; this.Div00.width = "10px"; 
this.Div00.width = "10%"; 
this.Div00.width = "Button00:10%";
```
- **`<strCompID>`** — Div 의 너비를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 Div 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 Div 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 너비가 적용됩니다.
- **`<nVal>`** — Div 의 너비를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": Div의 너비 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Div의 너비 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Div의 너비 결정
- "rem": MainFrame font-size 속성값을 기준으로 Div의 너비 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 Div의 너비 결정
- "%": <strCompID>의 width 속성값을 기준으로 Div의 너비 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > ContainerComponent > Div > Property > word-spacing

**Description**

Div 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다.

**Syntax**

```javascript
Div.wordSpacing[= strwordspacing]
```
...
> Components > ContainerComponent > Div > Method > addChild

**Description**

스크립트에서 동적으로 생성한 컴포넌트를 Div 의 자식 컴포넌트로 추가하는 메소드입니다.

**Syntax**

```javascript
Div.addChild( strChildID, objComp )
```
...
```javascript
var nIndex = this.Div00.addChild( "Button00", Button00 );
```
...
Div.destroyDiv.initDiv.insertChildDiv.-nexa-rtl-background-imageDiv.removeChildDiv.show
...
> Components > ContainerComponent > Div > Method > addEvent

**Description**

Div 에 특정 이벤트를 선언하여 추가하는 메소드입니다.

**Syntax**

```javascript
Div.addEvent( strEventID )
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| strEventID | String | Div 에 추가할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.Div00.addEvent( "onmove" );
```
...
- Div 에서 특정 이벤트를 제거하려면 removeEvent() 메소드를 사용하여야 합니다.
...
> Components > ContainerComponent > Div > Method > addEventHandler

**Description**

Div 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다.

**Syntax**

```javascript
Div.addEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.Div00_onmove = function( obj:nexacro.Div,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Div00.addEventHandler( "onmove", this.Div00_onmove, this);
```
...
> Components > ContainerComponent > Div > Method > addEventHandlerLookup

**Description**

함수를 검색하여 Div 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다.

**Syntax**

```javascript
Div.addEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.Div00_onmove = function( obj:nexacro.Div,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Div00.addEventHandlerLookup( "onmove", "Div00_onmove", this);
```
...
> Components > ContainerComponent > Div > Method > bringToFront

**Description**

부모가 동일한 컴포넌트 중 Div 이(가) 화면의 제일 앞에 표시되게 합니다.
...
- bringToFront() 메소드는 Div 을(를) 가장 나중에 표시되게 순서를 바꿉니다.
...
> Components > ContainerComponent > Div > Method > bringToPrev

**Description**

부모가 동일한 컴포넌트 중 Div 이(가) 화면에 한단계 앞에 표시되게 합니다.
...
- bringToPrev() 메소드는 Div 을(를) 한단계 나중에 표시되는 컴포넌트와 순서를 바꿉니다.
...
> Components > ContainerComponent > Div > Method > clearEventHandler
...
```javascript
Div.clearEventHandler( strEventID )
```
...
```javascript
var nCnt = this.Div00.clearEventHandler( "onmove" );
```
...
> Components > ContainerComponent > Div > Method > destroy

**Description**

스크립트에서 동적으로 생성한 Div 을(를) 삭제하는 메소드입니다.
...
var bSucc = this.Div00.destroy();

**Return**

| Type | Description |
| --- | --- |
| Boolean | Div 이(가) 정상적으로 삭제되면 true 를 반환합니다.

Div 이(가) 정상적으로 삭제되지 않으면 false 를 반환합니다. |

**Remark**

- 동적으로 생성한 Div 을(를) 완전히 삭제하기 위해서는 destroy() 메소드를 호출해야 합니다.

**See Also**

Div.initDiv.showForm.addChildForm.insertChildForm.removeChild
...
> Components > ContainerComponent > Div > Method > findEventHandler

**Description**

Div 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다.

**Syntax**

```javascript
Div.findEventHandler( strEventID, objFunc, objTarget )
```
...
var nIndex = this.Div00.findEventHandler( "onmove", this.Div00_onmove, this );
```
...
> Components > ContainerComponent > Div > Method > getEventHandler

**Description**

Div 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다.

**Syntax**

```javascript
Div.getEventHandler( strEventID, nIdx )
```
...
```javascript
var objFunc = Div00.getEventHandler( "onmove", 0 );
```
...
> Components > ContainerComponent > Div > Method > getOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Div 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nBottom = this.Div.getOffsetBottom();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 Div 의 bottom 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 Div 의 bottom 값을 동적으로 계산합니다.
...
> Components > ContainerComponent > Div > Method > getOffsetHeight

**Description**

Div 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nHeight = this.Div.getOffsetHeight();

**Return**

| Type | Description |
| --- | --- |
| Number | Div 의 높이를 픽셀단위의 숫자로 변환하여 반환합니다. |

**Remark**

- 화면에 표시된 Div 의 높이를 동적으로 계산합니다.
...
> Components > ContainerComponent > Div > Method > getOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Div 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nleft = this.Div.getOffsetLeft();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 Div 의 left 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 Div 의 left 값을 동적으로 계산합니다.
...
> Components > ContainerComponent > Div > Method > getOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Div 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nRight = this.Div.getOffsetRight();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 Div 의 right 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 Div 의 right 값을 동적으로 계산합니다.
...
> Components > ContainerComponent > Div > Method > getOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Div 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nTop = this.Div.getOffsetTop();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 Div 의 top 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 Div 의 top 값을 동적으로 계산합니다.
...
> Components > ContainerComponent > Div > Method > getOffsetWidth

**Description**

Div 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nWidth = this.Div.getOffsetWidth();

**Return**

| Type | Description |
| --- | --- |
| Number | Div 의 너비를 픽셀단위의 숫자로 변환하여 반환합니다. |

**Remark**

- 화면에 표시된 Div 의 너비를 동적으로 계산합니다.
...
> Components > ContainerComponent > Div > Method > getPixelBottom

**Description**

Div 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nbottom = this.Div.getPixelBottom();

**Return**

| Type | Description |
| --- | --- |
| Number | Div 의 bottom 속성값을 픽셀단위로 반환합니다.
...
> Components > ContainerComponent > Div > Method > getPixelHeight

**Description**

Div 의 height 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nheight = this.Div.getPixelHeight();

**Return**

| Type | Description |
| --- | --- |
| Number | Div 의 height 속성값을 픽셀단위로 반환합니다.
...
> Components > ContainerComponent > Div > Method > getPixelLeft

**Description**

Div 의 left 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nleft = this.Div.getPixelLeft();

**Return**

| Type | Description |
| --- | --- |
| Number | Div 의 left 속성값을 픽셀단위로 반환합니다.
...
> Components > ContainerComponent > Div > Method > getPixelRight

**Description**

Div 의 right 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nright = this.Div.getPixelRight();

**Return**

| Type | Description |
| --- | --- |
| Number | Div 의 right 속성값을 픽셀단위로 반환합니다.
...
> Components > ContainerComponent > Div > Method > getPixelTop

**Description**

Div 의 top 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var ntop = this.Div.getPixelTop();

**Return**

| Type | Description |
| --- | --- |
| Number | Div 의 top 속성값을 픽셀단위로 반환합니다.
...
> Components > ContainerComponent > Div > Method > getPixelWidth

**Description**

Div 의 width 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nwidth = this.Div.getPixelWidth();

**Return**

| Type | Description |
| --- | --- |
| Number | Div 의 width 속성값을 픽셀단위로 반환합니다.
...
> Components > ContainerComponent > Div > Method > init

**Description**

스크립트로 Div 을(를) 동적 생성한 후에 초기화하는 메소드입니다.
...
| vLeft | String, Number | Div 의 left 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 right 속성값을 기준으로 Div 의 left 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 Div 의 left 가 결정됩니다. |
| vTop | String, Number | Div 의 top 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 bottom 속성값을 기준으로 Div 의 top 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Div 의 top 이 결정됩니다. |
| vWidth | String, Number | Div 의 width 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 Div 의 width 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 Div 의 width 가 결정됩니다. |
| vHeight | String, Number | Div 의 height 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 Div 의 height 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Div 의 height 가 결정됩니다. |
| vRight | String, Number | Div 의 right 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vLeft, vWidth 값을 모두 설정했을 경우 vRight 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 left 속성값을 기준으로 Div 의 right 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 Div 의 right 가 결정됩니다. |
| vBottom | String, Number | Div 의 bottom 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vTop, vHeight 값을 모두 설정했을 경우 vBottom 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 top 속성값을 기준으로 Div 의 bottom 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Div 의 bottom 이 결정됩니다. |
| vMinWidth | String, Number | Div 이(가) 화면에 표시되는 최소 너비값을 pixel 단위의 숫자로 설정합니다. |
| vMaxWidth | String, Number | Div 이(가) 화면에 표시되는 최대 너비값을 pixel 단위의 숫자로 설정합니다.

vMinWidth 보다 작은 값을 설정하면 vMinWidth 값으로 설정됩니다. |
| vMinHeight | String, Number | Div 이(가) 화면에 표시되는 최소 높이값을 pixel 단위의 숫자로 설정합니다. |
| vMaxHeight | String, Number | Div 이(가) 화면에 표시되는 최대 높이값을 pixel 단위의 숫자로 설정합니다.
...
objComp.init( "Div00", 30, 120, 196, 46 );
objComp.init( "Div00", 30, 120, 196, 46, null, null );
objComp.init( "Div00", null, null, 300, "400px", "80%", 300 );
objComp.init( "Div00", 0, 0, 200, 100, null, null, 300, 500, 200, 500 );
objComp.init( "Div00", "Div22:10", 300, null, null, "Div33:10", "20%", 300, 500, 200, 500 );
```
...
- 인수값에 기준 컴포넌트를 포함하면 Div 의 위치는 기준 컴포넌트를 기준으로 상대적으로 결정됩니다.
  vLeft, vTop, vWidth, vHeight, vRight, vBottom 값에 기준 컴포넌트를 포함할 때는 "ID:Value" 형태로 설정하여야 합니다.

- 기준 컴포넌트는 Div 와(과) 부모(Parent)가 동일하여야 하며, Form 로딩 시 Div 보다 먼저 생성되어야 합니다.
...
Div.destroyDiv.showForm.addChildForm.insertChildForm.removeChild
...
> Components > ContainerComponent > Div > Method > insertChild

**Description**

스크립트로 동적 생성한 컴포넌트를 Div 의 자식 컴포넌트로 특정 순서에 추가하는 메소드입니다.

**Syntax**

```javascript
Div.insertChild( nIdx, strChildID, objComp )
```
...
```javascript
var nIndex = this.Div00.insertChild( 0, "Button00", Button00 );
```
...
Div.addChildDiv.destroyDiv.initDiv.removeChildDiv.show
...
> Components > ContainerComponent > Div > Method > insertEventHandler

**Description**

Div 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다.

**Syntax**

```javascript
Div.insertEventHandler( strEventID, nIndex, objFunc, objTarget )
```
...
var nIndex = this.Div00.insertEventHandler( "onmove", 0, this.Div00_onmove, this);
```
...
> Components > ContainerComponent > Div > Method > move

**Description**

Div 의 위치와 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
Div.move( vLeft, vTop [, vWidth, vHeight [, vRight, vBottom]] )
```
...
```javascript
this.Div00.move(10,10);
this.Div00.move(10,10,100,100);
this.Div00.move(null, null, 300, "400px", "80%", 300 );
```
...
> Components > ContainerComponent > Div > Method > moveToNext

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Div 이(가) 화면에 한단계 뒤에 표시되게 합니다.

**Syntax**

```javascript
Div.moveToNext( objComp )
Div.moveToNext( strComp )
```
...
```javascript
this.Div.moveToNext( this.Button00 );
this.Div.moveToNext( "Button00" );
```
...
- 인수로 전달되는 기준 컴포넌트와 Div 은(는) 부모가 동일하여야 합니다.

- 디자인 시 소스에 컴포넌트가 선언된 순서대로 화면에 표시됩니다.
  소스에서 위에 선언된 컴포넌트가 먼저 표시되고, 아래에 선언된 컴포넌트가 나중에 표시되게 됩니다.
  컴포넌트가 겹쳐져 있을 경우 화면에 표시되는 순서에 따라 먼저 표시된 컴포넌트가 나중에 표시되는 컴포넌트에 가려지게 됩니다.

- moveToNext() 메소드는 기준 컴포넌트보다 Div 이(가) 한단계 먼저 표시되게 순서를 바꿉니다.
...
> Components > ContainerComponent > Div > Method > moveToPrev

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Div 이(가) 화면에 한단계 앞에 표시되게 합니다.

**Syntax**

```javascript
Div.moveToPrev( objComp )
Div.moveToPrev( strComp )
```
...
```javascript
this.Div.moveToPrev( this.Button00 );
this.Div.moveToPrev( "Button00" );
```
...
- moveToPrev() 메소드는 기준 컴포넌트보다 Div 이(가) 한단계 나중에 표시되게 순서를 바꿉니다.
...
> Components > ContainerComponent > Div > Method > reload

**Description**

Div 에 url 속성으로 연결된 Form 을 다시 로딩하는 메서드입니다.
...
- url 속성으로 Form 이 연결되어 있을 경우만 메서드가 정상동작 합니다.
   Div 이 자체 콘텐츠로 구성되어 있는 경우는 메서드 실행 시 모든 콘텐츠가 삭제됩니다.

- Div 의 form 컨트롤에 정의된 reload() 메서드와 동일한 메서드입니다.
...
> Components > ContainerComponent > Div > Method > removeChild

**Description**

Div 에 동적으로 추가된 컴포넌트를 제거하는 메소드입니다.

**Syntax**

```javascript
Div.removeChild( strChildID )
```
...
```javascript
var objDelete = this.Div00.removeChild( "Button00" );
```
...
Div.addChildDiv.destroyDiv.initDiv.insertChildDiv.show
...
> Components > ContainerComponent > Div > Method > removeEvent

**Description**

Div 에 선언된 특정 이벤트를 삭제하는 메소드입니다.

**Syntax**

```javascript
Div.removeEvent( strEventID )
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| strEventID | String | Div 에서 삭제할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.Div00.removeEvent( "onmove" );
```
...
- Div 에 특정 이벤트를 추가하려면 addEvent() 메소드를 사용하여야 합니다.

- Div 에 기본으로 선언되어 있는 이벤트 삭제 시 오동작 할 수 있으므로 주의하여야 합니다.
...
> Components > ContainerComponent > Div > Method > removeEventHandler

**Description**

Div 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
Div.removeEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.Div00_onmove = function( obj:nexacro.Div,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Div00.removeEventHandler( "onmove", this.Div00_onmove, this);
```
...
> Components > ContainerComponent > Div > Method > removeEventHandlerLookup

**Description**

Div 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
Div.removeEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.Div00_onmove = function( obj:nexacro.Div,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Div00.removeEventHandlerLookup( "onmove", "Div00_onmove", this);
```
...
> Components > ContainerComponent > Div > Method > resize

**Description**

Div 의 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
Div.resize( vWidth, vHeight )
```
...
- Div 의 left 속성값이 null 이 아니면 resize() 메소드 실행 후 Div 의 우측 위치가 변경됩니다.
  또한, 메소드 실행 후 right 속성값은 null 이 됩니다.

- Div 의 left 속성값이 null 이면 resize() 메소드 실행 후 Div 의 좌측 위치가 변경됩니다.
  또한, 메소드 실행 후 left 속성값은 null 로 유지됩니다.

- Div 의 top 속성값이 null 이 아니면 resize() 메소드 실행 후 Div 의 하단 위치가 변경됩니다.
  또한, 메소드 실행 후 bottom 속성값은 null 이 됩니다.

- Div 의 top 속성값이 null 이면 resize() 메소드 실행 후 Div 의 상단 위치가 변경됩니다.
...
> Components > ContainerComponent > Div > Method > sendToBack

**Description**

부모가 동일한 컴포넌트 중 Div 이(가) 화면의 제일 뒤에 표시되게 합니다.
...
- sendToBack() 메소드는 Div 을(를) 가장 먼저 표시되게 순서를 바꿉니다.
...
> Components > ContainerComponent > Div > Method > sendToNext

**Description**

부모가 동일한 컴포넌트 중 Div 이(가) 화면에 한단계 뒤에 표시되게 합니다.
...
- sendToNext() 메소드는 Div 을(를) 한단계 먼저 표시되는 컴포넌트와 순서를 바꿉니다.
...
> Components > ContainerComponent > Div > Method > setContents

**Description**

Div 의 내부 구성 컨텐츠를 동적으로 설정하는 메소드입니다.

**Syntax**

```javascript
Div.setContents( strCont );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| strCont | String | Div 의 내부 구성 컨텐츠 정보를 XML 형태의 문자열로 설정합니다.
...
this.Div00.setContents( strCont );
```
...
> Components > ContainerComponent > Div > Method > setEventHandler

**Description**

Div 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다.

**Syntax**

```javascript
Div.setEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.Div00_onmove = function( obj:nexacro.Div,  e:nexacro.MoveEventInfo ) { //수행할 스크립트 };
var nIndex = this.Div00.setEventHandler( "onmove", this.Div00_onmove, this );
```
...
> Components > ContainerComponent > Div > Method > setEventHandlerLookup

**Description**

Div 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다.

**Syntax**

```javascript
Div.setEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.Div00_onmove = function( obj:nexacro.Div,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Div00.setEventHandlerLookup( "onmove", "Div00_onmove", this);
```
...
> Components > ContainerComponent > Div > Method > setFocus

**Description**

Div 컴포넌트(오브젝트)에 포커스를 설정하는 메서드입니다.

**Syntax**

```javascript
Div.setFocus( [bMoveScroll [, bInnerFocus]] )
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| bMoveScroll | Boolean | 부모 컴포넌트에 스크롤이 있을 경우, Div 기준으로 스크롤을 이동할지 여부를 설정합니다.

true: Div 이(가) 화면에 표시되도록 스크롤을 이동합니다.
false: Div 위치와 관계없이 스크롤을 이동하지 않습니다.
...
true: 포커스를 받을 수 있는 첫 번째 컴포넌트로 포커스를 이동합니다.
       포커스를 받을 수 있는 컴포넌트가 없는 경우 Div 에 포커스가 설정됩니다.
false: Div 에 포커스를 설정합니다.
...
```javascript
var objBefComp = this.Div00.setFocus();
var objBefComp = this.Div00.setFocus( false );
var objBefComp = this.Div00.setFocus( true, false );
```
...
| Type | Description |
| --- | --- |
| Object | Div 이(가) 포커스를 얻기 전에 포커스를 가지고 있던 컴포넌트를 반환합니다.
...
> Components > ContainerComponent > Div > Method > setOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Div 의 bottom 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Div.setOffsetBottom( nBottom );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nBottom | Number | 부모 컴포넌트의 Top 위치를 기준으로 Div 의 bottom 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Div.setOffsetBottom( 10 );
```
...
- 메소드 실행 전 Div 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Div 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > Div 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > Div 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 height, bottom 속성이 설정됩니다.
...
> Components > ContainerComponent > Div > Method > setOffsetHeight

**Description**

Div 의 높이를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Div.setOffsetHeight( nHeight );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nHeight | Number | Div 의 높이를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Div.setOffsetHeight( 10 );
```
...
> Components > ContainerComponent > Div > Method > setOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Div 의 left 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Div.setOffsetLeft( nLeft );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nLeft | Number | 부모 컴포넌트의 Left 위치를 기준으로 Div 의 left 값을 픽셀단위의 숫자로 설정합니다 |

**Sample Call**

```javascript
this.Div.setOffsetLeft( 10 );
```
...
- 메소드 실행 전 Div 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Div 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > Div 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, right 속성이 설정됩니다.
   > Div 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
...
> Components > ContainerComponent > Div > Method > setOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Div 의 right 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Div.setOffsetRight( nRight );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nRight | Number | 부모 컴포넌트의 Left 위치를 기준으로 Div 의 right 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Div.setOffsetRight( 600 );
```
...
- 메소드 실행 전 Div 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Div 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > Div 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > Div 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 width, right 속성이 설정됩니다.
...
> Components > ContainerComponent > Div > Method > setOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Div 의 top 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Div.setOffsetTop( nTop );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nTop | Number | 부모 컴포넌트의 Top 위치를 기준으로 Div 의 top 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Div.setOffsetTop( 10 );
```
...
- 메소드 실행 전 Div 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Div 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > Div 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, bottom 속성이 설정됩니다.
   > Div 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
...
> Components > ContainerComponent > Div > Method > setOffsetWidth

**Description**

Div 의 너비를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Div.setOffsetWidth( nWidth );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nWidth | Number | Div 의 너비를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Div.setOffsetWidth( 10 );
```
...
> Components > ContainerComponent > Div > Method > show

**Description**

스크립트로 동적 생성한 Div 을(를) 화면에 표시하는 메소드입니다.
...
Div.destroyDiv.initForm.addChildForm.insertChildForm.removeChild
...
> Components > ContainerComponent > Div > Event > onclick

**Description**

Div 영역 내에서 마우스 왼쪽버튼을 클릭했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onclick(obj:nexacro.Div,e:nexacro.ClickEventInfo);
```
...
- Div 영역 내에서 마우스의 lbuttondown 액션과 lbuttonup 액션이 발생되어야 합니다.
...
> Components > ContainerComponent > Div > Event > oncontextmenu

**Description**

Div 영역에서 오른쪽 마우스 버튼을 클릭하거나 터치를 일정시간 유지할 때 발생하는 이벤트입니다.

**Syntax**

```javascript
oncontextmenu(obj:nexacro.Div,e:nexacro.ContextMenuEventInfo);
```
...
- Div 컴포넌트는 마우스 우클릭이나 터치에 의해 표시되는 기본팝업메뉴가 제공되지 않습니다.
...
> Components > ContainerComponent > Div > Event > ondevicebuttonup
...
```javascript
ondevicebuttonup(obj:nexacro.Div,e:nexacro.DeviceButtonEventInfo);
```
...
> Components > ContainerComponent > Div > Event > ondrag

**Description**

Div 영역 내에서 마우스 왼쪽버튼으로 드래그를 수행했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondrag(obj:nexacro.Div,e:nexacro.DragEventInfo);
```
...
- Div 영역 내에서 마우스의 LButtonDown 후 LButtonUp 액션 없이 마우스 이동 시 ondrag 이벤트가 발생합니다.
...
> Components > ContainerComponent > Div > Event > ondragenter

**Description**

Div 영역 내로 드래그 상태의 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragenter(obj:nexacro.Div,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 Div 영역으로 마우스 포인터가 들어올 때마다 이벤트가 발생합니다.
...
> Components > ContainerComponent > Div > Event > ondragleave

**Description**

Div 영역 밖으로 드래그 상태의 마우스 포인터가 나갈 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragleave(obj:nexacro.Div,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 Div 영역에서 마우스 포인터가 나갈 때마다 이벤트가 발생합니다.
...
> Components > ContainerComponent > Div > Event > ondragmove

**Description**

Div 영역 내에서 드래그 상태의 마우스 포인터가 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragmove(obj:nexacro.Div,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 Div 영역 내에서 마우스 포인터가 움직일 때마다 이벤트가 발생합니다.
...
> Components > ContainerComponent > Div > Event > ondrop

**Description**

Div 영역 내에서 드래그 상태의 마우스 버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondrop(obj:nexacro.Div,e:nexacro.DragEventInfo);
```
...
- Div 영역 내에서 드래그 상태인 마우스의 LButtonUp 액션 발생 시 ondrop 이벤트가 발생합니다.
...
> Components > ContainerComponent > Div > Event > onhscroll

**Description**

Div 의 수평 스크롤바를 스크롤 했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onhscroll(obj:nexacro.Div,e:nexacro.ScrollEventInfo);
```
...
> Components > ContainerComponent > Div > Event > onkeydown

**Description**

Div 에 포커스가 있는 상태에서 키보드의 키가 눌렸을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkeydown(obj:nexacro.Div,e:nexacro.KeyEventInfo);
```
...
> Components > ContainerComponent > Div > Event > onkeyup

**Description**

Div 에 포커스가 있는 상태에서 눌렸던 키보드가 떼어질 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkeyup(obj:nexacro.Div,e:nexacro.KeyEventInfo);
```
...
> Components > ContainerComponent > Div > Event > onkillfocus

**Description**

Div 에서 포커스가 나갈  때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkillfocus(obj:nexacro.Div,e:nexacro.KillFocusEventInfo);
```
...
- showModal(), open() 등의 메소드로 팝업된 Frame 으로 포커스가 이동하는 경우 Div 에서 포커스 관련 이벤트가 발생하지 않습니다.
   또한, alert(), confirm() 메소드로 표시된 팝업으로 포커스가 이동하는 경우도 Div 에서 포커스 관련 이벤트가 발생하지 않습니다.
...
> Components > ContainerComponent > Div > Event > onlbuttondown

**Description**

Div 영역 내에서 마우스 왼쪽버튼을 눌렀을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onlbuttondown(obj:nexacro.Div,e:nexacro.MouseEventInfo);
```
...
- Div 영역 내에서 마우스의 LButtonDown 액션이 발생하면 이벤트가 발생합니다.
...
> Components > ContainerComponent > Div > Event > onlbuttonup

**Description**

Div 영역 내에서 눌렸던 마우스 왼쪽버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onlbuttonup(obj:nexacro.Div,e:nexacro.MouseEventInfo);
```
...
> Components > ContainerComponent > Div > Event > onmousedown

**Description**

Div 영역 내에서 마우스의 왼쪽/오른쪽 버튼을 제외한 나머지 버튼이 눌렸을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmousedown(obj:nexacro.Div,e:nexacro.MouseEventInfo);
```
...
> Components > ContainerComponent > Div > Event > onmouseenter

**Description**

Div 영역 내로 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmouseenter(obj:nexacro.Div,e:nexacro.MouseEventInfo);
```
...
> Components > ContainerComponent > Div > Event > onmouseleave

**Description**

Div 영역 밖으로 마우스 포인터가 나갈 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmouseleave(obj:nexacro.Div,e:nexacro.MouseEventInfo);
```
...
> Components > ContainerComponent > Div > Event > onmousemove

**Description**

Div 영역 내에서 마우스 포인터가 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmousemove(obj:nexacro.Div,e:nexacro.MouseEventInfo);
```
...
> Components > ContainerComponent > Div > Event > onmouseup
...
```javascript
onmouseup(obj:nexacro.Div,e:nexacro.MouseEventInfo);
```
...
> Components > ContainerComponent > Div > Event > onmousewheel

**Description**

Div 영역 내에서 마우스의 휠버튼을 회전했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmousewheel(obj:nexacro.Div,e:nexacro.MouseWheelEventInfo);
```
...
- Div 의 내부 Form 에서 마우스의 휠버튼 회전값을 처리할 필요가 없을 때 상위 컴포넌트로 휠버튼 회전값과 이벤트가 전파됩니다.
...
- Zoom 상태에서도 Div 에서 이벤트가 발생하고 리턴값에 따라 상위로 전파되므로 스크립트 작성 시 주의하여야 합니다.
   이 때, 스크롤은 처리되지 않으며 e.ctrlkey 속성값이 true 로 설정됩니다.

**Default Action**

- Div 에 스크롤바가 있다면 이벤트 발생 후 스크롤을 이동시킵니다.
...
> Components > ContainerComponent > Div > Event > onmove

**Description**

Div 의 위치가 이동했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmove(obj:nexacro.Div,e:nexacro.MoveEventInfo);
```
...
> Components > ContainerComponent > Div > Event > onrbuttondown

**Description**

Div 영역 내에서 마우스 오른쪽버튼을 눌렀을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onrbuttondown(obj:nexacro.Div,e:nexacro.MouseEventInfo);
```
...
> Components > ContainerComponent > Div > Event > onrbuttonup

**Description**

Div 영역 내에서 마우스 오른쪽버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onrbuttonup(obj:nexacro.Div,e:nexacro.MouseEventInfo);
```
...
> Components > ContainerComponent > Div > Event > onsetfocus

**Description**

Div 에 포커스가 들어올 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onsetfocus(obj:nexacro.Div,e:nexacro.SetFocusEventInfo);
```
...
- open() 메소드로 오픈된 Modeless 창에서 부모창의 Div 에 setFocus() 메소드 실행 시 환경에 따라 동작에 차이가 있으므로 주의하여야 합니다.
...
> Components > ContainerComponent > Div > Event > onsize

**Description**

Div 의 크기가 변경됐을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onsize(obj:nexacro.Div,e:nexacro.SizeEventInfo);
```
...
> Components > ContainerComponent > Div > Event > ontouchend

**Description**

Div 영역 내에서 터치를 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchend(obj:nexacro.Div,e:nexacro.TouchEventInfo);
```
...
> Components > ContainerComponent > Div > Event > ontouchmove

**Description**

Div 영역 내에서 터치 상태를 유지하며 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchmove(obj:nexacro.Div,e:nexacro.TouchEventInfo);
```
...
> Components > ContainerComponent > Div > Event > ontouchstart

**Description**

Div 영역 내에서 터치가 시작될 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchstart(obj:nexacro.Div,e:nexacro.TouchEventInfo);
```
...
> Components > ContainerComponent > Div > Event > onvscroll

**Description**

Div 의 수직 스크롤바를 스크롤 했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onvscroll(obj:nexacro.Div,e:nexacro.ScrollEventInfo);
```
