...
| Name | Description |
| --- | --- |
| accessibilityaction | GroupBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다. |
| accessibilitydesclevel | GroupBox 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| accessibilitydescription | GroupBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다. |
| accessibilityenable | GroupBox 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| accessibilitylabel | GroupBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다. |
| accessibilityrole | GroupBox에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다. |
| background | GroupBox 의 배경 영역을 설정하는 속성입니다. |
| border-radius | GroupBox 의 모서리 모양을 설정하는 속성입니다. |
| bottom | GroupBox 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다. |
| box-shadow | GroupBox 에 그림자 효과를 설정하는 속성입니다. |
| color | GroupBox 에 표시되는 텍스트의 색상을 설정하는 속성입니다. |
| cssclass | GroupBox 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다. |
| cursor | GroupBox 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다. |
| enable | GroupBox 의 사용가능 여부를 설정하는 속성입니다. |
| enableevent | GroupBox 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다. |
...
| font | GroupBox 에서 사용하는 폰트를 설정하는 속성입니다. |
| height | GroupBox 을(를) 표시하기 위한 높이를 설정하는 속성입니다. |
| hotkey | GroupBox 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다. |
| id | GroupBox의 고유 식별자를 설정하는 속성입니다. |
| initvalueid | GroupBox 에 적용될 InitValue 의 ID 를 설정하는 속성입니다. |
| layoutorder | Layout 컨테이너 내 Main Axis(type 속성값이 "horizontal"이면 수평축, type 속성값이 "vertical"이면 수직축)에 컴포넌트가 배치되는 순서를 설정합니다. |
| left | GroupBox 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다. |
| letter-spacing | GroupBox 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다. |
| maxheight | GroupBox 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다. |
| maxwidth | GroupBox 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다. |
| minheight | GroupBox 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다. |
| minwidth | GroupBox 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다. |
| name | GroupBox 의 이름을 설정하는 속성입니다. |
| -nexa-border | GroupBox 의 테두리를 설정하는 속성입니다. |
| -nexa-edge | GroupBox 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-padding | GroupBox 영역의 안쪽 여백을 설정하는 속성입니다. |
| -nexa-rtl-background-image | GroupBox 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다. |
| -nexa-rtl-edge-image | GroupBox 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| opacity | GroupBox 영역의 투명도를 설정하는 속성입니다. |
| parent | GroupBox 의 부모 오브젝트를 갖는 읽기전용 속성입니다. |
| positionstep | 부모 오브젝트가 화면분할기능을 사용할 때 GroupBox 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다. |
| right | GroupBox 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다. |
| rtl | GroupBox 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다. |
| tablecellarea | Layout 컨테이너 내 가상의 Table Cell 영역 내에서 컴포넌트가 배치되는 영역을 설정합니다. |
| taborder | 접근성 기능이 활성화 되어 있을 때 GroupBox 의 포커스 이동 순서를 설정하는 속성입니다. |
| text | GroupBox 에 타이틀로 표시될 텍스트를 설정하는 속성입니다. |
| titlealign | GroupBox 에 타이틀이 표시될 위치를 설정하는 속성입니다. |
| titlegap | GroupBox 의 타이틀이 표시되는 위치의 간격을 설정하는 속성입니다. |
| tooltiptext | GroupBox 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다. |
| tooltiptype | GroupBox 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다. |
| top | GroupBox 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다. |
| visible | GroupBox 이(가) 화면에 표시될지 여부를 설정하는 속성입니다. |
| width | GroupBox 을(를) 표시하기 위한 너비를 설정하는 속성입니다. |
| word-spacing | GroupBox 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다. |

**Method**

| Name | Description |
| --- | --- |
| addEvent | GroupBox 에 특정 이벤트를 선언하여 추가하는 메소드입니다. |
| addEventHandler | GroupBox 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다. |
| addEventHandlerLookup | 함수를 검색하여 GroupBox 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다. |
| bringToFront | 부모가 동일한 컴포넌트 중 GroupBox 이(가) 화면의 제일 앞에 표시되게 합니다. |
| bringToPrev | 부모가 동일한 컴포넌트 중 GroupBox 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| clearEventHandler | 특정 이벤트에 등록된 핸들러 함수를 모두 제거하는 메소드입니다. |
| destroy | 스크립트에서 동적으로 생성한 GroupBox 을(를) 삭제하는 메소드입니다. |
| findEventHandler | GroupBox 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다. |
| getEventHandler | GroupBox 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다. |
| getOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 GroupBox 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetHeight | GroupBox 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 GroupBox 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 GroupBox 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 GroupBox 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetWidth | GroupBox 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getPixelBottom | GroupBox 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelHeight | GroupBox 의 height 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelLeft | GroupBox 의 left 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelRight | GroupBox 의 right 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelTop | GroupBox 의 top 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelWidth | GroupBox 의 width 속성값을 픽셀단위로 반환하는 메소드입니다. |
| init | 스크립트로 GroupBox 을(를) 동적 생성한 후에 초기화하는 메소드입니다. |
| insertEventHandler | GroupBox 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다. |
| move | GroupBox 의 위치와 크기를 변경하는 메소드입니다. |
| moveToNext | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 GroupBox 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| moveToPrev | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 GroupBox 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| removeEvent | GroupBox 에 선언된 특정 이벤트를 삭제하는 메소드입니다. |
| removeEventHandler | GroupBox 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다. |
| removeEventHandlerLookup | GroupBox 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다. |
| resize | GroupBox 의 크기를 변경하는 메소드입니다. |
| sendToBack | 부모가 동일한 컴포넌트 중 GroupBox 이(가) 화면의 제일 뒤에 표시되게 합니다. |
| sendToNext | 부모가 동일한 컴포넌트 중 GroupBox 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| setEventHandler | GroupBox 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다. |
| setEventHandlerLookup | GroupBox 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다. |
| setOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 GroupBox 의 bottom 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetHeight | GroupBox 의 높이를 픽셀단위로 설정하는 메소드입니다. |
| setOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 GroupBox 의 left 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 GroupBox 의 right 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 GroupBox 의 top 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetWidth | GroupBox 의 너비를 픽셀단위로 설정하는 메소드입니다. |
| show | 스크립트로 동적 생성한 GroupBox 을(를) 화면에 표시하는 메소드입니다. |
...
> Components > Component > GroupBox > Property > -nexa-border

**Description**

GroupBox 의 테두리를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.border[= strborder]
```
...
this.GroupBox00.border = "1px solid #999999";
this.GroupBox00.border = "1px solid #999999, 1px solid #999999, 1px solid #999999, 1px solid #999999";
```
...
> Components > Component > GroupBox > Property > -nexa-edge

**Description**

GroupBox 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.edge[= stredge]
```
...
* Script ( normal property )
this.GroupBox00.edge = "URL('./images/border.png')" 5px 5px;
```
...
- GroupBox 내부에 테두리 형태로 이미지를 표시하고자 할 때 사용하는 속성입니다.
...
> Components > Component > GroupBox > Property > -nexa-padding

**Description**

GroupBox 영역의 안쪽 여백을 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.padding[= strpadding]
```
...
* Script ( normal property )
this.GroupBox00.padding = "5px 5px 5px 5px";
```
- **`<npadding>`** — GroupBox 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
- -nexa-padding 속성은 내부 컨텐츠영역과 GroupBox 사이의 여백으로 적용됩니다.
...
> Components > Component > GroupBox > Property > -nexa-rtl-background-image

**Description**

GroupBox 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.-nexa-rtl-background-image
```
...
> Components > Component > GroupBox > Property > -nexa-rtl-edge-image

**Description**

GroupBox 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.-nexa-rtl-edge-image
```
...
> Components > Component > GroupBox > Property > accessibilityaction

**Description**

GroupBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.accessibilityaction[= strAction]
```

**Setting Syntax**

```javascript
this.GroupBox00.accessibilityaction = "Accessibility Action Message"; 
this.GroupBox00.accessibilityaction = "Select by direction key";
```
...
> Components > Component > GroupBox > Property > accessibilitydesclevel

**Description**

GroupBox 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.accessibilitydesclevel[= enumLevel]
```
...
```
```javascript
this.GroupBox00.accessibilitydesclevel = "all";
```
- **`"all"`** — GroupBox 와 자식 컴포넌트에 대한 접근성을 모두 출력합니다.
- **`"self"`** — GroupBox 의 접근성만 출력하고 자식 컴포넌트의 접근성은 출력하지 않습니다.
- **`"child"`** — GroupBox 의 접근성은 출력하지 않고, 자식 컴포넌트의 접근성은 출력합니다.
- **`"none"`** — GroupBox 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
...
- accessibilitydesclevel 속성은 선택상자의 이동에 영향을 주지 않으므로 방향키로 선택상자가 GroupBox 에 이동되게 하지 않으려면 accessibilityenable 속성을 설정하여야 합니다.
...
> Components > Component > GroupBox > Property > accessibilitydescription

**Description**

GroupBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.accessibilitydescription[= strDescription]
```

**Setting Syntax**

```javascript
this.GroupBox00.accessibilitydescription = "Option";
```
...
> Components > Component > GroupBox > Property > accessibilityenable

**Description**

GroupBox 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.accessibilityenable[= bEnable]
```
...
```
```javascript
this.GroupBox00.accessibilityenable = false;
```
- **`true`** — GroupBox 에 선택상자가 이동되면 접근성 관련 속성값을 출력합니다.

방향키 또는 제스처로 선택상자 이동 시 Static 과 같이 포커스를 갖지 않는 컴포넌트에도 선택상자가 이동됩니다.
- **`false`** — GroupBox 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.

데스크탑 환경에서 방향키로 선택상자가 GroupBox 에 이동되지 않습니다.
모바일 환경에서 제스처로 선택상자가 GroupBox 에 이동되지 않습니다.
...
- 선택상자 이동 시 컴포넌트의 ARIA-LABEL + Status + Role 순서로 정보가 조합되어 접근성으로 출력됩니다.
   ...
   > Status : GroupBox 의 현재 상태가 반영됩니다.
   > Role : accessibilityrole 속성값이 반영됩니다. accessibilityrole 속성값을 설정하지 않으면 GroupBox 의 고유 Role 이 반영됩니다.

- accessibilityenable 속성값이 false 일 때 데스크탑 환경에서 방향키 외의 방법으로 선택상자를 GroupBox 로 이동시키면 스크린 리딩 프로그램에서 임의의 값을 출력할 수 있습니다.
...
> Components > Component > GroupBox > Property > accessibilitylabel

**Description**

GroupBox에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.accessibilitylabel[= strLabel]
```

**Setting Syntax**

```javascript
this.GroupBox00.accessibilitylabel = "OK Button"; 
this.GroupBox00.accessibilitylabel = "[@static00]"; 
this.GroupBox00.accessibilitylabel = "[@static00][@static01]"; 
this.GroupBox00.accessibilitylabel = "[@static00][@static01] OK Button";
```
...
> Components > Component > GroupBox > Property > accessibilityrole

**Description**

GroupBox에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.accessibilityrole[= enumRole]
```
...
```
```javascript
this.GroupBox00.accessibilityrole = "none"; 
this.GroupBox00.accessibilityrole = "button";
```
...
- accessibilityenable 속성값을 설정하지 않으면 GroupBox의 기본 Role 로 적용됩니다.

- 추가적인 속성값이 필요한 Role 설정 시 GroupBox에 해당 속성이 없으면 스크린 리더에 따라 정상적으로 정보를 읽지 못할 수 있습니다.
...
> Components > Component > GroupBox > Property > background

**Description**

GroupBox 의 배경 영역을 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.background[= strbackground]
```
...
* Script ( normal property )
this.GroupBox00.background = "#ffffaa";
this.GroupBox00.background = ""URL('./images/smiley.gif')" no-repeat center center #ffffaa";
this.GroupBox00.background = ""URL('./images/smiley.gif')" no-repeat center center /auto #ffffaa";
this.GroupBox00.background = ""URL('./images/smiley.gif')" no-repeat center center /15px 15% #ffffaa";
this.GroupBox00.background = "linear-gradient( red , blue , yellow )";
this.GroupBox00.background = "linear-gradient( #FF0000 , rgb(0,0,255) , rgb(255,255,0))";
this.GroupBox00.background = ""URL('./images/smiley.gif')" border-box border-box #ffffaa";
```
...
"left" 설정 시 GroupBox 의 왼쪽면과 이미지의 왼쪽면이 정렬되어 표시됩니다.
"center" 설정 시 GroupBox 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"right" 설정 시 GroupBox 의 오른쪽면과 이미지의 오른쪽면이 정렬되어 표시됩니다.
...
"top" 설정 시 GroupBox 의 윗쪽면과 이미지의 윗쪽면이 정렬되어 표시됩니다.
"center" 설정 시 GroupBox 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"bottom" 설정 시 GroupBox 의 아랫쪽면과 이미지의 아랫쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
0 보다 작거나 100 보다 큰 값을 설정 시 GroupBox 의 영역을 벗어난 가상의 위치로 적용됩니다.
...
예를 들어 <angle> 값이 "to left" 이면 GroupBox 의 right 위치가 시작점이 되고, left 위치가 끝점이 됩니다.
              <angle> 값이 "to right" 이면 GroupBox 의 left 위치가 시작점이 되고, right 위치가 끝점이 됩니다.
...
<bg-image> 에 적용된 이미지에 투명으로 적용된 부분이 있거나 이미지가 GroupBox 영역보다 작다면 해당 영역에 배경색이 표시됩니다.
...
> Components > Component > GroupBox > Property > border-radius

**Description**

GroupBox 의 모서리 모양을 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.borderRadius[= strborderradius]
```
...
* Script ( normal property )
this.GroupBox00.borderRadius = "10px";
this.GroupBox00.borderRadius = "5px 6px 10px / 5px 10px";
```
...
> Components > Component > GroupBox > Property > bottom

**Description**

GroupBox 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.bottom[= nBottom]
```
...
```
```javascript
this.GroupBox00.bottom = 10; 
this.GroupBox00.bottom = "10px"; 
this.GroupBox00.bottom = "10%"; 
this.GroupBox00.bottom = "Button00:10px"; 
this.GroupBox00.bottom = "Button00:10%";
```
- **`<strCompID>`** — GroupBox 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 GroupBox 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 GroupBox 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — GroupBox 의 하단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 bottom 속성값을 기준으로 GroupBox의 하단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 GroupBox의 하단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 GroupBox의 하단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 GroupBox의 하단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 top 속성값을 기준으로 GroupBox의 하단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 GroupBox의 하단 위치 결정
...
> Components > Component > GroupBox > Property > box-shadow

**Description**

GroupBox 에 그림자 효과를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.boxShadow[= strbshadow]
```
...
* Script ( normal property )
this.GroupBox00.boxShadow  = "10px 10px 10px #888888";
this.GroupBox00.boxShadow  = "inset 10px 10px 10px 5px #888888";
```
...
GroupBox 의 좌상단 위치를 기준으로 그림자 효과가 표시될 위치를 가로/세로 픽셀값으로 설정합니다.
...
> Components > Component > GroupBox > Property > color

**Description**

GroupBox 에 표시되는 텍스트의 색상을 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.color[= strcolor]
```
...
* Script ( normal property )
this.GroupBox00.color = "#999999";
this.GroupBox00.color = "rgb(255,0,0)";
this.GroupBox00.color = "red";
```
- **`<NamedColor>`** — "red","blue" 와 같이 미리 정의된 색상이름을 문자열로 설정합니다.
- **`<NumericColor>`** — 표시할 색의 색상코드입니다.
...
> Components > Component > GroupBox > Property > cssclass

**Description**

GroupBox 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.cssclass[= strcssclass]
```
...
```
```javascript
this.GroupBox00.cssclass = "TestClass"; 
this.GroupBox00.cssclass = "TestClass,TestClass2";
```
...
> Components > Component > GroupBox > Property > cursor

**Description**

GroupBox 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.cursor[= strCursor]
```
...
* Script ( normal property )
this.GroupBox00.cursor = "default";
```
...
> Components > Component > GroupBox > Property > enable

**Description**

GroupBox 의 사용가능 여부를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.enable[= benable]
```
...
```
```javascript
this.GroupBox00.enable = true; 
this.GroupBox00.enable = false;
```
- **`true`** — GroupBox 을(를) 사용할 수 있게 설정합니다.
- **`false`** — GroupBox 을(를) 사용할 수 없게 설정합니다.
...
> Components > Component > GroupBox > Property > enableevent

**Description**

GroupBox 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.enableevent[= bEvent]
```
...
```
```javascript
this.GroupBox00.enableevent = true;  
this.GroupBox00.enableevent = false;
```
- **`true`** — GroupBox 에서 이벤트가 발생하도록 설정합니다.
- **`false`** — GroupBox 에서 이벤트가 발생하지 않도록 설정합니다.
...
> Components > Component > GroupBox > Property > flexgrow
...
> Components > Component > GroupBox > Property > flexshrink
...
> Components > Component > GroupBox > Property > font

**Description**

GroupBox 에서 사용하는 폰트를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.font[= strfont]
```
...
* Script ( normal property )
this.GroupBox00.font = "bold 12pt/30px arial, sans-serif";
```
...
> Components > Component > GroupBox > Property > height

**Description**

GroupBox 을(를) 표시하기 위한 높이를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.height[= nHeight]
```
...
```
```javascript
this.GroupBox00.height = 10; 
this.GroupBox00.height = "10px"; 
this.GroupBox00.height = 10%"; 
this.GroupBox00.height = Button00:10%";
```
- **`<strCompID>`** — GroupBox 의 높이를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 GroupBox 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 GroupBox 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 높이가 적용됩니다.
- **`<nVal>`** — GroupBox 의 높이를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.


* <strCompID> 값을 생략했을 때 :
- "px": GroupBox의 높이 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 GroupBox의 높이 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 GroupBox의 높이 결정
- "rem": MainFrame font-size 속성값을 기준으로 GroupBox의 높이 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 GroupBox의 높이 결정
- "%": <strCompID>의 height 속성값을 기준으로 GroupBox의 높이 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > GroupBox > Property > hotkey

**Description**

GroupBox 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.hotkey[= strHotkey]
```

**Setting Syntax**

```javascript
this.GroupBox00.hotkey = "G"; 
this.GroupBox00.hotkey = "CTRL+A"; 
this.GroupBox00.hotkey = "CTRL+ALT+X";
```
...
> Components > Component > GroupBox > Property > id

**Description**

GroupBox의 고유 식별자를 설정하는 속성입니다.
...
- **`id`** — GroupBox를 구별할 수 있는 유일값을 갖습니다.
...
> Components > Component > GroupBox > Property > initvalueid

**Description**

GroupBox 에 적용될 InitValue 의 ID 를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.initvalueid[= strValueID]
```

**Setting Syntax**

- **`strValueID`** — InitValueDefinition 영역에 정의된 InitValue 파일에서 GroupBox 에 적용할 항목의 ID 를 문자열로 설정합니다.

**Remark**

- GroupBox 가 화면에 표시된 후에는 속성값을 설정하거나 변경 할 수 없습니다.
   GroupBox 를 동적으로 생성 시 show() 메소드 실행 전에 속성값을 설정하여야 합니다.
...
> Components > Component > GroupBox > Property > layoutorder
...
> Components > Component > GroupBox > Property > left

**Description**

GroupBox 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.GroupBox00.left = 10; 
this.GroupBox00.left = "10px"; 
this.GroupBox00.left = "10%"; 
this.GroupBox00.left = "Button00:10px"; 
this.GroupBox00.left = "Button00:10%";
```
- **`<strCompID>`** — GroupBox 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — GroupBox 의 좌측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 left 속성값을 기준으로 GroupBox의 좌측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 GroupBox의 좌측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 GroupBox의 좌측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 GroupBox의 좌측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 right 속성값을 기준으로 GroupBox의 좌측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 GroupBox의 좌측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > GroupBox > Property > letter-spacing

**Description**

GroupBox 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.letterSpacing[= strspace]
```
...
* Script ( normal property )
this.GroupBox00.letterSpacing = "2px";
```
...
> Components > Component > GroupBox > Property > maxheight

**Description**

GroupBox 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.maxheight[= nMaxHeight]
```
...
```
```javascript
this.GroupBox00.maxheight = 20; 
this.GroupBox00.maxheight = "20px";
```
- **`<nVal>`** — GroupBox 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 maxheight 보다 크면 화면에 표시되는 GroupBox 의 높이는 maxheight 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 GroupBox 의 높이가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > GroupBox > Property > maxwidth

**Description**

GroupBox 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.maxwidth[= nMaxWidth]
```
...
```
```javascript
this.GroupBox00.maxwidth = 20; 
this.GroupBox00.maxwidth = "20px";
```
- **`<nVal>`** — GroupBox 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 maxwidth 보다 크면 화면에 표시되는 GroupBox 의 너비는 maxwidth 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 GroupBox 의 너비가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > GroupBox > Property > minheight

**Description**

GroupBox 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.minheight[= nMinHeight]
```
...
```
```javascript
this.GroupBox00.minheight = 20; 
this.GroupBox00.minheight = "20px";
```
- **`<nVal>`** — GroupBox 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 minheight 보다 작다면 화면에 표시되는 GroupBox 의 높이는 minheight 속성값으로 적용됩니다.
  표시되는 높이만 적용되고 height 속성값은 변경되지 않습니다.
...
> Components > Component > GroupBox > Property > minwidth

**Description**

GroupBox 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.minwidth[= nMinWidth]
```
...
```
```javascript
this.GroupBox00.minwidth = 20; 
this.GroupBox00.minwidth = "20px";
```
- **`<nVal>`** — GroupBox 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 minwidth 보다 작으면 화면에 표시되는 GroupBox 의 너비는 minwidth 속성값으로 적용됩니다.
  표시되는 너비만 적용되고 width 속성값은 변경되지 않습니다.
...
> Components > Component > GroupBox > Property > name

**Description**

GroupBox 의 이름을 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.name[= strName]
```
...
> Components > Component > GroupBox > Property > opacity

**Description**

GroupBox 영역의 투명도를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.opacity[= stropacity]
```
...
* Script ( normal property )
this.GroupBox00.opacity = "0.8";
this.GroupBox00.opacity = 0.8;
this.GroupBox00.opacity = "80%";
```
...
> Components > Component > GroupBox > Property > parent

**Description**

GroupBox 의 부모 오브젝트를 갖는 읽기전용 속성입니다.
...
```javascript
var objParent = this.GroupBox00.parent;
```
...
- GroupBox 이(가) Div 와 같은 컨테이너 컴포넌트에 자식으로 존재한다면 parent 속성은 해당 컨테이너 컴포넌트를 갖습니다.
...
> Components > Component > GroupBox > Property > positionstep

**Description**

부모 오브젝트가 화면분할기능을 사용할 때 GroupBox 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.positionstep[= nStep]
```

**Setting Syntax**

```javascript
this.GroupBox00.positionstep = 0; 
this.GroupBox00.positionstep = -1;
```
- **`nStep`** — GroupBox 이(가) 표시될 분할화면의 인덱스를 설정합니다.
"-1" 로 설정하면 모든 분할화면에 GroupBox 이(가) 표시됩니다.
...
> Components > Component > GroupBox > Property > right

**Description**

GroupBox 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.right[= nRight]
```
...
```
```javascript
this.GroupBox00.right = 10; 
this.GroupBox00.right = "10px"; 
this.GroupBox00.right = "10%"; 
this.GroupBox00.right = "Button00:10px"; 
this.GroupBox00.right = "Button00:10%";
```
- **`<strCompID>`** — GroupBox 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — GroupBox 의 우측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 right 속성값을 기준으로 GroupBox의 우측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 GroupBox의 우측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 GroupBox의 우측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 GroupBox의 우측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 left 속성값을 기준으로 GroupBox의 우측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 GroupBox의 우측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > GroupBox > Property > rtl

**Description**

GroupBox 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다.
...
```
```javascript
var vRtl = this.GroupBox00.rtl;
```
- **`undefined`** — undefined 설정 시 상위 컴포넌트의 rtl 속성값이 적용됩니다.

사용자가 rtl 속성값을 설정하지 않거나 삭제했을 경우 undefined 가 설정됩니다.
- **`true`** — GroupBox 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 오른쪽으로 설정합니다.
GroupBox 의 내부 좌표계의 기준을 오른쪽으로 설정합니다.
GroupBox 의 텍스트 표시 기준을 오른쪽으로 설정합니다.
수직스크롤바가 있을 경우 왼쪽에 표시됩니다.
- **`false`** — GroupBox 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
GroupBox 의 내부 좌표계의 기준을 왼쪽으로 설정합니다.
GroupBox 의 텍스트 표시 기준을 왼쪽으로 설정합니다.
...
- GroupBox 부터 Environment 까지 상위의 모든 rtl 속성값이 undefined 이면
...
> Components > Component > GroupBox > Property > tablecellarea
...
```javascript
GroupBox.tablecellarea[= strArea]
```
...
> Components > Component > GroupBox > Property > taborder

**Description**

접근성 기능이 활성화 되어 있을 때 GroupBox 의 포커스 이동 순서를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.taborder[= nTabOrder]
```
...
- enableaccessibility 속성값에 의해 접근성 기능이 활성화 되어 있을 때만 적용되는 속성입니다.
...
> Components > Component > GroupBox > Property > text

**Description**

GroupBox 에 타이틀로 표시될 텍스트를 설정하는 속성입니다.
...
```javascript
this.GroupBox00.text = "Title Text";
```
- **`strText`** — GroupBox 에 타이틀로 표시될 텍스트를 설정합니다.
...
> Components > Component > GroupBox > Property > titlealign

**Description**

GroupBox 에 타이틀이 표시될 위치를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.titlealign[= enumTitleAlign]
```

**Setting Syntax**

```javascript
enumTitleAlign ::= 'topleft' | 'topcenter' | 'topright' | 'lefttop' | 'leftcenter' | 'leftbottom' | 'righttop' | 'rightcenter' | 'rightbottom' | 'bottomleft' | 'bottomcenter' | 'bottomright'
```
```javascript
this.GroupBox00.titlealign = "righttop";
```
- **`"topleft"`** — 타이틀을 상단 왼쪽에 표시합니다.
- **`"topcenter"`** — 타이틀을 상단 중앙에 표시합니다.
- **`"topright"`** — 타이틀을 상단 오른쪽에 표시합니다.
- **`"lefttop"`** — 타이틀을 왼쪽 상단에 표시합니다.
- **`"leftcenter"`** — 타이틀을 왼쪽 중단에 표시합니다.
- **`"leftbottom"`** — 타이틀을 왼쪽 하단에 표시합니다.
- **`"righttop"`** — 타이틀을 오른쪽 상단에 표시합니다.
- **`"rightcenter"`** — 타이틀을 오른쪽 중단에 표시합니다.
- **`"rightbottom"`** — 타이틀을 오른쪽 하단에 표시합니다.
- **`"bottomleft"`** — 타이틀을 하단 왼쪽에 표시합니다.
- **`"bottomcenter"`** — 타이틀을 하단 중앙에 표시합니다.
- **`"bottomright"`** — 타이틀을 하단 오른쪽에 표시합니다.

**Remark**

-타이틀이 왼쪽 또는 오른쪽에 표시될 때 회전되지 않고 가로로 표시됩니다.
...
> Components > Component > GroupBox > Property > titlegap

**Description**

GroupBox 의 타이틀이 표시되는 위치의 간격을 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.titlegap[= nGap]
```

**Setting Syntax**

```javascript
this.GroupBox00.titlegap = 10;
```
- **`nGap`** — titlealign 속성값에 따라 타이틀이 표시되는 위치의 간격을 pixel 단위의 숫자로 설정합니다.

undefined 를 설정하면 "10" 으로 적용됩니다.

**Remark**

- titlegap 속성값을 설정하지 않으면 undefined 로 적용됩니다.

- titlealign 속성값에 "center" 가 포함될 때는 titlegap 속성값이 무시됩니다.

- titlealign 속성값에 "topleft" 또는 "bottomleft" 일 경우 왼쪽에서 titlegap 속성값만큼의 간격을 두고 타이틀이 표시됩니다.
  titlealign 속성값에 "topright" 또는 "bottomright" 일 경우 오른쪽에서 titlegap 속성값만큼의 간격을 두고 타이틀이 표시됩니다.
  titlealign 속성값에 "lefttop" 또는 "righttop" 일 경우 상단에서 titlegap 속성값만큼의 간격을 두고 타이틀이 표시됩니다.
  titlealign 속성값에 "leftbottom" 또는 "rightbottom" 일 경우 하단에서 titlegap 속성값만큼의 간격을 두고 타이틀이 표시됩니다.
...
> Components > Component > GroupBox > Property > tooltiptext

**Description**

GroupBox 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.tooltiptext[= strToolTipText]
```

**Setting Syntax**

```javascript
this.GroupBox00.tooltiptext = "This is ToolTip Text"; this.GroupBox00.tooltiptext = "";          // 풍선 도움말이 표시되지 않습니다. 
this.GroupBox00.tooltiptext = null;        // 상위 컴포넌트의 풍선 도움말이 표시됩니다.
```
...
- 마우스 포인터가 GroupBox 영역 위에서 일정시간 움직이지 않으면 풍선도움말이 표시됩니다.
...
> Components > Component > GroupBox > Property > tooltiptype

**Description**

GroupBox 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.tooltiptype[= enumTooltipType]
```
...
```
```javascript
this.GroupBox00.tooltiptype = "hover";
```
- **`"default"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 GroupBox 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"hover"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 GroupBox 영역내에 멈춰서 일정시간이 경과하면 풍선도움말이 사라집니다.
GroupBox 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경되거나 사라진 풍선도움말이 다시 표시됩니다.
- **`"inplace"`** — GroupBox 의 좌측상단 안쪽에 풍선도움말을 표시합니다.

마우스 포인터가 GroupBox 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"default,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 GroupBox 영역에 있으면 풍선도움말이 사라지지 않습니다.
- **`"hover,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 GroupBox 영역에 있으면 풍선도움말이 사라지지 않습니다.
GroupBox 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경됩니다.
- **`"inplace,mouseleave"`** — GroupBox 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
- 표시되었다가 사라진 풍선도움말은 마우스 포인터가 GroupBox 영역을 나갔다가 들어오면 다시 표시됩니다.

- 마우스 포인터가 GroupBox 영역에서 벗어나면 풍선도움말이 사라집니다.
...
> Components > Component > GroupBox > Property > top

**Description**

GroupBox 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.GroupBox00.top = 10; 
this.GroupBox00.top = "10px"; 
this.GroupBox00.top = "10%"; 
this.GroupBox00.top = "Button00:10px"; 
this.GroupBox00.top = "Button00:10%";
```
- **`<strCompID>`** — GroupBox 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — GroupBox의 상단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 top 속성값을 기준으로 GroupBox의 상단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 GroupBox의 상단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 GroupBox의 상단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 GroupBox의 상단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 bottom 속성값을 기준으로 GroupBox의 상단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 GroupBox의 상단 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > GroupBox > Property > visible

**Description**

GroupBox 이(가) 화면에 표시될지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.visible[= bVisible]
```
...
```
```javascript
this.GroupBox00.visible = true; 
this.GroupBox00.visible = false;
```
- **`"true"`** — GroupBox 을(를) 화면에 표시합니다.
- **`"false"`** — GroupBox 을(를) 화면에 표시하지 않습니다.
...
> Components > Component > GroupBox > Property > width

**Description**

GroupBox 을(를) 표시하기 위한 너비를 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.width[= nWidth]
```
...
```
```javascript
this.GroupBox00.width = 10; this.GroupBox00.width = "10px"; 
this.GroupBox00.width = "10%"; 
this.GroupBox00.width = "Button00:10%";
```
- **`<strCompID>`** — GroupBox 의 너비를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 GroupBox 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 GroupBox 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 너비가 적용됩니다.
- **`<nVal>`** — GroupBox 의 너비를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": GroupBox의 너비 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 GroupBox의 너비 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 GroupBox의 너비 결정
- "rem": MainFrame font-size 속성값을 기준으로 GroupBox의 너비 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 GroupBox의 너비 결정
- "%": <strCompID>의 width 속성값을 기준으로 GroupBox의 너비 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > GroupBox > Property > word-spacing

**Description**

GroupBox 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다.

**Syntax**

```javascript
GroupBox.wordSpacing[= strwordspacing]
```
...
* Script ( normal property )
this.GroupBox00.wordSpacing = "30px";
```
...
> Components > Component > GroupBox > Method > addEvent

**Description**

GroupBox 에 특정 이벤트를 선언하여 추가하는 메소드입니다.

**Syntax**

```javascript
GroupBox.addEvent( strEventID )
```
...
| --- | --- | --- |
| strEventID | String | GroupBox 에 추가할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.GroupBox00.addEvent( "onmove" );
```
...
- GroupBox 에서 특정 이벤트를 제거하려면 removeEvent() 메소드를 사용하여야 합니다.
...
> Components > Component > GroupBox > Method > addEventHandler

**Description**

GroupBox 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다.

**Syntax**

```javascript
GroupBox.addEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.GroupBox00_onmove = function( obj:nexacro.GroupBox,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.GroupBox00.addEventHandler( "onmove", this.GroupBox00_onmove, this);
```
...
> Components > Component > GroupBox > Method > addEventHandlerLookup

**Description**

함수를 검색하여 GroupBox 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다.

**Syntax**

```javascript
GroupBox.addEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.GroupBox00_onmove = function( obj:nexacro.GroupBox,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.GroupBox00.addEventHandlerLookup( "onmove", "GroupBox00_onmove", this);
```
...
> Components > Component > GroupBox > Method > bringToFront

**Description**

부모가 동일한 컴포넌트 중 GroupBox 이(가) 화면의 제일 앞에 표시되게 합니다.
...
- bringToFront() 메소드는 GroupBox 을(를) 가장 나중에 표시되게 순서를 바꿉니다.
...
> Components > Component > GroupBox > Method > bringToPrev

**Description**

부모가 동일한 컴포넌트 중 GroupBox 이(가) 화면에 한단계 앞에 표시되게 합니다.

**Syntax**

```javascript
GroupBox.bringToPrev()
```

**Parameters**

this.GroupBox.bringToPrev();
...
- bringToPrev() 메소드는 GroupBox 을(를) 한단계 나중에 표시되는 컴포넌트와 순서를 바꿉니다.
...
> Components > Component > GroupBox > Method > clearEventHandler
...
```javascript
GroupBox.clearEventHandler( strEventID )
```
...
```javascript
var nCnt = this.GroupBox00.clearEventHandler( "onmove" );
```
...
> Components > Component > GroupBox > Method > destroy

**Description**

스크립트에서 동적으로 생성한 GroupBox 을(를) 삭제하는 메소드입니다.
...
var bSucc = this.GroupBox00.destroy();

**Return**

| Type | Description |
| --- | --- |
| Boolean | GroupBox 이(가) 정상적으로 삭제되면 true 를 반환합니다.

GroupBox 이(가) 정상적으로 삭제되지 않으면 false 를 반환합니다. |

**Remark**

- 동적으로 생성한 GroupBox 을(를) 완전히 삭제하기 위해서는 destroy() 메소드를 호출해야 합니다.

**See Also**

Form.addChildForm.insertChildForm.removeChildGroupBox.initGroupBox.show
...
> Components > Component > GroupBox > Method > findEventHandler

**Description**

GroupBox 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다.

**Syntax**

```javascript
GroupBox.findEventHandler( strEventID, objFunc, objTarget )
```
...
var nIndex = this.GroupBox00.findEventHandler( "onmove", this.GroupBox00_onmove, this );
```
...
> Components > Component > GroupBox > Method > getEventHandler

**Description**

GroupBox 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다.

**Syntax**

```javascript
GroupBox.getEventHandler( strEventID, nIdx )
```
...
```javascript
var objFunc = GroupBox00.getEventHandler( "onmove", 0 );
```
...
> Components > Component > GroupBox > Method > getOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 GroupBox 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
GroupBox.getOffsetBottom();
```

**Parameters**

var nBottom = this.GroupBox.getOffsetBottom();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 GroupBox 의 bottom 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 GroupBox 의 bottom 값을 동적으로 계산합니다.
...
> Components > Component > GroupBox > Method > getOffsetHeight

**Description**

GroupBox 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
GroupBox.getOffsetHeight();
```

**Parameters**

var nHeight = this.GroupBox.getOffsetHeight();

**Return**

| Type | Description |
| --- | --- |
| Number | GroupBox 의 높이를 픽셀단위의 숫자로 변환하여 반환합니다. |

**Remark**

- 화면에 표시된 GroupBox 의 높이를 동적으로 계산합니다.
...
> Components > Component > GroupBox > Method > getOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 GroupBox 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
GroupBox.getOffsetLeft();
```

**Parameters**

var nleft = this.GroupBox.getOffsetLeft();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 GroupBox 의 left 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 GroupBox 의 left 값을 동적으로 계산합니다.
...
> Components > Component > GroupBox > Method > getOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 GroupBox 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
GroupBox.getOffsetRight();
```

**Parameters**

var nRight = this.GroupBox.getOffsetRight();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 GroupBox 의 right 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 GroupBox 의 right 값을 동적으로 계산합니다.
...
> Components > Component > GroupBox > Method > getOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 GroupBox 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
GroupBox.getOffsetTop();
```

**Parameters**

var nTop = this.GroupBox.getOffsetTop();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 GroupBox 의 top 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 GroupBox 의 top 값을 동적으로 계산합니다.
...
> Components > Component > GroupBox > Method > getOffsetWidth

**Description**

GroupBox 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
GroupBox.getOffsetWidth();
```

**Parameters**

var nWidth = this.GroupBox.getOffsetWidth();

**Return**

| Type | Description |
| --- | --- |
| Number | GroupBox 의 너비를 픽셀단위의 숫자로 변환하여 반환합니다. |

**Remark**

- 화면에 표시된 GroupBox 의 너비를 동적으로 계산합니다.
...
> Components > Component > GroupBox > Method > getPixelBottom

**Description**

GroupBox 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
GroupBox.getPixelBottom();
```

**Parameters**

var nbottom = this.GroupBox.getPixelBottom();

**Return**

| Type | Description |
| --- | --- |
| Number | GroupBox 의 bottom 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > GroupBox > Method > getPixelHeight

**Description**

GroupBox 의 height 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
GroupBox.getPixelHeight();
```

**Parameters**

var nheight = this.GroupBox.getPixelHeight();

**Return**

| Type | Description |
| --- | --- |
| Number | GroupBox 의 height 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > GroupBox > Method > getPixelLeft

**Description**

GroupBox 의 left 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
GroupBox.getPixelLeft();
```

**Parameters**

var nleft = this.GroupBox.getPixelLeft();

**Return**

| Type | Description |
| --- | --- |
| Number | GroupBox 의 left 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > GroupBox > Method > getPixelRight

**Description**

GroupBox 의 right 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
GroupBox.getPixelRight();
```

**Parameters**

var nright = this.GroupBox.getPixelRight();

**Return**

| Type | Description |
| --- | --- |
| Number | GroupBox 의 right 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > GroupBox > Method > getPixelTop

**Description**

GroupBox 의 top 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
GroupBox.getPixelTop();
```

**Parameters**

var ntop = this.GroupBox.getPixelTop();

**Return**

| Type | Description |
| --- | --- |
| Number | GroupBox 의 top 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > GroupBox > Method > getPixelWidth

**Description**

GroupBox 의 width 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
GroupBox.getPixelWidth();
```

**Parameters**

var nwidth = this.GroupBox.getPixelWidth();

**Return**

| Type | Description |
| --- | --- |
| Number | GroupBox 의 width 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > GroupBox > Method > init

**Description**

스크립트로 GroupBox 을(를) 동적 생성한 후에 초기화하는 메소드입니다.
...
| vLeft | String, Number | GroupBox 의 left 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 right 속성값을 기준으로 GroupBox 의 left 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 GroupBox 의 left 가 결정됩니다. |
| vTop | String, Number | GroupBox 의 top 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 bottom 속성값을 기준으로 GroupBox 의 top 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 GroupBox 의 top 이 결정됩니다. |
| vWidth | String, Number | GroupBox 의 width 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 GroupBox 의 width 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 GroupBox 의 width 가 결정됩니다. |
| vHeight | String, Number | GroupBox 의 height 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 GroupBox 의 height 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 GroupBox 의 height 가 결정됩니다. |
| vRight | String, Number | GroupBox 의 right 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vLeft, vWidth 값을 모두 설정했을 경우 vRight 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 left 속성값을 기준으로 GroupBox 의 right 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 GroupBox 의 right 가 결정됩니다. |
| vBottom | String, Number | GroupBox 의 bottom 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vTop, vHeight 값을 모두 설정했을 경우 vBottom 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 top 속성값을 기준으로 GroupBox 의 bottom 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 GroupBox 의 bottom 이 결정됩니다. |
| vMinWidth | String, Number | GroupBox 이(가) 화면에 표시되는 최소 너비값을 pixel 단위의 숫자로 설정합니다. |
| vMaxWidth | String, Number | GroupBox 이(가) 화면에 표시되는 최대 너비값을 pixel 단위의 숫자로 설정합니다.

vMinWidth 보다 작은 값을 설정하면 vMinWidth 값으로 설정됩니다. |
| vMinHeight | String, Number | GroupBox 이(가) 화면에 표시되는 최소 높이값을 pixel 단위의 숫자로 설정합니다. |
| vMaxHeight | String, Number | GroupBox 이(가) 화면에 표시되는 최대 높이값을 pixel 단위의 숫자로 설정합니다.
...
```javascript
var objComp = new GroupBox();

objComp.init( "GroupBox00", 30, 120, 196, 46 );
objComp.init( "GroupBox00", 30, 120, 196, 46, null, null );
objComp.init( "GroupBox00", null, null, 300, "400px", "80%", 300 );
objComp.init( "GroupBox00", 0, 0, 200, 100, null, null, 300, 500, 200, 500 );
objComp.init( "GroupBox00", "GroupBox22:10", 300, null, null, "GroupBox33:10", "20%", 300, 500, 200, 500 );
```
...
- 인수값에 기준 컴포넌트를 포함하면 GroupBox 의 위치는 기준 컴포넌트를 기준으로 상대적으로 결정됩니다.
  vLeft, vTop, vWidth, vHeight, vRight, vBottom 값에 기준 컴포넌트를 포함할 때는 "ID:Value" 형태로 설정하여야 합니다.

- 기준 컴포넌트는 GroupBox 와(과) 부모(Parent)가 동일하여야 하며, Form 로딩 시 GroupBox 보다 먼저 생성되어야 합니다.
...
Form.addChildForm.insertChildForm.removeChildGroupBox.destroyGroupBox.show
...
> Components > Component > GroupBox > Method > insertEventHandler

**Description**

GroupBox 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다.

**Syntax**

```javascript
GroupBox.insertEventHandler( strEventID, nIndex, objFunc, objTarget )
```
...
var nIndex = this.GroupBox00.insertEventHandler( "onmove", 0, this.GroupBox00_onmove, this);
```
...
> Components > Component > GroupBox > Method > move

**Description**

GroupBox 의 위치와 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
GroupBox.move( vLeft, vTop [, vWidth, vHeight [, vRight, vBottom]] )
```
...
```javascript
this.GroupBox00.move(10,10);
this.GroupBox00.move(10,10,100,100);
this.GroupBox00.move(null, null, 300, "400px", "80%", 300 );
```
...
> Components > Component > GroupBox > Method > moveToNext

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 GroupBox 이(가) 화면에 한단계 뒤에 표시되게 합니다.

**Syntax**

```javascript
GroupBox.moveToNext( objComp )
GroupBox.moveToNext( strComp )
```
...
```javascript
this.GroupBox.moveToNext( this.Button00 );
this.GroupBox.moveToNext( "Button00" );
```
...
- 인수로 전달되는 기준 컴포넌트와 GroupBox 은(는) 부모가 동일하여야 합니다.

- 디자인 시 소스에 컴포넌트가 선언된 순서대로 화면에 표시됩니다.
  소스에서 위에 선언된 컴포넌트가 먼저 표시되고, 아래에 선언된 컴포넌트가 나중에 표시되게 됩니다.
  컴포넌트가 겹쳐져 있을 경우 화면에 표시되는 순서에 따라 먼저 표시된 컴포넌트가 나중에 표시되는 컴포넌트에 가려지게 됩니다.

- moveToNext() 메소드는 기준 컴포넌트보다 GroupBox 이(가) 한단계 먼저 표시되게 순서를 바꿉니다.
...
> Components > Component > GroupBox > Method > moveToPrev

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 GroupBox 이(가) 화면에 한단계 앞에 표시되게 합니다.

**Syntax**

```javascript
GroupBox.moveToPrev( objComp )
GroupBox.moveToPrev( strComp )
```
...
```javascript
this.GroupBox.moveToPrev( this.Button00 );
this.GroupBox.moveToPrev( "Button00" );
```
...
- moveToPrev() 메소드는 기준 컴포넌트보다 GroupBox 이(가) 한단계 나중에 표시되게 순서를 바꿉니다.
...
> Components > Component > GroupBox > Method > removeEvent

**Description**

GroupBox 에 선언된 특정 이벤트를 삭제하는 메소드입니다.

**Syntax**

```javascript
GroupBox.removeEvent( strEventID )
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| strEventID | String | GroupBox 에서 삭제할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.GroupBox00.removeEvent( "onmove" );
```
...
- GroupBox 에 특정 이벤트를 추가하려면 addEvent() 메소드를 사용하여야 합니다.

- GroupBox 에 기본으로 선언되어 있는 이벤트 삭제 시 오동작 할 수 있으므로 주의하여야 합니다.
...
> Components > Component > GroupBox > Method > removeEventHandler

**Description**

GroupBox 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
GroupBox.removeEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.GroupBox00_onmove = function( obj:nexacro.GroupBox,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.GroupBox00.removeEventHandler( "onmove", this.GroupBox00_onmove, this);
```
...
> Components > Component > GroupBox > Method > removeEventHandlerLookup

**Description**

GroupBox 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
GroupBox.removeEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.GroupBox00_onmove = function( obj:nexacro.GroupBox,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.GroupBox00.removeEventHandlerLookup( "onmove", "GroupBox00_onmove", this);
```
...
> Components > Component > GroupBox > Method > resize

**Description**

GroupBox 의 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
GroupBox.resize( vWidth, vHeight )
```
...
```javascript
this.GroupBox00.resize( 100,100 );
```
...
- GroupBox 의 left 속성값이 null 이 아니면 resize() 메소드 실행 후 GroupBox 의 우측 위치가 변경됩니다.
  또한, 메소드 실행 후 right 속성값은 null 이 됩니다.

- GroupBox 의 left 속성값이 null 이면 resize() 메소드 실행 후 GroupBox 의 좌측 위치가 변경됩니다.
  또한, 메소드 실행 후 left 속성값은 null 로 유지됩니다.

- GroupBox 의 top 속성값이 null 이 아니면 resize() 메소드 실행 후 GroupBox 의 하단 위치가 변경됩니다.
  또한, 메소드 실행 후 bottom 속성값은 null 이 됩니다.

- GroupBox 의 top 속성값이 null 이면 resize() 메소드 실행 후 GroupBox 의 상단 위치가 변경됩니다.
...
> Components > Component > GroupBox > Method > sendToBack

**Description**

부모가 동일한 컴포넌트 중 GroupBox 이(가) 화면의 제일 뒤에 표시되게 합니다.
...
- sendToBack() 메소드는 GroupBox 을(를) 가장 먼저 표시되게 순서를 바꿉니다.
...
> Components > Component > GroupBox > Method > sendToNext

**Description**

부모가 동일한 컴포넌트 중 GroupBox 이(가) 화면에 한단계 뒤에 표시되게 합니다.
...
- sendToNext() 메소드는 GroupBox 을(를) 한단계 먼저 표시되는 컴포넌트와 순서를 바꿉니다.
...
> Components > Component > GroupBox > Method > setEventHandler

**Description**

GroupBox 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다.

**Syntax**

```javascript
GroupBox.setEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.GroupBox00_onmove = function( obj:nexacro.GroupBox,  e:nexacro.MoveEventInfo ) { //수행할 스크립트 };
var nIndex = this.GroupBox00.setEventHandler( "onmove", this.GroupBox00_onmove, this );
```
...
> Components > Component > GroupBox > Method > setEventHandlerLookup

**Description**

GroupBox 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다.

**Syntax**

```javascript
GroupBox.setEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.GroupBox00_onmove = function( obj:nexacro.GroupBox,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.GroupBox00.setEventHandlerLookup( "onmove", "GroupBox00_onmove", this);
```
...
> Components > Component > GroupBox > Method > setOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 GroupBox 의 bottom 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
GroupBox.setOffsetBottom( nBottom );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nBottom | Number | 부모 컴포넌트의 Top 위치를 기준으로 GroupBox 의 bottom 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.GroupBox.setOffsetBottom( 10 );
```
...
- 메소드 실행 전 GroupBox 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > GroupBox 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > GroupBox 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > GroupBox 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 height, bottom 속성이 설정됩니다.
...
> Components > Component > GroupBox > Method > setOffsetHeight

**Description**

GroupBox 의 높이를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
GroupBox.setOffsetHeight( nHeight );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nHeight | Number | GroupBox 의 높이를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.GroupBox.setOffsetHeight( 10 );
```
...
> Components > Component > GroupBox > Method > setOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 GroupBox 의 left 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
GroupBox.setOffsetLeft( nLeft );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nLeft | Number | 부모 컴포넌트의 Left 위치를 기준으로 GroupBox 의 left 값을 픽셀단위의 숫자로 설정합니다 |

**Sample Call**

```javascript
this.GroupBox.setOffsetLeft( 10 );
```
...
- 메소드 실행 전 GroupBox 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > GroupBox 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > GroupBox 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, right 속성이 설정됩니다.
   > GroupBox 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
...
> Components > Component > GroupBox > Method > setOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 GroupBox 의 right 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
GroupBox.setOffsetRight( nRight );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nRight | Number | 부모 컴포넌트의 Left 위치를 기준으로 GroupBox 의 right 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.GroupBox.setOffsetRight( 600 );
```
...
- 메소드 실행 전 GroupBox 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > GroupBox 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > GroupBox 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > GroupBox 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 width, right 속성이 설정됩니다.
...
> Components > Component > GroupBox > Method > setOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 GroupBox 의 top 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
GroupBox.setOffsetTop( nTop );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nTop | Number | 부모 컴포넌트의 Top 위치를 기준으로 GroupBox 의 top 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.GroupBox.setOffsetTop( 10 );
```
...
- 메소드 실행 전 GroupBox 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > GroupBox 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > GroupBox 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, bottom 속성이 설정됩니다.
   > GroupBox 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
...
> Components > Component > GroupBox > Method > setOffsetWidth

**Description**

GroupBox 의 너비를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
GroupBox.setOffsetWidth( nWidth );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nWidth | Number | GroupBox 의 너비를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.GroupBox.setOffsetWidth( 10 );
```
...
> Components > Component > GroupBox > Method > show

**Description**

스크립트로 동적 생성한 GroupBox 을(를) 화면에 표시하는 메소드입니다.
...
Form.addChildForm.insertChildForm.removeChildGroupBox.destroyGroupBox.init
...
> Components > Component > GroupBox > Event > oncontextmenu
...
> Components > Component > GroupBox > Event > onlbuttondown
...
> Components > Component > GroupBox > Event > onlbuttonup
...
> Components > Component > GroupBox > Event > onmouseenter
...
> Components > Component > GroupBox > Event > onmouseleave
...
> Components > Component > GroupBox > Event > onmousemove
...
> Components > Component > GroupBox > Event > onmove
...
> Components > Component > GroupBox > Event > onrbuttondown
...
> Components > Component > GroupBox > Event > onrbuttonup
...
> Components > Component > GroupBox > Event > onsize
...
> Components > Component > GroupBox > Event > ontouchend
...
> Components > Component > GroupBox > Event > ontouchmove
...
> Components > Component > GroupBox > Event > ontouchstart
