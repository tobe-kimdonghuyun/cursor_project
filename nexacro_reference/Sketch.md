...
| Name | Description |
| --- | --- |
| accessibilityaction | Sketch에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다. |
| accessibilitydesclevel | Sketch 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| accessibilitydescription | Sketch에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다. |
| accessibilityenable | Sketch 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| accessibilitylabel | Sketch에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다. |
| accessibilityrole | Sketch에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다. |
| background | Sketch 의 배경 영역을 설정하는 속성입니다. |
| border-radius | Sketch 의 모서리 모양을 설정하는 속성입니다. |
| bottom | Sketch 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다. |
| box-shadow | Sketch 에 그림자 효과를 설정하는 속성입니다. |
| color | Sketch 에 표시되는 텍스트의 색상을 설정하는 속성입니다. |
| cssclass | Sketch 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다. |
| cursor | Sketch 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다. |
| editmode | Sketch 영역을 마우스 또는 터치로 드래그할 때 입력받는 방법을 설정하는 속성입니다. |
| enable | Sketch 의 사용가능 여부를 설정하는 속성입니다. |
| enableevent | Sketch 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다. |
| enableredraw | Sketch 에 변경이 발생하면 화면을 자동으로 다시 그릴 지 설정하는 속성입니다. |
...
| font | Sketch 에서 사용하는 폰트를 설정하는 속성입니다. |
| height | Sketch 을(를) 표시하기 위한 높이를 설정하는 속성입니다. |
| id | Sketch의 고유 식별자를 설정하는 속성입니다. |
| initvalueid | Sketch 에 적용될 InitValue 의 ID 를 설정하는 속성입니다. |
| layoutorder | Layout 컨테이너 내 Main Axis(type 속성값이 "horizontal"이면 수평축, type 속성값이 "vertical"이면 수직축)에 컴포넌트가 배치되는 순서를 설정합니다. |
| left | Sketch 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다. |
| letter-spacing | Sketch 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다. |
| maxheight | Sketch 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다. |
| maxwidth | Sketch 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다. |
| minheight | Sketch 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다. |
| minwidth | Sketch 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다. |
| name | Sketch 의 이름을 설정하는 속성입니다. |
| -nexa-border | Sketch 의 테두리를 설정하는 속성입니다. |
| -nexa-edge | Sketch 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-padding | Sketch 영역의 안쪽 여백을 설정하는 속성입니다. |
| -nexa-rtl-background-image | Sketch 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다. |
| -nexa-rtl-edge-image | Sketch 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| opacity | Sketch 영역의 투명도를 설정하는 속성입니다. |
| parent | Sketch 의 부모 오브젝트를 갖는 읽기전용 속성입니다. |
| positionstep | 부모 오브젝트가 화면분할기능을 사용할 때 Sketch 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다. |
| readonly | Sketch 에서 편집을 허용할 지 설정하는 속성입니다. |
| redoable | Sketch에서 redo() 메소드 사용이 가능한지 여부를 갖는 읽기전용 속성입니다. |
| right | Sketch 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다. |
| rtl | Sketch 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다. |
| tablecellarea | Layout 컨테이너 내 가상의 Table Cell 영역 내에서 컴포넌트가 배치되는 영역을 설정합니다. |
| taborder | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 Sketch 의 순서를 설정하는 속성입니다. |
| tabstop | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 Sketch 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다. |
| text | Sketch 에 입력된 값이 없을 때 화면에 표시될 텍스트를 설정하는 속성입니다. |
| tooltiptext | Sketch 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다. |
| tooltiptype | Sketch 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다. |
| top | Sketch 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다. |
| undoable | Sketch에서 undo() 메소드 사용이 가능한지 여부를 갖는 읽기전용 속성입니다. |
| usecontextmenu | Sketch 의 편집영역에서 오른쪽 마우스 클릭 시 기본팝업메뉴의 표시 여부를 설정하는 속성입니다. |
| value | Sketch 에서 편집이 완료된 이미지 데이터를 갖는 읽기전용 속성입니다. |
| visible | Sketch 이(가) 화면에 표시될지 여부를 설정하는 속성입니다. |
| width | Sketch 을(를) 표시하기 위한 너비를 설정하는 속성입니다. |
| word-spacing | Sketch 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다. |
...
| setFocus | Sketch 에 포커스를 설정하는 메서드입니다. |
...
| Name | Description |
| --- | --- |
| onclick | Sketch 영역 내에서 마우스 왼쪽버튼을 클릭했을 때 발생하는 이벤트입니다. |
| oncontextmenu | Sketch 영역에서 오른쪽 마우스 버튼을 클릭하거나 터치를 일정시간 유지할 때 발생하는 이벤트입니다. |
| ondblclick | Sketch 영역 내에서 마우스 왼쪽버튼을 더블클릭 했을 때 발생하는 이벤트입니다. |
| ondevicebuttonup | 모바일 에서 디바이스 버튼을 눌렀을 때 발생하는 이벤트입니다. |
| ondrag | Sketch 영역 내에서 마우스 왼쪽버튼으로 드래그를 수행했을 때 발생하는 이벤트입니다. |
| ondragenter | Sketch 영역 내로 드래그 상태의 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다. |
| ondragleave | Sketch 영역 밖으로 드래그 상태의 마우스 포인터가 나갈 때 발생하는 이벤트입니다. |
| ondragmove | Sketch 영역 내에서 드래그 상태의 마우스 포인터가 움직일 때 발생하는 이벤트입니다. |
| ondrop | Sketch 영역 내에서 드래그 상태의 마우스 버튼을 떼었을 때 발생하는 이벤트입니다. |
| onerror | Sketch에서 메소드 실행 중 오류가 생겼을 때 발생하는 이벤트입니다. |
| oninput | Sketch 에서 입력을 시도할 때 발생하는 이벤트 입니다. |
| onkeydown | Sketch 에 포커스가 있는 상태에서 키보드의 키가 눌렸을 때 발생하는 이벤트입니다. |
| onkeyup | Sketch 에 포커스가 있는 상태에서 눌렸던 키보드가 떼어질 때 발생하는 이벤트입니다. |
| onkillfocus | Sketch 에서 포커스가 나갈  때 발생하는 이벤트입니다. |
| onlbuttondown | Sketch 영역 내에서 마우스 왼쪽버튼을 눌렀을 때 발생하는 이벤트입니다. |
| onlbuttonup | Sketch 영역 내에서 눌렸던 마우스 왼쪽버튼을 떼었을 때 발생하는 이벤트입니다. |
| onload | loadSketch() 메소드 실행에 성공했을때 발생하는 이벤트입니다. |
| onmouseenter | Sketch 영역 내로 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다. |
| onmouseleave | Sketch 영역 밖으로 마우스 포인터가 나갈 때 발생하는 이벤트입니다. |
| onmousemove | Sketch 영역 내에서 마우스 포인터가 움직일 때 발생하는 이벤트입니다. |
| onmove | Sketch 의 위치가 이동했을 때 발생하는 이벤트입니다. |
| onrbuttondown | Sketch 영역 내에서 마우스 오른쪽버튼을 눌렀을 때 발생하는 이벤트입니다. |
| onrbuttonup | Sketch 영역 내에서 마우스 오른쪽버튼을 떼었을 때 발생하는 이벤트입니다. |
| onsetfocus | Sketch 에 포커스가 들어올 때 발생하는 이벤트입니다. |
| onsize | Sketch 의 크기가 변경됐을 때 발생하는 이벤트입니다. |
| onsuccess | saveSketch(), saveSketchToFile() 메소드 실행에 성공했을 때 발생하는 이벤트입니다. |
| ontouchend | Sketch 영역 내에서 터치를 떼었을 때 발생하는 이벤트입니다. |
| ontouchmove | Sketch 영역 내에서 터치 상태를 유지하며 움직일 때 발생하는 이벤트입니다. |
| ontouchstart | Sketch 영역 내에서 터치가 시작될 때 발생하는 이벤트입니다. |
...
> Components > Component > Sketch > Property > -nexa-border

**Description**

Sketch 의 테두리를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.border[= strborder]
```
...
this.Sketch00.border = "1px solid #999999";
this.Sketch00.border = "1px solid #999999, 1px solid #999999, 1px solid #999999, 1px solid #999999";
```
...
> Components > Component > Sketch > Property > -nexa-edge

**Description**

Sketch 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.
...
* Script ( normal property )
this.Sketch00.edge = "URL('./images/border.png')" 5px 5px;
```
...
- Sketch 내부에 테두리 형태로 이미지를 표시하고자 할 때 사용하는 속성입니다.
...
> Components > Component > Sketch > Property > -nexa-padding

**Description**

Sketch 영역의 안쪽 여백을 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.padding[= strpadding]
```
...
* Script ( normal property )
this.Sketch00.padding = "5px 5px 5px 5px";
```
- **`<npadding>`** — Sketch 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
- -nexa-padding 속성은 내부 컨텐츠영역과 Sketch 사이의 여백으로 적용됩니다.
...
> Components > Component > Sketch > Property > -nexa-rtl-background-image

**Description**

Sketch 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.-nexa-rtl-background-image
```
...
> Components > Component > Sketch > Property > -nexa-rtl-edge-image

**Description**

Sketch 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.-nexa-rtl-edge-image
```
...
> Components > Component > Sketch > Property > accessibilityaction

**Description**

Sketch에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.accessibilityaction[= strAction]
```

**Setting Syntax**

```javascript
this.Sketch00.accessibilityaction = "Accessibility Action Message"; 
this.Sketch00.accessibilityaction = "Select by direction key";
```
...
> Components > Component > Sketch > Property > accessibilitydesclevel

**Description**

Sketch 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.accessibilitydesclevel[= enumLevel]
```
...
```
```javascript
this.Sketch00.accessibilitydesclevel = "all";
```
- **`"all"`** — Sketch 와 자식 컴포넌트에 대한 접근성을 모두 출력합니다.
- **`"self"`** — Sketch 의 접근성만 출력하고 자식 컴포넌트의 접근성은 출력하지 않습니다.
- **`"child"`** — Sketch 의 접근성은 출력하지 않고, 자식 컴포넌트의 접근성은 출력합니다.
- **`"none"`** — Sketch 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
...
- accessibilitydesclevel 속성은 선택상자의 이동에 영향을 주지 않으므로 방향키로 선택상자가 Sketch 에 이동되게 하지 않으려면 accessibilityenable 속성을 설정하여야 합니다.
...
> Components > Component > Sketch > Property > accessibilitydescription

**Description**

Sketch에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.accessibilitydescription[= strDescription]
```

**Setting Syntax**

```javascript
this.Sketch00.accessibilitydescription = "Option";
```
...
> Components > Component > Sketch > Property > accessibilityenable

**Description**

Sketch 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.accessibilityenable[= bEnable]
```
...
```
```javascript
this.Sketch00.accessibilityenable = false;
```
- **`true`** — Sketch 에 선택상자가 이동되면 접근성 관련 속성값을 출력합니다.

방향키 또는 제스처로 선택상자 이동 시 Static 과 같이 포커스를 갖지 않는 컴포넌트에도 선택상자가 이동됩니다.
- **`false`** — Sketch 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.

데스크탑 환경에서 방향키로 선택상자가 Sketch 에 이동되지 않습니다.
모바일 환경에서 제스처로 선택상자가 Sketch 에 이동되지 않습니다.
...
- 선택상자 이동 시 컴포넌트의 ARIA-LABEL + Status + Role 순서로 정보가 조합되어 접근성으로 출력됩니다.
   ...
   > Status : Sketch 의 현재 상태가 반영됩니다.
   > Role : accessibilityrole 속성값이 반영됩니다. accessibilityrole 속성값을 설정하지 않으면 Sketch 의 고유 Role 이 반영됩니다.

- accessibilityenable 속성값이 false 일 때 데스크탑 환경에서 방향키 외의 방법으로 선택상자를 Sketch 로 이동시키면 스크린 리딩 프로그램에서 임의의 값을 출력할 수 있습니다.
...
> Components > Component > Sketch > Property > accessibilitylabel

**Description**

Sketch에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.accessibilitylabel[= strLabel]
```

**Setting Syntax**

```javascript
this.Sketch00.accessibilitylabel = "OK Button"; 
this.Sketch00.accessibilitylabel = "[@static00]"; 
this.Sketch00.accessibilitylabel = "[@static00][@static01]"; 
this.Sketch00.accessibilitylabel = "[@static00][@static01] OK Button";
```
...
> Components > Component > Sketch > Property > accessibilityrole

**Description**

Sketch에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.accessibilityrole[= enumRole]
```
...
```
```javascript
this.Sketch00.accessibilityrole = "none"; 
this.Sketch00.accessibilityrole = "button";
```
...
- accessibilityenable 속성값을 설정하지 않으면 Sketch의 기본 Role 로 적용됩니다.

- 추가적인 속성값이 필요한 Role 설정 시 Sketch에 해당 속성이 없으면 스크린 리더에 따라 정상적으로 정보를 읽지 못할 수 있습니다.
...
> Components > Component > Sketch > Property > background

**Description**

Sketch 의 배경 영역을 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.background[= strbackground]
```
...
* Script ( normal property )
this.Sketch00.background = "#ffffaa";
this.Sketch00.background = ""URL('./images/smiley.gif')" no-repeat center center #ffffaa";
this.Sketch00.background = ""URL('./images/smiley.gif')" no-repeat center center /auto #ffffaa";
this.Sketch00.background = ""URL('./images/smiley.gif')" no-repeat center center /15px 15% #ffffaa";
this.Sketch00.background = "linear-gradient( red , blue , yellow )";
this.Sketch00.background = "linear-gradient( #FF0000 , rgb(0,0,255) , rgb(255,255,0))";
this.Sketch00.background = ""URL('./images/smiley.gif')" border-box border-box #ffffaa";
```
...
"left" 설정 시 Sketch 의 왼쪽면과 이미지의 왼쪽면이 정렬되어 표시됩니다.
"center" 설정 시 Sketch 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"right" 설정 시 Sketch 의 오른쪽면과 이미지의 오른쪽면이 정렬되어 표시됩니다.
...
"top" 설정 시 Sketch 의 윗쪽면과 이미지의 윗쪽면이 정렬되어 표시됩니다.
"center" 설정 시 Sketch 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"bottom" 설정 시 Sketch 의 아랫쪽면과 이미지의 아랫쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
0 보다 작거나 100 보다 큰 값을 설정 시 Sketch 의 영역을 벗어난 가상의 위치로 적용됩니다.
...
예를 들어 <angle> 값이 "to left" 이면 Sketch 의 right 위치가 시작점이 되고, left 위치가 끝점이 됩니다.
              <angle> 값이 "to right" 이면 Sketch 의 left 위치가 시작점이 되고, right 위치가 끝점이 됩니다.
...
<bg-image> 에 적용된 이미지에 투명으로 적용된 부분이 있거나 이미지가 Sketch 영역보다 작다면 해당 영역에 배경색이 표시됩니다.
...
> Components > Component > Sketch > Property > border-radius

**Description**

Sketch 의 모서리 모양을 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.borderRadius[= strborderradius]
```
...
* Script ( normal property )
this.Sketch00.borderRadius = "10px";
this.Sketch00.borderRadius = "5px 6px 10px / 5px 10px";
```
...
> Components > Component > Sketch > Property > bottom

**Description**

Sketch 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.bottom[= nBottom]
```
...
```
```javascript
this.Sketch00.bottom = 10; 
this.Sketch00.bottom = "10px"; 
this.Sketch00.bottom = "10%"; 
this.Sketch00.bottom = "Button00:10px"; 
this.Sketch00.bottom = "Button00:10%";
```
- **`<strCompID>`** — Sketch 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 Sketch 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 Sketch 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Sketch 의 하단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 bottom 속성값을 기준으로 Sketch의 하단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 Sketch의 하단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Sketch의 하단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Sketch의 하단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 top 속성값을 기준으로 Sketch의 하단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 Sketch의 하단 위치 결정
...
> Components > Component > Sketch > Property > box-shadow

**Description**

Sketch 에 그림자 효과를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.boxShadow[= strbshadow]
```
...
* Script ( normal property )
this.Sketch00.boxShadow  = "10px 10px 10px #888888";
this.Sketch00.boxShadow  = "inset 10px 10px 10px 5px #888888";
```
...
Sketch 의 좌상단 위치를 기준으로 그림자 효과가 표시될 위치를 가로/세로 픽셀값으로 설정합니다.
...
> Components > Component > Sketch > Property > color

**Description**

Sketch 에 표시되는 텍스트의 색상을 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.color[= strcolor]
```
...
* Script ( normal property )
this.Sketch00.color = "#999999";
this.Sketch00.color = "rgb(255,0,0)";
this.Sketch00.color = "red";
```
- **`<NamedColor>`** — "red","blue" 와 같이 미리 정의된 색상이름을 문자열로 설정합니다.
- **`<NumericColor>`** — 표시할 색의 색상코드입니다.
...
> Components > Component > Sketch > Property > cssclass

**Description**

Sketch 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.cssclass[= strcssclass]
```
...
```
```javascript
this.Sketch00.cssclass = "TestClass"; 
this.Sketch00.cssclass = "TestClass,TestClass2";
```
...
> Components > Component > Sketch > Property > cursor

**Description**

Sketch 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.cursor[= strCursor]
```
...
> Components > Component > Sketch > Property > editmode

**Description**

Sketch 영역을 마우스 또는 터치로 드래그할 때 입력받는 방법을 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.editmode[= enumEditmode]
```

**Setting Syntax**

```javascript
enumEditmode ::= 'none' | 'stroke' | 'text' | 'erase'
```
```javascript
this.Sketch00.editmode = "stroke";
```
- **`"none"`** — 마우스 또는 터치로 드래그 하여도 입력이 되지 않습니다.
읽기전용 상태가 아니므로 "readonly Status"가 적용되지 않습니다.
- **`"stroke"`** — 마우스 또는 터치로 드래그 시 Brush 객체값에 맞게 그려집니다.
- **`"text"`** — 마우스 클릭 또는 터치 된 위치에 입력창이 표시되고 텍스트를 입력할 수 있게 합니다.
입력창에서 포커스가 나갈 때 이미지로 전환되어 Sketch에 표시됩니다.
- **`"erase"`** — 마우스 또는 터치로 드래그 시 Erase 객체값에 맞게 지워집니다.

**Remark**

- editmode 속성값을 설정하지 않거나 잘못된 값을 설정하면 "stroke"로 적용됩니다.
...
> Components > Component > Sketch > Property > enable

**Description**

Sketch 의 사용가능 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.enable[= benable]
```
...
```
```javascript
this.Sketch00.enable = true; 
this.Sketch00.enable = false;
```
- **`true`** — Sketch 을(를) 사용할 수 있게 설정합니다.
- **`false`** — Sketch 을(를) 사용할 수 없게 설정합니다.
...
> Components > Component > Sketch > Property > enableevent

**Description**

Sketch 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.enableevent[= bEvent]
```
...
> Components > Component > Sketch > Property > enableredraw

**Description**

Sketch 에 변경이 발생하면 화면을 자동으로 다시 그릴 지 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.enableredraw[= bRedraw]
```
...
> Components > Component > Sketch > Property > flexgrow
...
> Components > Component > Sketch > Property > flexshrink
...
> Components > Component > Sketch > Property > font

**Description**

Sketch 에서 사용하는 폰트를 설정하는 속성입니다.
...
* Script ( normal property )
this.Sketch00.font = "bold 12pt/30px arial, sans-serif";
```
...
> Components > Component > Sketch > Property > height

**Description**

Sketch 을(를) 표시하기 위한 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.height[= nHeight]
```
...
```
```javascript
this.Sketch00.height = 10; 
this.Sketch00.height = "10px"; 
this.Sketch00.height = 10%"; 
this.Sketch00.height = Button00:10%";
```
- **`<strCompID>`** — Sketch 의 높이를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 Sketch 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 Sketch 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 높이가 적용됩니다.
- **`<nVal>`** — Sketch 의 높이를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.


* <strCompID> 값을 생략했을 때 :
- "px": Sketch의 높이 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 Sketch의 높이 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Sketch의 높이 결정
- "rem": MainFrame font-size 속성값을 기준으로 Sketch의 높이 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 Sketch의 높이 결정
- "%": <strCompID>의 height 속성값을 기준으로 Sketch의 높이 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Sketch > Property > id

**Description**

Sketch의 고유 식별자를 설정하는 속성입니다.
...
> Components > Component > Sketch > Property > initvalueid

**Description**

Sketch 에 적용될 InitValue 의 ID 를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.initvalueid[= strValueID]
```

**Setting Syntax**

- **`strValueID`** — InitValueDefinition 영역에 정의된 InitValue 파일에서 Sketch 에 적용할 항목의 ID 를 문자열로 설정합니다.

**Remark**

- Sketch 가 화면에 표시된 후에는 속성값을 설정하거나 변경 할 수 없습니다.
   Sketch 를 동적으로 생성 시 show() 메소드 실행 전에 속성값을 설정하여야 합니다.
...
> Components > Component > Sketch > Property > layoutorder
...
> Components > Component > Sketch > Property > left

**Description**

Sketch 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.Sketch00.left = 10; 
this.Sketch00.left = "10px"; 
this.Sketch00.left = "10%"; 
this.Sketch00.left = "Button00:10px"; 
this.Sketch00.left = "Button00:10%";
```
- **`<strCompID>`** — Sketch 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Sketch 의 좌측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 left 속성값을 기준으로 Sketch의 좌측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Sketch의 좌측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Sketch의 좌측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Sketch의 좌측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 right 속성값을 기준으로 Sketch의 좌측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 Sketch의 좌측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Sketch > Property > letter-spacing

**Description**

Sketch 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.letterSpacing[= strspace]
```
...
* Script ( normal property )
this.Sketch00.letterSpacing = "2px";
```
...
> Components > Component > Sketch > Property > maxheight

**Description**

Sketch 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.maxheight[= nMaxHeight]
```
...
```
```javascript
this.Sketch00.maxheight = 20; 
this.Sketch00.maxheight = "20px";
```
- **`<nVal>`** — Sketch 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 maxheight 보다 크면 화면에 표시되는 Sketch 의 높이는 maxheight 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 Sketch 의 높이가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > Sketch > Property > maxwidth

**Description**

Sketch 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.maxwidth[= nMaxWidth]
```
...
```
```javascript
this.Sketch00.maxwidth = 20; 
this.Sketch00.maxwidth = "20px";
```
- **`<nVal>`** — Sketch 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 maxwidth 보다 크면 화면에 표시되는 Sketch 의 너비는 maxwidth 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 Sketch 의 너비가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > Sketch > Property > minheight

**Description**

Sketch 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.minheight[= nMinHeight]
```
...
```
```javascript
this.Sketch00.minheight = 20; 
this.Sketch00.minheight = "20px";
```
- **`<nVal>`** — Sketch 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 minheight 보다 작다면 화면에 표시되는 Sketch 의 높이는 minheight 속성값으로 적용됩니다.
  표시되는 높이만 적용되고 height 속성값은 변경되지 않습니다.
...
> Components > Component > Sketch > Property > minwidth

**Description**

Sketch 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.minwidth[= nMinWidth]
```
...
```
```javascript
this.Sketch00.minwidth = 20; 
this.Sketch00.minwidth = "20px";
```
- **`<nVal>`** — Sketch 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 minwidth 보다 작으면 화면에 표시되는 Sketch 의 너비는 minwidth 속성값으로 적용됩니다.
  표시되는 너비만 적용되고 width 속성값은 변경되지 않습니다.
...
> Components > Component > Sketch > Property > name

**Description**

Sketch 의 이름을 설정하는 속성입니다.
...
> Components > Component > Sketch > Property > opacity

**Description**

Sketch 영역의 투명도를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.opacity[= stropacity]
```
...
* Script ( normal property )
this.Sketch00.opacity = "0.8";
this.Sketch00.opacity = 0.8;
this.Sketch00.opacity = "80%";
```
...
> Components > Component > Sketch > Property > parent

**Description**

Sketch 의 부모 오브젝트를 갖는 읽기전용 속성입니다.
...
```javascript
var objParent = this.Sketch00.parent;
```
...
- Sketch 이(가) Div 와 같은 컨테이너 컴포넌트에 자식으로 존재한다면 parent 속성은 해당 컨테이너 컴포넌트를 갖습니다.
...
> Components > Component > Sketch > Property > positionstep

**Description**

부모 오브젝트가 화면분할기능을 사용할 때 Sketch 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.positionstep[= nStep]
```

**Setting Syntax**

```javascript
this.Sketch00.positionstep = 0; 
this.Sketch00.positionstep = -1;
```
- **`nStep`** — Sketch 이(가) 표시될 분할화면의 인덱스를 설정합니다.
"-1" 로 설정하면 모든 분할화면에 Sketch 이(가) 표시됩니다.
...
> Components > Component > Sketch > Property > readonly

**Description**

Sketch 에서 편집을 허용할 지 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.readonly[= bReadOnly]
```
...
```
- **`true`** — Sketch 의 편집을 불가능하게 설정합니다.
- **`false`** — Sketch 의 편집을 가능하게 설정합니다.
...
> Components > Component > Sketch > Property > redoable

**Description**

Sketch에서 redo() 메소드 사용이 가능한지 여부를 갖는 읽기전용 속성입니다.
...
```javascript
var redoable = this.Sketch00.redoable;
```
- **`"true"`** — Sketch 에서 1회 이상 undo() 메소드가 실행되어 Redo가 가능한 상태입니다.
- **`"false"`** — Sketch 에서 undo() 메소드가 실행되지 않아서 Redo할 수 없는 상태입니다.

**Remark**

- redoable 속성은 자동으로 설정되며 속성값을 설정할 수 없습니다.
...
> Components > Component > Sketch > Property > right

**Description**

Sketch 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.Sketch00.right = 10; 
this.Sketch00.right = "10px"; 
this.Sketch00.right = "10%"; 
this.Sketch00.right = "Button00:10px"; 
this.Sketch00.right = "Button00:10%";
```
- **`<strCompID>`** — Sketch 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Sketch 의 우측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 right 속성값을 기준으로 Sketch의 우측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Sketch의 우측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Sketch의 우측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Sketch의 우측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 left 속성값을 기준으로 Sketch의 우측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 Sketch의 우측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Sketch > Property > rtl

**Description**

Sketch 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다.
...
```
```javascript
var vRtl = this.Sketch00.rtl;
```
- **`undefined`** — undefined 설정 시 상위 컴포넌트의 rtl 속성값이 적용됩니다.

사용자가 rtl 속성값을 설정하지 않거나 삭제했을 경우 undefined 가 설정됩니다.
- **`true`** — Sketch 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 오른쪽으로 설정합니다.
Sketch 의 내부 좌표계의 기준을 오른쪽으로 설정합니다.
Sketch 의 텍스트 표시 기준을 오른쪽으로 설정합니다.
수직스크롤바가 있을 경우 왼쪽에 표시됩니다.
- **`false`** — Sketch 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
Sketch 의 내부 좌표계의 기준을 왼쪽으로 설정합니다.
Sketch 의 텍스트 표시 기준을 왼쪽으로 설정합니다.
...
- Sketch 부터 Environment 까지 상위의 모든 rtl 속성값이 undefined 이면
...
> Components > Component > Sketch > Property > tablecellarea
...
> Components > Component > Sketch > Property > taborder

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 Sketch 의 순서를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.taborder[= nTabOrder]
```
...
> Components > Component > Sketch > Property > tabstop

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 Sketch 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.tabstop[= bTabStop]
```
...
bTabStop ::= 'true' | 'false'
```
- **`"true"`** — Sketch 이(가) 탭키 입력에 의한 포커스를 받습니다.
- **`"false"`** — Sketch 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
...
> Components > Component > Sketch > Property > text

**Description**

Sketch 에 입력된 값이 없을 때 화면에 표시될 텍스트를 설정하는 속성입니다.
...
```javascript
this.Sketch00.text = "Empty";
```
- **`strText`** — 입력된 값이 없을 때 화면에 표시될 텍스트를 설정합니다.

**Remark**

- 입력이나 메소드에 의해 Sketch 에 입력이 발생하면 텍스트가 표시되지 않습니다.
...
> Components > Component > Sketch > Property > tooltiptext

**Description**

Sketch 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.tooltiptext[= strToolTipText]
```
...
- 마우스 포인터가 Sketch 영역 위에서 일정시간 움직이지 않으면 풍선도움말이 표시됩니다.
...
> Components > Component > Sketch > Property > tooltiptype

**Description**

Sketch 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.tooltiptype[= enumTooltipType]
```
...
```
```javascript
this.Sketch00.tooltiptype = "hover";
```
- **`"default"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Sketch 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"hover"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Sketch 영역내에 멈춰서 일정시간이 경과하면 풍선도움말이 사라집니다.
Sketch 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경되거나 사라진 풍선도움말이 다시 표시됩니다.
- **`"inplace"`** — Sketch 의 좌측상단 안쪽에 풍선도움말을 표시합니다.

마우스 포인터가 Sketch 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"default,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Sketch 영역에 있으면 풍선도움말이 사라지지 않습니다.
- **`"hover,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Sketch 영역에 있으면 풍선도움말이 사라지지 않습니다.
Sketch 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경됩니다.
- **`"inplace,mouseleave"`** — Sketch 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
- 표시되었다가 사라진 풍선도움말은 마우스 포인터가 Sketch 영역을 나갔다가 들어오면 다시 표시됩니다.

- 마우스 포인터가 Sketch 영역에서 벗어나면 풍선도움말이 사라집니다.
...
> Components > Component > Sketch > Property > top

**Description**

Sketch 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.Sketch00.top = 10; 
this.Sketch00.top = "10px"; 
this.Sketch00.top = "10%"; 
this.Sketch00.top = "Button00:10px"; 
this.Sketch00.top = "Button00:10%";
```
- **`<strCompID>`** — Sketch 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Sketch의 상단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 top 속성값을 기준으로 Sketch의 상단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 Sketch의 상단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Sketch의 상단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Sketch의 상단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 bottom 속성값을 기준으로 Sketch의 상단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 Sketch의 상단 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Sketch > Property > undoable

**Description**

Sketch에서 undo() 메소드 사용이 가능한지 여부를 갖는 읽기전용 속성입니다.
...
```javascript
var undoable = this.Sketch00.undoable;
```
- **`"true"`** — Sketch 에 수정된 내용이 있어서 Undo가 가능한 상태입니다.
- **`"false"`** — Sketch 에 수정된 내용이 없어서 Undo가 불가능한 상태입니다.

**Remark**

- undoable 속성은 자동으로 설정되며 속성값을 설정할 수 없습니다.
...
> Components > Component > Sketch > Property > usecontextmenu

**Description**

Sketch 의 편집영역에서 오른쪽 마우스 클릭 시 기본팝업메뉴의 표시 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.usecontextmenu[= bUseContextMenu]
```
...
```
```javascript
this.Sketch00.usecontextmenu = true;
```
...
- Environment 의 usecontextmenu 속성값이 "none" 또는 "form" 인 경우 Sketch 의 usecontextmenu 속성은 false 로 동작합니다.
...
> Components > Component > Sketch > Property > value

**Description**

Sketch 에서 편집이 완료된 이미지 데이터를 갖는 읽기전용 속성입니다.
...
```javascript
var objImage = this.Sketch00.value;
```
...
- value 속성은 이미지 오브젝트값을 가질 수 있습니다.

- value 속성에 값을 설정하려면 loadSketch() 메소드를 사용하여야 합니다.

- value 속성값을 초기화 하려면 clear() 메소드를 사용하여야 합니다.

- 화면에 직접 입력한 값은 saveSketch() 메소드를 사용하여야 value 속성에 반영됩니다.
   saveSketch() 메소드를 수행하지 않으면 화면에 표시되는 값과 value 속성값이 다르게 됩니다.


◆ Nexacro Runtime Environment 제약

- saveSketchToFile() 메소드를 사용하여 value 속성값을 파일로 저장하면 value 속성에 이미지 오브젝트의 Handle ID가 저장됩니다.
...
> Components > Component > Sketch > Property > visible

**Description**

Sketch 이(가) 화면에 표시될지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.visible[= bVisible]
```
...
```
```javascript
this.Sketch00.visible = true; 
this.Sketch00.visible = false;
```
- **`"true"`** — Sketch 을(를) 화면에 표시합니다.
- **`"false"`** — Sketch 을(를) 화면에 표시하지 않습니다.
...
> Components > Component > Sketch > Property > width

**Description**

Sketch 을(를) 표시하기 위한 너비를 설정하는 속성입니다.
...
```
```javascript
this.Sketch00.width = 10; this.Sketch00.width = "10px"; 
this.Sketch00.width = "10%"; 
this.Sketch00.width = "Button00:10%";
```
- **`<strCompID>`** — Sketch 의 너비를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 Sketch 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 Sketch 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 너비가 적용됩니다.
- **`<nVal>`** — Sketch 의 너비를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": Sketch의 너비 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Sketch의 너비 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Sketch의 너비 결정
- "rem": MainFrame font-size 속성값을 기준으로 Sketch의 너비 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 Sketch의 너비 결정
- "%": <strCompID>의 width 속성값을 기준으로 Sketch의 너비 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Sketch > Property > word-spacing

**Description**

Sketch 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다.

**Syntax**

```javascript
Sketch.wordSpacing[= strwordspacing]
```
...
* Script ( normal property )
this.Sketch00.wordSpacing = "30px";
```
...
> Components > Component > Sketch > Method > addEvent
...
> Components > Component > Sketch > Method > addEventHandler
...
> Components > Component > Sketch > Method > addEventHandlerLookup
...
> Components > Component > Sketch > Method > bringToFront
...
> Components > Component > Sketch > Method > bringToPrev
...
> Components > Component > Sketch > Method > clear
...
> Components > Component > Sketch > Method > clearEventHandler
...
> Components > Component > Sketch > Method > destroy
...
Form.addChildForm.insertChildForm.removeChildSketch.initSketch.show
...
> Components > Component > Sketch > Method > drawErase
...
> Components > Component > Sketch > Method > drawStroke
...
> Components > Component > Sketch > Method > drawText
...
> Components > Component > Sketch > Method > findEventHandler
...
> Components > Component > Sketch > Method > getEventHandler
...
> Components > Component > Sketch > Method > getOffsetBottom
...
> Components > Component > Sketch > Method > getOffsetHeight
...
> Components > Component > Sketch > Method > getOffsetLeft
...
> Components > Component > Sketch > Method > getOffsetRight
...
> Components > Component > Sketch > Method > getOffsetTop
...
> Components > Component > Sketch > Method > getOffsetWidth
...
> Components > Component > Sketch > Method > getPixelBottom
...
> Components > Component > Sketch > Method > getPixelHeight
...
> Components > Component > Sketch > Method > getPixelLeft
...
> Components > Component > Sketch > Method > getPixelRight
...
> Components > Component > Sketch > Method > getPixelTop
...
> Components > Component > Sketch > Method > getPixelWidth
...
> Components > Component > Sketch > Method > hideTextEditor
...
> Components > Component > Sketch > Method > init
...
Form.addChildForm.insertChildForm.removeChildSketch.destroySketch.show
...
> Components > Component > Sketch > Method > insertEventHandler
...
> Components > Component > Sketch > Method > move
...
> Components > Component > Sketch > Method > moveToNext
...
> Components > Component > Sketch > Method > moveToPrev
...
> Components > Component > Sketch > Method > redo
...
> Components > Component > Sketch > Method > removeEvent
...
> Components > Component > Sketch > Method > removeEventHandler
...
> Components > Component > Sketch > Method > removeEventHandlerLookup
...
> Components > Component > Sketch > Method > resize
...
> Components > Component > Sketch > Method > saveSketch
...
- strFormat 파라미터에 설정할 수 있는 값은 표를 참고해주세요.
   * 표에서 두 번째 컬럼의 WRE는 Safari(masOS, iOS/iPadOS) 브라우저를 제외한 WRE를 의미합니다.
...
> Components > Component > Sketch > Method > saveSketchToFile
...
> Components > Component > Sketch > Method > sendToBack
...
> Components > Component > Sketch > Method > sendToNext
...
> Components > Component > Sketch > Method > setBrushColor
...
> Components > Component > Sketch > Method > setBrushSize
...
> Components > Component > Sketch > Method > setBrushType
...
> Components > Component > Sketch > Method > setEraseSize
...
> Components > Component > Sketch > Method > setEventHandler
...
> Components > Component > Sketch > Method > setEventHandlerLookup
...
> Components > Component > Sketch > Method > setFocus

**Description**

Sketch 에 포커스를 설정하는 메서드입니다.

**Syntax**

```javascript
Sketch.setFocus( [bMoveScroll] )
```
...
> Components > Component > Sketch > Method > setOffsetBottom
...
> Components > Component > Sketch > Method > setOffsetHeight
...
> Components > Component > Sketch > Method > setOffsetLeft
...
> Components > Component > Sketch > Method > setOffsetRight
...
> Components > Component > Sketch > Method > setOffsetTop
...
> Components > Component > Sketch > Method > setOffsetWidth
...
> Components > Component > Sketch > Method > setTextFont
...
> Components > Component > Sketch > Method > show
...
Form.addChildForm.insertChildForm.removeChildSketch.destroySketch.init
...
> Components > Component > Sketch > Method > showTextEditor
...
> Components > Component > Sketch > Method > undo
...
> Components > Component > Sketch > Event > onclick

**Description**

Sketch 영역 내에서 마우스 왼쪽버튼을 클릭했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onclick(obj:nexacro.Sketch,e:nexacro.ClickEventInfo);
```
...
- Sketch 영역 내에서 마우스의 lbuttondown 액션과 lbuttonup 액션이 발생되어야 합니다.
...
> Components > Component > Sketch > Event > oncontextmenu

**Description**

Sketch 영역에서 오른쪽 마우스 버튼을 클릭하거나 터치를 일정시간 유지할 때 발생하는 이벤트입니다.

**Syntax**

```javascript
oncontextmenu(obj:nexacro.Sketch,e:nexacro.ContextMenuEventInfo);
```
...
> Components > Component > Sketch > Event > ondblclick

**Description**

Sketch 영역 내에서 마우스 왼쪽버튼을 더블클릭 했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondblclick(obj:nexacro.Sketch,e:nexacro.MouseEventInfo);
```
...
> Components > Component > Sketch > Event > ondevicebuttonup
...
```javascript
ondevicebuttonup(obj:nexacro.Sketch,e:nexacro.DeviceButtonEventInfo);
```
...
> Components > Component > Sketch > Event > ondrag

**Description**

Sketch 영역 내에서 마우스 왼쪽버튼으로 드래그를 수행했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondrag(obj:nexacro.Sketch,e:nexacro.DragEventInfo);
```
...
- Sketch 영역 내에서 마우스의 LButtonDown 후 LButtonUp 액션 없이 마우스 이동 시 ondrag 이벤트가 발생합니다.
...
> Components > Component > Sketch > Event > ondragenter

**Description**

Sketch 영역 내로 드래그 상태의 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragenter(obj:nexacro.Sketch,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 Sketch 영역으로 마우스 포인터가 들어올 때마다 이벤트가 발생합니다.
...
> Components > Component > Sketch > Event > ondragleave

**Description**

Sketch 영역 밖으로 드래그 상태의 마우스 포인터가 나갈 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragleave(obj:nexacro.Sketch,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 Sketch 영역에서 마우스 포인터가 나갈 때마다 이벤트가 발생합니다.
...
> Components > Component > Sketch > Event > ondragmove

**Description**

Sketch 영역 내에서 드래그 상태의 마우스 포인터가 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragmove(obj:nexacro.Sketch,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 Sketch 영역 내에서 마우스 포인터가 움직일 때마다 이벤트가 발생합니다.
...
> Components > Component > Sketch > Event > ondrop

**Description**

Sketch 영역 내에서 드래그 상태의 마우스 버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondrop(obj:nexacro.Sketch,e:nexacro.DragEventInfo);
```
...
- Sketch 영역 내에서 드래그 상태인 마우스의 LButtonUp 액션 발생 시 ondrop 이벤트가 발생합니다.
...
> Components > Component > Sketch > Event > onerror

**Description**

Sketch에서 메소드 실행 중 오류가 생겼을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onerror(obj:nexacro.Sketch,e:nexacro.SketchErrorEventInfo);
```
...
- saveSketchToFile(), loadSketch() 메소드 실행 중 통신오류나 파일형식 문제로 오류가 생겼을 때 발생합니다.
...
> Components > Component > Sketch > Event > oninput

**Description**

Sketch 에서 입력을 시도할 때 발생하는 이벤트 입니다.

**Syntax**

```javascript
oninput(obj:nexacro.Sketch,e:nexacro.InputEventInfo);
```
...
> Components > Component > Sketch > Event > onkeydown

**Description**

Sketch 에 포커스가 있는 상태에서 키보드의 키가 눌렸을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkeydown(obj:nexacro.Sketch,e:nexacro.KeyEventInfo);
```
...
> Components > Component > Sketch > Event > onkeyup

**Description**

Sketch 에 포커스가 있는 상태에서 눌렸던 키보드가 떼어질 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkeyup(obj:nexacro.Sketch,e:nexacro.KeyEventInfo);
```
...
> Components > Component > Sketch > Event > onkillfocus

**Description**

Sketch 에서 포커스가 나갈  때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkillfocus(obj:nexacro.Sketch,e:nexacro.KillFocusEventInfo);
```
...
- showModal(), open() 등의 메소드로 팝업된 Frame 으로 포커스가 이동하는 경우 Sketch 에서 포커스 관련 이벤트가 발생하지 않습니다.
   또한, alert(), confirm() 메소드로 표시된 팝업으로 포커스가 이동하는 경우도 Sketch 에서 포커스 관련 이벤트가 발생하지 않습니다.
...
> Components > Component > Sketch > Event > onlbuttondown

**Description**

Sketch 영역 내에서 마우스 왼쪽버튼을 눌렀을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onlbuttondown(obj:nexacro.Sketch,e:nexacro.MouseEventInfo);
```
...
- Sketch 영역 내에서 마우스의 LButtonDown 액션이 발생하면 이벤트가 발생합니다.
...
> Components > Component > Sketch > Event > onlbuttonup

**Description**

Sketch 영역 내에서 눌렸던 마우스 왼쪽버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onlbuttonup(obj:nexacro.Sketch,e:nexacro.MouseEventInfo);
```
...
> Components > Component > Sketch > Event > onload

**Description**

loadSketch() 메소드 실행에 성공했을때 발생하는 이벤트입니다.

**Syntax**

```javascript
onload(obj:nexacro.Sketch,e:nexacro.SketchLoadEventInfo);
```
...
> Components > Component > Sketch > Event > onmouseenter

**Description**

Sketch 영역 내로 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmouseenter(obj:nexacro.Sketch,e:nexacro.MouseEventInfo);
```
...
> Components > Component > Sketch > Event > onmouseleave

**Description**

Sketch 영역 밖으로 마우스 포인터가 나갈 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmouseleave(obj:nexacro.Sketch,e:nexacro.MouseEventInfo);
```
...
> Components > Component > Sketch > Event > onmousemove

**Description**

Sketch 영역 내에서 마우스 포인터가 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmousemove(obj:nexacro.Sketch,e:nexacro.MouseEventInfo);
```
...
> Components > Component > Sketch > Event > onmove

**Description**

Sketch 의 위치가 이동했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmove(obj:nexacro.Sketch,e:nexacro.MoveEventInfo);
```
...
> Components > Component > Sketch > Event > onrbuttondown

**Description**

Sketch 영역 내에서 마우스 오른쪽버튼을 눌렀을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onrbuttondown(obj:nexacro.Sketch,e:nexacro.MouseEventInfo);
```
...
> Components > Component > Sketch > Event > onrbuttonup

**Description**

Sketch 영역 내에서 마우스 오른쪽버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onrbuttonup(obj:nexacro.Sketch,e:nexacro.MouseEventInfo);
```
...
> Components > Component > Sketch > Event > onsetfocus

**Description**

Sketch 에 포커스가 들어올 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onsetfocus(obj:nexacro.Sketch,e:nexacro.SetFocusEventInfo);
```
...
- open() 메소드로 오픈된 Modeless 창에서 부모창의 Sketch 에 setFocus() 메소드 실행 시 환경에 따라 동작에 차이가 있으므로 주의하여야 합니다.
...
> Components > Component > Sketch > Event > onsize

**Description**

Sketch 의 크기가 변경됐을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onsize(obj:nexacro.Sketch,e:nexacro.SizeEventInfo);
```
...
> Components > Component > Sketch > Event > onsuccess

**Description**

saveSketch(), saveSketchToFile() 메소드 실행에 성공했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onsuccess(obj:nexacro.Sketch,e:nexacro.SketchEventInfo);
```
...
> Components > Component > Sketch > Event > ontouchend

**Description**

Sketch 영역 내에서 터치를 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchend(obj:nexacro.Sketch,e:nexacro.TouchEventInfo);
```
...
> Components > Component > Sketch > Event > ontouchmove

**Description**

Sketch 영역 내에서 터치 상태를 유지하며 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchmove(obj:nexacro.Sketch,e:nexacro.TouchEventInfo);
```
...
> Components > Component > Sketch > Event > ontouchstart

**Description**

Sketch 영역 내에서 터치가 시작될 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchstart(obj:nexacro.Sketch,e:nexacro.TouchEventInfo);
```
