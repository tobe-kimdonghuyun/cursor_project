...
| Name | Description |
| --- | --- |
| acceptstab | TextArea 에서 탭키 입력을 들여쓰기로 적용할지 포커스 이동으로 적용할지 결정하는 속성입니다. |
| accessibilityaction | TextArea에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다. |
| accessibilitydesclevel | TextArea 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| accessibilitydescription | TextArea에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다. |
| accessibilityenable | TextArea 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| accessibilitylabel | TextArea에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다. |
| accessibilityrole | TextArea에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다. |
| autoselect | TextArea 의 편집영역이 활성화 될 때 텍스트를 전체선택 할지 설정하는 속성입니다. |
| autoskip | TextArea 에 입력중인 문자열의 길이가 maxlength 속성값에 도달했을 때 포커스를 자동으로 이동시킬지 설정하는 속성입니다. |
| background | TextArea 의 배경 영역을 설정하는 속성입니다. |
| border-radius | TextArea 의 모서리 모양을 설정하는 속성입니다. |
| bottom | TextArea 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다. |
| box-shadow | TextArea 에 그림자 효과를 설정하는 속성입니다. |
| color | TextArea 에 표시되는 텍스트의 색상을 설정하는 속성입니다. |
| cssclass | TextArea 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다. |
| cursor | TextArea 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다. |
| displaynulltext | TextArea 의 value 속성값이 null 또는 undefined 일 때 TextArea 에 표시될 대체 문자열을 설정하는 속성입니다. |
| dragscrolltype | TextArea에서 터치 후 드래그로 스크롤이 발생할 경우, 스크롤 방향을 설정하는 속성입니다. |
| enable | TextArea 의 사용가능 여부를 설정하는 속성입니다. |
| enableevent | TextArea 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다. |
...
| font | TextArea 에서 사용하는 폰트를 설정하는 속성입니다. |
| height | TextArea 을(를) 표시하기 위한 높이를 설정하는 속성입니다. |
| hotkey | TextArea 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다. |
| hscrollbar | TextArea 의 서브컨트롤인 수평 스크롤바의 오브젝트를 갖는 읽기전용 속성입니다. |
| id | TextArea의 고유 식별자를 설정하는 속성입니다. |
| imemode | TextArea 의 기본 입력 언어를 설정하는 속성입니다. |
| initvalueid | TextArea 에 적용될 InitValue 의 ID 를 설정하는 속성입니다. |
| inputfilter | TextArea 에 입력을 제한 시킬 문자를 타입별로 설정하는 속성입니다. |
| inputmode | TextArea 에 입력되는 영문자를 대문자 또는 소문자로 변환할지 설정하는 속성입니다. |
| inputtype | TextArea 에 입력을 허용할 문자를 타입별로 설정하는 속성입니다. |
| layoutorder | Layout 컨테이너 내 Main Axis(type 속성값이 "horizontal"이면 수평축, type 속성값이 "vertical"이면 수직축)에 컴포넌트가 배치되는 순서를 설정합니다. |
| left | TextArea 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다. |
| letter-spacing | TextArea 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다. |
| maxheight | TextArea 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다. |
| maxlength | TextArea 에 입력할 수 있는 문자열의 최대길이를 설정하는 속성입니다. |
| maxwidth | TextArea 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다. |
| minheight | TextArea 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다. |
| minwidth | TextArea 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다. |
| name | TextArea 의 이름을 설정하는 속성입니다. |
| -nexa-border | TextArea 의 테두리를 설정하는 속성입니다. |
| -nexa-edge | TextArea 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-padding | TextArea 영역의 안쪽 여백을 설정하는 속성입니다. |
| -nexa-rtl-background-image | TextArea 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다. |
| -nexa-rtl-edge-image | TextArea 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-text-align | TextArea 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다. |
| -nexa-text-decoration | TextArea 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다. |
| -nexa-word-wrap | TextArea 에 표시되는 텍스트가 출력영역보다 길 경우 자동으로 줄바꿈 되도록 설정하는 속성입니다. |
| opacity | TextArea 영역의 투명도를 설정하는 속성입니다. |
| parent | TextArea 의 부모 오브젝트를 갖는 읽기전용 속성입니다. |
| positionstep | 부모 오브젝트가 화면분할기능을 사용할 때 TextArea 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다. |
| readonly | TextArea 에서 편집을 허용할 지 설정하는 속성입니다. |
| right | TextArea 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다. |
| rtl | TextArea 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다. |
| scrollbarbarminsize | TextArea 에 표시되는 스크롤바의 트랙바(TrackBar) 최소크기를 설정하는 속성입니다. |
| scrollbarbaroutsize | TextArea 의 스크롤바에서 트랙바(TrackBar)가 사라지는 기준 크기를 설정하는 속성입니다. |
| scrollbardecbuttonsize | TextArea 에 표시되는 스크롤바의 감소 버튼(DecButton) 크기를 설정하는 속성입니다. |
| scrollbarincbuttonsize | TextArea 에 표시되는 스크롤바의 증가 버튼(IncButton) 크기를 설정하는 속성입니다. |
| scrollbarsize | TextArea 에 표시되는 스크롤바의 크기를 설정하는 속성입니다. |
| scrollbartrackbarsize | TextArea 에 표시되는 스크롤바의 트랙바(TrackBar) 크기를 설정하는 속성입니다. |
| scrollbartype | TextArea 에 스크롤바가 표시되는 형식을 설정하는 속성입니다. |
| scrollindicatorsize | TextArea 에 표시되는 스크롤 인디케이터바의 크기를 설정하는 속성입니다. |
| scrolltype | TextArea 에서 사용되는 스크롤의 종류를 설정하는 속성입니다. |
| tablecellarea | Layout 컨테이너 내 가상의 Table Cell 영역 내에서 컴포넌트가 배치되는 영역을 설정합니다. |
| taborder | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 TextArea 의 순서를 설정하는 속성입니다. |
| tabstop | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 TextArea 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다. |
| text | TextArea 에 표시되는 문자열을 갖는 읽기전용 속성입니다. |
| tooltiptext | TextArea 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다. |
| tooltiptype | TextArea 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다. |
| top | TextArea 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다. |
| usecontextmenu | TextArea 의 편집영역에서 오른쪽 마우스 클릭 시 기본팝업메뉴의 표시 여부를 설정하는 속성입니다. |
| usesoftkeyboard | TextArea 가 포커스를 가질 때 키패드의 표시 여부를 설정하는 속성입니다. |
| value | TextArea 에 표시되는 문자열을 갖는 속성입니다. |
| visible | TextArea 이(가) 화면에 표시될지 여부를 설정하는 속성입니다. |
| vscrollbar | TextArea 의 서브컨트롤인 수직 스크롤바의 오브젝트를 갖는 읽기전용 속성입니다. |
| width | TextArea 을(를) 표시하기 위한 너비를 설정하는 속성입니다. |
| word-spacing | TextArea 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다. |

**Method**

| Name | Description |
| --- | --- |
| addEvent | TextArea 에 특정 이벤트를 선언하여 추가하는 메소드입니다. |
| addEventHandler | TextArea 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다. |
| addEventHandlerLookup | 함수를 검색하여 TextArea 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다. |
| bringToFront | 부모가 동일한 컴포넌트 중 TextArea 이(가) 화면의 제일 앞에 표시되게 합니다. |
| bringToPrev | 부모가 동일한 컴포넌트 중 TextArea 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| clearEventHandler | 특정 이벤트에 등록된 핸들러 함수를 모두 제거하는 메소드입니다. |
| deleteText | TextArea 의 입력값 중 특정위치에서 특정길이만큼 텍스트를 삭제하는 메소드입니다. |
| destroy | 스크립트에서 동적으로 생성한 TextArea 을(를) 삭제하는 메소드입니다. |
| find | TextArea 의 value 속성값에서 특정 텍스트의 시작위치를 반환하는 메소드입니다. |
| findEventHandler | TextArea 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다. |
| getCaretPos | TextArea 에서 캐럿이 위치한 인덱스를 반환하는 메소드입니다. |
| getEventHandler | TextArea 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다. |
| getHScrollPos | TextArea 에 표시된 수평스크롤바의 트랙바 위치값을 반환하는 메소드입니다. |
| getLength | TextArea 의 value 속성에 설정된 문자열의 길이를 반환하는 메소드입니다. |
| getOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 TextArea 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetHeight | TextArea 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 TextArea 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 TextArea 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 TextArea 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetWidth | TextArea 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getPixelBottom | TextArea 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelHeight | TextArea 의 height 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelLeft | TextArea 의 left 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelRight | TextArea 의 right 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelTop | TextArea 의 top 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelWidth | TextArea 의 width 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getSelect | TextArea 컴포넌트의 텍스트 편집 영역에서 선택한 텍스트의 시작 인덱스와 끝 인덱스를 배열 형태로 반환하는 메서드입니다. |
| getSelectedText | TextArea 컴포넌트의 텍스트 편집 영역에서 선택한 텍스트를 반환하는 메서드입니다. |
| getVScrollPos | TextArea 에 표시된 수직스크롤바의 트랙바 위치값을 반환하는 메소드입니다. |
| init | 스크립트로 TextArea 을(를) 동적 생성한 후에 초기화하는 메소드입니다. |
| insertEventHandler | TextArea 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다. |
| insertText | TextArea 의 특정 위치에 새로운 텍스트를 삽입하는 메소드입니다. |
| move | TextArea 의 위치와 크기를 변경하는 메소드입니다. |
| moveToNext | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 TextArea 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| moveToPrev | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 TextArea 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| removeEvent | TextArea 에 선언된 특정 이벤트를 삭제하는 메소드입니다. |
| removeEventHandler | TextArea 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다. |
| removeEventHandlerLookup | TextArea 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다. |
| replace | TextArea 의 value 속성값에서 특정 텍스트를 새로운 텍스트로 모두 치환하는 메소드입니다. |
| resize | TextArea 의 크기를 변경하는 메소드입니다. |
| scrollBy | TextArea 에 표시된 스크롤을 현재 위치에서 인수로 전달된 값만큼 이동시키는 메소드입니다. |
| scrollTo | TextArea 에 표시된 스크롤을 특정 위치로 이동시키는 메소드입니다. |
| sendToBack | 부모가 동일한 컴포넌트 중 TextArea 이(가) 화면의 제일 뒤에 표시되게 합니다. |
| sendToNext | 부모가 동일한 컴포넌트 중 TextArea 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| setCaretPos | TextArea 에서 캐럿의 위치를 인덱스로 설정하는 메소드입니다. |
| setEventHandler | TextArea 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다. |
| setEventHandlerLookup | TextArea 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다. |
| setFocus | TextArea 에 포커스를 설정하는 메서드입니다. |
| setOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 TextArea 의 bottom 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetHeight | TextArea 의 높이를 픽셀단위로 설정하는 메소드입니다. |
| setOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 TextArea 의 left 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 TextArea 의 right 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 TextArea 의 top 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetWidth | TextArea 의 너비를 픽셀단위로 설정하는 메소드입니다. |
| setSelect | TextArea 에 포커스가 있을 때 인수로 지정된 영역을 선택하는 메소드입니다. |
| setSelectedText | TextArea 에서 현재 선택되어 있는 텍스트를 전달된 인수값으로 변경하는 메소드입니다. |
| show | 스크립트로 동적 생성한 TextArea 을(를) 화면에 표시하는 메소드입니다. |
| updateToDataset | TextArea 의 value 속성값을 바인딩 되어 있는 DataSet 에 즉시 반영시키는 메소드입니다. |

**Event**

| Name | Description |
| --- | --- |
| canchange | TextArea 에서 value 속성값이 변경될 때 발생하는 이벤트입니다. |
| onchanged | TextArea 에서 value 속성값이 변경된 후 발생하는 이벤트입니다. |
| oncontextmenu | TextArea 영역에서 오른쪽 마우스 버튼을 클릭하거나 터치를 일정시간 유지할 때 발생하는 이벤트입니다. |
| ondevicebuttonup | 모바일 에서 디바이스 버튼을 눌렀을 때 발생하는 이벤트입니다. |
| ondrag | TextArea 영역 내에서 마우스 왼쪽버튼으로 드래그를 수행했을 때 발생하는 이벤트입니다. |
| ondragenter | TextArea 영역 내로 드래그 상태의 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다. |
| ondragleave | TextArea 영역 밖으로 드래그 상태의 마우스 포인터가 나갈 때 발생하는 이벤트입니다. |
| ondragmove | TextArea 영역 내에서 드래그 상태의 마우스 포인터가 움직일 때 발생하는 이벤트입니다. |
| ondrop | TextArea 영역 내에서 드래그 상태의 마우스 버튼을 떼었을 때 발생하는 이벤트입니다. |
| oneditclick | TextArea 컴포넌트의 텍스트 편집 영역에서 마우스 왼쪽 버튼을 클릭했을 때 발생하는 이벤트입니다. |
| onhscroll | TextArea 의 수평 스크롤바를 스크롤 했을 때 발생하는 이벤트입니다. |
| oninput | TextArea 에서 입력을 시도할 때 발생하는 이벤트 입니다. |
| onkeydown | TextArea 에 포커스가 있는 상태에서 키보드의 키가 눌렸을 때 발생하는 이벤트입니다. |
| onkeyup | TextArea 에 포커스가 있는 상태에서 눌렸던 키보드가 떼어질 때 발생하는 이벤트입니다. |
| onkillfocus | TextArea 에서 포커스가 나갈  때 발생하는 이벤트입니다. |
| onlbuttondown | TextArea 영역 내에서 마우스 왼쪽버튼을 눌렀을 때 발생하는 이벤트입니다. |
| onlbuttonup | TextArea 영역 내에서 눌렸던 마우스 왼쪽버튼을 떼었을 때 발생하는 이벤트입니다. |
| onmouseenter | TextArea 영역 내로 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다. |
| onmouseleave | TextArea 영역 밖으로 마우스 포인터가 나갈 때 발생하는 이벤트입니다. |
| onmousemove | TextArea 영역 내에서 마우스 포인터가 움직일 때 발생하는 이벤트입니다. |
| onmousewheel | TextArea 영역 내에서 마우스의 휠버튼을 회전했을 때 발생하는 이벤트입니다. |
| onmove | TextArea 의 위치가 이동했을 때 발생하는 이벤트입니다. |
| onrbuttondown | TextArea 영역 내에서 마우스 오른쪽버튼을 눌렀을 때 발생하는 이벤트입니다. |
| onrbuttonup | TextArea 영역 내에서 마우스 오른쪽버튼을 떼었을 때 발생하는 이벤트입니다. |
| onsetfocus | TextArea 에 포커스가 들어올 때 발생하는 이벤트입니다. |
| onsize | TextArea 의 크기가 변경됐을 때 발생하는 이벤트입니다. |
| ontouchend | TextArea 영역 내에서 터치를 떼었을 때 발생하는 이벤트입니다. |
| ontouchmove | TextArea 영역 내에서 터치 상태를 유지하며 움직일 때 발생하는 이벤트입니다. |
| ontouchstart | TextArea 영역 내에서 터치가 시작될 때 발생하는 이벤트입니다. |
| onvscroll | TextArea 의 수직 스크롤바를 스크롤 했을 때 발생하는 이벤트입니다. |
...
> Components > Component > TextArea > Property > -nexa-border

**Description**

TextArea 의 테두리를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.border[= strborder]
```
...
this.TextArea00.border = "1px solid #999999";
this.TextArea00.border = "1px solid #999999, 1px solid #999999, 1px solid #999999, 1px solid #999999";
```
...
> Components > Component > TextArea > Property > -nexa-edge

**Description**

TextArea 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.edge[= stredge]
```
...
* Script ( normal property )
this.TextArea00.edge = "URL('./images/border.png')" 5px 5px;
```
...
- TextArea 내부에 테두리 형태로 이미지를 표시하고자 할 때 사용하는 속성입니다.
...
> Components > Component > TextArea > Property > -nexa-padding

**Description**

TextArea 영역의 안쪽 여백을 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.padding[= strpadding]
```
...
* Script ( normal property )
this.TextArea00.padding = "5px 5px 5px 5px";
```
- **`<npadding>`** — TextArea 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
- -nexa-padding 속성은 내부 컨텐츠영역과 TextArea 사이의 여백으로 적용됩니다.
...
> Components > Component > TextArea > Property > -nexa-rtl-background-image

**Description**

TextArea 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.-nexa-rtl-background-image
```
...
> Components > Component > TextArea > Property > -nexa-rtl-edge-image

**Description**

TextArea 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.-nexa-rtl-edge-image
```
...
> Components > Component > TextArea > Property > -nexa-text-align

**Description**

TextArea 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.textAlign[= strtextalign]
```
...
* Script ( normal property )
this.TextArea00.textAlign = "center";
```
...
- TextArea 의 너비보다 표시되는 텍스트의 길이가 크면 "right" 를 설정해도 "left" 로 동작됩니다.
...
> Components > Component > TextArea > Property > -nexa-text-decoration

**Description**

TextArea 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.textDecoration[= strTxtDeco]
```
...
* Script ( normal property )
this.TextArea00.textDecoration = "underline overline";
```
...
> Components > Component > TextArea > Property > -nexa-word-wrap

**Description**

TextArea 에 표시되는 텍스트가 출력영역보다 길 경우 자동으로 줄바꿈 되도록 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.wordWrap[= strwordwrap]
```
...
> Components > Component > TextArea > Property > acceptstab

**Description**

TextArea 에서 탭키 입력을 들여쓰기로 적용할지 포커스 이동으로 적용할지 결정하는 속성입니다.

**Syntax**

```javascript
TextArea.acceptstab[= bTab]
```
...
> Components > Component > TextArea > Property > accessibilityaction

**Description**

TextArea에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.accessibilityaction[= strAction]
```

**Setting Syntax**

```javascript
this.TextArea00.accessibilityaction = "Accessibility Action Message"; 
this.TextArea00.accessibilityaction = "Select by direction key";
```
...
> Components > Component > TextArea > Property > accessibilitydesclevel

**Description**

TextArea 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.accessibilitydesclevel[= enumLevel]
```
...
```
```javascript
this.TextArea00.accessibilitydesclevel = "all";
```
- **`"all"`** — TextArea 와 자식 컴포넌트에 대한 접근성을 모두 출력합니다.
- **`"self"`** — TextArea 의 접근성만 출력하고 자식 컴포넌트의 접근성은 출력하지 않습니다.
- **`"child"`** — TextArea 의 접근성은 출력하지 않고, 자식 컴포넌트의 접근성은 출력합니다.
- **`"none"`** — TextArea 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
...
- accessibilitydesclevel 속성은 선택상자의 이동에 영향을 주지 않으므로 방향키로 선택상자가 TextArea 에 이동되게 하지 않으려면 accessibilityenable 속성을 설정하여야 합니다.
...
> Components > Component > TextArea > Property > accessibilitydescription

**Description**

TextArea에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.accessibilitydescription[= strDescription]
```

**Setting Syntax**

```javascript
this.TextArea00.accessibilitydescription = "Option";
```
...
> Components > Component > TextArea > Property > accessibilityenable

**Description**

TextArea 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.accessibilityenable[= bEnable]
```
...
```
```javascript
this.TextArea00.accessibilityenable = false;
```
- **`true`** — TextArea 에 선택상자가 이동되면 접근성 관련 속성값을 출력합니다.

방향키 또는 제스처로 선택상자 이동 시 Static 과 같이 포커스를 갖지 않는 컴포넌트에도 선택상자가 이동됩니다.
- **`false`** — TextArea 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.

데스크탑 환경에서 방향키로 선택상자가 TextArea 에 이동되지 않습니다.
모바일 환경에서 제스처로 선택상자가 TextArea 에 이동되지 않습니다.
...
- 선택상자 이동 시 컴포넌트의 ARIA-LABEL + Value + Status + Role 순서로 정보가 조합되어 접근성으로 출력됩니다.
   ...
   > Value : TextArea 의 text 속성값이 반영됩니다. text 속성값이 없을 경우 "빈줄"로 반영됩니다.
   > Status : TextArea 가 편집가능상태인지 여부가 반영됩니다.
   > Role : accessibilityrole 속성값이 반영됩니다. accessibilityrole 속성값을 설정하지 않으면 TextArea 의 고유 Role 이 반영됩니다.
               센스리더는 TextArea 의 고유 Role 로 "편집창"을 출력합니다.

- TextArea 가 편집상태일 때 캐럿이동 또는 텍스트선택/삭제 시 캐럿위치의 텍스트를 접근성으로 출력합니다.
   캐럿 이동 및 텍스트 선택은 접근성과 무관하게 키액션으로 동작됩니다.

- TextArea 에 입력된 텍스트가 없을 경우 접근성으로 "빈줄" 이라고 출력합니다.

- accessibilityenable 속성값이 false 일 때 데스크탑 환경에서 방향키 외의 방법으로 선택상자를 TextArea 로 이동시키면 스크린 리딩 프로그램에서 임의의 값을 출력할 수 있습니다.


◆ 컨테이너 컴포넌트(Div, PopupDiv, TabpageControl, View) 선택상자 이동 제약

아래와 같은 환경에서 컨테이너 컴포넌트로 선택상자가 이동하지 않고 컨테이너 컴포넌트 내에 배치된 컴포넌트로 이동합니다.
- Android, iOS/iPadOS 운영체제에서 실행 시
- Windows 운영체제에서 센스리더 가상커서 사용 시
...
> Components > Component > TextArea > Property > accessibilitylabel

**Description**

TextArea에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.accessibilitylabel[= strLabel]
```

**Setting Syntax**

```javascript
this.TextArea00.accessibilitylabel = "OK Button"; 
this.TextArea00.accessibilitylabel = "[@static00]"; 
this.TextArea00.accessibilitylabel = "[@static00][@static01]"; 
this.TextArea00.accessibilitylabel = "[@static00][@static01] OK Button";
```
...
> Components > Component > TextArea > Property > accessibilityrole

**Description**

TextArea에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.accessibilityrole[= enumRole]
```
...
```
```javascript
this.TextArea00.accessibilityrole = "none"; 
this.TextArea00.accessibilityrole = "button";
```
...
- accessibilityenable 속성값을 설정하지 않으면 TextArea의 기본 Role 로 적용됩니다.

- 추가적인 속성값이 필요한 Role 설정 시 TextArea에 해당 속성이 없으면 스크린 리더에 따라 정상적으로 정보를 읽지 못할 수 있습니다.
...
> Components > Component > TextArea > Property > autoselect

**Description**

TextArea 의 편집영역이 활성화 될 때 텍스트를 전체선택 할지 설정하는 속성입니다.
...
```
```javascript
this.TextArea00.autoselect = true;
```
...
> Components > Component > TextArea > Property > autoskip

**Description**

TextArea 에 입력중인 문자열의 길이가 maxlength 속성값에 도달했을 때 포커스를 자동으로 이동시킬지 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.autoskip[= bAutoskip]
```
...
> Components > Component > TextArea > Property > background

**Description**

TextArea 의 배경 영역을 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.background[= strbackground]
```
...
* Script ( normal property )
this.TextArea00.background = "#ffffaa";
this.TextArea00.background = ""URL('./images/smiley.gif')" no-repeat center center #ffffaa";
this.TextArea00.background = ""URL('./images/smiley.gif')" no-repeat center center /auto #ffffaa";
this.TextArea00.background = ""URL('./images/smiley.gif')" no-repeat center center /15px 15% #ffffaa";
this.TextArea00.background = "linear-gradient( red , blue , yellow )";
this.TextArea00.background = "linear-gradient( #FF0000 , rgb(0,0,255) , rgb(255,255,0))";
this.TextArea00.background = ""URL('./images/smiley.gif')" border-box border-box #ffffaa";
```
...
"left" 설정 시 TextArea 의 왼쪽면과 이미지의 왼쪽면이 정렬되어 표시됩니다.
"center" 설정 시 TextArea 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"right" 설정 시 TextArea 의 오른쪽면과 이미지의 오른쪽면이 정렬되어 표시됩니다.
...
"top" 설정 시 TextArea 의 윗쪽면과 이미지의 윗쪽면이 정렬되어 표시됩니다.
"center" 설정 시 TextArea 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"bottom" 설정 시 TextArea 의 아랫쪽면과 이미지의 아랫쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
0 보다 작거나 100 보다 큰 값을 설정 시 TextArea 의 영역을 벗어난 가상의 위치로 적용됩니다.
...
예를 들어 <angle> 값이 "to left" 이면 TextArea 의 right 위치가 시작점이 되고, left 위치가 끝점이 됩니다.
              <angle> 값이 "to right" 이면 TextArea 의 left 위치가 시작점이 되고, right 위치가 끝점이 됩니다.
...
<bg-image> 에 적용된 이미지에 투명으로 적용된 부분이 있거나 이미지가 TextArea 영역보다 작다면 해당 영역에 배경색이 표시됩니다.
...
> Components > Component > TextArea > Property > border-radius

**Description**

TextArea 의 모서리 모양을 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.borderRadius[= strborderradius]
```
...
* Script ( normal property )
this.TextArea00.borderRadius = "10px";
this.TextArea00.borderRadius = "5px 6px 10px / 5px 10px";
```
...
> Components > Component > TextArea > Property > bottom

**Description**

TextArea 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.bottom[= nBottom]
```
...
```
```javascript
this.TextArea00.bottom = 10; 
this.TextArea00.bottom = "10px"; 
this.TextArea00.bottom = "10%"; 
this.TextArea00.bottom = "Button00:10px"; 
this.TextArea00.bottom = "Button00:10%";
```
- **`<strCompID>`** — TextArea 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 TextArea 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 TextArea 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — TextArea 의 하단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 bottom 속성값을 기준으로 TextArea의 하단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 TextArea의 하단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 TextArea의 하단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 TextArea의 하단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 top 속성값을 기준으로 TextArea의 하단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 TextArea의 하단 위치 결정
...
> Components > Component > TextArea > Property > box-shadow

**Description**

TextArea 에 그림자 효과를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.boxShadow[= strbshadow]
```
...
* Script ( normal property )
this.TextArea00.boxShadow  = "10px 10px 10px #888888";
this.TextArea00.boxShadow  = "inset 10px 10px 10px 5px #888888";
```
...
TextArea 의 좌상단 위치를 기준으로 그림자 효과가 표시될 위치를 가로/세로 픽셀값으로 설정합니다.
...
> Components > Component > TextArea > Property > color

**Description**

TextArea 에 표시되는 텍스트의 색상을 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.color[= strcolor]
```
...
* Script ( normal property )
this.TextArea00.color = "#999999";
this.TextArea00.color = "rgb(255,0,0)";
this.TextArea00.color = "red";
```
- **`<NamedColor>`** — "red","blue" 와 같이 미리 정의된 색상이름을 문자열로 설정합니다.
- **`<NumericColor>`** — 표시할 색의 색상코드입니다.
...
> Components > Component > TextArea > Property > cssclass

**Description**

TextArea 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.cssclass[= strcssclass]
```
...
```
```javascript
this.TextArea00.cssclass = "TestClass"; 
this.TextArea00.cssclass = "TestClass,TestClass2";
```
...
> Components > Component > TextArea > Property > cursor

**Description**

TextArea 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.cursor[= strCursor]
```
...
* Script ( normal property )
this.TextArea00.cursor = "default";
```
...
> Components > Component > TextArea > Property > displaynulltext

**Description**

TextArea 의 value 속성값이 null 또는 undefined 일 때 TextArea 에 표시될 대체 문자열을 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.displaynulltext[= strText]
```

**Setting Syntax**

```javascript
this.TextArea00.displaynulltext = "no value";
```
- **`strText`** — value 속성값이 null 일 때 TextArea 에 표시될 대체 문자열을 설정합니다.

**Remark**

- value 속성값이 null 또는 undefined 이고, TextArea 에 포커스가 없을 때 대체 문자열이 표시됩니다.
...
> Components > Component > TextArea > Property > dragscrolltype

**Description**

TextArea에서 터치 후 드래그로 스크롤이 발생할 경우, 스크롤 방향을 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.dragscrolltype[= enumType]
```
...
> Components > Component > TextArea > Property > enable

**Description**

TextArea 의 사용가능 여부를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.enable[= benable]
```
...
```
```javascript
this.TextArea00.enable = true; 
this.TextArea00.enable = false;
```
- **`true`** — TextArea 을(를) 사용할 수 있게 설정합니다.
- **`false`** — TextArea 을(를) 사용할 수 없게 설정합니다.
...
> Components > Component > TextArea > Property > enableevent

**Description**

TextArea 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.enableevent[= bEvent]
```
...
> Components > Component > TextArea > Property > flexgrow
...
> Components > Component > TextArea > Property > flexshrink
...
> Components > Component > TextArea > Property > font

**Description**

TextArea 에서 사용하는 폰트를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.font[= strfont]
```
...
* Script ( normal property )
this.TextArea00.font = "bold 12pt/30px arial, sans-serif";
```
...
> Components > Component > TextArea > Property > height

**Description**

TextArea 을(를) 표시하기 위한 높이를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.height[= nHeight]
```
...
```
```javascript
this.TextArea00.height = 10; 
this.TextArea00.height = "10px"; 
this.TextArea00.height = 10%"; 
this.TextArea00.height = Button00:10%";
```
- **`<strCompID>`** — TextArea 의 높이를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 TextArea 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 TextArea 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 높이가 적용됩니다.
- **`<nVal>`** — TextArea 의 높이를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.


* <strCompID> 값을 생략했을 때 :
- "px": TextArea의 높이 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 TextArea의 높이 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 TextArea의 높이 결정
- "rem": MainFrame font-size 속성값을 기준으로 TextArea의 높이 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 TextArea의 높이 결정
- "%": <strCompID>의 height 속성값을 기준으로 TextArea의 높이 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > TextArea > Property > hotkey

**Description**

TextArea 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.hotkey[= strHotkey]
```

**Setting Syntax**

```javascript
this.TextArea00.hotkey = "G"; 
this.TextArea00.hotkey = "CTRL+A"; 
this.TextArea00.hotkey = "CTRL+ALT+X";
```
...
> Components > Component > TextArea > Property > hscrollbar

**Description**

TextArea 의 서브컨트롤인 수평 스크롤바의 오브젝트를 갖는 읽기전용 속성입니다.
...
```javascript
this.TextArea00.hscrollbar.decbuttonsize = 30;
```
...
> Components > Component > TextArea > Property > id

**Description**

TextArea의 고유 식별자를 설정하는 속성입니다.
...
- **`id`** — TextArea를 구별할 수 있는 유일값을 갖습니다.
...
> Components > Component > TextArea > Property > imemode

**Description**

TextArea 의 기본 입력 언어를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.imemode[= enumImemode]
```
...
> Components > Component > TextArea > Property > initvalueid

**Description**

TextArea 에 적용될 InitValue 의 ID 를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.initvalueid[= strValueID]
```

**Setting Syntax**

- **`strValueID`** — InitValueDefinition 영역에 정의된 InitValue 파일에서 TextArea 에 적용할 항목의 ID 를 문자열로 설정합니다.

**Remark**

- TextArea 가 화면에 표시된 후에는 속성값을 설정하거나 변경 할 수 없습니다.
   TextArea 를 동적으로 생성 시 show() 메소드 실행 전에 속성값을 설정하여야 합니다.
...
> Components > Component > TextArea > Property > inputfilter

**Description**

TextArea 에 입력을 제한 시킬 문자를 타입별로 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.inputfilter[= strInputfilter]
```
...
> Components > Component > TextArea > Property > inputmode

**Description**

TextArea 에 입력되는 영문자를 대문자 또는 소문자로 변환할지 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.inputmode[= enumInputmode]
```
...
```
```javascript
this.TextArea00.inputmode = "normal";
```
...
> Components > Component > TextArea > Property > inputtype

**Description**

TextArea 에 입력을 허용할 문자를 타입별로 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.inputtype[= strInputtype]
```
...
```
```javascript
this.TextArea00.inputtype = "english";                       // 영문자만 입력허용 
this.TextArea00.inputtype = "english,number";            // 영문자와 숫자만 입력허용 
this.TextArea00.inputtype = "english,number,space";  // 영문자, 숫자, 공백만 입력허용
```
...
> Components > Component > TextArea > Property > layoutorder
...
> Components > Component > TextArea > Property > left

**Description**

TextArea 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.TextArea00.left = 10; 
this.TextArea00.left = "10px"; 
this.TextArea00.left = "10%"; 
this.TextArea00.left = "Button00:10px"; 
this.TextArea00.left = "Button00:10%";
```
- **`<strCompID>`** — TextArea 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — TextArea 의 좌측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 left 속성값을 기준으로 TextArea의 좌측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 TextArea의 좌측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 TextArea의 좌측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 TextArea의 좌측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 right 속성값을 기준으로 TextArea의 좌측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 TextArea의 좌측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > TextArea > Property > letter-spacing

**Description**

TextArea 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.letterSpacing[= strspace]
```
...
* Script ( normal property )
this.TextArea00.letterSpacing = "2px";
```
...
> Components > Component > TextArea > Property > maxheight

**Description**

TextArea 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.maxheight[= nMaxHeight]
```
...
```
```javascript
this.TextArea00.maxheight = 20; 
this.TextArea00.maxheight = "20px";
```
- **`<nVal>`** — TextArea 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 maxheight 보다 크면 화면에 표시되는 TextArea 의 높이는 maxheight 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 TextArea 의 높이가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > TextArea > Property > maxlength

**Description**

TextArea 에 입력할 수 있는 문자열의 최대길이를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.maxlength[= nMaxlength]
```

**Setting Syntax**

```javascript
this.TextArea00.maxlength = 10;
```
...
> Components > Component > TextArea > Property > maxwidth

**Description**

TextArea 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.maxwidth[= nMaxWidth]
```
...
```
```javascript
this.TextArea00.maxwidth = 20; 
this.TextArea00.maxwidth = "20px";
```
- **`<nVal>`** — TextArea 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 maxwidth 보다 크면 화면에 표시되는 TextArea 의 너비는 maxwidth 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 TextArea 의 너비가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > TextArea > Property > minheight

**Description**

TextArea 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.minheight[= nMinHeight]
```
...
```
```javascript
this.TextArea00.minheight = 20; 
this.TextArea00.minheight = "20px";
```
- **`<nVal>`** — TextArea 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 minheight 보다 작다면 화면에 표시되는 TextArea 의 높이는 minheight 속성값으로 적용됩니다.
  표시되는 높이만 적용되고 height 속성값은 변경되지 않습니다.
...
> Components > Component > TextArea > Property > minwidth

**Description**

TextArea 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.minwidth[= nMinWidth]
```
...
```
```javascript
this.TextArea00.minwidth = 20; 
this.TextArea00.minwidth = "20px";
```
- **`<nVal>`** — TextArea 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 minwidth 보다 작으면 화면에 표시되는 TextArea 의 너비는 minwidth 속성값으로 적용됩니다.
  표시되는 너비만 적용되고 width 속성값은 변경되지 않습니다.
...
> Components > Component > TextArea > Property > name

**Description**

TextArea 의 이름을 설정하는 속성입니다.
...
> Components > Component > TextArea > Property > opacity

**Description**

TextArea 영역의 투명도를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.opacity[= stropacity]
```
...
* Script ( normal property )
this.TextArea00.opacity = "0.8";
this.TextArea00.opacity = 0.8;
this.TextArea00.opacity = "80%";
```
...
> Components > Component > TextArea > Property > parent

**Description**

TextArea 의 부모 오브젝트를 갖는 읽기전용 속성입니다.
...
```javascript
var objParent = this.TextArea00.parent;
```
...
- TextArea 이(가) Div 와 같은 컨테이너 컴포넌트에 자식으로 존재한다면 parent 속성은 해당 컨테이너 컴포넌트를 갖습니다.
...
> Components > Component > TextArea > Property > positionstep

**Description**

부모 오브젝트가 화면분할기능을 사용할 때 TextArea 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.positionstep[= nStep]
```

**Setting Syntax**

```javascript
this.TextArea00.positionstep = 0; 
this.TextArea00.positionstep = -1;
```
- **`nStep`** — TextArea 이(가) 표시될 분할화면의 인덱스를 설정합니다.
"-1" 로 설정하면 모든 분할화면에 TextArea 이(가) 표시됩니다.
...
> Components > Component > TextArea > Property > readonly

**Description**

TextArea 에서 편집을 허용할 지 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.readonly[= bReadOnly]
```
...
```
- **`true`** — TextArea 의 편집을 불가능하게 설정합니다.
...
- **`false`** — TextArea 의 편집을 가능하게 설정합니다.
...
> Components > Component > TextArea > Property > right

**Description**

TextArea 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.right[= nRight]
```
...
```
```javascript
this.TextArea00.right = 10; 
this.TextArea00.right = "10px"; 
this.TextArea00.right = "10%"; 
this.TextArea00.right = "Button00:10px"; 
this.TextArea00.right = "Button00:10%";
```
- **`<strCompID>`** — TextArea 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — TextArea 의 우측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 right 속성값을 기준으로 TextArea의 우측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 TextArea의 우측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 TextArea의 우측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 TextArea의 우측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 left 속성값을 기준으로 TextArea의 우측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 TextArea의 우측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > TextArea > Property > rtl

**Description**

TextArea 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다.
...
```
```javascript
var vRtl = this.TextArea00.rtl;
```
- **`undefined`** — undefined 설정 시 상위 컴포넌트의 rtl 속성값이 적용됩니다.

사용자가 rtl 속성값을 설정하지 않거나 삭제했을 경우 undefined 가 설정됩니다.
- **`true`** — TextArea 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 오른쪽으로 설정합니다.
TextArea 의 내부 좌표계의 기준을 오른쪽으로 설정합니다.
TextArea 의 텍스트 표시 기준을 오른쪽으로 설정합니다.
수직스크롤바가 있을 경우 왼쪽에 표시됩니다.
- **`false`** — TextArea 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
TextArea 의 내부 좌표계의 기준을 왼쪽으로 설정합니다.
TextArea 의 텍스트 표시 기준을 왼쪽으로 설정합니다.
...
- TextArea 부터 Environment 까지 상위의 모든 rtl 속성값이 undefined 이면
...
> Components > Component > TextArea > Property > scrollbarbarminsize

**Description**

TextArea 에 표시되는 스크롤바의 트랙바(TrackBar) 최소크기를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.scrollbarbarminsize[= nSize]
```

**Setting Syntax**

```javascript
this.TextArea00.scrollbarbarminsize = 20;
```
...
- TextArea 의 크기 변경에 의해 트랙바의 크기가 자동변경될 때 scrollbarbarminsize 속성값 미만으로 작아지지 않습니다.
...
> Components > Component > TextArea > Property > scrollbarbaroutsize

**Description**

TextArea 의 스크롤바에서 트랙바(TrackBar)가 사라지는 기준 크기를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.scrollbarbaroutsize[= nSize]
```

**Setting Syntax**

```javascript
this.TextArea00.scrollbarbaroutsize( 50 );
```
...
- TextArea 의 크기가 변경되어 스크롤바가 줄어들 때 트랙바를 표시할 공간이 scrollbarbaroutsize 속성값보다 작아지면 트랙바를 표시하지 않습니다.
...
> Components > Component > TextArea > Property > scrollbardecbuttonsize

**Description**

TextArea 에 표시되는 스크롤바의 감소 버튼(DecButton) 크기를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.scrollbardecbuttonsize[= nSize]
```

**Setting Syntax**

```javascript
this.TextArea00.scrollbardecbuttonsize = 30;
```
- **`nSize`** — 스크롤바의 감소 버튼(DecButton) 크기를 pixel 단위의 숫자로 설정합니다.

음수값이나 TextArea 의 너비/높이보다 큰 값을 설정할 수 없습니다.
...
> Components > Component > TextArea > Property > scrollbarincbuttonsize

**Description**

TextArea 에 표시되는 스크롤바의 증가 버튼(IncButton) 크기를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.scrollbarincbuttonsize[= nSize]
```

**Setting Syntax**

```javascript
this.TextArea00.scrollbarincbuttonsize = 30;
```
...
> Components > Component > TextArea > Property > scrollbarsize

**Description**

TextArea 에 표시되는 스크롤바의 크기를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.scrollbarsize[= nSize]
```

**Setting Syntax**

```javascript
this.TextArea00.scrollbarsize = 30;
```
...
> Components > Component > TextArea > Property > scrollbartrackbarsize

**Description**

TextArea 에 표시되는 스크롤바의 트랙바(TrackBar) 크기를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.scrollbartrackbarsize[= nSize]
```

**Setting Syntax**

```javascript
this.TextArea00.scrollbartrackbarsize = 20;
```
- **`nSize`** — 스크롤바의 트랙바 크기를 pixel 단위의 숫자로 설정합니다.

-1 을 설정하면 TextArea 크기와 내부 컨텐츠에 따라 트랙바 크기가 자동으로 조절됩니다.
...
> Components > Component > TextArea > Property > scrollbartype

**Description**

TextArea 에 스크롤바가 표시되는 형식을 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.scrollbartype[= strBartype]
```
...
```
```javascript
this.TextArea00.scrollbartype = "none"; 
this.TextArea00.scrollbartype = "default autoindicator"; 
this.TextArea00.scrollbartype = "auto fixed"; 
this.TextArea00.scrollbartype = "indicator none";
```
...
- 데스크탑에 적용되는 값과 모바일에 적용되는 값을 함께 설정할 수 있지만 권장하지 않습니다.
   ex) this.TextArea00.scrollbartype = "fixed autoindicator";
...
> Components > Component > TextArea > Property > scrollindicatorsize

**Description**

TextArea 에 표시되는 스크롤 인디케이터바의 크기를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.scrollindicatorsize[= nSize]
```

**Setting Syntax**

```javascript
this.TextArea00.scrollindicatorsize = 30;
```
...
- TextArea 에 스크롤 인디케이터바가 아닌 스크롤바가 표시될 경우 scrollbarsize 속성으로 크기를 설정하여야 합니다.
...
> Components > Component > TextArea > Property > scrolltype

**Description**

TextArea 에서 사용되는 스크롤의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.scrolltype[= enumType]
```
...
```
- **`"none"`** — TextArea 에서 수평/수직 스크롤을 사용하지 않습니다.
- **`"both"`** — TextArea 에서 수평/수직 스크롤을 모두 사용합니다.
- **`"vertical"`** — TextArea 에서 수직 스크롤만 사용합니다.

수평 스크롤은 사용하지 않습니다.
- **`"horizontal"`** — TextArea 에서 수평 스크롤만 사용합니다.
...
- TextArea 에서 사용되는 스크롤에 대한 자세한 설정은 scrollbartype 속성을 사용하여야 합니다.

**See Also**

TextArea.scrollbartype
...
> Components > Component > TextArea > Property > tablecellarea
...
```javascript
TextArea.tablecellarea[= strArea]
```
...
> Components > Component > TextArea > Property > taborder

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 TextArea 의 순서를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.taborder[= nTabOrder]
```
...
> Components > Component > TextArea > Property > tabstop

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 TextArea 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.tabstop[= bTabStop]
```
...
bTabStop ::= 'true' | 'false'
```
- **`"true"`** — TextArea 이(가) 탭키 입력에 의한 포커스를 받습니다.
- **`"false"`** — TextArea 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
...
> Components > Component > TextArea > Property > text

**Description**

TextArea 에 표시되는 문자열을 갖는 읽기전용 속성입니다.
...
> Components > Component > TextArea > Property > tooltiptext

**Description**

TextArea 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.tooltiptext[= strToolTipText]
```
...
- 마우스 포인터가 TextArea 영역 위에서 일정시간 움직이지 않으면 풍선도움말이 표시됩니다.
...
> Components > Component > TextArea > Property > tooltiptype

**Description**

TextArea 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.tooltiptype[= enumTooltipType]
```
...
```
```javascript
this.TextArea00.tooltiptype = "hover";
```
- **`"default"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 TextArea 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"hover"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 TextArea 영역내에 멈춰서 일정시간이 경과하면 풍선도움말이 사라집니다.
TextArea 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경되거나 사라진 풍선도움말이 다시 표시됩니다.
- **`"inplace"`** — TextArea 의 좌측상단 안쪽에 풍선도움말을 표시합니다.

마우스 포인터가 TextArea 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"default,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 TextArea 영역에 있으면 풍선도움말이 사라지지 않습니다.
- **`"hover,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 TextArea 영역에 있으면 풍선도움말이 사라지지 않습니다.
TextArea 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경됩니다.
- **`"inplace,mouseleave"`** — TextArea 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
- 표시되었다가 사라진 풍선도움말은 마우스 포인터가 TextArea 영역을 나갔다가 들어오면 다시 표시됩니다.

- 마우스 포인터가 TextArea 영역에서 벗어나면 풍선도움말이 사라집니다.
...
> Components > Component > TextArea > Property > top

**Description**

TextArea 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.TextArea00.top = 10; 
this.TextArea00.top = "10px"; 
this.TextArea00.top = "10%"; 
this.TextArea00.top = "Button00:10px"; 
this.TextArea00.top = "Button00:10%";
```
- **`<strCompID>`** — TextArea 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — TextArea의 상단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 top 속성값을 기준으로 TextArea의 상단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 TextArea의 상단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 TextArea의 상단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 TextArea의 상단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 bottom 속성값을 기준으로 TextArea의 상단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 TextArea의 상단 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > TextArea > Property > usecontextmenu

**Description**

TextArea 의 편집영역에서 오른쪽 마우스 클릭 시 기본팝업메뉴의 표시 여부를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.usecontextmenu[= bUseContextMenu]
```
...
```
```javascript
this.TextArea00.usecontextmenu = true;
```
...
- Environment 의 usecontextmenu 속성값이 "none" 또는 "form" 인 경우 TextArea 의 usecontextmenu 속성은 false 로 동작합니다.
...
> Components > Component > TextArea > Property > usesoftkeyboard

**Description**

TextArea 가 포커스를 가질 때 키패드의 표시 여부를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.usesoftkeyboard[= bUseKeyboard]
```
...
```
```javascript
this.TextArea00.usesoftkeyboard = false;
```
- **`true`** — TextArea 가 포커스를 가질 때 키패드가 자동으로 표시됩니다.
- **`false`** — TextArea 가 포커스를 가질 때 키패드가 표시되지 않습니다.
...
> Components > Component > TextArea > Property > value

**Description**

TextArea 에 표시되는 문자열을 갖는 속성입니다.
...
- TextArea 와 Dataset 을 바인딩하는 경우에 기본으로 연동되는 속성입니다.

- displaynulltext 속성값에 의해 화면에 보여지는 문자열은 value 속성에 저장되지 않습니다.

- 넥사크로 스튜디오에서 줄바꿈을 하기 위해서는 "Ctrl+Enter" 를 사용합니다.
   또한, value 속성값에 "&#10;" 이 있다면 줄바꿈 처리됩니다.
...
> Components > Component > TextArea > Property > visible

**Description**

TextArea 이(가) 화면에 표시될지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.visible[= bVisible]
```
...
```
```javascript
this.TextArea00.visible = true; 
this.TextArea00.visible = false;
```
- **`"true"`** — TextArea 을(를) 화면에 표시합니다.
- **`"false"`** — TextArea 을(를) 화면에 표시하지 않습니다.
...
> Components > Component > TextArea > Property > vscrollbar

**Description**

TextArea 의 서브컨트롤인 수직 스크롤바의 오브젝트를 갖는 읽기전용 속성입니다.
...
```javascript
this.TextArea00.vscrollbar.decbuttonsize = 30;
```
...
> Components > Component > TextArea > Property > width

**Description**

TextArea 을(를) 표시하기 위한 너비를 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.width[= nWidth]
```
...
```
```javascript
this.TextArea00.width = 10; this.TextArea00.width = "10px"; 
this.TextArea00.width = "10%"; 
this.TextArea00.width = "Button00:10%";
```
- **`<strCompID>`** — TextArea 의 너비를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 TextArea 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 TextArea 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 너비가 적용됩니다.
- **`<nVal>`** — TextArea 의 너비를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": TextArea의 너비 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 TextArea의 너비 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 TextArea의 너비 결정
- "rem": MainFrame font-size 속성값을 기준으로 TextArea의 너비 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 TextArea의 너비 결정
- "%": <strCompID>의 width 속성값을 기준으로 TextArea의 너비 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > TextArea > Property > word-spacing

**Description**

TextArea 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다.

**Syntax**

```javascript
TextArea.wordSpacing[= strwordspacing]
```
...
* Script ( normal property )
this.TextArea00.wordSpacing = "30px";
```
...
> Components > Component > TextArea > Method > addEvent

**Description**

TextArea 에 특정 이벤트를 선언하여 추가하는 메소드입니다.

**Syntax**

```javascript
TextArea.addEvent( strEventID )
```
...
- TextArea 에서 특정 이벤트를 제거하려면 removeEvent() 메소드를 사용하여야 합니다.
...
> Components > Component > TextArea > Method > addEventHandler

**Description**

TextArea 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다.

**Syntax**

```javascript
TextArea.addEventHandler( strEventID, objFunc, objTarget )
```
...
> Components > Component > TextArea > Method > addEventHandlerLookup

**Description**

함수를 검색하여 TextArea 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다.

**Syntax**

```javascript
TextArea.addEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
> Components > Component > TextArea > Method > bringToFront

**Description**

부모가 동일한 컴포넌트 중 TextArea 이(가) 화면의 제일 앞에 표시되게 합니다.
...
- bringToFront() 메소드는 TextArea 을(를) 가장 나중에 표시되게 순서를 바꿉니다.
...
> Components > Component > TextArea > Method > bringToPrev

**Description**

부모가 동일한 컴포넌트 중 TextArea 이(가) 화면에 한단계 앞에 표시되게 합니다.

**Syntax**

```javascript
TextArea.bringToPrev()
```

**Parameters**

this.TextArea.bringToPrev();
...
- bringToPrev() 메소드는 TextArea 을(를) 한단계 나중에 표시되는 컴포넌트와 순서를 바꿉니다.
...
> Components > Component > TextArea > Method > clearEventHandler
...
```javascript
TextArea.clearEventHandler( strEventID )
```
...
> Components > Component > TextArea > Method > deleteText

**Description**

TextArea 의 입력값 중 특정위치에서 특정길이만큼 텍스트를 삭제하는 메소드입니다.

**Syntax**

```javascript
TextArea.deleteText( [nIndex [,nCnt]] )
```
...
- nIndex 값을 설정하지 않으면 "0"으로 적용됩니다.

- nCnt 값을 설정하지 않으면 "-1"로 적용됩니다.

- 삭제하려는 텍스트에 개행문자(Carriage Return, Line Feed)가 포함되어 있을 경우 개행문자도 각각 "1"로 계산하므로 주의하여야 합니다.
...
> Components > Component > TextArea > Method > destroy

**Description**

스크립트에서 동적으로 생성한 TextArea 을(를) 삭제하는 메소드입니다.
...
var bSucc = this.TextArea00.destroy();
...
- 동적으로 생성한 TextArea 을(를) 완전히 삭제하기 위해서는 destroy() 메소드를 호출해야 합니다.

**See Also**

Form.addChildForm.insertChildForm.removeChildTextArea.initTextArea.show
...
> Components > Component > TextArea > Method > find

**Description**

TextArea 의 value 속성값에서 특정 텍스트의 시작위치를 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.find( strText [,nIndex] )
```
...
- 개행문자(Carriage Return, Line Feed)도 각각 "1"로 계산하므로 시작위치 계산 시 주의하여야 합니다.
...
> Components > Component > TextArea > Method > findEventHandler

**Description**

TextArea 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.findEventHandler( strEventID, objFunc, objTarget )
```
...
> Components > Component > TextArea > Method > getCaretPos

**Description**

TextArea 에서 캐럿이 위치한 인덱스를 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.getCaretPos()
```
...
- TextArea 에 포커스가 있고 캐럿이 표시되고 있어야 합니다.
...
> Components > Component > TextArea > Method > getEventHandler

**Description**

TextArea 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.getEventHandler( strEventID, nIdx )
```
...
> Components > Component > TextArea > Method > getHScrollPos

**Description**

TextArea 에 표시된 수평스크롤바의 트랙바 위치값을 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.getHScrollPos()
```

**Parameters**

var nScrollPos = this.TextArea00.getHScrollPos();
...
TextArea.getVScrollPosTextArea.scrollbartype
...
> Components > Component > TextArea > Method > getLength

**Description**

TextArea 의 value 속성에 설정된 문자열의 길이를 반환하는 메소드입니다.
...
var nLength = this.TextArea00.getLength();
...
> Components > Component > TextArea > Method > getOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 TextArea 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.getOffsetBottom();
```

**Parameters**

var nBottom = this.TextArea.getOffsetBottom();
...
- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 TextArea 의 bottom 값을 동적으로 계산합니다.
...
> Components > Component > TextArea > Method > getOffsetHeight

**Description**

TextArea 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.getOffsetHeight();
```

**Parameters**

var nHeight = this.TextArea.getOffsetHeight();
...
- 화면에 표시된 TextArea 의 높이를 동적으로 계산합니다.
...
> Components > Component > TextArea > Method > getOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 TextArea 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.getOffsetLeft();
```

**Parameters**

var nleft = this.TextArea.getOffsetLeft();
...
- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 TextArea 의 left 값을 동적으로 계산합니다.
...
> Components > Component > TextArea > Method > getOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 TextArea 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.getOffsetRight();
```

**Parameters**

var nRight = this.TextArea.getOffsetRight();
...
- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 TextArea 의 right 값을 동적으로 계산합니다.
...
> Components > Component > TextArea > Method > getOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 TextArea 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.getOffsetTop();
```

**Parameters**

var nTop = this.TextArea.getOffsetTop();
...
- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 TextArea 의 top 값을 동적으로 계산합니다.
...
> Components > Component > TextArea > Method > getOffsetWidth

**Description**

TextArea 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.getOffsetWidth();
```

**Parameters**

var nWidth = this.TextArea.getOffsetWidth();
...
- 화면에 표시된 TextArea 의 너비를 동적으로 계산합니다.
...
> Components > Component > TextArea > Method > getPixelBottom

**Description**

TextArea 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.getPixelBottom();
```

**Parameters**

var nbottom = this.TextArea.getPixelBottom();
...
> Components > Component > TextArea > Method > getPixelHeight

**Description**

TextArea 의 height 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.getPixelHeight();
```

**Parameters**

var nheight = this.TextArea.getPixelHeight();
...
> Components > Component > TextArea > Method > getPixelLeft

**Description**

TextArea 의 left 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.getPixelLeft();
```

**Parameters**

var nleft = this.TextArea.getPixelLeft();
...
> Components > Component > TextArea > Method > getPixelRight

**Description**

TextArea 의 right 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.getPixelRight();
```

**Parameters**

var nright = this.TextArea.getPixelRight();
...
> Components > Component > TextArea > Method > getPixelTop

**Description**

TextArea 의 top 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.getPixelTop();
```

**Parameters**

var ntop = this.TextArea.getPixelTop();
...
> Components > Component > TextArea > Method > getPixelWidth

**Description**

TextArea 의 width 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.getPixelWidth();
```

**Parameters**

var nwidth = this.TextArea.getPixelWidth();
...
> Components > Component > TextArea > Method > getSelect

**Description**

TextArea 컴포넌트의 텍스트 편집 영역에서 선택한 텍스트의 시작 인덱스와 끝 인덱스를 배열 형태로 반환하는 메서드입니다.
...
var vArrSelect = this.TextArea00.getSelect();
...
- TextArea 컴포넌트의 텍스트 편집 영역에 포커스가 있고 캐럿이 표시된 상태에서만 정상적으로 값을 반환합니다.
...
> Components > Component > TextArea > Method > getSelectedText

**Description**

TextArea 컴포넌트의 텍스트 편집 영역에서 선택한 텍스트를 반환하는 메서드입니다.
...
var strText = this.TextArea00.getSelectedText();
...
> Components > Component > TextArea > Method > getVScrollPos

**Description**

TextArea 에 표시된 수직스크롤바의 트랙바 위치값을 반환하는 메소드입니다.

**Syntax**

```javascript
TextArea.getVScrollPos()
```

**Parameters**

var nScrollPos = this.TextArea00.getVScrollPos();
...
TextArea.getHScrollPosTextArea.scrollbartype
...
> Components > Component > TextArea > Method > init

**Description**

스크립트로 TextArea 을(를) 동적 생성한 후에 초기화하는 메소드입니다.
...
- 인수값에 기준 컴포넌트를 포함하면 TextArea 의 위치는 기준 컴포넌트를 기준으로 상대적으로 결정됩니다.
  vLeft, vTop, vWidth, vHeight, vRight, vBottom 값에 기준 컴포넌트를 포함할 때는 "ID:Value" 형태로 설정하여야 합니다.

- 기준 컴포넌트는 TextArea 와(과) 부모(Parent)가 동일하여야 하며, Form 로딩 시 TextArea 보다 먼저 생성되어야 합니다.
...
Form.addChildForm.insertChildForm.removeChildTextArea.destroyTextArea.show
...
> Components > Component > TextArea > Method > insertEventHandler

**Description**

TextArea 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다.

**Syntax**

```javascript
TextArea.insertEventHandler( strEventID, nIndex, objFunc, objTarget )
```
...
> Components > Component > TextArea > Method > insertText

**Description**

TextArea 의 특정 위치에 새로운 텍스트를 삽입하는 메소드입니다.

**Syntax**

```javascript
TextArea.insertText( strText [,nIndex] )
```
...
- nIndex 값을 설정하지 않으면 "-1"로 적용됩니다.

- 개행문자(Carriage Return, Line Feed)도 각각 "1"로 계산하므로 삽입위치 계산 시 주의하여야 합니다.
...
> Components > Component > TextArea > Method > move

**Description**

TextArea 의 위치와 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
TextArea.move( vLeft, vTop [, vWidth, vHeight [, vRight, vBottom]] )
```
...
> Components > Component > TextArea > Method > moveToNext

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 TextArea 이(가) 화면에 한단계 뒤에 표시되게 합니다.

**Syntax**

```javascript
TextArea.moveToNext( objComp )
TextArea.moveToNext( strComp )
```
...
- 인수로 전달되는 기준 컴포넌트와 TextArea 은(는) 부모가 동일하여야 합니다.

- 디자인 시 소스에 컴포넌트가 선언된 순서대로 화면에 표시됩니다.
  소스에서 위에 선언된 컴포넌트가 먼저 표시되고, 아래에 선언된 컴포넌트가 나중에 표시되게 됩니다.
  컴포넌트가 겹쳐져 있을 경우 화면에 표시되는 순서에 따라 먼저 표시된 컴포넌트가 나중에 표시되는 컴포넌트에 가려지게 됩니다.

- moveToNext() 메소드는 기준 컴포넌트보다 TextArea 이(가) 한단계 먼저 표시되게 순서를 바꿉니다.
...
> Components > Component > TextArea > Method > moveToPrev

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 TextArea 이(가) 화면에 한단계 앞에 표시되게 합니다.

**Syntax**

```javascript
TextArea.moveToPrev( objComp )
TextArea.moveToPrev( strComp )
```
...
- moveToPrev() 메소드는 기준 컴포넌트보다 TextArea 이(가) 한단계 나중에 표시되게 순서를 바꿉니다.
...
> Components > Component > TextArea > Method > removeEvent

**Description**

TextArea 에 선언된 특정 이벤트를 삭제하는 메소드입니다.

**Syntax**

```javascript
TextArea.removeEvent( strEventID )
```
...
- TextArea 에 특정 이벤트를 추가하려면 addEvent() 메소드를 사용하여야 합니다.

- TextArea 에 기본으로 선언되어 있는 이벤트 삭제 시 오동작 할 수 있으므로 주의하여야 합니다.
...
> Components > Component > TextArea > Method > removeEventHandler

**Description**

TextArea 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
TextArea.removeEventHandler( strEventID, objFunc, objTarget )
```
...
> Components > Component > TextArea > Method > removeEventHandlerLookup

**Description**

TextArea 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
TextArea.removeEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
> Components > Component > TextArea > Method > replace

**Description**

TextArea 의 value 속성값에서 특정 텍스트를 새로운 텍스트로 모두 치환하는 메소드입니다.

**Syntax**

```javascript
TextArea.replace( strOld [,strNew] )
```
...
> Components > Component > TextArea > Method > resize

**Description**

TextArea 의 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
TextArea.resize( vWidth, vHeight )
```
...
- TextArea 의 left 속성값이 null 이 아니면 resize() 메소드 실행 후 TextArea 의 우측 위치가 변경됩니다.
  또한, 메소드 실행 후 right 속성값은 null 이 됩니다.

- TextArea 의 left 속성값이 null 이면 resize() 메소드 실행 후 TextArea 의 좌측 위치가 변경됩니다.
  또한, 메소드 실행 후 left 속성값은 null 로 유지됩니다.

- TextArea 의 top 속성값이 null 이 아니면 resize() 메소드 실행 후 TextArea 의 하단 위치가 변경됩니다.
  또한, 메소드 실행 후 bottom 속성값은 null 이 됩니다.

- TextArea 의 top 속성값이 null 이면 resize() 메소드 실행 후 TextArea 의 상단 위치가 변경됩니다.
...
> Components > Component > TextArea > Method > scrollBy

**Description**

TextArea 에 표시된 스크롤을 현재 위치에서 인수로 전달된 값만큼 이동시키는 메소드입니다.

**Syntax**

```javascript
TextArea.scrollBy( nHoffsetpos, nVoffsetpos )
```
...
> Components > Component > TextArea > Method > scrollTo

**Description**

TextArea 에 표시된 스크롤을 특정 위치로 이동시키는 메소드입니다.

**Syntax**

```javascript
TextArea.scrollTo( nHpos, nVpos )
```
...
> Components > Component > TextArea > Method > sendToBack

**Description**

부모가 동일한 컴포넌트 중 TextArea 이(가) 화면의 제일 뒤에 표시되게 합니다.
...
- sendToBack() 메소드는 TextArea 을(를) 가장 먼저 표시되게 순서를 바꿉니다.
...
> Components > Component > TextArea > Method > sendToNext

**Description**

부모가 동일한 컴포넌트 중 TextArea 이(가) 화면에 한단계 뒤에 표시되게 합니다.
...
- sendToNext() 메소드는 TextArea 을(를) 한단계 먼저 표시되는 컴포넌트와 순서를 바꿉니다.
...
TextArea 에서 캐럿의 위치를 인덱스로 설정하는 메소드입니다.

**Syntax**

```javascript
TextArea.setCaretPos( [nIndex] )
```
...
- 개행문자(Carriage Return, Line Feed)도 각각 "1"로 계산하므로 위치계산 시 주의하여야 합니다.
...
> Components > Component > TextArea > Method > setEventHandler

**Description**

TextArea 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다.

**Syntax**

```javascript
TextArea.setEventHandler( strEventID, objFunc, objTarget )
```
...
> Components > Component > TextArea > Method > setEventHandlerLookup

**Description**

TextArea 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다.

**Syntax**

```javascript
TextArea.setEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
> Components > Component > TextArea > Method > setFocus

**Description**

TextArea 에 포커스를 설정하는 메서드입니다.

**Syntax**

```javascript
TextArea.setFocus( [bMoveScroll] )
```
...
> Components > Component > TextArea > Method > setOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 TextArea 의 bottom 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
TextArea.setOffsetBottom( nBottom );
```
...
- 메소드 실행 전 TextArea 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > TextArea 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > TextArea 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > TextArea 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 height, bottom 속성이 설정됩니다.
...
> Components > Component > TextArea > Method > setOffsetHeight

**Description**

TextArea 의 높이를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
TextArea.setOffsetHeight( nHeight );
```
...
> Components > Component > TextArea > Method > setOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 TextArea 의 left 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
TextArea.setOffsetLeft( nLeft );
```
...
- 메소드 실행 전 TextArea 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > TextArea 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > TextArea 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, right 속성이 설정됩니다.
   > TextArea 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
...
> Components > Component > TextArea > Method > setOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 TextArea 의 right 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
TextArea.setOffsetRight( nRight );
```
...
- 메소드 실행 전 TextArea 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > TextArea 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > TextArea 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > TextArea 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 width, right 속성이 설정됩니다.
...
> Components > Component > TextArea > Method > setOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 TextArea 의 top 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
TextArea.setOffsetTop( nTop );
```
...
- 메소드 실행 전 TextArea 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > TextArea 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > TextArea 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, bottom 속성이 설정됩니다.
   > TextArea 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
...
> Components > Component > TextArea > Method > setOffsetWidth

**Description**

TextArea 의 너비를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
TextArea.setOffsetWidth( nWidth );
```
...
> Components > Component > TextArea > Method > setSelect

**Description**

TextArea 에 포커스가 있을 때 인수로 지정된 영역을 선택하는 메소드입니다.

**Syntax**

```javascript
TextArea.setSelect( [nBegin [,nEnd]] )
```
...
- 개행문자(Carriage Return, Line Feed)도 각각 1 로 계산하므로 영역 계산 시 주의하여야 합니다.
...
- Mobile WRE 는 nBegin, nEnd 값에 따라 정상적으로 선택 되지 않을 수 있습니다.
...
> Components > Component > TextArea > Method > setSelectedText

**Description**

TextArea 에서 현재 선택되어 있는 텍스트를 전달된 인수값으로 변경하는 메소드입니다.

**Syntax**

```javascript
TextArea.setSelectedText( strText )
```
...
- TextArea 에 선택된 텍스트가 없으면 setSelectedText() 메소드는 동작하지 않습니다.
...
> Components > Component > TextArea > Method > show

**Description**

스크립트로 동적 생성한 TextArea 을(를) 화면에 표시하는 메소드입니다.
...
Form.addChildForm.insertChildForm.removeChildTextArea.destroyTextArea.init
...
> Components > Component > TextArea > Method > updateToDataset

**Description**

TextArea 의 value 속성값을 바인딩 되어 있는 DataSet 에 즉시 반영시키는 메소드입니다.

**Syntax**

```javascript
TextArea.updateToDataset()
```

**Parameters**

var bSucc = this.TextArea00.updateToDataset();
...
- TextArea 의 value 속성이 DataSet 에 바인딩 되어 있어야 합니다.

- TextArea 의 value 속성값이 바인딩 되어있는 Dataset 의 값과 같으면 Dataset 에 값이 반영되지 않고 "false"를 반환합니다.
...
> Components > Component > TextArea > Event > canchange

**Description**

TextArea 에서 value 속성값이 변경될 때 발생하는 이벤트입니다.

**Syntax**

```javascript
canchange(obj:nexacro.TextArea,e:nexacro.ChangeEventInfo);
```
...
- TextArea 에서 문자를 입력/삭제 후 포커스를 이동하면 value 속성값이 변경됩니다.
...
> Components > Component > TextArea > Event > onchanged

**Description**

TextArea 에서 value 속성값이 변경된 후 발생하는 이벤트입니다.

**Syntax**

```javascript
onchanged(obj:nexacro.TextArea,e:nexacro.ChangeEventInfo);
```
...
> Components > Component > TextArea > Event > oncontextmenu

**Description**

TextArea 영역에서 오른쪽 마우스 버튼을 클릭하거나 터치를 일정시간 유지할 때 발생하는 이벤트입니다.

**Syntax**

```javascript
oncontextmenu(obj:nexacro.TextArea,e:nexacro.ContextMenuEventInfo);
```
...
> Components > Component > TextArea > Event > ondevicebuttonup
...
```javascript
ondevicebuttonup(obj:nexacro.TextArea,e:nexacro.DeviceButtonEventInfo);
```
...
> Components > Component > TextArea > Event > ondrag

**Description**

TextArea 영역 내에서 마우스 왼쪽버튼으로 드래그를 수행했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondrag(obj:nexacro.TextArea,e:nexacro.DragEventInfo);
```
...
- TextArea 영역 내에서 마우스의 LButtonDown 후 LButtonUp 액션 없이 마우스 이동 시 ondrag 이벤트가 발생합니다.
...
> Components > Component > TextArea > Event > ondragenter

**Description**

TextArea 영역 내로 드래그 상태의 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragenter(obj:nexacro.TextArea,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 TextArea 영역으로 마우스 포인터가 들어올 때마다 이벤트가 발생합니다.
...
> Components > Component > TextArea > Event > ondragleave

**Description**

TextArea 영역 밖으로 드래그 상태의 마우스 포인터가 나갈 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragleave(obj:nexacro.TextArea,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 TextArea 영역에서 마우스 포인터가 나갈 때마다 이벤트가 발생합니다.
...
> Components > Component > TextArea > Event > ondragmove

**Description**

TextArea 영역 내에서 드래그 상태의 마우스 포인터가 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragmove(obj:nexacro.TextArea,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 TextArea 영역 내에서 마우스 포인터가 움직일 때마다 이벤트가 발생합니다.
...
> Components > Component > TextArea > Event > ondrop

**Description**

TextArea 영역 내에서 드래그 상태의 마우스 버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondrop(obj:nexacro.TextArea,e:nexacro.DragEventInfo);
```
...
- TextArea 영역 내에서 드래그 상태인 마우스의 LButtonUp 액션 발생 시 ondrop 이벤트가 발생합니다.
...
> Components > Component > TextArea > Event > oneditclick

**Description**

TextArea 컴포넌트의 텍스트 편집 영역에서 마우스 왼쪽 버튼을 클릭했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
oneditclick(obj:nexacro.TextArea,e:nexacro.EditClickEventInfo);
```
...
> Components > Component > TextArea > Event > onhscroll

**Description**

TextArea 의 수평 스크롤바를 스크롤 했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onhscroll(obj:nexacro.TextArea,e:nexacro.ScrollEventInfo);
```
...
> Components > Component > TextArea > Event > oninput

**Description**

TextArea 에서 입력을 시도할 때 발생하는 이벤트 입니다.

**Syntax**

```javascript
oninput(obj:nexacro.TextArea,e:nexacro.InputEventInfo);
```
...
> Components > Component > TextArea > Event > onkeydown

**Description**

TextArea 에 포커스가 있는 상태에서 키보드의 키가 눌렸을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkeydown(obj:nexacro.TextArea,e:nexacro.KeyEventInfo);
```
...
> Components > Component > TextArea > Event > onkeyup

**Description**

TextArea 에 포커스가 있는 상태에서 눌렸던 키보드가 떼어질 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkeyup(obj:nexacro.TextArea,e:nexacro.KeyEventInfo);
```
...
> Components > Component > TextArea > Event > onkillfocus

**Description**

TextArea 에서 포커스가 나갈  때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkillfocus(obj:nexacro.TextArea,e:nexacro.KillFocusEventInfo);
```
...
- showModal(), open() 등의 메소드로 팝업된 Frame 으로 포커스가 이동하는 경우 TextArea 에서 포커스 관련 이벤트가 발생하지 않습니다.
   또한, alert(), confirm() 메소드로 표시된 팝업으로 포커스가 이동하는 경우도 TextArea 에서 포커스 관련 이벤트가 발생하지 않습니다.
...
> Components > Component > TextArea > Event > onlbuttondown

**Description**

TextArea 영역 내에서 마우스 왼쪽버튼을 눌렀을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onlbuttondown(obj:nexacro.TextArea,e:nexacro.MouseEventInfo);
```
...
- TextArea 영역 내에서 마우스의 LButtonDown 액션이 발생하면 이벤트가 발생합니다.
...
> Components > Component > TextArea > Event > onlbuttonup

**Description**

TextArea 영역 내에서 눌렸던 마우스 왼쪽버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onlbuttonup(obj:nexacro.TextArea,e:nexacro.MouseEventInfo);
```
...
> Components > Component > TextArea > Event > onmouseenter

**Description**

TextArea 영역 내로 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmouseenter(obj:nexacro.TextArea,e:nexacro.MouseEventInfo);
```
...
> Components > Component > TextArea > Event > onmouseleave

**Description**

TextArea 영역 밖으로 마우스 포인터가 나갈 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmouseleave(obj:nexacro.TextArea,e:nexacro.MouseEventInfo);
```
...
> Components > Component > TextArea > Event > onmousemove

**Description**

TextArea 영역 내에서 마우스 포인터가 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmousemove(obj:nexacro.TextArea,e:nexacro.MouseEventInfo);
```
...
TextArea 영역 내에서 마우스의 휠버튼을 회전했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmousewheel(obj:nexacro.TextArea,e:nexacro.MouseWheelEventInfo);
```
...
- TextArea 에서 마우스의 휠버튼 회전값을 처리할 필요가 없을 때 상위 컴포넌트로 휠버튼 회전값과 이벤트가 전파됩니다.
   즉, TextArea 에서 스크롤이 이동될 때는 상위로 이벤트가 전파되지 않고, 스크롤이 처음이나 마지막 상태일 때 상위로 이벤트가 전파됩니다.
...
- Zoom 상태에서도 TextArea 에서 이벤트가 발생하고 리턴값에 따라 상위로 전파되므로 스크립트 작성 시 주의하여야 합니다.
   이 때, 스크롤은 처리되지 않으며 e.ctrlkey 속성값이 true 로 설정됩니다.

**Default Action**

- TextArea 컴포넌트에 스크롤바가 있다면 이벤트 발생 후 스크롤을 이동시킵니다.
...
> Components > Component > TextArea > Event > onmove

**Description**

TextArea 의 위치가 이동했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmove(obj:nexacro.TextArea,e:nexacro.MoveEventInfo);
```
...
> Components > Component > TextArea > Event > onrbuttondown

**Description**

TextArea 영역 내에서 마우스 오른쪽버튼을 눌렀을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onrbuttondown(obj:nexacro.TextArea,e:nexacro.MouseEventInfo);
```
...
> Components > Component > TextArea > Event > onrbuttonup

**Description**

TextArea 영역 내에서 마우스 오른쪽버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onrbuttonup(obj:nexacro.TextArea,e:nexacro.MouseEventInfo);
```
...
> Components > Component > TextArea > Event > onsetfocus

**Description**

TextArea 에 포커스가 들어올 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onsetfocus(obj:nexacro.TextArea,e:nexacro.SetFocusEventInfo);
```
...
- open() 메소드로 오픈된 Modeless 창에서 부모창의 TextArea 에 setFocus() 메소드 실행 시 환경에 따라 동작에 차이가 있으므로 주의하여야 합니다.
...
> Components > Component > TextArea > Event > onsize

**Description**

TextArea 의 크기가 변경됐을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onsize(obj:nexacro.TextArea,e:nexacro.SizeEventInfo);
```
...
> Components > Component > TextArea > Event > ontouchend

**Description**

TextArea 영역 내에서 터치를 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchend(obj:nexacro.TextArea,e:nexacro.TouchEventInfo);
```
...
> Components > Component > TextArea > Event > ontouchmove

**Description**

TextArea 영역 내에서 터치 상태를 유지하며 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchmove(obj:nexacro.TextArea,e:nexacro.TouchEventInfo);
```
...
> Components > Component > TextArea > Event > ontouchstart

**Description**

TextArea 영역 내에서 터치가 시작될 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchstart(obj:nexacro.TextArea,e:nexacro.TouchEventInfo);
```
...
> Components > Component > TextArea > Event > onvscroll

**Description**

TextArea 의 수직 스크롤바를 스크롤 했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onvscroll(obj:nexacro.TextArea,e:nexacro.ScrollEventInfo);
```
