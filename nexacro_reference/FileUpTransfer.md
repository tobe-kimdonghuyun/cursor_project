...
```javascript
this.FileUpTransfer00_onmove = function( obj:nexacro.FileUpTransfer,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.FileUpTransfer00.addEventHandler( "onmove", this.FileUpTransfer00_onmove, this);
```
...
```javascript
this.FileUpTransfer00_onmove = function( obj:nexacro.FileUpTransfer,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.FileUpTransfer00.addEventHandlerLookup( "onmove", "FileUpTransfer00_onmove", this);
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| strID | String | filelist 속성에 추가 할 파일정보의 ID 를 문자열로 설정합니다.
...
| Type | Description |
| --- | --- |
| Number | 파일정보 추가에 성공하면 추가된 위치의 인덱스를 반환합니다.
...
| Type | Description |
| --- | --- |
| Boolean | FileUpTransfer 이(가) 정상적으로 삭제되면 true 를 반환합니다.
...
| Type | Description |
| --- | --- |
| Boolean | 인수로 전달된 VirtualFile 오브젝트와 일치하는 파일정보가 filelist 속성에 존재하면 true 를 반환합니다.
...
var nIndex = this.FileUpTransfer00.findEventHandler( "onmove", this.FileUpTransfer00_onmove, this );
```
...
| Type | Description |
| --- | --- |
| Array | filelist 속성에서 지정한 파일명과 일치하는 파일정보를 VirtualFile 오브젝트 배열로 반환합니다.
...
| Type | Description |
| --- | --- |
| Object | filelist 속성에서 지정한 파일명과 일치하는 파일정보의 인덱스를 배열로 반환합니다.
...
var nIndex = this.FileUpTransfer00.insertEventHandler( "onmove", 0, this.FileUpTransfer00_onmove, this);
```
...
```javascript
this.FileUpTransfer00_onmove = function( obj:nexacro.FileUpTransfer,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.FileUpTransfer00.removeEventHandler( "onmove", this.FileUpTransfer00_onmove, this);
```
...
```javascript
this.FileUpTransfer00_onmove = function( obj:nexacro.FileUpTransfer,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.FileUpTransfer00.removeEventHandlerLookup( "onmove", "FileUpTransfer00_onmove", this);
```
...
| Type | Description |
| --- | --- |
| Number | filelist 속성에서 제거된 파일정보의 인덱스를 반환합니다.
...
| Parameters | Type | Description |
| --- | --- | --- |
| nIndex | Number | filelist 속성에서 제거할 파일정보의 인덱스를 숫자로 설정합니다.
...
```javascript
this.FileUpTransfer00_onmove = function( obj:nexacro.FileUpTransfer,  e:nexacro.MoveEventInfo ) { //수행할 스크립트 };
var nIndex = this.FileUpTransfer00.setEventHandler( "onmove", this.FileUpTransfer00_onmove, this );
```
...
```javascript
this.FileUpTransfer00_onmove = function( obj:nexacro.FileUpTransfer,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.FileUpTransfer00.setEventHandlerLookup( "onmove", "FileUpTransfer00_onmove", this);
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nIndex | Number | filelist 속성에서 변경할 파일정보의 인덱스를 숫자로 설정합니다.
...
| Type | Description |
| --- | --- |
| Boolean | 인수로 전달된 인덱스의 파일정보 변경에 성공하면 true 를 반환합니다.
