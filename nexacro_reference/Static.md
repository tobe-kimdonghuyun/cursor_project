...
| --- | --- | --- |
| 포커스 이동 | Tab | WRE 실행 시 다음 조건이 만족하는 경우 Tab키 입력 시 Static 컴포넌트 내 링크 텍스트 영역으로 포커스가 이동합니다.
- usedecorate 속성값 true
- 링크(link) 타입으로 설정한 텍스트

링크 텍스트 영역이 여러 개인 경우에는 순서대로 이동하고 마지막 링크 텍스트 영역에서 Tab키 입력 시 Tab 이동 순서에 따라 다음 컴포넌트로 포커스가 이동합니다. |
...
| Name | Description |
| --- | --- |
| accessibilityaction | Static에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다. |
| accessibilitydesclevel | Static 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| accessibilitydescription | Static에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다. |
| accessibilityenable | Static 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| accessibilitylabel | Static에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다. |
| accessibilityrole | Static에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다. |
| background | Static 의 배경 영역을 설정하는 속성입니다. |
| border-radius | Static 의 모서리 모양을 설정하는 속성입니다. |
| bottom | Static 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다. |
| box-shadow | Static 에 그림자 효과를 설정하는 속성입니다. |
| color | Static 에 표시되는 텍스트의 색상을 설정하는 속성입니다. |
| cssclass | Static 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다. |
| cursor | Static 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다. |
| enable | Static 의 사용가능 여부를 설정하는 속성입니다. |
| enableevent | Static 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다. |
| expr | Static 에 표시될 텍스트를 동적으로 생성하는 수식을 설정하는 속성입니다. |
| fittocontents | Static 의 내부 컨텐츠영역이 컨텐츠 내용에 맞게 자동조정되는 영역을 설정하는 속성입니다. |
...
| font | Static 에서 사용하는 폰트를 설정하는 속성입니다. |
| height | Static 을(를) 표시하기 위한 높이를 설정하는 속성입니다. |
| hotkey | Static 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다. |
| id | Static의 고유 식별자를 설정하는 속성입니다. |
| initvalueid | Static 에 적용될 InitValue 의 ID 를 설정하는 속성입니다. |
| layoutorder | Layout 컨테이너 내 Main Axis(type 속성값이 "horizontal"이면 수평축, type 속성값이 "vertical"이면 수직축)에 컴포넌트가 배치되는 순서를 설정합니다. |
| left | Static 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다. |
| letter-spacing | Static 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다. |
| maxheight | Static 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다. |
| maxwidth | Static 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다. |
| minheight | Static 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다. |
| minwidth | Static 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다. |
| name | Static 의 이름을 설정하는 속성입니다. |
| -nexa-border | Static 의 테두리를 설정하는 속성입니다. |
| -nexa-edge | Static 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-padding | Static 영역의 안쪽 여백을 설정하는 속성입니다. |
| -nexa-rtl-background-image | Static 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다. |
| -nexa-rtl-edge-image | Static 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-text-align | Static 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다. |
| -nexa-text-decoration | Static 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다. |
| -nexa-vertical-align | Static 에 표시되는 텍스트 또는 컨텐츠의 세로 정렬 방식을 설정하는 속성입니다. |
| -nexa-word-wrap | Static 에 표시되는 텍스트가 출력영역보다 길 경우 자동으로 줄바꿈 되도록 설정하는 속성입니다. |
| opacity | Static 영역의 투명도를 설정하는 속성입니다. |
| parent | Static 의 부모 오브젝트를 갖는 읽기전용 속성입니다. |
| positionstep | 부모 오브젝트가 화면분할기능을 사용할 때 Static 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다. |
| right | Static 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다. |
| rtl | Static 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다. |
| tablecellarea | Layout 컨테이너 내 가상의 Table Cell 영역 내에서 컴포넌트가 배치되는 영역을 설정합니다. |
| taborder | 접근성 기능이 활성화 되어 있을 때 Static 의 포커스 이동 순서를 설정하는 속성입니다. |
| text | Static 에 표시될 텍스트를 설정하는 속성입니다. |
| tooltiptext | Static 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다. |
| tooltiptype | Static 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다. |
| top | Static 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다. |
| usedecorate | Static에 표시되는 텍스트에 Decorate 효과를 적용할 지 설정하는 속성입니다. |
| visible | Static 이(가) 화면에 표시될지 여부를 설정하는 속성입니다. |
| width | Static 을(를) 표시하기 위한 너비를 설정하는 속성입니다. |
| word-spacing | Static 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다. |

**Method**

| Name | Description |
| --- | --- |
| addEvent | Static 에 특정 이벤트를 선언하여 추가하는 메소드입니다. |
| addEventHandler | Static 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다. |
| addEventHandlerLookup | 함수를 검색하여 Static 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다. |
| bringToFront | 부모가 동일한 컴포넌트 중 Static 이(가) 화면의 제일 앞에 표시되게 합니다. |
| bringToPrev | 부모가 동일한 컴포넌트 중 Static 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| clearEventHandler | 특정 이벤트에 등록된 핸들러 함수를 모두 제거하는 메소드입니다. |
| destroy | 스크립트에서 동적으로 생성한 Static 을(를) 삭제하는 메소드입니다. |
| findEventHandler | Static 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다. |
| getDisplayText | Static 에 표시된 텍스트값을 반환하는 메소드입니다. |
| getEventHandler | Static 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다. |
| getOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 Static 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetHeight | Static 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 Static 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 Static 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 Static 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetWidth | Static 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getPixelBottom | Static 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelHeight | Static 의 height 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelLeft | Static 의 left 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelRight | Static 의 right 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelTop | Static 의 top 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelWidth | Static 의 width 속성값을 픽셀단위로 반환하는 메소드입니다. |
| init | 스크립트로 Static 을(를) 동적 생성한 후에 초기화하는 메소드입니다. |
| insertEventHandler | Static 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다. |
| move | Static 의 위치와 크기를 변경하는 메소드입니다. |
| moveToNext | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Static 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| moveToPrev | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Static 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| removeEvent | Static 에 선언된 특정 이벤트를 삭제하는 메소드입니다. |
| removeEventHandler | Static 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다. |
| removeEventHandlerLookup | Static 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다. |
| resize | Static 의 크기를 변경하는 메소드입니다. |
| sendToBack | 부모가 동일한 컴포넌트 중 Static 이(가) 화면의 제일 뒤에 표시되게 합니다. |
| sendToNext | 부모가 동일한 컴포넌트 중 Static 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| setEventHandler | Static 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다. |
| setEventHandlerLookup | Static 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다. |
| setOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 Static 의 bottom 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetHeight | Static 의 높이를 픽셀단위로 설정하는 메소드입니다. |
| setOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 Static 의 left 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 Static 의 right 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 Static 의 top 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetWidth | Static 의 너비를 픽셀단위로 설정하는 메소드입니다. |
| show | 스크립트로 동적 생성한 Static 을(를) 화면에 표시하는 메소드입니다. |
...
> Components > Component > Static > Property > -nexa-border

**Description**

Static 의 테두리를 설정하는 속성입니다.

**Syntax**

```javascript
Static.border[= strborder]
```
...
this.Static00.border = "1px solid #999999";
this.Static00.border = "1px solid #999999, 1px solid #999999, 1px solid #999999, 1px solid #999999";
```
...
> Components > Component > Static > Property > -nexa-edge

**Description**

Static 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.
...
* Script ( normal property )
this.Static00.edge = "URL('./images/border.png')" 5px 5px;
```
...
- Static 내부에 테두리 형태로 이미지를 표시하고자 할 때 사용하는 속성입니다.
...
> Components > Component > Static > Property > -nexa-padding

**Description**

Static 영역의 안쪽 여백을 설정하는 속성입니다.

**Syntax**

```javascript
Static.padding[= strpadding]
```
...
* Script ( normal property )
this.Static00.padding = "5px 5px 5px 5px";
```
- **`<npadding>`** — Static 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
- -nexa-padding 속성은 내부 컨텐츠영역과 Static 사이의 여백으로 적용됩니다.
...
> Components > Component > Static > Property > -nexa-rtl-background-image

**Description**

Static 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
Static.-nexa-rtl-background-image
```
...
> Components > Component > Static > Property > -nexa-rtl-edge-image

**Description**

Static 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
Static.-nexa-rtl-edge-image
```
...
> Components > Component > Static > Property > -nexa-text-align

**Description**

Static 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
Static.textAlign[= strtextalign]
```
...
* Script ( normal property )
this.Static00.textAlign = "center";
```
...
- Static 의 너비보다 표시되는 텍스트의 길이가 크면 "right" 를 설정해도 "left" 로 동작됩니다.
...
> Components > Component > Static > Property > -nexa-text-decoration

**Description**

Static 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다.

**Syntax**

```javascript
Static.textDecoration[= strTxtDeco]
```
...
* Script ( normal property )
this.Static00.textDecoration = "underline overline";
```
...
> Components > Component > Static > Property > -nexa-vertical-align

**Description**

Static 에 표시되는 텍스트 또는 컨텐츠의 세로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
Static.verticalAlign[= strvertalign]
```
...
* Script ( normal property )
this.Static00.verticalAlign = "middle";
```
...
> Components > Component > Static > Property > -nexa-word-wrap

**Description**

Static 에 표시되는 텍스트가 출력영역보다 길 경우 자동으로 줄바꿈 되도록 설정하는 속성입니다.

**Syntax**

```javascript
Static.wordWrap[= strwordwrap]
```
...
> Components > Component > Static > Property > accessibilityaction

**Description**

Static에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Static.accessibilityaction[= strAction]
```

**Setting Syntax**

```javascript
this.Static00.accessibilityaction = "Accessibility Action Message"; 
this.Static00.accessibilityaction = "Select by direction key";
```
...
> Components > Component > Static > Property > accessibilitydesclevel

**Description**

Static 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
Static.accessibilitydesclevel[= enumLevel]
```
...
```
```javascript
this.Static00.accessibilitydesclevel = "all";
```
- **`"all"`** — Static 와 자식 컴포넌트에 대한 접근성을 모두 출력합니다.
- **`"self"`** — Static 의 접근성만 출력하고 자식 컴포넌트의 접근성은 출력하지 않습니다.
- **`"child"`** — Static 의 접근성은 출력하지 않고, 자식 컴포넌트의 접근성은 출력합니다.
- **`"none"`** — Static 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
...
- accessibilitydesclevel 속성은 선택상자의 이동에 영향을 주지 않으므로 방향키로 선택상자가 Static 에 이동되게 하지 않으려면 accessibilityenable 속성을 설정하여야 합니다.
...
> Components > Component > Static > Property > accessibilitydescription

**Description**

Static에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Static.accessibilitydescription[= strDescription]
```

**Setting Syntax**

```javascript
this.Static00.accessibilitydescription = "Option";
```
...
> Components > Component > Static > Property > accessibilityenable

**Description**

Static 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
Static.accessibilityenable[= bEnable]
```
...
```
```javascript
this.Static00.accessibilityenable = false;
```
- **`true`** — Static 에 선택상자가 이동되면 접근성 관련 속성값을 출력합니다.

방향키 또는 제스처로 선택상자 이동 시 Static 과 같이 포커스를 갖지 않는 컴포넌트에도 선택상자가 이동됩니다.
- **`false`** — Static 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.

데스크탑 환경에서 방향키로 선택상자가 Static 에 이동되지 않습니다.
모바일 환경에서 제스처로 선택상자가 Static 에 이동되지 않습니다.
...
- 선택상자 이동 시 컴포넌트의 ARIA-LABEL + Status + Role 순서로 정보가 조합되어 접근성으로 출력됩니다.
   ...
   > Status : Static 의 현재 상태가 반영됩니다.
   > Role : accessibilityrole 속성값이 반영됩니다. accessibilityrole 속성값을 설정하지 않으면 Static 의 고유 Role 이 반영됩니다.

- accessibilityenable 속성값이 false 일 때 데스크탑 환경에서 방향키 외의 방법으로 선택상자를 Static 로 이동시키면 스크린 리딩 프로그램에서 임의의 값을 출력할 수 있습니다.
...
> Components > Component > Static > Property > accessibilitylabel

**Description**

Static에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Static.accessibilitylabel[= strLabel]
```

**Setting Syntax**

```javascript
this.Static00.accessibilitylabel = "OK Button"; 
this.Static00.accessibilitylabel = "[@static00]"; 
this.Static00.accessibilitylabel = "[@static00][@static01]"; 
this.Static00.accessibilitylabel = "[@static00][@static01] OK Button";
```
...
> Components > Component > Static > Property > accessibilityrole

**Description**

Static에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Static.accessibilityrole[= enumRole]
```
...
```
```javascript
this.Static00.accessibilityrole = "none"; 
this.Static00.accessibilityrole = "button";
```
...
- accessibilityenable 속성값을 설정하지 않으면 Static의 기본 Role 로 적용됩니다.

- 추가적인 속성값이 필요한 Role 설정 시 Static에 해당 속성이 없으면 스크린 리더에 따라 정상적으로 정보를 읽지 못할 수 있습니다.
...
> Components > Component > Static > Property > background

**Description**

Static 의 배경 영역을 설정하는 속성입니다.

**Syntax**

```javascript
Static.background[= strbackground]
```
...
* Script ( normal property )
this.Static00.background = "#ffffaa";
this.Static00.background = ""URL('./images/smiley.gif')" no-repeat center center #ffffaa";
this.Static00.background = ""URL('./images/smiley.gif')" no-repeat center center /auto #ffffaa";
this.Static00.background = ""URL('./images/smiley.gif')" no-repeat center center /15px 15% #ffffaa";
this.Static00.background = "linear-gradient( red , blue , yellow )";
this.Static00.background = "linear-gradient( #FF0000 , rgb(0,0,255) , rgb(255,255,0))";
this.Static00.background = ""URL('./images/smiley.gif')" border-box border-box #ffffaa";
```
...
"left" 설정 시 Static 의 왼쪽면과 이미지의 왼쪽면이 정렬되어 표시됩니다.
"center" 설정 시 Static 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"right" 설정 시 Static 의 오른쪽면과 이미지의 오른쪽면이 정렬되어 표시됩니다.
...
"top" 설정 시 Static 의 윗쪽면과 이미지의 윗쪽면이 정렬되어 표시됩니다.
"center" 설정 시 Static 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"bottom" 설정 시 Static 의 아랫쪽면과 이미지의 아랫쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
0 보다 작거나 100 보다 큰 값을 설정 시 Static 의 영역을 벗어난 가상의 위치로 적용됩니다.
...
예를 들어 <angle> 값이 "to left" 이면 Static 의 right 위치가 시작점이 되고, left 위치가 끝점이 됩니다.
              <angle> 값이 "to right" 이면 Static 의 left 위치가 시작점이 되고, right 위치가 끝점이 됩니다.
...
<bg-image> 에 적용된 이미지에 투명으로 적용된 부분이 있거나 이미지가 Static 영역보다 작다면 해당 영역에 배경색이 표시됩니다.
...
> Components > Component > Static > Property > border-radius

**Description**

Static 의 모서리 모양을 설정하는 속성입니다.

**Syntax**

```javascript
Static.borderRadius[= strborderradius]
```
...
* Script ( normal property )
this.Static00.borderRadius = "10px";
this.Static00.borderRadius = "5px 6px 10px / 5px 10px";
```
...
> Components > Component > Static > Property > bottom

**Description**

Static 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
Static.bottom[= nBottom]
```
...
```
```javascript
this.Static00.bottom = 10; 
this.Static00.bottom = "10px"; 
this.Static00.bottom = "10%"; 
this.Static00.bottom = "Button00:10px"; 
this.Static00.bottom = "Button00:10%";
```
- **`<strCompID>`** — Static 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 Static 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 Static 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Static 의 하단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 bottom 속성값을 기준으로 Static의 하단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 Static의 하단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Static의 하단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Static의 하단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 top 속성값을 기준으로 Static의 하단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 Static의 하단 위치 결정
...
> Components > Component > Static > Property > box-shadow

**Description**

Static 에 그림자 효과를 설정하는 속성입니다.

**Syntax**

```javascript
Static.boxShadow[= strbshadow]
```
...
* Script ( normal property )
this.Static00.boxShadow  = "10px 10px 10px #888888";
this.Static00.boxShadow  = "inset 10px 10px 10px 5px #888888";
```
...
Static 의 좌상단 위치를 기준으로 그림자 효과가 표시될 위치를 가로/세로 픽셀값으로 설정합니다.
...
> Components > Component > Static > Property > color

**Description**

Static 에 표시되는 텍스트의 색상을 설정하는 속성입니다.
...
* Script ( normal property )
this.Static00.color = "#999999";
this.Static00.color = "rgb(255,0,0)";
this.Static00.color = "red";
```
- **`<NamedColor>`** — "red","blue" 와 같이 미리 정의된 색상이름을 문자열로 설정합니다.
- **`<NumericColor>`** — 표시할 색의 색상코드입니다.
...
> Components > Component > Static > Property > cssclass

**Description**

Static 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다.

**Syntax**

```javascript
Static.cssclass[= strcssclass]
```
...
```
```javascript
this.Static00.cssclass = "TestClass"; 
this.Static00.cssclass = "TestClass,TestClass2";
```
...
> Components > Component > Static > Property > cursor

**Description**

Static 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
Static.cursor[= strCursor]
```
...
> Components > Component > Static > Property > enable

**Description**

Static 의 사용가능 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Static.enable[= benable]
```
...
```
```javascript
this.Static00.enable = true; 
this.Static00.enable = false;
```
- **`true`** — Static 을(를) 사용할 수 있게 설정합니다.
- **`false`** — Static 을(를) 사용할 수 없게 설정합니다.
...
> Components > Component > Static > Property > enableevent

**Description**

Static 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Static.enableevent[= bEvent]
```
...
```
```javascript
this.Static00.enableevent = true;  
this.Static00.enableevent = false;
```
- **`true`** — Static 에서 이벤트가 발생하도록 설정합니다.
- **`false`** — Static 에서 이벤트가 발생하지 않도록 설정합니다.
...
> Components > Component > Static > Property > expr

**Description**

Static 에 표시될 텍스트를 동적으로 생성하는 수식을 설정하는 속성입니다.
...
```javascript
this.Static00.expr = "3*5";this.Static00.expr = "image.text";
```
- **`strExpr`** — 텍스트로 적용될 수식을 설정합니다.
접근 가능한 영역에 정의된 함수를 설정할 수 있습니다.

설정된 수식을 동적으로 실행하여 그 결과값을 Static 에 텍스트로 표시합니다.

**Remark**

- 동적으로 Static 에 적용된 텍스트는 getDisplayText() 메서드를 사용하여 확인할 수 있습니다.
...
> Components > Component > Static > Property > fittocontents

**Description**

Static 의 내부 컨텐츠영역이 컨텐츠 내용에 맞게 자동조정되는 영역을 설정하는 속성입니다.

**Syntax**

```javascript
Static.fittocontents[= enumFitTo]
```
...
```
```javascript
this.Static00.fittocontents = "width";
```
- **`"none"`** — 컨텐츠 내용과 관계없이 디자인 시 설정한 Static 의 너비와 높이를 유지합니다.
- **`"width"`** — 컨텐츠 내용에 맞게 Static 의 내부 컨텐츠영역 너비를 자동 조정합니다.
- **`"height"`** — 컨텐츠 내용에 맞게 Static 의 내부 컨텐츠영역 높이를 자동 조정합니다.
- **`"both"`** — 컨텐츠 내용에 맞게 Static 의 내부 컨텐츠영역 너비와 높이를 자동 조정합니다.

**Remark**

- fittocontents 속성값을 설정하지 않으면 "none" 으로 적용됩니다.

- Static 의 전체 크기는 내부 컨텐츠영역 크기에 -nexa-border, -nexa-padding 영역을 더해서 결정됩니다.

- Form 이 로딩될 때와 fittocontents 속성값이 변경되었을 때만 내부 컨텐츠영역의 크기가 자동 조정됩니다.
   Bind 된 속성이나 스크립트에 의해 Static 의 컨텐츠가 변경된 경우는 내부 컨텐츠영역의 크기가 자동 조정되지 않습니다.

- Bind 된 속성에 의해 Static 의 컨텐츠가 변경되어 내부 컨텐츠영역의 크기가 다시 조정되어야 할 때는
   Form 의 onbindingvaluechanged 이벤트에서 resetScroll() 메소드를 실행하여 크기를 재조정 하여야 합니다.

- 스크립트에 의해 Static 의 컨텐츠가 변경되어 내부 컨텐츠영역의 크기가 다시 조정되어야 할 때는
...
> Components > Component > Static > Property > flexgrow
...
> Components > Component > Static > Property > flexshrink
...
> Components > Component > Static > Property > font

**Description**

Static 에서 사용하는 폰트를 설정하는 속성입니다.
...
* Script ( normal property )
this.Static00.font = "bold 12pt/30px arial, sans-serif";
```
...
> Components > Component > Static > Property > height

**Description**

Static 을(를) 표시하기 위한 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Static.height[= nHeight]
```
...
```
```javascript
this.Static00.height = 10; 
this.Static00.height = "10px"; 
this.Static00.height = 10%"; 
this.Static00.height = Button00:10%";
```
- **`<strCompID>`** — Static 의 높이를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 Static 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 Static 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 높이가 적용됩니다.
- **`<nVal>`** — Static 의 높이를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.


* <strCompID> 값을 생략했을 때 :
- "px": Static의 높이 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 Static의 높이 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Static의 높이 결정
- "rem": MainFrame font-size 속성값을 기준으로 Static의 높이 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 Static의 높이 결정
- "%": <strCompID>의 height 속성값을 기준으로 Static의 높이 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Static > Property > hotkey

**Description**

Static 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다.

**Syntax**

```javascript
Static.hotkey[= strHotkey]
```

**Setting Syntax**

```javascript
this.Static00.hotkey = "G"; 
this.Static00.hotkey = "CTRL+A"; 
this.Static00.hotkey = "CTRL+ALT+X";
```
...
> Components > Component > Static > Property > id

**Description**

Static의 고유 식별자를 설정하는 속성입니다.
...
> Components > Component > Static > Property > initvalueid

**Description**

Static 에 적용될 InitValue 의 ID 를 설정하는 속성입니다.

**Syntax**

```javascript
Static.initvalueid[= strValueID]
```

**Setting Syntax**

- **`strValueID`** — InitValueDefinition 영역에 정의된 InitValue 파일에서 Static 에 적용할 항목의 ID 를 문자열로 설정합니다.

**Remark**

- Static 가 화면에 표시된 후에는 속성값을 설정하거나 변경 할 수 없습니다.
   Static 를 동적으로 생성 시 show() 메소드 실행 전에 속성값을 설정하여야 합니다.
...
> Components > Component > Static > Property > layoutorder
...
> Components > Component > Static > Property > left

**Description**

Static 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.Static00.left = 10; 
this.Static00.left = "10px"; 
this.Static00.left = "10%"; 
this.Static00.left = "Button00:10px"; 
this.Static00.left = "Button00:10%";
```
- **`<strCompID>`** — Static 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Static 의 좌측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 left 속성값을 기준으로 Static의 좌측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Static의 좌측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Static의 좌측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Static의 좌측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 right 속성값을 기준으로 Static의 좌측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 Static의 좌측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Static > Property > letter-spacing

**Description**

Static 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다.

**Syntax**

```javascript
Static.letterSpacing[= strspace]
```
...
* Script ( normal property )
this.Static00.letterSpacing = "2px";
```
...
> Components > Component > Static > Property > maxheight

**Description**

Static 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Static.maxheight[= nMaxHeight]
```
...
```
```javascript
this.Static00.maxheight = 20; 
this.Static00.maxheight = "20px";
```
- **`<nVal>`** — Static 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 maxheight 보다 크면 화면에 표시되는 Static 의 높이는 maxheight 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 Static 의 높이가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > Static > Property > maxwidth

**Description**

Static 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다.

**Syntax**

```javascript
Static.maxwidth[= nMaxWidth]
```
...
```
```javascript
this.Static00.maxwidth = 20; 
this.Static00.maxwidth = "20px";
```
- **`<nVal>`** — Static 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 maxwidth 보다 크면 화면에 표시되는 Static 의 너비는 maxwidth 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 Static 의 너비가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > Static > Property > minheight

**Description**

Static 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Static.minheight[= nMinHeight]
```
...
```
```javascript
this.Static00.minheight = 20; 
this.Static00.minheight = "20px";
```
- **`<nVal>`** — Static 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 minheight 보다 작다면 화면에 표시되는 Static 의 높이는 minheight 속성값으로 적용됩니다.
  표시되는 높이만 적용되고 height 속성값은 변경되지 않습니다.
...
> Components > Component > Static > Property > minwidth

**Description**

Static 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다.

**Syntax**

```javascript
Static.minwidth[= nMinWidth]
```
...
```
```javascript
this.Static00.minwidth = 20; 
this.Static00.minwidth = "20px";
```
- **`<nVal>`** — Static 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 minwidth 보다 작으면 화면에 표시되는 Static 의 너비는 minwidth 속성값으로 적용됩니다.
  표시되는 너비만 적용되고 width 속성값은 변경되지 않습니다.
...
> Components > Component > Static > Property > name

**Description**

Static 의 이름을 설정하는 속성입니다.
...
> Components > Component > Static > Property > opacity

**Description**

Static 영역의 투명도를 설정하는 속성입니다.

**Syntax**

```javascript
Static.opacity[= stropacity]
```
...
* Script ( normal property )
this.Static00.opacity = "0.8";
this.Static00.opacity = 0.8;
this.Static00.opacity = "80%";
```
...
> Components > Component > Static > Property > parent

**Description**

Static 의 부모 오브젝트를 갖는 읽기전용 속성입니다.
...
```javascript
var objParent = this.Static00.parent;
```
...
- Static 이(가) Div 와 같은 컨테이너 컴포넌트에 자식으로 존재한다면 parent 속성은 해당 컨테이너 컴포넌트를 갖습니다.
...
> Components > Component > Static > Property > positionstep

**Description**

부모 오브젝트가 화면분할기능을 사용할 때 Static 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다.

**Syntax**

```javascript
Static.positionstep[= nStep]
```

**Setting Syntax**

```javascript
this.Static00.positionstep = 0; 
this.Static00.positionstep = -1;
```
- **`nStep`** — Static 이(가) 표시될 분할화면의 인덱스를 설정합니다.
"-1" 로 설정하면 모든 분할화면에 Static 이(가) 표시됩니다.
...
> Components > Component > Static > Property > right

**Description**

Static 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.Static00.right = 10; 
this.Static00.right = "10px"; 
this.Static00.right = "10%"; 
this.Static00.right = "Button00:10px"; 
this.Static00.right = "Button00:10%";
```
- **`<strCompID>`** — Static 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Static 의 우측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 right 속성값을 기준으로 Static의 우측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Static의 우측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Static의 우측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Static의 우측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 left 속성값을 기준으로 Static의 우측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 Static의 우측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Static > Property > rtl

**Description**

Static 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다.
...
```
```javascript
var vRtl = this.Static00.rtl;
```
- **`undefined`** — undefined 설정 시 상위 컴포넌트의 rtl 속성값이 적용됩니다.

사용자가 rtl 속성값을 설정하지 않거나 삭제했을 경우 undefined 가 설정됩니다.
- **`true`** — Static 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 오른쪽으로 설정합니다.
Static 의 내부 좌표계의 기준을 오른쪽으로 설정합니다.
Static 의 텍스트 표시 기준을 오른쪽으로 설정합니다.
수직스크롤바가 있을 경우 왼쪽에 표시됩니다.
- **`false`** — Static 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
Static 의 내부 좌표계의 기준을 왼쪽으로 설정합니다.
Static 의 텍스트 표시 기준을 왼쪽으로 설정합니다.
...
- Static 부터 Environment 까지 상위의 모든 rtl 속성값이 undefined 이면
...
> Components > Component > Static > Property > tablecellarea
...
> Components > Component > Static > Property > taborder

**Description**

접근성 기능이 활성화 되어 있을 때 Static 의 포커스 이동 순서를 설정하는 속성입니다.

**Syntax**

```javascript
Static.taborder[= nTabOrder]
```
...
> Components > Component > Static > Property > text

**Description**

Static 에 표시될 텍스트를 설정하는 속성입니다.
...
```javascript
this.Static00.text = "No :";
```
- **`strText`** — Static 에 표시될 텍스트를 설정합니다.

**Remark**

- usedecorate 속성값을 "true"로 설정하면 Decorate String 을 사용할 수 있습니다.

- Decorate String은 "Static > Property > usedecorate" 항목을 참고하세요.
...
> Components > Component > Static > Property > tooltiptext

**Description**

Static 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다.

**Syntax**

```javascript
Static.tooltiptext[= strToolTipText]
```

**Setting Syntax**

```javascript
this.Static00.tooltiptext = "This is ToolTip Text"; this.Static00.tooltiptext = "";          // 풍선 도움말이 표시되지 않습니다. 
this.Static00.tooltiptext = null;        // 상위 컴포넌트의 풍선 도움말이 표시됩니다.
```
...
- 마우스 포인터가 Static 영역 위에서 일정시간 움직이지 않으면 풍선도움말이 표시됩니다.
...
> Components > Component > Static > Property > tooltiptype

**Description**

Static 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다.

**Syntax**

```javascript
Static.tooltiptype[= enumTooltipType]
```
...
```
```javascript
this.Static00.tooltiptype = "hover";
```
- **`"default"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Static 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"hover"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Static 영역내에 멈춰서 일정시간이 경과하면 풍선도움말이 사라집니다.
Static 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경되거나 사라진 풍선도움말이 다시 표시됩니다.
- **`"inplace"`** — Static 의 좌측상단 안쪽에 풍선도움말을 표시합니다.

마우스 포인터가 Static 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"default,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Static 영역에 있으면 풍선도움말이 사라지지 않습니다.
- **`"hover,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Static 영역에 있으면 풍선도움말이 사라지지 않습니다.
Static 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경됩니다.
- **`"inplace,mouseleave"`** — Static 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
- 표시되었다가 사라진 풍선도움말은 마우스 포인터가 Static 영역을 나갔다가 들어오면 다시 표시됩니다.

- 마우스 포인터가 Static 영역에서 벗어나면 풍선도움말이 사라집니다.
...
> Components > Component > Static > Property > top

**Description**

Static 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.Static00.top = 10; 
this.Static00.top = "10px"; 
this.Static00.top = "10%"; 
this.Static00.top = "Button00:10px"; 
this.Static00.top = "Button00:10%";
```
- **`<strCompID>`** — Static 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Static의 상단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 top 속성값을 기준으로 Static의 상단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 Static의 상단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Static의 상단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Static의 상단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 bottom 속성값을 기준으로 Static의 상단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 Static의 상단 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
Static에 표시되는 텍스트에 Decorate 효과를 적용할 지 설정하는 속성입니다.

**Syntax**

```javascript
Static.usedecorate[= bDecorate]
```

**Setting Syntax**

```javascript
bDecorate ::= 'true' | 'false'
```
```javascript
this.Static00.usedecorate = true; 
this.Static00.text = "<u v='true'><i v='true'>Static00</i></u>";
```
- **`"true"`** — 텍스트에 Decorate 효과를 적용합니다.
- **`"false"`** — 텍스트에 Decorate 효과를 적용하지 않습니다.

**Remark**

- usedecorate 속성값을 설정하지 않으면 false 로 적용됩니다.

- Source에 text 속성값을 직접 입력할 때 "<", ">" 같은 특수문자는 "&lt;", "&gt;" 형태의 HTML 문법을 사용하여야 합니다.
  "@굴림" 등 "@"가 붙은 폰트는 HTML에서 지원하지 않습니다.

- text 속성값에 Tag 형식으로 Decorate 효과를 설정합니다. 

- link 효과는 execBrowser() 메소드와 동일하게 동작합니다. 
...
> Components > Component > Static > Property > visible

**Description**

Static 이(가) 화면에 표시될지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Static.visible[= bVisible]
```
...
```
- **`"true"`** — Static 을(를) 화면에 표시합니다.
- **`"false"`** — Static 을(를) 화면에 표시하지 않습니다.
...
> Components > Component > Static > Property > width

**Description**

Static 을(를) 표시하기 위한 너비를 설정하는 속성입니다.
...
```
```javascript
this.Static00.width = 10; this.Static00.width = "10px"; 
this.Static00.width = "10%"; 
this.Static00.width = "Button00:10%";
```
- **`<strCompID>`** — Static 의 너비를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 Static 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 Static 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 너비가 적용됩니다.
- **`<nVal>`** — Static 의 너비를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": Static의 너비 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Static의 너비 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Static의 너비 결정
- "rem": MainFrame font-size 속성값을 기준으로 Static의 너비 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 Static의 너비 결정
- "%": <strCompID>의 width 속성값을 기준으로 Static의 너비 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Static > Property > word-spacing

**Description**

Static 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다.

**Syntax**

```javascript
Static.wordSpacing[= strwordspacing]
```
...
* Script ( normal property )
this.Static00.wordSpacing = "30px";
```
...
> Components > Component > Static > Method > addEvent

**Description**

Static 에 특정 이벤트를 선언하여 추가하는 메소드입니다.

**Syntax**

```javascript
Static.addEvent( strEventID )
```
...
| --- | --- | --- |
| strEventID | String | Static 에 추가할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.Static00.addEvent( "onmove" );
```
...
- Static 에서 특정 이벤트를 제거하려면 removeEvent() 메소드를 사용하여야 합니다.
...
> Components > Component > Static > Method > addEventHandler

**Description**

Static 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다.

**Syntax**

```javascript
Static.addEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.Static00_onmove = function( obj:nexacro.Static,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Static00.addEventHandler( "onmove", this.Static00_onmove, this);
```
...
> Components > Component > Static > Method > addEventHandlerLookup

**Description**

함수를 검색하여 Static 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다.

**Syntax**

```javascript
Static.addEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.Static00_onmove = function( obj:nexacro.Static,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Static00.addEventHandlerLookup( "onmove", "Static00_onmove", this);
```
...
> Components > Component > Static > Method > bringToFront

**Description**

부모가 동일한 컴포넌트 중 Static 이(가) 화면의 제일 앞에 표시되게 합니다.
...
- bringToFront() 메소드는 Static 을(를) 가장 나중에 표시되게 순서를 바꿉니다.
...
> Components > Component > Static > Method > bringToPrev

**Description**

부모가 동일한 컴포넌트 중 Static 이(가) 화면에 한단계 앞에 표시되게 합니다.
...
- bringToPrev() 메소드는 Static 을(를) 한단계 나중에 표시되는 컴포넌트와 순서를 바꿉니다.
...
> Components > Component > Static > Method > clearEventHandler
...
```javascript
Static.clearEventHandler( strEventID )
```
...
```javascript
var nCnt = this.Static00.clearEventHandler( "onmove" );
```
...
> Components > Component > Static > Method > destroy

**Description**

스크립트에서 동적으로 생성한 Static 을(를) 삭제하는 메소드입니다.
...
var bSucc = this.Static00.destroy();

**Return**

| Type | Description |
| --- | --- |
| Boolean | Static 이(가) 정상적으로 삭제되면 true 를 반환합니다.

Static 이(가) 정상적으로 삭제되지 않으면 false 를 반환합니다. |

**Remark**

- 동적으로 생성한 Static 을(를) 완전히 삭제하기 위해서는 destroy() 메소드를 호출해야 합니다.

**See Also**

Form.addChildForm.insertChildForm.removeChildStatic.initStatic.show
...
> Components > Component > Static > Method > findEventHandler

**Description**

Static 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다.

**Syntax**

```javascript
Static.findEventHandler( strEventID, objFunc, objTarget )
```
...
var nIndex = this.Static00.findEventHandler( "onmove", this.Static00_onmove, this );
```
...
> Components > Component > Static > Method > getDisplayText

**Description**

Static 에 표시된 텍스트값을 반환하는 메소드입니다.
...
var strTxt = this.Static00.getDisplayText() ;

**Return**

| Type | Description |
| --- | --- |
| String | Static 에 표시된 텍스트값을 반환합니다. |
...
> Components > Component > Static > Method > getEventHandler

**Description**

Static 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다.

**Syntax**

```javascript
Static.getEventHandler( strEventID, nIdx )
```
...
```javascript
var objFunc = Static00.getEventHandler( "onmove", 0 );
```
...
> Components > Component > Static > Method > getOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Static 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
Static.getOffsetBottom();
```

**Parameters**

var nBottom = this.Static.getOffsetBottom();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 Static 의 bottom 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 Static 의 bottom 값을 동적으로 계산합니다.
...
> Components > Component > Static > Method > getOffsetHeight

**Description**

Static 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nHeight = this.Static.getOffsetHeight();

**Return**

| Type | Description |
| --- | --- |
| Number | Static 의 높이를 픽셀단위의 숫자로 변환하여 반환합니다. |

**Remark**

- 화면에 표시된 Static 의 높이를 동적으로 계산합니다.
...
> Components > Component > Static > Method > getOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Static 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nleft = this.Static.getOffsetLeft();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 Static 의 left 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 Static 의 left 값을 동적으로 계산합니다.
...
> Components > Component > Static > Method > getOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Static 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
Static.getOffsetRight();
```

**Parameters**

var nRight = this.Static.getOffsetRight();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 Static 의 right 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 Static 의 right 값을 동적으로 계산합니다.
...
> Components > Component > Static > Method > getOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Static 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nTop = this.Static.getOffsetTop();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 Static 의 top 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 Static 의 top 값을 동적으로 계산합니다.
...
> Components > Component > Static > Method > getOffsetWidth

**Description**

Static 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nWidth = this.Static.getOffsetWidth();

**Return**

| Type | Description |
| --- | --- |
| Number | Static 의 너비를 픽셀단위의 숫자로 변환하여 반환합니다. |

**Remark**

- 화면에 표시된 Static 의 너비를 동적으로 계산합니다.
...
> Components > Component > Static > Method > getPixelBottom

**Description**

Static 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
Static.getPixelBottom();
```

**Parameters**

var nbottom = this.Static.getPixelBottom();

**Return**

| Type | Description |
| --- | --- |
| Number | Static 의 bottom 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Static > Method > getPixelHeight

**Description**

Static 의 height 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nheight = this.Static.getPixelHeight();

**Return**

| Type | Description |
| --- | --- |
| Number | Static 의 height 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Static > Method > getPixelLeft

**Description**

Static 의 left 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nleft = this.Static.getPixelLeft();

**Return**

| Type | Description |
| --- | --- |
| Number | Static 의 left 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Static > Method > getPixelRight

**Description**

Static 의 right 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
Static.getPixelRight();
```

**Parameters**

var nright = this.Static.getPixelRight();

**Return**

| Type | Description |
| --- | --- |
| Number | Static 의 right 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Static > Method > getPixelTop

**Description**

Static 의 top 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var ntop = this.Static.getPixelTop();

**Return**

| Type | Description |
| --- | --- |
| Number | Static 의 top 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Static > Method > getPixelWidth

**Description**

Static 의 width 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nwidth = this.Static.getPixelWidth();

**Return**

| Type | Description |
| --- | --- |
| Number | Static 의 width 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Static > Method > init

**Description**

스크립트로 Static 을(를) 동적 생성한 후에 초기화하는 메소드입니다.
...
| vLeft | String, Number | Static 의 left 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 right 속성값을 기준으로 Static 의 left 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 Static 의 left 가 결정됩니다. |
| vTop | String, Number | Static 의 top 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 bottom 속성값을 기준으로 Static 의 top 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Static 의 top 이 결정됩니다. |
| vWidth | String, Number | Static 의 width 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 Static 의 width 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 Static 의 width 가 결정됩니다. |
| vHeight | String, Number | Static 의 height 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 Static 의 height 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Static 의 height 가 결정됩니다. |
| vRight | String, Number | Static 의 right 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vLeft, vWidth 값을 모두 설정했을 경우 vRight 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 left 속성값을 기준으로 Static 의 right 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 Static 의 right 가 결정됩니다. |
| vBottom | String, Number | Static 의 bottom 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vTop, vHeight 값을 모두 설정했을 경우 vBottom 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 top 속성값을 기준으로 Static 의 bottom 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Static 의 bottom 이 결정됩니다. |
| vMinWidth | String, Number | Static 이(가) 화면에 표시되는 최소 너비값을 pixel 단위의 숫자로 설정합니다. |
| vMaxWidth | String, Number | Static 이(가) 화면에 표시되는 최대 너비값을 pixel 단위의 숫자로 설정합니다.

vMinWidth 보다 작은 값을 설정하면 vMinWidth 값으로 설정됩니다. |
| vMinHeight | String, Number | Static 이(가) 화면에 표시되는 최소 높이값을 pixel 단위의 숫자로 설정합니다. |
| vMaxHeight | String, Number | Static 이(가) 화면에 표시되는 최대 높이값을 pixel 단위의 숫자로 설정합니다.
...
objComp.init( "Static00", 30, 120, 196, 46 );
objComp.init( "Static00", 30, 120, 196, 46, null, null );
objComp.init( "Static00", null, null, 300, "400px", "80%", 300 );
objComp.init( "Static00", 0, 0, 200, 100, null, null, 300, 500, 200, 500 );
objComp.init( "Static00", "Static22:10", 300, null, null, "Static33:10", "20%", 300, 500, 200, 500 );
```
...
- 인수값에 기준 컴포넌트를 포함하면 Static 의 위치는 기준 컴포넌트를 기준으로 상대적으로 결정됩니다.
  vLeft, vTop, vWidth, vHeight, vRight, vBottom 값에 기준 컴포넌트를 포함할 때는 "ID:Value" 형태로 설정하여야 합니다.

- 기준 컴포넌트는 Static 와(과) 부모(Parent)가 동일하여야 하며, Form 로딩 시 Static 보다 먼저 생성되어야 합니다.
...
Form.addChildForm.insertChildForm.removeChildStatic.destroyStatic.show
...
> Components > Component > Static > Method > insertEventHandler

**Description**

Static 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다.

**Syntax**

```javascript
Static.insertEventHandler( strEventID, nIndex, objFunc, objTarget )
```
...
var nIndex = this.Static00.insertEventHandler( "onmove", 0, this.Static00_onmove, this);
```
...
> Components > Component > Static > Method > move

**Description**

Static 의 위치와 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
Static.move( vLeft, vTop [, vWidth, vHeight [, vRight, vBottom]] )
```
...
```javascript
this.Static00.move(10,10);
this.Static00.move(10,10,100,100);
this.Static00.move(null, null, 300, "400px", "80%", 300 );
```
...
> Components > Component > Static > Method > moveToNext

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Static 이(가) 화면에 한단계 뒤에 표시되게 합니다.

**Syntax**

```javascript
Static.moveToNext( objComp )
Static.moveToNext( strComp )
```
...
```javascript
this.Static.moveToNext( this.Button00 );
this.Static.moveToNext( "Button00" );
```
...
- 인수로 전달되는 기준 컴포넌트와 Static 은(는) 부모가 동일하여야 합니다.

- 디자인 시 소스에 컴포넌트가 선언된 순서대로 화면에 표시됩니다.
  소스에서 위에 선언된 컴포넌트가 먼저 표시되고, 아래에 선언된 컴포넌트가 나중에 표시되게 됩니다.
  컴포넌트가 겹쳐져 있을 경우 화면에 표시되는 순서에 따라 먼저 표시된 컴포넌트가 나중에 표시되는 컴포넌트에 가려지게 됩니다.

- moveToNext() 메소드는 기준 컴포넌트보다 Static 이(가) 한단계 먼저 표시되게 순서를 바꿉니다.
...
> Components > Component > Static > Method > moveToPrev

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Static 이(가) 화면에 한단계 앞에 표시되게 합니다.

**Syntax**

```javascript
Static.moveToPrev( objComp )
Static.moveToPrev( strComp )
```
...
```javascript
this.Static.moveToPrev( this.Button00 );
this.Static.moveToPrev( "Button00" );
```
...
- moveToPrev() 메소드는 기준 컴포넌트보다 Static 이(가) 한단계 나중에 표시되게 순서를 바꿉니다.
...
> Components > Component > Static > Method > removeEvent

**Description**

Static 에 선언된 특정 이벤트를 삭제하는 메소드입니다.

**Syntax**

```javascript
Static.removeEvent( strEventID )
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| strEventID | String | Static 에서 삭제할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.Static00.removeEvent( "onmove" );
```
...
- Static 에 특정 이벤트를 추가하려면 addEvent() 메소드를 사용하여야 합니다.

- Static 에 기본으로 선언되어 있는 이벤트 삭제 시 오동작 할 수 있으므로 주의하여야 합니다.
...
> Components > Component > Static > Method > removeEventHandler

**Description**

Static 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
Static.removeEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.Static00_onmove = function( obj:nexacro.Static,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Static00.removeEventHandler( "onmove", this.Static00_onmove, this);
```
...
> Components > Component > Static > Method > removeEventHandlerLookup

**Description**

Static 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
Static.removeEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.Static00_onmove = function( obj:nexacro.Static,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Static00.removeEventHandlerLookup( "onmove", "Static00_onmove", this);
```
...
> Components > Component > Static > Method > resize

**Description**

Static 의 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
Static.resize( vWidth, vHeight )
```
...
- Static 의 left 속성값이 null 이 아니면 resize() 메소드 실행 후 Static 의 우측 위치가 변경됩니다.
  또한, 메소드 실행 후 right 속성값은 null 이 됩니다.

- Static 의 left 속성값이 null 이면 resize() 메소드 실행 후 Static 의 좌측 위치가 변경됩니다.
  또한, 메소드 실행 후 left 속성값은 null 로 유지됩니다.

- Static 의 top 속성값이 null 이 아니면 resize() 메소드 실행 후 Static 의 하단 위치가 변경됩니다.
  또한, 메소드 실행 후 bottom 속성값은 null 이 됩니다.

- Static 의 top 속성값이 null 이면 resize() 메소드 실행 후 Static 의 상단 위치가 변경됩니다.
...
> Components > Component > Static > Method > sendToBack

**Description**

부모가 동일한 컴포넌트 중 Static 이(가) 화면의 제일 뒤에 표시되게 합니다.
...
- sendToBack() 메소드는 Static 을(를) 가장 먼저 표시되게 순서를 바꿉니다.
...
> Components > Component > Static > Method > sendToNext

**Description**

부모가 동일한 컴포넌트 중 Static 이(가) 화면에 한단계 뒤에 표시되게 합니다.
...
- sendToNext() 메소드는 Static 을(를) 한단계 먼저 표시되는 컴포넌트와 순서를 바꿉니다.
...
> Components > Component > Static > Method > setEventHandler

**Description**

Static 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다.

**Syntax**

```javascript
Static.setEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.Static00_onmove = function( obj:nexacro.Static,  e:nexacro.MoveEventInfo ) { //수행할 스크립트 };
var nIndex = this.Static00.setEventHandler( "onmove", this.Static00_onmove, this );
```
...
> Components > Component > Static > Method > setEventHandlerLookup

**Description**

Static 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다.

**Syntax**

```javascript
Static.setEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.Static00_onmove = function( obj:nexacro.Static,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Static00.setEventHandlerLookup( "onmove", "Static00_onmove", this);
```
...
> Components > Component > Static > Method > setOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Static 의 bottom 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Static.setOffsetBottom( nBottom );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nBottom | Number | 부모 컴포넌트의 Top 위치를 기준으로 Static 의 bottom 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Static.setOffsetBottom( 10 );
```
...
- 메소드 실행 전 Static 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Static 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > Static 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > Static 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 height, bottom 속성이 설정됩니다.
...
> Components > Component > Static > Method > setOffsetHeight

**Description**

Static 의 높이를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Static.setOffsetHeight( nHeight );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nHeight | Number | Static 의 높이를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Static.setOffsetHeight( 10 );
```
...
> Components > Component > Static > Method > setOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Static 의 left 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Static.setOffsetLeft( nLeft );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nLeft | Number | 부모 컴포넌트의 Left 위치를 기준으로 Static 의 left 값을 픽셀단위의 숫자로 설정합니다 |

**Sample Call**

```javascript
this.Static.setOffsetLeft( 10 );
```
...
- 메소드 실행 전 Static 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Static 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > Static 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, right 속성이 설정됩니다.
   > Static 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
...
> Components > Component > Static > Method > setOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Static 의 right 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Static.setOffsetRight( nRight );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nRight | Number | 부모 컴포넌트의 Left 위치를 기준으로 Static 의 right 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Static.setOffsetRight( 600 );
```
...
- 메소드 실행 전 Static 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Static 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > Static 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > Static 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 width, right 속성이 설정됩니다.
...
> Components > Component > Static > Method > setOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Static 의 top 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Static.setOffsetTop( nTop );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nTop | Number | 부모 컴포넌트의 Top 위치를 기준으로 Static 의 top 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Static.setOffsetTop( 10 );
```
...
- 메소드 실행 전 Static 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Static 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > Static 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, bottom 속성이 설정됩니다.
   > Static 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
...
> Components > Component > Static > Method > setOffsetWidth

**Description**

Static 의 너비를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Static.setOffsetWidth( nWidth );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nWidth | Number | Static 의 너비를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Static.setOffsetWidth( 10 );
```
...
> Components > Component > Static > Method > show

**Description**

스크립트로 동적 생성한 Static 을(를) 화면에 표시하는 메소드입니다.
...
Form.addChildForm.insertChildForm.removeChildStatic.destroyStatic.init
...
> Components > Component > Static > Event > onclick
...
> Components > Component > Static > Event > oncontextmenu
...
> Components > Component > Static > Event > onlbuttondown
...
> Components > Component > Static > Event > onlbuttonup
...
> Components > Component > Static > Event > onmouseenter
...
> Components > Component > Static > Event > onmouseleave
...
> Components > Component > Static > Event > onmousemove
...
> Components > Component > Static > Event > onmove
...
> Components > Component > Static > Event > onrbuttondown
...
> Components > Component > Static > Event > onrbuttonup
...
> Components > Component > Static > Event > onsize
...
> Components > Component > Static > Event > ontouchend
...
> Components > Component > Static > Event > ontouchmove
...
> Components > Component > Static > Event > ontouchstart
