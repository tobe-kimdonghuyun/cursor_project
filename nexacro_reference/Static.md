...
```
Static 에 추가할 이벤트의 ID 를 문자열로 설정합니다.
```
...
Static 이(가) 정상적으로 삭제되면 true 를 반환합니다.
...
부모 컴포넌트의 Top 위치를 기준으로 Static 의 bottom 값을 픽셀단위의 숫자로 반환합니다.
...
Static 의 높이를 픽셀단위의 숫자로 변환하여 반환합니다.
...
부모 컴포넌트의 Left 위치를 기준으로 Static 의 left 값을 픽셀단위의 숫자로 반환합니다.
...
부모 컴포넌트의 Left 위치를 기준으로 Static 의 right 값을 픽셀단위의 숫자로 반환합니다.
...
부모 컴포넌트의 Top 위치를 기준으로 Static 의 top 값을 픽셀단위의 숫자로 반환합니다.
...
Static 의 너비를 픽셀단위의 숫자로 변환하여 반환합니다.
...
Static 의 bottom 속성값을 픽셀단위로 반환합니다.
...
Static 의 height 속성값을 픽셀단위로 반환합니다.
...
Static 의 left 속성값을 픽셀단위로 반환합니다.
...
Static 의 right 속성값을 픽셀단위로 반환합니다.
...
Static 의 width 속성값을 픽셀단위로 반환합니다.
...
```
Static 의 left 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
...
```
Static 에서 삭제할 이벤트의 ID 를 문자열로 설정합니다.
```
...
```
Static 의 width 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
음수값을 설정할 수 없습니다.
...
```
부모 컴포넌트의 Top 위치를 기준으로 Static 의 bottom 값을 픽셀단위의 숫자로 설정합니다.
```
...
```
부모 컴포넌트의 Left 위치를 기준으로 Static 의 left 값을 픽셀단위의 숫자로 설정합니다
```
...
```
부모 컴포넌트의 Left 위치를 기준으로 Static 의 right 값을 픽셀단위의 숫자로 설정합니다.
```
...
```
부모 컴포넌트의 Top 위치를 기준으로 Static 의 top 값을 픽셀단위의 숫자로 설정합니다.
```
