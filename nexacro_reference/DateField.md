...
| --- | --- | --- |
| strEventID | String | DateField 에 추가할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.DateField00.addEvent( "onmove" );
```
...
```javascript
this.DateField00_onmove = function( obj:nexacro.DateField,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.DateField00.addEventHandler( "onmove", this.DateField00_onmove, this);
```
...
```javascript
this.DateField00_onmove = function( obj:nexacro.DateField,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.DateField00.addEventHandlerLookup( "onmove", "DateField00_onmove", this);
```
...
```javascript
var nCnt = this.DateField00.clearEventHandler( "onmove" );
```
...
| Type | Description |
| --- | --- |
| Boolean | DateField 이(가) 정상적으로 삭제되면 true 를 반환합니다.
...
var nIndex = this.DateField00.findEventHandler( "onmove", this.DateField00_onmove, this );
```
...
| Type | Description |
| --- | --- |
| String | DateField 에 표시된 텍스트값을 반환합니다. |
...
```javascript
var objFunc = DateField00.getEventHandler( "onmove", 0 );
```
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 DateField 의 bottom 값을 픽셀단위의 숫자로 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | DateField 의 높이를 픽셀단위의 숫자로 변환하여 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 DateField 의 left 값을 픽셀단위의 숫자로 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 DateField 의 right 값을 픽셀단위의 숫자로 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 DateField 의 top 값을 픽셀단위의 숫자로 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | DateField 의 너비를 픽셀단위의 숫자로 변환하여 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | DateField 의 bottom 속성값을 픽셀단위로 반환합니다.
...
| Type | Description |
| --- | --- |
| Number | DateField 의 height 속성값을 픽셀단위로 반환합니다.
...
| Type | Description |
| --- | --- |
| Number | DateField 의 left 속성값을 픽셀단위로 반환합니다.
...
| Type | Description |
| --- | --- |
| Number | DateField 의 right 속성값을 픽셀단위로 반환합니다.
...
| Type | Description |
| --- | --- |
| Number | DateField 의 top 속성값을 픽셀단위로 반환합니다.
...
| Type | Description |
| --- | --- |
| Number | DateField 의 width 속성값을 픽셀단위로 반환합니다.
...
| Type | Description |
| --- | --- |
| String | DateField 컴포넌트에 입력한 텍스트의 유효성 검사 결과를 반환합니다.
...
| vLeft | String, Number | DateField 의 left 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
...
| vTop | String, Number | DateField 의 top 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 bottom 속성값을 기준으로 DateField 의 top 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 DateField 의 top 이 결정됩니다. |
| vWidth | String, Number | DateField 의 width 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
...
| vHeight | String, Number | DateField 의 height 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 DateField 의 height 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 DateField 의 height 가 결정됩니다. |
| vRight | String, Number | DateField 의 right 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vLeft, vWidth 값을 모두 설정했을 경우 vRight 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 left 속성값을 기준으로 DateField 의 right 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 DateField 의 right 가 결정됩니다. |
| vBottom | String, Number | DateField 의 bottom 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vTop, vHeight 값을 모두 설정했을 경우 vBottom 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 top 속성값을 기준으로 DateField 의 bottom 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 DateField 의 bottom 이 결정됩니다. |
| vMinWidth | String, Number | DateField 이(가) 화면에 표시되는 최소 너비값을 pixel 단위의 숫자로 설정합니다. |
| vMaxWidth | String, Number | DateField 이(가) 화면에 표시되는 최대 너비값을 pixel 단위의 숫자로 설정합니다.

vMinWidth 보다 작은 값을 설정하면 vMinWidth 값으로 설정됩니다. |
| vMinHeight | String, Number | DateField 이(가) 화면에 표시되는 최소 높이값을 pixel 단위의 숫자로 설정합니다. |
| vMaxHeight | String, Number | DateField 이(가) 화면에 표시되는 최대 높이값을 pixel 단위의 숫자로 설정합니다.
...
objComp.init( "DateField00", 30, 120, 196, 46 );
objComp.init( "DateField00", 30, 120, 196, 46, null, null );
objComp.init( "DateField00", null, null, 300, "400px", "80%", 300 );
objComp.init( "DateField00", 0, 0, 200, 100, null, null, 300, 500, 200, 500 );
objComp.init( "DateField00", "DateField22:10", 300, null, null, "DateField33:10", "20%", 300, 500, 200, 500 );
```
...
var nIndex = this.DateField00.insertEventHandler( "onmove", 0, this.DateField00_onmove, this);
```
...
| Type | Description |
| --- | --- |
| Boolean | 화면에 팝업달력이 표시되어 있으면 true를 반환합니다.
...
```javascript
this.DateField00.move(10,10);
this.DateField00.move(10,10,100,100);
this.DateField00.move(null, null, 300, "400px", "80%", 300 );
```
...
```javascript
this.DateField.moveToNext( this.Button00 );
this.DateField.moveToNext( "Button00" );
```
...
```javascript
this.DateField.moveToPrev( this.Button00 );
this.DateField.moveToPrev( "Button00" );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| strEventID | String | DateField 에서 삭제할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.DateField00.removeEvent( "onmove" );
```
...
```javascript
this.DateField00_onmove = function( obj:nexacro.DateField,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.DateField00.removeEventHandler( "onmove", this.DateField00_onmove, this);
```
...
```javascript
this.DateField00_onmove = function( obj:nexacro.DateField,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.DateField00.removeEventHandlerLookup( "onmove", "DateField00_onmove", this);
```
...
```javascript
this.DateField00.resize( 100,100 );
```
...
```javascript
this.DateField00_onmove = function( obj:nexacro.DateField,  e:nexacro.MoveEventInfo ) { //수행할 스크립트 };
var nIndex = this.DateField00.setEventHandler( "onmove", this.DateField00_onmove, this );
```
...
```javascript
this.DateField00_onmove = function( obj:nexacro.DateField,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.DateField00.setEventHandlerLookup( "onmove", "DateField00_onmove", this);
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| bMoveScroll | Boolean | 부모 컴포넌트에 스크롤이 있을 경우, DateField 기준으로 스크롤을 이동할지 여부를 설정합니다.
...
```javascript
var objBefComp = this.DateField00.setFocus();
var objBefComp = this.DateField00.setFocus( false );
```
...
| Type | Description |
| --- | --- |
| Object | DateField 이(가) 포커스를 얻기 전에 포커스를 가지고 있던 컴포넌트를 반환합니다.
...
```javascript
this.DateField00.setInnerDataset( this.Dataset00 )
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nBottom | Number | 부모 컴포넌트의 Top 위치를 기준으로 DateField 의 bottom 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.DateField.setOffsetBottom( 10 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nHeight | Number | DateField 의 높이를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.DateField.setOffsetHeight( 10 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nLeft | Number | 부모 컴포넌트의 Left 위치를 기준으로 DateField 의 left 값을 픽셀단위의 숫자로 설정합니다 |

**Sample Call**

```javascript
this.DateField.setOffsetLeft( 10 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nRight | Number | 부모 컴포넌트의 Left 위치를 기준으로 DateField 의 right 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.DateField.setOffsetRight( 600 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nTop | Number | 부모 컴포넌트의 Top 위치를 기준으로 DateField 의 top 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.DateField.setOffsetTop( 10 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nWidth | Number | DateField 의 너비를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.DateField.setOffsetWidth( 10 );
```
...
this.DateField00.setFocus();

bSucc = this.DateField00.setSelect();
bSucc = this.DateField00.setSelect( 3 );
bSucc = this.DateField00.setSelect( 3, 5 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| obj | DateField | Event가 발생한 Object. |
...
| Type | Description |
| --- | --- |
| Boolean | 이벤트에서 리턴값을 true로 반환하면 변경된 날짜가 적용됩니다.
...
| --- | --- | --- |
| obj | DateField | Event가 발생한 Object. |
| e | DateFieldCloseUpEventInfo | Event Object. |
...
| --- | --- | --- |
| obj | DateField | Event가 발생한 Object. |
| e | DateFieldDayClickEventInfo | Event Object. |
...
| Type | Description |
| --- | --- |
| Boolean | 이벤트의 리턴값으로 true를 반환하면 팝업달력이 화면에 표시됩니다.
