...
| Name | Description |
| --- | --- |
| accessibilityaction | Button에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다. |
| accessibilitydesclevel | Button 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| accessibilitydescription | Button에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다. |
| accessibilityenable | Button 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| accessibilitylabel | Button에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다. |
| accessibilityrole | Button에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다. |
| background | Button 의 배경 영역을 설정하는 속성입니다. |
| border-radius | Button 의 모서리 모양을 설정하는 속성입니다. |
| bottom | Button 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다. |
| box-shadow | Button 에 그림자 효과를 설정하는 속성입니다. |
| color | Button 에 표시되는 텍스트의 색상을 설정하는 속성입니다. |
| cssclass | Button 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다. |
| cursor | Button 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다. |
| defaultbutton | 활성화 된 폼에서 엔터키 입력으로 Button 의 onclick 이벤트를 발생시킬지 설정하는 속성입니다. |
| enable | Button 의 사용가능 여부를 설정하는 속성입니다. |
| enableevent | Button 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다. |
| escapebutton | 활성화 된 폼에서 ESC키 입력으로 Button 의 onclick 이벤트를 발생시킬지 설정하는 속성입니다. |
| expr | Button 에 표시될 텍스트를 동적으로 생성하는 수식을 설정하는 속성입니다. |
| fittocontents | Button 의 내부 컨텐츠영역이 컨텐츠 내용에 맞게 자동조정되는 영역을 설정하는 속성입니다. |
...
| font | Button 에서 사용하는 폰트를 설정하는 속성입니다. |
| height | Button 을(를) 표시하기 위한 높이를 설정하는 속성입니다. |
| hotkey | Button 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다. |
| id | Button의 고유 식별자를 설정하는 속성입니다. |
| initvalueid | Button 에 적용될 InitValue 의 ID 를 설정하는 속성입니다. |
| layoutorder | Layout 컨테이너 내 Main Axis(type 속성값이 "horizontal"이면 수평축, type 속성값이 "vertical"이면 수직축)에 컴포넌트가 배치되는 순서를 설정합니다. |
| left | Button 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다. |
| letter-spacing | Button 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다. |
| maxheight | Button 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다. |
| maxwidth | Button 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다. |
| minheight | Button 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다. |
| minwidth | Button 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다. |
| name | Button 의 이름을 설정하는 속성입니다. |
| -nexa-border | Button 의 테두리를 설정하는 속성입니다. |
| -nexa-edge | Button 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-icon | Button에서 텍스트와 함께 표시 될 아이콘 이미지를 설정하는 속성입니다. |
| -nexa-icon-position | Button에서 텍스트와 함께 표시 될 아이콘 이미지의 위치를 설정하는 속성입니다. |
| -nexa-padding | Button 과 내부 컨텐츠영역 사이의 여백을 설정하는 속성입니다. |
| -nexa-rtl-background-image | Button 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다. |
| -nexa-rtl-edge-image | Button 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-rtl-icon | Button 의 rtl 속성이 true 로 적용될 때 표시될 아이콘 이미지를 설정하는 속성입니다. |
| -nexa-text-align | Button 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다. |
| -nexa-text-decoration | Button 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다. |
| -nexa-text-padding | Button 에 표시되는 아이콘과 텍스트의 간격을 설정하는 속성입니다. |
| -nexa-vertical-align | Button 에 표시되는 텍스트 또는 컨텐츠의 세로 정렬 방식을 설정하는 속성입니다. |
| -nexa-word-wrap | Button 에 표시되는 텍스트가 출력영역보다 길 경우 자동으로 줄바꿈 되도록 설정하는 속성입니다. |
| opacity | Button 영역의 투명도를 설정하는 속성입니다. |
| parent | Button 의 부모 오브젝트를 갖는 읽기전용 속성입니다. |
| positionstep | 부모 오브젝트가 화면분할기능을 사용할 때 Button 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다. |
| right | Button 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다. |
| rtl | Button 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다. |
| tablecellarea | Layout 컨테이너 내 가상의 Table Cell 영역 내에서 컴포넌트가 배치되는 영역을 설정합니다. |
| taborder | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 Button 의 순서를 설정하는 속성입니다. |
| tabstop | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 Button 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다. |
| text | Button 에 표시될 텍스트를 설정하는 속성입니다. |
| textwidth | Button 에 표시되는 텍스트의 출력영역 너비를 설정하는 속성입니다. |
| tooltiptext | Button 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다. |
| tooltiptype | Button 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다. |
| top | Button 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다. |
| visible | Button 이(가) 화면에 표시될지 여부를 설정하는 속성입니다. |
| width | Button 을(를) 표시하기 위한 너비를 설정하는 속성입니다. |
| word-spacing | Button 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다. |

**Method**

| Name | Description |
| --- | --- |
| addEvent | Button 에 특정 이벤트를 선언하여 추가하는 메소드입니다. |
| addEventHandler | Button 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다. |
| addEventHandlerLookup | 함수를 검색하여 Button 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다. |
| bringToFront | 부모가 동일한 컴포넌트 중 Button 이(가) 화면의 제일 앞에 표시되게 합니다. |
| bringToPrev | 부모가 동일한 컴포넌트 중 Button 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| clearEventHandler | 특정 이벤트에 등록된 핸들러 함수를 모두 제거하는 메소드입니다. |
| click | Button 의 onclick 이벤트를 강제로 발생시키는 메소드입니다. |
| destroy | 스크립트에서 동적으로 생성한 Button 을(를) 삭제하는 메소드입니다. |
| findEventHandler | Button 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다. |
| getDisplayText | Button 에 표시된 텍스트값을 반환하는 메소드입니다. |
| getEventHandler | Button 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다. |
| getOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 Button 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetHeight | Button 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 Button 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 Button 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 Button 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetWidth | Button 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getPixelBottom | Button 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelHeight | Button 의 height 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelLeft | Button 의 left 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelRight | Button 의 right 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelTop | Button 의 top 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelWidth | Button 의 width 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getSelectStatus | 현재 Button의 Status가 Selected 인지 확인하는 메소드입니다. |
| init | 스크립트로 Button 을(를) 동적 생성한 후에 초기화하는 메소드입니다. |
| insertEventHandler | Button 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다. |
| move | Button 의 위치와 크기를 변경하는 메소드입니다. |
| moveToNext | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Button 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| moveToPrev | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Button 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| removeEvent | Button 에 선언된 특정 이벤트를 삭제하는 메소드입니다. |
| removeEventHandler | Button 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다. |
| removeEventHandlerLookup | Button 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다. |
| resize | Button 의 크기를 변경하는 메소드입니다. |
| sendToBack | 부모가 동일한 컴포넌트 중 Button 이(가) 화면의 제일 뒤에 표시되게 합니다. |
| sendToNext | 부모가 동일한 컴포넌트 중 Button 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| setEventHandler | Button 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다. |
| setEventHandlerLookup | Button 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다. |
| setFocus | Button 에 포커스를 설정하는 메서드입니다. |
| setOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 Button 의 bottom 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetHeight | Button 의 높이를 픽셀단위로 설정하는 메소드입니다. |
| setOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 Button 의 left 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 Button 의 right 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 Button 의 top 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetWidth | Button 의 너비를 픽셀단위로 설정하는 메소드입니다. |
| setSelectStatus | Button에 Selected Status를 적용하거나 제거하는 메소드입니다. |
| show | 스크립트로 동적 생성한 Button 을(를) 화면에 표시하는 메소드입니다. |
| toggleSelectStatus | Button에 Selected Status 적용을 토글시키는 메소드입니다. |

**Event**

| Name | Description |
| --- | --- |
| onclick | Button 영역 내에서 마우스 왼쪽버튼을 클릭했을 때 발생하는 이벤트입니다. |
| oncontextmenu | Button 영역에서 오른쪽 마우스 버튼을 클릭하거나 터치를 일정시간 유지할 때 발생하는 이벤트입니다. |
| ondblclick | Button 영역 내에서 마우스 왼쪽버튼을 더블클릭 했을 때 발생하는 이벤트입니다. |
| ondevicebuttonup | 모바일 에서 디바이스 버튼을 눌렀을 때 발생하는 이벤트입니다. |
| ondrag | Button 영역 내에서 마우스 왼쪽버튼으로 드래그를 수행했을 때 발생하는 이벤트입니다. |
| ondragenter | Button 영역 내로 드래그 상태의 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다. |
| ondragleave | Button 영역 밖으로 드래그 상태의 마우스 포인터가 나갈 때 발생하는 이벤트입니다. |
| ondragmove | Button 영역 내에서 드래그 상태의 마우스 포인터가 움직일 때 발생하는 이벤트입니다. |
| ondrop | Button 영역 내에서 드래그 상태의 마우스 버튼을 떼었을 때 발생하는 이벤트입니다. |
| onkeydown | Button 에 포커스가 있는 상태에서 키보드의 키가 눌렸을 때 발생하는 이벤트입니다. |
| onkeyup | Button 에 포커스가 있는 상태에서 눌렸던 키보드가 떼어질 때 발생하는 이벤트입니다. |
| onkillfocus | Button 에서 포커스가 나갈  때 발생하는 이벤트입니다. |
| onlbuttondown | Button 영역 내에서 마우스 왼쪽버튼을 눌렀을 때 발생하는 이벤트입니다. |
| onlbuttonup | Button 영역 내에서 눌렸던 마우스 왼쪽버튼을 떼었을 때 발생하는 이벤트입니다. |
| onmouseenter | Button 영역 내로 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다. |
| onmouseleave | Button 영역 밖으로 마우스 포인터가 나갈 때 발생하는 이벤트입니다. |
| onmousemove | Button 영역 내에서 마우스 포인터가 움직일 때 발생하는 이벤트입니다. |
| onmove | Button 의 위치가 이동했을 때 발생하는 이벤트입니다. |
| onrbuttondown | Button 영역 내에서 마우스 오른쪽버튼을 눌렀을 때 발생하는 이벤트입니다. |
| onrbuttonup | Button 영역 내에서 마우스 오른쪽버튼을 떼었을 때 발생하는 이벤트입니다. |
| onsetfocus | Button 에 포커스가 들어올 때 발생하는 이벤트입니다. |
| onsize | Button 의 크기가 변경됐을 때 발생하는 이벤트입니다. |
| ontouchend | Button 영역 내에서 터치를 떼었을 때 발생하는 이벤트입니다. |
| ontouchmove | Button 영역 내에서 터치 상태를 유지하며 움직일 때 발생하는 이벤트입니다. |
| ontouchstart | Button 영역 내에서 터치가 시작될 때 발생하는 이벤트입니다. |
...
> Components > Component > Button > Property > -nexa-border

**Description**

Button 의 테두리를 설정하는 속성입니다.

**Syntax**

```javascript
Button.border[= strborder]
```
...
this.Button00.border = "1px solid #999999";
this.Button00.border = "1px solid #999999, 1px solid #999999, 1px solid #999999, 1px solid #999999";
```
...
> Components > Component > Button > Property > -nexa-edge

**Description**

Button 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.
...
* Script ( normal property )
this.Button00.edge = "URL('./images/border.png')" 5px 5px;
```
...
- Button 내부에 테두리 형태로 이미지를 표시하고자 할 때 사용하는 속성입니다.
...
> Components > Component > Button > Property > -nexa-icon

**Description**

Button에서 텍스트와 함께 표시 될 아이콘 이미지를 설정하는 속성입니다.
...
* Script ( normal property )
this.Button.icon = "URL('./images/smiley.gif')" ;
this.Button.icon = "URL('theme://images/border.png')";
```
- **`<Theme-Image>`** — 테마에 선언된 이미지를 "theme://images/이미지명" 형식으로 설정합니다.
...
> Components > Component > Button > Property > -nexa-icon-position

**Description**

Button에서 텍스트와 함께 표시 될 아이콘 이미지의 위치를 설정하는 속성입니다.

**Syntax**

```javascript
Button.iconPosition[= striconpos]
```
...
> Components > Component > Button > Property > -nexa-padding

**Description**

Button 과 내부 컨텐츠영역 사이의 여백을 설정하는 속성입니다.

**Syntax**

```javascript
Button.padding[= strpadding]
```
...
* Script ( normal property )
this.Button00.padding = "5px 5px 5px 5px";
```
- **`<npadding>`** — Button 과 내부 컨텐츠영역 사이의 여백을 pixel 단위로 설정합니다.
...
> Components > Component > Button > Property > -nexa-rtl-background-image

**Description**

Button 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
Button.-nexa-rtl-background-image
```
...
> Components > Component > Button > Property > -nexa-rtl-edge-image

**Description**

Button 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
Button.-nexa-rtl-edge-image
```
...
> Components > Component > Button > Property > -nexa-rtl-icon

**Description**

Button 의 rtl 속성이 true 로 적용될 때 표시될 아이콘 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
Button.-nexa-rtl-icon
```
...
> Components > Component > Button > Property > -nexa-text-align

**Description**

Button 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
Button.textAlign[= strtextalign]
```
...
* Script ( normal property )
this.Button00.textAlign = "center";
```
...
- Button 의 너비보다 표시되는 텍스트의 길이가 크면 "right" 를 설정해도 "left" 로 동작됩니다.
...
> Components > Component > Button > Property > -nexa-text-decoration

**Description**

Button 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다.

**Syntax**

```javascript
Button.textDecoration[= strTxtDeco]
```
...
* Script ( normal property )
this.Button00.textDecoration = "underline overline";
```
...
> Components > Component > Button > Property > -nexa-text-padding

**Description**

Button 에 표시되는 아이콘과 텍스트의 간격을 설정하는 속성입니다.

**Syntax**

```javascript
Button.textPadding[= strtextpadding]
```
...
* Script ( normal property )
this.Button00.textPadding = "5px 5px 5px 5px";
```
...
- Button 에 표시되는 아이콘이 없을 경우 -nexa-text-padding 속성값은 무시됩니다.
...
> Components > Component > Button > Property > -nexa-vertical-align

**Description**

Button 에 표시되는 텍스트 또는 컨텐츠의 세로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
Button.verticalAlign[= strvertalign]
```
...
* Script ( normal property )
this.Button00.verticalAlign = "middle";
```
...
> Components > Component > Button > Property > -nexa-word-wrap

**Description**

Button 에 표시되는 텍스트가 출력영역보다 길 경우 자동으로 줄바꿈 되도록 설정하는 속성입니다.

**Syntax**

```javascript
Button.wordWrap[= strwordwrap]
```
...
> Components > Component > Button > Property > accessibilityaction

**Description**

Button에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Button.accessibilityaction[= strAction]
```

**Setting Syntax**

```javascript
this.Button00.accessibilityaction = "Accessibility Action Message"; 
this.Button00.accessibilityaction = "Select by direction key";
```
...
> Components > Component > Button > Property > accessibilitydesclevel

**Description**

Button 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
Button.accessibilitydesclevel[= enumLevel]
```
...
```
```javascript
this.Button00.accessibilitydesclevel = "all";
```
- **`"all"`** — Button 와 자식 컴포넌트에 대한 접근성을 모두 출력합니다.
- **`"self"`** — Button 의 접근성만 출력하고 자식 컴포넌트의 접근성은 출력하지 않습니다.
- **`"child"`** — Button 의 접근성은 출력하지 않고, 자식 컴포넌트의 접근성은 출력합니다.
- **`"none"`** — Button 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
...
> Components > Component > Button > Property > accessibilitydescription

**Description**

Button에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Button.accessibilitydescription[= strDescription]
```

**Setting Syntax**

```javascript
this.Button00.accessibilitydescription = "Option";
```
...
> Components > Component > Button > Property > accessibilityenable

**Description**

Button 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
Button.accessibilityenable[= bEnable]
```
...
```
```javascript
this.Button00.accessibilityenable = false;
```
- **`true`** — Button 에 선택상자가 이동되면 접근성 관련 속성값을 출력합니다.

방향키 또는 제스처로 선택상자 이동 시 Static 과 같이 포커스를 갖지 않는 컴포넌트에도 선택상자가 이동됩니다.
- **`false`** — Button 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.

데스크탑 환경에서 방향키로 선택상자가 Button 에 이동되지 않습니다.
모바일 환경에서 제스처로 선택상자가 Button 에 이동되지 않습니다.
...
> Components > Component > Button > Property > accessibilitylabel

**Description**

Button에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Button.accessibilitylabel[= strLabel]
```

**Setting Syntax**

```javascript
this.Button00.accessibilitylabel = "OK Button"; 
this.Button00.accessibilitylabel = "[@static00]"; 
this.Button00.accessibilitylabel = "[@static00][@static01]"; 
this.Button00.accessibilitylabel = "[@static00][@static01] OK Button";
```
...
> Components > Component > Button > Property > accessibilityrole

**Description**

Button에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Button.accessibilityrole[= enumRole]
```
...
```
```javascript
this.Button00.accessibilityrole = "none"; 
this.Button00.accessibilityrole = "button";
```
...
Button 의 배경 영역을 설정하는 속성입니다.

**Syntax**

```javascript
Button.background[= strbackground]
```
...
this.Button00.background = ""URL('./images/smiley.gif')" border-box border-box #ffffaa";
```
...
> Components > Component > Button > Property > border-radius

**Description**

Button 의 모서리 모양을 설정하는 속성입니다.

**Syntax**

```javascript
Button.borderRadius[= strborderradius]
```
...
this.Button00.borderRadius = "5px 6px 10px / 5px 10px";
```
...
> Components > Component > Button > Property > bottom

**Description**

Button 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
Button.bottom[= nBottom]
```
...
this.Button00.bottom = "Button00:10%";
```
- **`<strCompID>`** — Button 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
- **`<nVal>`** — Button 의 하단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.
...
> Components > Component > Button > Property > box-shadow

**Description**

Button 에 그림자 효과를 설정하는 속성입니다.

**Syntax**

```javascript
Button.boxShadow[= strbshadow]
```
...
this.Button00.boxShadow  = "inset 10px 10px 10px 5px #888888";
```
...
Button 의 좌상단 위치를 기준으로 그림자 효과가 표시될 위치를 가로/세로 픽셀값으로 설정합니다.
...
> Components > Component > Button > Property > color

**Description**

Button 에 표시되는 텍스트의 색상을 설정하는 속성입니다.

**Syntax**

```javascript
Button.color[= strcolor]
```
...
* Script ( normal property )
this.Button00.color = "#999999";
this.Button00.color = "rgb(255,0,0)";
this.Button00.color = "red";
```
- **`<NamedColor>`** — "red","blue" 와 같이 미리 정의된 색상이름을 문자열로 설정합니다.
- **`<NumericColor>`** — 표시할 색의 색상코드입니다.
...
> Components > Component > Button > Property > cssclass

**Description**

Button 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다.

**Syntax**

```javascript
Button.cssclass[= strcssclass]
```
...
```
```javascript
this.Button00.cssclass = "TestClass"; 
this.Button00.cssclass = "TestClass,TestClass2";
```
...
> Components > Component > Button > Property > cursor

**Description**

Button 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
Button.cursor[= strCursor]
```
...
> Components > Component > Button > Property > defaultbutton

**Description**

활성화 된 폼에서 엔터키 입력으로 Button 의 onclick 이벤트를 발생시킬지 설정하는 속성입니다.

**Syntax**

```javascript
Button.defaultbutton[= bdefault]
```
...
```
```javascript
Button00.defaultbutton = true;Button00.defaultbutton = false;
```
- **`true`** — 폼 내에서 엔터키를 눌렀을 때, 해당 버튼에서 onclick 이벤트가 발생합니다.
- **`false`** — 해당 버튼에 포커스되었을 때만 엔터키에 의해 onclick 이벤트가 발생합니다.
(Default)

**Remark**

- defaultbutton 속성값을 설정하지 않으면 "false"로 적용됩니다.

- Button 이 포커스 되어 있을 경우는 defaultbutton 속성값에 관계없이 엔터키로 onclick 이벤트가 발생합니다.

- 같은 폼에 defaultbutton 속성을 "true"로 설정한 Button이 2개 이상 존재할 경우 마지막에 로딩된 Button의 이벤트가 발생합니다.
  Source 에 선언된 순서에 따라 컴포넌트가 로딩되므로 마지막에 선언된 Button 에서 이벤트가 발생합니다.
...
> Components > Component > Button > Property > enable

**Description**

Button 의 사용가능 여부를 설정하는 속성입니다.
...
```
```javascript
this.Button00.enable = true; 
this.Button00.enable = false;
```
- **`true`** — Button 을(를) 사용할 수 있게 설정합니다.
- **`false`** — Button 을(를) 사용할 수 없게 설정합니다.
...
> Components > Component > Button > Property > enableevent

**Description**

Button 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Button.enableevent[= bEvent]
```
...
```
```javascript
this.Button00.enableevent = true;  
this.Button00.enableevent = false;
```
- **`true`** — Button 에서 이벤트가 발생하도록 설정합니다.
- **`false`** — Button 에서 이벤트가 발생하지 않도록 설정합니다.
...
> Components > Component > Button > Property > escapebutton

**Description**

활성화 된 폼에서 ESC키 입력으로 Button 의 onclick 이벤트를 발생시킬지 설정하는 속성입니다.

**Syntax**

```javascript
Button.escapebutton[= bEscape]
```
...
```
```javascript
Button00.escapebutton = true;Button00.escapebutton = false;
```
- **`true`** — 폼 내에서 ESC 키를 눌렀을 때, 해당 버튼에서 onclick 이벤트가 발생합니다.
- **`false`** — ESC 키를 입력해도 onclick 이벤트가 발생하지 않습니다.
(Default)

**Remark**

- escapebutton 속성값을 설정하지 않으면 "false"로 적용됩니다.

- 같은 폼에 escapebutton 속성을 "true"로 설정한 Button이 2개 이상 존재할 경우 마지막에 로딩된 Button의 이벤트가 발생합니다.
  Source 에 선언된 순서에 따라 컴포넌트가 로딩되므로 마지막에 선언된 Button 에서 이벤트가 발생합니다.
...
> Components > Component > Button > Property > expr

**Description**

Button 에 표시될 텍스트를 동적으로 생성하는 수식을 설정하는 속성입니다.
...
```javascript
this.Button00.expr = "3*5";this.Button00.expr = "image.text";
```
- **`strExpr`** — 텍스트로 적용될 수식을 설정합니다.
접근 가능한 영역에 정의된 함수를 설정할 수 있습니다.

설정된 수식을 동적으로 실행하여 그 결과값을 Button 에 텍스트로 표시합니다.

**Remark**

- 동적으로 Button 에 적용된 텍스트는 getDisplayText() 메서드를 사용하여 확인할 수 있습니다.
...
> Components > Component > Button > Property > fittocontents

**Description**

Button 의 내부 컨텐츠영역이 컨텐츠 내용에 맞게 자동조정되는 영역을 설정하는 속성입니다.

**Syntax**

```javascript
Button.fittocontents[= enumFitTo]
```
...
```
```javascript
this.Button00.fittocontents = "width";
```
- **`"none"`** — 컨텐츠 내용과 관계없이 디자인 시 설정한 Button 의 너비와 높이를 유지합니다.
- **`"width"`** — 컨텐츠 내용에 맞게 Button 의 내부 컨텐츠영역 너비를 자동 조정합니다.
- **`"height"`** — 컨텐츠 내용에 맞게 Button 의 내부 컨텐츠영역 높이를 자동 조정합니다.
- **`"both"`** — 컨텐츠 내용에 맞게 Button 의 내부 컨텐츠영역 너비와 높이를 자동 조정합니다.

**Remark**

- fittocontents 속성값을 설정하지 않으면 "none" 으로 적용됩니다.

- Button 의 전체 크기는 내부 컨텐츠영역 크기에 -nexa-border, -nexa-padding 영역을 더해서 결정됩니다.

- Form 이 로딩될 때와 fittocontents 속성값이 변경되었을 때만 내부 컨텐츠영역의 크기가 자동 조정됩니다.
   Bind 된 속성이나 스크립트에 의해 Button 의 컨텐츠가 변경된 경우는 내부 컨텐츠영역의 크기가 자동 조정되지 않습니다.

- Bind 된 속성에 의해 Button 의 컨텐츠가 변경되어 내부 컨텐츠영역의 크기가 다시 조정되어야 할 때는
   Form 의 onbindingvaluechanged 이벤트에서 resetScroll() 메소드를 실행하여 크기를 재조정 하여야 합니다.

- 스크립트에 의해 Button 의 컨텐츠가 변경되어 내부 컨텐츠영역의 크기가 다시 조정되어야 할 때는
...
> Components > Component > Button > Property > flexgrow
...
> Components > Component > Button > Property > flexshrink
...
> Components > Component > Button > Property > font

**Description**

Button 에서 사용하는 폰트를 설정하는 속성입니다.
...
* Script ( normal property )
this.Button00.font = "bold 12pt/30px arial, sans-serif";
```
...
> Components > Component > Button > Property > height

**Description**

Button 을(를) 표시하기 위한 높이를 설정하는 속성입니다.
...
```
```javascript
this.Button00.height = 10; 
this.Button00.height = "10px"; 
this.Button00.height = 10%"; 
this.Button00.height = Button00:10%";
```
- **`<strCompID>`** — Button 의 높이를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 Button 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 Button 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 높이가 적용됩니다.
- **`<nVal>`** — Button 의 높이를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.


* <strCompID> 값을 생략했을 때 :
- "px": Button의 높이 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 Button의 높이 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Button의 높이 결정
- "rem": MainFrame font-size 속성값을 기준으로 Button의 높이 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 Button의 높이 결정
- "%": <strCompID>의 height 속성값을 기준으로 Button의 높이 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Button > Property > hotkey

**Description**

Button 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다.

**Syntax**

```javascript
Button.hotkey[= strHotkey]
```

**Setting Syntax**

```javascript
this.Button00.hotkey = "G"; 
this.Button00.hotkey = "CTRL+A"; 
this.Button00.hotkey = "CTRL+ALT+X";
```
...
> Components > Component > Button > Property > id

**Description**

Button의 고유 식별자를 설정하는 속성입니다.
...
> Components > Component > Button > Property > initvalueid

**Description**

Button 에 적용될 InitValue 의 ID 를 설정하는 속성입니다.

**Syntax**

```javascript
Button.initvalueid[= strValueID]
```

**Setting Syntax**

- **`strValueID`** — InitValueDefinition 영역에 정의된 InitValue 파일에서 Button 에 적용할 항목의 ID 를 문자열로 설정합니다.

**Remark**

- Button 가 화면에 표시된 후에는 속성값을 설정하거나 변경 할 수 없습니다.
   Button 를 동적으로 생성 시 show() 메소드 실행 전에 속성값을 설정하여야 합니다.
...
> Components > Component > Button > Property > layoutorder
...
> Components > Component > Button > Property > left

**Description**

Button 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.Button00.left = 10; 
this.Button00.left = "10px"; 
this.Button00.left = "10%"; 
this.Button00.left = "Button00:10px"; 
this.Button00.left = "Button00:10%";
```
- **`<strCompID>`** — Button 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Button 의 좌측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 left 속성값을 기준으로 Button의 좌측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Button의 좌측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Button의 좌측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Button의 좌측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 right 속성값을 기준으로 Button의 좌측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 Button의 좌측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Button > Property > letter-spacing

**Description**

Button 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다.

**Syntax**

```javascript
Button.letterSpacing[= strspace]
```
...
* Script ( normal property )
this.Button00.letterSpacing = "2px";
```
...
> Components > Component > Button > Property > maxheight

**Description**

Button 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Button.maxheight[= nMaxHeight]
```
...
```
```javascript
this.Button00.maxheight = 20; 
this.Button00.maxheight = "20px";
```
- **`<nVal>`** — Button 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 maxheight 보다 크면 화면에 표시되는 Button 의 높이는 maxheight 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 Button 의 높이가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > Button > Property > maxwidth

**Description**

Button 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다.

**Syntax**

```javascript
Button.maxwidth[= nMaxWidth]
```
...
```
```javascript
this.Button00.maxwidth = 20; 
this.Button00.maxwidth = "20px";
```
- **`<nVal>`** — Button 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 maxwidth 보다 크면 화면에 표시되는 Button 의 너비는 maxwidth 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 Button 의 너비가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > Button > Property > minheight

**Description**

Button 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Button.minheight[= nMinHeight]
```
...
```
```javascript
this.Button00.minheight = 20; 
this.Button00.minheight = "20px";
```
- **`<nVal>`** — Button 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 minheight 보다 작다면 화면에 표시되는 Button 의 높이는 minheight 속성값으로 적용됩니다.
  표시되는 높이만 적용되고 height 속성값은 변경되지 않습니다.
...
> Components > Component > Button > Property > minwidth

**Description**

Button 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다.

**Syntax**

```javascript
Button.minwidth[= nMinWidth]
```
...
```
```javascript
this.Button00.minwidth = 20; 
this.Button00.minwidth = "20px";
```
- **`<nVal>`** — Button 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 minwidth 보다 작으면 화면에 표시되는 Button 의 너비는 minwidth 속성값으로 적용됩니다.
  표시되는 너비만 적용되고 width 속성값은 변경되지 않습니다.
...
> Components > Component > Button > Property > name

**Description**

Button 의 이름을 설정하는 속성입니다.
...
> Components > Component > Button > Property > opacity

**Description**

Button 영역의 투명도를 설정하는 속성입니다.

**Syntax**

```javascript
Button.opacity[= stropacity]
```
...
* Script ( normal property )
this.Button00.opacity = "0.8";
this.Button00.opacity = 0.8;
this.Button00.opacity = "80%";
```
...
> Components > Component > Button > Property > parent

**Description**

Button 의 부모 오브젝트를 갖는 읽기전용 속성입니다.
...
```javascript
var objParent = this.Button00.parent;
```
...
- Button 이(가) Div 와 같은 컨테이너 컴포넌트에 자식으로 존재한다면 parent 속성은 해당 컨테이너 컴포넌트를 갖습니다.
...
> Components > Component > Button > Property > positionstep

**Description**

부모 오브젝트가 화면분할기능을 사용할 때 Button 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다.

**Syntax**

```javascript
Button.positionstep[= nStep]
```

**Setting Syntax**

```javascript
this.Button00.positionstep = 0; 
this.Button00.positionstep = -1;
```
- **`nStep`** — Button 이(가) 표시될 분할화면의 인덱스를 설정합니다.
"-1" 로 설정하면 모든 분할화면에 Button 이(가) 표시됩니다.
...
> Components > Component > Button > Property > right

**Description**

Button 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.Button00.right = 10; 
this.Button00.right = "10px"; 
this.Button00.right = "10%"; 
this.Button00.right = "Button00:10px"; 
this.Button00.right = "Button00:10%";
```
- **`<strCompID>`** — Button 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Button 의 우측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 right 속성값을 기준으로 Button의 우측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Button의 우측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Button의 우측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Button의 우측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 left 속성값을 기준으로 Button의 우측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 Button의 우측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Button > Property > rtl

**Description**

Button 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다.
...
```
```javascript
var vRtl = this.Button00.rtl;
```
- **`undefined`** — undefined 설정 시 상위 컴포넌트의 rtl 속성값이 적용됩니다.

사용자가 rtl 속성값을 설정하지 않거나 삭제했을 경우 undefined 가 설정됩니다.
- **`true`** — Button 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 오른쪽으로 설정합니다.
Button 의 내부 좌표계의 기준을 오른쪽으로 설정합니다.
Button 의 텍스트 표시 기준을 오른쪽으로 설정합니다.
수직스크롤바가 있을 경우 왼쪽에 표시됩니다.
- **`false`** — Button 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
Button 의 내부 좌표계의 기준을 왼쪽으로 설정합니다.
Button 의 텍스트 표시 기준을 왼쪽으로 설정합니다.
...
- Button 부터 Environment 까지 상위의 모든 rtl 속성값이 undefined 이면
...
> Components > Component > Button > Property > tablecellarea
...
> Components > Component > Button > Property > taborder

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 Button 의 순서를 설정하는 속성입니다.

**Syntax**

```javascript
Button.taborder[= nTabOrder]
```
...
> Components > Component > Button > Property > tabstop

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 Button 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Button.tabstop[= bTabStop]
```
...
bTabStop ::= 'true' | 'false'
```
- **`"true"`** — Button 이(가) 탭키 입력에 의한 포커스를 받습니다.
- **`"false"`** — Button 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
...
> Components > Component > Button > Property > text

**Description**

Button 에 표시될 텍스트를 설정하는 속성입니다.
...
```javascript
this.Button00.text = "Print";
```
- **`strText`** — Button 에 표시될 텍스트를 설정합니다.
...
> Components > Component > Button > Property > textwidth

**Description**

Button 에 표시되는 텍스트의 출력영역 너비를 설정하는 속성입니다.

**Syntax**

```javascript
Button.textwidth[= nWidth]
```

**Setting Syntax**

```javascript
this.Button00.textwidth = 30;
```
- **`nWidth`** — 텍스트가 표시되는 내부영역의 너비를 pixel 단위의 숫자로 설정합니다.

**Remark**

- 컴포넌트에 표시되어야 할 텍스트가 길 경우 줄바꿈 처리를 하기 위해 설정합니다.
   줄바꿈을 위해서는 -nexa-word-wrap 속성을 설정하여야 합니다.

- Button 에 아이콘 이미지가 설정되어 있는 경우만 적용되는 속성입니다.
   아이콘 이미지는 -nexa-icon 속성으로 설정합니다.

**See Also**

Button.-nexa-iconButton.-nexa-word-wrap
...
> Components > Component > Button > Property > tooltiptext

**Description**

Button 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다.

**Syntax**

```javascript
Button.tooltiptext[= strToolTipText]
```

**Setting Syntax**

```javascript
this.Button00.tooltiptext = "This is ToolTip Text"; this.Button00.tooltiptext = "";          // 풍선 도움말이 표시되지 않습니다. 
this.Button00.tooltiptext = null;        // 상위 컴포넌트의 풍선 도움말이 표시됩니다.
```
...
- 마우스 포인터가 Button 영역 위에서 일정시간 움직이지 않으면 풍선도움말이 표시됩니다.
...
> Components > Component > Button > Property > tooltiptype

**Description**

Button 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다.

**Syntax**

```javascript
Button.tooltiptype[= enumTooltipType]
```
...
```
```javascript
this.Button00.tooltiptype = "hover";
```
- **`"default"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Button 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"hover"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Button 영역내에 멈춰서 일정시간이 경과하면 풍선도움말이 사라집니다.
Button 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경되거나 사라진 풍선도움말이 다시 표시됩니다.
- **`"inplace"`** — Button 의 좌측상단 안쪽에 풍선도움말을 표시합니다.

마우스 포인터가 Button 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"default,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Button 영역에 있으면 풍선도움말이 사라지지 않습니다.
- **`"hover,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Button 영역에 있으면 풍선도움말이 사라지지 않습니다.
Button 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경됩니다.
- **`"inplace,mouseleave"`** — Button 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
- 표시되었다가 사라진 풍선도움말은 마우스 포인터가 Button 영역을 나갔다가 들어오면 다시 표시됩니다.

- 마우스 포인터가 Button 영역에서 벗어나면 풍선도움말이 사라집니다.
...
> Components > Component > Button > Property > top

**Description**

Button 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.Button00.top = 10; 
this.Button00.top = "10px"; 
this.Button00.top = "10%"; 
this.Button00.top = "Button00:10px"; 
this.Button00.top = "Button00:10%";
```
- **`<strCompID>`** — Button 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Button의 상단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 top 속성값을 기준으로 Button의 상단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 Button의 상단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Button의 상단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Button의 상단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 bottom 속성값을 기준으로 Button의 상단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 Button의 상단 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Button > Property > visible

**Description**

Button 이(가) 화면에 표시될지 여부를 설정하는 속성입니다.
...
```
- **`"true"`** — Button 을(를) 화면에 표시합니다.
- **`"false"`** — Button 을(를) 화면에 표시하지 않습니다.
...
> Components > Component > Button > Property > width

**Description**

Button 을(를) 표시하기 위한 너비를 설정하는 속성입니다.
...
```
```javascript
this.Button00.width = 10; this.Button00.width = "10px"; 
this.Button00.width = "10%"; 
this.Button00.width = "Button00:10%";
```
- **`<strCompID>`** — Button 의 너비를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 Button 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 Button 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 너비가 적용됩니다.
- **`<nVal>`** — Button 의 너비를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": Button의 너비 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Button의 너비 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Button의 너비 결정
- "rem": MainFrame font-size 속성값을 기준으로 Button의 너비 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 Button의 너비 결정
- "%": <strCompID>의 width 속성값을 기준으로 Button의 너비 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Button > Property > word-spacing

**Description**

Button 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다.

**Syntax**

```javascript
Button.wordSpacing[= strwordspacing]
```
...
* Script ( normal property )
this.Button00.wordSpacing = "30px";
```
...
> Components > Component > Button > Method > addEvent

**Description**

Button 에 특정 이벤트를 선언하여 추가하는 메소드입니다.

**Syntax**

```javascript
Button.addEvent( strEventID )
```
...
| --- | --- | --- |
| strEventID | String | Button 에 추가할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.Button00.addEvent( "onmove" );
```
...
- Button 에서 특정 이벤트를 제거하려면 removeEvent() 메소드를 사용하여야 합니다.
...
> Components > Component > Button > Method > addEventHandler

**Description**

Button 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다.

**Syntax**

```javascript
Button.addEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.Button00_onmove = function( obj:nexacro.Button,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Button00.addEventHandler( "onmove", this.Button00_onmove, this);
```
...
> Components > Component > Button > Method > addEventHandlerLookup

**Description**

함수를 검색하여 Button 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다.

**Syntax**

```javascript
Button.addEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.Button00_onmove = function( obj:nexacro.Button,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Button00.addEventHandlerLookup( "onmove", "Button00_onmove", this);
```
...
> Components > Component > Button > Method > bringToFront

**Description**

부모가 동일한 컴포넌트 중 Button 이(가) 화면의 제일 앞에 표시되게 합니다.
...
- bringToFront() 메소드는 Button 을(를) 가장 나중에 표시되게 순서를 바꿉니다.
...
> Components > Component > Button > Method > bringToPrev

**Description**

부모가 동일한 컴포넌트 중 Button 이(가) 화면에 한단계 앞에 표시되게 합니다.
...
- bringToPrev() 메소드는 Button 을(를) 한단계 나중에 표시되는 컴포넌트와 순서를 바꿉니다.
...
> Components > Component > Button > Method > clearEventHandler
...
```javascript
Button.clearEventHandler( strEventID )
```
...
```javascript
var nCnt = this.Button00.clearEventHandler( "onmove" );
```
...
> Components > Component > Button > Method > click

**Description**

Button 의 onclick 이벤트를 강제로 발생시키는 메소드입니다.
...
- click() 메소드에 의해 onclick 이벤트 발생 시 이벤트정보 오브젝트(e 오브젝트)의 좌표관련 속성값은 모두 "-1"이 됩니다.
...
> Components > Component > Button > Method > destroy

**Description**

스크립트에서 동적으로 생성한 Button 을(를) 삭제하는 메소드입니다.
...
var bSucc = this.Button00.destroy();

**Return**

| Type | Description |
| --- | --- |
| Boolean | Button 이(가) 정상적으로 삭제되면 true 를 반환합니다.

Button 이(가) 정상적으로 삭제되지 않으면 false 를 반환합니다. |

**Remark**

- 동적으로 생성한 Button 을(를) 완전히 삭제하기 위해서는 destroy() 메소드를 호출해야 합니다.

**See Also**

Button.initButton.showForm.addChildForm.insertChildForm.removeChild
...
> Components > Component > Button > Method > findEventHandler

**Description**

Button 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다.

**Syntax**

```javascript
Button.findEventHandler( strEventID, objFunc, objTarget )
```
...
var nIndex = this.Button00.findEventHandler( "onmove", this.Button00_onmove, this );
```
...
> Components > Component > Button > Method > getDisplayText

**Description**

Button 에 표시된 텍스트값을 반환하는 메소드입니다.

**Syntax**

```javascript
Button.getDisplayText()
```

**Parameters**

var strTxt = this.Button00.getDisplayText() ;

**Return**

| Type | Description |
| --- | --- |
| String | Button 에 표시된 텍스트값을 반환합니다. |
...
> Components > Component > Button > Method > getEventHandler

**Description**

Button 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다.

**Syntax**

```javascript
Button.getEventHandler( strEventID, nIdx )
```
...
```javascript
var objFunc = Button00.getEventHandler( "onmove", 0 );
```
...
> Components > Component > Button > Method > getOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Button 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
Button.getOffsetBottom();
```

**Parameters**

var nBottom = this.Button.getOffsetBottom();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 Button 의 bottom 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 Button 의 bottom 값을 동적으로 계산합니다.
...
> Components > Component > Button > Method > getOffsetHeight

**Description**

Button 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nHeight = this.Button.getOffsetHeight();

**Return**

| Type | Description |
| --- | --- |
| Number | Button 의 높이를 픽셀단위의 숫자로 변환하여 반환합니다. |

**Remark**

- 화면에 표시된 Button 의 높이를 동적으로 계산합니다.
...
> Components > Component > Button > Method > getOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Button 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
Button.getOffsetLeft();
```

**Parameters**

var nleft = this.Button.getOffsetLeft();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 Button 의 left 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 Button 의 left 값을 동적으로 계산합니다.
...
> Components > Component > Button > Method > getOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Button 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
Button.getOffsetRight();
```

**Parameters**

var nRight = this.Button.getOffsetRight();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 Button 의 right 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 Button 의 right 값을 동적으로 계산합니다.
...
> Components > Component > Button > Method > getOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Button 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nTop = this.Button.getOffsetTop();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 Button 의 top 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 Button 의 top 값을 동적으로 계산합니다.
...
> Components > Component > Button > Method > getOffsetWidth

**Description**

Button 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nWidth = this.Button.getOffsetWidth();

**Return**

| Type | Description |
| --- | --- |
| Number | Button 의 너비를 픽셀단위의 숫자로 변환하여 반환합니다. |

**Remark**

- 화면에 표시된 Button 의 너비를 동적으로 계산합니다.
...
> Components > Component > Button > Method > getPixelBottom

**Description**

Button 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
Button.getPixelBottom();
```

**Parameters**

var nbottom = this.Button.getPixelBottom();

**Return**

| Type | Description |
| --- | --- |
| Number | Button 의 bottom 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Button > Method > getPixelHeight

**Description**

Button 의 height 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nheight = this.Button.getPixelHeight();

**Return**

| Type | Description |
| --- | --- |
| Number | Button 의 height 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Button > Method > getPixelLeft

**Description**

Button 의 left 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nleft = this.Button.getPixelLeft();

**Return**

| Type | Description |
| --- | --- |
| Number | Button 의 left 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Button > Method > getPixelRight

**Description**

Button 의 right 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
Button.getPixelRight();
```

**Parameters**

var nright = this.Button.getPixelRight();

**Return**

| Type | Description |
| --- | --- |
| Number | Button 의 right 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Button > Method > getPixelTop

**Description**

Button 의 top 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var ntop = this.Button.getPixelTop();

**Return**

| Type | Description |
| --- | --- |
| Number | Button 의 top 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Button > Method > getPixelWidth

**Description**

Button 의 width 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nwidth = this.Button.getPixelWidth();

**Return**

| Type | Description |
| --- | --- |
| Number | Button 의 width 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Button > Method > getSelectStatus

**Description**

현재 Button의 Status가 Selected 인지 확인하는 메소드입니다.

**Syntax**

```javascript
Button.getSelectStatus()
```

**Parameters**

var bStatus = this.Button00.getSelectStatus();

**Return**

| Type | Description |
| --- | --- |
| Boolean | Button의 Status가 Selected이면 "true"를 반환합니다.
Button의 Status가 Selected가 아니면 "false"를 반환합니다. |

**Remark**

- Button의 Status가 Selected이면 XCSS에 정의된 스타일값이 적용됩니다.
...
> Components > Component > Button > Method > init

**Description**

스크립트로 Button 을(를) 동적 생성한 후에 초기화하는 메소드입니다.
...
| vLeft | String, Number | Button 의 left 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 right 속성값을 기준으로 Button 의 left 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 Button 의 left 가 결정됩니다. |
| vTop | String, Number | Button 의 top 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 bottom 속성값을 기준으로 Button 의 top 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Button 의 top 이 결정됩니다. |
| vWidth | String, Number | Button 의 width 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 Button 의 width 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 Button 의 width 가 결정됩니다. |
| vHeight | String, Number | Button 의 height 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 Button 의 height 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Button 의 height 가 결정됩니다. |
| vRight | String, Number | Button 의 right 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vLeft, vWidth 값을 모두 설정했을 경우 vRight 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 left 속성값을 기준으로 Button 의 right 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 Button 의 right 가 결정됩니다. |
| vBottom | String, Number | Button 의 bottom 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vTop, vHeight 값을 모두 설정했을 경우 vBottom 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 top 속성값을 기준으로 Button 의 bottom 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Button 의 bottom 이 결정됩니다. |
| vMinWidth | String, Number | Button 이(가) 화면에 표시되는 최소 너비값을 pixel 단위의 숫자로 설정합니다. |
| vMaxWidth | String, Number | Button 이(가) 화면에 표시되는 최대 너비값을 pixel 단위의 숫자로 설정합니다.

vMinWidth 보다 작은 값을 설정하면 vMinWidth 값으로 설정됩니다. |
| vMinHeight | String, Number | Button 이(가) 화면에 표시되는 최소 높이값을 pixel 단위의 숫자로 설정합니다. |
| vMaxHeight | String, Number | Button 이(가) 화면에 표시되는 최대 높이값을 pixel 단위의 숫자로 설정합니다.
...
objComp.init( "Button00", "Button22:10", 300, null, null, "Button33:10", "20%", 300, 500, 200, 500 );
```
...
- 인수값에 기준 컴포넌트를 포함하면 Button 의 위치는 기준 컴포넌트를 기준으로 상대적으로 결정됩니다.
  vLeft, vTop, vWidth, vHeight, vRight, vBottom 값에 기준 컴포넌트를 포함할 때는 "ID:Value" 형태로 설정하여야 합니다.

- 기준 컴포넌트는 Button 와(과) 부모(Parent)가 동일하여야 하며, Form 로딩 시 Button 보다 먼저 생성되어야 합니다.
...
Button.destroyButton.showForm.addChildForm.insertChildForm.removeChild
...
> Components > Component > Button > Method > insertEventHandler

**Description**

Button 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다.

**Syntax**

```javascript
Button.insertEventHandler( strEventID, nIndex, objFunc, objTarget )
```
...
var nIndex = this.Button00.insertEventHandler( "onmove", 0, this.Button00_onmove, this);
```
...
> Components > Component > Button > Method > move

**Description**

Button 의 위치와 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
Button.move( vLeft, vTop [, vWidth, vHeight [, vRight, vBottom]] )
```
...
```javascript
this.Button00.move(10,10);
this.Button00.move(10,10,100,100);
this.Button00.move(null, null, 300, "400px", "80%", 300 );
```
...
> Components > Component > Button > Method > moveToNext

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Button 이(가) 화면에 한단계 뒤에 표시되게 합니다.

**Syntax**

```javascript
Button.moveToNext( objComp )
Button.moveToNext( strComp )
```
...
```javascript
this.Button.moveToNext( this.Button00 );
this.Button.moveToNext( "Button00" );
```
...
- 인수로 전달되는 기준 컴포넌트와 Button 은(는) 부모가 동일하여야 합니다.

- 디자인 시 소스에 컴포넌트가 선언된 순서대로 화면에 표시됩니다.
  소스에서 위에 선언된 컴포넌트가 먼저 표시되고, 아래에 선언된 컴포넌트가 나중에 표시되게 됩니다.
  컴포넌트가 겹쳐져 있을 경우 화면에 표시되는 순서에 따라 먼저 표시된 컴포넌트가 나중에 표시되는 컴포넌트에 가려지게 됩니다.

- moveToNext() 메소드는 기준 컴포넌트보다 Button 이(가) 한단계 먼저 표시되게 순서를 바꿉니다.
...
> Components > Component > Button > Method > moveToPrev

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Button 이(가) 화면에 한단계 앞에 표시되게 합니다.

**Syntax**

```javascript
Button.moveToPrev( objComp )
Button.moveToPrev( strComp )
```
...
```javascript
this.Button.moveToPrev( this.Button00 );
this.Button.moveToPrev( "Button00" );
```
...
- moveToPrev() 메소드는 기준 컴포넌트보다 Button 이(가) 한단계 나중에 표시되게 순서를 바꿉니다.
...
> Components > Component > Button > Method > removeEvent

**Description**

Button 에 선언된 특정 이벤트를 삭제하는 메소드입니다.

**Syntax**

```javascript
Button.removeEvent( strEventID )
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| strEventID | String | Button 에서 삭제할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.Button00.removeEvent( "onmove" );
```
...
- Button 에 특정 이벤트를 추가하려면 addEvent() 메소드를 사용하여야 합니다.

- Button 에 기본으로 선언되어 있는 이벤트 삭제 시 오동작 할 수 있으므로 주의하여야 합니다.
...
> Components > Component > Button > Method > removeEventHandler

**Description**

Button 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
Button.removeEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.Button00_onmove = function( obj:nexacro.Button,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Button00.removeEventHandler( "onmove", this.Button00_onmove, this);
```
...
> Components > Component > Button > Method > removeEventHandlerLookup

**Description**

Button 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
Button.removeEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.Button00_onmove = function( obj:nexacro.Button,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Button00.removeEventHandlerLookup( "onmove", "Button00_onmove", this);
```
...
> Components > Component > Button > Method > resize

**Description**

Button 의 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
Button.resize( vWidth, vHeight )
```
...
- Button 의 left 속성값이 null 이 아니면 resize() 메소드 실행 후 Button 의 우측 위치가 변경됩니다.
  또한, 메소드 실행 후 right 속성값은 null 이 됩니다.

- Button 의 left 속성값이 null 이면 resize() 메소드 실행 후 Button 의 좌측 위치가 변경됩니다.
  또한, 메소드 실행 후 left 속성값은 null 로 유지됩니다.

- Button 의 top 속성값이 null 이 아니면 resize() 메소드 실행 후 Button 의 하단 위치가 변경됩니다.
  또한, 메소드 실행 후 bottom 속성값은 null 이 됩니다.

- Button 의 top 속성값이 null 이면 resize() 메소드 실행 후 Button 의 상단 위치가 변경됩니다.
...
> Components > Component > Button > Method > sendToBack

**Description**

부모가 동일한 컴포넌트 중 Button 이(가) 화면의 제일 뒤에 표시되게 합니다.
...
- sendToBack() 메소드는 Button 을(를) 가장 먼저 표시되게 순서를 바꿉니다.
...
> Components > Component > Button > Method > sendToNext

**Description**

부모가 동일한 컴포넌트 중 Button 이(가) 화면에 한단계 뒤에 표시되게 합니다.
...
- sendToNext() 메소드는 Button 을(를) 한단계 먼저 표시되는 컴포넌트와 순서를 바꿉니다.
...
> Components > Component > Button > Method > setEventHandler

**Description**

Button 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다.
...
```javascript
this.Button00_onmove = function( obj:nexacro.Button,  e:nexacro.MoveEventInfo ) { //수행할 스크립트 };
var nIndex = this.Button00.setEventHandler( "onmove", this.Button00_onmove, this );
```
...
> Components > Component > Button > Method > setEventHandlerLookup

**Description**

Button 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다.

**Syntax**

```javascript
Button.setEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.Button00_onmove = function( obj:nexacro.Button,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Button00.setEventHandlerLookup( "onmove", "Button00_onmove", this);
```
...
> Components > Component > Button > Method > setFocus

**Description**

Button 에 포커스를 설정하는 메서드입니다.

**Syntax**

```javascript
Button.setFocus( [bMoveScroll] )
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| bMoveScroll | Boolean | 부모 컴포넌트에 스크롤이 있을 경우, Button 기준으로 스크롤을 이동할지 여부를 설정합니다.

true: Button 이(가) 화면에 표시되도록 스크롤을 이동합니다.
false: Button 위치와 관계없이 스크롤을 이동하지 않습니다.
...
```javascript
var objBefComp = this.Button00.setFocus();
var objBefComp = this.Button00.setFocus( false );
```
...
| Type | Description |
| --- | --- |
| Object | Button 이(가) 포커스를 얻기 전에 포커스를 가지고 있던 컴포넌트를 반환합니다.
...
> Components > Component > Button > Method > setOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Button 의 bottom 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Button.setOffsetBottom( nBottom );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nBottom | Number | 부모 컴포넌트의 Top 위치를 기준으로 Button 의 bottom 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Button.setOffsetBottom( 10 );
```
...
- 메소드 실행 전 Button 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Button 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > Button 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > Button 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 height, bottom 속성이 설정됩니다.
...
> Components > Component > Button > Method > setOffsetHeight

**Description**

Button 의 높이를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Button.setOffsetHeight( nHeight );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nHeight | Number | Button 의 높이를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Button.setOffsetHeight( 10 );
```
...
> Components > Component > Button > Method > setOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Button 의 left 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Button.setOffsetLeft( nLeft );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nLeft | Number | 부모 컴포넌트의 Left 위치를 기준으로 Button 의 left 값을 픽셀단위의 숫자로 설정합니다 |

**Sample Call**

```javascript
this.Button.setOffsetLeft( 10 );
```
...
- 메소드 실행 전 Button 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Button 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > Button 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, right 속성이 설정됩니다.
   > Button 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
...
> Components > Component > Button > Method > setOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Button 의 right 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Button.setOffsetRight( nRight );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nRight | Number | 부모 컴포넌트의 Left 위치를 기준으로 Button 의 right 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Button.setOffsetRight( 600 );
```
...
- 메소드 실행 전 Button 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Button 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > Button 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > Button 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 width, right 속성이 설정됩니다.
...
> Components > Component > Button > Method > setOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Button 의 top 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Button.setOffsetTop( nTop );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nTop | Number | 부모 컴포넌트의 Top 위치를 기준으로 Button 의 top 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Button.setOffsetTop( 10 );
```
...
- 메소드 실행 전 Button 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Button 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > Button 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, bottom 속성이 설정됩니다.
   > Button 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
...
> Components > Component > Button > Method > setOffsetWidth

**Description**

Button 의 너비를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Button.setOffsetWidth( nWidth );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nWidth | Number | Button 의 너비를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Button.setOffsetWidth( 10 );
```
...
> Components > Component > Button > Method > setSelectStatus

**Description**

Button에 Selected Status를 적용하거나 제거하는 메소드입니다.

**Syntax**

```javascript
Button.setSelectStatus( bSelect )
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| bSelect | Boolean | true이면 선택된 상태로 설정되고, false이면 선택되지 않은 상태로 설정됩니다. |

**Sample Call**

```javascript
var bOldSelect = this.Button00.setSelectStatus(true);
```
...
| Type | Description |
| --- | --- |
| Boolean | 메소드 실행 전에 Button의 Status가 Selected 였다면 "true"를 반환합니다.
메소드 실행 전에 Button의 Status가 Selected 가 아니였다면 "false"를 반환합니다. |

**Remark**

- Button 이 가질 수 있는 Status는 Disabled, Focused, Mouseover, Pushed, Selected 입니다.
  Selected 와 Disabled 를 제외한 Status는 마우스의 움직임에 따라 결정되므로 따로 발생 시점을 지정할 수 없습니다.

- Selected Status를 지정하기 위해서는 스크립트로 접근하여야 합니다.

- bSelect 값이 "true"이면 메소드 실행 후 XCSS에 정의된 Selected Status 값이 Button에 적용됩니다.
...
> Components > Component > Button > Method > show

**Description**

스크립트로 동적 생성한 Button 을(를) 화면에 표시하는 메소드입니다.
...
Button.destroyButton.initForm.addChildForm.insertChildForm.removeChild
...
> Components > Component > Button > Method > toggleSelectStatus

**Description**

Button에 Selected Status 적용을 토글시키는 메소드입니다.

**Syntax**

```javascript
Button.toggleSelectStatus()
```

**Parameters**

var bOldSelect = this.Button00.toggleSelectStatus();
...
- Button에 Selected Status 가 적용되어 있다면 제거합니다.

- Button에 Selected Status 가 적용되어 있지 않다면 적용합니다.
...
> Components > Component > Button > Event > onclick

**Description**

Button 영역 내에서 마우스 왼쪽버튼을 클릭했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onclick(obj:nexacro.Button,e:nexacro.ClickEventInfo);
```
...
- Button 영역 내에서 마우스의 lbuttondown 액션과 lbuttonup 액션이 발생되어야 합니다.
...
> Components > Component > Button > Event > oncontextmenu

**Description**

Button 영역에서 오른쪽 마우스 버튼을 클릭하거나 터치를 일정시간 유지할 때 발생하는 이벤트입니다.

**Syntax**

```javascript
oncontextmenu(obj:nexacro.Button,e:nexacro.ContextMenuEventInfo);
```
...
- Button 컴포넌트는 마우스 우클릭이나 터치에 의해 표시되는 기본팝업메뉴가 제공되지 않습니다.
...
> Components > Component > Button > Event > ondblclick

**Description**

Button 영역 내에서 마우스 왼쪽버튼을 더블클릭 했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondblclick(obj:nexacro.Button,e:nexacro.MouseEventInfo);
```
...
> Components > Component > Button > Event > ondevicebuttonup
...
```javascript
ondevicebuttonup(obj:nexacro.Button,e:nexacro.DeviceButtonEventInfo);
```
...
> Components > Component > Button > Event > ondrag

**Description**

Button 영역 내에서 마우스 왼쪽버튼으로 드래그를 수행했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondrag(obj:nexacro.Button,e:nexacro.DragEventInfo);
```
...
- Button 영역 내에서 마우스의 LButtonDown 후 LButtonUp 액션 없이 마우스 이동 시 ondrag 이벤트가 발생합니다.
...
> Components > Component > Button > Event > ondragenter

**Description**

Button 영역 내로 드래그 상태의 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragenter(obj:nexacro.Button,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 Button 영역으로 마우스 포인터가 들어올 때마다 이벤트가 발생합니다.
...
> Components > Component > Button > Event > ondragleave

**Description**

Button 영역 밖으로 드래그 상태의 마우스 포인터가 나갈 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragleave(obj:nexacro.Button,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 Button 영역에서 마우스 포인터가 나갈 때마다 이벤트가 발생합니다.
...
> Components > Component > Button > Event > ondragmove

**Description**

Button 영역 내에서 드래그 상태의 마우스 포인터가 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondragmove(obj:nexacro.Button,e:nexacro.DragEventInfo);
```
...
- 드래그 상태를 유지하고 있으면 Button 영역 내에서 마우스 포인터가 움직일 때마다 이벤트가 발생합니다.
...
> Components > Component > Button > Event > ondrop

**Description**

Button 영역 내에서 드래그 상태의 마우스 버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ondrop(obj:nexacro.Button,e:nexacro.DragEventInfo);
```
...
- Button 영역 내에서 드래그 상태인 마우스의 LButtonUp 액션 발생 시 ondrop 이벤트가 발생합니다.
...
> Components > Component > Button > Event > onkeydown

**Description**

Button 에 포커스가 있는 상태에서 키보드의 키가 눌렸을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkeydown(obj:nexacro.Button,e:nexacro.KeyEventInfo);
```
...
> Components > Component > Button > Event > onkeyup

**Description**

Button 에 포커스가 있는 상태에서 눌렸던 키보드가 떼어질 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkeyup(obj:nexacro.Button,e:nexacro.KeyEventInfo);
```
...
> Components > Component > Button > Event > onkillfocus

**Description**

Button 에서 포커스가 나갈  때 발생하는 이벤트입니다.

**Syntax**

```javascript
onkillfocus(obj:nexacro.Button,e:nexacro.KillFocusEventInfo);
```
...
- showModal(), open() 등의 메소드로 팝업된 Frame 으로 포커스가 이동하는 경우 Button 에서 포커스 관련 이벤트가 발생하지 않습니다.
   또한, alert(), confirm() 메소드로 표시된 팝업으로 포커스가 이동하는 경우도 Button 에서 포커스 관련 이벤트가 발생하지 않습니다.
...
> Components > Component > Button > Event > onlbuttondown

**Description**

Button 영역 내에서 마우스 왼쪽버튼을 눌렀을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onlbuttondown(obj:nexacro.Button,e:nexacro.MouseEventInfo);
```
...
- Button 영역 내에서 마우스의 LButtonDown 액션이 발생하면 이벤트가 발생합니다.
...
> Components > Component > Button > Event > onlbuttonup

**Description**

Button 영역 내에서 눌렸던 마우스 왼쪽버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onlbuttonup(obj:nexacro.Button,e:nexacro.MouseEventInfo);
```
...
> Components > Component > Button > Event > onmouseenter

**Description**

Button 영역 내로 마우스 포인터가 들어왔을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmouseenter(obj:nexacro.Button,e:nexacro.MouseEventInfo);
```
...
> Components > Component > Button > Event > onmouseleave

**Description**

Button 영역 밖으로 마우스 포인터가 나갈 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmouseleave(obj:nexacro.Button,e:nexacro.MouseEventInfo);
```
...
> Components > Component > Button > Event > onmousemove

**Description**

Button 영역 내에서 마우스 포인터가 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmousemove(obj:nexacro.Button,e:nexacro.MouseEventInfo);
```
...
> Components > Component > Button > Event > onmove

**Description**

Button 의 위치가 이동했을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onmove(obj:nexacro.Button,e:nexacro.MoveEventInfo);
```
...
> Components > Component > Button > Event > onrbuttondown

**Description**

Button 영역 내에서 마우스 오른쪽버튼을 눌렀을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onrbuttondown(obj:nexacro.Button,e:nexacro.MouseEventInfo);
```
...
> Components > Component > Button > Event > onrbuttonup

**Description**

Button 영역 내에서 마우스 오른쪽버튼을 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onrbuttonup(obj:nexacro.Button,e:nexacro.MouseEventInfo);
```
...
> Components > Component > Button > Event > onsetfocus

**Description**

Button 에 포커스가 들어올 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onsetfocus(obj:nexacro.Button,e:nexacro.SetFocusEventInfo);
```
...
- open() 메소드로 오픈된 Modeless 창에서 부모창의 Button 에 setFocus() 메소드 실행 시 환경에 따라 동작에 차이가 있으므로 주의하여야 합니다.
...
> Components > Component > Button > Event > onsize

**Description**

Button 의 크기가 변경됐을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
onsize(obj:nexacro.Button,e:nexacro.SizeEventInfo);
```
...
> Components > Component > Button > Event > ontouchend

**Description**

Button 영역 내에서 터치를 떼었을 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchend(obj:nexacro.Button,e:nexacro.TouchEventInfo);
```
...
> Components > Component > Button > Event > ontouchmove

**Description**

Button 영역 내에서 터치 상태를 유지하며 움직일 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchmove(obj:nexacro.Button,e:nexacro.TouchEventInfo);
```
...
> Components > Component > Button > Event > ontouchstart

**Description**

Button 영역 내에서 터치가 시작될 때 발생하는 이벤트입니다.

**Syntax**

```javascript
ontouchstart(obj:nexacro.Button,e:nexacro.TouchEventInfo);
```
