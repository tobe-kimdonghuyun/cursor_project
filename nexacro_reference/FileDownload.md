...
## Components > Component > FileDownload
...
| Name | Description |
| --- | --- |
| accessibilityaction | FileDownload에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다. |
| accessibilitydesclevel | FileDownload 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| accessibilitydescription | FileDownload에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다. |
| accessibilityenable | FileDownload 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| accessibilitylabel | FileDownload에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다. |
| accessibilityrole | FileDownload에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다. |
| background | FileDownload 의 배경 영역을 설정하는 속성입니다. |
| border-radius | FileDownload 의 모서리 모양을 설정하는 속성입니다. |
| bottom | FileDownload 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다. |
| box-shadow | FileDownload 에 그림자 효과를 설정하는 속성입니다. |
| color | FileDownload 에 표시되는 텍스트의 색상을 설정하는 속성입니다. |
| cssclass | FileDownload 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다. |
| cursor | FileDownload 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다. |
| downloadfilename | 파일 다운로드 시 표시되는 파일선택창에 기본으로 표시될 파일명을 설정합니다. |
| downloadurl | FileDownload 에서 다운로드 받을 파일의 경로를 설정하는 속성입니다. |
| enable | FileDownload 의 사용가능 여부를 설정하는 속성입니다. |
| enableevent | FileDownload 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다. |
| expr | FileDownload 에 표시될 텍스트를 동적으로 생성하는 수식을 설정하는 속성입니다. |
| filefilter | 파일 다운로드 시 표시되는 파일선택창에 적용될 파일형식을 설정하는 속성입니다. |
| filefilterindex | 파일선택창에 기본으로 표시될 파일형식을 인덱스값으로 설정하는 속성입니다. |
| fittocontents | FileDownload 의 내부 컨텐츠영역이 컨텐츠 내용에 맞게 자동조정되는 영역을 설정하는 속성입니다. |
...
| font | FileDownload 에서 사용하는 폰트를 설정하는 속성입니다. |
| height | FileDownload 을(를) 표시하기 위한 높이를 설정하는 속성입니다. |
| hotkey | FileDownload 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다. |
| id | FileDownload의 고유 식별자를 설정하는 속성입니다. |
| layoutorder | Layout 컨테이너 내 Main Axis(type 속성값이 "horizontal"이면 수평축, type 속성값이 "vertical"이면 수직축)에 컴포넌트가 배치되는 순서를 설정합니다. |
| left | FileDownload 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다. |
| letter-spacing | FileDownload 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다. |
| maxheight | FileDownload 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다. |
| maxwidth | FileDownload 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다. |
| minheight | FileDownload 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다. |
| minwidth | FileDownload 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다. |
| name | FileDownload 의 이름을 설정하는 속성입니다. |
| -nexa-border | FileDownload 의 테두리를 설정하는 속성입니다. |
| -nexa-edge | FileDownload 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-icon | FileDownload에서 텍스트와 함께 표시 될 아이콘 이미지를 설정하는 속성입니다. |
| -nexa-icon-position | FileDownload에서 텍스트와 함께 표시 될 아이콘 이미지의 위치를 설정하는 속성입니다. |
| -nexa-padding | FileDownload 영역의 안쪽 여백을 설정하는 속성입니다. |
| -nexa-rtl-background-image | FileDownload 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다. |
| -nexa-rtl-edge-image | FileDownload 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-rtl-icon | FileDownload 의 rtl 속성이 true 로 적용될 때 표시될 아이콘 이미지를 설정하는 속성입니다. |
| -nexa-text-align | FileDownload 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다. |
| -nexa-text-decoration | FileDownload 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다. |
| -nexa-text-padding | FileDownload 에 표시되는 아이콘과 텍스트의 간격을 설정하는 속성입니다. |
| -nexa-vertical-align | FileDownload 에 표시되는 텍스트 또는 컨텐츠의 세로 정렬 방식을 설정하는 속성입니다. |
| -nexa-word-wrap | FileDownload 에 표시되는 텍스트가 출력영역보다 길 경우 자동으로 줄바꿈 되도록 설정하는 속성입니다. |
| opacity | FileDownload 영역의 투명도를 설정하는 속성입니다. |
| parent | FileDownload 의 부모 오브젝트를 갖는 읽기전용 속성입니다. |
| positionstep | 부모 오브젝트가 화면분할기능을 사용할 때 FileDownload 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다. |
| right | FileDownload 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다. |
| rtl | FileDownload 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다. |
| tablecellarea | Layout 컨테이너 내 가상의 Table Cell 영역 내에서 컴포넌트가 배치되는 영역을 설정합니다. |
| taborder | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 FileDownload 의 순서를 설정하는 속성입니다. |
| tabstop | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 FileDownload 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다. |
| text | FileDownload 에 표시될 텍스트를 설정하는 속성입니다. |
| tooltiptext | FileDownload 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다. |
| tooltiptype | FileDownload 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다. |
| top | FileDownload 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다. |
| visible | FileDownload 이(가) 화면에 표시될지 여부를 설정하는 속성입니다. |
| width | FileDownload 을(를) 표시하기 위한 너비를 설정하는 속성입니다. |
| word-spacing | FileDownload 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다. |

**Method**

| Name | Description |
| --- | --- |
| addEvent | FileDownload 에 특정 이벤트를 선언하여 추가하는 메소드입니다. |
| addEventHandler | FileDownload 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다. |
| addEventHandlerLookup | 함수를 검색하여 FileDownload 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다. |
| bringToFront | 부모가 동일한 컴포넌트 중 FileDownload 이(가) 화면의 제일 앞에 표시되게 합니다. |
| bringToPrev | 부모가 동일한 컴포넌트 중 FileDownload 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| clearEventHandler | 특정 이벤트에 등록된 핸들러 함수를 모두 제거하는 메소드입니다. |
| destroy | 스크립트에서 동적으로 생성한 FileDownload 을(를) 삭제하는 메소드입니다. |
| download | 웹에 저장된 특정 파일을 HTTP/HTTPS 통신방식으로 다운로드 받는 메소드입니다. |
| findEventHandler | FileDownload 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다. |
| getDisplayText | FileDownload 에 표시된 텍스트값을 반환하는 메소드입니다. |
| getEventHandler | FileDownload 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다. |
| getOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 FileDownload 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetHeight | FileDownload 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 FileDownload 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 FileDownload 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 FileDownload 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetWidth | FileDownload 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getPixelBottom | FileDownload 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelHeight | FileDownload 의 height 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelLeft | FileDownload 의 left 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelRight | FileDownload 의 right 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelTop | FileDownload 의 top 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelWidth | FileDownload 의 width 속성값을 픽셀단위로 반환하는 메소드입니다. |
| init | 스크립트로 FileDownload 을(를) 동적 생성한 후에 초기화하는 메소드입니다. |
| insertEventHandler | FileDownload 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다. |
| move | FileDownload 의 위치와 크기를 변경하는 메소드입니다. |
| moveToNext | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 FileDownload 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| moveToPrev | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 FileDownload 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| removeEvent | FileDownload 에 선언된 특정 이벤트를 삭제하는 메소드입니다. |
| removeEventHandler | FileDownload 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다. |
| removeEventHandlerLookup | FileDownload 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다. |
| resize | FileDownload 의 크기를 변경하는 메소드입니다. |
| sendToBack | 부모가 동일한 컴포넌트 중 FileDownload 이(가) 화면의 제일 뒤에 표시되게 합니다. |
| sendToNext | 부모가 동일한 컴포넌트 중 FileDownload 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| setEventHandler | FileDownload 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다. |
| setEventHandlerLookup | FileDownload 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다. |
| setFocus | FileDownload 에 포커스를 설정하는 메서드입니다. |
| setOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 FileDownload 의 bottom 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetHeight | FileDownload 의 높이를 픽셀단위로 설정하는 메소드입니다. |
| setOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 FileDownload 의 left 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 FileDownload 의 right 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 FileDownload 의 top 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetWidth | FileDownload 의 너비를 픽셀단위로 설정하는 메소드입니다. |
| show | 스크립트로 동적 생성한 FileDownload 을(를) 화면에 표시하는 메소드입니다. |
...
> Components > Component > FileDownload > Property > -nexa-border

**Description**

FileDownload 의 테두리를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.border[= strborder]
```
...
this.FileDownload00.border = "1px solid #999999";
this.FileDownload00.border = "1px solid #999999, 1px solid #999999, 1px solid #999999, 1px solid #999999";
```
...
> Components > Component > FileDownload > Property > -nexa-edge

**Description**

FileDownload 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.edge[= stredge]
```
...
* Script ( normal property )
this.FileDownload00.edge = "URL('./images/border.png')" 5px 5px;
```
...
- FileDownload 내부에 테두리 형태로 이미지를 표시하고자 할 때 사용하는 속성입니다.
...
> Components > Component > FileDownload > Property > -nexa-icon

**Description**

FileDownload에서 텍스트와 함께 표시 될 아이콘 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.icon[= strurl]
```
...
* Script ( normal property )
this.FileDownload.icon = "URL('./images/smiley.gif')" ;
this.FileDownload.icon = "URL('theme://images/border.png')";
```
- **`<Theme-Image>`** — 테마에 선언된 이미지를 "theme://images/이미지명" 형식으로 설정합니다.
...
> Components > Component > FileDownload > Property > -nexa-icon-position

**Description**

FileDownload에서 텍스트와 함께 표시 될 아이콘 이미지의 위치를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.iconPosition[= striconpos]
```
...
* Script ( normal property )
this.FileDownload.iconPosition = "left";
```
...
> Components > Component > FileDownload > Property > -nexa-padding

**Description**

FileDownload 영역의 안쪽 여백을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.padding[= strpadding]
```
...
* Script ( normal property )
this.FileDownload00.padding = "5px 5px 5px 5px";
```
- **`<npadding>`** — FileDownload 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
- -nexa-padding 속성은 내부 컨텐츠영역과 FileDownload 사이의 여백으로 적용됩니다.
...
> Components > Component > FileDownload > Property > -nexa-rtl-background-image

**Description**

FileDownload 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.-nexa-rtl-background-image
```
...
> Components > Component > FileDownload > Property > -nexa-rtl-edge-image

**Description**

FileDownload 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.-nexa-rtl-edge-image
```
...
> Components > Component > FileDownload > Property > -nexa-rtl-icon

**Description**

FileDownload 의 rtl 속성이 true 로 적용될 때 표시될 아이콘 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.-nexa-rtl-icon
```
...
> Components > Component > FileDownload > Property > -nexa-text-align

**Description**

FileDownload 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.textAlign[= strtextalign]
```
...
* Script ( normal property )
this.FileDownload00.textAlign = "center";
```
...
- FileDownload 의 너비보다 표시되는 텍스트의 길이가 크면 "right" 를 설정해도 "left" 로 동작됩니다.
...
> Components > Component > FileDownload > Property > -nexa-text-decoration

**Description**

FileDownload 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.textDecoration[= strTxtDeco]
```
...
* Script ( normal property )
this.FileDownload00.textDecoration = "underline overline";
```
...
> Components > Component > FileDownload > Property > -nexa-text-padding

**Description**

FileDownload 에 표시되는 아이콘과 텍스트의 간격을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.textPadding[= strtextpadding]
```
...
* Script ( normal property )
this.FileDownload00.textPadding = "5px 5px 5px 5px";
```
...
- FileDownload 에 표시되는 아이콘이 없을 경우 -nexa-text-padding 속성값은 무시됩니다.
...
> Components > Component > FileDownload > Property > -nexa-vertical-align

**Description**

FileDownload 에 표시되는 텍스트 또는 컨텐츠의 세로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.verticalAlign[= strvertalign]
```
...
* Script ( normal property )
this.FileDownload00.verticalAlign = "middle";
```
...
> Components > Component > FileDownload > Property > -nexa-word-wrap

**Description**

FileDownload 에 표시되는 텍스트가 출력영역보다 길 경우 자동으로 줄바꿈 되도록 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.wordWrap[= strwordwrap]
```
...
* Script ( normal property )
this.FileDownload.wordWrap = "char";
```
...
> Components > Component > FileDownload > Property > accessibilityaction

**Description**

FileDownload에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.accessibilityaction[= strAction]
```

**Setting Syntax**

```javascript
this.FileDownload00.accessibilityaction = "Accessibility Action Message"; 
this.FileDownload00.accessibilityaction = "Select by direction key";
```
...
> Components > Component > FileDownload > Property > accessibilitydesclevel

**Description**

FileDownload 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.accessibilitydesclevel[= enumLevel]
```
...
```
```javascript
this.FileDownload00.accessibilitydesclevel = "all";
```
- **`"all"`** — FileDownload 와 자식 컴포넌트에 대한 접근성을 모두 출력합니다.
- **`"self"`** — FileDownload 의 접근성만 출력하고 자식 컴포넌트의 접근성은 출력하지 않습니다.
- **`"child"`** — FileDownload 의 접근성은 출력하지 않고, 자식 컴포넌트의 접근성은 출력합니다.
- **`"none"`** — FileDownload 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
...
- accessibilitydesclevel 속성은 선택상자의 이동에 영향을 주지 않으므로 방향키로 선택상자가 FileDownload 에 이동되게 하지 않으려면 accessibilityenable 속성을 설정하여야 합니다.
...
> Components > Component > FileDownload > Property > accessibilitydescription

**Description**

FileDownload에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.accessibilitydescription[= strDescription]
```

**Setting Syntax**

```javascript
this.FileDownload00.accessibilitydescription = "Option";
```
...
> Components > Component > FileDownload > Property > accessibilityenable

**Description**

FileDownload 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.accessibilityenable[= bEnable]
```
...
```
```javascript
this.FileDownload00.accessibilityenable = false;
```
- **`true`** — FileDownload 에 선택상자가 이동되면 접근성 관련 속성값을 출력합니다.

방향키 또는 제스처로 선택상자 이동 시 Static 과 같이 포커스를 갖지 않는 컴포넌트에도 선택상자가 이동됩니다.
- **`false`** — FileDownload 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.

데스크탑 환경에서 방향키로 선택상자가 FileDownload 에 이동되지 않습니다.
모바일 환경에서 제스처로 선택상자가 FileDownload 에 이동되지 않습니다.
...
- 선택상자 이동 시 컴포넌트의 ARIA-LABEL + Status + Role 순서로 정보가 조합되어 접근성으로 출력됩니다.
   ...
   > Status : FileDownload 의 현재 상태가 반영됩니다.
   > Role : accessibilityrole 속성값이 반영됩니다. accessibilityrole 속성값을 설정하지 않으면 FileDownload 의 고유 Role 이 반영됩니다.

- accessibilityenable 속성값이 false 일 때 데스크탑 환경에서 방향키 외의 방법으로 선택상자를 FileDownload 로 이동시키면 스크린 리딩 프로그램에서 임의의 값을 출력할 수 있습니다.
...
> Components > Component > FileDownload > Property > accessibilitylabel

**Description**

FileDownload에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.accessibilitylabel[= strLabel]
```

**Setting Syntax**

```javascript
this.FileDownload00.accessibilitylabel = "OK Button"; 
this.FileDownload00.accessibilitylabel = "[@static00]"; 
this.FileDownload00.accessibilitylabel = "[@static00][@static01]"; 
this.FileDownload00.accessibilitylabel = "[@static00][@static01] OK Button";
```
...
> Components > Component > FileDownload > Property > accessibilityrole

**Description**

FileDownload에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.accessibilityrole[= enumRole]
```
...
```
```javascript
this.FileDownload00.accessibilityrole = "none"; 
this.FileDownload00.accessibilityrole = "button";
```
...
- accessibilityenable 속성값을 설정하지 않으면 FileDownload의 기본 Role 로 적용됩니다.

- 추가적인 속성값이 필요한 Role 설정 시 FileDownload에 해당 속성이 없으면 스크린 리더에 따라 정상적으로 정보를 읽지 못할 수 있습니다.
...
> Components > Component > FileDownload > Property > background

**Description**

FileDownload 의 배경 영역을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.background[= strbackground]
```
...
* Script ( normal property )
this.FileDownload00.background = "#ffffaa";
this.FileDownload00.background = ""URL('./images/smiley.gif')" no-repeat center center #ffffaa";
this.FileDownload00.background = ""URL('./images/smiley.gif')" no-repeat center center /auto #ffffaa";
this.FileDownload00.background = ""URL('./images/smiley.gif')" no-repeat center center /15px 15% #ffffaa";
this.FileDownload00.background = "linear-gradient( red , blue , yellow )";
this.FileDownload00.background = "linear-gradient( #FF0000 , rgb(0,0,255) , rgb(255,255,0))";
this.FileDownload00.background = ""URL('./images/smiley.gif')" border-box border-box #ffffaa";
```
...
"left" 설정 시 FileDownload 의 왼쪽면과 이미지의 왼쪽면이 정렬되어 표시됩니다.
"center" 설정 시 FileDownload 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"right" 설정 시 FileDownload 의 오른쪽면과 이미지의 오른쪽면이 정렬되어 표시됩니다.
...
"top" 설정 시 FileDownload 의 윗쪽면과 이미지의 윗쪽면이 정렬되어 표시됩니다.
"center" 설정 시 FileDownload 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"bottom" 설정 시 FileDownload 의 아랫쪽면과 이미지의 아랫쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
0 보다 작거나 100 보다 큰 값을 설정 시 FileDownload 의 영역을 벗어난 가상의 위치로 적용됩니다.
...
예를 들어 <angle> 값이 "to left" 이면 FileDownload 의 right 위치가 시작점이 되고, left 위치가 끝점이 됩니다.
              <angle> 값이 "to right" 이면 FileDownload 의 left 위치가 시작점이 되고, right 위치가 끝점이 됩니다.
...
<bg-image> 에 적용된 이미지에 투명으로 적용된 부분이 있거나 이미지가 FileDownload 영역보다 작다면 해당 영역에 배경색이 표시됩니다.
...
> Components > Component > FileDownload > Property > border-radius

**Description**

FileDownload 의 모서리 모양을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.borderRadius[= strborderradius]
```
...
* Script ( normal property )
this.FileDownload00.borderRadius = "10px";
this.FileDownload00.borderRadius = "5px 6px 10px / 5px 10px";
```
...
> Components > Component > FileDownload > Property > bottom

**Description**

FileDownload 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.bottom[= nBottom]
```
...
```
```javascript
this.FileDownload00.bottom = 10; 
this.FileDownload00.bottom = "10px"; 
this.FileDownload00.bottom = "10%"; 
this.FileDownload00.bottom = "Button00:10px"; 
this.FileDownload00.bottom = "Button00:10%";
```
- **`<strCompID>`** — FileDownload 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 FileDownload 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 FileDownload 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — FileDownload 의 하단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 bottom 속성값을 기준으로 FileDownload의 하단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 FileDownload의 하단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 FileDownload의 하단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 FileDownload의 하단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 top 속성값을 기준으로 FileDownload의 하단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 FileDownload의 하단 위치 결정
...
> Components > Component > FileDownload > Property > box-shadow

**Description**

FileDownload 에 그림자 효과를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.boxShadow[= strbshadow]
```
...
* Script ( normal property )
this.FileDownload00.boxShadow  = "10px 10px 10px #888888";
this.FileDownload00.boxShadow  = "inset 10px 10px 10px 5px #888888";
```
...
FileDownload 의 좌상단 위치를 기준으로 그림자 효과가 표시될 위치를 가로/세로 픽셀값으로 설정합니다.
...
> Components > Component > FileDownload > Property > color

**Description**

FileDownload 에 표시되는 텍스트의 색상을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.color[= strcolor]
```
...
* Script ( normal property )
this.FileDownload00.color = "#999999";
this.FileDownload00.color = "rgb(255,0,0)";
this.FileDownload00.color = "red";
```
- **`<NamedColor>`** — "red","blue" 와 같이 미리 정의된 색상이름을 문자열로 설정합니다.
- **`<NumericColor>`** — 표시할 색의 색상코드입니다.
...
> Components > Component > FileDownload > Property > cssclass

**Description**

FileDownload 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.cssclass[= strcssclass]
```
...
```
```javascript
this.FileDownload00.cssclass = "TestClass"; 
this.FileDownload00.cssclass = "TestClass,TestClass2";
```
...
> Components > Component > FileDownload > Property > cursor

**Description**

FileDownload 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.cursor[= strCursor]
```
...
* Script ( normal property )
this.FileDownload00.cursor = "default";
```
...
> Components > Component > FileDownload > Property > downloadfilename

**Description**

파일 다운로드 시 표시되는 파일선택창에 기본으로 표시될 파일명을 설정합니다.

**Syntax**

```javascript
FileDownload.downloadfilename[= strFileName]
```

**Setting Syntax**

```javascript
this.FileDownload00.downloadfilename = "Test.txt";
```
- **`strFileName`** — 다운로드를 위한 파일선택창에 기본으로 표시될 파일명을 설정합니다.

값을 설정하지 않으면 파일선택창에 빈값이 표시됩니다.
...
- downloadfilename 속성값 설정 시 filefilter 와 filefilterindex 속성값은 무시되고, 파일선택창의 파일형식은 자동으로 설정됩니다.

- download() 메소드에서 strTargetPath 파라미터를 설정했을 경우 다운로드를 위한 파일선택창이 표시되지 않습니다.
...
> Components > Component > FileDownload > Property > downloadurl

**Description**

FileDownload 에서 다운로드 받을 파일의 경로를 설정하는 속성입니다.
...
```javascript
this.FileDownload00.downloadurl = "http://www.abc.com/index.html";
```
- **`strURL`** — 다운로드 받을 파일의 경로와 파일명을 문자열로 설정합니다.

**Remark**

- download() 메소드 실행 시 파라미터를 입력하지 않은 경우에 downloadurl 속성에 설정된 값이 적용됩니다.

- download() 메소드 실행 시 파라미터가 입력되었다면 downloadurl 속성에 설정된 값은 무시됩니다.
...
> Components > Component > FileDownload > Property > enable

**Description**

FileDownload 의 사용가능 여부를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.enable[= benable]
```
...
```
```javascript
this.FileDownload00.enable = true; 
this.FileDownload00.enable = false;
```
- **`true`** — FileDownload 을(를) 사용할 수 있게 설정합니다.
- **`false`** — FileDownload 을(를) 사용할 수 없게 설정합니다.
...
> Components > Component > FileDownload > Property > enableevent

**Description**

FileDownload 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.enableevent[= bEvent]
```
...
```
```javascript
this.FileDownload00.enableevent = true;  
this.FileDownload00.enableevent = false;
```
- **`true`** — FileDownload 에서 이벤트가 발생하도록 설정합니다.
- **`false`** — FileDownload 에서 이벤트가 발생하지 않도록 설정합니다.
...
> Components > Component > FileDownload > Property > expr

**Description**

FileDownload 에 표시될 텍스트를 동적으로 생성하는 수식을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.expr[= strExpr]
```

**Setting Syntax**

```javascript
this.FileDownload00.expr = "3*5";this.FileDownload00.expr = "image.text";
```
- **`strExpr`** — 텍스트로 적용될 수식을 설정합니다.
접근 가능한 영역에 정의된 함수를 설정할 수 있습니다.

설정된 수식을 동적으로 실행하여 그 결과값을 FileDownload 에 텍스트로 표시합니다.

**Remark**

- 동적으로 FileDownload 에 적용된 텍스트는 getDisplayText() 메서드를 사용하여 확인할 수 있습니다.
...
```javascript
FileDownload.filefilter[= strFileFilter]
```

**Setting Syntax**

```javascript
this.FileDownload00.filefilter = "All(*.*)|*.*|Text Files(*.txt)|*.txt|";this.FileDownload00.filefilter = "Excel Files(*.xlsx)|*.xls;*.xlsx|Word Files(*.docx)|*.doc;*.docx|ALL Files(*.*)|*.*|";
```
...
- FileDownload 의 download() 메소드 실행 시 strTargetPath 파라미터를 설정하지 않아야 파일선택창이 표시됩니다.
   strTargetPath 파라미터를 설정하면 파일선택창이 표시되지 않고 파라미터에 설정한 값에 맞게 파일이 다운로드됩니다.
...
```javascript
FileDownload.filefilterindex[= nIndex]
```

**Setting Syntax**

```javascript
this.FileDownload00.filefilterindex = 1;
```
...
> Components > Component > FileDownload > Property > fittocontents

**Description**

FileDownload 의 내부 컨텐츠영역이 컨텐츠 내용에 맞게 자동조정되는 영역을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.fittocontents[= enumFitTo]
```
...
```
```javascript
this.FileDownload00.fittocontents = "width";
```
- **`"none"`** — 컨텐츠 내용과 관계없이 디자인 시 설정한 FileDownload 의 너비와 높이를 유지합니다.
- **`"width"`** — 컨텐츠 내용에 맞게 FileDownload 의 내부 컨텐츠영역 너비를 자동 조정합니다.
- **`"height"`** — 컨텐츠 내용에 맞게 FileDownload 의 내부 컨텐츠영역 높이를 자동 조정합니다.
- **`"both"`** — 컨텐츠 내용에 맞게 FileDownload 의 내부 컨텐츠영역 너비와 높이를 자동 조정합니다.

**Remark**

- fittocontents 속성값을 설정하지 않으면 "none" 으로 적용됩니다.

- FileDownload 의 전체 크기는 내부 컨텐츠영역 크기에 -nexa-border, -nexa-padding 영역을 더해서 결정됩니다.

- Form 이 로딩될 때와 fittocontents 속성값이 변경되었을 때만 내부 컨텐츠영역의 크기가 자동 조정됩니다.
   Bind 된 속성이나 스크립트에 의해 FileDownload 의 컨텐츠가 변경된 경우는 내부 컨텐츠영역의 크기가 자동 조정되지 않습니다.

- Bind 된 속성에 의해 FileDownload 의 컨텐츠가 변경되어 내부 컨텐츠영역의 크기가 다시 조정되어야 할 때는
   Form 의 onbindingvaluechanged 이벤트에서 resetScroll() 메소드를 실행하여 크기를 재조정 하여야 합니다.

- 스크립트에 의해 FileDownload 의 컨텐츠가 변경되어 내부 컨텐츠영역의 크기가 다시 조정되어야 할 때는
...
> Components > Component > FileDownload > Property > flexgrow
...
> Components > Component > FileDownload > Property > flexshrink
...
> Components > Component > FileDownload > Property > font

**Description**

FileDownload 에서 사용하는 폰트를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.font[= strfont]
```
...
* Script ( normal property )
this.FileDownload00.font = "bold 12pt/30px arial, sans-serif";
```
...
> Components > Component > FileDownload > Property > height

**Description**

FileDownload 을(를) 표시하기 위한 높이를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.height[= nHeight]
```
...
```
```javascript
this.FileDownload00.height = 10; 
this.FileDownload00.height = "10px"; 
this.FileDownload00.height = 10%"; 
this.FileDownload00.height = Button00:10%";
```
- **`<strCompID>`** — FileDownload 의 높이를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 FileDownload 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 FileDownload 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 높이가 적용됩니다.
- **`<nVal>`** — FileDownload 의 높이를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.


* <strCompID> 값을 생략했을 때 :
- "px": FileDownload의 높이 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 FileDownload의 높이 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 FileDownload의 높이 결정
- "rem": MainFrame font-size 속성값을 기준으로 FileDownload의 높이 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 FileDownload의 높이 결정
- "%": <strCompID>의 height 속성값을 기준으로 FileDownload의 높이 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > FileDownload > Property > hotkey

**Description**

FileDownload 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.hotkey[= strHotkey]
```

**Setting Syntax**

```javascript
this.FileDownload00.hotkey = "G"; 
this.FileDownload00.hotkey = "CTRL+A"; 
this.FileDownload00.hotkey = "CTRL+ALT+X";
```
...
> Components > Component > FileDownload > Property > id

**Description**

FileDownload의 고유 식별자를 설정하는 속성입니다.
...
- **`id`** — FileDownload를 구별할 수 있는 유일값을 갖습니다.
...
> Components > Component > FileDownload > Property > layoutorder
...
> Components > Component > FileDownload > Property > left

**Description**

FileDownload 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.left[= nLeft]
```
...
```
```javascript
this.FileDownload00.left = 10; 
this.FileDownload00.left = "10px"; 
this.FileDownload00.left = "10%"; 
this.FileDownload00.left = "Button00:10px"; 
this.FileDownload00.left = "Button00:10%";
```
- **`<strCompID>`** — FileDownload 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — FileDownload 의 좌측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 left 속성값을 기준으로 FileDownload의 좌측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 FileDownload의 좌측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 FileDownload의 좌측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 FileDownload의 좌측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 right 속성값을 기준으로 FileDownload의 좌측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 FileDownload의 좌측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > FileDownload > Property > letter-spacing

**Description**

FileDownload 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.letterSpacing[= strspace]
```
...
* Script ( normal property )
this.FileDownload00.letterSpacing = "2px";
```
...
> Components > Component > FileDownload > Property > maxheight

**Description**

FileDownload 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.maxheight[= nMaxHeight]
```
...
```
```javascript
this.FileDownload00.maxheight = 20; 
this.FileDownload00.maxheight = "20px";
```
- **`<nVal>`** — FileDownload 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 maxheight 보다 크면 화면에 표시되는 FileDownload 의 높이는 maxheight 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 FileDownload 의 높이가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > FileDownload > Property > maxwidth

**Description**

FileDownload 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.maxwidth[= nMaxWidth]
```
...
```
```javascript
this.FileDownload00.maxwidth = 20; 
this.FileDownload00.maxwidth = "20px";
```
- **`<nVal>`** — FileDownload 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 maxwidth 보다 크면 화면에 표시되는 FileDownload 의 너비는 maxwidth 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 FileDownload 의 너비가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > FileDownload > Property > minheight

**Description**

FileDownload 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.minheight[= nMinHeight]
```
...
```
```javascript
this.FileDownload00.minheight = 20; 
this.FileDownload00.minheight = "20px";
```
- **`<nVal>`** — FileDownload 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 minheight 보다 작다면 화면에 표시되는 FileDownload 의 높이는 minheight 속성값으로 적용됩니다.
  표시되는 높이만 적용되고 height 속성값은 변경되지 않습니다.
...
> Components > Component > FileDownload > Property > minwidth

**Description**

FileDownload 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.minwidth[= nMinWidth]
```
...
```
```javascript
this.FileDownload00.minwidth = 20; 
this.FileDownload00.minwidth = "20px";
```
- **`<nVal>`** — FileDownload 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 minwidth 보다 작으면 화면에 표시되는 FileDownload 의 너비는 minwidth 속성값으로 적용됩니다.
  표시되는 너비만 적용되고 width 속성값은 변경되지 않습니다.
...
> Components > Component > FileDownload > Property > name

**Description**

FileDownload 의 이름을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.name[= strName]
```
...
> Components > Component > FileDownload > Property > opacity

**Description**

FileDownload 영역의 투명도를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.opacity[= stropacity]
```
...
* Script ( normal property )
this.FileDownload00.opacity = "0.8";
this.FileDownload00.opacity = 0.8;
this.FileDownload00.opacity = "80%";
```
...
> Components > Component > FileDownload > Property > parent

**Description**

FileDownload 의 부모 오브젝트를 갖는 읽기전용 속성입니다.
...
```javascript
var objParent = this.FileDownload00.parent;
```
...
- FileDownload 이(가) Div 와 같은 컨테이너 컴포넌트에 자식으로 존재한다면 parent 속성은 해당 컨테이너 컴포넌트를 갖습니다.
...
> Components > Component > FileDownload > Property > positionstep

**Description**

부모 오브젝트가 화면분할기능을 사용할 때 FileDownload 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.positionstep[= nStep]
```

**Setting Syntax**

```javascript
this.FileDownload00.positionstep = 0; 
this.FileDownload00.positionstep = -1;
```
- **`nStep`** — FileDownload 이(가) 표시될 분할화면의 인덱스를 설정합니다.
"-1" 로 설정하면 모든 분할화면에 FileDownload 이(가) 표시됩니다.
...
> Components > Component > FileDownload > Property > right

**Description**

FileDownload 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.right[= nRight]
```
...
```
```javascript
this.FileDownload00.right = 10; 
this.FileDownload00.right = "10px"; 
this.FileDownload00.right = "10%"; 
this.FileDownload00.right = "Button00:10px"; 
this.FileDownload00.right = "Button00:10%";
```
- **`<strCompID>`** — FileDownload 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — FileDownload 의 우측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 right 속성값을 기준으로 FileDownload의 우측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 FileDownload의 우측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 FileDownload의 우측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 FileDownload의 우측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 left 속성값을 기준으로 FileDownload의 우측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 FileDownload의 우측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > FileDownload > Property > rtl

**Description**

FileDownload 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다.
...
```
```javascript
var vRtl = this.FileDownload00.rtl;
```
- **`undefined`** — undefined 설정 시 상위 컴포넌트의 rtl 속성값이 적용됩니다.

사용자가 rtl 속성값을 설정하지 않거나 삭제했을 경우 undefined 가 설정됩니다.
- **`true`** — FileDownload 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 오른쪽으로 설정합니다.
FileDownload 의 내부 좌표계의 기준을 오른쪽으로 설정합니다.
FileDownload 의 텍스트 표시 기준을 오른쪽으로 설정합니다.
수직스크롤바가 있을 경우 왼쪽에 표시됩니다.
- **`false`** — FileDownload 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
FileDownload 의 내부 좌표계의 기준을 왼쪽으로 설정합니다.
FileDownload 의 텍스트 표시 기준을 왼쪽으로 설정합니다.
...
- FileDownload 부터 Environment 까지 상위의 모든 rtl 속성값이 undefined 이면
...
> Components > Component > FileDownload > Property > tablecellarea
...
```javascript
FileDownload.tablecellarea[= strArea]
```
...
> Components > Component > FileDownload > Property > taborder

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 FileDownload 의 순서를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.taborder[= nTabOrder]
```
...
> Components > Component > FileDownload > Property > tabstop

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 FileDownload 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.tabstop[= bTabStop]
```
...
bTabStop ::= 'true' | 'false'
```
- **`"true"`** — FileDownload 이(가) 탭키 입력에 의한 포커스를 받습니다.
- **`"false"`** — FileDownload 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
...
> Components > Component > FileDownload > Property > text

**Description**

FileDownload 에 표시될 텍스트를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.text[= strText]
```

**Setting Syntax**

```javascript
this.FileDownload00.text = "Print";
```
- **`strText`** — FileDownload 에 표시될 텍스트를 설정합니다.
...
> Components > Component > FileDownload > Property > tooltiptext

**Description**

FileDownload 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.tooltiptext[= strToolTipText]
```

**Setting Syntax**

```javascript
this.FileDownload00.tooltiptext = "This is ToolTip Text"; this.FileDownload00.tooltiptext = "";          // 풍선 도움말이 표시되지 않습니다. 
this.FileDownload00.tooltiptext = null;        // 상위 컴포넌트의 풍선 도움말이 표시됩니다.
```
...
- 마우스 포인터가 FileDownload 영역 위에서 일정시간 움직이지 않으면 풍선도움말이 표시됩니다.
...
> Components > Component > FileDownload > Property > tooltiptype

**Description**

FileDownload 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.tooltiptype[= enumTooltipType]
```
...
```
```javascript
this.FileDownload00.tooltiptype = "hover";
```
- **`"default"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 FileDownload 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"hover"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 FileDownload 영역내에 멈춰서 일정시간이 경과하면 풍선도움말이 사라집니다.
FileDownload 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경되거나 사라진 풍선도움말이 다시 표시됩니다.
- **`"inplace"`** — FileDownload 의 좌측상단 안쪽에 풍선도움말을 표시합니다.

마우스 포인터가 FileDownload 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"default,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 FileDownload 영역에 있으면 풍선도움말이 사라지지 않습니다.
- **`"hover,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 FileDownload 영역에 있으면 풍선도움말이 사라지지 않습니다.
FileDownload 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경됩니다.
- **`"inplace,mouseleave"`** — FileDownload 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
- 표시되었다가 사라진 풍선도움말은 마우스 포인터가 FileDownload 영역을 나갔다가 들어오면 다시 표시됩니다.

- 마우스 포인터가 FileDownload 영역에서 벗어나면 풍선도움말이 사라집니다.
...
> Components > Component > FileDownload > Property > top

**Description**

FileDownload 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.top[= nTop]
```
...
```
```javascript
this.FileDownload00.top = 10; 
this.FileDownload00.top = "10px"; 
this.FileDownload00.top = "10%"; 
this.FileDownload00.top = "Button00:10px"; 
this.FileDownload00.top = "Button00:10%";
```
- **`<strCompID>`** — FileDownload 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — FileDownload의 상단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 top 속성값을 기준으로 FileDownload의 상단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 FileDownload의 상단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 FileDownload의 상단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 FileDownload의 상단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 bottom 속성값을 기준으로 FileDownload의 상단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 FileDownload의 상단 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > FileDownload > Property > visible

**Description**

FileDownload 이(가) 화면에 표시될지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.visible[= bVisible]
```
...
```
```javascript
this.FileDownload00.visible = true; 
this.FileDownload00.visible = false;
```
- **`"true"`** — FileDownload 을(를) 화면에 표시합니다.
- **`"false"`** — FileDownload 을(를) 화면에 표시하지 않습니다.
...
> Components > Component > FileDownload > Property > width

**Description**

FileDownload 을(를) 표시하기 위한 너비를 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.width[= nWidth]
```
...
```
```javascript
this.FileDownload00.width = 10; this.FileDownload00.width = "10px"; 
this.FileDownload00.width = "10%"; 
this.FileDownload00.width = "Button00:10%";
```
- **`<strCompID>`** — FileDownload 의 너비를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 FileDownload 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 FileDownload 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 너비가 적용됩니다.
- **`<nVal>`** — FileDownload 의 너비를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": FileDownload의 너비 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 FileDownload의 너비 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 FileDownload의 너비 결정
- "rem": MainFrame font-size 속성값을 기준으로 FileDownload의 너비 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 FileDownload의 너비 결정
- "%": <strCompID>의 width 속성값을 기준으로 FileDownload의 너비 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > FileDownload > Property > word-spacing

**Description**

FileDownload 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다.

**Syntax**

```javascript
FileDownload.wordSpacing[= strwordspacing]
```
...
* Script ( normal property )
this.FileDownload00.wordSpacing = "30px";
```
...
> Components > Component > FileDownload > Method > addEvent

**Description**

FileDownload 에 특정 이벤트를 선언하여 추가하는 메소드입니다.

**Syntax**

```javascript
FileDownload.addEvent( strEventID )
```
...
| --- | --- | --- |
| strEventID | String | FileDownload 에 추가할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.FileDownload00.addEvent( "onmove" );
```
...
- FileDownload 에서 특정 이벤트를 제거하려면 removeEvent() 메소드를 사용하여야 합니다.
...
> Components > Component > FileDownload > Method > addEventHandler

**Description**

FileDownload 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다.

**Syntax**

```javascript
FileDownload.addEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.FileDownload00_onmove = function( obj:nexacro.FileDownload,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.FileDownload00.addEventHandler( "onmove", this.FileDownload00_onmove, this);
```
...
> Components > Component > FileDownload > Method > addEventHandlerLookup

**Description**

함수를 검색하여 FileDownload 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다.

**Syntax**

```javascript
FileDownload.addEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.FileDownload00_onmove = function( obj:nexacro.FileDownload,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.FileDownload00.addEventHandlerLookup( "onmove", "FileDownload00_onmove", this);
```
...
> Components > Component > FileDownload > Method > bringToFront

**Description**

부모가 동일한 컴포넌트 중 FileDownload 이(가) 화면의 제일 앞에 표시되게 합니다.

**Syntax**

```javascript
FileDownload.bringToFront()
```

**Parameters**

this.FileDownload.bringToFront();
...
- bringToFront() 메소드는 FileDownload 을(를) 가장 나중에 표시되게 순서를 바꿉니다.
...
> Components > Component > FileDownload > Method > bringToPrev

**Description**

부모가 동일한 컴포넌트 중 FileDownload 이(가) 화면에 한단계 앞에 표시되게 합니다.

**Syntax**

```javascript
FileDownload.bringToPrev()
```

**Parameters**

this.FileDownload.bringToPrev();
...
- bringToPrev() 메소드는 FileDownload 을(를) 한단계 나중에 표시되는 컴포넌트와 순서를 바꿉니다.
...
> Components > Component > FileDownload > Method > clearEventHandler
...
```javascript
FileDownload.clearEventHandler( strEventID )
```
...
```javascript
var nCnt = this.FileDownload00.clearEventHandler( "onmove" );
```
...
> Components > Component > FileDownload > Method > destroy

**Description**

스크립트에서 동적으로 생성한 FileDownload 을(를) 삭제하는 메소드입니다.
...
var bSucc = this.FileDownload00.destroy();

**Return**

| Type | Description |
| --- | --- |
| Boolean | FileDownload 이(가) 정상적으로 삭제되면 true 를 반환합니다.

FileDownload 이(가) 정상적으로 삭제되지 않으면 false 를 반환합니다. |

**Remark**

- 동적으로 생성한 FileDownload 을(를) 완전히 삭제하기 위해서는 destroy() 메소드를 호출해야 합니다.

**See Also**

FileDownload.initFileDownload.showForm.addChildForm.insertChildForm.removeChild
...
> Components > Component > FileDownload > Method > download

**Description**

웹에 저장된 특정 파일을 HTTP/HTTPS 통신방식으로 다운로드 받는 메소드입니다.
...
strUrl 값을 생략할 경우 downloadurl 속성에 설정된 값이 적용됩니다.
strUrl 값을 설정하면 downloadurl 속성에 설정된 값은 무시됩니다. |
...
* Nexacro Runtime Environment 일 때만 지원하는 파라미터입니다. |

**Sample Call**

```javascript
var bSucc = FileDownload00.download( "http://www.abc.com/index.html" );
var bSucc = FileDownload00.download( "http://www.abc.com/index.html", "C:\\Users\\nexacro\\index.html" );
```
...
| Type | Description |
| --- | --- |
| Boolean | 실제 파일의 다운로드 성공여부와는 관계없이 메소드의 수행여부를 반환합니다.
...
- execNexacro 메소드의 "-THR" 옵션값에 따라 여러개의 파일을 동시에 다운로드 할 수 있습니다.
...
> Components > Component > FileDownload > Method > findEventHandler

**Description**

FileDownload 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다.

**Syntax**

```javascript
FileDownload.findEventHandler( strEventID, objFunc, objTarget )
```
...
var nIndex = this.FileDownload00.findEventHandler( "onmove", this.FileDownload00_onmove, this );
```
...
> Components > Component > FileDownload > Method > getDisplayText

**Description**

FileDownload 에 표시된 텍스트값을 반환하는 메소드입니다.

**Syntax**

```javascript
FileDownload.getDisplayText()
```

**Parameters**

var strTxt = this.FileDownload00.getDisplayText() ;

**Return**

| Type | Description |
| --- | --- |
| String | FileDownload 에 표시된 텍스트값을 반환합니다. |
...
> Components > Component > FileDownload > Method > getEventHandler

**Description**

FileDownload 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다.

**Syntax**

```javascript
FileDownload.getEventHandler( strEventID, nIdx )
```
...
```javascript
var objFunc = FileDownload00.getEventHandler( "onmove", 0 );
```
...
> Components > Component > FileDownload > Method > getOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 FileDownload 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
FileDownload.getOffsetBottom();
```

**Parameters**

var nBottom = this.FileDownload.getOffsetBottom();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 FileDownload 의 bottom 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 FileDownload 의 bottom 값을 동적으로 계산합니다.
...
> Components > Component > FileDownload > Method > getOffsetHeight

**Description**

FileDownload 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
FileDownload.getOffsetHeight();
```

**Parameters**

var nHeight = this.FileDownload.getOffsetHeight();

**Return**

| Type | Description |
| --- | --- |
| Number | FileDownload 의 높이를 픽셀단위의 숫자로 변환하여 반환합니다. |

**Remark**

- 화면에 표시된 FileDownload 의 높이를 동적으로 계산합니다.
...
> Components > Component > FileDownload > Method > getOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 FileDownload 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
FileDownload.getOffsetLeft();
```

**Parameters**

var nleft = this.FileDownload.getOffsetLeft();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 FileDownload 의 left 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 FileDownload 의 left 값을 동적으로 계산합니다.
...
> Components > Component > FileDownload > Method > getOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 FileDownload 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
FileDownload.getOffsetRight();
```

**Parameters**

var nRight = this.FileDownload.getOffsetRight();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 FileDownload 의 right 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 FileDownload 의 right 값을 동적으로 계산합니다.
...
> Components > Component > FileDownload > Method > getOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 FileDownload 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
FileDownload.getOffsetTop();
```

**Parameters**

var nTop = this.FileDownload.getOffsetTop();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 FileDownload 의 top 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 FileDownload 의 top 값을 동적으로 계산합니다.
...
> Components > Component > FileDownload > Method > getOffsetWidth

**Description**

FileDownload 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
FileDownload.getOffsetWidth();
```

**Parameters**

var nWidth = this.FileDownload.getOffsetWidth();

**Return**

| Type | Description |
| --- | --- |
| Number | FileDownload 의 너비를 픽셀단위의 숫자로 변환하여 반환합니다. |

**Remark**

- 화면에 표시된 FileDownload 의 너비를 동적으로 계산합니다.
...
> Components > Component > FileDownload > Method > getPixelBottom

**Description**

FileDownload 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
FileDownload.getPixelBottom();
```

**Parameters**

var nbottom = this.FileDownload.getPixelBottom();

**Return**

| Type | Description |
| --- | --- |
| Number | FileDownload 의 bottom 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > FileDownload > Method > getPixelHeight

**Description**

FileDownload 의 height 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
FileDownload.getPixelHeight();
```

**Parameters**

var nheight = this.FileDownload.getPixelHeight();

**Return**

| Type | Description |
| --- | --- |
| Number | FileDownload 의 height 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > FileDownload > Method > getPixelLeft

**Description**

FileDownload 의 left 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
FileDownload.getPixelLeft();
```

**Parameters**

var nleft = this.FileDownload.getPixelLeft();

**Return**

| Type | Description |
| --- | --- |
| Number | FileDownload 의 left 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > FileDownload > Method > getPixelRight

**Description**

FileDownload 의 right 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
FileDownload.getPixelRight();
```

**Parameters**

var nright = this.FileDownload.getPixelRight();

**Return**

| Type | Description |
| --- | --- |
| Number | FileDownload 의 right 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > FileDownload > Method > getPixelTop

**Description**

FileDownload 의 top 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
FileDownload.getPixelTop();
```

**Parameters**

var ntop = this.FileDownload.getPixelTop();

**Return**

| Type | Description |
| --- | --- |
| Number | FileDownload 의 top 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > FileDownload > Method > getPixelWidth

**Description**

FileDownload 의 width 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
FileDownload.getPixelWidth();
```

**Parameters**

var nwidth = this.FileDownload.getPixelWidth();

**Return**

| Type | Description |
| --- | --- |
| Number | FileDownload 의 width 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > FileDownload > Method > init

**Description**

스크립트로 FileDownload 을(를) 동적 생성한 후에 초기화하는 메소드입니다.
...
| vLeft | String, Number | FileDownload 의 left 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 right 속성값을 기준으로 FileDownload 의 left 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 FileDownload 의 left 가 결정됩니다. |
| vTop | String, Number | FileDownload 의 top 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 bottom 속성값을 기준으로 FileDownload 의 top 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 FileDownload 의 top 이 결정됩니다. |
| vWidth | String, Number | FileDownload 의 width 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 FileDownload 의 width 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 FileDownload 의 width 가 결정됩니다. |
| vHeight | String, Number | FileDownload 의 height 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 FileDownload 의 height 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 FileDownload 의 height 가 결정됩니다. |
| vRight | String, Number | FileDownload 의 right 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vLeft, vWidth 값을 모두 설정했을 경우 vRight 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 left 속성값을 기준으로 FileDownload 의 right 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 FileDownload 의 right 가 결정됩니다. |
| vBottom | String, Number | FileDownload 의 bottom 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vTop, vHeight 값을 모두 설정했을 경우 vBottom 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 top 속성값을 기준으로 FileDownload 의 bottom 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 FileDownload 의 bottom 이 결정됩니다. |
| vMinWidth | String, Number | FileDownload 이(가) 화면에 표시되는 최소 너비값을 pixel 단위의 숫자로 설정합니다. |
| vMaxWidth | String, Number | FileDownload 이(가) 화면에 표시되는 최대 너비값을 pixel 단위의 숫자로 설정합니다.
...
| vMaxHeight | String, Number | FileDownload 이(가) 화면에 표시되는 최대 높이값을 pixel 단위의 숫자로 설정합니다.
...
objComp.init( "FileDownload00", 30, 120, 196, 46 );
objComp.init( "FileDownload00", 30, 120, 196, 46, null, null );
objComp.init( "FileDownload00", null, null, 300, "400px", "80%", 300 );
objComp.init( "FileDownload00", 0, 0, 200, 100, null, null, 300, 500, 200, 500 );
objComp.init( "FileDownload00", "FileDownload22:10", 300, null, null, "FileDownload33:10", "20%", 300, 500, 200, 500 );
```
...
- 인수값에 기준 컴포넌트를 포함하면 FileDownload 의 위치는 기준 컴포넌트를 기준으로 상대적으로 결정됩니다.
  vLeft, vTop, vWidth, vHeight, vRight, vBottom 값에 기준 컴포넌트를 포함할 때는 "ID:Value" 형태로 설정하여야 합니다.

- 기준 컴포넌트는 FileDownload 와(과) 부모(Parent)가 동일하여야 하며, Form 로딩 시 FileDownload 보다 먼저 생성되어야 합니다.
...
FileDownload.destroyFileDownload.showForm.addChildForm.insertChildForm.removeChild
...
> Components > Component > FileDownload > Method > insertEventHandler

**Description**

FileDownload 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다.

**Syntax**

```javascript
FileDownload.insertEventHandler( strEventID, nIndex, objFunc, objTarget )
```
...
var nIndex = this.FileDownload00.insertEventHandler( "onmove", 0, this.FileDownload00_onmove, this);
```
...
> Components > Component > FileDownload > Method > move

**Description**

FileDownload 의 위치와 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
FileDownload.move( vLeft, vTop [, vWidth, vHeight [, vRight, vBottom]] )
```
...
```javascript
this.FileDownload00.move(10,10);
this.FileDownload00.move(10,10,100,100);
this.FileDownload00.move(null, null, 300, "400px", "80%", 300 );
```
...
> Components > Component > FileDownload > Method > moveToNext

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 FileDownload 이(가) 화면에 한단계 뒤에 표시되게 합니다.

**Syntax**

```javascript
FileDownload.moveToNext( objComp )
FileDownload.moveToNext( strComp )
```
...
```javascript
this.FileDownload.moveToNext( this.Button00 );
this.FileDownload.moveToNext( "Button00" );
```
...
- 인수로 전달되는 기준 컴포넌트와 FileDownload 은(는) 부모가 동일하여야 합니다.

- 디자인 시 소스에 컴포넌트가 선언된 순서대로 화면에 표시됩니다.
  소스에서 위에 선언된 컴포넌트가 먼저 표시되고, 아래에 선언된 컴포넌트가 나중에 표시되게 됩니다.
  컴포넌트가 겹쳐져 있을 경우 화면에 표시되는 순서에 따라 먼저 표시된 컴포넌트가 나중에 표시되는 컴포넌트에 가려지게 됩니다.

- moveToNext() 메소드는 기준 컴포넌트보다 FileDownload 이(가) 한단계 먼저 표시되게 순서를 바꿉니다.
...
> Components > Component > FileDownload > Method > moveToPrev

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 FileDownload 이(가) 화면에 한단계 앞에 표시되게 합니다.

**Syntax**

```javascript
FileDownload.moveToPrev( objComp )
FileDownload.moveToPrev( strComp )
```
...
```javascript
this.FileDownload.moveToPrev( this.Button00 );
this.FileDownload.moveToPrev( "Button00" );
```
...
- moveToPrev() 메소드는 기준 컴포넌트보다 FileDownload 이(가) 한단계 나중에 표시되게 순서를 바꿉니다.
...
> Components > Component > FileDownload > Method > removeEvent

**Description**

FileDownload 에 선언된 특정 이벤트를 삭제하는 메소드입니다.

**Syntax**

```javascript
FileDownload.removeEvent( strEventID )
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| strEventID | String | FileDownload 에서 삭제할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.FileDownload00.removeEvent( "onmove" );
```
...
- FileDownload 에 특정 이벤트를 추가하려면 addEvent() 메소드를 사용하여야 합니다.

- FileDownload 에 기본으로 선언되어 있는 이벤트 삭제 시 오동작 할 수 있으므로 주의하여야 합니다.
...
> Components > Component > FileDownload > Method > removeEventHandler

**Description**

FileDownload 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
FileDownload.removeEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.FileDownload00_onmove = function( obj:nexacro.FileDownload,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.FileDownload00.removeEventHandler( "onmove", this.FileDownload00_onmove, this);
```
...
> Components > Component > FileDownload > Method > removeEventHandlerLookup

**Description**

FileDownload 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
FileDownload.removeEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.FileDownload00_onmove = function( obj:nexacro.FileDownload,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.FileDownload00.removeEventHandlerLookup( "onmove", "FileDownload00_onmove", this);
```
...
> Components > Component > FileDownload > Method > resize

**Description**

FileDownload 의 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
FileDownload.resize( vWidth, vHeight )
```
...
```javascript
this.FileDownload00.resize( 100,100 );
```
...
- FileDownload 의 left 속성값이 null 이 아니면 resize() 메소드 실행 후 FileDownload 의 우측 위치가 변경됩니다.
  또한, 메소드 실행 후 right 속성값은 null 이 됩니다.

- FileDownload 의 left 속성값이 null 이면 resize() 메소드 실행 후 FileDownload 의 좌측 위치가 변경됩니다.
  또한, 메소드 실행 후 left 속성값은 null 로 유지됩니다.

- FileDownload 의 top 속성값이 null 이 아니면 resize() 메소드 실행 후 FileDownload 의 하단 위치가 변경됩니다.
  또한, 메소드 실행 후 bottom 속성값은 null 이 됩니다.

- FileDownload 의 top 속성값이 null 이면 resize() 메소드 실행 후 FileDownload 의 상단 위치가 변경됩니다.
...
> Components > Component > FileDownload > Method > sendToBack

**Description**

부모가 동일한 컴포넌트 중 FileDownload 이(가) 화면의 제일 뒤에 표시되게 합니다.

**Syntax**

```javascript
FileDownload.sendToBack()
```

**Parameters**

this.FileDownload.sendToBack();
...
- sendToBack() 메소드는 FileDownload 을(를) 가장 먼저 표시되게 순서를 바꿉니다.
...
> Components > Component > FileDownload > Method > sendToNext

**Description**

부모가 동일한 컴포넌트 중 FileDownload 이(가) 화면에 한단계 뒤에 표시되게 합니다.

**Syntax**

```javascript
FileDownload.sendToNext()
```

**Parameters**

this.FileDownload.sendToNext();
...
- sendToNext() 메소드는 FileDownload 을(를) 한단계 먼저 표시되는 컴포넌트와 순서를 바꿉니다.
...
> Components > Component > FileDownload > Method > setEventHandler

**Description**

FileDownload 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다.

**Syntax**

```javascript
FileDownload.setEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.FileDownload00_onmove = function( obj:nexacro.FileDownload,  e:nexacro.MoveEventInfo ) { //수행할 스크립트 };
var nIndex = this.FileDownload00.setEventHandler( "onmove", this.FileDownload00_onmove, this );
```
...
> Components > Component > FileDownload > Method > setEventHandlerLookup

**Description**

FileDownload 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다.

**Syntax**

```javascript
FileDownload.setEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.FileDownload00_onmove = function( obj:nexacro.FileDownload,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.FileDownload00.setEventHandlerLookup( "onmove", "FileDownload00_onmove", this);
```
...
> Components > Component > FileDownload > Method > setFocus

**Description**

FileDownload 에 포커스를 설정하는 메서드입니다.

**Syntax**

```javascript
FileDownload.setFocus( [bMoveScroll] )
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| bMoveScroll | Boolean | 부모 컴포넌트에 스크롤이 있을 경우, FileDownload 기준으로 스크롤을 이동할지 여부를 설정합니다.

true: FileDownload 이(가) 화면에 표시되도록 스크롤을 이동합니다.
false: FileDownload 위치와 관계없이 스크롤을 이동하지 않습니다.
...
```javascript
var objBefComp = this.FileDownload00.setFocus();
var objBefComp = this.FileDownload00.setFocus( false );
```
...
| Type | Description |
| --- | --- |
| Object | FileDownload 이(가) 포커스를 얻기 전에 포커스를 가지고 있던 컴포넌트를 반환합니다.
...
> Components > Component > FileDownload > Method > setOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 FileDownload 의 bottom 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
FileDownload.setOffsetBottom( nBottom );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nBottom | Number | 부모 컴포넌트의 Top 위치를 기준으로 FileDownload 의 bottom 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.FileDownload.setOffsetBottom( 10 );
```
...
- 메소드 실행 전 FileDownload 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > FileDownload 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > FileDownload 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > FileDownload 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 height, bottom 속성이 설정됩니다.
...
> Components > Component > FileDownload > Method > setOffsetHeight

**Description**

FileDownload 의 높이를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
FileDownload.setOffsetHeight( nHeight );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nHeight | Number | FileDownload 의 높이를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.FileDownload.setOffsetHeight( 10 );
```
...
> Components > Component > FileDownload > Method > setOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 FileDownload 의 left 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
FileDownload.setOffsetLeft( nLeft );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nLeft | Number | 부모 컴포넌트의 Left 위치를 기준으로 FileDownload 의 left 값을 픽셀단위의 숫자로 설정합니다 |

**Sample Call**

```javascript
this.FileDownload.setOffsetLeft( 10 );
```
...
- 메소드 실행 전 FileDownload 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > FileDownload 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > FileDownload 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, right 속성이 설정됩니다.
   > FileDownload 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
...
> Components > Component > FileDownload > Method > setOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 FileDownload 의 right 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
FileDownload.setOffsetRight( nRight );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nRight | Number | 부모 컴포넌트의 Left 위치를 기준으로 FileDownload 의 right 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.FileDownload.setOffsetRight( 600 );
```
...
- 메소드 실행 전 FileDownload 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > FileDownload 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > FileDownload 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > FileDownload 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 width, right 속성이 설정됩니다.
...
> Components > Component > FileDownload > Method > setOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 FileDownload 의 top 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
FileDownload.setOffsetTop( nTop );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nTop | Number | 부모 컴포넌트의 Top 위치를 기준으로 FileDownload 의 top 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.FileDownload.setOffsetTop( 10 );
```
...
- 메소드 실행 전 FileDownload 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > FileDownload 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > FileDownload 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, bottom 속성이 설정됩니다.
   > FileDownload 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
...
> Components > Component > FileDownload > Method > setOffsetWidth

**Description**

FileDownload 의 너비를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
FileDownload.setOffsetWidth( nWidth );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nWidth | Number | FileDownload 의 너비를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.FileDownload.setOffsetWidth( 10 );
```
...
> Components > Component > FileDownload > Method > show

**Description**

스크립트로 동적 생성한 FileDownload 을(를) 화면에 표시하는 메소드입니다.
...
FileDownload.destroyFileDownload.initForm.addChildForm.insertChildForm.removeChild
...
> Components > Component > FileDownload > Event > onclick
...
> Components > Component > FileDownload > Event > oncontextmenu
...
> Components > Component > FileDownload > Event > ondevicebuttonup
...
> Components > Component > FileDownload > Event > onerror
...
> Components > Component > FileDownload > Event > onkeydown
...
> Components > Component > FileDownload > Event > onkeyup
...
> Components > Component > FileDownload > Event > onkillfocus
...
> Components > Component > FileDownload > Event > onlbuttondown
...
> Components > Component > FileDownload > Event > onlbuttonup
...
> Components > Component > FileDownload > Event > onmouseenter
...
> Components > Component > FileDownload > Event > onmouseleave
...
> Components > Component > FileDownload > Event > onmousemove
...
> Components > Component > FileDownload > Event > onmove
...
> Components > Component > FileDownload > Event > onrbuttondown
...
> Components > Component > FileDownload > Event > onrbuttonup
...
> Components > Component > FileDownload > Event > onsetfocus
...
> Components > Component > FileDownload > Event > onsize
...
> Components > Component > FileDownload > Event > onsuccess
...
> Components > Component > FileDownload > Event > ontouchend
...
> Components > Component > FileDownload > Event > ontouchmove
...
> Components > Component > FileDownload > Event > ontouchstart
