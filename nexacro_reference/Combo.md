...
ComboList가 열린 상태에서 이동된 위치의 아이템을 결정하려면 Enter 를 입력하여야 합니다. |
| 아이템 결정 | Enter | 이동된 위치의 아이템을 선택 결정하여 value 속성에 반영합니다. |
| 스크롤 이동(페이지) | PageUp/PageDown | ComboList에 vscrollbar가 활성화됐을 때 페이지 단위(화면에 표시되는 아이템 개수)로 스크롤합니다.
이동된 위치의 아이템을 결정하려면 Enter 키를 입력해야 합니다. |
| 스크롤 이동(최상단/최하단) | Home/End | ComboList에 vscrollbar가 활성화됐을 때 최상단 또는 최하단으로 스크롤합니다.
이동된 위치의 아이템을 결정하려면 Enter 키를 입력해야 합니다.
...
| Name | Description |
| --- | --- |
| acceptvaluetype | Combo 에서 InnerDataset 에 없는 코드값을 스크립트로 value 속성에 설정할 때 처리방식을 결정하는 속성입니다. |
| accessibilityaction | Combo에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다. |
| accessibilitydesclevel | Combo 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| accessibilitydescription | Combo에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다. |
| accessibilityenable | Combo 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| accessibilitylabel | Combo에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다. |
| accessibilityrole | Combo에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다. |
| autoselect | Combo 의 편집영역이 활성화 될 때 텍스트를 전체선택 할지 설정하는 속성입니다. |
| autoskip | Combo의 아이템이 선택되었을 때 포커스를 자동으로 이동시킬지 설정하는 속성입니다. |
| background | Combo 의 배경 영역을 설정하는 속성입니다. |
| border-radius | Combo 의 모서리 모양을 설정하는 속성입니다. |
| bottom | Combo 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다. |
| box-shadow | Combo 에 그림자 효과를 설정하는 속성입니다. |
| buttonsize | Combo 드롭다운 버튼의 크기를 설정하는 속성입니다. |
| codecolumn | Combo 의 아이템 리스트에서 코드값으로 사용될 Column을 설정하는 속성입니다. |
| color | Combo 에 표시되는 텍스트의 색상을 설정하는 속성입니다. |
| comboedit | Combo 의 서브컨트롤인 편집영역(comboedit) 오브젝트를 갖는 속성입니다. |
| combolist | Combo 의 서브컨트롤인 아이템 리스트(combolist) 오브젝트를 갖는 속성입니다. |
| cssclass | Combo 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다. |
| cursor | Combo 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다. |
| datacolumn | Combo 의 아이템 리스트에서 데이터값으로 사용될 Column을 설정하는 속성입니다. |
| displaynulltext | Combo 의 value 속성값이 null 또는 undefined 일 때 Combo 에 표시될 대체 문자열을 설정하는 속성입니다. |
| displayrowcount | Combo 의 아이템 리스트에 표시될 아이템의 최대 갯수를 설정하는 속성입니다. |
| dropbutton | Combo 의 서브컨트롤인 드롭버튼(DropButton) 오브젝트를 갖는 속성입니다 |
| enable | Combo 의 사용가능 여부를 설정하는 속성입니다. |
| enableevent | Combo 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다. |
...
| font | Combo 에서 사용하는 폰트를 설정하는 속성입니다. |
| height | Combo 을(를) 표시하기 위한 높이를 설정하는 속성입니다. |
| hotkey | Combo 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다. |
| id | Combo의 고유 식별자를 설정하는 속성입니다. |
| imemode | Combo 의 기본 입력 언어를 설정하는 속성입니다. |
| index | Combo 의 아이템 중 선택된 아이템의 인덱스를 갖는 속성입니다. |
| initvalueid | Combo 에 적용될 InitValue 의 ID 를 설정하는 속성입니다. |
| innerdataset | Combo 의 아이템 리스트를 구성할 DataSet 의 ID를 설정하는 속성입니다. |
| itemheight | Combo 의 아이템 리스트에서 각 행의 높이를 설정하는 속성입니다. |
| layoutorder | Layout 컨테이너 내 Main Axis(type 속성값이 "horizontal"이면 수평축, type 속성값이 "vertical"이면 수직축)에 컴포넌트가 배치되는 순서를 설정합니다. |
| left | Combo 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다. |
| letter-spacing | Combo 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다. |
| maxheight | Combo 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다. |
| maxwidth | Combo 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다. |
| minheight | Combo 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다. |
| minwidth | Combo 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다. |
| name | Combo 의 이름을 설정하는 속성입니다. |
| -nexa-border | Combo 의 테두리를 설정하는 속성입니다. |
| -nexa-edge | Combo 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-padding | Combo 영역의 안쪽 여백을 설정하는 속성입니다. |
| -nexa-rtl-background-image | Combo 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다. |
| -nexa-rtl-edge-image | Combo 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| opacity | Combo 영역의 투명도를 설정하는 속성입니다. |
| parent | Combo 의 부모 오브젝트를 갖는 읽기전용 속성입니다. |
| popupsize | 화면에 팝업으로 표시되는 아이템 리스트의 크기를 설정하는 속성입니다. |
| popuptype | Combo 의 아이템 리스트가 표시되는 방식을 설정하는 속성입니다. |
| positionstep | 부모 오브젝트가 화면분할기능을 사용할 때 Combo 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다. |
| readonly | Combo 에서 아이템 변경을 허용할 지 설정하는 속성입니다. |
| right | Combo 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다. |
| rtl | Combo 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다. |
...
| scrollindicatorsize | Combo 에 표시되는 스크롤 인디케이터바의 크기를 설정하는 속성입니다. |
| selectbyarrowkey | combolist 컨트롤이 열린 상태에서 아이템 항목 이동과 아이템 선택 결정을 동시에 처리할지 여부를 설정하는 속성입니다. |
| tablecellarea | Layout 컨테이너 내 가상의 Table Cell 영역 내에서 컴포넌트가 배치되는 영역을 설정합니다. |
| taborder | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 Combo 의 순서를 설정하는 속성입니다. |
| tabstop | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 Combo 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다. |
| text | Combo 에서 선택된 아이템의 데이터값을 갖는 속성입니다. |
| tooltiptext | Combo 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다. |
| tooltiptype | Combo 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다. |
| top | Combo 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다. |
| type | Combo 가 동작하는 방법을 설정하는 속성입니다. |
| usecontextmenu | Combo 의 편집영역에서 오른쪽 마우스 클릭 시 기본팝업메뉴의 표시 여부를 설정하는 속성입니다. |
| usesoftkeyboard | Combo 가 포커스를 가질 때 키패드의 표시 여부를 설정하는 속성입니다. |
| value | Combo 에서 선택된 아이템의 코드값을 갖는 속성입니다. |
| visible | Combo 이(가) 화면에 표시될지 여부를 설정하는 속성입니다. |
| width | Combo 을(를) 표시하기 위한 너비를 설정하는 속성입니다. |
| word-spacing | Combo 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다. |

**Method**

| Name | Description |
| --- | --- |
| addEvent | Combo 에 특정 이벤트를 선언하여 추가하는 메소드입니다. |
| addEventHandler | Combo 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다. |
| addEventHandlerLookup | 함수를 검색하여 Combo 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다. |
| bringToFront | 부모가 동일한 컴포넌트 중 Combo 이(가) 화면의 제일 앞에 표시되게 합니다. |
| bringToPrev | 부모가 동일한 컴포넌트 중 Combo 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| clearEventHandler | 특정 이벤트에 등록된 핸들러 함수를 모두 제거하는 메소드입니다. |
| destroy | 스크립트에서 동적으로 생성한 Combo 을(를) 삭제하는 메소드입니다. |
| dropdown | Combo 의 아이템 리스트를 화면에 표시하는 메소드입니다. |
| findEventHandler | Combo 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다. |
| getCaretPos | Combo 의 편집영역에서 캐럿이 위치한 인덱스를 반환하는 메소드입니다. |
| getCount | Combo 에 표시되는 전체 아이템의 갯수를 반환하는 메소드입니다. |
| getEventHandler | Combo 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다. |
| getInnerDataset | Combo 의 innerdataset 속성에 설정되어 있는 DataSet 오브젝트를 반환하는 메소드입니다. |
| getOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 Combo 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetHeight | Combo 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 Combo 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 Combo 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 Combo 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getOffsetWidth | Combo 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다. |
| getPixelBottom | Combo 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelHeight | Combo 의 height 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelLeft | Combo 의 left 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelRight | Combo 의 right 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelTop | Combo 의 top 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getPixelWidth | Combo 의 width 속성값을 픽셀단위로 반환하는 메소드입니다. |
| getSelect | Combo 컴포넌트의 텍스트 편집 영역에서 선택한 텍스트의 시작 인덱스와 끝 인덱스를 배열 형태로 반환하는 메서드입니다. |
| getSelectedText | Combo 컴포넌트의 텍스트 편집 영역에서 선택한 텍스트를 반환하는 메서드입니다. |
| init | 스크립트로 Combo 을(를) 동적 생성한 후에 초기화하는 메소드입니다. |
| insertEventHandler | Combo 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다. |
| isDropdown | Combo 의 아이템 리스트가 화면에 표시되어 있는지 여부를 반환하는 메소드입니다. |
| move | Combo 의 위치와 크기를 변경하는 메소드입니다. |
| moveToNext | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Combo 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| moveToPrev | 부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Combo 이(가) 화면에 한단계 앞에 표시되게 합니다. |
| removeEvent | Combo 에 선언된 특정 이벤트를 삭제하는 메소드입니다. |
| removeEventHandler | Combo 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다. |
| removeEventHandlerLookup | Combo 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다. |
| resize | Combo 의 크기를 변경하는 메소드입니다. |
| sendToBack | 부모가 동일한 컴포넌트 중 Combo 이(가) 화면의 제일 뒤에 표시되게 합니다. |
| sendToNext | 부모가 동일한 컴포넌트 중 Combo 이(가) 화면에 한단계 뒤에 표시되게 합니다. |
| setEventHandler | Combo 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다. |
| setEventHandlerLookup | Combo 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다. |
| setFocus | Combo 에 포커스를 설정하는 메서드입니다. |
| setInnerDataset | Combo 의 innerdataset 속성에 인수로 전달된 DataSet 오브젝트를 설정하는 메소드입니다. |
| setOffsetBottom | 부모 컴포넌트의 Top 위치를 기준으로 Combo 의 bottom 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetHeight | Combo 의 높이를 픽셀단위로 설정하는 메소드입니다. |
| setOffsetLeft | 부모 컴포넌트의 Left 위치를 기준으로 Combo 의 left 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetRight | 부모 컴포넌트의 Left 위치를 기준으로 Combo 의 right 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetTop | 부모 컴포넌트의 Top 위치를 기준으로 Combo 의 top 값을 픽셀단위로 설정하는 메소드입니다. |
| setOffsetWidth | Combo 의 너비를 픽셀단위로 설정하는 메소드입니다. |
| setSelect | Combo 의 에디트 영역에 포커스가 있을 때 인수로 지정된 영역을 선택하는 메소드입니다. |
| setSelectedText | Combo 의 편집영역에서 현재 선택되어 있는 텍스트를 전달된 인수값으로 변경하는 메소드입니다. |
| show | 스크립트로 동적 생성한 Combo 을(를) 화면에 표시하는 메소드입니다. |
| updateToDataset | Combo 의 value 속성값을 바인딩 되어 있는 DataSet 에 즉시 반영시키는 메소드입니다. |
...
| oneditclick | Combo 컴포넌트의 텍스트 편집 영역에서 마우스 왼쪽 버튼을 클릭했을 때 발생하는 이벤트입니다. |
...
> Components > Component > Combo > Property > -nexa-border

**Description**

Combo 의 테두리를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.border[= strborder]
```
...
this.Combo00.border = "1px solid #999999";
this.Combo00.border = "1px solid #999999, 1px solid #999999, 1px solid #999999, 1px solid #999999";
```
...
> Components > Component > Combo > Property > -nexa-edge

**Description**

Combo 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.
...
* Script ( normal property )
this.Combo00.edge = "URL('./images/border.png')" 5px 5px;
```
...
- Combo 내부에 테두리 형태로 이미지를 표시하고자 할 때 사용하는 속성입니다.
...
> Components > Component > Combo > Property > -nexa-padding

**Description**

Combo 영역의 안쪽 여백을 설정하는 속성입니다.

**Syntax**

```javascript
Combo.padding[= strpadding]
```
...
* Script ( normal property )
this.Combo00.padding = "5px 5px 5px 5px";
```
- **`<npadding>`** — Combo 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
- -nexa-padding 속성은 내부 컨텐츠영역과 Combo 사이의 여백으로 적용됩니다.
...
> Components > Component > Combo > Property > -nexa-rtl-background-image

**Description**

Combo 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.-nexa-rtl-background-image
```
...
> Components > Component > Combo > Property > -nexa-rtl-edge-image

**Description**

Combo 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.-nexa-rtl-edge-image
```
...
> Components > Component > Combo > Property > acceptvaluetype

**Description**

Combo 에서 InnerDataset 에 없는 코드값을 스크립트로 value 속성에 설정할 때 처리방식을 결정하는 속성입니다.

**Syntax**

```javascript
Combo.acceptvaluetype[= enumAccept]
```
...
```
```javascript
this.Combo00.acceptvaluetype = "ignoreinvalid";
```
...
- Combo 에 바인드 된 DataSet 의 데이터값이 value 속성에 설정되는 경우는 적용되지 않습니다.
...
> Components > Component > Combo > Property > accessibilityaction

**Description**

Combo에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.accessibilityaction[= strAction]
```

**Setting Syntax**

```javascript
this.Combo00.accessibilityaction = "Accessibility Action Message"; 
this.Combo00.accessibilityaction = "Select by direction key";
```
...
> Components > Component > Combo > Property > accessibilitydesclevel

**Description**

Combo 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.accessibilitydesclevel[= enumLevel]
```
...
```
```javascript
this.Combo00.accessibilitydesclevel = "all";
```
- **`"all"`** — Combo 와 자식 컴포넌트에 대한 접근성을 모두 출력합니다.
- **`"self"`** — Combo 의 접근성만 출력하고 자식 컴포넌트의 접근성은 출력하지 않습니다.
- **`"child"`** — Combo 의 접근성은 출력하지 않고, 자식 컴포넌트의 접근성은 출력합니다.
- **`"none"`** — Combo 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
...
- accessibilitydesclevel 속성은 선택상자의 이동에 영향을 주지 않으므로 방향키로 선택상자가 Combo 에 이동되게 하지 않으려면 accessibilityenable 속성을 설정하여야 합니다.
...
> Components > Component > Combo > Property > accessibilitydescription

**Description**

Combo에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.accessibilitydescription[= strDescription]
```

**Setting Syntax**

```javascript
this.Combo00.accessibilitydescription = "Option";
```
...
> Components > Component > Combo > Property > accessibilityenable

**Description**

Combo 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.accessibilityenable[= bEnable]
```
...
```
```javascript
this.Combo00.accessibilityenable = false;
```
- **`true`** — Combo 에 선택상자가 이동되면 접근성 관련 속성값을 출력합니다.

방향키 또는 제스처로 선택상자 이동 시 Static 과 같이 포커스를 갖지 않는 컴포넌트에도 선택상자가 이동됩니다.
- **`false`** — Combo 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.

데스크탑 환경에서 방향키로 선택상자가 Combo 에 이동되지 않습니다.
모바일 환경에서 제스처로 선택상자가 Combo 에 이동되지 않습니다.
...
- 선택상자 이동 시 컴포넌트의 ARIA-LABEL + Status + Role 순서로 정보가 조합되어 접근성으로 출력됩니다.
   ...
   > Status : Combo 의 현재 상태가 반영됩니다.
   > Role : accessibilityrole 속성값이 반영됩니다. accessibilityrole 속성값을 설정하지 않으면 Combo 의 고유 Role 이 반영됩니다.

- accessibilityenable 속성값이 false 일 때 데스크탑 환경에서 방향키 외의 방법으로 선택상자를 Combo 로 이동시키면 스크린 리딩 프로그램에서 임의의 값을 출력할 수 있습니다.
...
> Components > Component > Combo > Property > accessibilitylabel

**Description**

Combo에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.accessibilitylabel[= strLabel]
```

**Setting Syntax**

```javascript
this.Combo00.accessibilitylabel = "OK Button"; 
this.Combo00.accessibilitylabel = "[@static00]"; 
this.Combo00.accessibilitylabel = "[@static00][@static01]"; 
this.Combo00.accessibilitylabel = "[@static00][@static01] OK Button";
```
...
> Components > Component > Combo > Property > accessibilityrole

**Description**

Combo에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.accessibilityrole[= enumRole]
```
...
```
```javascript
this.Combo00.accessibilityrole = "none"; 
this.Combo00.accessibilityrole = "button";
```
...
- accessibilityenable 속성값을 설정하지 않으면 Combo의 기본 Role 로 적용됩니다.

- 추가적인 속성값이 필요한 Role 설정 시 Combo에 해당 속성이 없으면 스크린 리더에 따라 정상적으로 정보를 읽지 못할 수 있습니다.
...
> Components > Component > Combo > Property > autoselect

**Description**

Combo 의 편집영역이 활성화 될 때 텍스트를 전체선택 할지 설정하는 속성입니다.

**Syntax**

```javascript
Combo.autoselect[= bAutoselect]
```
...
```
```javascript
this.Combo00.autoselect = true;this.Combo00.autoselect = false;
```
...
> Components > Component > Combo > Property > autoskip

**Description**

Combo의 아이템이 선택되었을 때 포커스를 자동으로 이동시킬지 설정하는 속성입니다.

**Syntax**

```javascript
Combo.autoskip[= bAutoskip]
```
...
```
```javascript
this.Combo00.autoskip = true;this.Combo00.autoskip = false;
```
- **`true`** — Combo 의 아이템이 선택되었을 때 포커스를 다음 컴포넌트로 이동시킵니다.
- **`false`** — Combo 의 아이템이 선택되어도 포커스를 이동시키지 않습니다.

**Remark**

- autoskip 속성값을 설정하지 않으면 false 로 적용됩니다.

- 엔터키나 마우스로 리스트를 선택완료하면 Combo 의 아이템이 선택된 것으로 처리합니다.
...
> Components > Component > Combo > Property > background

**Description**

Combo 의 배경 영역을 설정하는 속성입니다.

**Syntax**

```javascript
Combo.background[= strbackground]
```
...
* Script ( normal property )
this.Combo00.background = "#ffffaa";
this.Combo00.background = ""URL('./images/smiley.gif')" no-repeat center center #ffffaa";
this.Combo00.background = ""URL('./images/smiley.gif')" no-repeat center center /auto #ffffaa";
this.Combo00.background = ""URL('./images/smiley.gif')" no-repeat center center /15px 15% #ffffaa";
this.Combo00.background = "linear-gradient( red , blue , yellow )";
this.Combo00.background = "linear-gradient( #FF0000 , rgb(0,0,255) , rgb(255,255,0))";
this.Combo00.background = ""URL('./images/smiley.gif')" border-box border-box #ffffaa";
```
...
"left" 설정 시 Combo 의 왼쪽면과 이미지의 왼쪽면이 정렬되어 표시됩니다.
"center" 설정 시 Combo 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"right" 설정 시 Combo 의 오른쪽면과 이미지의 오른쪽면이 정렬되어 표시됩니다.
...
"top" 설정 시 Combo 의 윗쪽면과 이미지의 윗쪽면이 정렬되어 표시됩니다.
"center" 설정 시 Combo 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"bottom" 설정 시 Combo 의 아랫쪽면과 이미지의 아랫쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
0 보다 작거나 100 보다 큰 값을 설정 시 Combo 의 영역을 벗어난 가상의 위치로 적용됩니다.
...
예를 들어 <angle> 값이 "to left" 이면 Combo 의 right 위치가 시작점이 되고, left 위치가 끝점이 됩니다.
              <angle> 값이 "to right" 이면 Combo 의 left 위치가 시작점이 되고, right 위치가 끝점이 됩니다.
...
<bg-image> 에 적용된 이미지에 투명으로 적용된 부분이 있거나 이미지가 Combo 영역보다 작다면 해당 영역에 배경색이 표시됩니다.
...
> Components > Component > Combo > Property > border-radius

**Description**

Combo 의 모서리 모양을 설정하는 속성입니다.

**Syntax**

```javascript
Combo.borderRadius[= strborderradius]
```
...
* Script ( normal property )
this.Combo00.borderRadius = "10px";
this.Combo00.borderRadius = "5px 6px 10px / 5px 10px";
```
...
> Components > Component > Combo > Property > bottom

**Description**

Combo 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
Combo.bottom[= nBottom]
```
...
```
```javascript
this.Combo00.bottom = 10; 
this.Combo00.bottom = "10px"; 
this.Combo00.bottom = "10%"; 
this.Combo00.bottom = "Button00:10px"; 
this.Combo00.bottom = "Button00:10%";
```
- **`<strCompID>`** — Combo 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 Combo 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 Combo 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Combo 의 하단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 bottom 속성값을 기준으로 Combo의 하단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 Combo의 하단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Combo의 하단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Combo의 하단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 top 속성값을 기준으로 Combo의 하단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 Combo의 하단 위치 결정
...
> Components > Component > Combo > Property > box-shadow

**Description**

Combo 에 그림자 효과를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.boxShadow[= strbshadow]
```
...
* Script ( normal property )
this.Combo00.boxShadow  = "10px 10px 10px #888888";
this.Combo00.boxShadow  = "inset 10px 10px 10px 5px #888888";
```
...
Combo 의 좌상단 위치를 기준으로 그림자 효과가 표시될 위치를 가로/세로 픽셀값으로 설정합니다.
...
> Components > Component > Combo > Property > buttonsize

**Description**

Combo 드롭다운 버튼의 크기를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.buttonsize[= strSize]
```
...
- buttonsize 속성값을 설정하지 않으면 undefined 로 적용됩니다.
  undefined 설정 시 Combo 의 height 속성값이 적용됩니다.

- <strWidth> 값이 Combo 의 width 속성값보다 클 경우 Combo 의 너비에 맞게 드롭다운 버튼이 표시됩니다.
...
> Components > Component > Combo > Property > codecolumn

**Description**

Combo 의 아이템 리스트에서 코드값으로 사용될 Column을 설정하는 속성입니다.

**Syntax**

```javascript
Combo.codecolumn[= strColumnID]
```

**Setting Syntax**

```javascript
this.Combo00.codecolumn = "codecolumn";
```
...
- Combo 에서 선택된 아이템의 코드값은 value 속성에 설정됩니다.
...
> Components > Component > Combo > Property > color

**Description**

Combo 에 표시되는 텍스트의 색상을 설정하는 속성입니다.

**Syntax**

```javascript
Combo.color[= strcolor]
```
...
* Script ( normal property )
this.Combo00.color = "#999999";
this.Combo00.color = "rgb(255,0,0)";
this.Combo00.color = "red";
```
- **`<NamedColor>`** — "red","blue" 와 같이 미리 정의된 색상이름을 문자열로 설정합니다.
- **`<NumericColor>`** — 표시할 색의 색상코드입니다.
...
> Components > Component > Combo > Property > comboedit

**Description**

Combo 의 서브컨트롤인 편집영역(comboedit) 오브젝트를 갖는 속성입니다.
...
```javascript
var edit = this.Combo00.comboedit ;
```
...
> Components > Component > Combo > Property > combolist

**Description**

Combo 의 서브컨트롤인 아이템 리스트(combolist) 오브젝트를 갖는 속성입니다.
...
```javascript
var listbox = this.Combo00.combolist ;
```

**Remark**

- 아이템 리스트(combolist)가 최초 한번 표시된 후에 접근할 수 있습니다.
...
> Components > Component > Combo > Property > cssclass

**Description**

Combo 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다.

**Syntax**

```javascript
Combo.cssclass[= strcssclass]
```
...
```
```javascript
this.Combo00.cssclass = "TestClass"; 
this.Combo00.cssclass = "TestClass,TestClass2";
```
...
> Components > Component > Combo > Property > cursor

**Description**

Combo 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.cursor[= strCursor]
```
...
> Components > Component > Combo > Property > datacolumn

**Description**

Combo 의 아이템 리스트에서 데이터값으로 사용될 Column을 설정하는 속성입니다.

**Syntax**

```javascript
Combo.datacolumn[= strColumnID]
```

**Setting Syntax**

```javascript
this.Combo00.datacolumn = "datacolumn";
```
...
- Combo 에서 선택된 아이템의 데이터값은 text 속성값에 설정됩니다.
...
> Components > Component > Combo > Property > displaynulltext

**Description**

Combo 의 value 속성값이 null 또는 undefined 일 때 Combo 에 표시될 대체 문자열을 설정하는 속성입니다.

**Syntax**

```javascript
Combo.displaynulltext[= strText]
```

**Setting Syntax**

```javascript
this.Combo00.displaynulltext = "no value";
```
- **`strText`** — value 속성값이 null 일 때 Combo 에 표시될 대체 문자열을 설정합니다.

**Remark**

- value 속성값이 null 또는 undefined 이고, Combo 에 포커스가 없을 때 대체 문자열이 표시됩니다.
...
> Components > Component > Combo > Property > displayrowcount

**Description**

Combo 의 아이템 리스트에 표시될 아이템의 최대 갯수를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.displayrowcount[= nRowNum]
```
...
> Components > Component > Combo > Property > dropbutton

**Description**

Combo 의 서브컨트롤인 드롭버튼(DropButton) 오브젝트를 갖는 속성입니다
...
```javascript
var objButton = this.Combo00.dropbutton;
```
...
> Components > Component > Combo > Property > enable

**Description**

Combo 의 사용가능 여부를 설정하는 속성입니다.
...
```
```javascript
this.Combo00.enable = true; 
this.Combo00.enable = false;
```
- **`true`** — Combo 을(를) 사용할 수 있게 설정합니다.
- **`false`** — Combo 을(를) 사용할 수 없게 설정합니다.
...
> Components > Component > Combo > Property > enableevent

**Description**

Combo 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.enableevent[= bEvent]
```
...
```
```javascript
this.Combo00.enableevent = true;  
this.Combo00.enableevent = false;
```
- **`true`** — Combo 에서 이벤트가 발생하도록 설정합니다.
- **`false`** — Combo 에서 이벤트가 발생하지 않도록 설정합니다.
...
> Components > Component > Combo > Property > flexgrow
...
> Components > Component > Combo > Property > flexshrink
...
> Components > Component > Combo > Property > font

**Description**

Combo 에서 사용하는 폰트를 설정하는 속성입니다.
...
* Script ( normal property )
this.Combo00.font = "bold 12pt/30px arial, sans-serif";
```
...
> Components > Component > Combo > Property > height

**Description**

Combo 을(를) 표시하기 위한 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.height[= nHeight]
```
...
```
```javascript
this.Combo00.height = 10; 
this.Combo00.height = "10px"; 
this.Combo00.height = 10%"; 
this.Combo00.height = Button00:10%";
```
- **`<strCompID>`** — Combo 의 높이를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 Combo 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 Combo 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 높이가 적용됩니다.
- **`<nVal>`** — Combo 의 높이를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.


* <strCompID> 값을 생략했을 때 :
- "px": Combo의 높이 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 Combo의 높이 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Combo의 높이 결정
- "rem": MainFrame font-size 속성값을 기준으로 Combo의 높이 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 Combo의 높이 결정
- "%": <strCompID>의 height 속성값을 기준으로 Combo의 높이 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Combo > Property > hotkey

**Description**

Combo 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.hotkey[= strHotkey]
```

**Setting Syntax**

```javascript
this.Combo00.hotkey = "G"; 
this.Combo00.hotkey = "CTRL+A"; 
this.Combo00.hotkey = "CTRL+ALT+X";
```
...
> Components > Component > Combo > Property > id

**Description**

Combo의 고유 식별자를 설정하는 속성입니다.
...
> Components > Component > Combo > Property > imemode

**Description**

Combo 의 기본 입력 언어를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.imemode[= enumImemode]
```
...
> Components > Component > Combo > Property > index

**Description**

Combo 의 아이템 중 선택된 아이템의 인덱스를 갖는 속성입니다.
...
```javascript
this.Combo00.index = 5;var nIdx = this.Comb00.index;
```
...
> Components > Component > Combo > Property > initvalueid

**Description**

Combo 에 적용될 InitValue 의 ID 를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.initvalueid[= strValueID]
```

**Setting Syntax**

- **`strValueID`** — InitValueDefinition 영역에 정의된 InitValue 파일에서 Combo 에 적용할 항목의 ID 를 문자열로 설정합니다.

**Remark**

- Combo 가 화면에 표시된 후에는 속성값을 설정하거나 변경 할 수 없습니다.
   Combo 를 동적으로 생성 시 show() 메소드 실행 전에 속성값을 설정하여야 합니다.
...
> Components > Component > Combo > Property > innerdataset

**Description**

Combo 의 아이템 리스트를 구성할 DataSet 의 ID를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.innerdataset[= strDatasetID]
```

**Setting Syntax**

```javascript
this.Comb00.innerdataset = "Dataset00";
```
...
- innerdataset 속성값을 변경하거나 DataSet 이 갱신되면 Combo 의 value 속성값에 해당하는 아이템이 자동으로 선택됩니다.
  만일 DataSet에 value 속성값에 해당하는 아이템이 없다면 Combo 에서 표시되는 값을 유지하게 됩니다.
...
> Components > Component > Combo > Property > itemheight

**Description**

Combo 의 아이템 리스트에서 각 행의 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.itemheight[= nHeight]
```

**Setting Syntax**

```javascript
this.Combo00.itemheight = 20;
```
...
> Components > Component > Combo > Property > layoutorder
...
> Components > Component > Combo > Property > left

**Description**

Combo 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.Combo00.left = 10; 
this.Combo00.left = "10px"; 
this.Combo00.left = "10%"; 
this.Combo00.left = "Button00:10px"; 
this.Combo00.left = "Button00:10%";
```
- **`<strCompID>`** — Combo 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Combo 의 좌측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 left 속성값을 기준으로 Combo의 좌측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Combo의 좌측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Combo의 좌측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Combo의 좌측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 right 속성값을 기준으로 Combo의 좌측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 Combo의 좌측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Combo > Property > letter-spacing

**Description**

Combo 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다.

**Syntax**

```javascript
Combo.letterSpacing[= strspace]
```
...
* Script ( normal property )
this.Combo00.letterSpacing = "2px";
```
...
> Components > Component > Combo > Property > maxheight

**Description**

Combo 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.maxheight[= nMaxHeight]
```
...
```
```javascript
this.Combo00.maxheight = 20; 
this.Combo00.maxheight = "20px";
```
- **`<nVal>`** — Combo 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 maxheight 보다 크면 화면에 표시되는 Combo 의 높이는 maxheight 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 Combo 의 높이가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > Combo > Property > maxwidth

**Description**

Combo 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.maxwidth[= nMaxWidth]
```
...
```
```javascript
this.Combo00.maxwidth = 20; 
this.Combo00.maxwidth = "20px";
```
- **`<nVal>`** — Combo 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 maxwidth 보다 크면 화면에 표시되는 Combo 의 너비는 maxwidth 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 Combo 의 너비가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > Combo > Property > minheight

**Description**

Combo 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.minheight[= nMinHeight]
```
...
```
```javascript
this.Combo00.minheight = 20; 
this.Combo00.minheight = "20px";
```
- **`<nVal>`** — Combo 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 minheight 보다 작다면 화면에 표시되는 Combo 의 높이는 minheight 속성값으로 적용됩니다.
  표시되는 높이만 적용되고 height 속성값은 변경되지 않습니다.
...
> Components > Component > Combo > Property > minwidth

**Description**

Combo 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.minwidth[= nMinWidth]
```
...
```
```javascript
this.Combo00.minwidth = 20; 
this.Combo00.minwidth = "20px";
```
- **`<nVal>`** — Combo 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 minwidth 보다 작으면 화면에 표시되는 Combo 의 너비는 minwidth 속성값으로 적용됩니다.
  표시되는 너비만 적용되고 width 속성값은 변경되지 않습니다.
...
> Components > Component > Combo > Property > name

**Description**

Combo 의 이름을 설정하는 속성입니다.
...
> Components > Component > Combo > Property > opacity

**Description**

Combo 영역의 투명도를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.opacity[= stropacity]
```
...
* Script ( normal property )
this.Combo00.opacity = "0.8";
this.Combo00.opacity = 0.8;
this.Combo00.opacity = "80%";
```
...
> Components > Component > Combo > Property > parent

**Description**

Combo 의 부모 오브젝트를 갖는 읽기전용 속성입니다.
...
```javascript
var objParent = this.Combo00.parent;
```
...
- Combo 이(가) Div 와 같은 컨테이너 컴포넌트에 자식으로 존재한다면 parent 속성은 해당 컨테이너 컴포넌트를 갖습니다.
...
> Components > Component > Combo > Property > popupsize
...
```
```javascript
this.Combo00.popupsize  = "120 250";
```
...
> Components > Component > Combo > Property > popuptype

**Description**

Combo 의 아이템 리스트가 표시되는 방식을 설정하는 속성입니다.

**Syntax**

```javascript
Combo.popuptype[= enumType]
```
...
- 다중 모니터의 경우 Combo 가 표시되고 있는 모니터를 기준으로 아이템 리스트가 표시됩니다.
...
> Components > Component > Combo > Property > positionstep

**Description**

부모 오브젝트가 화면분할기능을 사용할 때 Combo 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.positionstep[= nStep]
```

**Setting Syntax**

```javascript
this.Combo00.positionstep = 0; 
this.Combo00.positionstep = -1;
```
- **`nStep`** — Combo 이(가) 표시될 분할화면의 인덱스를 설정합니다.
"-1" 로 설정하면 모든 분할화면에 Combo 이(가) 표시됩니다.
...
> Components > Component > Combo > Property > readonly

**Description**

Combo 에서 아이템 변경을 허용할 지 설정하는 속성입니다.

**Syntax**

```javascript
Combo.readonly[= bReadOnly]
```
...
```
- **`true`** — Combo 에 선택된 아이템을 변경할 수 없으며 아이템 리스트가 표시되지 않습니다.
Combo 에 표시된 텍스트를 선택하여 내용을 복사하는 것은 가능합니다.

하위 컨트롤에 "readonly" Status 가 적용됩니다.
"readonly" Status 가 없는 하위 컨트롤은 "disabled" Status 가 적용됩니다.
- **`false`** — Combo 에 선택된 아이템을 변경할 수 있습니다.
...
> Components > Component > Combo > Property > right

**Description**

Combo 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.Combo00.right = 10; 
this.Combo00.right = "10px"; 
this.Combo00.right = "10%"; 
this.Combo00.right = "Button00:10px"; 
this.Combo00.right = "Button00:10%";
```
- **`<strCompID>`** — Combo 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Combo 의 우측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 right 속성값을 기준으로 Combo의 우측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Combo의 우측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Combo의 우측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Combo의 우측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 left 속성값을 기준으로 Combo의 우측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 Combo의 우측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Combo > Property > rtl

**Description**

Combo 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다.
...
```
```javascript
var vRtl = this.Combo00.rtl;
```
- **`undefined`** — undefined 설정 시 상위 컴포넌트의 rtl 속성값이 적용됩니다.

사용자가 rtl 속성값을 설정하지 않거나 삭제했을 경우 undefined 가 설정됩니다.
- **`true`** — Combo 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 오른쪽으로 설정합니다.
Combo 의 내부 좌표계의 기준을 오른쪽으로 설정합니다.
Combo 의 텍스트 표시 기준을 오른쪽으로 설정합니다.
수직스크롤바가 있을 경우 왼쪽에 표시됩니다.
- **`false`** — Combo 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
Combo 의 내부 좌표계의 기준을 왼쪽으로 설정합니다.
Combo 의 텍스트 표시 기준을 왼쪽으로 설정합니다.
...
- Combo 부터 Environment 까지 상위의 모든 rtl 속성값이 undefined 이면
...
> Components > Component > Combo > Property > scrollbarbarminsize
...
```javascript
Combo.scrollbarbarminsize[= nSize]
```

**Setting Syntax**

```javascript
this.Combo00.scrollbarbarminsize = 20;
```
...
> Components > Component > Combo > Property > scrollbarbaroutsize
...
```javascript
Combo.scrollbarbaroutsize[= nSize]
```

**Setting Syntax**

```javascript
this.Combo00.scrollbarbaroutsize = 50;
```
...
> Components > Component > Combo > Property > scrollbardecbuttonsize
...
```javascript
Combo.scrollbardecbuttonsize[= nHeight]
```

**Setting Syntax**

```javascript
this.Combo00.scrollbardecbuttonsize = 30;
```
...
> Components > Component > Combo > Property > scrollbarincbuttonsize
...
```javascript
Combo.scrollbarincbuttonsize[= nHeight]
```

**Setting Syntax**

```javascript
this.Combo00.scrollbarincbuttonsize = 30;
```
...
> Components > Component > Combo > Property > scrollbarsize
...
```javascript
Combo.scrollbarsize[= nWidth]
```

**Setting Syntax**

```javascript
this.Combo00.scrollbarsize = 20;
```
...
> Components > Component > Combo > Property > scrollbartrackbarsize
...
```javascript
Combo.scrollbartrackbarsize[= nSize]
```

**Setting Syntax**

```javascript
this.Combo00.scrollbartrackbarsize = 20;
```
...
> Components > Component > Combo > Property > scrollindicatorsize

**Description**

Combo 에 표시되는 스크롤 인디케이터바의 크기를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.scrollindicatorsize[= nSize]
```

**Setting Syntax**

```javascript
this.Combo00.scrollindicatorsize = 30;
```
...
- Combo 에 스크롤 인디케이터바가 아닌 스크롤바가 표시될 경우 scrollbarsize 속성으로 크기를 설정하여야 합니다.
...
```javascript
Combo.selectbyarrowkey[= bSelectbyarrowkey]
```
...
```
- **`true`** — combolist 컨트롤이 열린 상태에서 아이템 항목을 이동하면 선택 결정된 상태가 되어 value 속성에 반영합니다.
- **`false`** — combolist 컨트롤이 열린 상태에서 아이템 항목 이동 후 Enter 키를 입력하면 아이템 선택 결정이 처리됩니다.
...
> Components > Component > Combo > Property > tablecellarea
...
> Components > Component > Combo > Property > taborder

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 Combo 의 순서를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.taborder[= nTabOrder]
```
...
> Components > Component > Combo > Property > tabstop

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 Combo 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.tabstop[= bTabStop]
```
...
bTabStop ::= 'true' | 'false'
```
- **`"true"`** — Combo 이(가) 탭키 입력에 의한 포커스를 받습니다.
- **`"false"`** — Combo 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
...
> Components > Component > Combo > Property > text

**Description**

Combo 에서 선택된 아이템의 데이터값을 갖는 속성입니다.
...
> Components > Component > Combo > Property > tooltiptext

**Description**

Combo 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다.

**Syntax**

```javascript
Combo.tooltiptext[= strToolTipText]
```

**Setting Syntax**

```javascript
this.Combo00.tooltiptext = "This is ToolTip Text"; this.Combo00.tooltiptext = "";          // 풍선 도움말이 표시되지 않습니다. 
this.Combo00.tooltiptext = null;        // 상위 컴포넌트의 풍선 도움말이 표시됩니다.
```
...
- 마우스 포인터가 Combo 영역 위에서 일정시간 움직이지 않으면 풍선도움말이 표시됩니다.
...
> Components > Component > Combo > Property > tooltiptype

**Description**

Combo 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다.

**Syntax**

```javascript
Combo.tooltiptype[= enumTooltipType]
```
...
```
```javascript
this.Combo00.tooltiptype = "hover";
```
- **`"default"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Combo 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"hover"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Combo 영역내에 멈춰서 일정시간이 경과하면 풍선도움말이 사라집니다.
Combo 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경되거나 사라진 풍선도움말이 다시 표시됩니다.
- **`"inplace"`** — Combo 의 좌측상단 안쪽에 풍선도움말을 표시합니다.

마우스 포인터가 Combo 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"default,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Combo 영역에 있으면 풍선도움말이 사라지지 않습니다.
- **`"hover,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 Combo 영역에 있으면 풍선도움말이 사라지지 않습니다.
Combo 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경됩니다.
- **`"inplace,mouseleave"`** — Combo 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
- 표시되었다가 사라진 풍선도움말은 마우스 포인터가 Combo 영역을 나갔다가 들어오면 다시 표시됩니다.

- 마우스 포인터가 Combo 영역에서 벗어나면 풍선도움말이 사라집니다.
...
> Components > Component > Combo > Property > top

**Description**

Combo 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다.
...
```javascript
this.Combo00.top = 10; 
this.Combo00.top = "10px"; 
this.Combo00.top = "10%"; 
this.Combo00.top = "Button00:10px"; 
this.Combo00.top = "Button00:10%";
```
- **`<strCompID>`** — Combo 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — Combo의 상단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 top 속성값을 기준으로 Combo의 상단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 Combo의 상단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Combo의 상단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 Combo의 상단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 bottom 속성값을 기준으로 Combo의 상단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 Combo의 상단 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
```
```javascript
this.Combo00.type = "caseifilter";
```
- **`"dropdown"`** — 아이템 리스트에 전체 아이템이 모두 표시됩니다.

Combo 의 편집창에 문자를 입력할 수 없습니다.
- **`"search"`** — Combo 의 편집창에 문자열 입력 시 검색기능이 활성화됩니다.
...
- **`"filter"`** — Combo 의 편집창에 문자열 입력 시 필터기능이 활성화됩니다.
...
- **`"filterlike"`** — Combo 의 편집창에 문자열 입력 시 필터기능이 활성화됩니다.
...
문자를 추가로 입력하면 아이템 리스트가 자동으로 갱신됩니다.
아이템 필터 시 대소문자를 구별합니다.
- **`"caseisearch"`** — Combo 의 편집창에 문자열 입력 시 검색기능이 활성화됩니다.

"search" 값과 동일하게 동작하며 아이템 검색 시 대소문자를 구별하지 않습니다.
- **`"caseifilter"`** — Combo 의 편집창에 문자열 입력 시 필터기능이 활성화됩니다.

"filter" 값과 동일하게 동작하며 아이템 필터 시 대소문자를 구별하지 않습니다.
- **`"caseifilterlike"`** — Combo 의 편집창에 문자열 입력 시 필터기능이 활성화됩니다.
...
> Components > Component > Combo > Property > usecontextmenu

**Description**

Combo 의 편집영역에서 오른쪽 마우스 클릭 시 기본팝업메뉴의 표시 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.usecontextmenu[= bUseContextMenu]
```
...
```
```javascript
this.Combo00.usecontextmenu = true;
```
...
- Environment 의 usecontextmenu 속성값이 "none" 또는 "form" 인 경우 Combo 의 usecontextmenu 속성은 false 로 동작합니다.
...
> Components > Component > Combo > Property > usesoftkeyboard

**Description**

Combo 가 포커스를 가질 때 키패드의 표시 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.usesoftkeyboard[= bUseKeyboard]
```
...
```
```javascript
this.Combo00.usesoftkeyboard = false;
```
- **`true`** — Combo 가 포커스를 가질 때 키패드가 자동으로 표시됩니다.
- **`false`** — Combo 가 포커스를 가질 때 키패드가 표시되지 않습니다.
...
> Components > Component > Combo > Property > value

**Description**

Combo 에서 선택된 아이템의 코드값을 갖는 속성입니다.

**Syntax**

```javascript
Combo.value[= strValue]
```

**Setting Syntax**

```javascript
this.Combo00.value  = "00";
```
...
- Combo 에서 선택된 아이템의 코드값이 value 속성값으로 설정됩니다.

- Combo 에 DataSet 을 바인딩 하면 기본적으로 연동되는 속성입니다.
...
> Components > Component > Combo > Property > visible

**Description**

Combo 이(가) 화면에 표시될지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
Combo.visible[= bVisible]
```
...
```
```javascript
this.Combo00.visible = true; 
this.Combo00.visible = false;
```
- **`"true"`** — Combo 을(를) 화면에 표시합니다.
...
> Components > Component > Combo > Property > width

**Description**

Combo 을(를) 표시하기 위한 너비를 설정하는 속성입니다.
...
```
```javascript
this.Combo00.width = 10; this.Combo00.width = "10px"; 
this.Combo00.width = "10%"; 
this.Combo00.width = "Button00:10%";
```
- **`<strCompID>`** — Combo 의 너비를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 Combo 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 Combo 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 너비가 적용됩니다.
- **`<nVal>`** — Combo 의 너비를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": Combo의 너비 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 Combo의 너비 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 Combo의 너비 결정
- "rem": MainFrame font-size 속성값을 기준으로 Combo의 너비 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 Combo의 너비 결정
- "%": <strCompID>의 width 속성값을 기준으로 Combo의 너비 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > Combo > Property > word-spacing

**Description**

Combo 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다.

**Syntax**

```javascript
Combo.wordSpacing[= strwordspacing]
```
...
> Components > Component > Combo > Method > addEvent

**Description**

Combo 에 특정 이벤트를 선언하여 추가하는 메소드입니다.

**Syntax**

```javascript
Combo.addEvent( strEventID )
```
...
| --- | --- | --- |
| strEventID | String | Combo 에 추가할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.Combo00.addEvent( "onmove" );
```
...
- Combo 에서 특정 이벤트를 제거하려면 removeEvent() 메소드를 사용하여야 합니다.
...
> Components > Component > Combo > Method > addEventHandler

**Description**

Combo 의 특정 이벤트에 핸들러 함수를 추가하는 메소드입니다.

**Syntax**

```javascript
Combo.addEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.Combo00_onmove = function( obj:nexacro.Combo,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Combo00.addEventHandler( "onmove", this.Combo00_onmove, this);
```
...
> Components > Component > Combo > Method > addEventHandlerLookup

**Description**

함수를 검색하여 Combo 의 특정 이벤트에 핸들러 함수로 추가하는 메소드입니다.

**Syntax**

```javascript
Combo.addEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.Combo00_onmove = function( obj:nexacro.Combo,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Combo00.addEventHandlerLookup( "onmove", "Combo00_onmove", this);
```
...
> Components > Component > Combo > Method > bringToFront

**Description**

부모가 동일한 컴포넌트 중 Combo 이(가) 화면의 제일 앞에 표시되게 합니다.
...
- bringToFront() 메소드는 Combo 을(를) 가장 나중에 표시되게 순서를 바꿉니다.
...
> Components > Component > Combo > Method > bringToPrev

**Description**

부모가 동일한 컴포넌트 중 Combo 이(가) 화면에 한단계 앞에 표시되게 합니다.
...
- bringToPrev() 메소드는 Combo 을(를) 한단계 나중에 표시되는 컴포넌트와 순서를 바꿉니다.
...
> Components > Component > Combo > Method > clearEventHandler
...
```javascript
Combo.clearEventHandler( strEventID )
```
...
```javascript
var nCnt = this.Combo00.clearEventHandler( "onmove" );
```
...
> Components > Component > Combo > Method > destroy

**Description**

스크립트에서 동적으로 생성한 Combo 을(를) 삭제하는 메소드입니다.
...
var bSucc = this.Combo00.destroy();

**Return**

| Type | Description |
| --- | --- |
| Boolean | Combo 이(가) 정상적으로 삭제되면 true 를 반환합니다.

Combo 이(가) 정상적으로 삭제되지 않으면 false 를 반환합니다. |

**Remark**

- 동적으로 생성한 Combo 을(를) 완전히 삭제하기 위해서는 destroy() 메소드를 호출해야 합니다.

**See Also**

Combo.initCombo.showForm.addChildForm.insertChildForm.removeChild
...
> Components > Component > Combo > Method > dropdown

**Description**

Combo 의 아이템 리스트를 화면에 표시하는 메소드입니다.
...
- Combo 의 visible 속성값이 false 이거나 enable 속성값이 false 이면 메소드가 동작하지 않습니다.

- 화면에 아이템 리스트가 표시되어 있다면 메소드가 동작하지 않습니다.

- type 속성값이 "search" 또는 "filter" 일 때 검색 기능이 활성화 된 상태에서 dropdown() 메소드를 실행하면
  자동으로 표시되어 있던 검색된 아이템 리스트가 닫히고, 전체 아이템이 있는 리스트가 화면에 표시됩니다.


◆ Mobile 제약

- Android 에서 입력패드가 표시되어 있을 때는 dropdown() 메소드가 곧바로 적용되지 않습니다.
...
> Components > Component > Combo > Method > findEventHandler

**Description**

Combo 의 특정 이벤트에서 핸들러 함수를 찾아 인덱스를 반환하는 메소드입니다.

**Syntax**

```javascript
Combo.findEventHandler( strEventID, objFunc, objTarget )
```
...
var nIndex = this.Combo00.findEventHandler( "onmove", this.Combo00_onmove, this );
```
...
> Components > Component > Combo > Method > getCaretPos

**Description**

Combo 의 편집영역에서 캐럿이 위치한 인덱스를 반환하는 메소드입니다.
...
var nCaretpos = this.Combo00.getCaretPos();
...
읽기 전용 상태이거나 Combo에 포커스가 없으면 "-1"을 반환합니다.
...
> Components > Component > Combo > Method > getCount

**Description**

Combo 에 표시되는 전체 아이템의 갯수를 반환하는 메소드입니다.
...
var nCount = this.Combo00.getCount();

**Return**

| Type | Description |
| --- | --- |
| Number | Combo에 표시되는 전체 아이템의 갯수를 반환합니다. |
...
> Components > Component > Combo > Method > getEventHandler

**Description**

Combo 의 특정 이벤트에서 지정된 인덱스에 해당하는 핸들러 함수를 반환하는 메소드입니다.

**Syntax**

```javascript
Combo.getEventHandler( strEventID, nIdx )
```
...
```javascript
var objFunc = Combo00.getEventHandler( "onmove", 0 );
```
...
> Components > Component > Combo > Method > getInnerDataset

**Description**

Combo 의 innerdataset 속성에 설정되어 있는 DataSet 오브젝트를 반환하는 메소드입니다.

**Syntax**

```javascript
Combo.getInnerDataset()
```

**Parameters**

var objDataset = this.Combo00.getInnerDataset();
...
> Components > Component > Combo > Method > getOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Combo 의 bottom 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
Combo.getOffsetBottom();
```

**Parameters**

var nBottom = this.Combo.getOffsetBottom();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 Combo 의 bottom 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 Combo 의 bottom 값을 동적으로 계산합니다.
...
> Components > Component > Combo > Method > getOffsetHeight

**Description**

Combo 의 높이를 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
Combo.getOffsetHeight();
```

**Parameters**

var nHeight = this.Combo.getOffsetHeight();

**Return**

| Type | Description |
| --- | --- |
| Number | Combo 의 높이를 픽셀단위의 숫자로 변환하여 반환합니다. |

**Remark**

- 화면에 표시된 Combo 의 높이를 동적으로 계산합니다.
...
> Components > Component > Combo > Method > getOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Combo 의 left 값을 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nleft = this.Combo.getOffsetLeft();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 Combo 의 left 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 Combo 의 left 값을 동적으로 계산합니다.
...
> Components > Component > Combo > Method > getOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Combo 의 right 값을 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
Combo.getOffsetRight();
```

**Parameters**

var nRight = this.Combo.getOffsetRight();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 Combo 의 right 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Left 위치를 기준으로 Combo 의 right 값을 동적으로 계산합니다.
...
> Components > Component > Combo > Method > getOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Combo 의 top 값을 픽셀단위의 숫자로 반환하는 메소드입니다.
...
var nTop = this.Combo.getOffsetTop();

**Return**

| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 Combo 의 top 값을 픽셀단위의 숫자로 반환합니다. |

**Remark**

- 화면에 표시된 부모 컴포넌트의 Top 위치를 기준으로 Combo 의 top 값을 동적으로 계산합니다.
...
> Components > Component > Combo > Method > getOffsetWidth

**Description**

Combo 의 너비를 픽셀단위의 숫자로 반환하는 메소드입니다.

**Syntax**

```javascript
Combo.getOffsetWidth();
```

**Parameters**

var nWidth = this.Combo.getOffsetWidth();

**Return**

| Type | Description |
| --- | --- |
| Number | Combo 의 너비를 픽셀단위의 숫자로 변환하여 반환합니다. |

**Remark**

- 화면에 표시된 Combo 의 너비를 동적으로 계산합니다.
...
> Components > Component > Combo > Method > getPixelBottom

**Description**

Combo 의 bottom 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
Combo.getPixelBottom();
```

**Parameters**

var nbottom = this.Combo.getPixelBottom();

**Return**

| Type | Description |
| --- | --- |
| Number | Combo 의 bottom 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Combo > Method > getPixelHeight

**Description**

Combo 의 height 속성값을 픽셀단위로 반환하는 메소드입니다.

**Syntax**

```javascript
Combo.getPixelHeight();
```

**Parameters**

var nheight = this.Combo.getPixelHeight();

**Return**

| Type | Description |
| --- | --- |
| Number | Combo 의 height 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Combo > Method > getPixelLeft

**Description**

Combo 의 left 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nleft = this.Combo.getPixelLeft();

**Return**

| Type | Description |
| --- | --- |
| Number | Combo 의 left 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Combo > Method > getPixelRight

**Description**

Combo 의 right 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nright = this.Combo.getPixelRight();

**Return**

| Type | Description |
| --- | --- |
| Number | Combo 의 right 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Combo > Method > getPixelTop

**Description**

Combo 의 top 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var ntop = this.Combo.getPixelTop();

**Return**

| Type | Description |
| --- | --- |
| Number | Combo 의 top 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Combo > Method > getPixelWidth

**Description**

Combo 의 width 속성값을 픽셀단위로 반환하는 메소드입니다.
...
var nwidth = this.Combo.getPixelWidth();

**Return**

| Type | Description |
| --- | --- |
| Number | Combo 의 width 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > Combo > Method > getSelect

**Description**

Combo 컴포넌트의 텍스트 편집 영역에서 선택한 텍스트의 시작 인덱스와 끝 인덱스를 배열 형태로 반환하는 메서드입니다.
...
var vArrSelect = this.Combo00.getSelect();
...
- Combo 컴포넌트의 텍스트 편집 영역에 포커스가 있고 캐럿이 표시된 상태에서만 정상적으로 값을 반환합니다.
...
> Components > Component > Combo > Method > getSelectedText

**Description**

Combo 컴포넌트의 텍스트 편집 영역에서 선택한 텍스트를 반환하는 메서드입니다.
...
var strText = this.Combo00.getSelectedText();
...
> Components > Component > Combo > Method > init

**Description**

스크립트로 Combo 을(를) 동적 생성한 후에 초기화하는 메소드입니다.
...
| vLeft | String, Number | Combo 의 left 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 right 속성값을 기준으로 Combo 의 left 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 Combo 의 left 가 결정됩니다. |
| vTop | String, Number | Combo 의 top 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 bottom 속성값을 기준으로 Combo 의 top 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Combo 의 top 이 결정됩니다. |
| vWidth | String, Number | Combo 의 width 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 Combo 의 width 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 Combo 의 width 가 결정됩니다. |
| vHeight | String, Number | Combo 의 height 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 Combo 의 height 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Combo 의 height 가 결정됩니다. |
| vRight | String, Number | Combo 의 right 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vLeft, vWidth 값을 모두 설정했을 경우 vRight 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 left 속성값을 기준으로 Combo 의 right 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 Combo 의 right 가 결정됩니다. |
| vBottom | String, Number | Combo 의 bottom 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vTop, vHeight 값을 모두 설정했을 경우 vBottom 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 top 속성값을 기준으로 Combo 의 bottom 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Combo 의 bottom 이 결정됩니다. |
| vMinWidth | String, Number | Combo 이(가) 화면에 표시되는 최소 너비값을 pixel 단위의 숫자로 설정합니다. |
| vMaxWidth | String, Number | Combo 이(가) 화면에 표시되는 최대 너비값을 pixel 단위의 숫자로 설정합니다.

vMinWidth 보다 작은 값을 설정하면 vMinWidth 값으로 설정됩니다. |
| vMinHeight | String, Number | Combo 이(가) 화면에 표시되는 최소 높이값을 pixel 단위의 숫자로 설정합니다. |
| vMaxHeight | String, Number | Combo 이(가) 화면에 표시되는 최대 높이값을 pixel 단위의 숫자로 설정합니다.
...
```javascript
var objComp = new Combo();

objComp.init( "Combo00", 30, 120, 196, 46 );
objComp.init( "Combo00", 30, 120, 196, 46, null, null );
objComp.init( "Combo00", null, null, 300, "400px", "80%", 300 );
objComp.init( "Combo00", 0, 0, 200, 100, null, null, 300, 500, 200, 500 );
objComp.init( "Combo00", "Combo22:10", 300, null, null, "Combo33:10", "20%", 300, 500, 200, 500 );
```
...
- 인수값에 기준 컴포넌트를 포함하면 Combo 의 위치는 기준 컴포넌트를 기준으로 상대적으로 결정됩니다.
  vLeft, vTop, vWidth, vHeight, vRight, vBottom 값에 기준 컴포넌트를 포함할 때는 "ID:Value" 형태로 설정하여야 합니다.

- 기준 컴포넌트는 Combo 와(과) 부모(Parent)가 동일하여야 하며, Form 로딩 시 Combo 보다 먼저 생성되어야 합니다.
...
Combo.destroyCombo.showForm.addChildForm.insertChildForm.removeChild
...
> Components > Component > Combo > Method > insertEventHandler

**Description**

Combo 의 특정 이벤트에 핸들러 함수를 지정한 위치에 삽입하는 메소드입니다.

**Syntax**

```javascript
Combo.insertEventHandler( strEventID, nIndex, objFunc, objTarget )
```
...
var nIndex = this.Combo00.insertEventHandler( "onmove", 0, this.Combo00_onmove, this);
```
...
> Components > Component > Combo > Method > isDropdown

**Description**

Combo 의 아이템 리스트가 화면에 표시되어 있는지 여부를 반환하는 메소드입니다.
...
var bVal = this.Combo00.isDropdown();

**Return**

| Type | Description |
| --- | --- |
| Boolean | 화면에 아이템 리스트가 표시되어 있으면 "true"를 반환합니다.
화면에 아이템 리스트가 표시되어 있지 않으면 "false"를 반환합니다. |

**Remark**

- Combo 의 검색기능에 의해 자동으로 아이템 리스트가 표시되어도 "true"를 반환합니다.
...
> Components > Component > Combo > Method > move

**Description**

Combo 의 위치와 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
Combo.move( vLeft, vTop [, vWidth, vHeight [, vRight, vBottom]] )
```
...
```javascript
this.Combo00.move(10,10);
this.Combo00.move(10,10,100,100);
this.Combo00.move(null, null, 300, "400px", "80%", 300 );
```
...
> Components > Component > Combo > Method > moveToNext

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Combo 이(가) 화면에 한단계 뒤에 표시되게 합니다.

**Syntax**

```javascript
Combo.moveToNext( objComp )
Combo.moveToNext( strComp )
```
...
```javascript
this.Combo.moveToNext( this.Button00 );
this.Combo.moveToNext( "Button00" );
```
...
- 인수로 전달되는 기준 컴포넌트와 Combo 은(는) 부모가 동일하여야 합니다.

- 디자인 시 소스에 컴포넌트가 선언된 순서대로 화면에 표시됩니다.
  소스에서 위에 선언된 컴포넌트가 먼저 표시되고, 아래에 선언된 컴포넌트가 나중에 표시되게 됩니다.
  컴포넌트가 겹쳐져 있을 경우 화면에 표시되는 순서에 따라 먼저 표시된 컴포넌트가 나중에 표시되는 컴포넌트에 가려지게 됩니다.

- moveToNext() 메소드는 기준 컴포넌트보다 Combo 이(가) 한단계 먼저 표시되게 순서를 바꿉니다.
...
> Components > Component > Combo > Method > moveToPrev

**Description**

부모가 동일한 컴포넌트 중 인수로 전달된 컴포넌트보다 Combo 이(가) 화면에 한단계 앞에 표시되게 합니다.

**Syntax**

```javascript
Combo.moveToPrev( objComp )
Combo.moveToPrev( strComp )
```
...
```javascript
this.Combo.moveToPrev( this.Button00 );
this.Combo.moveToPrev( "Button00" );
```
...
- moveToPrev() 메소드는 기준 컴포넌트보다 Combo 이(가) 한단계 나중에 표시되게 순서를 바꿉니다.
...
> Components > Component > Combo > Method > removeEvent

**Description**

Combo 에 선언된 특정 이벤트를 삭제하는 메소드입니다.

**Syntax**

```javascript
Combo.removeEvent( strEventID )
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| strEventID | String | Combo 에서 삭제할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.Combo00.removeEvent( "onmove" );
```
...
- Combo 에 특정 이벤트를 추가하려면 addEvent() 메소드를 사용하여야 합니다.

- Combo 에 기본으로 선언되어 있는 이벤트 삭제 시 오동작 할 수 있으므로 주의하여야 합니다.
...
> Components > Component > Combo > Method > removeEventHandler

**Description**

Combo 의 특정 이벤트에서 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
Combo.removeEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.Combo00_onmove = function( obj:nexacro.Combo,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Combo00.removeEventHandler( "onmove", this.Combo00_onmove, this);
```
...
> Components > Component > Combo > Method > removeEventHandlerLookup

**Description**

Combo 의 특정 이벤트에서 검색된 함수와 동일한 핸들러 함수를 제거하는 메소드입니다.

**Syntax**

```javascript
Combo.removeEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.Combo00_onmove = function( obj:nexacro.Combo,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Combo00.removeEventHandlerLookup( "onmove", "Combo00_onmove", this);
```
...
> Components > Component > Combo > Method > resize

**Description**

Combo 의 크기를 변경하는 메소드입니다.

**Syntax**

```javascript
Combo.resize( vWidth, vHeight )
```
...
- Combo 의 left 속성값이 null 이 아니면 resize() 메소드 실행 후 Combo 의 우측 위치가 변경됩니다.
  또한, 메소드 실행 후 right 속성값은 null 이 됩니다.

- Combo 의 left 속성값이 null 이면 resize() 메소드 실행 후 Combo 의 좌측 위치가 변경됩니다.
  또한, 메소드 실행 후 left 속성값은 null 로 유지됩니다.

- Combo 의 top 속성값이 null 이 아니면 resize() 메소드 실행 후 Combo 의 하단 위치가 변경됩니다.
  또한, 메소드 실행 후 bottom 속성값은 null 이 됩니다.

- Combo 의 top 속성값이 null 이면 resize() 메소드 실행 후 Combo 의 상단 위치가 변경됩니다.
...
> Components > Component > Combo > Method > sendToBack

**Description**

부모가 동일한 컴포넌트 중 Combo 이(가) 화면의 제일 뒤에 표시되게 합니다.
...
- sendToBack() 메소드는 Combo 을(를) 가장 먼저 표시되게 순서를 바꿉니다.
...
> Components > Component > Combo > Method > sendToNext

**Description**

부모가 동일한 컴포넌트 중 Combo 이(가) 화면에 한단계 뒤에 표시되게 합니다.
...
- sendToNext() 메소드는 Combo 을(를) 한단계 먼저 표시되는 컴포넌트와 순서를 바꿉니다.
...
> Components > Component > Combo > Method > setEventHandler

**Description**

Combo 의 특정 이벤트에서 첫번째 핸들러 함수를 변경하는 메소드입니다.

**Syntax**

```javascript
Combo.setEventHandler( strEventID, objFunc, objTarget )
```
...
```javascript
this.Combo00_onmove = function( obj:nexacro.Combo,  e:nexacro.MoveEventInfo ) { //수행할 스크립트 };
var nIndex = this.Combo00.setEventHandler( "onmove", this.Combo00_onmove, this );
```
...
> Components > Component > Combo > Method > setEventHandlerLookup

**Description**

Combo 의 특정 이벤트에서 첫번째 핸들러 함수를 검색된 함수로 변경하는 메소드입니다.

**Syntax**

```javascript
Combo.setEventHandlerLookup( strEventID, strFunc, objTarget )
```
...
```javascript
this.Combo00_onmove = function( obj:nexacro.Combo,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Combo00.setEventHandlerLookup( "onmove", "Combo00_onmove", this);
```
...
> Components > Component > Combo > Method > setFocus

**Description**

Combo 에 포커스를 설정하는 메서드입니다.

**Syntax**

```javascript
Combo.setFocus( [bMoveScroll] )
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| bMoveScroll | Boolean | 부모 컴포넌트에 스크롤이 있을 경우, Combo 기준으로 스크롤을 이동할지 여부를 설정합니다.

true: Combo 이(가) 화면에 표시되도록 스크롤을 이동합니다.
false: Combo 위치와 관계없이 스크롤을 이동하지 않습니다.
...
```javascript
var objBefComp = this.Combo00.setFocus();
var objBefComp = this.Combo00.setFocus( false );
```
...
| Type | Description |
| --- | --- |
| Object | Combo 이(가) 포커스를 얻기 전에 포커스를 가지고 있던 컴포넌트를 반환합니다.
...
> Components > Component > Combo > Method > setInnerDataset

**Description**

Combo 의 innerdataset 속성에 인수로 전달된 DataSet 오브젝트를 설정하는 메소드입니다.

**Syntax**

```javascript
Combo.setInnerDataset( objDataset )
```
...
```javascript
this.Combo00.setInnerDataset( this.Dataset00 ) ;
```
...
- innerdataset 속성에 DataSet 설정 후 codecolumn, datacolumn 속성을 설정하여야 Combo에 데이터가 정상 반영됩니다.
...
> Components > Component > Combo > Method > setOffsetBottom

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Combo 의 bottom 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Combo.setOffsetBottom( nBottom );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nBottom | Number | 부모 컴포넌트의 Top 위치를 기준으로 Combo 의 bottom 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Combo.setOffsetBottom( 10 );
```
...
- 메소드 실행 전 Combo 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Combo 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > Combo 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > Combo 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 height, bottom 속성이 설정됩니다.
...
> Components > Component > Combo > Method > setOffsetHeight

**Description**

Combo 의 높이를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Combo.setOffsetHeight( nHeight );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nHeight | Number | Combo 의 높이를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Combo.setOffsetHeight( 10 );
```
...
> Components > Component > Combo > Method > setOffsetLeft

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Combo 의 left 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Combo.setOffsetLeft( nLeft );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nLeft | Number | 부모 컴포넌트의 Left 위치를 기준으로 Combo 의 left 값을 픽셀단위의 숫자로 설정합니다 |

**Sample Call**

```javascript
this.Combo.setOffsetLeft( 10 );
```
...
- 메소드 실행 전 Combo 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Combo 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > Combo 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, right 속성이 설정됩니다.
   > Combo 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
...
> Components > Component > Combo > Method > setOffsetRight

**Description**

부모 컴포넌트의 Left 위치를 기준으로 Combo 의 right 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Combo.setOffsetRight( nRight );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nRight | Number | 부모 컴포넌트의 Left 위치를 기준으로 Combo 의 right 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Combo.setOffsetRight( 600 );
```
...
- 메소드 실행 전 Combo 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Combo 에 left, width 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > Combo 에 left, right 속성이 설정되어 있었다면 메소드 실행 후 left, width 속성이 설정됩니다.
   > Combo 에 width, right 속성이 설정되어 있었다면 메소드 실행 후 width, right 속성이 설정됩니다.
...
> Components > Component > Combo > Method > setOffsetTop

**Description**

부모 컴포넌트의 Top 위치를 기준으로 Combo 의 top 값을 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Combo.setOffsetTop( nTop );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nTop | Number | 부모 컴포넌트의 Top 위치를 기준으로 Combo 의 top 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Combo.setOffsetTop( 10 );
```
...
- 메소드 실행 전 Combo 에 설정된 초기 속성에 따라 메소드 실행 후 설정되는 속성이 달라집니다.
   > Combo 에 top, height 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
   > Combo 에 top, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, bottom 속성이 설정됩니다.
   > Combo 에 height, bottom 속성이 설정되어 있었다면 메소드 실행 후 top, height 속성이 설정됩니다.
...
> Components > Component > Combo > Method > setOffsetWidth

**Description**

Combo 의 너비를 픽셀단위로 설정하는 메소드입니다.

**Syntax**

```javascript
Combo.setOffsetWidth( nWidth );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nWidth | Number | Combo 의 너비를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Combo.setOffsetWidth( 10 );
```
...
> Components > Component > Combo > Method > setSelect

**Description**

Combo 의 에디트 영역에 포커스가 있을 때 인수로 지정된 영역을 선택하는 메소드입니다.

**Syntax**

```javascript
Combo.setSelect( [nBegin [, nEnd]] )
```
...
this.Combo00.setFocus();

bSucc = this.Combo00.setSelect();
bSucc = this.Combo00.setSelect( 3 );
bSucc = this.Combo00.setSelect( 3, 5 );
```
...
- type 속성값이 "dropdown" 이 아닌 경우 에디트 영역의 텍스트를 대상으로 메소드가 수행됩니다.
...
> Components > Component > Combo > Method > setSelectedText

**Description**

Combo 의 편집영역에서 현재 선택되어 있는 텍스트를 전달된 인수값으로 변경하는 메소드입니다.

**Syntax**

```javascript
Combo.setSelectedText( strText )
```
...
```javascript
var strOldText = this.Combo00.setSelectedText( "Character string to change." );
```
...
- 편집영역에 선택된 텍스트가 없으면 setSelectedText() 메소드는 동작하지 않습니다.
...
> Components > Component > Combo > Method > show

**Description**

스크립트로 동적 생성한 Combo 을(를) 화면에 표시하는 메소드입니다.
...
Combo.destroyCombo.initForm.addChildForm.insertChildForm.removeChild
...
> Components > Component > Combo > Method > updateToDataset

**Description**

Combo 의 value 속성값을 바인딩 되어 있는 DataSet 에 즉시 반영시키는 메소드입니다.

**Syntax**

```javascript
Combo.updateToDataset()
```

**Parameters**

var bSucc = this.Combo00.updateToDataset();
...
- Combo 의 value 속성이 DataSet 에 바인딩 되어 있어야 합니다.

- Combo 의 value 속성값이 바인딩 되어있는 Dataset 의 값과 같으면 Dataset 에 값이 반영되지 않고 "false"를 반환합니다.
...
> Components > Component > Combo > Event > canitemchange
...
| Type | Description |
| --- | --- |
| Boolean | 이벤트에서 리턴값을 "true"로 반환하면 변경된 아이템이 적용됩니다.
이벤트에서 리턴값을 "false"로 반환하면 아이템이 변경되지 않습니다.
...
> Components > Component > Combo > Event > oncloseup
...
> Components > Component > Combo > Event > oncontextmenu
...
> Components > Component > Combo > Event > ondevicebuttonup
...
> Components > Component > Combo > Event > ondrag
...
> Components > Component > Combo > Event > ondragenter
...
> Components > Component > Combo > Event > ondragleave
...
> Components > Component > Combo > Event > ondragmove
...
> Components > Component > Combo > Event > ondrop
...
> Components > Component > Combo > Event > ondropdown
...
| Type | Description |
| --- | --- |
| Boolean | 이벤트의 리턴값으로 "true"를 반환하면 아이템 리스트가 화면에 표시됩니다.
이벤트의 리턴값으로 "false"를 반환하면 아이템 리스트가 표시되지 않습니다.
...
> Components > Component > Combo > Event > oneditclick

**Description**

Combo 컴포넌트의 텍스트 편집 영역에서 마우스 왼쪽 버튼을 클릭했을 때 발생하는 이벤트입니다.
...
> Components > Component > Combo > Event > oninnerdatachanged
...
> Components > Component > Combo > Event > oninput
...
> Components > Component > Combo > Event > onitemchanged
...
> Components > Component > Combo > Event > onitemclick
...
> Components > Component > Combo > Event > onkeydown
...
> Components > Component > Combo > Event > onkeyup
...
> Components > Component > Combo > Event > onkillfocus
...
> Components > Component > Combo > Event > onlbuttondown
...
> Components > Component > Combo > Event > onlbuttonup
...
* comboedit 내 다운/업인 경우: 클릭 이벤트 발생
* combolist 내 다운/업인 경우: 아이템 변경 처리
...
> Components > Component > Combo > Event > onmouseenter
...
> Components > Component > Combo > Event > onmouseleave
...
> Components > Component > Combo > Event > onmousemove
...
> Components > Component > Combo > Event > onmousewheel
...
> Components > Component > Combo > Event > onmove
...
> Components > Component > Combo > Event > onrbuttondown
...
> Components > Component > Combo > Event > onrbuttonup
...
> Components > Component > Combo > Event > onsetfocus
...
> Components > Component > Combo > Event > onsize
...
> Components > Component > Combo > Event > ontouchend
...
> Components > Component > Combo > Event > ontouchmove
...
> Components > Component > Combo > Event > ontouchstart
