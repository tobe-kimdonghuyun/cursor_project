...
```
Combo 에 추가할 이벤트의 ID 를 문자열로 설정합니다.
```
...
Combo 이(가) 정상적으로 삭제되면 true 를 반환합니다.
...
부모 컴포넌트의 Top 위치를 기준으로 Combo 의 bottom 값을 픽셀단위의 숫자로 반환합니다.
...
Combo 의 높이를 픽셀단위의 숫자로 변환하여 반환합니다.
...
부모 컴포넌트의 Left 위치를 기준으로 Combo 의 left 값을 픽셀단위의 숫자로 반환합니다.
...
부모 컴포넌트의 Left 위치를 기준으로 Combo 의 right 값을 픽셀단위의 숫자로 반환합니다.
...
부모 컴포넌트의 Top 위치를 기준으로 Combo 의 top 값을 픽셀단위의 숫자로 반환합니다.
...
Combo 의 너비를 픽셀단위의 숫자로 변환하여 반환합니다.
...
Combo 의 bottom 속성값을 픽셀단위로 반환합니다.
...
Combo 의 height 속성값을 픽셀단위로 반환합니다.
...
Combo 의 right 속성값을 픽셀단위로 반환합니다.
...
Combo 의 width 속성값을 픽셀단위로 반환합니다.
...
화면에 아이템 리스트가 표시되어 있으면 "true"를 반환합니다.
...
```
Combo 의 left 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
...
```
Combo 에서 삭제할 이벤트의 ID 를 문자열로 설정합니다.
```
...
```
Combo 의 width 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
음수값을 설정할 수 없습니다.
...
```
부모 컴포넌트에 스크롤이 있을 경우, Combo 기준으로 스크롤을 이동할지 여부를 설정합니다.
...
Combo 이(가) 포커스를 얻기 전에 포커스를 가지고 있던 컴포넌트를 반환합니다.
...
```
부모 컴포넌트의 Top 위치를 기준으로 Combo 의 bottom 값을 픽셀단위의 숫자로 설정합니다.
```
...
```
부모 컴포넌트의 Left 위치를 기준으로 Combo 의 left 값을 픽셀단위의 숫자로 설정합니다
```
...
```
부모 컴포넌트의 Left 위치를 기준으로 Combo 의 right 값을 픽셀단위의 숫자로 설정합니다.
```
...
```
부모 컴포넌트의 Top 위치를 기준으로 Combo 의 top 값을 픽셀단위의 숫자로 설정합니다.
```
...
이벤트에서 리턴값을 "true"로 반환하면 변경된 아이템이 적용됩니다.
...
이벤트의 리턴값으로 "true"를 반환하면 아이템 리스트가 화면에 표시됩니다.
