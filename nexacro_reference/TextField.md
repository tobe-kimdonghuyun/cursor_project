...
| --- | --- | --- |
| strEventID | String | TextField 에 추가할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.TextField00.addEvent( "onmove" );
```
...
```javascript
this.TextField00_onmove = function( obj:nexacro.TextField,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.TextField00.addEventHandler( "onmove", this.TextField00_onmove, this);
```
...
```javascript
this.TextField00_onmove = function( obj:nexacro.TextField,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.TextField00.addEventHandlerLookup( "onmove", "TextField00_onmove", this);
```
...
```javascript
var nCnt = this.TextField00.clearEventHandler( "onmove" );
```
...
| Type | Description |
| --- | --- |
| Boolean | TextField 이(가) 정상적으로 삭제되면 true 를 반환합니다.
...
var nIndex = this.TextField00.findEventHandler( "onmove", this.TextField00_onmove, this );
```
...
| Type | Description |
| --- | --- |
| String | TextField 에 표시된 텍스트값을 반환합니다. |
...
```javascript
var objFunc = TextField00.getEventHandler( "onmove", 0 );
```
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 TextField 의 bottom 값을 픽셀단위의 숫자로 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | TextField 의 높이를 픽셀단위의 숫자로 변환하여 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 TextField 의 left 값을 픽셀단위의 숫자로 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 TextField 의 right 값을 픽셀단위의 숫자로 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 TextField 의 top 값을 픽셀단위의 숫자로 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | TextField 의 너비를 픽셀단위의 숫자로 변환하여 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | TextField 의 bottom 속성값을 픽셀단위로 반환합니다.
...
| Type | Description |
| --- | --- |
| Number | TextField 의 height 속성값을 픽셀단위로 반환합니다.
...
| Type | Description |
| --- | --- |
| Number | TextField 의 left 속성값을 픽셀단위로 반환합니다.
...
| Type | Description |
| --- | --- |
| Number | TextField 의 top 속성값을 픽셀단위로 반환합니다.
...
| Type | Description |
| --- | --- |
| Number | TextField 의 width 속성값을 픽셀단위로 반환합니다.
...
| Type | Description |
| --- | --- |
| String | TextField 컴포넌트에 입력한 텍스트의 유효성 검사 결과를 반환합니다.
...
| vLeft | String, Number | TextField 의 left 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
...
| vTop | String, Number | TextField 의 top 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 bottom 속성값을 기준으로 TextField 의 top 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 TextField 의 top 이 결정됩니다. |
| vWidth | String, Number | TextField 의 width 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
...
| vHeight | String, Number | TextField 의 height 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 TextField 의 height 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 TextField 의 height 가 결정됩니다. |
| vRight | String, Number | TextField 의 right 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vLeft, vWidth 값을 모두 설정했을 경우 vRight 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 left 속성값을 기준으로 TextField 의 right 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 TextField 의 right 가 결정됩니다. |
| vBottom | String, Number | TextField 의 bottom 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vTop, vHeight 값을 모두 설정했을 경우 vBottom 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 top 속성값을 기준으로 TextField 의 bottom 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 TextField 의 bottom 이 결정됩니다. |
| vMinWidth | String, Number | TextField 이(가) 화면에 표시되는 최소 너비값을 pixel 단위의 숫자로 설정합니다. |
| vMaxWidth | String, Number | TextField 이(가) 화면에 표시되는 최대 너비값을 pixel 단위의 숫자로 설정합니다.

vMinWidth 보다 작은 값을 설정하면 vMinWidth 값으로 설정됩니다. |
| vMinHeight | String, Number | TextField 이(가) 화면에 표시되는 최소 높이값을 pixel 단위의 숫자로 설정합니다. |
| vMaxHeight | String, Number | TextField 이(가) 화면에 표시되는 최대 높이값을 pixel 단위의 숫자로 설정합니다.
...
```javascript
var objComp = new TextField();

objComp.init( "TextField00", 30, 120, 196, 46 );
objComp.init( "TextField00", 30, 120, 196, 46, null, null );
objComp.init( "TextField00", null, null, 300, "400px", "80%", 300 );
objComp.init( "TextField00", 0, 0, 200, 100, null, null, 300, 500, 200, 500 );
objComp.init( "TextField00", "TextField22:10", 300, null, null, "TextField33:10", "20%", 300, 500, 200, 500 );
```
...
var nIndex = this.TextField00.insertEventHandler( "onmove", 0, this.TextField00_onmove, this);
```
...
```javascript
this.TextField00.move(10,10);
this.TextField00.move(10,10,100,100);
this.TextField00.move(null, null, 300, "400px", "80%", 300 );
```
...
```javascript
this.TextField.moveToNext( this.Button00 );
this.TextField.moveToNext( "Button00" );
```
...
```javascript
this.TextField.moveToPrev( this.Button00 );
this.TextField.moveToPrev( "Button00" );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| strEventID | String | TextField 에서 삭제할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.TextField00.removeEvent( "onmove" );
```
...
```javascript
this.TextField00_onmove = function( obj:nexacro.TextField,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.TextField00.removeEventHandler( "onmove", this.TextField00_onmove, this);
```
...
```javascript
this.TextField00_onmove = function( obj:nexacro.TextField,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.TextField00.removeEventHandlerLookup( "onmove", "TextField00_onmove", this);
```
...
```javascript
this.TextField00.resize( 100,100 );
```
...
```javascript
var bSucc;
bSucc = this.TextField00.setCaretPos();
bSucc = this.TextField00.setCaretPos( -1 );
```
...
```javascript
this.TextField00_onmove = function( obj:nexacro.TextField,  e:nexacro.MoveEventInfo ) { //수행할 스크립트 };
var nIndex = this.TextField00.setEventHandler( "onmove", this.TextField00_onmove, this );
```
...
```javascript
this.TextField00_onmove = function( obj:nexacro.TextField,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.TextField00.setEventHandlerLookup( "onmove", "TextField00_onmove", this);
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| bMoveScroll | Boolean | 부모 컴포넌트에 스크롤이 있을 경우, TextField 기준으로 스크롤을 이동할지 여부를 설정합니다.
...
```javascript
var objBefComp = this.TextField00.setFocus();
var objBefComp = this.TextField00.setFocus( false );
```
...
| Type | Description |
| --- | --- |
| Object | TextField 이(가) 포커스를 얻기 전에 포커스를 가지고 있던 컴포넌트를 반환합니다.
...
| Parameters | Type | Description |
| --- | --- | --- |
| nBottom | Number | 부모 컴포넌트의 Top 위치를 기준으로 TextField 의 bottom 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.TextField.setOffsetBottom( 10 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nHeight | Number | TextField 의 높이를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.TextField.setOffsetHeight( 10 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nLeft | Number | 부모 컴포넌트의 Left 위치를 기준으로 TextField 의 left 값을 픽셀단위의 숫자로 설정합니다 |

**Sample Call**

```javascript
this.TextField.setOffsetLeft( 10 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nRight | Number | 부모 컴포넌트의 Left 위치를 기준으로 TextField 의 right 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.TextField.setOffsetRight( 600 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nTop | Number | 부모 컴포넌트의 Top 위치를 기준으로 TextField 의 top 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.TextField.setOffsetTop( 10 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nWidth | Number | TextField 의 너비를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.TextField.setOffsetWidth( 10 );
```
...
this.TextField00.setFocus();

bSucc = this.TextField00.setSelect();
bSucc = this.TextField00.setSelect( 3 );
bSucc = this.TextField00.setSelect( 3, 5 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| strText | String | TextField 컴포넌트에 선택되어 있는 텍스트를 대체할 문자열을 설정합니다. |

**Sample Call**

```javascript
var strOldText = this.TextField00.setSelectedText( "Character string to change." );
```
...
| Type | Description |
| --- | --- |
| String | TextField 컴포넌트에 선택되어 있던 텍스트를 문자열로 반환합니다. |
...
| Parameters | Type | Description |
| --- | --- | --- |
| obj | TextField | Event가 발생한 Object. |
