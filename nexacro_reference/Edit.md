...
| --- | --- | --- |
| strEventID | String | Edit 에 추가할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.Edit00.addEvent( "onmove" );
```
...
```javascript
this.Edit00_onmove = function( obj:nexacro.Edit,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Edit00.addEventHandler( "onmove", this.Edit00_onmove, this);
```
...
```javascript
this.Edit00_onmove = function( obj:nexacro.Edit,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Edit00.addEventHandlerLookup( "onmove", "Edit00_onmove", this);
```
...
```javascript
var nCnt = this.Edit00.clearEventHandler( "onmove" );
```
...
| Type | Description |
| --- | --- |
| Boolean | Edit 이(가) 정상적으로 삭제되면 true 를 반환합니다.
...
var nIndex = this.Edit00.findEventHandler( "onmove", this.Edit00_onmove, this );
```
...
```javascript
var objFunc = Edit00.getEventHandler( "onmove", 0 );
```
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 Edit 의 bottom 값을 픽셀단위의 숫자로 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | Edit 의 높이를 픽셀단위의 숫자로 변환하여 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 Edit 의 left 값을 픽셀단위의 숫자로 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 Edit 의 right 값을 픽셀단위의 숫자로 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 Edit 의 top 값을 픽셀단위의 숫자로 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | Edit 의 너비를 픽셀단위의 숫자로 변환하여 반환합니다. |
...
| Type | Description |
| --- | --- |
| Number | Edit 의 bottom 속성값을 픽셀단위로 반환합니다.
...
| Type | Description |
| --- | --- |
| Number | Edit 의 height 속성값을 픽셀단위로 반환합니다.
...
| Type | Description |
| --- | --- |
| Number | Edit 의 left 속성값을 픽셀단위로 반환합니다.
...
| Type | Description |
| --- | --- |
| Number | Edit 의 right 속성값을 픽셀단위로 반환합니다.
...
| Type | Description |
| --- | --- |
| Number | Edit 의 top 속성값을 픽셀단위로 반환합니다.
...
| Type | Description |
| --- | --- |
| Number | Edit 의 width 속성값을 픽셀단위로 반환합니다.
...
| vLeft | String, Number | Edit 의 left 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.
...
| vTop | String, Number | Edit 의 top 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 bottom 속성값을 기준으로 Edit 의 top 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Edit 의 top 이 결정됩니다. |
| vWidth | String, Number | Edit 의 width 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 Edit 의 width 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 Edit 의 width 가 결정됩니다. |
| vHeight | String, Number | Edit 의 height 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 Edit 의 height 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Edit 의 height 가 결정됩니다. |
| vRight | String, Number | Edit 의 right 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vLeft, vWidth 값을 모두 설정했을 경우 vRight 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 left 속성값을 기준으로 Edit 의 right 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 Edit 의 right 가 결정됩니다. |
| vBottom | String, Number | Edit 의 bottom 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vTop, vHeight 값을 모두 설정했을 경우 vBottom 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 top 속성값을 기준으로 Edit 의 bottom 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 Edit 의 bottom 이 결정됩니다. |
| vMinWidth | String, Number | Edit 이(가) 화면에 표시되는 최소 너비값을 pixel 단위의 숫자로 설정합니다. |
| vMaxWidth | String, Number | Edit 이(가) 화면에 표시되는 최대 너비값을 pixel 단위의 숫자로 설정합니다.

vMinWidth 보다 작은 값을 설정하면 vMinWidth 값으로 설정됩니다. |
| vMinHeight | String, Number | Edit 이(가) 화면에 표시되는 최소 높이값을 pixel 단위의 숫자로 설정합니다. |
| vMaxHeight | String, Number | Edit 이(가) 화면에 표시되는 최대 높이값을 pixel 단위의 숫자로 설정합니다.
...
```javascript
var objComp = new Edit();

objComp.init( "Edit00", 30, 120, 196, 46 );
objComp.init( "Edit00", 30, 120, 196, 46, null, null );
objComp.init( "Edit00", null, null, 300, "400px", "80%", 300 );
objComp.init( "Edit00", 0, 0, 200, 100, null, null, 300, 500, 200, 500 );
objComp.init( "Edit00", "Edit22:10", 300, null, null, "Edit33:10", "20%", 300, 500, 200, 500 );
```
...
var nIndex = this.Edit00.insertEventHandler( "onmove", 0, this.Edit00_onmove, this);
```
...
```javascript
this.Edit00.move(10,10);
this.Edit00.move(10,10,100,100);
this.Edit00.move(null, null, 300, "400px", "80%", 300 );
```
...
```javascript
this.Edit.moveToNext( this.Button00 );
this.Edit.moveToNext( "Button00" );
```
...
```javascript
this.Edit.moveToPrev( this.Button00 );
this.Edit.moveToPrev( "Button00" );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| strEventID | String | Edit 에서 삭제할 이벤트의 ID 를 문자열로 설정합니다. |

**Sample Call**

```javascript
var bResult = this.Edit00.removeEvent( "onmove" );
```
...
```javascript
this.Edit00_onmove = function( obj:nexacro.Edit,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Edit00.removeEventHandler( "onmove", this.Edit00_onmove, this);
```
...
```javascript
this.Edit00_onmove = function( obj:nexacro.Edit,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Edit00.removeEventHandlerLookup( "onmove", "Edit00_onmove", this);
```
...
```javascript
var bSucc;
bSucc = this.Edit00.setCaretPos();
bSucc = this.Edit00.setCaretPos( -1 );
```
...
```javascript
this.Edit00_onmove = function( obj:nexacro.Edit,  e:nexacro.MoveEventInfo ) { //수행할 스크립트 };
var nIndex = this.Edit00.setEventHandler( "onmove", this.Edit00_onmove, this );
```
...
```javascript
this.Edit00_onmove = function( obj:nexacro.Edit,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.Edit00.setEventHandlerLookup( "onmove", "Edit00_onmove", this);
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| bMoveScroll | Boolean | 부모 컴포넌트에 스크롤이 있을 경우, Edit 기준으로 스크롤을 이동할지 여부를 설정합니다.
...
```javascript
var objBefComp = this.Edit00.setFocus();
var objBefComp = this.Edit00.setFocus( false );
```
...
| Type | Description |
| --- | --- |
| Object | Edit 이(가) 포커스를 얻기 전에 포커스를 가지고 있던 컴포넌트를 반환합니다.
...
| Parameters | Type | Description |
| --- | --- | --- |
| nBottom | Number | 부모 컴포넌트의 Top 위치를 기준으로 Edit 의 bottom 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Edit.setOffsetBottom( 10 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nHeight | Number | Edit 의 높이를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Edit.setOffsetHeight( 10 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nLeft | Number | 부모 컴포넌트의 Left 위치를 기준으로 Edit 의 left 값을 픽셀단위의 숫자로 설정합니다 |

**Sample Call**

```javascript
this.Edit.setOffsetLeft( 10 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nRight | Number | 부모 컴포넌트의 Left 위치를 기준으로 Edit 의 right 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Edit.setOffsetRight( 600 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nTop | Number | 부모 컴포넌트의 Top 위치를 기준으로 Edit 의 top 값을 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Edit.setOffsetTop( 10 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| nWidth | Number | Edit 의 너비를 픽셀단위의 숫자로 설정합니다. |

**Sample Call**

```javascript
this.Edit.setOffsetWidth( 10 );
```
...
bSucc = this.Edit00.setSelect();
bSucc = this.Edit00.setSelect( 3 );
bSucc = this.Edit00.setSelect( 3, 5 );
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| strText | String | Edit 에 선택되어 있는 텍스트를 대체할 문자열을 설정합니다. |

**Sample Call**

```javascript
var strOldText = this.Edit00.setSelectedText( "Character string to change." );
```
...
| Type | Description |
| --- | --- |
| String | Edit 에 선택되어 있던 텍스트를 문자열로 반환합니다. |
