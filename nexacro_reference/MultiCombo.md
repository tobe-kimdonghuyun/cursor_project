...
| 아이템 이동취소 | ESC | 아이템 항목을 이동했을 때 원래 위치로 이동을 취소합니다.
Ctrl + Space 입력으로 이동된 위치의 아이템이 결정된 상태에서는 위치이동을 취소할 수 없습니다. |
...
| 스크롤 이동(페이지) | PageUp/PageDown | MultiComboList에 vscrollbar가 활성화됐을 때 페이지 단위(화면에 표시되는 아이템 개수)로 스크롤합니다.
이동된 위치의 아이템을 결정하려면 Ctrl + Space 키를 입력해야 합니다. |
| 스크롤 이동(최상단/최하단) | Home/End | MultiComboList에 vscrollbar가 활성화됐을 때 최상단 또는 최하단으로 스크롤합니다.
이동된 위치의 아이템을 결정하려면 Enter 키를 입력해야 합니다.
type 속성값이 "dropdown"일때만 스크롤 동작에 반영되며 그 외의 경우에는 multicomboedit 캐럿 위치에 반영됩니다. |
| tagboxitem 선택 | 좌우방향키 | type 속성값이 "dropdown"인 경우, tagboxitem 선택이 안되어 있을 때 좌 방향키를 누르면 마지막에 추가된 tagboxitem이 선택됩니다.
type 속성값이 "dropdown"이 아닌 경우, 편집영역에 포커스가 있고 caret 위치가 0인 상태에서 좌 방향키를 누르면 마지막에 추가된 tagboxitem이 선택됩니다.

아래와 같은 동작 제약이 있습니다.
- 편집 영역의 caret 위치가 0이 아닌 경우엔 동작하지 않습니다.
- 마지막 tagboxitem가 선택되어 있는 상태에서 우 방향키를 누르면 tagboxitem 선택이 해제되며 편집영역에 포커스가 들어갑니다.

편집영역에 포커스가 들어갈 때와 다른 컴포넌트로 포커스가 이동할 때 선택된 tagboxitem이 있다면 tagboxitem 선택이 해제됩니다. |
| tagboxitem 삭제 | Delete | 현재 선택되어 있는 tagboxitem을 삭제합니다. 
삭제 후 다음 tagboxitem이 선택됩니다. 
마지막 tagboxitem을 삭제했을 때는 선택된 tagboxitem의 이전 tagboxitem이 선택됩니다. |
...
| MultiComboList 열기 | Alt + 아래방향키 또는 Option + 아래방향키 | MultiComboList 가 표시됩니다. |
| 아이템 이동 | Ctrl + 상하방향키 | 아이템 항목을 이동합니다.
이동된 위치의 아이템을 결정하려면 Enter 를 입력하여야 합니다. |
| 아이템 이동취소 | ESC | 아이템 항목을 이동했을 때 원래 위치로 이동을 취소합니다.
Enter 입력으로 이동된 위치의 아이템이 결정된 상태에서는 위치이동을 취소할 수 없습니다. |
| 아이템 결정 | Enter | 이동된 위치의 아이템을 선택 결정하여 value 속성에 반영합니다. |
| 아이템 선택/선택취소 | Ctrl + Space | 하나의 아이템을 선택하거나 선택 취소합니다. |
...
| Name | Description |
| --- | --- |
| acceptvaluetype | MultiCombo 에서 InnerDataset 에 없는 코드값을 스크립트로 value 속성에 설정할 때 처리방식을 결정하는 속성입니다. |
| accessibilityaction | MultiCombo에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다. |
| accessibilitydesclevel | MultiCombo 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다. |
| accessibilitydescription | MultiCombo에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다. |
| accessibilityenable | MultiCombo 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다. |
| accessibilitylabel | MultiCombo에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다. |
| accessibilityrole | MultiCombo에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다. |
| autoselect | MultiCombo 컴포넌트의 편집영역이 활성화될 때 텍스트를 전체선택 할지 설정하는 속성입니다. |
| autoskip | MultiCombo 컴포넌트의 아이템이 선택되었을 때 포커스를 자동으로 이동시킬지 설정하는 속성입니다. |
| background | MultiCombo 의 배경 영역을 설정하는 속성입니다. |
| border-radius | MultiCombo 의 모서리 모양을 설정하는 속성입니다. |
| bottom | MultiCombo 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다. |
| box-shadow | MultiCombo 에 그림자 효과를 설정하는 속성입니다. |
| buttonsize | MultiCombo 컴포넌트의 드롭다운 버튼 크기를 설정하는 속성입니다. |
| codecolumn | MultiCombo 컴포넌트에서 아이템의 코드값으로 사용될 Column을 설정하는 속성입니다. |
| color | MultiCombo 에 표시되는 텍스트의 색상을 설정하는 속성입니다. |
| counttextformat | MultiCombo 컴포넌트의 edittype 속성값이 "count"일 때 선택된 아이템 개수를 표시할 텍스트를 설정하는 속성입니다. |
| cssclass | MultiCombo 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다. |
| cursor | MultiCombo 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다. |
| datacolumn | MultiCombo 컴포넌트에서 아이템의 데이터값으로 사용될 Column을 설정하는 속성입니다. |
| displaynulltext | MultiCombo 의 value 속성값이 null 또는 undefined 일 때 MultiCombo 에 표시될 대체 문자열을 설정하는 속성입니다. |
| displayrowcount | MultiCombo 컴포넌트의 아이템 리스트에 표시될 아이템의 최대 개수를 설정하는 속성입니다. |
| dropbutton | MultiCombo 컴포넌트의 서브컨트롤인 드롭버튼(DropButton) 오브젝트를 갖는 속성입니다 |
| edittype | MultiCombo 컴포넌트에서 선택된 아이템의 표시 방식을 설정하는 속성입니다. |
| enable | MultiCombo 의 사용가능 여부를 설정하는 속성입니다. |
| enableevent | MultiCombo 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다. |
...
| font | MultiCombo 에서 사용하는 폰트를 설정하는 속성입니다. |
| height | MultiCombo 을(를) 표시하기 위한 높이를 설정하는 속성입니다. |
| hotkey | MultiCombo 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다. |
| id | MultiCombo의 고유 식별자를 설정하는 속성입니다. |
| imemode | MultiCombo 의 기본 입력 언어를 설정하는 속성입니다. |
| index | MultiCombo 컴포넌트의 아이템 중 선택된 아이템의 인덱스를 갖는 속성입니다. |
| initvalueid | MultiCombo 에 적용될 InitValue 의 ID 를 설정하는 속성입니다. |
| innerdataset | MultiCombo 컴포넌트의 아이템 리스트를 구성할 Dataset 오브젝트의 ID를 설정하는 속성입니다. |
| itemheight | MultiCombo 컴포넌트의 아이템 리스트에서 각 행의 높이를 설정하는 속성입니다. |
| layoutorder | Layout 컨테이너 내 Main Axis(type 속성값이 "horizontal"이면 수평축, type 속성값이 "vertical"이면 수직축)에 컴포넌트가 배치되는 순서를 설정합니다. |
| left | MultiCombo 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다. |
| letter-spacing | MultiCombo 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다. |
| maxheight | MultiCombo 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다. |
| maxwidth | MultiCombo 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다. |
| minheight | MultiCombo 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다. |
| minwidth | MultiCombo 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다. |
| multicomboedit | MultiCombo 컴포넌트의 서브컨트롤인 편집영역(multicomboedit) 오브젝트를 갖는 속성입니다. |
| multicombolist | MultiCombo 컴포넌트의 서브컨트롤인 아이템 리스트(multicombolist) 오브젝트를 갖는 속성입니다. |
| name | MultiCombo 의 이름을 설정하는 속성입니다. |
| -nexa-border | MultiCombo 의 테두리를 설정하는 속성입니다. |
| -nexa-edge | MultiCombo 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-padding | MultiCombo 영역의 안쪽 여백을 설정하는 속성입니다. |
| -nexa-rtl-background-image | MultiCombo 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다. |
| -nexa-rtl-edge-image | MultiCombo 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| opacity | MultiCombo 영역의 투명도를 설정하는 속성입니다. |
| parent | MultiCombo 의 부모 오브젝트를 갖는 읽기전용 속성입니다. |
| popupsize | 화면에 팝업으로 표시되는 아이템 리스트의 크기를 설정하는 속성입니다. |
| popuptype | MultiCombo 컴포넌트의 아이템 리스트가 표시되는 방식을 설정하는 속성입니다. |
| positionstep | 부모 오브젝트가 화면분할기능을 사용할 때 MultiCombo 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다. |
| readonly | MultiCombo 컴포넌트에서 아이템 변경을 허용할지 설정하는 속성입니다. |
| readonlycolumn | MultiCombo 컴포넌트에서 아이템 readonly 여부 설정 시 사용될 Column을 설정하는 속성입니다. |
| right | MultiCombo 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다. |
| rtl | MultiCombo 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다. |
...
| scrollindicatorsize | MultiCombo 에 표시되는 스크롤 인디케이터바의 크기를 설정하는 속성입니다. |
| selectallcheckboxheight | MultiCombo 컴포넌트의 아이템 리스트에서 selectallcheckbox의 높이를 설정하는 속성입니다. |
| selectallcheckboxtext | 아이템 리스트 상단에 아이템 전체를 선택 또는 선택해제하는 체크박스(selectallcheckbox)의 텍스트를 설정하는 속성입니다. |
| showselectallcheckbox | 아이템 리스트 상단에 아이템 전체를 선택 또는 선택해제하는 체크박스의 표시 여부를 설정하는 속성입니다. |
| tablecellarea | Layout 컨테이너 내 가상의 Table Cell 영역 내에서 컴포넌트가 배치되는 영역을 설정합니다. |
| taborder | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 MultiCombo 의 순서를 설정하는 속성입니다. |
| tabstop | 탭키 입력으로 컴포넌트간 포커스를 이동할 때 MultiCombo 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다. |
| tagboxitemhorizontalgap | MultiCombo 컴포넌트의 multicombotagbox에서 tagboxitem 간의 수평 간격을 설정하는 속성입니다. |
| tagboxitemverticalgap | MultiCombo 컴포넌트의 multicombotagbox에서 tagboxitem 간의 수직 간격을 설정하는 속성입니다. |
| tagboxscrollbarsize | multicombotagbox에 표시되는 스크롤바의 너비를 설정하는 속성입니다. |
| tagboxscrollbartype | multicombotagbox에 스크롤바가 표시되는 형식을 설정하는 속성입니다. |
| tagboxscrollindicatorsize | multicombotagbox에 표시되는 스크롤 인디케이터바의 크기를 설정하는 속성입니다. |
| tagbuttonsize | MultiCombo 컴포넌트 tagbutton의 크기를 설정하는 속성입니다. |
| text | MultiCombo 컴포넌트에서 선택된 아이템의 데이터값을 갖는 속성입니다. |
| textseparator | MultiCombo 컴포넌트에서 2개 이상의 text 속성값 설정 시 구분자로 사용할 값을 설정하는 속성입니다. |
| tooltiptext | MultiCombo 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다. |
| tooltiptype | MultiCombo 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다. |
| top | MultiCombo 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다. |
| type | MultiCombo 컴포넌트가 동작하는 방법을 설정하는 속성입니다. |
| usecontextmenu | MultiCombo 의 편집영역에서 오른쪽 마우스 클릭 시 기본팝업메뉴의 표시 여부를 설정하는 속성입니다. |
| usesoftkeyboard | MultiCombo 가 포커스를 가질 때 키패드의 표시 여부를 설정하는 속성입니다. |
| value | MultiCombo 컴포넌트에서 선택된 아이템의 코드값을 갖는 속성입니다. |
| visible | MultiCombo 이(가) 화면에 표시될지 여부를 설정하는 속성입니다. |
| width | MultiCombo 을(를) 표시하기 위한 너비를 설정하는 속성입니다. |
| word-spacing | MultiCombo 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다. |
...
| getSelectedText | MultiCombo 컴포넌트의 텍스트 편집 영역에서 선택한 텍스트를 반환하는 메서드입니다. |
...
| setFocus | MultiCombo 에 포커스를 설정하는 메서드입니다. |
...
| oneditclick | MultiCombo 컴포넌트의 텍스트 편집 영역에서 마우스 왼쪽 버튼을 클릭했을 때 발생하는 이벤트입니다. |
...
> Components > Component > MultiCombo > Property > -nexa-border

**Description**

MultiCombo 의 테두리를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.border[= strborder]
```
...
this.MultiCombo00.border = "1px solid #999999";
this.MultiCombo00.border = "1px solid #999999, 1px solid #999999, 1px solid #999999, 1px solid #999999";
```
...
> Components > Component > MultiCombo > Property > -nexa-edge

**Description**

MultiCombo 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.edge[= stredge]
```
...
* Script ( normal property )
this.MultiCombo00.edge = "URL('./images/border.png')" 5px 5px;
```
...
- MultiCombo 내부에 테두리 형태로 이미지를 표시하고자 할 때 사용하는 속성입니다.
...
> Components > Component > MultiCombo > Property > -nexa-padding

**Description**

MultiCombo 영역의 안쪽 여백을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.padding[= strpadding]
```
...
* Script ( normal property )
this.MultiCombo00.padding = "5px 5px 5px 5px";
```
- **`<npadding>`** — MultiCombo 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
- -nexa-padding 속성은 내부 컨텐츠영역과 MultiCombo 사이의 여백으로 적용됩니다.
...
> Components > Component > MultiCombo > Property > -nexa-rtl-background-image

**Description**

MultiCombo 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.-nexa-rtl-background-image
```
...
> Components > Component > MultiCombo > Property > -nexa-rtl-edge-image

**Description**

MultiCombo 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.-nexa-rtl-edge-image
```
...
> Components > Component > MultiCombo > Property > acceptvaluetype

**Description**

MultiCombo 에서 InnerDataset 에 없는 코드값을 스크립트로 value 속성에 설정할 때 처리방식을 결정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.acceptvaluetype[= enumAccept]
```
...
```
```javascript
this.MultiCombo00.acceptvaluetype = "ignoreinvalid";
```
...
- MultiCombo 에 바인드 된 DataSet 의 데이터값이 value 속성에 설정되는 경우는 적용되지 않습니다.
...
> Components > Component > MultiCombo > Property > accessibilityaction

**Description**

MultiCombo에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 action 정보를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.accessibilityaction[= strAction]
```

**Setting Syntax**

```javascript
this.MultiCombo00.accessibilityaction = "Accessibility Action Message"; 
this.MultiCombo00.accessibilityaction = "Select by direction key";
```
...
> Components > Component > MultiCombo > Property > accessibilitydesclevel

**Description**

MultiCombo 에 선택상자 이동 시 하위 컴포넌트의 접근성 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.accessibilitydesclevel[= enumLevel]
```
...
```
```javascript
this.MultiCombo00.accessibilitydesclevel = "all";
```
- **`"all"`** — MultiCombo 와 자식 컴포넌트에 대한 접근성을 모두 출력합니다.
- **`"self"`** — MultiCombo 의 접근성만 출력하고 자식 컴포넌트의 접근성은 출력하지 않습니다.
- **`"child"`** — MultiCombo 의 접근성은 출력하지 않고, 자식 컴포넌트의 접근성은 출력합니다.
- **`"none"`** — MultiCombo 와 자식 컴포넌트에 대한 접근성을 모두 출력하지 않습니다.
...
- accessibilitydesclevel 속성은 선택상자의 이동에 영향을 주지 않으므로 방향키로 선택상자가 MultiCombo 에 이동되게 하지 않으려면 accessibilityenable 속성을 설정하여야 합니다.
...
> Components > Component > MultiCombo > Property > accessibilitydescription

**Description**

MultiCombo에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 description 정보를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.accessibilitydescription[= strDescription]
```

**Setting Syntax**

```javascript
this.MultiCombo00.accessibilitydescription = "Option";
```
...
> Components > Component > MultiCombo > Property > accessibilityenable

**Description**

MultiCombo 에 선택상자 이동 시 접근성 관련 속성값 출력여부를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.accessibilityenable[= bEnable]
```
...
```
```javascript
this.MultiCombo00.accessibilityenable = false;
```
- **`true`** — MultiCombo 에 선택상자가 이동되면 접근성 관련 속성값을 출력합니다.

방향키 또는 제스처로 선택상자 이동 시 Static 과 같이 포커스를 갖지 않는 컴포넌트에도 선택상자가 이동됩니다.
- **`false`** — MultiCombo 에 선택상자가 이동되어도 접근성 관련 속성값을 출력하지 않습니다.

데스크탑 환경에서 방향키로 선택상자가 MultiCombo 에 이동되지 않습니다.
모바일 환경에서 제스처로 선택상자가 MultiCombo 에 이동되지 않습니다.
...
- 선택상자 이동 시 컴포넌트의 ARIA-LABEL + Status + Role 순서로 정보가 조합되어 접근성으로 출력됩니다.
   ...
   > Status : MultiCombo 의 현재 상태가 반영됩니다.
   > Role : accessibilityrole 속성값이 반영됩니다. accessibilityrole 속성값을 설정하지 않으면 MultiCombo 의 고유 Role 이 반영됩니다.

- accessibilityenable 속성값이 false 일 때 데스크탑 환경에서 방향키 외의 방법으로 선택상자를 MultiCombo 로 이동시키면 스크린 리딩 프로그램에서 임의의 값을 출력할 수 있습니다.
...
> Components > Component > MultiCombo > Property > accessibilitylabel

**Description**

MultiCombo에 선택상자 이동 시 accessibilitydescreadtype 속성에 따라 스크린 리더의 음성 출력 대상으로 포함할 label 정보를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.accessibilitylabel[= strLabel]
```

**Setting Syntax**

```javascript
this.MultiCombo00.accessibilitylabel = "OK Button"; 
this.MultiCombo00.accessibilitylabel = "[@static00]"; 
this.MultiCombo00.accessibilitylabel = "[@static00][@static01]"; 
this.MultiCombo00.accessibilitylabel = "[@static00][@static01] OK Button";
```
...
> Components > Component > MultiCombo > Property > accessibilityrole

**Description**

MultiCombo에 선택상자 이동 시 스크린 리더가 읽어주는 Role 정보를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.accessibilityrole[= enumRole]
```
...
```
```javascript
this.MultiCombo00.accessibilityrole = "none"; 
this.MultiCombo00.accessibilityrole = "button";
```
...
- accessibilityenable 속성값을 설정하지 않으면 MultiCombo의 기본 Role 로 적용됩니다.

- 추가적인 속성값이 필요한 Role 설정 시 MultiCombo에 해당 속성이 없으면 스크린 리더에 따라 정상적으로 정보를 읽지 못할 수 있습니다.
...
> Components > Component > MultiCombo > Property > autoselect

**Description**

MultiCombo 컴포넌트의 편집영역이 활성화될 때 텍스트를 전체선택 할지 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.autoselect[= bAutoselect]
```
...
```
```javascript
this.MultiCombo00.autoselect = true;
this.MultiCombo00.autoselect = false;
```
...
> Components > Component > MultiCombo > Property > autoskip

**Description**

MultiCombo 컴포넌트의 아이템이 선택되었을 때 포커스를 자동으로 이동시킬지 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.autoskip[= bAutoskip]
```
...
```
```javascript
this.MultiCombo00.autoskip = true;
this.MultiCombo00.autoskip = false;
```
- **`true`** — MultiCombo 컴포넌트의 아이템이 선택되었을 때 포커스를 다음 컴포넌트로 이동시킵니다.
- **`false`** — MultiCombo 컴포넌트의 아이템이 선택되어도 포커스를 이동시키지 않습니다.

**Remark**

- autoskip 속성값을 설정하지 않으면 false로 적용됩니다.

- 엔터키나 마우스로 리스트를 선택완료하면 MultiCombo 컴포넌트의 아이템이 선택된 것으로 처리합니다.
...
> Components > Component > MultiCombo > Property > background

**Description**

MultiCombo 의 배경 영역을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.background[= strbackground]
```
...
* Script ( normal property )
this.MultiCombo00.background = "#ffffaa";
this.MultiCombo00.background = ""URL('./images/smiley.gif')" no-repeat center center #ffffaa";
this.MultiCombo00.background = ""URL('./images/smiley.gif')" no-repeat center center /auto #ffffaa";
this.MultiCombo00.background = ""URL('./images/smiley.gif')" no-repeat center center /15px 15% #ffffaa";
this.MultiCombo00.background = "linear-gradient( red , blue , yellow )";
this.MultiCombo00.background = "linear-gradient( #FF0000 , rgb(0,0,255) , rgb(255,255,0))";
this.MultiCombo00.background = ""URL('./images/smiley.gif')" border-box border-box #ffffaa";
```
...
"left" 설정 시 MultiCombo 의 왼쪽면과 이미지의 왼쪽면이 정렬되어 표시됩니다.
"center" 설정 시 MultiCombo 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"right" 설정 시 MultiCombo 의 오른쪽면과 이미지의 오른쪽면이 정렬되어 표시됩니다.
...
"top" 설정 시 MultiCombo 의 윗쪽면과 이미지의 윗쪽면이 정렬되어 표시됩니다.
"center" 설정 시 MultiCombo 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"bottom" 설정 시 MultiCombo 의 아랫쪽면과 이미지의 아랫쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
0 보다 작거나 100 보다 큰 값을 설정 시 MultiCombo 의 영역을 벗어난 가상의 위치로 적용됩니다.
...
예를 들어 <angle> 값이 "to left" 이면 MultiCombo 의 right 위치가 시작점이 되고, left 위치가 끝점이 됩니다.
              <angle> 값이 "to right" 이면 MultiCombo 의 left 위치가 시작점이 되고, right 위치가 끝점이 됩니다.
...
<bg-image> 에 적용된 이미지에 투명으로 적용된 부분이 있거나 이미지가 MultiCombo 영역보다 작다면 해당 영역에 배경색이 표시됩니다.
...
> Components > Component > MultiCombo > Property > border-radius

**Description**

MultiCombo 의 모서리 모양을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.borderRadius[= strborderradius]
```
...
* Script ( normal property )
this.MultiCombo00.borderRadius = "10px";
this.MultiCombo00.borderRadius = "5px 6px 10px / 5px 10px";
```
...
> Components > Component > MultiCombo > Property > bottom

**Description**

MultiCombo 을(를) 표시하기 위한 하단 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.bottom[= nBottom]
```
...
```
```javascript
this.MultiCombo00.bottom = 10; 
this.MultiCombo00.bottom = "10px"; 
this.MultiCombo00.bottom = "10%"; 
this.MultiCombo00.bottom = "Button00:10px"; 
this.MultiCombo00.bottom = "Button00:10%";
```
- **`<strCompID>`** — MultiCombo 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 MultiCombo 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 MultiCombo 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — MultiCombo 의 하단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 bottom 속성값을 기준으로 MultiCombo의 하단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 MultiCombo의 하단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 MultiCombo의 하단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 MultiCombo의 하단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 top 속성값을 기준으로 MultiCombo의 하단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 MultiCombo의 하단 위치 결정
...
> Components > Component > MultiCombo > Property > box-shadow

**Description**

MultiCombo 에 그림자 효과를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.boxShadow[= strbshadow]
```
...
* Script ( normal property )
this.MultiCombo00.boxShadow  = "10px 10px 10px #888888";
this.MultiCombo00.boxShadow  = "inset 10px 10px 10px 5px #888888";
```
...
MultiCombo 의 좌상단 위치를 기준으로 그림자 효과가 표시될 위치를 가로/세로 픽셀값으로 설정합니다.
...
> Components > Component > MultiCombo > Property > buttonsize

**Description**

MultiCombo 컴포넌트의 드롭다운 버튼 크기를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.buttonsize[= strSize]
```
...
```
```javascript
this.MultiCombo00.buttonsize = "20";
this.MultiCombo00.buttonsize = "40 20";
```
...
- buttonsize 속성값을 설정하지 않으면 undefined로 적용됩니다.
  undefined 설정 시 MultiCombo 컴포넌트의 height 속성값이 적용됩니다.

- <strWidth> 값이 MultiCombo 컴포넌트의 width 속성값보다 클 경우 MultiCombo 컴포넌트의 너비에 맞게 드롭다운 버튼이 표시됩니다.
...
> Components > Component > MultiCombo > Property > codecolumn

**Description**

MultiCombo 컴포넌트에서 아이템의 코드값으로 사용될 Column을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.codecolumn[= strColumnID]
```

**Setting Syntax**

```javascript
this.MultiCombo00.codecolumn = "codecolumn";
```
...
- MultiCombo 컴포넌트에서 선택된 아이템의 코드값은 value 속성에 설정됩니다.
...
> Components > Component > MultiCombo > Property > color

**Description**

MultiCombo 에 표시되는 텍스트의 색상을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.color[= strcolor]
```
...
* Script ( normal property )
this.MultiCombo00.color = "#999999";
this.MultiCombo00.color = "rgb(255,0,0)";
this.MultiCombo00.color = "red";
```
- **`<NamedColor>`** — "red","blue" 와 같이 미리 정의된 색상이름을 문자열로 설정합니다.
- **`<NumericColor>`** — 표시할 색의 색상코드입니다.
...
> Components > Component > MultiCombo > Property > counttextformat
...
```javascript
MultiCombo.counttextformat[= strExpr]
```

**Setting Syntax**

```javascript
this.MultiCombo00.counttextformat = "[#]개 아이템을 선택했습니다.";
this.MultiCombo00.counttextformat = "[*]개 아이템 중에서 [#]개를 선택했습니다.";
```
- **`strExpr`** — 선택된 아이템 개수를 표시할 텍스트를 설정합니다.
...
- counttextformat 속성값을 설정하지 않으면 "[#] item(s) selected"으로 적용됩니다.
...
> Components > Component > MultiCombo > Property > cssclass

**Description**

MultiCombo 의 Style 을 XCSS 파일에 정의된 class 로 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.cssclass[= strcssclass]
```
...
```
```javascript
this.MultiCombo00.cssclass = "TestClass"; 
this.MultiCombo00.cssclass = "TestClass,TestClass2";
```
...
> Components > Component > MultiCombo > Property > cursor

**Description**

MultiCombo 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.cursor[= strCursor]
```
...
* Script ( normal property )
this.MultiCombo00.cursor = "default";
```
...
> Components > Component > MultiCombo > Property > datacolumn

**Description**

MultiCombo 컴포넌트에서 아이템의 데이터값으로 사용될 Column을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.datacolumn[= strColumnID]
```

**Setting Syntax**

```javascript
this.MultiCombo00.datacolumn = "datacolumn";
```
...
- MultiCombo 컴포넌트에서 선택된 아이템의 데이터값은 text 속성값에 설정됩니다.
...
> Components > Component > MultiCombo > Property > displaynulltext

**Description**

MultiCombo 의 value 속성값이 null 또는 undefined 일 때 MultiCombo 에 표시될 대체 문자열을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.displaynulltext[= strText]
```

**Setting Syntax**

```javascript
this.MultiCombo00.displaynulltext = "no value";
```
- **`strText`** — value 속성값이 null 일 때 MultiCombo 에 표시될 대체 문자열을 설정합니다.

**Remark**

- value 속성값이 null 또는 undefined 이고, MultiCombo 에 포커스가 없을 때 대체 문자열이 표시됩니다.
...
> Components > Component > MultiCombo > Property > displayrowcount

**Description**

MultiCombo 컴포넌트의 아이템 리스트에 표시될 아이템의 최대 개수를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.displayrowcount[= nRowNum]
```
...
- displayrowcount 속성값을 설정하지 않으면 undefined로 적용됩니다.

- displayrowcount 속성값 보다 아이템의 개수가 작으면 아이템 개수에 맞게 리스트가 표시됩니다.

- displayrowcount 속성값 보다 아이템의 개수가 많으면 아이템 리스트에 스크롤이 표시됩니다.

- MultiCombo 컴포넌트 하단에 아이템 3개를 표시할 공간이 없다면 아이템 리스트가 MultiCombo 컴포넌트 상단에 표시됩니다.
...
> Components > Component > MultiCombo > Property > dropbutton

**Description**

MultiCombo 컴포넌트의 서브컨트롤인 드롭버튼(DropButton) 오브젝트를 갖는 속성입니다

**Syntax**

```javascript
MultiCombo.dropbutton // get
```

**Setting Syntax**

```javascript
var objButton = this.MultiCombo00.dropbutton;
```
...
> Components > Component > MultiCombo > Property > edittype

**Description**

MultiCombo 컴포넌트에서 선택된 아이템의 표시 방식을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.edittype[= enumMode]
```
...
```
```javascript
this.MultiCombo00.edittype = "singletag";
```
...
- edittype 속성값을 설정하지 않으면 "text"로 적용됩니다.
...
> Components > Component > MultiCombo > Property > enable

**Description**

MultiCombo 의 사용가능 여부를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.enable[= benable]
```
...
```
```javascript
this.MultiCombo00.enable = true; 
this.MultiCombo00.enable = false;
```
- **`true`** — MultiCombo 을(를) 사용할 수 있게 설정합니다.
- **`false`** — MultiCombo 을(를) 사용할 수 없게 설정합니다.
...
> Components > Component > MultiCombo > Property > enableevent

**Description**

MultiCombo 에서 이벤트를 발생시킬지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.enableevent[= bEvent]
```
...
```
```javascript
this.MultiCombo00.enableevent = true;  
this.MultiCombo00.enableevent = false;
```
- **`true`** — MultiCombo 에서 이벤트가 발생하도록 설정합니다.
- **`false`** — MultiCombo 에서 이벤트가 발생하지 않도록 설정합니다.
...
> Components > Component > MultiCombo > Property > flexgrow
...
> Components > Component > MultiCombo > Property > flexshrink
...
> Components > Component > MultiCombo > Property > font

**Description**

MultiCombo 에서 사용하는 폰트를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.font[= strfont]
```
...
* Script ( normal property )
this.MultiCombo00.font = "bold 12pt/30px arial, sans-serif";
```
...
> Components > Component > MultiCombo > Property > height

**Description**

MultiCombo 을(를) 표시하기 위한 높이를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.height[= nHeight]
```
...
```
```javascript
this.MultiCombo00.height = 10; 
this.MultiCombo00.height = "10px"; 
this.MultiCombo00.height = 10%"; 
this.MultiCombo00.height = Button00:10%";
```
- **`<strCompID>`** — MultiCombo 의 높이를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 MultiCombo 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 MultiCombo 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 높이가 적용됩니다.
- **`<nVal>`** — MultiCombo 의 높이를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.


* <strCompID> 값을 생략했을 때 :
- "px": MultiCombo의 높이 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 MultiCombo의 높이 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 MultiCombo의 높이 결정
- "rem": MainFrame font-size 속성값을 기준으로 MultiCombo의 높이 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 MultiCombo의 높이 결정
- "%": <strCompID>의 height 속성값을 기준으로 MultiCombo의 높이 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > MultiCombo > Property > hotkey

**Description**

MultiCombo 의 기본 액션을 수행하기 위한 단축키를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.hotkey[= strHotkey]
```

**Setting Syntax**

```javascript
this.MultiCombo00.hotkey = "G"; 
this.MultiCombo00.hotkey = "CTRL+A"; 
this.MultiCombo00.hotkey = "CTRL+ALT+X";
```
...
> Components > Component > MultiCombo > Property > id

**Description**

MultiCombo의 고유 식별자를 설정하는 속성입니다.
...
- **`id`** — MultiCombo를 구별할 수 있는 유일값을 갖습니다.
...
> Components > Component > MultiCombo > Property > imemode

**Description**

MultiCombo 의 기본 입력 언어를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.imemode[= enumImemode]
```
...
> Components > Component > MultiCombo > Property > index

**Description**

MultiCombo 컴포넌트의 아이템 중 선택된 아이템의 인덱스를 갖는 속성입니다.

**Syntax**

```javascript
MultiCombo.index[= strIndex]
```

**Setting Syntax**

```javascript
this.MultiCombo00.index = "0,1,2";
```
- **`strIndex`** — 선택할 아이템의 인덱스를 1개 이상 콤마(,) 구분자를 사용해 설정합니다.

- 인덱스는 0부터 시작하며 (아이템 개수 - 1)까지 설정할 수 있습니다.
...
> Components > Component > MultiCombo > Property > initvalueid

**Description**

MultiCombo 에 적용될 InitValue 의 ID 를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.initvalueid[= strValueID]
```

**Setting Syntax**

- **`strValueID`** — InitValueDefinition 영역에 정의된 InitValue 파일에서 MultiCombo 에 적용할 항목의 ID 를 문자열로 설정합니다.

**Remark**

- MultiCombo 가 화면에 표시된 후에는 속성값을 설정하거나 변경 할 수 없습니다.
   MultiCombo 를 동적으로 생성 시 show() 메소드 실행 전에 속성값을 설정하여야 합니다.
...
> Components > Component > MultiCombo > Property > innerdataset

**Description**

MultiCombo 컴포넌트의 아이템 리스트를 구성할 Dataset 오브젝트의 ID를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.innerdataset[= strDatasetID]
```

**Setting Syntax**

```javascript
this.MultiCombo00.innerdataset = "Dataset00";
```
...
> Components > Component > MultiCombo > Property > itemheight

**Description**

MultiCombo 컴포넌트의 아이템 리스트에서 각 행의 높이를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.itemheight[= nHeight]
```

**Setting Syntax**

```javascript
this.MultiCombo00.itemheight = 20;
```
...
> Components > Component > MultiCombo > Property > layoutorder
...
> Components > Component > MultiCombo > Property > left

**Description**

MultiCombo 을(를) 표시하기 위한 좌측 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.left[= nLeft]
```
...
```
```javascript
this.MultiCombo00.left = 10; 
this.MultiCombo00.left = "10px"; 
this.MultiCombo00.left = "10%"; 
this.MultiCombo00.left = "Button00:10px"; 
this.MultiCombo00.left = "Button00:10%";
```
- **`<strCompID>`** — MultiCombo 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — MultiCombo 의 좌측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 left 속성값을 기준으로 MultiCombo의 좌측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 MultiCombo의 좌측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 MultiCombo의 좌측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 MultiCombo의 좌측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 right 속성값을 기준으로 MultiCombo의 좌측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 MultiCombo의 좌측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > MultiCombo > Property > letter-spacing

**Description**

MultiCombo 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.letterSpacing[= strspace]
```
...
* Script ( normal property )
this.MultiCombo00.letterSpacing = "2px";
```
...
> Components > Component > MultiCombo > Property > maxheight

**Description**

MultiCombo 이(가) 화면에 표시되는 최대 높이를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.maxheight[= nMaxHeight]
```
...
```
```javascript
this.MultiCombo00.maxheight = 20; 
this.MultiCombo00.maxheight = "20px";
```
- **`<nVal>`** — MultiCombo 이(가) 화면에 표시되는 높이의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 maxheight 보다 크면 화면에 표시되는 MultiCombo 의 높이는 maxheight 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 MultiCombo 의 높이가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > MultiCombo > Property > maxwidth

**Description**

MultiCombo 이(가) 화면에 표시되는 최대 너비를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.maxwidth[= nMaxWidth]
```
...
```
```javascript
this.MultiCombo00.maxwidth = 20; 
this.MultiCombo00.maxwidth = "20px";
```
- **`<nVal>`** — MultiCombo 이(가) 화면에 표시되는 너비의 최대값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 maxwidth 보다 크면 화면에 표시되는 MultiCombo 의 너비는 maxwidth 속성값으로 적용됩니다.
...
- Position 관련 속성(left, top 등)에 기준컴포넌트를 설정하여 MultiCombo 의 너비가 상대적으로 설정될 경우에도 적용되는 속성입니다.
...
> Components > Component > MultiCombo > Property > minheight

**Description**

MultiCombo 이(가) 화면에 표시되는 최소 높이를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.minheight[= nMinHeight]
```
...
```
```javascript
this.MultiCombo00.minheight = 20; 
this.MultiCombo00.minheight = "20px";
```
- **`<nVal>`** — MultiCombo 이(가) 화면에 표시되는 높이의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- height 속성값이 minheight 보다 작다면 화면에 표시되는 MultiCombo 의 높이는 minheight 속성값으로 적용됩니다.
  표시되는 높이만 적용되고 height 속성값은 변경되지 않습니다.
...
> Components > Component > MultiCombo > Property > minwidth

**Description**

MultiCombo 이(가) 화면에 표시되는 최소 너비를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.minwidth[= nMinWidth]
```
...
```
```javascript
this.MultiCombo00.minwidth = 20; 
this.MultiCombo00.minwidth = "20px";
```
- **`<nVal>`** — MultiCombo 이(가) 화면에 표시되는 너비의 최소값을 pixel 단위의 숫자로 설정합니다.

**Remark**

- width 속성값이 minwidth 보다 작으면 화면에 표시되는 MultiCombo 의 너비는 minwidth 속성값으로 적용됩니다.
  표시되는 너비만 적용되고 width 속성값은 변경되지 않습니다.
...
> Components > Component > MultiCombo > Property > multicomboedit

**Description**

MultiCombo 컴포넌트의 서브컨트롤인 편집영역(multicomboedit) 오브젝트를 갖는 속성입니다.

**Syntax**

```javascript
MultiCombo.multicomboedit // get
```

**Setting Syntax**

```javascript
var edit = thisMultiCombo00.multicomboedit;
```
...
> Components > Component > MultiCombo > Property > multicombolist

**Description**

MultiCombo 컴포넌트의 서브컨트롤인 아이템 리스트(multicombolist) 오브젝트를 갖는 속성입니다.

**Syntax**

```javascript
MultiCombo.multicombolist // get
```

**Setting Syntax**

```javascript
var listbox = thisMultiCombo00.multicombolist;
```

**Remark**

- 아이템 리스트(multicombolist)가 최초 한번 표시된 후에 접근할 수 있습니다.
...
> Components > Component > MultiCombo > Property > name

**Description**

MultiCombo 의 이름을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.name[= strName]
```
...
> Components > Component > MultiCombo > Property > opacity

**Description**

MultiCombo 영역의 투명도를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.opacity[= stropacity]
```
...
* Script ( normal property )
this.MultiCombo00.opacity = "0.8";
this.MultiCombo00.opacity = 0.8;
this.MultiCombo00.opacity = "80%";
```
...
> Components > Component > MultiCombo > Property > parent

**Description**

MultiCombo 의 부모 오브젝트를 갖는 읽기전용 속성입니다.
...
```javascript
var objParent = this.MultiCombo00.parent;
```
...
- MultiCombo 이(가) Div 와 같은 컨테이너 컴포넌트에 자식으로 존재한다면 parent 속성은 해당 컨테이너 컴포넌트를 갖습니다.
...
> Components > Component > MultiCombo > Property > popupsize

**Description**

화면에 팝업으로 표시되는 아이템 리스트의 크기를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.popupsize[= strSize]
```
...
```
```javascript
this.MultiCombo00.popupsize  = "120 250";
```
...
값을 생략할 경우 아이템 리스트의 높이가 자동으로 적용됩니다.

**Remark**

- popupsize 속성값을 설정하지 않으면 undefined로 적용됩니다.
   undefined 설정 시 아이템 리스트의 너비와 높이가 자동으로 적용됩니다.

- popupsize 속성에 너비값을 아이템의 텍스트 길이보다 작게 설정할 경우 텍스트가 잘려서 표시됩니다.
...
> Components > Component > MultiCombo > Property > popuptype

**Description**

MultiCombo 컴포넌트의 아이템 리스트가 표시되는 방식을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.popuptype[= enumType]
```
...
```
```javascript
this.MultiCombo00.popuptype  = "normal";
```
- **`"none"`** — 아이템 리스트를 화면에 표시하지 않습니다.
- **`"normal"`** — 아이템 리스트가 표시되는 일반적인 규칙을 따릅니다.
- **`"center"`** — Application이 실행 중인 화면의 중앙에 아이템 리스트가 표시됩니다
...
- 다중 모니터의 경우 MultiCombo 컴포넌트가 표시되고 있는 모니터를 기준으로 아이템 리스트가 표시됩니다.
...
> Components > Component > MultiCombo > Property > positionstep

**Description**

부모 오브젝트가 화면분할기능을 사용할 때 MultiCombo 이(가) 표시될 화면의 인덱스를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.positionstep[= nStep]
```

**Setting Syntax**

```javascript
this.MultiCombo00.positionstep = 0; 
this.MultiCombo00.positionstep = -1;
```
- **`nStep`** — MultiCombo 이(가) 표시될 분할화면의 인덱스를 설정합니다.
"-1" 로 설정하면 모든 분할화면에 MultiCombo 이(가) 표시됩니다.
...
> Components > Component > MultiCombo > Property > readonly

**Description**

MultiCombo 컴포넌트에서 아이템 변경을 허용할지 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.readonly[= bReadOnly]
```
...
```
- **`true`** — MultiCombo 컴포넌트에서 선택된 아이템을 변경할 수 없으며 아이템 리스트가 표시되지 않습니다.
MultiCombo 컴포넌트에 표시된 텍스트를 선택하여 내용을 복사하는 것은 가능합니다.

하위 컨트롤에 "readonly" Status 가 적용됩니다.
"readonly" Status 가 없는 하위 컨트롤은 "disabled" Status 가 적용됩니다.
- **`false`** — MultiCombo 컴포넌트에서 선택된 아이템을 변경할 수 있습니다.
...
- Android WRE는 편집영역의 선택과 복사 기능에 대한 정확한 동작을 보장하지 않습니다.
...
> Components > Component > MultiCombo > Property > readonlycolumn

**Description**

MultiCombo 컴포넌트에서 아이템 readonly 여부 설정 시 사용될 Column을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.readonlycolumn[= strColumnID]
```

**Setting Syntax**

```javascript
this.MultiCombo00.readonlycolumn = "Column0";
```
- **`strColumnID`** — innerdataset 속성에 설정된 Dataset 오브젝트의 Column 중 아이템 readonly 여부를 설정할 Column의 ID를 문자열로 설정합니다.

**Remark**

- MultiCombo 컴포넌트의 readonly 속성값이 false인 경우 개별 아이템의 readonly 여부를 설정합니다.
  MultiCombo 컴포넌트의 readonly 속성값이 true인 경우에는 모든 아이템이 readonly로 처리됩니다.
...
> Components > Component > MultiCombo > Property > right

**Description**

MultiCombo 를 표시하기 위한 우측 좌표값을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.right[= nRight]
```
...
```
```javascript
this.MultiCombo00.right = 10; 
this.MultiCombo00.right = "10px"; 
this.MultiCombo00.right = "10%"; 
this.MultiCombo00.right = "Button00:10px"; 
this.MultiCombo00.right = "Button00:10%";
```
- **`<strCompID>`** — MultiCombo 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — MultiCombo 의 우측 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 right 속성값을 기준으로 MultiCombo의 우측 위치 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 MultiCombo의 우측 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 MultiCombo의 우측 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 MultiCombo의 우측 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 left 속성값을 기준으로 MultiCombo의 우측 위치 결정
- "%": <strCompID>의 width 속성값을 기준으로 MultiCombo의 우측 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > MultiCombo > Property > rtl

**Description**

MultiCombo 에서 내부 컨텐츠 또는 컴포넌트의 표시 기준을 설정하는 속성입니다.
...
```
```javascript
var vRtl = this.MultiCombo00.rtl;
```
- **`undefined`** — undefined 설정 시 상위 컴포넌트의 rtl 속성값이 적용됩니다.

사용자가 rtl 속성값을 설정하지 않거나 삭제했을 경우 undefined 가 설정됩니다.
- **`true`** — MultiCombo 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 오른쪽으로 설정합니다.
MultiCombo 의 내부 좌표계의 기준을 오른쪽으로 설정합니다.
MultiCombo 의 텍스트 표시 기준을 오른쪽으로 설정합니다.
수직스크롤바가 있을 경우 왼쪽에 표시됩니다.
- **`false`** — MultiCombo 의 내부 컨텐츠 또는 컴포넌트가 표시되는 기준을 왼쪽으로 설정합니다.
MultiCombo 의 내부 좌표계의 기준을 왼쪽으로 설정합니다.
MultiCombo 의 텍스트 표시 기준을 왼쪽으로 설정합니다.
...
- MultiCombo 부터 Environment 까지 상위의 모든 rtl 속성값이 undefined 이면
...
> Components > Component > MultiCombo > Property > scrollbarbarminsize
...
```javascript
MultiCombo.scrollbarbarminsize[= nSize]
```

**Setting Syntax**

```javascript
this.MultiCombo00.scrollbarbarminsize = 20;
```
...
> Components > Component > MultiCombo > Property > scrollbarbaroutsize
...
```javascript
MultiCombo.scrollbarbaroutsize[= nSize]
```

**Setting Syntax**

```javascript
this.MultiCombo00.scrollbarbaroutsize( 50 );
```
...
> Components > Component > MultiCombo > Property > scrollbardecbuttonsize
...
```javascript
MultiCombo.scrollbardecbuttonsize[= nHeight]
```

**Setting Syntax**

```javascript
this.MultiCombo00.scrollbardecbuttonsize = 30;
```
...
> Components > Component > MultiCombo > Property > scrollbarincbuttonsize
...
```javascript
MultiCombo.scrollbarincbuttonsize[= nHeight]
```

**Setting Syntax**

```javascript
this.MultiCombo00.scrollbarincbuttonsize = 30;
```
...
> Components > Component > MultiCombo > Property > scrollbarsize
...
```javascript
MultiCombo.scrollbarsize[= nWidth]
```

**Setting Syntax**

```javascript
this.MultiCombo00.scrollbarsize = 20;
```
...
> Components > Component > MultiCombo > Property > scrollbartrackbarsize
...
```javascript
MultiCombo.scrollbartrackbarsize[= nSize]
```

**Setting Syntax**

```javascript
this.MultiCombo00.scrollbartrackbarsize = 20;
```
- **`nSize`** — 스크롤바의 트랙바 크기를 pixel 단위의 숫자로 설정합니다.

-1 을 설정하면 아이템 리스트 크기와 아이템의 개수에 따라 트랙바 크기가 자동으로 조절됩니다.
-2 이하의 음수값은 설정할 수 없습니다.

**Remark**

- scrollbartrackbarsize 속성값을 설정하지 않으면 undefined 가 설정되고 -1로 동작합니다.

- scrollbartrackbarsize 속성을 설정하면 아이템 리스트 크기와 아이템 개수에 관계없이 트랙바 크기가 고정되어 표시됩니다.
...
> Components > Component > MultiCombo > Property > scrollindicatorsize

**Description**

MultiCombo 에 표시되는 스크롤 인디케이터바의 크기를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.scrollindicatorsize[= nSize]
```

**Setting Syntax**

```javascript
this.MultiCombo00.scrollindicatorsize = 30;
```
...
- MultiCombo 에 스크롤 인디케이터바가 아닌 스크롤바가 표시될 경우 scrollbarsize 속성으로 크기를 설정하여야 합니다.
...
MultiCombo 컴포넌트의 아이템 리스트에서 selectallcheckbox의 높이를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.selectallcheckboxheight[= nHeight]
```

**Setting Syntax**

```javascript
this.MultiCombo00.selectallcheckboxheight = 20;
```
- **`nHeight`** — selectallcheckbox의 높이를 pixel 단위의 숫자로 설정합니다.

**Remark**

- selectallcheckboxheight 속성을 설정하지 않으면 글자 크기를 기준으로 selectallcheckbox의 높이를 자동 계산합니다.
...
아이템 리스트 상단에 아이템 전체를 선택 또는 선택해제하는 체크박스(selectallcheckbox)의 텍스트를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.selectallcheckboxtext[=strText]
```

**Setting Syntax**

```javascript
this.MultiCombo00.selectallcheckboxtext = "Check All";
```
- **`strText`** — 아이템 리스트 상단에 아이템 전체를 선택 또는 선택해제하는 체크박스의 텍스트를 설정합니다.

**Remark**

- selectallcheckboxtext 속성값을 설정하지 않으면 "Select All"로 적용됩니다.
...
> Components > Component > MultiCombo > Property > showselectallcheckbox

**Description**

아이템 리스트 상단에 아이템 전체를 선택 또는 선택해제하는 체크박스의 표시 여부를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.showselectallcheckbox[= bSelectall]
```
...
```
```javascript
this.MultiCombo00.showselectallcheckbox = true;
this.MultiCombo00.showselectallcheckbox = false;
```
...
- showselectallcheckbox 속성값을 설정하지 않으면 false로 적용됩니다.
...
> Components > Component > MultiCombo > Property > tablecellarea
...
```javascript
MultiCombo.tablecellarea[= strArea]
```
...
> Components > Component > MultiCombo > Property > taborder

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 MultiCombo 의 순서를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.taborder[= nTabOrder]
```
...
> Components > Component > MultiCombo > Property > tabstop

**Description**

탭키 입력으로 컴포넌트간 포커스를 이동할 때 MultiCombo 이(가) 포커스를 받을 지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.tabstop[= bTabStop]
```
...
bTabStop ::= 'true' | 'false'
```
- **`"true"`** — MultiCombo 이(가) 탭키 입력에 의한 포커스를 받습니다.
- **`"false"`** — MultiCombo 이(가) 탭키 입력에 의한 포커스를 받지 않습니다.
...
### tagboxitemhorizontalgap

> Components > Component > MultiCombo > Property > tagboxitemhorizontalgap

**Description**

MultiCombo 컴포넌트의 multicombotagbox에서 tagboxitem 간의 수평 간격을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.tagboxitemhorizontalgap [=nGap]
```

**Setting Syntax**

```javascript
this.MultiCombo00.tagboxitemhorizontalgap = 5;
```
- **`nGap`** — tagboxitem 간의 간격을 pixel 단위의 숫자로 설정합니다.

**Remark**

- tagboxitemhorizontalgap 속성값을 설정하지 않으면 undefined로 적용됩니다.
  undefined 설정 시 5px로 적용됩니다.

- tagboxitem과 tagboxedit 사이의 간격에도 적용됩니다.


---

### tagboxitemverticalgap

> Components > Component > MultiCombo > Property > tagboxitemverticalgap

**Description**

MultiCombo 컴포넌트의 multicombotagbox에서 tagboxitem 간의 수직 간격을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.tagboxitemverticalgap [=nGap]
```

**Setting Syntax**

```javascript
this.MultiCombo00.tagboxitemverticalgap = 5;
```
- **`nGap`** — tagboxitem 간의 간격을 pixel 단위의 숫자로 설정합니다.

**Remark**

- tagboxitemverticalgap 속성값을 설정하지 않으면 undefined로 적용됩니다.
  undefined 설정 시 5px로 적용됩니다.
...
> Components > Component > MultiCombo > Property > tagboxscrollbarsize

**Description**

multicombotagbox에 표시되는 스크롤바의 너비를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.tagboxscrollbarsize[= nWidth]
```

**Setting Syntax**

```javascript
this.MultiCombo00.tagboxscrollbarsize = 20;
```
- **`nWidth`** — 스크롤바의 너비를 숫자로 설정합니다.

**Remark**

- tagboxscrollbarsize 속성값을 변경하면 스크롤바 내부버튼의 높이와 너비가 같이 변경됩니다.
...
> Components > Component > MultiCombo > Property > tagboxscrollbartype

**Description**

multicombotagbox에 스크롤바가 표시되는 형식을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.tagboxscrollbartype[= strBartype]
```

**Setting Syntax**

```javascript
strBartype ::= <desktype> | <mobiletype>

<desktype> ::= 'default' | 'none' | 'fixed' | 'auto'
<mobiletype> ::= 'default' | 'none' | 'indicator' | 'autoindicator'
```
```javascript
this.MultiCombo00.tagboxscrollbartype = "none";
this.MultiCombo00.tagboxscrollbartype = "default";
```
- **`"default"`** — Desktop 환경인 경우 "auto"로 적용됩니다.
Mobile 환경인 경우 "autoindicator"로 적용됩니다.
...
- tagboxscrollbartype 속성값을 설정하지 않으면 "default"로 적용됩니다.

- edittype 속성값이 "singletag"인 경우에는 가로 스크롤바, "multitag"인 경우에는 세로 스크롤바만 표시됩니다.


---

### tagboxscrollindicatorsize

> Components > Component > MultiCombo > Property > tagboxscrollindicatorsize

**Description**

multicombotagbox에 표시되는 스크롤 인디케이터바의 크기를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.tagboxscrollindicatorsize[= nSize]
```

**Setting Syntax**

```javascript
this.MultiCombo00.tagboxscrollindicatorsize = 30;
```
- **`nSize`** — 스크롤 인디케이터바의 크기를 pixel 단위의 숫자로 설정합니다.

**Remark**

- tagboxscrollindicatorsize 속성값은 수직스크롤바의 너비와 수평스크롤바의 높이에 동일하게 적용됩니다.

- 스크롤 인디케이터바가 아닌 스크롤바가 표시될 경우 tagboxscrollbarsize 속성으로 크기를 설정하여야 합니다.
...
MultiCombo 컴포넌트 tagbutton의 크기를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.tagbuttonsize [= strSize]
```
...
```
```javascript
this.MultiCombo00.tagbuttonsize = "20";
this.MultiCombo00.tagbuttonsize = "40 20";
```
- **`<strWidth>`** — tagbutton의 너비를 pixel 단위의 문자열로 설정합니다.
- **`<strHeight>`** — tagbutton의 높이를 pixel 단위의 문자열로 설정합니다.

값을 생략할 경우 <strWidth> 값이 적용됩니다.

**Remark**

- tagbuttonsize 속성값을 설정하지 않으면 undefined로 적용됩니다.
  undefined 설정 시 tagtext 글자 크기를 기준으로 자동 계산되어 적용됩니다.
...
> Components > Component > MultiCombo > Property > text

**Description**

MultiCombo 컴포넌트에서 선택된 아이템의 데이터값을 갖는 속성입니다.

**Syntax**

```javascript
MultiCombo.text[= strText]
```

**Setting Syntax**

```javascript
this.MultiCombo00.text = "data00,data01";
```
- **`strText`** — 아이템 리스트 중에서 선택할 아이템의 데이터값을 1개 이상 구분자를 사용해 설정합니다.
구분자는 textseparator 속성값을 적용합니다.
...
> Components > Component > MultiCombo > Property > textseparator
...
```javascript
MultiCombo.textseparator[= strTextSeparator]
```

**Setting Syntax**

```javascript
this.MultiCombo00.textseparator = ";";
```
...
> Components > Component > MultiCombo > Property > tooltiptext

**Description**

MultiCombo 에 마우스 포인터를 올려 놓았을 때 표시되는 풍선도움말을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.tooltiptext[= strToolTipText]
```

**Setting Syntax**

```javascript
this.MultiCombo00.tooltiptext = "This is ToolTip Text"; this.MultiCombo00.tooltiptext = "";          // 풍선 도움말이 표시되지 않습니다. 
this.MultiCombo00.tooltiptext = null;        // 상위 컴포넌트의 풍선 도움말이 표시됩니다.
```
...
- 마우스 포인터가 MultiCombo 영역 위에서 일정시간 움직이지 않으면 풍선도움말이 표시됩니다.
...
> Components > Component > MultiCombo > Property > tooltiptype

**Description**

MultiCombo 에서 풍선도움말이 표시될 위치와 방식을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.tooltiptype[= enumTooltipType]
```
...
```
```javascript
this.MultiCombo00.tooltiptype = "hover";
```
- **`"default"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 MultiCombo 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"hover"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 MultiCombo 영역내에 멈춰서 일정시간이 경과하면 풍선도움말이 사라집니다.
MultiCombo 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경되거나 사라진 풍선도움말이 다시 표시됩니다.
- **`"inplace"`** — MultiCombo 의 좌측상단 안쪽에 풍선도움말을 표시합니다.

마우스 포인터가 MultiCombo 영역내에 위치하고 일정시간이 경과하면 풍선도움말이 사라집니다.
- **`"default,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 MultiCombo 영역에 있으면 풍선도움말이 사라지지 않습니다.
- **`"hover,mouseleave"`** — 마우스 포인터의 오른쪽 하단 위치에 풍선도움말을 표시합니다.

마우스 포인터가 MultiCombo 영역에 있으면 풍선도움말이 사라지지 않습니다.
MultiCombo 영역 내에서 마우스 포인터를 이동한 후 멈추면 풍선도움말의 위치가 변경됩니다.
- **`"inplace,mouseleave"`** — MultiCombo 의 좌측상단 안쪽에 풍선도움말을 표시합니다.
...
- 표시되었다가 사라진 풍선도움말은 마우스 포인터가 MultiCombo 영역을 나갔다가 들어오면 다시 표시됩니다.

- 마우스 포인터가 MultiCombo 영역에서 벗어나면 풍선도움말이 사라집니다.
...
> Components > Component > MultiCombo > Property > top

**Description**

MultiCombo 을(를) 표시하기 위한 상단 좌표값을 설정하는 속성입니다.
...
```
```javascript
this.MultiCombo00.top = 10; 
this.MultiCombo00.top = "10px"; 
this.MultiCombo00.top = "10%"; 
this.MultiCombo00.top = "Button00:10px"; 
this.MultiCombo00.top = "Button00:10%";
```
- **`<strCompID>`** — MultiCombo 의 좌표값을 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.
...
값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 좌표값이 적용됩니다.
- **`<nVal>`** — MultiCombo의 상단 좌표값을 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": 부모(Parent)의 top 속성값을 기준으로 MultiCombo의 상단 위치 설정
- "%": 부모(Parent)의 height 속성값을 기준으로 MultiCombo의 상단 위치 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 MultiCombo의 상단 위치 결정
- "rem": MainFrame font-size 속성값을 기준으로 MultiCombo의 상단 위치 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID>의 bottom 속성값을 기준으로 MultiCombo의 상단 위치 결정
- "%": <strCompID>의 height 속성값을 기준으로 MultiCombo의 상단 위치 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > MultiCombo > Property > type

**Description**

MultiCombo 컴포넌트가 동작하는 방법을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.type[= enumType]
```
...
```
```javascript
this.MultiCombo00.type = "caseifilter";
```
- **`"dropdown"`** — 아이템 리스트에 전체 아이템이 모두 표시됩니다.

MultiCombo 컴포넌트의 편집창에 문자를 입력할 수 없습니다.
- **`"search"`** — MultiCombo 컴포넌트의 편집창에 문자열 입력 시 검색기능이 활성화됩니다.

편집창에 입력된 문자열로 시작하는 첫 번째 아이템이 선택된 아이템 리스트가 표시됩니다.
편집창에 입력된 문자열로 시작하는 아이템이 없을 경우 아이템 리스트가 표시되지 않습니다.

아이템 리스트에는 전체 아이템이 모두 표시됩니다.
아이템 검색 시 대소문자를 구별합니다.
- **`"filter"`** — MultiCombo 컴포넌트의 편집창에 문자열 입력 시 필터기능이 활성화됩니다.
...
- **`"filterlike"`** — MultiCombo 컴포넌트의 편집창에 문자열 입력 시 필터기능이 활성화됩니다.
...
문자를 추가로 입력하면 아이템 리스트가 자동으로 갱신됩니다.
아이템 필터 시 대소문자를 구별합니다.
- **`"caseisearch"`** — MultiCombo 컴포넌트의 편집창에 문자열 입력 시 검색기능이 활성화됩니다.

"search" 값과 동일하게 동작하며 아이템 검색 시 대소문자를 구별하지 않습니다.
- **`"caseifilter"`** — MultiCombo 컴포넌트의 편집창에 문자열 입력 시 필터기능이 활성화됩니다.

"filter" 값과 동일하게 동작하며 아이템 필터 시 대소문자를 구별하지 않습니다.
- **`"caseifilterlike"`** — MultiCombo 컴포넌트의 편집창에 문자열 입력 시 필터기능이 활성화됩니다.
...
- type 속성값에 관계없이 MultiCombo 컴포넌트의 드롭버튼(DropButton) 클릭 시 전체 아이템이 있는 아이템 리스트가 표시됩니다.

- type 속성을 "dropdown" 이외의 값으로 설정하면 검색/필터 기능이 활성화됩니다.
...
> Components > Component > MultiCombo > Property > usecontextmenu

**Description**

MultiCombo 의 편집영역에서 오른쪽 마우스 클릭 시 기본팝업메뉴의 표시 여부를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.usecontextmenu[= bUseContextMenu]
```
...
```
```javascript
this.MultiCombo00.usecontextmenu = true;
```
...
- Environment 의 usecontextmenu 속성값이 "none" 또는 "form" 인 경우 MultiCombo 의 usecontextmenu 속성은 false 로 동작합니다.
...
> Components > Component > MultiCombo > Property > usesoftkeyboard

**Description**

MultiCombo 가 포커스를 가질 때 키패드의 표시 여부를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.usesoftkeyboard[= bUseKeyboard]
```
...
```
```javascript
this.MultiCombo00.usesoftkeyboard = false;
```
- **`true`** — MultiCombo 가 포커스를 가질 때 키패드가 자동으로 표시됩니다.
- **`false`** — MultiCombo 가 포커스를 가질 때 키패드가 표시되지 않습니다.

**Remark**

- usesoftkeyboard 속성값을 설정하지 않으면 true로 적용됩니다.

- type 속성값이 "dropdown" 일 때는 속성값에 관계없이 키패드가 항상 표시되지 않습니다.


◆ Windows NRE 제약

- Windows NRE는 OS 가 Windows 10 이상이고, 연결된 키보드가 없을 때만 적용됩니다.
...
> Components > Component > MultiCombo > Property > value

**Description**

MultiCombo 컴포넌트에서 선택된 아이템의 코드값을 갖는 속성입니다.

**Syntax**

```javascript
MultiCombo.value[= strValue]
```

**Setting Syntax**

```javascript
this.MultiCombo00.value  = "00,01,02";
```
...
- MultiCombo 컴포넌트에서 선택된 아이템의 코드값이 value 속성값으로 설정됩니다.

- MultiCombo 컴포넌트에 Dataset 오브젝트를 바인딩하면 기본적으로 연동되는 속성입니다.
...
> Components > Component > MultiCombo > Property > visible

**Description**

MultiCombo 이(가) 화면에 표시될지 여부를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.visible[= bVisible]
```
...
```
```javascript
this.MultiCombo00.visible = true; 
this.MultiCombo00.visible = false;
```
- **`"true"`** — MultiCombo 을(를) 화면에 표시합니다.
- **`"false"`** — MultiCombo 을(를) 화면에 표시하지 않습니다.
...
> Components > Component > MultiCombo > Property > width

**Description**

MultiCombo 을(를) 표시하기 위한 너비를 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.width[= nWidth]
```
...
```
```javascript
this.MultiCombo00.width = 10; this.MultiCombo00.width = "10px"; 
this.MultiCombo00.width = "10%"; 
this.MultiCombo00.width = "Button00:10%";
```
- **`<strCompID>`** — MultiCombo 의 너비를 상대적으로 적용하기 위해 기준이 되는 컴포넌트의 ID 를 설정합니다.

기준 컴포넌트는 MultiCombo 와 부모(Parent)가 동일하여야 합니다.
또한, Form 로딩 시 MultiCombo 보다 먼저 생성되어야 합니다.

값을 설정하지 않거나 잘못된 값을 설정하면 부모(Parent) 를 기준으로 너비가 적용됩니다.
- **`<nVal>`** — MultiCombo 의 너비를 절대 길이 단위("px"), 비율 단위("%"), 상대 길이 단위("em", "rem")의 숫자로 설정합니다.

* <strCompID> 값을 생략했을 때 :
- "px": MultiCombo의 너비 설정
- "%": 부모(Parent)의 width 속성값을 기준으로 MultiCombo의 너비 결정
- "em": 컴포넌트의 font-size 속성값을 기준으로 MultiCombo의 너비 결정
- "rem": MainFrame font-size 속성값을 기준으로 MultiCombo의 너비 결정

* <strCompID> 값을 설정했을 때 :
- "px":  <strCompID> 값은 무시되고 설정값이 MultiCombo의 너비 결정
- "%": <strCompID>의 width 속성값을 기준으로 MultiCombo의 너비 결정
<strCompID> 값 설정 시 "em", "rem" 단위는 지원하지 않습니다.
...
> Components > Component > MultiCombo > Property > word-spacing

**Description**

MultiCombo 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다.

**Syntax**

```javascript
MultiCombo.wordSpacing[= strwordspacing]
```
...
* Script ( normal property )
this.MultiCombo00.wordSpacing = "30px";
```
...
> Components > Component > MultiCombo > Method > addEvent
...
```javascript
var bResult = this.MultiCombo00.addEvent( "onmove" );
```
...
> Components > Component > MultiCombo > Method > addEventHandler
...
```javascript
this.MultiCombo00_onmove = function( obj:nexacro.MultiCombo,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.MultiCombo00.addEventHandler( "onmove", this.MultiCombo00_onmove, this);
```
...
> Components > Component > MultiCombo > Method > addEventHandlerLookup
...
```javascript
this.MultiCombo00_onmove = function( obj:nexacro.MultiCombo,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.MultiCombo00.addEventHandlerLookup( "onmove", "MultiCombo00_onmove", this);
```
...
> Components > Component > MultiCombo > Method > bringToFront
...
> Components > Component > MultiCombo > Method > bringToPrev
...
> Components > Component > MultiCombo > Method > clearEventHandler
...
```javascript
var nCnt = this.MultiCombo00.clearEventHandler( "onmove" );
```
...
> Components > Component > MultiCombo > Method > clearSelect
...
> Components > Component > MultiCombo > Method > destroy
...
| Type | Description |
| --- | --- |
| Boolean | MultiCombo 이(가) 정상적으로 삭제되면 true 를 반환합니다.

MultiCombo 이(가) 정상적으로 삭제되지 않으면 false 를 반환합니다. |
...
Form.addChildForm.insertChildForm.removeChildMultiCombo.initMultiCombo.show
...
> Components > Component > MultiCombo > Method > dropdown
...
> Components > Component > MultiCombo > Method > findEventHandler
...
var nIndex = this.MultiCombo00.findEventHandler( "onmove", this.MultiCombo00_onmove, this );
```
...
> Components > Component > MultiCombo > Method > getCaretPos
...
읽기 전용 상태이거나 MultiCombo 컴포넌트에 포커스가 없으면 "-1"을 반환합니다.
...
> Components > Component > MultiCombo > Method > getCount
...
| Type | Description |
| --- | --- |
| Number | MultiCombo 컴포넌트에 표시되는 전체 아이템의 개수를 반환합니다. |
...
> Components > Component > MultiCombo > Method > getEventHandler
...
```javascript
var objFunc = MultiCombo00.getEventHandler( "onmove", 0 );
```
...
> Components > Component > MultiCombo > Method > getInnerDataset
...
> Components > Component > MultiCombo > Method > getOffsetBottom
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 MultiCombo 의 bottom 값을 픽셀단위의 숫자로 반환합니다. |
...
> Components > Component > MultiCombo > Method > getOffsetHeight
...
| Type | Description |
| --- | --- |
| Number | MultiCombo 의 높이를 픽셀단위의 숫자로 변환하여 반환합니다. |
...
> Components > Component > MultiCombo > Method > getOffsetLeft
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 MultiCombo 의 left 값을 픽셀단위의 숫자로 반환합니다. |
...
> Components > Component > MultiCombo > Method > getOffsetRight
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Left 위치를 기준으로 MultiCombo 의 right 값을 픽셀단위의 숫자로 반환합니다. |
...
> Components > Component > MultiCombo > Method > getOffsetTop
...
| Type | Description |
| --- | --- |
| Number | 부모 컴포넌트의 Top 위치를 기준으로 MultiCombo 의 top 값을 픽셀단위의 숫자로 반환합니다. |
...
> Components > Component > MultiCombo > Method > getOffsetWidth
...
| Type | Description |
| --- | --- |
| Number | MultiCombo 의 너비를 픽셀단위의 숫자로 변환하여 반환합니다. |
...
> Components > Component > MultiCombo > Method > getPixelBottom
...
| Type | Description |
| --- | --- |
| Number | MultiCombo 의 bottom 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > MultiCombo > Method > getPixelHeight
...
| Type | Description |
| --- | --- |
| Number | MultiCombo 의 height 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > MultiCombo > Method > getPixelLeft
...
| Type | Description |
| --- | --- |
| Number | MultiCombo 의 left 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > MultiCombo > Method > getPixelRight
...
| Type | Description |
| --- | --- |
| Number | MultiCombo 의 right 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > MultiCombo > Method > getPixelTop
...
| Type | Description |
| --- | --- |
| Number | MultiCombo 의 top 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > MultiCombo > Method > getPixelWidth
...
| Type | Description |
| --- | --- |
| Number | MultiCombo 의 width 속성값을 픽셀단위로 반환합니다.
...
> Components > Component > MultiCombo > Method > getSelect
...
```javascript
var bSelect = this.MultiCombo00.getSelect( 0 );
```
...
> Components > Component > MultiCombo > Method > getSelectedCount
...
> Components > Component > MultiCombo > Method > getSelectedItems
...
> Components > Component > MultiCombo > Method > getSelectedText

**Description**

MultiCombo 컴포넌트의 텍스트 편집 영역에서 선택한 텍스트를 반환하는 메서드입니다.
...
- MultiCombo 컴포넌트의 텍스트 편집 영역에 포커스가 있고 캐럿이 표시된 상태에서만 정상적으로 값을 반환합니다.
...
> Components > Component > MultiCombo > Method > init
...
| vLeft | String, Number | MultiCombo 의 left 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 right 속성값을 기준으로 MultiCombo 의 left 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 MultiCombo 의 left 가 결정됩니다. |
| vTop | String, Number | MultiCombo 의 top 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 bottom 속성값을 기준으로 MultiCombo 의 top 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 MultiCombo 의 top 이 결정됩니다. |
| vWidth | String, Number | MultiCombo 의 width 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 MultiCombo 의 width 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 MultiCombo 의 width 가 결정됩니다. |
| vHeight | String, Number | MultiCombo 의 height 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트값은 무시되고 pixel 값으로 MultiCombo 의 height 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 MultiCombo 의 height 가 결정됩니다. |
| vRight | String, Number | MultiCombo 의 right 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vLeft, vWidth 값을 모두 설정했을 경우 vRight 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 left 속성값을 기준으로 MultiCombo 의 right 가 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 width 속성값을 기준으로 MultiCombo 의 right 가 결정됩니다. |
| vBottom | String, Number | MultiCombo 의 bottom 속성값을 pixel 또는 비율("%") 단위의 숫자로 설정합니다.

vTop, vHeight 값을 모두 설정했을 경우 vBottom 값은 무시됩니다.

* 값에 기준 컴포넌트를 포함하여 설정했을 때 :
pixel 단위로 설정 시 기준 컴포넌트의 top 속성값을 기준으로 MultiCombo 의 bottom 이 결정됩니다.
비율("%") 단위로 설정 시 기준 컴포넌트의 height 속성값을 기준으로 MultiCombo 의 bottom 이 결정됩니다. |
| vMinWidth | String, Number | MultiCombo 이(가) 화면에 표시되는 최소 너비값을 pixel 단위의 숫자로 설정합니다. |
| vMaxWidth | String, Number | MultiCombo 이(가) 화면에 표시되는 최대 너비값을 pixel 단위의 숫자로 설정합니다.

vMinWidth 보다 작은 값을 설정하면 vMinWidth 값으로 설정됩니다. |
| vMinHeight | String, Number | MultiCombo 이(가) 화면에 표시되는 최소 높이값을 pixel 단위의 숫자로 설정합니다. |
| vMaxHeight | String, Number | MultiCombo 이(가) 화면에 표시되는 최대 높이값을 pixel 단위의 숫자로 설정합니다.
...
```javascript
var objComp = new MultiCombo();

objComp.init( "MultiCombo00", 30, 120, 196, 46 );
objComp.init( "MultiCombo00", 30, 120, 196, 46, null, null );
objComp.init( "MultiCombo00", null, null, 300, "400px", "80%", 300 );
objComp.init( "MultiCombo00", 0, 0, 200, 100, null, null, 300, 500, 200, 500 );
objComp.init( "MultiCombo00", "MultiCombo22:10", 300, null, null, "MultiCombo33:10", "20%", 300, 500, 200, 500 );
```
...
Form.addChildForm.insertChildForm.removeChildMultiCombo.destroyMultiCombo.show
...
> Components > Component > MultiCombo > Method > insertEventHandler
...
var nIndex = this.MultiCombo00.insertEventHandler( "onmove", 0, this.MultiCombo00_onmove, this);
```
...
> Components > Component > MultiCombo > Method > isDropdown
...
| Type | Description |
| --- | --- |
| Boolean | 화면에 아이템 리스트가 표시되어 있으면 true를 반환합니다.
화면에 아이템 리스트가 표시되어 있지 않으면 false를 반환합니다. |
...
> Components > Component > MultiCombo > Method > move
...
```javascript
this.MultiCombo00.move(10,10);
this.MultiCombo00.move(10,10,100,100);
this.MultiCombo00.move(null, null, 300, "400px", "80%", 300 );
```
...
> Components > Component > MultiCombo > Method > moveToNext
...
```javascript
this.MultiCombo.moveToNext( this.Button00 );
this.MultiCombo.moveToNext( "Button00" );
```
...
> Components > Component > MultiCombo > Method > moveToPrev
...
```javascript
this.MultiCombo.moveToPrev( this.Button00 );
this.MultiCombo.moveToPrev( "Button00" );
```
...
> Components > Component > MultiCombo > Method > removeEvent
...
```javascript
var bResult = this.MultiCombo00.removeEvent( "onmove" );
```
...
> Components > Component > MultiCombo > Method > removeEventHandler
...
```javascript
this.MultiCombo00_onmove = function( obj:nexacro.MultiCombo,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.MultiCombo00.removeEventHandler( "onmove", this.MultiCombo00_onmove, this);
```
...
> Components > Component > MultiCombo > Method > removeEventHandlerLookup
...
```javascript
this.MultiCombo00_onmove = function( obj:nexacro.MultiCombo,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.MultiCombo00.removeEventHandlerLookup( "onmove", "MultiCombo00_onmove", this);
```
...
> Components > Component > MultiCombo > Method > resize
...
```javascript
this.MultiCombo00.resize( 100,100 );
```
...
> Components > Component > MultiCombo > Method > sendToBack
...
> Components > Component > MultiCombo > Method > sendToNext
...
> Components > Component > MultiCombo > Method > setEventHandler
...
```javascript
this.MultiCombo00_onmove = function( obj:nexacro.MultiCombo,  e:nexacro.MoveEventInfo ) { //수행할 스크립트 };
var nIndex = this.MultiCombo00.setEventHandler( "onmove", this.MultiCombo00_onmove, this );
```
...
> Components > Component > MultiCombo > Method > setEventHandlerLookup
...
```javascript
this.MultiCombo00_onmove = function( obj:nexacro.MultiCombo,  e:nexacro.MoveEventInfo) { // 수행할 스크립트 };
var nIndex = this.MultiCombo00.setEventHandlerLookup( "onmove", "MultiCombo00_onmove", this);
```
...
> Components > Component > MultiCombo > Method > setFocus

**Description**

MultiCombo 에 포커스를 설정하는 메서드입니다.

**Syntax**

```javascript
MultiCombo.setFocus( [bMoveScroll] )
```
...
| Parameters | Type | Description |
| --- | --- | --- |
| bMoveScroll | Boolean | 부모 컴포넌트에 스크롤이 있을 경우, MultiCombo 기준으로 스크롤을 이동할지 여부를 설정합니다.

true: MultiCombo 이(가) 화면에 표시되도록 스크롤을 이동합니다.
false: MultiCombo 위치와 관계없이 스크롤을 이동하지 않습니다.
...
```javascript
var objBefComp = this.MultiCombo00.setFocus();
var objBefComp = this.MultiCombo00.setFocus( false );
```
...
| Type | Description |
| --- | --- |
| Object | MultiCombo 이(가) 포커스를 얻기 전에 포커스를 가지고 있던 컴포넌트를 반환합니다.
...
> Components > Component > MultiCombo > Method > setInnerDataset
...
```javascript
this.MultiCombo00.setInnerDataset( this.Dataset00 ) ;
```
...
> Components > Component > MultiCombo > Method > setOffsetBottom
...
```javascript
this.MultiCombo.setOffsetBottom( 10 );
```
...
> Components > Component > MultiCombo > Method > setOffsetHeight
...
```javascript
this.MultiCombo.setOffsetHeight( 10 );
```
...
> Components > Component > MultiCombo > Method > setOffsetLeft
...
```javascript
this.MultiCombo.setOffsetLeft( 10 );
```
...
> Components > Component > MultiCombo > Method > setOffsetRight
...
```javascript
this.MultiCombo.setOffsetRight( 600 );
```
...
> Components > Component > MultiCombo > Method > setOffsetTop
...
```javascript
this.MultiCombo.setOffsetTop( 10 );
```
...
> Components > Component > MultiCombo > Method > setOffsetWidth
...
```javascript
this.MultiCombo.setOffsetWidth( 10 );
```
...
> Components > Component > MultiCombo > Method > setSelect
...
> Components > Component > MultiCombo > Method > setSelectedText
...
```javascript
var strOldText = this.MultiCombo00.setSelectedText( "Character string to change." );
```
...
| Type | Description |
| --- | --- |
| String | 편집영역에 선택되어 있던 텍스트를 문자열로 반환합니다. |
...
> Components > Component > MultiCombo > Method > setSelectItems
...
```javascript
this.MultiCombo00.setSelectItems([0,2], true);
```
...
> Components > Component > MultiCombo > Method > setSelectRange
...
```javascript
this.MultiCombo00.setSelectRange(0, 2, true)
```
...
> Components > Component > MultiCombo > Method > show
...
Form.addChildForm.insertChildForm.removeChildMultiCombo.destroyMultiCombo.init
...
> Components > Component > MultiCombo > Method > updateToDataset
...
> Components > Component > MultiCombo > Event > canitemchange
...
> Components > Component > MultiCombo > Event > oncloseup
...
> Components > Component > MultiCombo > Event > oncontextmenu
...
> Components > Component > MultiCombo > Event > ondevicebuttonup
...
> Components > Component > MultiCombo > Event > ondrag
...
> Components > Component > MultiCombo > Event > ondragenter
...
> Components > Component > MultiCombo > Event > ondragleave
...
> Components > Component > MultiCombo > Event > ondragmove
...
> Components > Component > MultiCombo > Event > ondrop
...
> Components > Component > MultiCombo > Event > ondropdown
...
| Type | Description |
| --- | --- |
| Boolean | 이벤트의 리턴값으로 true를 반환하면 아이템 리스트가 화면에 표시됩니다.
...
> Components > Component > MultiCombo > Event > oneditclick

**Description**

MultiCombo 컴포넌트의 텍스트 편집 영역에서 마우스 왼쪽 버튼을 클릭했을 때 발생하는 이벤트입니다.
...
> Components > Component > MultiCombo > Event > oninnerdatachanged
...
> Components > Component > MultiCombo > Event > oninput
...
> Components > Component > MultiCombo > Event > onitemchanged
...
> Components > Component > MultiCombo > Event > onitemclick
...
> Components > Component > MultiCombo > Event > onkeydown
...
> Components > Component > MultiCombo > Event > onkeyup
...
> Components > Component > MultiCombo > Event > onkillfocus
...
> Components > Component > MultiCombo > Event > onlbuttondown
...
> Components > Component > MultiCombo > Event > onlbuttonup
...
> Components > Component > MultiCombo > Event > onmouseenter
...
> Components > Component > MultiCombo > Event > onmouseleave
...
> Components > Component > MultiCombo > Event > onmousemove
...
> Components > Component > MultiCombo > Event > onmousewheel
...
> Components > Component > MultiCombo > Event > onmove
...
> Components > Component > MultiCombo > Event > onrbuttondown
...
> Components > Component > MultiCombo > Event > onrbuttonup
...
> Components > Component > MultiCombo > Event > onsetfocus
...
> Components > Component > MultiCombo > Event > onsize
...
> Components > Component > MultiCombo > Event > ontouchend
...
> Components > Component > MultiCombo > Event > ontouchmove
...
> Components > Component > MultiCombo > Event > ontouchstart
...
## Components > Component > MultiCombo > Objects
...
MultiCombo 컴포넌트를 구성하는 하위 오브젝트입니다.


---

## Components > Component > MultiCombo > MultiComboListControl

### MultiComboListControl

> Components > Component > MultiCombo > Objects > MultiComboListControl

**Description**

여러 개의 후보값 중에서 1개 또는 여러 개의 값을 선택하기 위해 사용하는 오브젝트입니다.

**Property**

| Name | Description |
| --- | --- |
| background | MultiComboListControl 의 배경 영역을 설정하는 속성입니다. |
| border-radius | MultiComboListControl 의 모서리 모양을 설정하는 속성입니다. |
| box-shadow | MultiComboListControl 에 그림자 효과를 설정하는 속성입니다. |
| color | MultiComboListControl 에 표시되는 텍스트의 색상을 설정하는 속성입니다. |
| cursor | MultiComboListControl 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다. |
| font | MultiComboListControl 에서 사용하는 폰트를 설정하는 속성입니다. |
| letter-spacing | MultiComboListControl 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다. |
| -nexa-border | MultiComboListControl 의 테두리를 설정하는 속성입니다. |
| -nexa-edge | MultiComboListControl 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-padding | MultiComboListControl 영역의 안쪽 여백을 설정하는 속성입니다. |
| -nexa-rtl-background-image | MultiComboListControl 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다. |
| -nexa-rtl-edge-image | MultiComboListControl 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-text-align | MultiComboListControl 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다. |
| -nexa-text-decoration | MultiComboListControl 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다. |
| -nexa-vertical-align | MultiComboListControl 에 표시되는 텍스트 또는 컨텐츠의 세로 정렬 방식을 설정하는 속성입니다. |
| -nexa-word-wrap | MultiComboListControl 에 표시되는 텍스트가 출력영역보다 길 경우 자동으로 줄바꿈 되도록 설정하는 속성입니다. |
| opacity | MultiComboListControl 영역의 투명도를 설정하는 속성입니다. |
| word-spacing | MultiComboListControl 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다. |
...
| Name | TypeName |
| --- | --- |
| checkboxset | nexacro.CheckBoxSet |
| selectallcheckbox | nexacro.CheckBox |
| multicomboedit | nexacro.Edit |
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > -nexa-border

**Description**

MultiComboListControl 의 테두리를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.-nexa-border
```
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > -nexa-edge

**Description**

MultiComboListControl 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.-nexa-edge
```
...
- MultiComboListControl 내부에 테두리 형태로 이미지를 표시하고자 할 때 사용하는 속성입니다.
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > -nexa-padding

**Description**

MultiComboListControl 영역의 안쪽 여백을 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.-nexa-padding
```
...
-nexa-padding : 5px 5px 5px 5px;
```
- **`<npadding>`** — MultiComboListControl 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
- MultiComboListControl 의 너비보다 표시되는 컨텐츠의 너비가 길면 "right" 방향의 padding 값이 무시됩니다.
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > -nexa-rtl-background-image

**Description**

MultiComboListControl 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.-nexa-rtl-background-image
```
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > -nexa-rtl-edge-image

**Description**

MultiComboListControl 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.-nexa-rtl-edge-image
```
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > -nexa-text-align

**Description**

MultiComboListControl 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.textAlign[= strtextalign]
```
...
* Script ( normal property )
this.MultiComboListControl00.textAlign = "center";
```
...
- MultiComboListControl 의 너비보다 표시되는 텍스트의 길이가 크면 "right" 를 설정해도 "left" 로 동작됩니다.
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > -nexa-text-decoration

**Description**

MultiComboListControl 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.-nexa-text-decoration
```
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > -nexa-vertical-align

**Description**

MultiComboListControl 에 표시되는 텍스트 또는 컨텐츠의 세로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.-nexa-vertical-align
```
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > -nexa-word-wrap

**Description**

MultiComboListControl 에 표시되는 텍스트가 출력영역보다 길 경우 자동으로 줄바꿈 되도록 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.-nexa-word-wrap
```
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > background

**Description**

MultiComboListControl 의 배경 영역을 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.background
```
...
"left" 설정 시 MultiComboListControl 의 왼쪽면과 이미지의 왼쪽면이 정렬되어 표시됩니다.
"center" 설정 시 MultiComboListControl 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"right" 설정 시 MultiComboListControl 의 오른쪽면과 이미지의 오른쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
"top" 설정 시 MultiComboListControl 의 윗쪽면과 이미지의 윗쪽면이 정렬되어 표시됩니다.
"center" 설정 시 MultiComboListControl 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"bottom" 설정 시 MultiComboListControl 의 아랫쪽면과 이미지의 아랫쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
0 보다 작거나 100 보다 큰 값을 설정 시 MultiComboListControl 의 영역을 벗어난 가상의 위치로 적용됩니다.
...
<angle> 값에 설정된 방향에 따라 시작점과 끝점의 위치가 결정됩니다.
예를 들어 <angle> 값이 "to left" 이면 MultiComboListControl 의 right 위치가 시작점이 되고, left 위치가 끝점이 됩니다.
              <angle> 값이 "to right" 이면 MultiComboListControl 의 left 위치가 시작점이 되고, right 위치가 끝점이 됩니다.
...
<bg-image> 또는 <linear-gradient> 값이 설정되어 있다면 배경색은 배경이미지 또는 그라데이션 아래에 표시됩니다.
<bg-image> 에 적용된 이미지에 투명으로 적용된 부분이 있거나 이미지가 MultiComboListControl 영역보다 작다면 해당 영역에 배경색이 표시됩니다.
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > border-radius

**Description**

MultiComboListControl 의 모서리 모양을 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.border-radius
```
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > box-shadow

**Description**

MultiComboListControl 에 그림자 효과를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.box-shadow
```
...
MultiComboListControl 의 좌상단 위치를 기준으로 그림자 효과가 표시될 위치를 가로/세로 픽셀값으로 설정합니다.
- **`<horizontal>`** — 그림자 효과가 표시되는 가로 위치를 설정합니다.
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > color

**Description**

MultiComboListControl 에 표시되는 텍스트의 색상을 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.color
```
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > cursor

**Description**

MultiComboListControl 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.cursor
```
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > font

**Description**

MultiComboListControl 에서 사용하는 폰트를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.font
```
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > letter-spacing

**Description**

MultiComboListControl 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.letter-spacing
```
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > opacity

**Description**

MultiComboListControl 영역의 투명도를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.opacity
```
...
> Components > Component > MultiCombo > Objects > MultiComboListControl > Property > word-spacing

**Description**

MultiComboListControl 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboListControl.word-spacing
```
...
## Components > Component > MultiCombo > MultiComboTagBoxControl

### MultiComboTagBoxControl

> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl
...
| Name | Description |
| --- | --- |
| background | MultiComboTagBoxControl 의 배경 영역을 설정하는 속성입니다. |
| border-radius | MultiComboTagBoxControl 의 모서리 모양을 설정하는 속성입니다. |
| box-shadow | MultiComboTagBoxControl 에 그림자 효과를 설정하는 속성입니다. |
| color | MultiComboTagBoxControl 에 표시되는 텍스트의 색상을 설정하는 속성입니다. |
| cursor | MultiComboTagBoxControl 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다. |
| font | MultiComboTagBoxControl 에서 사용하는 폰트를 설정하는 속성입니다. |
| letter-spacing | MultiComboTagBoxControl 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다. |
| -nexa-border | MultiComboTagBoxControl 의 테두리를 설정하는 속성입니다. |
| -nexa-edge | MultiComboTagBoxControl 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-padding | MultiComboTagBoxControl 영역의 안쪽 여백을 설정하는 속성입니다. |
| -nexa-rtl-background-image | MultiComboTagBoxControl 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다. |
| -nexa-rtl-edge-image | MultiComboTagBoxControl 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-text-align | MultiComboTagBoxControl 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다. |
| -nexa-text-decoration | MultiComboTagBoxControl 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다. |
| -nexa-vertical-align | MultiComboTagBoxControl 에 표시되는 텍스트 또는 컨텐츠의 세로 정렬 방식을 설정하는 속성입니다. |
| -nexa-word-wrap | MultiComboTagBoxControl 에 표시되는 텍스트가 출력영역보다 길 경우 자동으로 줄바꿈 되도록 설정하는 속성입니다. |
| opacity | MultiComboTagBoxControl 영역의 투명도를 설정하는 속성입니다. |
| word-spacing | MultiComboTagBoxControl 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다. |
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > -nexa-border

**Description**

MultiComboTagBoxControl 의 테두리를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.-nexa-border
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > -nexa-edge

**Description**

MultiComboTagBoxControl 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.-nexa-edge
```
...
- MultiComboTagBoxControl 내부에 테두리 형태로 이미지를 표시하고자 할 때 사용하는 속성입니다.
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > -nexa-padding

**Description**

MultiComboTagBoxControl 영역의 안쪽 여백을 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.-nexa-padding
```
...
-nexa-padding : 5px 5px 5px 5px;
```
- **`<npadding>`** — MultiComboTagBoxControl 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
- MultiComboTagBoxControl 의 너비보다 표시되는 컨텐츠의 너비가 길면 "right" 방향의 padding 값이 무시됩니다.
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > -nexa-rtl-background-image

**Description**

MultiComboTagBoxControl 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.-nexa-rtl-background-image
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > -nexa-rtl-edge-image

**Description**

MultiComboTagBoxControl 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.-nexa-rtl-edge-image
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > -nexa-text-align

**Description**

MultiComboTagBoxControl 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.textAlign[= strtextalign]
```
...
* Script ( normal property )
this.MultiComboTagBoxControl00.textAlign = "center";
```
- **`"left"`** — 텍스트 또는 컨텐츠를 왼쪽으로 정렬합니다.
- **`"center"`** — 텍스트 또는 컨텐츠를 가운데로 정렬합니다.
- **`"right"`** — 텍스트 또는 컨텐츠를 오른쪽으로 정렬합니다.
...
- MultiComboTagBoxControl 의 너비보다 표시되는 텍스트의 길이가 크면 "right" 를 설정해도 "left" 로 동작됩니다.
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > -nexa-text-decoration

**Description**

MultiComboTagBoxControl 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.-nexa-text-decoration
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > -nexa-vertical-align

**Description**

MultiComboTagBoxControl 에 표시되는 텍스트 또는 컨텐츠의 세로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.-nexa-vertical-align
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > -nexa-word-wrap

**Description**

MultiComboTagBoxControl 에 표시되는 텍스트가 출력영역보다 길 경우 자동으로 줄바꿈 되도록 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.-nexa-word-wrap
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > background

**Description**

MultiComboTagBoxControl 의 배경 영역을 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.background
```
...
"left" 설정 시 MultiComboTagBoxControl 의 왼쪽면과 이미지의 왼쪽면이 정렬되어 표시됩니다.
"center" 설정 시 MultiComboTagBoxControl 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"right" 설정 시 MultiComboTagBoxControl 의 오른쪽면과 이미지의 오른쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
"top" 설정 시 MultiComboTagBoxControl 의 윗쪽면과 이미지의 윗쪽면이 정렬되어 표시됩니다.
"center" 설정 시 MultiComboTagBoxControl 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"bottom" 설정 시 MultiComboTagBoxControl 의 아랫쪽면과 이미지의 아랫쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
0 보다 작거나 100 보다 큰 값을 설정 시 MultiComboTagBoxControl 의 영역을 벗어난 가상의 위치로 적용됩니다.
...
<angle> 값에 설정된 방향에 따라 시작점과 끝점의 위치가 결정됩니다.
예를 들어 <angle> 값이 "to left" 이면 MultiComboTagBoxControl 의 right 위치가 시작점이 되고, left 위치가 끝점이 됩니다.
              <angle> 값이 "to right" 이면 MultiComboTagBoxControl 의 left 위치가 시작점이 되고, right 위치가 끝점이 됩니다.
...
<bg-image> 또는 <linear-gradient> 값이 설정되어 있다면 배경색은 배경이미지 또는 그라데이션 아래에 표시됩니다.
<bg-image> 에 적용된 이미지에 투명으로 적용된 부분이 있거나 이미지가 MultiComboTagBoxControl 영역보다 작다면 해당 영역에 배경색이 표시됩니다.
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > border-radius

**Description**

MultiComboTagBoxControl 의 모서리 모양을 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.border-radius
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > box-shadow

**Description**

MultiComboTagBoxControl 에 그림자 효과를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.box-shadow
```
...
MultiComboTagBoxControl 의 좌상단 위치를 기준으로 그림자 효과가 표시될 위치를 가로/세로 픽셀값으로 설정합니다.
- **`<horizontal>`** — 그림자 효과가 표시되는 가로 위치를 설정합니다.
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > color

**Description**

MultiComboTagBoxControl 에 표시되는 텍스트의 색상을 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.color
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > cursor

**Description**

MultiComboTagBoxControl 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.cursor
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > font

**Description**

MultiComboTagBoxControl 에서 사용하는 폰트를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.font
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > letter-spacing

**Description**

MultiComboTagBoxControl 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.letter-spacing
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > opacity

**Description**

MultiComboTagBoxControl 영역의 투명도를 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.opacity
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Property > word-spacing

**Description**

MultiComboTagBoxControl 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다.

**Syntax**

```javascript
MultiComboTagBoxControl.word-spacing
```
...
## Components > Component > MultiCombo > MultiComboTagBoxControl > Objects

### Objects

> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects

**Description**

MultiComboTagBoxControl을 구성하는 하위 오브젝트입니다.


---

## Components > Component > MultiCombo > MultiComboTagBoxControl > TagBoxControl

### TagBoxControl

> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl

**Description**

multicombotagbox 내 표시되는 태그 아이템을 표시하는 오브젝트입니다.

**Property**

| Name | Description |
| --- | --- |
| background | TagBoxControl 의 배경 영역을 설정하는 속성입니다. |
| border-radius | TagBoxControl 의 모서리 모양을 설정하는 속성입니다. |
| box-shadow | TagBoxControl 에 그림자 효과를 설정하는 속성입니다. |
| color | TagBoxControl 에 표시되는 텍스트의 색상을 설정하는 속성입니다. |
| cursor | TagBoxControl 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다. |
| font | TagBoxControl 에서 사용하는 폰트를 설정하는 속성입니다. |
| letter-spacing | TagBoxControl 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다. |
| -nexa-border | TagBoxControl 의 테두리를 설정하는 속성입니다. |
| -nexa-edge | TagBoxControl 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-padding | TagBoxControl 영역의 안쪽 여백을 설정하는 속성입니다. |
| -nexa-rtl-background-image | TagBoxControl 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다. |
| -nexa-rtl-edge-image | TagBoxControl 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다. |
| -nexa-text-align | TagBoxControl 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다. |
| -nexa-text-decoration | TagBoxControl 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다. |
| -nexa-vertical-align | TagBoxControl 에 표시되는 텍스트 또는 컨텐츠의 세로 정렬 방식을 설정하는 속성입니다. |
| -nexa-word-wrap | TagBoxControl 에 표시되는 텍스트가 출력영역보다 길 경우 자동으로 줄바꿈 되도록 설정하는 속성입니다. |
| opacity | TagBoxControl 영역의 투명도를 설정하는 속성입니다. |
| word-spacing | TagBoxControl 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다. |
...
| Name | TypeName |
| --- | --- |
| tagtext | nexacro.Static |
| tagbutton | nexacro.Button |
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > -nexa-border

**Description**

TagBoxControl 의 테두리를 설정하는 속성입니다.

**Syntax**

```javascript
TagBoxControl.-nexa-border
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > -nexa-edge

**Description**

TagBoxControl 의 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
TagBoxControl.-nexa-edge
```
...
- TagBoxControl 내부에 테두리 형태로 이미지를 표시하고자 할 때 사용하는 속성입니다.
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > -nexa-padding

**Description**

TagBoxControl 영역의 안쪽 여백을 설정하는 속성입니다.

**Syntax**

```javascript
TagBoxControl.-nexa-padding
```
...
-nexa-padding : 5px 5px 5px 5px;
```
- **`<npadding>`** — TagBoxControl 영역의 안쪽 여백을 pixel 단위로 설정합니다.
...
- TagBoxControl 의 너비보다 표시되는 컨텐츠의 너비가 길면 "right" 방향의 padding 값이 무시됩니다.
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > -nexa-rtl-background-image

**Description**

TagBoxControl 의 rtl 속성이 true 로 적용될 때 배경에 표시될 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
TagBoxControl.-nexa-rtl-background-image
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > -nexa-rtl-edge-image

**Description**

TagBoxControl 의 rtl 속성이 true 로 적용될 때 테두리(Border) 안쪽에 표시될 Edge 이미지를 설정하는 속성입니다.

**Syntax**

```javascript
TagBoxControl.-nexa-rtl-edge-image
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > -nexa-text-align

**Description**

TagBoxControl 에 표시되는 텍스트 또는 컨텐츠의 가로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
TagBoxControl.textAlign[= strtextalign]
```
...
* Script ( normal property )
this.TagBoxControl00.textAlign = "center";
```
- **`"left"`** — 텍스트 또는 컨텐츠를 왼쪽으로 정렬합니다.
- **`"center"`** — 텍스트 또는 컨텐츠를 가운데로 정렬합니다.
- **`"right"`** — 텍스트 또는 컨텐츠를 오른쪽으로 정렬합니다.
...
- TagBoxControl 의 너비보다 표시되는 텍스트의 길이가 크면 "right" 를 설정해도 "left" 로 동작됩니다.
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > -nexa-text-decoration

**Description**

TagBoxControl 에 표시되는 텍스트에 적용할 효과를 설정하는 속성입니다.

**Syntax**

```javascript
TagBoxControl.-nexa-text-decoration
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > -nexa-vertical-align

**Description**

TagBoxControl 에 표시되는 텍스트 또는 컨텐츠의 세로 정렬 방식을 설정하는 속성입니다.

**Syntax**

```javascript
TagBoxControl.-nexa-vertical-align
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > -nexa-word-wrap

**Description**

TagBoxControl 에 표시되는 텍스트가 출력영역보다 길 경우 자동으로 줄바꿈 되도록 설정하는 속성입니다.

**Syntax**

```javascript
TagBoxControl.-nexa-word-wrap
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > background

**Description**

TagBoxControl 의 배경 영역을 설정하는 속성입니다.

**Syntax**

```javascript
TagBoxControl.background
```
...
"left" 설정 시 TagBoxControl 의 왼쪽면과 이미지의 왼쪽면이 정렬되어 표시됩니다.
"center" 설정 시 TagBoxControl 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"right" 설정 시 TagBoxControl 의 오른쪽면과 이미지의 오른쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
"top" 설정 시 TagBoxControl 의 윗쪽면과 이미지의 윗쪽면이 정렬되어 표시됩니다.
"center" 설정 시 TagBoxControl 의 중앙과 이미지의 중앙이 정렬되어 표시됩니다.
"bottom" 설정 시 TagBoxControl 의 아랫쪽면과 이미지의 아랫쪽면이 정렬되어 표시됩니다.
<pos-percentage> '%' 형식으로 설정 시 이미지의 위치가 비율로 설정됩니다.
...
0 보다 작거나 100 보다 큰 값을 설정 시 TagBoxControl 의 영역을 벗어난 가상의 위치로 적용됩니다.
...
<angle> 값에 설정된 방향에 따라 시작점과 끝점의 위치가 결정됩니다.
예를 들어 <angle> 값이 "to left" 이면 TagBoxControl 의 right 위치가 시작점이 되고, left 위치가 끝점이 됩니다.
              <angle> 값이 "to right" 이면 TagBoxControl 의 left 위치가 시작점이 되고, right 위치가 끝점이 됩니다.
...
<bg-image> 또는 <linear-gradient> 값이 설정되어 있다면 배경색은 배경이미지 또는 그라데이션 아래에 표시됩니다.
<bg-image> 에 적용된 이미지에 투명으로 적용된 부분이 있거나 이미지가 TagBoxControl 영역보다 작다면 해당 영역에 배경색이 표시됩니다.
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > border-radius

**Description**

TagBoxControl 의 모서리 모양을 설정하는 속성입니다.

**Syntax**

```javascript
TagBoxControl.border-radius
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > box-shadow

**Description**

TagBoxControl 에 그림자 효과를 설정하는 속성입니다.

**Syntax**

```javascript
TagBoxControl.box-shadow
```
...
TagBoxControl 의 좌상단 위치를 기준으로 그림자 효과가 표시될 위치를 가로/세로 픽셀값으로 설정합니다.
- **`<horizontal>`** — 그림자 효과가 표시되는 가로 위치를 설정합니다.
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > color

**Description**

TagBoxControl 에 표시되는 텍스트의 색상을 설정하는 속성입니다.
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > cursor

**Description**

TagBoxControl 영역에서 표시될 마우스 포인터의 종류를 설정하는 속성입니다.

**Syntax**

```javascript
TagBoxControl.cursor
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > font

**Description**

TagBoxControl 에서 사용하는 폰트를 설정하는 속성입니다.
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > letter-spacing

**Description**

TagBoxControl 에 표시되는 문자의 간격(자간)을 설정하는 속성입니다.

**Syntax**

```javascript
TagBoxControl.letter-spacing
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > opacity

**Description**

TagBoxControl 영역의 투명도를 설정하는 속성입니다.

**Syntax**

```javascript
TagBoxControl.opacity
```
...
> Components > Component > MultiCombo > Objects > MultiComboTagBoxControl > Objects > TagBoxControl > Property > word-spacing

**Description**

TagBoxControl 에 표시되는 텍스트의 단어 사이 간격을 설정하는 속성입니다.

**Syntax**

```javascript
TagBoxControl.word-spacing
```
